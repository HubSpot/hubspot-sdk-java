...
internal class DraftServiceAsyncTest {
    ...
    fun update() {
        ...
        val draftServiceAsync = client.cms().pages().landingPages().draft()
    ...
    fun get() {
        ...
        val pagesPageFuture = draftServiceAsync.get("objectId")
    ...
    fun pushLive() {
        ...
        val future = draftServiceAsync.pushLive("objectId")
    ...
    fun reset() {
        ...
        val future = draftServiceAsync.reset("objectId")
