...
internal class DraftServiceAsyncTest {
    ...
    fun getDraft() {
        ...
        val draftServiceAsync = client.cms().pages().sitePages().draft()

        val pagesPageFuture = draftServiceAsync.getDraft("objectId")
    ...
    fun publishDraft() {
        ...
        val future = draftServiceAsync.publishDraft("objectId")
    ...
    fun resetSitePageDraft() {
        ...
        val future = draftServiceAsync.resetSitePageDraft("objectId")
    ...
    fun updateDraft() {
        ...
        val pagesPageFuture =
            draftServiceAsync.updateDraft(
                DraftUpdateDraftParams.builder()
                    .objectId("objectId")
                    .pagesPage(
                        PagesPage.builder()
                            .id("id")
