...
internal class LineItemServiceAsyncTest {
    ...
    fun create() {
        ...
        val lineItemServiceAsync = client.crm().objects().lineItems()
    ...
    fun delete() {
        ...
        val future = lineItemServiceAsync.delete("lineItemId")
