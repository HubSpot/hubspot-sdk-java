...
internal class DraftServiceTest {
    ...
    fun getDraft() {
        ...
        val draftService = client.cms().pages().sitePages().draft()

        val pagesPage = draftService.getDraft("objectId")
    ...
    fun publishDraft() {
        ...
        draftService.publishDraft("objectId")
    }
    ...
    fun resetSitePageDraft() {
        ...
        draftService.resetSitePageDraft("objectId")
    }
