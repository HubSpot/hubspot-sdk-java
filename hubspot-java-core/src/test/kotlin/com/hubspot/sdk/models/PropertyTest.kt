...
internal class PropertyTest {
    ...
    fun create() {
        ...
        assertThat(property.numberDisplayHint()).contains(Property.NumberDisplayHint.CURRENCY)
        ...
        assertThat(property.textDisplayHint()).contains(Property.TextDisplayHint.DOMAIN_NAME)
