...
internal class PublicAndFilterBranchTest {

    @Test
    fun create() {
        val publicAndFilterBranch =
        ...
        assertThat(publicAndFilterBranch.filterBranchOperator()).isEqualTo("filterBranchOperator")
        assertThat(publicAndFilterBranch.filterBranchType())
    ...
    fun roundtrip() {
        ...
        val roundtrippedPublicAndFilterBranch =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(publicAndFilterBranch),
                jacksonTypeRef<PublicAndFilterBranch>(),
            )

        assertThat(roundtrippedPublicAndFilterBranch).isEqualTo(publicAndFilterBranch)
    }
}
