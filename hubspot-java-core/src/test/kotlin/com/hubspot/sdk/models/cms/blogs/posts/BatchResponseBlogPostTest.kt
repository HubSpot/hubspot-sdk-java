...
internal class BatchResponseBlogPostTest {

    @Test
    fun create() {
        val batchResponseBlogPost =
            BatchResponseBlogPost.builder()
        ...
        assertThat(batchResponseBlogPost.completedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(batchResponseBlogPost.results())
            .containsExactly(
                BlogPost.builder()
                    .id("id")
                    .abStatus(BlogPost.AbStatus.AUTOMATED_LOSER_VARIANT)
        ...
        assertThat(batchResponseBlogPost.requestedAt())
    ...
    fun roundtrip() {
        ...
        val roundtrippedBatchResponseBlogPost =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(batchResponseBlogPost),
                jacksonTypeRef<BatchResponseBlogPost>(),
            )

        assertThat(roundtrippedBatchResponseBlogPost).isEqualTo(batchResponseBlogPost)
    }
}
