...
internal class EmailCreateRequestTest {
    ...
    fun create() {
        ...
        assertThat(emailCreateRequest.activeDomain()).contains("activeDomain")
        assertThat(emailCreateRequest.archived()).contains(true)
        assertThat(emailCreateRequest.businessUnitId()).contains(0L)
        assertThat(emailCreateRequest.campaign()).contains("campaign")
        ...
        assertThat(emailCreateRequest.language()).contains(EmailCreateRequest.Language.AA)
        assertThat(emailCreateRequest.name()).contains("name")
        ...
        assertThat(emailCreateRequest.state()).contains(EmailCreateRequest.State.AGENT_GENERATED)
        assertThat(emailCreateRequest.subcategory())
            .contains(EmailCreateRequest.Subcategory.AB_LOSER_VARIANT)
        assertThat(emailCreateRequest.subject()).contains("subject")
