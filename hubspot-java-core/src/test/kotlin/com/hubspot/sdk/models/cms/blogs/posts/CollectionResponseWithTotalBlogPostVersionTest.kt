...
internal class CollectionResponseWithTotalBlogPostVersionTest {

    @Test
    fun create() {
        val collectionResponseWithTotalBlogPostVersion =
            CollectionResponseWithTotalBlogPostVersion.builder()
                .addResult(
        ...
        assertThat(collectionResponseWithTotalBlogPostVersion.results())
            .containsExactly(
                VersionBlogPost.builder()
                    .id("id")
                    .object_(
        ...
        assertThat(collectionResponseWithTotalBlogPostVersion.total()).isEqualTo(0)
        assertThat(collectionResponseWithTotalBlogPostVersion.paging())
            .contains(
                Paging.builder()
                    .next(NextPage.builder().after("after").link("link").build())
                    .prev(PreviousPage.builder().before("before").link("link").build())
    ...
    fun roundtrip() {
        ...
        val roundtrippedCollectionResponseWithTotalBlogPostVersion =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(collectionResponseWithTotalBlogPostVersion),
                jacksonTypeRef<CollectionResponseWithTotalBlogPostVersion>(),
            )

        assertThat(roundtrippedCollectionResponseWithTotalBlogPostVersion)
            .isEqualTo(collectionResponseWithTotalBlogPostVersion)
    }
}
