...
internal class PublicEmailVersionTest {

    @Test
    fun create() {
        val publicEmailVersion =
            PublicEmailVersion.builder()
                .id("id")
                .object_(
                    PublicEmail.builder()
                        .isAb(true)
        ...
        assertThat(publicEmailVersion.id()).isEqualTo("id")
        assertThat(publicEmailVersion.object_())
            .isEqualTo(
                PublicEmail.builder()
                    .isAb(true)
                    .id("id")
        ...
        assertThat(publicEmailVersion.updatedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(publicEmailVersion.user())
    ...
    fun roundtrip() {
        ...
        val roundtrippedPublicEmailVersion =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(publicEmailVersion),
                jacksonTypeRef<PublicEmailVersion>(),
            )

        assertThat(roundtrippedPublicEmailVersion).isEqualTo(publicEmailVersion)
    }
}
