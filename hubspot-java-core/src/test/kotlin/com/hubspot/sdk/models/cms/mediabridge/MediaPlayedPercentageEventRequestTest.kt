    ...
    fun create() {
        val mediaPlayedPercentageEventRequest =
            MediaPlayedPercentageEventRequest.builder()
                ...
                .externalPlayContext(MediaPlayedPercentageEventRequest.ExternalPlayContext.EMAIL)
                .mediaBridgeId(0L)
                .mediaName("mediaName")
                .mediaUrl("mediaUrl")
                .pageId(0L)
        ...
        assertThat(mediaPlayedPercentageEventRequest.externalPlayContext())
            .contains(MediaPlayedPercentageEventRequest.ExternalPlayContext.EMAIL)
