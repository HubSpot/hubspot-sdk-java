...
internal class AuthorGetParamsTest {

    @Test
    fun create() {
        AuthorGetParams.builder().objectId("objectId").archived(true).property("property").build()
    }

    @Test
    fun pathParams() {
        val params = AuthorGetParams.builder().objectId("objectId").build()
