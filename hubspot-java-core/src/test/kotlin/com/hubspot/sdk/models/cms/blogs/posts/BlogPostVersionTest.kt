...
internal class BlogPostVersionTest {

    @Test
    fun create() {
        val blogPostVersion =
            BlogPostVersion.builder()
                .id("id")
                .object_(
                    BlogPost.builder()
                        .id("id")
        ...
        assertThat(blogPostVersion.id()).isEqualTo("id")
        assertThat(blogPostVersion.object_())
            .isEqualTo(
                BlogPost.builder()
                    .id("id")
                    .abStatus(BlogPost.AbStatus.AUTOMATED_LOSER_VARIANT)
        ...
        assertThat(blogPostVersion.updatedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(blogPostVersion.user())
    ...
    fun roundtrip() {
        ...
        val roundtrippedBlogPostVersion =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(blogPostVersion),
                jacksonTypeRef<BlogPostVersion>(),
            )

        assertThat(roundtrippedBlogPostVersion).isEqualTo(blogPostVersion)
    }
}
