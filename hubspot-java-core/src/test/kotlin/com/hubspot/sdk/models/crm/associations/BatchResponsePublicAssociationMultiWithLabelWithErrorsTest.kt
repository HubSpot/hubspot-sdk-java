...
import com.hubspot.sdk.models.crm.AssociationSpecWithLabel
...
internal class BatchResponsePublicAssociationMultiWithLabelWithErrorsTest {

    @Test
    fun create() {
        val batchResponsePublicAssociationMultiWithLabelWithErrors =
            BatchResponsePublicAssociationMultiWithLabelWithErrors.builder()
                ...
                .status(BatchResponsePublicAssociationMultiWithLabelWithErrors.Status.CANCELED)
                .addError(
                ...
                .links(
                    BatchResponsePublicAssociationMultiWithLabelWithErrors.Links.builder()
                        .putAdditionalProperty("foo", JsonValue.from("string"))
                        .build()
                )
                .numErrors(0)
        ...
        assertThat(batchResponsePublicAssociationMultiWithLabelWithErrors.completedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(batchResponsePublicAssociationMultiWithLabelWithErrors.results())
            .containsExactly(
                PublicAssociationMultiWithLabel.builder()
                    .from(PublicObjectId.builder().id("id").build())
                    .addTo(
        ...
        assertThat(batchResponsePublicAssociationMultiWithLabelWithErrors.startedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(batchResponsePublicAssociationMultiWithLabelWithErrors.status())
            .isEqualTo(BatchResponsePublicAssociationMultiWithLabelWithErrors.Status.CANCELED)
        assertThat(batchResponsePublicAssociationMultiWithLabelWithErrors.errors().getOrNull())
            .containsExactly(
                StandardError.builder()
                    .category("category")
                    .context(
        ...
        assertThat(batchResponsePublicAssociationMultiWithLabelWithErrors.links())
            .contains(
                BatchResponsePublicAssociationMultiWithLabelWithErrors.Links.builder()
                    .putAdditionalProperty("foo", JsonValue.from("string"))
                    .build()
            )
        assertThat(batchResponsePublicAssociationMultiWithLabelWithErrors.numErrors()).contains(0)
        assertThat(batchResponsePublicAssociationMultiWithLabelWithErrors.requestedAt())
    ...
    fun roundtrip() {
        ...
        val roundtrippedBatchResponsePublicAssociationMultiWithLabelWithErrors =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(
                    batchResponsePublicAssociationMultiWithLabelWithErrors
                ),
                jacksonTypeRef<BatchResponsePublicAssociationMultiWithLabelWithErrors>(),
            )

        assertThat(roundtrippedBatchResponsePublicAssociationMultiWithLabelWithErrors)
            .isEqualTo(batchResponsePublicAssociationMultiWithLabelWithErrors)
    }
}
