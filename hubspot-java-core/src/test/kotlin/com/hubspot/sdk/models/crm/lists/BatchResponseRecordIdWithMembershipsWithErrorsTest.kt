...
internal class BatchResponseRecordIdWithMembershipsWithErrorsTest {

    @Test
    fun create() {
        val batchResponseRecordIdWithMembershipsWithErrors =
            BatchResponseRecordIdWithMembershipsWithErrors.builder()
                ...
                .status(BatchResponseRecordIdWithMembershipsWithErrors.Status.CANCELED)
                .addError(
                ...
                .links(
                    BatchResponseRecordIdWithMembershipsWithErrors.Links.builder()
                        .putAdditionalProperty("foo", JsonValue.from("string"))
                        .build()
                )
                .numErrors(0)
        ...
        assertThat(batchResponseRecordIdWithMembershipsWithErrors.completedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(batchResponseRecordIdWithMembershipsWithErrors.results())
            .containsExactly(
                RecordIdWithMemberships.builder()
                    .objectTypeId("objectTypeId")
                    .recordId("recordId")
        ...
        assertThat(batchResponseRecordIdWithMembershipsWithErrors.startedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(batchResponseRecordIdWithMembershipsWithErrors.status())
            .isEqualTo(BatchResponseRecordIdWithMembershipsWithErrors.Status.CANCELED)
        assertThat(batchResponseRecordIdWithMembershipsWithErrors.errors().getOrNull())
            .containsExactly(
                StandardError.builder()
                    .category("category")
                    .context(
        ...
        assertThat(batchResponseRecordIdWithMembershipsWithErrors.links())
            .contains(
                BatchResponseRecordIdWithMembershipsWithErrors.Links.builder()
                    .putAdditionalProperty("foo", JsonValue.from("string"))
                    .build()
            )
        assertThat(batchResponseRecordIdWithMembershipsWithErrors.numErrors()).contains(0)
        assertThat(batchResponseRecordIdWithMembershipsWithErrors.requestedAt())
    ...
    fun roundtrip() {
        ...
        val roundtrippedBatchResponseRecordIdWithMembershipsWithErrors =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(batchResponseRecordIdWithMembershipsWithErrors),
                jacksonTypeRef<BatchResponseRecordIdWithMembershipsWithErrors>(),
            )

        assertThat(roundtrippedBatchResponseRecordIdWithMembershipsWithErrors)
            .isEqualTo(batchResponseRecordIdWithMembershipsWithErrors)
    }
}
