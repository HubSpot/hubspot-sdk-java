...
internal class ListsByIdResponseTest {

    @Test
    fun create() {
        val listsByIdResponse =
            ListsByIdResponse.builder()
                .addList(
        ...
        assertThat(listsByIdResponse.lists())
            .containsExactly(
                PublicObjectList.builder()
                    .listId("listId")
                    .listVersion(0)
    ...
    fun roundtrip() {
        ...
        val roundtrippedListsByIdResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(listsByIdResponse),
                jacksonTypeRef<ListsByIdResponse>(),
            )

        assertThat(roundtrippedListsByIdResponse).isEqualTo(listsByIdResponse)
    }
}
