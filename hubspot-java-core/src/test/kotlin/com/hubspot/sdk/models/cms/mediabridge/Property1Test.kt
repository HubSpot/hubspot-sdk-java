...
internal class Property1Test {
    ...
    fun create() {
        ...
        assertThat(property1.currencyPropertyName()).contains("currencyPropertyName")
        ...
        assertThat(property1.numberDisplayHint()).contains(Property1.NumberDisplayHint.CURRENCY)
