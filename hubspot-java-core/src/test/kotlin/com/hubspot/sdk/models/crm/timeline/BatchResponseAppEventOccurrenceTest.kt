...
internal class BatchResponseAppEventOccurrenceTest {

    @Test
    fun create() {
        val batchResponseAppEventOccurrence =
            BatchResponseAppEventOccurrence.builder()
                ...
                .status(BatchResponseAppEventOccurrence.Status.CANCELED)
                .addError(
                ...
                .links(
                    BatchResponseAppEventOccurrence.Links.builder()
                        .putAdditionalProperty("foo", JsonValue.from("string"))
                        .build()
                )
                .numErrors(0)
        ...
        assertThat(batchResponseAppEventOccurrence.completedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(batchResponseAppEventOccurrence.results())
            .containsExactly(
                AppEventOccurrence.builder()
                    .id("id")
                    .eventTypeName("eventTypeName")
        ...
        assertThat(batchResponseAppEventOccurrence.startedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(batchResponseAppEventOccurrence.status())
            .isEqualTo(BatchResponseAppEventOccurrence.Status.CANCELED)
        assertThat(batchResponseAppEventOccurrence.errors().getOrNull())
            .containsExactly(
                StandardError.builder()
                    .category("category")
                    .context(
        ...
        assertThat(batchResponseAppEventOccurrence.links())
            .contains(
                BatchResponseAppEventOccurrence.Links.builder()
                    .putAdditionalProperty("foo", JsonValue.from("string"))
                    .build()
            )
        assertThat(batchResponseAppEventOccurrence.numErrors()).contains(0)
        assertThat(batchResponseAppEventOccurrence.requestedAt())
    ...
    fun roundtrip() {
        ...
        val roundtrippedBatchResponseAppEventOccurrence =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(batchResponseAppEventOccurrence),
                jacksonTypeRef<BatchResponseAppEventOccurrence>(),
            )

        assertThat(roundtrippedBatchResponseAppEventOccurrence)
            .isEqualTo(batchResponseAppEventOccurrence)
    }
}
