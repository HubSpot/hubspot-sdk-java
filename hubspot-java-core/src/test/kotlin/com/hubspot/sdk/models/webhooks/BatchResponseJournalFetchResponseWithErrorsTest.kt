...
internal class BatchResponseJournalFetchResponseWithErrorsTest {

    @Test
    fun create() {
        val batchResponseJournalFetchResponseWithErrors =
            BatchResponseJournalFetchResponseWithErrors.builder()
                ...
                .status(BatchResponseJournalFetchResponseWithErrors.Status.CANCELED)
                .addError(
                ...
                .links(
                    BatchResponseJournalFetchResponseWithErrors.Links.builder()
                        .putAdditionalProperty("foo", JsonValue.from("string"))
                        .build()
                )
                .numErrors(0)
        ...
        assertThat(batchResponseJournalFetchResponseWithErrors.completedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(batchResponseJournalFetchResponseWithErrors.results())
            .containsExactly(
                JournalFetchResponse.builder()
                    .currentOffset("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .expiresAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        ...
        assertThat(batchResponseJournalFetchResponseWithErrors.startedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(batchResponseJournalFetchResponseWithErrors.status())
            .isEqualTo(BatchResponseJournalFetchResponseWithErrors.Status.CANCELED)
        assertThat(batchResponseJournalFetchResponseWithErrors.errors().getOrNull())
            .containsExactly(
                StandardError.builder()
                    .category("category")
                    .context(
        ...
        assertThat(batchResponseJournalFetchResponseWithErrors.links())
            .contains(
                BatchResponseJournalFetchResponseWithErrors.Links.builder()
                    .putAdditionalProperty("foo", JsonValue.from("string"))
                    .build()
            )
        assertThat(batchResponseJournalFetchResponseWithErrors.numErrors()).contains(0)
        assertThat(batchResponseJournalFetchResponseWithErrors.requestedAt())
    ...
    fun roundtrip() {
        ...
        val roundtrippedBatchResponseJournalFetchResponseWithErrors =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(batchResponseJournalFetchResponseWithErrors),
                jacksonTypeRef<BatchResponseJournalFetchResponseWithErrors>(),
            )

        assertThat(roundtrippedBatchResponseJournalFetchResponseWithErrors)
            .isEqualTo(batchResponseJournalFetchResponseWithErrors)
    }
}
