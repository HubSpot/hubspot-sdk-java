...
internal class ExternalBehavioralEventTypeDefinitionTest {
    ...
    fun create() {
        ...
        assertThat(externalBehavioralEventTypeDefinition.detailTemplate())
            .contains("detailTemplate")
        assertThat(externalBehavioralEventTypeDefinition.headerTemplate())
            .contains("headerTemplate")
