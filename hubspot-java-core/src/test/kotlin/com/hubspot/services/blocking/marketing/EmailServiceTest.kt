...
import com.hubspot.models.marketing.emails.EmailUpdateRequest
import com.hubspot.models.marketing.emails.PublicButtonStyleSettings
import com.hubspot.models.marketing.emails.PublicDividerStyleSettings
import com.hubspot.models.marketing.emails.PublicEmailContent
import com.hubspot.models.marketing.emails.PublicEmailFromDetails
import com.hubspot.models.marketing.emails.PublicEmailRecipients
import com.hubspot.models.marketing.emails.PublicEmailStyleSettings
import com.hubspot.models.marketing.emails.PublicEmailSubscriptionDetails
import com.hubspot.models.marketing.emails.PublicEmailTestingDetails
import com.hubspot.models.marketing.emails.PublicEmailToDetails
import com.hubspot.models.marketing.emails.PublicFontStyle
import com.hubspot.models.marketing.emails.PublicRssEmailDetails
import com.hubspot.models.marketing.emails.PublicWebversionDetails
...
internal class EmailServiceTest {
    ...
    fun delete() {
        ...
        emailService.delete(EmailDeleteParams.builder().emailId("emailId").archived(true).build())
    }
    ...
    fun getDraft() {
        ...
        val publicEmail = emailService.getDraft("emailId")
    ...
    fun listRevisions() {
        ...
        val page = emailService.listRevisions("emailId")
    ...
    fun resetDraft() {
        ...
        emailService.resetDraft("emailId")
    }
    ...
    fun restoreRevisionToDraft() {
        ...
        val publicEmail =
            emailService.restoreRevisionToDraft(
    ...
    fun unpublish() {
        ...
        emailService.unpublish("emailId")
    }
