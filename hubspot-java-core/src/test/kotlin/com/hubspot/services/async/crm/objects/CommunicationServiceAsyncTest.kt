...
internal class CommunicationServiceAsyncTest {
    ...
    fun create() {
        ...
        val simplePublicObjectFuture =
            communicationServiceAsync.create(
    ...
    fun update() {
        ...
        val simplePublicObjectFuture =
            communicationServiceAsync.update(
                CommunicationUpdateParams.builder()
    ...
    fun list() {
        ...
        val pageFuture = communicationServiceAsync.list()
    ...
    fun delete() {
        ...
        val future = communicationServiceAsync.delete("communicationId")
    ...
    fun search() {
        ...
        val collectionResponseWithTotalSimplePublicObjectFuture =
            communicationServiceAsync.search(
