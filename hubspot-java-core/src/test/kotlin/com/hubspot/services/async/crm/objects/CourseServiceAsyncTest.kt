...
internal class CourseServiceAsyncTest {

    @Disabled("Mock server tests are disabled")
    @Test
    fun create() {
        val client = HubSpotOkHttpClientAsync.builder().accessToken("My Access Token").build()
        val courseServiceAsync = client.crm().objects().courses()

        val simplePublicObjectFuture =
            courseServiceAsync.create(
    ...
    fun update() {
        ...
        val simplePublicObjectFuture =
            courseServiceAsync.update(
                CourseUpdateParams.builder()
                    .courseId("courseId")
    ...
    fun list() {
        ...
        val pageFuture = courseServiceAsync.list()
    ...
    fun delete() {
        ...
        val future = courseServiceAsync.delete("courseId")
