...
internal class GenericObjectServiceAsyncTest {

    @Disabled("Mock server tests are disabled")
    @Test
    fun create() {
        val client = HubSpotOkHttpClientAsync.builder().accessToken("My Access Token").build()
        val genericObjectServiceAsync = client.crm().objects().genericObjects()

        val simplePublicObjectFuture =
            genericObjectServiceAsync.create(
    ...
    fun update() {
        ...
        val simplePublicObjectFuture =
            genericObjectServiceAsync.update(
    ...
    fun list() {
        ...
        val pageFuture = genericObjectServiceAsync.list("objectType")
    ...
    fun delete() {
        ...
        val future =
            genericObjectServiceAsync.delete(
    ...
    fun search() {
        ...
        val collectionResponseWithTotalSimplePublicObjectFuture =
            genericObjectServiceAsync.search(
