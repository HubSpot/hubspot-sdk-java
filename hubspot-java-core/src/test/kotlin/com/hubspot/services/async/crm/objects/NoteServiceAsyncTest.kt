...
internal class NoteServiceAsyncTest {
    ...
    fun create() {
        ...
        val noteServiceAsync = client.crm().objects().notes()
    ...
    fun list() {
        ...
        val pageFuture = noteServiceAsync.list()
    ...
    fun delete() {
        ...
        val future = noteServiceAsync.delete("noteId")
