...
internal class CompanyServiceAsyncTest {
    ...
    fun create() {
        ...
        val companyServiceAsync = client.crm().objects().companies()
    ...
    fun list() {
        ...
        val pageFuture = companyServiceAsync.list()
    ...
    fun delete() {
        ...
        val future = companyServiceAsync.delete("companyId")
