...
internal class TicketServiceAsyncTest {
    ...
    fun create() {
        ...
        val ticketServiceAsync = client.crm().objects().tickets()
    ...
    fun list() {
        ...
        val pageFuture = ticketServiceAsync.list()
    ...
    fun delete() {
        ...
        val future = ticketServiceAsync.delete("ticketId")
