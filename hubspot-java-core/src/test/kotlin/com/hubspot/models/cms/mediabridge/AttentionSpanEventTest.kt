    ...
    fun create() {
        val attentionSpanEvent =
            AttentionSpanEvent.builder()
                ...
                .externalPlayContext(AttentionSpanEvent.ExternalPlayContext.EMAIL)
                .mediaUrl("mediaUrl")
                .pageId(0L)
                .pageName("pageName")
        ...
        assertThat(attentionSpanEvent.externalPlayContext())
            .contains(AttentionSpanEvent.ExternalPlayContext.EMAIL)
