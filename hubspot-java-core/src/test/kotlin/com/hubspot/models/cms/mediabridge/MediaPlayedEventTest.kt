    ...
    fun create() {
        val mediaPlayedEvent =
            MediaPlayedEvent.builder()
                ...
                .externalPlayContext(MediaPlayedEvent.ExternalPlayContext.EMAIL)
                .iframeUrl("iframeUrl")
                .mediaUrl("mediaUrl")
                .pageId(0L)
                .pageName("pageName")
        ...
        assertThat(mediaPlayedEvent.externalPlayContext())
            .contains(MediaPlayedEvent.ExternalPlayContext.EMAIL)
