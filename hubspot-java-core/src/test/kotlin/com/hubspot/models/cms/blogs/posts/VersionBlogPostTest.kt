...
internal class VersionBlogPostTest {
    ...
    fun create() {
        ...
        assertThat(versionBlogPost.id()).isEqualTo("id")
        assertThat(versionBlogPost.object_())
            .isEqualTo(
                BlogPost.builder()
                    .id("id")
                    .abStatus(BlogPost.AbStatus.AUTOMATED_LOSER_VARIANT)
        ...
        assertThat(versionBlogPost.updatedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(versionBlogPost.user())
    ...
    fun roundtrip() {
        ...
        val roundtrippedVersionBlogPost =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(versionBlogPost),
                jacksonTypeRef<VersionBlogPost>(),
            )

        assertThat(roundtrippedVersionBlogPost).isEqualTo(versionBlogPost)
    }
}
