...
internal class BatchResponseSimplePublicUpsertObjectWithErrorsTest {

    @Test
    fun create() {
        val batchResponseSimplePublicUpsertObjectWithErrors =
            BatchResponseSimplePublicUpsertObjectWithErrors.builder()
                ...
                .status(BatchResponseSimplePublicUpsertObjectWithErrors.Status.CANCELED)
                .addError(
                ...
                .links(
                    BatchResponseSimplePublicUpsertObjectWithErrors.Links.builder()
                        .putAdditionalProperty("foo", JsonValue.from("string"))
                        .build()
                )
                .numErrors(0)
        ...
        assertThat(batchResponseSimplePublicUpsertObjectWithErrors.completedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(batchResponseSimplePublicUpsertObjectWithErrors.results())
            .containsExactly(
                SimplePublicUpsertObject.builder()
                    .id("id")
                    .archived(true)
        ...
        assertThat(batchResponseSimplePublicUpsertObjectWithErrors.startedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(batchResponseSimplePublicUpsertObjectWithErrors.status())
            .isEqualTo(BatchResponseSimplePublicUpsertObjectWithErrors.Status.CANCELED)
        assertThat(batchResponseSimplePublicUpsertObjectWithErrors.errors().getOrNull())
            .containsExactly(
                StandardError.builder()
                    .category("category")
                    .context(
        ...
        assertThat(batchResponseSimplePublicUpsertObjectWithErrors.links())
            .contains(
                BatchResponseSimplePublicUpsertObjectWithErrors.Links.builder()
                    .putAdditionalProperty("foo", JsonValue.from("string"))
                    .build()
            )
        assertThat(batchResponseSimplePublicUpsertObjectWithErrors.numErrors()).contains(0)
        assertThat(batchResponseSimplePublicUpsertObjectWithErrors.requestedAt())
    ...
    fun roundtrip() {
        ...
        val roundtrippedBatchResponseSimplePublicUpsertObjectWithErrors =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(batchResponseSimplePublicUpsertObjectWithErrors),
                jacksonTypeRef<BatchResponseSimplePublicUpsertObjectWithErrors>(),
            )

        assertThat(roundtrippedBatchResponseSimplePublicUpsertObjectWithErrors)
            .isEqualTo(batchResponseSimplePublicUpsertObjectWithErrors)
    }
}
