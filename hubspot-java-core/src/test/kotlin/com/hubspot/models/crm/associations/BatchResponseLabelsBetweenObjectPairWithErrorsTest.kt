...
internal class BatchResponseLabelsBetweenObjectPairWithErrorsTest {

    @Test
    fun create() {
        val batchResponseLabelsBetweenObjectPairWithErrors =
            BatchResponseLabelsBetweenObjectPairWithErrors.builder()
                ...
                .status(BatchResponseLabelsBetweenObjectPairWithErrors.Status.CANCELED)
                .addError(
                ...
                .links(
                    BatchResponseLabelsBetweenObjectPairWithErrors.Links.builder()
                        .putAdditionalProperty("foo", JsonValue.from("string"))
                        .build()
                )
                .numErrors(0)
        ...
        assertThat(batchResponseLabelsBetweenObjectPairWithErrors.completedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(batchResponseLabelsBetweenObjectPairWithErrors.results())
            .containsExactly(
                LabelsBetweenObjectPair.builder()
                    .fromObjectId("fromObjectId")
                    .fromObjectTypeId("fromObjectTypeId")
        ...
        assertThat(batchResponseLabelsBetweenObjectPairWithErrors.startedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(batchResponseLabelsBetweenObjectPairWithErrors.status())
            .isEqualTo(BatchResponseLabelsBetweenObjectPairWithErrors.Status.CANCELED)
        assertThat(batchResponseLabelsBetweenObjectPairWithErrors.errors().getOrNull())
            .containsExactly(
                StandardError.builder()
                    .category("category")
                    .context(
        ...
        assertThat(batchResponseLabelsBetweenObjectPairWithErrors.links())
            .contains(
                BatchResponseLabelsBetweenObjectPairWithErrors.Links.builder()
                    .putAdditionalProperty("foo", JsonValue.from("string"))
                    .build()
            )
        assertThat(batchResponseLabelsBetweenObjectPairWithErrors.numErrors()).contains(0)
        assertThat(batchResponseLabelsBetweenObjectPairWithErrors.requestedAt())
    ...
    fun roundtrip() {
        ...
        val roundtrippedBatchResponseLabelsBetweenObjectPairWithErrors =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(batchResponseLabelsBetweenObjectPairWithErrors),
                jacksonTypeRef<BatchResponseLabelsBetweenObjectPairWithErrors>(),
            )

        assertThat(roundtrippedBatchResponseLabelsBetweenObjectPairWithErrors)
            .isEqualTo(batchResponseLabelsBetweenObjectPairWithErrors)
    }
}
