...
internal class CollectionResponseWithTotalPublicEmailTest {

    @Test
    fun create() {
        val collectionResponseWithTotalPublicEmail =
            CollectionResponseWithTotalPublicEmail.builder()
                .addResult(
                    PublicEmail.builder()
                        .isAb(true)
                        .id("id")
        ...
        assertThat(collectionResponseWithTotalPublicEmail.results())
            .containsExactly(
                PublicEmail.builder()
                    .isAb(true)
                    .id("id")
        ...
        assertThat(collectionResponseWithTotalPublicEmail.total()).isEqualTo(0)
        assertThat(collectionResponseWithTotalPublicEmail.paging())
            .contains(
                Paging.builder()
                    .next(NextPage.builder().after("after").link("link").build())
                    .prev(PreviousPage.builder().before("before").link("link").build())
    ...
    fun roundtrip() {
        ...
        val roundtrippedCollectionResponseWithTotalPublicEmail =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(collectionResponseWithTotalPublicEmail),
                jacksonTypeRef<CollectionResponseWithTotalPublicEmail>(),
            )

        assertThat(roundtrippedCollectionResponseWithTotalPublicEmail)
            .isEqualTo(collectionResponseWithTotalPublicEmail)
    }
}
