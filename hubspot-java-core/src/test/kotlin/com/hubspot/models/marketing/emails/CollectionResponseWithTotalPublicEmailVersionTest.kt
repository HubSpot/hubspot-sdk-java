...
internal class CollectionResponseWithTotalPublicEmailVersionTest {

    @Test
    fun create() {
        val collectionResponseWithTotalPublicEmailVersion =
            CollectionResponseWithTotalPublicEmailVersion.builder()
                .addResult(
                            ...
                            PublicEmail.builder()
                                    ...
                                    PublicEmailContent.builder()
                                        ...
                                        .styleSettings(
                                            PublicEmailStyleSettings.builder()
                                                ...
                                                .backgroundImageType(
                                                    PublicEmailStyleSettings.BackgroundImageType
                                                        .REPEAT
                                                )
                                ...
                                .testing(
                                    PublicEmailTestingDetails.builder()
                                        ...
                                        .abStatus(
                                            PublicEmailTestingDetails.AbStatus
                                                .AUTOMATED_LOSER_VARIANT
                                        )
                                        .abSuccessMetric(
        ...
        assertThat(collectionResponseWithTotalPublicEmailVersion.results())
            .containsExactly(
                VersionPublicEmail.builder()
                    .id("id")
                    .object_(
        ...
        assertThat(collectionResponseWithTotalPublicEmailVersion.total()).isEqualTo(0)
        assertThat(collectionResponseWithTotalPublicEmailVersion.paging())
            .contains(
                Paging.builder()
                    .next(NextPage.builder().after("after").link("link").build())
                    .prev(PreviousPage.builder().before("before").link("link").build())
    ...
    fun roundtrip() {
        ...
        val roundtrippedCollectionResponseWithTotalPublicEmailVersion =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(collectionResponseWithTotalPublicEmailVersion),
                jacksonTypeRef<CollectionResponseWithTotalPublicEmailVersion>(),
            )

        assertThat(roundtrippedCollectionResponseWithTotalPublicEmailVersion)
            .isEqualTo(collectionResponseWithTotalPublicEmailVersion)
    }
}
