...
internal class RangedNumberPropertyOperationTest {
    ...
    fun create() {
        ...
        assertThat(rangedNumberPropertyOperation.lowerBound()).isEqualTo(0.0)
        ...
        assertThat(rangedNumberPropertyOperation.upperBound()).isEqualTo(0.0)
        assertThat(rangedNumberPropertyOperation.defaultValue()).contains("defaultValue")
        assertThat(rangedNumberPropertyOperation.renderSpec()).contains("renderSpec")
    }
