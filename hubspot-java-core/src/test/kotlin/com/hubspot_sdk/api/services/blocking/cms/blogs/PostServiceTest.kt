...
internal class PostServiceTest {
    ...
    fun createLangVariation() {
        ...
        val blogPost =
            postService.createLangVariation(
    ...
    fun detachFromLangGroup() {
        ...
        postService.detachFromLangGroup(DetachFromLangGroupRequestVNext.builder().id("id").build())
    }
    ...
    fun getDraftById() {
        ...
        val blogPost = postService.getDraftById("objectId")
    ...
    fun getPreviousVersions() {
        ...
        val page = postService.getPreviousVersions("objectId")
    ...
    fun restorePreviousVersion() {
        ...
        val blogPost =
            postService.restorePreviousVersion(
    ...
    fun restorePreviousVersionToDraft() {
        ...
        val blogPost =
            postService.restorePreviousVersionToDraft(
    ...
    fun setLangPrimary() {
        ...
        postService.setLangPrimary(SetNewLanguagePrimaryRequestVNext.builder().id("id").build())
    }
