...
internal class DiscountServiceAsyncTest {
    ...
    fun create() {
        val client =
            HubspotOkHttpClientAsync.builder()
                ...
                .build()
        val discountServiceAsync = client.crm().objects().discounts()
    ...
    fun delete() {
        ...
        val future = discountServiceAsync.delete("discountId")
