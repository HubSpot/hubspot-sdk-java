...
internal class LandingPageServiceTest {
    ...
    fun attachToLangGroup() {
        ...
        landingPageService.attachToLangGroup(
    ...
    fun createBatch() {
        ...
        val batchResponsePage =
            landingPageService.createBatch(
    ...
    fun createFolder() {
        ...
        val contentFolder =
            landingPageService.createFolder(
    ...
    fun createFoldersBatch() {
        ...
        val batchResponseContentFolder =
            landingPageService.createFoldersBatch(
    ...
    fun createLanguageVariation() {
        ...
        val page =
            landingPageService.createLanguageVariation(
    ...
    fun deleteBatch() {
        ...
        landingPageService.deleteBatch(BatchInputString.builder().addInput("string").build())
    }
    ...
    fun deleteFolder() {
        ...
        landingPageService.deleteFolder(
    ...
    fun deleteFoldersBatch() {
        ...
        landingPageService.deleteFoldersBatch(BatchInputString.builder().addInput("string").build())
    }
    ...
    fun detachFromLangGroup() {
        ...
        landingPageService.detachFromLangGroup(
    ...
    fun getFolderRevision() {
        ...
        val versionContentFolder =
            landingPageService.getFolderRevision(
    ...
    fun getFoldersBatch() {
        ...
        val batchResponseContentFolder =
            landingPageService.getFoldersBatch(
    ...
    fun getRevision() {
        ...
        val versionPage =
            landingPageService.getRevision(
    ...
    fun rerunAbTest() {
        ...
        landingPageService.rerunAbTest(
    ...
    fun restoreFolderRevision() {
        ...
        val contentFolder =
            landingPageService.restoreFolderRevision(
    ...
    fun restoreRevision() {
        ...
        val page =
            landingPageService.restoreRevision(
    ...
    fun restoreRevisionToDraft() {
        ...
        val page =
            landingPageService.restoreRevisionToDraft(
    ...
    fun setNewLangPrimary() {
        ...
        landingPageService.setNewLangPrimary(
    ...
    fun updateBatch() {
        ...
        val batchResponsePage =
            landingPageService.updateBatch(
    ...
    fun updateFolder() {
        ...
        val contentFolder =
            landingPageService.updateFolder(
    ...
    fun updateFoldersBatch() {
        ...
        val batchResponseContentFolder =
            landingPageService.updateFoldersBatch(
    ...
    fun updateLanguages() {
        ...
        landingPageService.updateLanguages(
