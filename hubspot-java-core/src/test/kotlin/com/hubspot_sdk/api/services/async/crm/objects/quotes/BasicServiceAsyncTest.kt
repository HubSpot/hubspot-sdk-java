...
internal class BasicServiceAsyncTest {
    ...
    fun create() {
        ...
        val basicServiceAsync = client.crm().objects().quotes().basic()

        val batchResponseSimplePublicObjectFuture =
            basicServiceAsync.create(
