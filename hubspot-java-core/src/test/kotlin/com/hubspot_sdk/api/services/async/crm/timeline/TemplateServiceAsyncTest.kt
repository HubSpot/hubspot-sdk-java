...
internal class TemplateServiceAsyncTest {
    ...
    fun create() {
        val client =
            HubspotOkHttpClientAsync.builder()
                ...
                .build()
        val templateServiceAsync = client.crm().timeline().templates()

        val timelineEventTemplateFuture =
        ...
        val timelineEventTemplate = timelineEventTemplateFuture.get()
    ...
    fun list() {
        ...
        val collectionResponseTimelineEventTemplateNoPagingFuture = templateServiceAsync.list(0)

        val collectionResponseTimelineEventTemplateNoPaging =
            collectionResponseTimelineEventTemplateNoPagingFuture.get()
