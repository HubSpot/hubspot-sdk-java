...
internal class BatchResponseSimplePublicObjectWithErrorsTest {

    @Test
    fun create() {
        val batchResponseSimplePublicObjectWithErrors =
            BatchResponseSimplePublicObjectWithErrors.builder()
                ...
                .status(BatchResponseSimplePublicObjectWithErrors.Status.CANCELED)
                .addError(
                ...
                .links(
                    BatchResponseSimplePublicObjectWithErrors.Links.builder()
                        .putAdditionalProperty("foo", JsonValue.from("string"))
                        .build()
                )
                .numErrors(0)
        ...
        assertThat(batchResponseSimplePublicObjectWithErrors.completedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(batchResponseSimplePublicObjectWithErrors.results())
            .containsExactly(
                SimplePublicObject.builder()
                    .id("id")
                    .archived(true)
        ...
        assertThat(batchResponseSimplePublicObjectWithErrors.startedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(batchResponseSimplePublicObjectWithErrors.status())
            .isEqualTo(BatchResponseSimplePublicObjectWithErrors.Status.CANCELED)
        assertThat(batchResponseSimplePublicObjectWithErrors.errors().getOrNull())
            .containsExactly(
                StandardError.builder()
                    .category("category")
                    .context(
        ...
        assertThat(batchResponseSimplePublicObjectWithErrors.links())
            .contains(
                BatchResponseSimplePublicObjectWithErrors.Links.builder()
                    .putAdditionalProperty("foo", JsonValue.from("string"))
                    .build()
            )
        assertThat(batchResponseSimplePublicObjectWithErrors.numErrors()).contains(0)
        assertThat(batchResponseSimplePublicObjectWithErrors.requestedAt())
    ...
    fun roundtrip() {
        ...
        val roundtrippedBatchResponseSimplePublicObjectWithErrors =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(batchResponseSimplePublicObjectWithErrors),
                jacksonTypeRef<BatchResponseSimplePublicObjectWithErrors>(),
            )

        assertThat(roundtrippedBatchResponseSimplePublicObjectWithErrors)
            .isEqualTo(batchResponseSimplePublicObjectWithErrors)
    }
}
