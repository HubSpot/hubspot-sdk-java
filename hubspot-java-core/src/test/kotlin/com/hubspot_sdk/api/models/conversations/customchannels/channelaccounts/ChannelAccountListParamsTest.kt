...
internal class ChannelAccountListParamsTest {
    ...
    fun create() {
        ChannelAccountListParams.builder()
            ...
            .archived(true)
            .defaultPageLength(0)
            .addDeliveryIdentifierType(
                ChannelAccountListParams.DeliveryIdentifierType.HS_EMAIL_ADDRESS
            )
        ...
        assertThat(queryParams)
            .isEqualTo(
                QueryParams.builder()
                    ...
                    .put("deliveryIdentifierType", listOf("HS_EMAIL_ADDRESS").joinToString(","))
