...
import com.hubspot_sdk.api.models.cms.mediabridge.Option1
...
internal class BatchResponsePropertyTest {
    ...
    fun create() {
        ...
        assertThat(batchResponseProperty.errors().getOrNull())
            .containsExactly(
                StandardError.builder()
                    .category("category")
                    .context(
        ...
        assertThat(batchResponseProperty.numErrors()).contains(0)
