...
internal class WebhookGetJournalEarliestParamsTest {
    ...
    @Test
    fun queryParams() {
        val params = WebhookGetJournalEarliestParams.builder().installPortalId(0).build()
    ...
    fun queryParamsWithoutOptionalFields() {
        val params = WebhookGetJournalEarliestParams.builder().build()
