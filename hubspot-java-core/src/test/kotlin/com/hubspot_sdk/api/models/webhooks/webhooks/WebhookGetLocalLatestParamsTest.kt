...
internal class WebhookGetLocalLatestParamsTest {
    ...
    @Test
    fun queryParams() {
        val params = WebhookGetLocalLatestParams.builder().installPortalId(0).build()
    ...
    fun queryParamsWithoutOptionalFields() {
        val params = WebhookGetLocalLatestParams.builder().build()
