...
internal class WebhookGetNextJournalByOffsetParamsTest {

    @Test
    fun create() {
        WebhookGetNextJournalByOffsetParams.builder().offset("offset").installPortalId(0).build()
    }

    @Test
    fun pathParams() {
        val params = WebhookGetNextJournalByOffsetParams.builder().offset("offset").build()
