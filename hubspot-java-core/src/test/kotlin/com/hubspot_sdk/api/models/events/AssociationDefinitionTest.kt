...
internal class AssociationDefinitionTest {
    ...
    fun create() {
        ...
        assertThat(associationDefinition.isDefault()).isEqualTo(true)
        ...
        assertThat(associationDefinition.readOnly()).isEqualTo(true)
        ...
        assertThat(associationDefinition.hiddenReason())
            .contains(AssociationDefinition.HiddenReason.DEFAULT)
