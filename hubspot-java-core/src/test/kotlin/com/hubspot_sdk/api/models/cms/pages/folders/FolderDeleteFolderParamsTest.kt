...
internal class FolderDeleteFolderParamsTest {
    ...
    @Test
    fun pathParams() {
        val params = FolderDeleteFolderParams.builder().objectId("objectId").build()
    ...
    @Test
    fun queryParams() {
        val params = FolderDeleteFolderParams.builder().objectId("objectId").archived(true).build()
