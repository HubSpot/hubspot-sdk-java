...
internal class ApiContactFlowTest {
    ...
    fun create() {
        ...
        assertThat(apiContactFlow.id()).isEqualTo("id")
        assertThat(apiContactFlow.actions())
            .containsExactly(
                ApiContactFlow.Action.ofApiStaticBranch(
                    ApiStaticBranchAction.builder()
                        .actionId("1")
                        .inputValue(
                            ApiActionDataValue.builder()
        ...
        assertThat(apiContactFlow.blockedDates())
            .containsExactly(
                ApiBlockedDate.builder()
                    .dayOfMonth(0)
                    .month(ApiBlockedDate.Month.JANUARY)
        ...
        assertThat(apiContactFlow.canEnrollFromSalesforce()).isEqualTo(true)
        assertThat(apiContactFlow.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(apiContactFlow.crmObjectCreationStatus())
            .isEqualTo(ApiContactFlow.CrmObjectCreationStatus.PENDING)
        assertThat(apiContactFlow.customProperties())
            .isEqualTo(
                ApiContactFlow.CustomProperties.builder()
                    .putAdditionalProperty("foo", JsonValue.from("string"))
                    .build()
            )
        assertThat(apiContactFlow.dataSources())
            .containsExactly(
                ApiContactFlow.DataSource.ofApiAssociation(
                    ApiAssociationDataSource.builder()
                        .associationCategory(
                            ApiAssociationDataSource.AssociationCategory.HUBSPOT_DEFINED
                        )
        ...
        assertThat(apiContactFlow.flowType()).isEqualTo(ApiContactFlow.FlowType.WORKFLOW)
        assertThat(apiContactFlow.isEnabled()).isEqualTo(true)
        assertThat(apiContactFlow.nextAvailableActionId()).isEqualTo("nextAvailableActionId")
        assertThat(apiContactFlow.objectTypeId()).isEqualTo("objectTypeId")
        assertThat(apiContactFlow.revisionId()).isEqualTo("revisionId")
        assertThat(apiContactFlow.suppressionListIds()).containsExactly(0)
        assertThat(apiContactFlow.timeWindows())
            .containsExactly(
                ApiTimeWindow.builder()
                    .day(ApiTimeWindow.Day.MONDAY)
                    .endTime(ApiTimeOfDay.builder().hour(0).minute(0).build())
        ...
        assertThat(apiContactFlow.type()).isEqualTo(ApiContactFlow.Type.CONTACT_FLOW)
        assertThat(apiContactFlow.updatedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(apiContactFlow.description()).contains("description")
        assertThat(apiContactFlow.enrollmentCriteria())
            .contains(
                ApiContactFlow.EnrollmentCriteria.ofApiListBased(
                    ApiListBasedEnrollmentCriteria.builder()
                        .listFilterBranch(
                            PublicOrFilterBranch.builder()
                                .addFilterBranch(
        ...
        assertThat(apiContactFlow.enrollmentSchedule())
            .contains(
                ApiContactFlow.EnrollmentSchedule.ofApiDaily(
                    ApiDailyEnrollmentSchedule.builder()
                        .timeOfDay(ApiTimeOfDay.builder().hour(0).minute(0).build())
                        .type(ApiDailyEnrollmentSchedule.Type.DAILY)
                        .build()
        ...
        assertThat(apiContactFlow.eventAnchor())
            .contains(
                ApiContactFlow.EventAnchor.ofApiContactProperty(
                    ApiContactPropertyAnchor.builder()
                        .contactProperty("example_date_property")
                        .type(ApiContactPropertyAnchor.Type.CONTACT_PROPERTY_ANCHOR)
                        .build()
        ...
        assertThat(apiContactFlow.goalFilterBranch())
            .contains(
                ApiContactFlow.GoalFilterBranch.ofPublicOr(
                    PublicOrFilterBranch.builder()
                        .filterBranches(listOf())
                        .filterBranchOperator("filterBranchOperator")
                        .filterBranchType(PublicOrFilterBranch.FilterBranchType.OR)
        ...
        assertThat(apiContactFlow.name()).contains("name")
        assertThat(apiContactFlow.startActionId()).contains("startActionId")
        assertThat(apiContactFlow.unEnrollmentSetting())
            .contains(
                ApiUnEnrollmentSetting.builder()
                    .addFlowId("string")
                    .type(ApiUnEnrollmentSetting.Type.ALL)
        ...
        assertThat(apiContactFlow.uuid()).contains("uuid")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedApiContactFlow =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(apiContactFlow),
                jacksonTypeRef<ApiContactFlow>(),
            )

        assertThat(roundtrippedApiContactFlow).isEqualTo(apiContactFlow)
    }
}
