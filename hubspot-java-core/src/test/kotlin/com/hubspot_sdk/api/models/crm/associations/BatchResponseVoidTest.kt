...
internal class BatchResponseVoidTest {

    @Test
    fun create() {
        val batchResponseVoid =
            BatchResponseVoid.builder()
                ...
                .links(
                    BatchResponseVoid.Links.builder()
                        .putAdditionalProperty("foo", JsonValue.from("string"))
                        .build()
                )
                .numErrors(0)
        ...
        assertThat(batchResponseVoid.completedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(batchResponseVoid.results())
        ...
        assertThat(batchResponseVoid.numErrors()).contains(0)
        assertThat(batchResponseVoid.requestedAt())
    ...
    fun roundtrip() {
        ...
        val roundtrippedBatchResponseVoid =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(batchResponseVoid),
                jacksonTypeRef<BatchResponseVoid>(),
            )

        assertThat(roundtrippedBatchResponseVoid).isEqualTo(batchResponseVoid)
    }
}
