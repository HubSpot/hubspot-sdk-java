...
internal class WebhookGetJournalLatestParamsTest {
    ...
    @Test
    fun queryParams() {
        val params = WebhookGetJournalLatestParams.builder().installPortalId(0).build()
    ...
    fun queryParamsWithoutOptionalFields() {
        val params = WebhookGetJournalLatestParams.builder().build()
