...
internal class WebhookGetLatestLocalJournalParamsTest {
    ...
    @Test
    fun queryParams() {
        val params = WebhookGetLatestLocalJournalParams.builder().installPortalId(0).build()
    ...
    fun queryParamsWithoutOptionalFields() {
        val params = WebhookGetLatestLocalJournalParams.builder().build()
