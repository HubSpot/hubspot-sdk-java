...
internal class ApiErrorTest {
    ...
    fun create() {
        ...
        assertThat(apiError.category()).isEqualTo("VALIDATION_ERROR")
        assertThat(apiError.correlationId()).isEqualTo("aeb5f871-7f07-4993-9211-075dc63e7cbf")
        assertThat(apiError.message())
            .isEqualTo("Invalid input (details will vary based on the error)")
        assertThat(apiError.context())
            .contains(
                ApiError.Context.builder()
                    .putAdditionalProperty("0", JsonValue.from(listOf("string")))
                    .putAdditionalProperty("1", JsonValue.from(listOf("string")))
        ...
        assertThat(apiError.errors().getOrNull())
            .containsExactly(
                ErrorDetail.builder()
                    .message("message")
                    .code("code")
        ...
        assertThat(apiError.subCategory()).contains("subCategory")
    }
