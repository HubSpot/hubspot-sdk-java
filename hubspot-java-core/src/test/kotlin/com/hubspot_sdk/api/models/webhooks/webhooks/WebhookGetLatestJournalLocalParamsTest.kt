...
internal class WebhookGetLatestJournalLocalParamsTest {
    ...
    @Test
    fun queryParams() {
        val params = WebhookGetLatestJournalLocalParams.builder().installPortalId(0).build()
    ...
    fun queryParamsWithoutOptionalFields() {
        val params = WebhookGetLatestJournalLocalParams.builder().build()
