...
internal class OccurrenceListParamsTest {

    @Test
    fun create() {
        OccurrenceListParams.builder()
            .addId("string")
            .after("after")
            .before("before")
            .eventType("eventType")
            ...
            .objectId(0L)
            .objectProperty(
                OccurrenceListParams.ObjectProperty.builder()
            ...
            .addProperty("string")
            .property(
                OccurrenceListParams.Property.builder()
                    .propname(JsonValue.from(mapOf<String, Any>()))
                    .build()
            )
            .addSort("string")
    ...
    fun queryParamsWithoutOptionalFields() {
        val params = OccurrenceListParams.builder().build()
