...
internal class BatchResponsePublicAssociationDefinitionUserConfigurationWithErrorsTest {

    @Test
    fun create() {
        val batchResponsePublicAssociationDefinitionUserConfigurationWithErrors =
            BatchResponsePublicAssociationDefinitionUserConfigurationWithErrors.builder()
                ...
                .status(
                    BatchResponsePublicAssociationDefinitionUserConfigurationWithErrors.Status
                        .CANCELED
                )
                .addError(
                ...
                .links(
                    BatchResponsePublicAssociationDefinitionUserConfigurationWithErrors.Links
                        .builder()
                        .putAdditionalProperty("foo", JsonValue.from("string"))
                        .build()
                )
        ...
        assertThat(batchResponsePublicAssociationDefinitionUserConfigurationWithErrors.results())
            .containsExactly(
                PublicAssociationDefinitionUserConfiguration.builder()
        ...
        assertThat(batchResponsePublicAssociationDefinitionUserConfigurationWithErrors.startedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(batchResponsePublicAssociationDefinitionUserConfigurationWithErrors.status())
            .isEqualTo(
                BatchResponsePublicAssociationDefinitionUserConfigurationWithErrors.Status.CANCELED
            )
        assertThat(
        ...
        assertThat(batchResponsePublicAssociationDefinitionUserConfigurationWithErrors.links())
            .contains(
                BatchResponsePublicAssociationDefinitionUserConfigurationWithErrors.Links.builder()
                    .putAdditionalProperty("foo", JsonValue.from("string"))
                    .build()
            )
        assertThat(batchResponsePublicAssociationDefinitionUserConfigurationWithErrors.numErrors())
            .contains(0)
        assertThat(
    ...
    fun roundtrip() {
        ...
        val roundtrippedBatchResponsePublicAssociationDefinitionUserConfigurationWithErrors =
        ...
        assertThat(roundtrippedBatchResponsePublicAssociationDefinitionUserConfigurationWithErrors)
            .isEqualTo(batchResponsePublicAssociationDefinitionUserConfigurationWithErrors)
    }
}
