...
internal class WebhookGetLocalJournalLatestParamsTest {
    ...
    @Test
    fun queryParams() {
        val params = WebhookGetLocalJournalLatestParams.builder().installPortalId(0).build()
    ...
    fun queryParamsWithoutOptionalFields() {
        val params = WebhookGetLocalJournalLatestParams.builder().build()
