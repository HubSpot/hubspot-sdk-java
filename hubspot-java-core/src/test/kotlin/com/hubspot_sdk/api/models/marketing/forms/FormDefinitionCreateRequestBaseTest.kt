...
internal class FormDefinitionCreateRequestBaseTest {

    @Test
    fun create() {
        val formDefinitionCreateRequestBase =
        ...
        assertThat(formDefinitionCreateRequestBase.archived()).isEqualTo(true)
        assertThat(formDefinitionCreateRequestBase.configuration())
            .isEqualTo(
                HubSpotFormConfiguration.builder()
                    .allowLinkToResetKnownValues(true)
                    .archivable(true)
        ...
        assertThat(formDefinitionCreateRequestBase.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(formDefinitionCreateRequestBase.displayOptions())
            .isEqualTo(
                FormDisplayOptions.builder()
                    .renderRawHtml(true)
                    .style(
        ...
        assertThat(formDefinitionCreateRequestBase.fieldGroups())
            .containsExactly(
                FieldGroup.builder()
                    .addField(
                        EmailField.builder()
        ...
        assertThat(formDefinitionCreateRequestBase.formType())
            .isEqualTo(FormDefinitionCreateRequestBase.FormType.HUBSPOT)
        assertThat(formDefinitionCreateRequestBase.legalConsentOptions())
            .isEqualTo(
                FormDefinitionCreateRequestBase.LegalConsentOptions.ofNone(
                    LegalConsentOptionsNone.builder()
                        .type(LegalConsentOptionsNone.Type.NONE)
                        .build()
                )
            )
        assertThat(formDefinitionCreateRequestBase.name()).isEqualTo("name")
        assertThat(formDefinitionCreateRequestBase.updatedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(formDefinitionCreateRequestBase.archivedAt())
    ...
    fun roundtrip() {
        ...
        val roundtrippedFormDefinitionCreateRequestBase =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(formDefinitionCreateRequestBase),
                jacksonTypeRef<FormDefinitionCreateRequestBase>(),
            )

        assertThat(roundtrippedFormDefinitionCreateRequestBase)
            .isEqualTo(formDefinitionCreateRequestBase)
    }
}
