...
internal class PublicUserUpdateTest {
    ...
    fun create() {
        ...
        assertThat(publicUserUpdate.primaryTeamId()).contains("101")
        assertThat(publicUserUpdate.roleId()).contains("100")
        assertThat(publicUserUpdate.secondaryTeamIds().getOrNull()).containsExactly("102")
    }
