...
internal class CollectionResponseWithTotalPageForwardPagingTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedCollectionResponseWithTotalPageForwardPaging =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(collectionResponseWithTotalPageForwardPaging),
                jacksonTypeRef<CollectionResponseWithTotalPageForwardPaging>(),
            )

        assertThat(roundtrippedCollectionResponseWithTotalPageForwardPaging)
            .isEqualTo(collectionResponseWithTotalPageForwardPaging)
    }
}
