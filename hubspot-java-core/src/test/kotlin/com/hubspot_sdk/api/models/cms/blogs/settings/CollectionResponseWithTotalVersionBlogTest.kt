...
internal class CollectionResponseWithTotalVersionBlogTest {

    @Test
    fun create() {
        val collectionResponseWithTotalVersionBlog =
            CollectionResponseWithTotalVersionBlog.builder()
                .addResult(
                    VersionBlog.builder()
                        .id("id")
                        .object_(
        ...
        assertThat(collectionResponseWithTotalVersionBlog.results())
            .containsExactly(
                VersionBlog.builder()
                    .id("id")
                    .object_(
    ...
    fun roundtrip() {
        ...
        val roundtrippedCollectionResponseWithTotalVersionBlog =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(collectionResponseWithTotalVersionBlog),
                jacksonTypeRef<CollectionResponseWithTotalVersionBlog>(),
            )

        assertThat(roundtrippedCollectionResponseWithTotalVersionBlog)
            .isEqualTo(collectionResponseWithTotalVersionBlog)
    }
}
