...
internal class CollectionResponseWithTotalPublicEmailForwardPagingTest {

    @Test
    fun create() {
        val collectionResponseWithTotalPublicEmailForwardPaging =
            CollectionResponseWithTotalPublicEmailForwardPaging.builder()
                .addResult(
                    PublicEmail.builder()
                        .id("38175169118")
                        .content(
        ...
        assertThat(collectionResponseWithTotalPublicEmailForwardPaging.results())
            .containsExactly(
                PublicEmail.builder()
                    .id("38175169118")
                    .content(
        ...
        assertThat(collectionResponseWithTotalPublicEmailForwardPaging.total()).isEqualTo(0)
        assertThat(collectionResponseWithTotalPublicEmailForwardPaging.paging())
            .contains(
    ...
    fun roundtrip() {
        ...
        val roundtrippedCollectionResponseWithTotalPublicEmailForwardPaging =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(collectionResponseWithTotalPublicEmailForwardPaging),
                jacksonTypeRef<CollectionResponseWithTotalPublicEmailForwardPaging>(),
            )

        assertThat(roundtrippedCollectionResponseWithTotalPublicEmailForwardPaging)
            .isEqualTo(collectionResponseWithTotalPublicEmailForwardPaging)
    }
}
