...
internal class BatchInputBlogPostTest {

    @Test
    fun create() {
        val batchInputBlogPost =
        ...
        assertThat(batchInputBlogPost.inputs())
            .containsExactly(
                BlogPost.builder()
                    .id("id")
                    .abStatus(BlogPost.AbStatus.MASTER)
    ...
    fun roundtrip() {
        ...
        val roundtrippedBatchInputBlogPost =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(batchInputBlogPost),
                jacksonTypeRef<BatchInputBlogPost>(),
            )

        assertThat(roundtrippedBatchInputBlogPost).isEqualTo(batchInputBlogPost)
    }
}
