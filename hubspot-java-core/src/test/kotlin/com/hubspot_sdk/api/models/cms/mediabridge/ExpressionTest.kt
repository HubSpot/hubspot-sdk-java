    ...
    fun ofBooleanPropertyVariable() {
        val booleanPropertyVariable =
            BooleanPropertyVariable.builder()
                ...
                .addInput(
                    BooleanPropertyVariable.Input.builder()
                        .putAdditionalProperty("foo", JsonValue.from("bar"))
                        .build()
                )
                .propertyName("propertyName")
    ...
    fun ofNumberPropertyVariable() {
        val numberPropertyVariable =
            NumberPropertyVariable.builder()
                ...
                .addInput(
                    NumberPropertyVariable.Input.builder()
                        .putAdditionalProperty("foo", JsonValue.from("bar"))
                        .build()
                )
                .propertyName("propertyName")
    ...
    fun ofNumberTargetPropertyVariable() {
        val numberTargetPropertyVariable =
            NumberTargetPropertyVariable.builder()
                ...
                .addInput(
                    NumberTargetPropertyVariable.Input.builder()
                        .putAdditionalProperty("foo", JsonValue.from("bar"))
                        .build()
                )
                .propertyName("propertyName")
    ...
    fun ofRoundDownNumbers() {
        val roundDownNumbers =
            RoundDownNumbers.builder()
                ...
                .addInput(
                    RoundDownNumbers.Input.builder()
                        .putAdditionalProperty("foo", JsonValue.from("bar"))
                        .build()
                )
                .propertyName("propertyName")
    ...
    fun ofFetchCurrencyDecimalPlaces() {
        val fetchCurrencyDecimalPlaces =
            FetchCurrencyDecimalPlaces.builder()
                ...
                .addInput(
                    FetchCurrencyDecimalPlaces.Input.builder()
                        .putAdditionalProperty("foo", JsonValue.from("bar"))
                        .build()
                )
                .propertyName("propertyName")
    ...
    fun ofPipelineProbability() {
        val pipelineProbability =
            PipelineProbability.builder()
                ...
                .addInput(
                    PipelineProbability.Input.builder()
                        .putAdditionalProperty("foo", JsonValue.from("bar"))
                        .build()
                )
                .propertyName("propertyName")
    ...
    fun ofIsPipelineStageClosed() {
        val isPipelineStageClosed =
            IsPipelineStageClosed.builder()
                ...
                .addInput(
                    IsPipelineStageClosed.Input.builder()
                        .putAdditionalProperty("foo", JsonValue.from("bar"))
                        .build()
                )
                .propertyName("propertyName")
    ...
    fun ofYear() {
        val year =
            Year.builder()
                ...
                .addInput(
                    Year.Input.builder().putAdditionalProperty("foo", JsonValue.from("bar")).build()
                )
                .propertyName("propertyName")
                .value(0.0)
                .build()
    ...
    fun ofOr() {
        val or =
            Or.builder()
                ...
                .addInput(
                    Or.Input.builder().putAdditionalProperty("foo", JsonValue.from("bar")).build()
                )
                .propertyName("propertyName")
                .value(true)
                .build()
    ...
    fun ofExtractMostRecentEmailReplyText() {
        val extractMostRecentEmailReplyText =
            ExtractMostRecentEmailReplyText.builder()
                ...
                .addInput(
                    ExtractMostRecentEmailReplyText.Input.builder()
                        .putAdditionalProperty("foo", JsonValue.from("bar"))
                        .build()
                )
                .propertyName("propertyName")
    ...
    fun ofIsEngagementType() {
        val isEngagementType =
            IsEngagementType.builder()
                ...
                .addInput(
                    IsEngagementType.Input.builder()
                        .putAdditionalProperty("foo", JsonValue.from("bar"))
                        .build()
                )
                .propertyName("propertyName")
    ...
    fun ofAddTime() {
        val addTime =
            AddTime.builder()
                ...
                .stringToCheck(
                    AddTime.StringToCheck.builder()
                        .putAdditionalProperty("foo", JsonValue.from("bar"))
                        .build()
                )
                .addInput(
                    AddTime.Input.builder()
                        .putAdditionalProperty("foo", JsonValue.from("bar"))
                        .build()
                )
                .propertyName("propertyName")
