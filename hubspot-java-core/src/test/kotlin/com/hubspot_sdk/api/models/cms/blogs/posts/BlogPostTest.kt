...
internal class BlogPostTest {
    ...
    fun create() {
        ...
        assertThat(blogPost.currentState()).isEqualTo(BlogPost.CurrentState.AUTOMATED)
        ...
        assertThat(blogPost.language()).isEqualTo(BlogPost.Language.AF)
                            ...
                            mapOf(
                                ...
                                "styles" to
                                    mapOf(
                                        ...
                                        "backgroundGradient" to
                                            mapOf(
                                                "angle" to mapOf("units" to "units", "value" to 0),
                                                "colors" to
                                                    listOf(
                                                        mapOf(
                                                            "color" to
