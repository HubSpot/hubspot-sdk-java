...
internal class PublicEmailTest {
    ...
    fun create() {
        ...
        assertThat(publicEmail.id()).isEqualTo("38175169118")
        ...
        assertThat(publicEmail.name()).isEqualTo("My subject")
        assertThat(publicEmail.sendOnPublish()).isEqualTo(true)
        assertThat(publicEmail.state()).isEqualTo(PublicEmail.State.DRAFT)
        assertThat(publicEmail.subcategory()).isEqualTo("batch")
        assertThat(publicEmail.subject()).isEqualTo("My subject")
        ...
        assertThat(publicEmail.clonedFrom()).contains("3817552341")
        ...
        assertThat(publicEmail.isAb()).contains(true)
