...
internal class ListFetchResponseTest {

    @Test
    fun create() {
        val listFetchResponse =
            ListFetchResponse.builder()
                .list(
        ...
        assertThat(listFetchResponse.list())
            .isEqualTo(
                PublicObjectList.builder()
                    .listId("listId")
                    .listVersion(0)
    ...
    fun roundtrip() {
        ...
        val roundtrippedListFetchResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(listFetchResponse),
                jacksonTypeRef<ListFetchResponse>(),
            )

        assertThat(roundtrippedListFetchResponse).isEqualTo(listFetchResponse)
    }
}
