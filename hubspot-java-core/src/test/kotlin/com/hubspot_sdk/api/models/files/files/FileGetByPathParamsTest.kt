...
internal class FileGetByPathParamsTest {
    ...
    @Test
    fun pathParams() {
        val params = FileGetByPathParams.builder().path("path").build()
    ...
    @Test
    fun queryParams() {
        val params = FileGetByPathParams.builder().path("path").addProperty("string").build()
