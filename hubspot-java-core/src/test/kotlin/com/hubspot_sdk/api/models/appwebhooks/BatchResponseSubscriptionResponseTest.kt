    ...
    fun create() {
        val batchResponseSubscriptionResponse =
            BatchResponseSubscriptionResponse.builder()
                ...
                .status(BatchResponseSubscriptionResponse.Status.CANCELED)
                .addError(
        ...
        assertThat(batchResponseSubscriptionResponse.status())
            .isEqualTo(BatchResponseSubscriptionResponse.Status.CANCELED)
        assertThat(batchResponseSubscriptionResponse.errors().getOrNull())
            .containsExactly(
                StandardError.builder()
                    .category("category")
                    .context(
        ...
        assertThat(batchResponseSubscriptionResponse.numErrors()).contains(0)
