...
internal class WebhookSubscriptionGetLocalJournalNextByOffsetParamsTest {
    ...
    fun pathParams() {
        val params =
            WebhookSubscriptionGetLocalJournalNextByOffsetParams.builder().offset("offset").build()
