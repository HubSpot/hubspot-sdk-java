...
internal class PublicChannelAccountTest {
    ...
    fun create() {
        ...
        assertThat(publicChannelAccount.id()).contains("id")
        assertThat(publicChannelAccount.active()).contains(true)
        assertThat(publicChannelAccount.archivedAt())
            .contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(publicChannelAccount.authorized()).contains(true)
        assertThat(publicChannelAccount.channelId()).contains("channelId")
        ...
        assertThat(publicChannelAccount.inboxId()).contains("inboxId")
        assertThat(publicChannelAccount.name()).contains("name")
    }
