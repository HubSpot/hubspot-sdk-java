...
internal class WebhookGetLocalJournalEarliestParamsTest {
    ...
    @Test
    fun queryParams() {
        val params = WebhookGetLocalJournalEarliestParams.builder().installPortalId(0).build()
    ...
    fun queryParamsWithoutOptionalFields() {
        val params = WebhookGetLocalJournalEarliestParams.builder().build()
