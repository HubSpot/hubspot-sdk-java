...
internal class SchemaListParamsTest {
    ...
    @Test
    fun create() {
        SchemaListParams.builder().appId(0).archived(true).build()
    }

    @Test
    fun pathParams() {
        val params = SchemaListParams.builder().appId(0).build()
    ...
    @Test
    fun queryParams() {
        val params = SchemaListParams.builder().appId(0).archived(true).build()
