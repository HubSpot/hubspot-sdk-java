...
internal class CollectionResponseWithTotalVersionPageTest {

    @Test
    fun create() {
        val collectionResponseWithTotalVersionPage =
            CollectionResponseWithTotalVersionPage.builder()
                .addResult(
                    VersionPage.builder()
                        .id("id")
                        .object_(
        ...
        assertThat(collectionResponseWithTotalVersionPage.results())
            .containsExactly(
                VersionPage.builder()
                    .id("id")
                    .object_(
    ...
    fun roundtrip() {
        ...
        val roundtrippedCollectionResponseWithTotalVersionPage =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(collectionResponseWithTotalVersionPage),
                jacksonTypeRef<CollectionResponseWithTotalVersionPage>(),
            )

        assertThat(roundtrippedCollectionResponseWithTotalVersionPage)
            .isEqualTo(collectionResponseWithTotalVersionPage)
    }
}
