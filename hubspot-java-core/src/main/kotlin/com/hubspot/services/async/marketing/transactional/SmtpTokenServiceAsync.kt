...
import com.hubspot.models.marketing.transactional.smtptokens.SmtpTokenListPageAsync
...
interface SmtpTokenServiceAsync {
    ...
    interface WithRawResponse {
         ...
         * is otherwise the same as [SmtpTokenServiceAsync.create].
         */
        fun create(
            params: SmtpTokenCreateParams
         ...
         * is otherwise the same as [SmtpTokenServiceAsync.list].
         */
         ...
         * the same as [SmtpTokenServiceAsync.resetPassword].
         */
