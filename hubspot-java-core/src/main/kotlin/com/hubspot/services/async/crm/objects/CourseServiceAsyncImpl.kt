...
import com.hubspot.models.crm.objects.courses.CourseListPageAsync
...
import com.hubspot.services.async.crm.objects.courses.BatchServiceAsync
import com.hubspot.services.async.crm.objects.courses.BatchServiceAsyncImpl
import java.util.concurrent.CompletableFuture
import java.util.function.Consumer
import kotlin.jvm.optionals.getOrNull

class CourseServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    CourseServiceAsync {

    private val withRawResponse: CourseServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    private val batch: BatchServiceAsync by lazy { BatchServiceAsyncImpl(clientOptions) }

    override fun withRawResponse(): CourseServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CourseServiceAsync =
        CourseServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            CourseServiceAsyncImpl.WithRawResponseImpl(
                ...
                .thenApply { response ->
                    errorHandler.handle(response).parseable {
                        response
                            ...
                            .let {
                                CourseListPageAsync.builder()
                                    .service(CourseServiceAsyncImpl(clientOptions))
