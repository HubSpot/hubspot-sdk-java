...
import com.hubspot.models.crm.objects.tickets.TicketCreateParams
import com.hubspot.models.crm.objects.tickets.TicketDeleteParams
import com.hubspot.models.crm.objects.tickets.TicketGetParams
import com.hubspot.models.crm.objects.tickets.TicketListPageAsync
import com.hubspot.models.crm.objects.tickets.TicketListParams
import com.hubspot.models.crm.objects.tickets.TicketMergeParams
import com.hubspot.models.crm.objects.tickets.TicketSearchParams
import com.hubspot.models.crm.objects.tickets.TicketUpdateParams
import com.hubspot.services.async.crm.objects.tickets.BatchServiceAsync
...
interface TicketServiceAsync {
     ...
     */
    fun create(params: TicketCreateParams): CompletableFuture<SimplePublicObject> =
    ...
    interface WithRawResponse {
         ...
         * same as [TicketServiceAsync.create].
         */
        fun create(
            params: TicketCreateParams
         ...
         * same as [TicketServiceAsync.list].
         */
         ...
         * otherwise the same as [TicketServiceAsync.merge].
         */
        fun merge(
            params: TicketMergeParams
        ): CompletableFuture<HttpResponseFor<SimplePublicObject>> =
         ...
         * otherwise the same as [TicketServiceAsync.search].
         */
        fun search(
            params: TicketSearchParams
