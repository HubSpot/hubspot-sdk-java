...
import com.hubspot.models.cms.pages.landingpages.LandingPageCloneParams
import com.hubspot.models.cms.pages.landingpages.LandingPageCreateParams
import com.hubspot.models.cms.pages.landingpages.LandingPageDeleteParams
import com.hubspot.models.cms.pages.landingpages.LandingPageGetDraftParams
import com.hubspot.models.cms.pages.landingpages.LandingPageGetParams
import com.hubspot.models.cms.pages.landingpages.LandingPageListPageAsync
import com.hubspot.models.cms.pages.landingpages.LandingPageListParams
import com.hubspot.models.cms.pages.landingpages.LandingPagePushDraftLiveParams
import com.hubspot.models.cms.pages.landingpages.LandingPageResetDraftParams
import com.hubspot.models.cms.pages.landingpages.LandingPageScheduleParams
import com.hubspot.models.cms.pages.landingpages.LandingPageUpdateDraftParams
import com.hubspot.models.cms.pages.landingpages.LandingPageUpdateParams
...
interface LandingPageServiceAsync {
    ...
    fun create(params: LandingPageCreateParams): CompletableFuture<PageData> =
     ...
     */
    fun update(objectId: String, params: LandingPageUpdateParams): CompletableFuture<PageData> =
    ...
    /** @see update */
    fun update(params: LandingPageUpdateParams): CompletableFuture<PageData> =
    ...
    fun clone(params: LandingPageCloneParams): CompletableFuture<PageData> =
    ...
    /** @see get */
    fun get(params: LandingPageGetParams): CompletableFuture<PageData> =
    ...
    /** @see getDraft */
    fun getDraft(params: LandingPageGetDraftParams): CompletableFuture<PageData> =
    ...
    /** @see updateDraft */
    fun updateDraft(params: LandingPageUpdateDraftParams): CompletableFuture<PageData> =
    ...
    interface WithRawResponse {
         ...
         */
        fun create(params: LandingPageCreateParams): CompletableFuture<HttpResponseFor<PageData>> =
            create(params, RequestOptions.none())
        ...
        /** @see update */
        fun update(params: LandingPageUpdateParams): CompletableFuture<HttpResponseFor<PageData>> =
            update(params, RequestOptions.none())
         ...
         */
        fun clone(params: LandingPageCloneParams): CompletableFuture<HttpResponseFor<PageData>> =
            clone(params, RequestOptions.none())
        ...
        /** @see get */
        fun get(params: LandingPageGetParams): CompletableFuture<HttpResponseFor<PageData>> =
            get(params, RequestOptions.none())
