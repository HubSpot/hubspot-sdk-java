...
interface MeetingServiceAsync {
     ...
     */
    fun create(params: MeetingCreateParams): CompletableFuture<SimplePublicObject> =
    ...
    interface WithRawResponse {
         ...
         * the same as [MeetingServiceAsync.create].
         */
        fun create(
            params: MeetingCreateParams
         ...
         * same as [MeetingServiceAsync.list].
         */
         ...
         * is otherwise the same as [MeetingServiceAsync.delete].
         */
         ...
         * otherwise the same as [MeetingServiceAsync.search].
         */
        fun search(
            params: MeetingSearchParams
