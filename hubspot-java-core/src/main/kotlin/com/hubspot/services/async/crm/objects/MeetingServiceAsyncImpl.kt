...
import com.hubspot.models.crm.objects.meetings.MeetingListPageAsync
...
import com.hubspot.services.async.crm.objects.meetings.BatchServiceAsync
import com.hubspot.services.async.crm.objects.meetings.BatchServiceAsyncImpl
                ...
                .thenApply { response ->
                    errorHandler.handle(response).parseable {
                        response
                            ...
                            .let {
                                MeetingListPageAsync.builder()
                                    .service(MeetingServiceAsyncImpl(clientOptions))
