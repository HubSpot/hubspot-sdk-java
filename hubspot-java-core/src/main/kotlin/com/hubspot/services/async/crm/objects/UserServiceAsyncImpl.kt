...
import com.hubspot.models.crm.objects.users.UserCreateParams
import com.hubspot.models.crm.objects.users.UserDeleteParams
import com.hubspot.models.crm.objects.users.UserGetParams
import com.hubspot.models.crm.objects.users.UserListPageAsync
import com.hubspot.models.crm.objects.users.UserListParams
import com.hubspot.models.crm.objects.users.UserSearchParams
import com.hubspot.models.crm.objects.users.UserUpdateParams
import com.hubspot.services.async.crm.objects.users.BatchServiceAsync
import com.hubspot.services.async.crm.objects.users.BatchServiceAsyncImpl
        ...
        override fun create(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("crm", "objects", "2026-03", "users")
        ...
        override fun update(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("crm", "objects", "2026-03", "users", params._pathParam(0))
                    .body(json(clientOptions.jsonMapper, params._body()))
                    .build()
                    .prepareAsync(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
        ...
        override fun search(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.POST)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("crm", "objects", "2026-03", "users", "search")
                    .body(json(clientOptions.jsonMapper, params._body()))
                    .build()
                    .prepareAsync(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
