...
import com.hubspot.models.crm.objects.notes.NoteListPageAsync
...
import com.hubspot.services.async.crm.objects.notes.BatchServiceAsync
import com.hubspot.services.async.crm.objects.notes.BatchServiceAsyncImpl
                ...
                .thenApply { response ->
                    errorHandler.handle(response).parseable {
                        response
                            ...
                            .let {
                                NoteListPageAsync.builder()
                                    .service(NoteServiceAsyncImpl(clientOptions))
