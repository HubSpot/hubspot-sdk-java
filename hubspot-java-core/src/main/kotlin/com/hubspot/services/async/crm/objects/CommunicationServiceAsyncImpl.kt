...
import com.hubspot.models.crm.objects.communications.CommunicationCreateParams
import com.hubspot.models.crm.objects.communications.CommunicationDeleteParams
import com.hubspot.models.crm.objects.communications.CommunicationGetParams
import com.hubspot.models.crm.objects.communications.CommunicationListPageAsync
import com.hubspot.models.crm.objects.communications.CommunicationListParams
import com.hubspot.models.crm.objects.communications.CommunicationSearchParams
import com.hubspot.models.crm.objects.communications.CommunicationUpdateParams
import com.hubspot.services.async.crm.objects.communications.BatchServiceAsync
import com.hubspot.services.async.crm.objects.communications.BatchServiceAsyncImpl
import java.util.concurrent.CompletableFuture
import java.util.function.Consumer
import kotlin.jvm.optionals.getOrNull

class CommunicationServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    CommunicationServiceAsync {

    private val withRawResponse: CommunicationServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    private val batch: BatchServiceAsync by lazy { BatchServiceAsyncImpl(clientOptions) }

    override fun withRawResponse(): CommunicationServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): CommunicationServiceAsync =
        CommunicationServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            CommunicationServiceAsyncImpl.WithRawResponseImpl(
        ...
        override fun create(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("crm", "objects", "2026-03", "communications")
        ...
        override fun update(
            ...
            checkRequired("communicationId", params.communicationId().getOrNull())
            val request =
                HttpRequest.builder()
                ...
                .thenApply { response ->
                    errorHandler.handle(response).parseable {
                        response
                            ...
                            .let {
                                CommunicationListPageAsync.builder()
                                    .service(CommunicationServiceAsyncImpl(clientOptions))
        ...
        override fun search(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.POST)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("crm", "objects", "2026-03", "communications", "search")
                    .body(json(clientOptions.jsonMapper, params._body()))
                    .build()
                    .prepareAsync(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
