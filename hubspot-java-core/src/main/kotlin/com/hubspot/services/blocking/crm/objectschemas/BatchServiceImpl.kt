...
package com.hubspot.services.blocking.crm.objectschemas
...
import com.hubspot.models.crm.objectschemas.batch.BatchGetParams
...
class BatchServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val getHandler: Handler<CollectionResponseObjectSchemaNoPaging> =
        ...
        override fun get(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("crm-object-schemas", "2026-03", "schemas", "batch", "read")
