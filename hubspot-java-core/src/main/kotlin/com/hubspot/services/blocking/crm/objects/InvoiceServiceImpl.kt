...
import com.hubspot.models.crm.objects.invoices.InvoiceListPage
...
import com.hubspot.services.blocking.crm.objects.invoices.BatchService
import com.hubspot.services.blocking.crm.objects.invoices.BatchServiceImpl
        ...
        override fun update(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("crm", "objects", "2026-03", "invoices", params._pathParam(0))
                    .body(json(clientOptions.jsonMapper, params._body()))
                    .build()
                    .prepare(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
