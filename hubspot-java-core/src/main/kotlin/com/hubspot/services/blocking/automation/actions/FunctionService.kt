...
import com.hubspot.models.automation.actions.CollectionResponsePublicActionFunctionIdentifierNoPaging
import com.hubspot.models.automation.actions.PublicActionFunction
import com.hubspot.models.automation.actions.PublicActionFunctionIdentifier
...
interface FunctionService {
    ...
    interface WithRawResponse {
         ...
         * but is otherwise the same as [FunctionService.delete].
         */
        @MustBeClosed
         ...
         * /automation/actions/2026-03/{appId}/{definitionId}/functions/{functionType}/{functionId}`,
         * but is otherwise the same as [FunctionService.createOrReplace].
         */
        @MustBeClosed
        fun createOrReplace(
            functionId: String,
         ...
         * otherwise the same as [FunctionService.createOrReplaceByFunctionType].
         */
        @MustBeClosed
        fun createOrReplaceByFunctionType(
            functionType: FunctionCreateOrReplaceByFunctionTypeParams.FunctionType,
         ...
         * Returns a raw HTTP response for `delete
         * /automation/actions/2026-03/{appId}/{definitionId}/functions/{functionType}`, but is
         * otherwise the same as [FunctionService.deleteByFunctionType].
         */
        @MustBeClosed
        fun deleteByFunctionType(
            functionType: FunctionDeleteByFunctionTypeParams.FunctionType,
         ...
         * Returns a raw HTTP response for `get
         * /automation/actions/2026-03/{appId}/{definitionId}/functions/{functionType}/{functionId}`,
         * but is otherwise the same as [FunctionService.get].
         */
        @MustBeClosed
        fun get(
            functionId: String,
         ...
         * Returns a raw HTTP response for `get
         * /automation/actions/2026-03/{appId}/{definitionId}/functions/{functionType}`, but is
         * otherwise the same as [FunctionService.getByFunctionType].
         */
        @MustBeClosed
        fun getByFunctionType(
            functionType: FunctionGetByFunctionTypeParams.FunctionType,
