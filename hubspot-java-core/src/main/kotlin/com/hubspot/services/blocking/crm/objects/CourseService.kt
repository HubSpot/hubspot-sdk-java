...
interface CourseService {
     ...
     */
    fun create(params: CourseCreateParams): SimplePublicObject =
    ...
    interface WithRawResponse {
         ...
         * same as [CourseService.create].
         */
        @MustBeClosed
        fun create(params: CourseCreateParams): HttpResponseFor<SimplePublicObject> =
            create(params, RequestOptions.none())
         ...
         * otherwise the same as [CourseService.get].
         */
        @MustBeClosed
         ...
         * otherwise the same as [CourseService.search].
         */
        @MustBeClosed
        fun search(
            params: CourseSearchParams
