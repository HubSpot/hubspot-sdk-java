...
import com.hubspot.models.crm.objects.taxes.TaxCreateParams
import com.hubspot.models.crm.objects.taxes.TaxDeleteParams
import com.hubspot.models.crm.objects.taxes.TaxGetParams
import com.hubspot.models.crm.objects.taxes.TaxListPage
import com.hubspot.models.crm.objects.taxes.TaxListParams
import com.hubspot.models.crm.objects.taxes.TaxSearchParams
import com.hubspot.models.crm.objects.taxes.TaxUpdateParams
import com.hubspot.services.blocking.crm.objects.taxes.BatchService
import com.hubspot.services.blocking.crm.objects.taxes.BatchServiceImpl
import java.util.function.Consumer
import kotlin.jvm.optionals.getOrNull

class TaxServiceImpl internal constructor(private val clientOptions: ClientOptions) : TaxService {

    private val withRawResponse: TaxService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    private val batch: BatchService by lazy { BatchServiceImpl(clientOptions) }

    override fun withRawResponse(): TaxService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): TaxService =
        TaxServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(params: TaxListParams, requestOptions: RequestOptions): TaxListPage =
        // get /crm/objects/2026-03/taxes
        withRawResponse().list(params, requestOptions).parse()

    override fun delete(params: TaxDeleteParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            TaxServiceImpl.WithRawResponseImpl(
        ...
        override fun list(
            ...
            return errorHandler.handle(response).parseable {
                response
                    ...
                    .let {
                        TaxListPage.builder()
                            .service(TaxServiceImpl(clientOptions))
                            .params(params)
                            .response(it)
                            .build()
                    }
        ...
        override fun delete(params: TaxDeleteParams, requestOptions: RequestOptions): HttpResponse {
            // We check here instead of in the params builder because this can be specified
            // positionally or in the params class.
            checkRequired("taxId", params.taxId().getOrNull())
            val request =
        ...
        override fun search(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.POST)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("crm", "objects", "2026-03", "taxes", "search")
                    .body(json(clientOptions.jsonMapper, params._body()))
                    .build()
                    .prepare(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
