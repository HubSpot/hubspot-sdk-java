...
import com.hubspot.models.marketing.campaigns.PublicSpendItem
...
interface SpendService {
    ...
    interface WithRawResponse {
         ...
         * but is otherwise the same as [SpendService.create].
         */
        @MustBeClosed
        fun create(
            campaignGuid: String,
