...
import com.hubspot.models.crm.objects.notes.NoteCreateParams
import com.hubspot.models.crm.objects.notes.NoteDeleteParams
import com.hubspot.models.crm.objects.notes.NoteGetParams
import com.hubspot.models.crm.objects.notes.NoteListPage
import com.hubspot.models.crm.objects.notes.NoteListParams
import com.hubspot.models.crm.objects.notes.NoteSearchParams
import com.hubspot.models.crm.objects.notes.NoteUpdateParams
import com.hubspot.services.blocking.crm.objects.notes.BatchService
import com.hubspot.services.blocking.crm.objects.notes.BatchServiceImpl
...
class NoteServiceImpl internal constructor(private val clientOptions: ClientOptions) : NoteService {
    ...
    override fun delete(params: NoteDeleteParams, requestOptions: RequestOptions) {
        ...
        override fun create(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("crm", "objects", "2026-03", "notes")
        ...
        override fun update(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("crm", "objects", "2026-03", "notes", params._pathParam(0))
                    .body(json(clientOptions.jsonMapper, params._body()))
                    .build()
                    .prepare(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
        ...
        override fun list(
            ...
            return errorHandler.handle(response).parseable {
                response
                    ...
                    .let {
                        NoteListPage.builder()
                            .service(NoteServiceImpl(clientOptions))
                            .params(params)
                            .response(it)
                            .build()
                    }
        ...
        override fun search(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.POST)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("crm", "objects", "2026-03", "notes", "search")
                    .body(json(clientOptions.jsonMapper, params._body()))
                    .build()
                    .prepare(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
