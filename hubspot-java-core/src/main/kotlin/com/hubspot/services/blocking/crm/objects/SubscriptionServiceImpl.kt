...
import com.hubspot.models.crm.objects.subscriptions.SubscriptionCreateParams
import com.hubspot.models.crm.objects.subscriptions.SubscriptionDeleteParams
import com.hubspot.models.crm.objects.subscriptions.SubscriptionGetParams
import com.hubspot.models.crm.objects.subscriptions.SubscriptionListPage
import com.hubspot.models.crm.objects.subscriptions.SubscriptionListParams
import com.hubspot.models.crm.objects.subscriptions.SubscriptionSearchParams
import com.hubspot.models.crm.objects.subscriptions.SubscriptionUpdateParams
import com.hubspot.services.blocking.crm.objects.subscriptions.BatchService
import com.hubspot.services.blocking.crm.objects.subscriptions.BatchServiceImpl
        ...
        override fun create(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("crm", "objects", "2026-03", "subscriptions")
        ...
        override fun search(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.POST)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("crm", "objects", "2026-03", "subscriptions", "search")
                    .body(json(clientOptions.jsonMapper, params._body()))
                    .build()
                    .prepare(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
