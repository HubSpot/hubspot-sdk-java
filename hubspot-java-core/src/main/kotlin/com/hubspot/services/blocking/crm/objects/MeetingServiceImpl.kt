...
import com.hubspot.models.crm.objects.meetings.MeetingCreateParams
import com.hubspot.models.crm.objects.meetings.MeetingDeleteParams
import com.hubspot.models.crm.objects.meetings.MeetingGetParams
import com.hubspot.models.crm.objects.meetings.MeetingListPage
import com.hubspot.models.crm.objects.meetings.MeetingListParams
import com.hubspot.models.crm.objects.meetings.MeetingSearchParams
import com.hubspot.models.crm.objects.meetings.MeetingUpdateParams
import com.hubspot.services.blocking.crm.objects.meetings.BatchService
import com.hubspot.services.blocking.crm.objects.meetings.BatchServiceImpl
...
class MeetingServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun list(params: MeetingListParams, requestOptions: RequestOptions): MeetingListPage =
        // get /crm/objects/2026-03/meetings
        withRawResponse().list(params, requestOptions).parse()

    override fun delete(params: MeetingDeleteParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun create(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("crm", "objects", "2026-03", "meetings")
        ...
        override fun update(
            ...
            checkRequired("meetingId", params.meetingId().getOrNull())
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.PATCH)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("crm", "objects", "2026-03", "meetings", params._pathParam(0))
                    .body(json(clientOptions.jsonMapper, params._body()))
                    .build()
                    .prepare(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
        ...
        override fun list(
            ...
            return errorHandler.handle(response).parseable {
                response
                    ...
                    .let {
                        MeetingListPage.builder()
                            .service(MeetingServiceImpl(clientOptions))
                            .params(params)
                            .response(it)
                            .build()
                    }
        ...
        override fun search(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.POST)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("crm", "objects", "2026-03", "meetings", "search")
                    .body(json(clientOptions.jsonMapper, params._body()))
                    .build()
                    .prepare(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
