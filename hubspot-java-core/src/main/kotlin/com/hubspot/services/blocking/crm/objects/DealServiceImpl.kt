...
import com.hubspot.models.crm.objects.deals.DealCreateParams
import com.hubspot.models.crm.objects.deals.DealDeleteParams
import com.hubspot.models.crm.objects.deals.DealGetParams
import com.hubspot.models.crm.objects.deals.DealListPage
import com.hubspot.models.crm.objects.deals.DealListParams
import com.hubspot.models.crm.objects.deals.DealMergeParams
import com.hubspot.models.crm.objects.deals.DealSearchParams
import com.hubspot.models.crm.objects.deals.DealUpdateParams
import com.hubspot.services.blocking.crm.objects.deals.BatchService
import com.hubspot.services.blocking.crm.objects.deals.BatchServiceImpl
import java.util.function.Consumer
import kotlin.jvm.optionals.getOrNull

class DealServiceImpl internal constructor(private val clientOptions: ClientOptions) : DealService {

    private val withRawResponse: DealService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    private val batch: BatchService by lazy { BatchServiceImpl(clientOptions) }

    override fun withRawResponse(): DealService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): DealService =
        DealServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(params: DealListParams, requestOptions: RequestOptions): DealListPage =
        // get /crm/objects/2026-03/0-3
        withRawResponse().list(params, requestOptions).parse()

    override fun delete(params: DealDeleteParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            DealServiceImpl.WithRawResponseImpl(
        ...
        override fun list(
            ...
            return errorHandler.handle(response).parseable {
                response
                    ...
                    .let {
                        DealListPage.builder()
                            .service(DealServiceImpl(clientOptions))
                            .params(params)
                            .response(it)
                            .build()
                    }
