...
import com.hubspot.models.crm.objects.goaltargets.GoalTargetCreateParams
import com.hubspot.models.crm.objects.goaltargets.GoalTargetDeleteParams
import com.hubspot.models.crm.objects.goaltargets.GoalTargetGetParams
import com.hubspot.models.crm.objects.goaltargets.GoalTargetListPage
import com.hubspot.models.crm.objects.goaltargets.GoalTargetListParams
import com.hubspot.models.crm.objects.goaltargets.GoalTargetSearchParams
import com.hubspot.models.crm.objects.goaltargets.GoalTargetUpdateParams
import com.hubspot.services.blocking.crm.objects.goaltargets.BatchService
import com.hubspot.services.blocking.crm.objects.goaltargets.BatchServiceImpl
import java.util.function.Consumer
import kotlin.jvm.optionals.getOrNull

class GoalTargetServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    GoalTargetService {

    private val withRawResponse: GoalTargetService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    private val batch: BatchService by lazy { BatchServiceImpl(clientOptions) }

    override fun withRawResponse(): GoalTargetService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): GoalTargetService =
        GoalTargetServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun list(
        params: GoalTargetListParams,
        requestOptions: RequestOptions,
    ): GoalTargetListPage =
        // get /crm/objects/2026-03/goal_targets
        withRawResponse().list(params, requestOptions).parse()

    override fun delete(params: GoalTargetDeleteParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            GoalTargetServiceImpl.WithRawResponseImpl(
        ...
        override fun create(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("crm", "objects", "2026-03", "goal_targets")
        ...
        override fun update(
            ...
            checkRequired("goalTargetId", params.goalTargetId().getOrNull())
            val request =
                HttpRequest.builder()
        ...
        override fun list(
            ...
            return errorHandler.handle(response).parseable {
                response
                    ...
                    .let {
                        GoalTargetListPage.builder()
                            .service(GoalTargetServiceImpl(clientOptions))
                            .params(params)
                            .response(it)
                            .build()
                    }
        ...
        override fun search(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.POST)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("crm", "objects", "2026-03", "goal_targets", "search")
                    .body(json(clientOptions.jsonMapper, params._body()))
                    .build()
                    .prepare(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
