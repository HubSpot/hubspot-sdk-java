...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(exchangeRate: ExchangeRate) = apply {
            id = exchangeRate.id
            conversionRate = exchangeRate.conversionRate
            ...
            visibleInUi = exchangeRate.visibleInUi
    ...
    override fun toString() =
        "ExchangeRate{id=$id, conversionRate=$conversionRate, createdAt=$createdAt, effectiveAt=$effectiveAt, fromCurrencyCode=$fromCurrencyCode, toCurrencyCode=$toCurrencyCode, updatedAt=$updatedAt, visibleInUi=$visibleInUi, additionalProperties=$additionalProperties}"
}
