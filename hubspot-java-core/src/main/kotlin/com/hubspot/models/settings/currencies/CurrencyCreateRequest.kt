...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CurrencyCreateRequest].
         *
    ...
    /** A builder for [CurrencyCreateRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(currencyCreateRequest: CurrencyCreateRequest) = apply {
            currencyCode = currencyCreateRequest.currencyCode
            additionalProperties = currencyCreateRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CurrencyCreateRequest].
         *
         ...
         */
        fun build(): CurrencyCreateRequest =
    ...
    fun validate(): CurrencyCreateRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CurrencyCreateRequest &&
    ...
    override fun toString() =
        "CurrencyCreateRequest{currencyCode=$currencyCode, additionalProperties=$additionalProperties}"
}
