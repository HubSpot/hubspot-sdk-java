...
class WebhookGetLocalJournalBatchAfterOffsetParams
private constructor(
    ...
    /** A builder for [WebhookGetLocalJournalBatchAfterOffsetParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            offset = webhookGetLocalJournalBatchAfterOffsetParams.offset
            count = webhookGetLocalJournalBatchAfterOffsetParams.count
            installPortalId = webhookGetLocalJournalBatchAfterOffsetParams.installPortalId
            additionalHeaders =
                webhookGetLocalJournalBatchAfterOffsetParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                webhookGetLocalJournalBatchAfterOffsetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [WebhookGetLocalJournalBatchAfterOffsetParams].
         *
         ...
         */
        fun build(): WebhookGetLocalJournalBatchAfterOffsetParams =
            WebhookGetLocalJournalBatchAfterOffsetParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebhookGetLocalJournalBatchAfterOffsetParams &&
            offset == other.offset &&
            count == other.count &&
    ...
    override fun toString() =
        "WebhookGetLocalJournalBatchAfterOffsetParams{offset=$offset, count=$count, installPortalId=$installPortalId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
