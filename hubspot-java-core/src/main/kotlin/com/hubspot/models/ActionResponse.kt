...
private constructor(
    ...
    ) : this(completedAt, startedAt, status, links, requestedAt, mutableMapOf())
    ...
    /**
     * The current status of the action, with possible values: CANCELED, COMPLETE, PENDING,
     * PROCESSING.
     *
     * @throws HubSpotInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ActionResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(actionResponse: ActionResponse) = apply {
            completedAt = actionResponse.completedAt
            startedAt = actionResponse.startedAt
            status = actionResponse.status
            links = actionResponse.links
            requestedAt = actionResponse.requestedAt
            additionalProperties = actionResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ActionResponse].
         *
    ...
    private val hashCode: Int by lazy {
        Objects.hash(completedAt, startedAt, status, links, requestedAt, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ActionResponse{completedAt=$completedAt, startedAt=$startedAt, status=$status, links=$links, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
