...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [QuickRepliesAttachment].
         *
    ...
    /** A builder for [QuickRepliesAttachment]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(quickRepliesAttachment: QuickRepliesAttachment) = apply {
            quickReplies = quickRepliesAttachment.quickReplies.map { it.toMutableList() }
            type = quickRepliesAttachment.type
            additionalProperties = quickRepliesAttachment.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [QuickRepliesAttachment].
         *
         ...
         */
        fun build(): QuickRepliesAttachment =
    ...
    fun validate(): QuickRepliesAttachment = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is QuickRepliesAttachment &&
            quickReplies == other.quickReplies &&
            type == other.type &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(quickReplies, type, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "QuickRepliesAttachment{quickReplies=$quickReplies, type=$type, additionalProperties=$additionalProperties}"
}
