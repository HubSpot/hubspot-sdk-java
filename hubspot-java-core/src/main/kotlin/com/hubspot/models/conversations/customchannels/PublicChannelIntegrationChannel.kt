...
class PublicChannelIntegrationChannel
...
private constructor(
    ...
    /** A builder for [PublicChannelIntegrationChannel]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicChannelIntegrationChannel: PublicChannelIntegrationChannel) =
            apply {
                id = publicChannelIntegrationChannel.id
                capabilities = publicChannelIntegrationChannel.capabilities
                createdAt = publicChannelIntegrationChannel.createdAt
                name = publicChannelIntegrationChannel.name
                channelAccountConnectionRedirectUrl =
                    publicChannelIntegrationChannel.channelAccountConnectionRedirectUrl
                channelDescription = publicChannelIntegrationChannel.channelDescription
                channelLogoUrl = publicChannelIntegrationChannel.channelLogoUrl
                webhookUrl = publicChannelIntegrationChannel.webhookUrl
                additionalProperties =
                    publicChannelIntegrationChannel.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [PublicChannelIntegrationChannel].
         *
         ...
         */
        fun build(): PublicChannelIntegrationChannel =
            PublicChannelIntegrationChannel(
                checkRequired("id", id),
    ...
    fun validate(): PublicChannelIntegrationChannel = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicChannelIntegrationChannel &&
            id == other.id &&
    ...
    override fun toString() =
        "PublicChannelIntegrationChannel{id=$id, capabilities=$capabilities, createdAt=$createdAt, name=$name, channelAccountConnectionRedirectUrl=$channelAccountConnectionRedirectUrl, channelDescription=$channelDescription, channelLogoUrl=$channelLogoUrl, webhookUrl=$webhookUrl, additionalProperties=$additionalProperties}"
}
