...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(messageGetParams: MessageGetParams) = apply {
            channelId = messageGetParams.channelId
    ...
    override fun hashCode(): Int =
        Objects.hash(channelId, messageId, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "MessageGetParams{channelId=$channelId, messageId=$messageId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
