...
class CollectionResponseWithTotalPublicCampaign
...
private constructor(
    ...
    /**
     * An array of PublicCampaign objects, each representing a campaign with its associated
     * properties.
     *
    ...
    /** A builder for [CollectionResponseWithTotalPublicCampaign]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            collectionResponseWithTotalPublicCampaign: CollectionResponseWithTotalPublicCampaign
        ) = apply {
            results = collectionResponseWithTotalPublicCampaign.results.map { it.toMutableList() }
            total = collectionResponseWithTotalPublicCampaign.total
            paging = collectionResponseWithTotalPublicCampaign.paging
            additionalProperties =
                collectionResponseWithTotalPublicCampaign.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CollectionResponseWithTotalPublicCampaign].
         *
         ...
         */
        fun build(): CollectionResponseWithTotalPublicCampaign =
            CollectionResponseWithTotalPublicCampaign(
    ...
    fun validate(): CollectionResponseWithTotalPublicCampaign = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionResponseWithTotalPublicCampaign &&
    ...
    override fun toString() =
        "CollectionResponseWithTotalPublicCampaign{results=$results, total=$total, paging=$paging, additionalProperties=$additionalProperties}"
}
