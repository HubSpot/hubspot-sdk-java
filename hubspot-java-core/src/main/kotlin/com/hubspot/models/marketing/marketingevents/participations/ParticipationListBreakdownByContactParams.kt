...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ParticipationListBreakdownByContactParams = builder().build()
    ...
    /** A builder for [ParticipationListBreakdownByContactParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            participationListBreakdownByContactParams: ParticipationListBreakdownByContactParams
        ) = apply {
            contactIdentifier = participationListBreakdownByContactParams.contactIdentifier
            after = participationListBreakdownByContactParams.after
            limit = participationListBreakdownByContactParams.limit
            state = participationListBreakdownByContactParams.state
            additionalHeaders =
                participationListBreakdownByContactParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                participationListBreakdownByContactParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ParticipationListBreakdownByContactParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ParticipationListBreakdownByContactParams =
            ParticipationListBreakdownByContactParams(
                contactIdentifier,
                after,
                limit,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ParticipationListBreakdownByContactParams &&
    ...
    override fun toString() =
        "ParticipationListBreakdownByContactParams{contactIdentifier=$contactIdentifier, after=$after, limit=$limit, state=$state, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
