 ...
 */
class MarketingEventUpdateByExternalEventIdParams
private constructor(
    ...
    /** A builder for [MarketingEventUpdateByExternalEventIdParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            marketingEventUpdateByExternalEventIdParams: MarketingEventUpdateByExternalEventIdParams
        ) = apply {
            externalEventId = marketingEventUpdateByExternalEventIdParams.externalEventId
            externalAccountId = marketingEventUpdateByExternalEventIdParams.externalAccountId
            marketingEventUpdateRequestParams =
                marketingEventUpdateByExternalEventIdParams.marketingEventUpdateRequestParams
            additionalHeaders =
                marketingEventUpdateByExternalEventIdParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                marketingEventUpdateByExternalEventIdParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [MarketingEventUpdateByExternalEventIdParams].
         *
         ...
         */
        fun build(): MarketingEventUpdateByExternalEventIdParams =
            MarketingEventUpdateByExternalEventIdParams(
                externalEventId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MarketingEventUpdateByExternalEventIdParams &&
    ...
    override fun toString() =
        "MarketingEventUpdateByExternalEventIdParams{externalEventId=$externalEventId, externalAccountId=$externalAccountId, marketingEventUpdateRequestParams=$marketingEventUpdateRequestParams, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
