...
class PublicCampaignBatchUpdateItem
...
private constructor(
    ...
    /** A builder for [PublicCampaignBatchUpdateItem]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicCampaignBatchUpdateItem: PublicCampaignBatchUpdateItem) = apply {
            id = publicCampaignBatchUpdateItem.id
            properties = publicCampaignBatchUpdateItem.properties
        ...
        /**
         * Returns an immutable instance of [PublicCampaignBatchUpdateItem].
         *
         ...
         */
        fun build(): PublicCampaignBatchUpdateItem =
            PublicCampaignBatchUpdateItem(
                checkRequired("id", id),
    ...
    fun validate(): PublicCampaignBatchUpdateItem = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicCampaignBatchUpdateItem &&
            id == other.id &&
            properties == other.properties &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(id, properties, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "PublicCampaignBatchUpdateItem{id=$id, properties=$properties, additionalProperties=$additionalProperties}"
}
