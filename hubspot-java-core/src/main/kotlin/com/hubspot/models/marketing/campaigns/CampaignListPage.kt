...
private constructor(
    ...
    private val response: CollectionResponseWithTotalPublicCampaign,
) : Page<PublicCampaign> {

    /**
     * Delegates to [CollectionResponseWithTotalPublicCampaign], but gracefully handles missing
     * data.
     *
     * @see CollectionResponseWithTotalPublicCampaign.results
     */
     ...
     * data.
     *
     * @see CollectionResponseWithTotalPublicCampaign.paging
     */
    ...
    fun response(): CollectionResponseWithTotalPublicCampaign = response
    ...
    class Builder internal constructor() {
        ...
        private var response: CollectionResponseWithTotalPublicCampaign? = null
        ...
        /** The response that this page was parsed from. */
        fun response(response: CollectionResponseWithTotalPublicCampaign) = apply {
