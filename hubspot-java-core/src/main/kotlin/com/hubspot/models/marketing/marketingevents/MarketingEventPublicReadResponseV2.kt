...
private constructor(
    ...
    private val eventStatusV2: JsonField<String>,
    ...
    private constructor(
        ...
        @JsonProperty("eventStatusV2")
        @ExcludeMissing
        eventStatusV2: JsonField<String> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun eventStatusV2(): Optional<String> = eventStatusV2.getOptional("eventStatusV2")
    ...
    /**
     * Returns the raw JSON value of [eventStatusV2].
     *
     * Unlike [eventStatusV2], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("eventStatusV2")
    @ExcludeMissing
    fun _eventStatusV2(): JsonField<String> = eventStatusV2
    ...
    class Builder internal constructor() {
        ...
        private var eventStatusV2: JsonField<String> = JsonMissing.of()
        ...
        internal fun from(marketingEventPublicReadResponseV2: MarketingEventPublicReadResponseV2) =
            apply {
                ...
                eventStatusV2 = marketingEventPublicReadResponseV2.eventStatusV2
        ...
        fun eventStatusV2(eventStatusV2: String) = eventStatusV2(JsonField.of(eventStatusV2))

        /**
         * Sets [Builder.eventStatusV2] to an arbitrary JSON value.
         *
         * You should usually call [Builder.eventStatusV2] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun eventStatusV2(eventStatusV2: JsonField<String>) = apply {
            this.eventStatusV2 = eventStatusV2
        }
    ...
    internal fun validity(): Int =
        (if (createdAt.asKnown().isPresent) 1 else 0) +
            ...
            (if (eventStatusV2.asKnown().isPresent) 1 else 0) +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MarketingEventPublicReadResponseV2 &&
            ...
            eventStatusV2 == other.eventStatusV2 &&
