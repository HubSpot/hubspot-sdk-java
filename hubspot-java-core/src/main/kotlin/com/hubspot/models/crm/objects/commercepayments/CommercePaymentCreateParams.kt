...
/**
 * Create a commerce payment with the given properties and return a copy of the object, including
 * the ID. Documentation and examples for creating standard commerce payments is provided.
 */
class CommercePaymentCreateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CommercePaymentCreateParams].
         *
    ...
    /** A builder for [CommercePaymentCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(commercePaymentCreateParams: CommercePaymentCreateParams) = apply {
            simplePublicObjectInputForCreate =
                commercePaymentCreateParams.simplePublicObjectInputForCreate
            additionalHeaders = commercePaymentCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = commercePaymentCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CommercePaymentCreateParams].
         *
         ...
         */
        fun build(): CommercePaymentCreateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CommercePaymentCreateParams &&
    ...
    override fun toString() =
        "CommercePaymentCreateParams{simplePublicObjectInputForCreate=$simplePublicObjectInputForCreate, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
