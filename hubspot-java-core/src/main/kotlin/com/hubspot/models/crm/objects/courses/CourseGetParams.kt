...
package com.hubspot.models.crm.objects.courses
...
private constructor(
    ...
    fun courseId(): Optional<String> = Optional.ofNullable(courseId)
    ...
    companion object {
        ...
        @JvmStatic fun none(): CourseGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [CourseGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CourseGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(courseGetParams: CourseGetParams) = apply {
            courseId = courseGetParams.courseId
            archived = courseGetParams.archived
            associations = courseGetParams.associations?.toMutableList()
            idProperty = courseGetParams.idProperty
            properties = courseGetParams.properties?.toMutableList()
            propertiesWithHistory = courseGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = courseGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = courseGetParams.additionalQueryParams.toBuilder()
        }

        fun courseId(courseId: String?) = apply { this.courseId = courseId }

        /** Alias for calling [Builder.courseId] with `courseId.orElse(null)`. */
        fun courseId(courseId: Optional<String>) = courseId(courseId.getOrNull())
        ...
        /**
         * Returns an immutable instance of [CourseGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CourseGetParams =
            CourseGetParams(
                courseId,
                archived,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CourseGetParams &&
    ...
    override fun toString() =
        "CourseGetParams{courseId=$courseId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
