...
/**
 * Create multiple lead records in a single request by providing a batch of lead data. This endpoint
 * allows for efficient creation of leads by processing them together, which can be useful for
 * syncing data from other systems or importing large datasets.
 */
