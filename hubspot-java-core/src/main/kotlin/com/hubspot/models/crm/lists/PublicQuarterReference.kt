...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicQuarterReference].
         *
    ...
    /** A builder for [PublicQuarterReference]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicQuarterReference: PublicQuarterReference) = apply {
            day = publicQuarterReference.day
            month = publicQuarterReference.month
            referenceType = publicQuarterReference.referenceType
            hour = publicQuarterReference.hour
            millisecond = publicQuarterReference.millisecond
            minute = publicQuarterReference.minute
            second = publicQuarterReference.second
            additionalProperties = publicQuarterReference.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicQuarterReference].
         *
         ...
         */
        fun build(): PublicQuarterReference =
    ...
    fun validate(): PublicQuarterReference = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicQuarterReference &&
            day == other.day &&
            month == other.month &&
    ...
    override fun toString() =
        "PublicQuarterReference{day=$day, month=$month, referenceType=$referenceType, hour=$hour, millisecond=$millisecond, minute=$minute, second=$second, additionalProperties=$additionalProperties}"
}
