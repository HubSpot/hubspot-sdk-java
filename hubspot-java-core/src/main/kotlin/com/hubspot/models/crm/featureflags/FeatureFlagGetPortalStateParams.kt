...
class FeatureFlagGetPortalStateParams
private constructor(
    ...
    /** A builder for [FeatureFlagGetPortalStateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(featureFlagGetPortalStateParams: FeatureFlagGetPortalStateParams) =
            apply {
                appId = featureFlagGetPortalStateParams.appId
                flagName = featureFlagGetPortalStateParams.flagName
                portalId = featureFlagGetPortalStateParams.portalId
                additionalHeaders = featureFlagGetPortalStateParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    featureFlagGetPortalStateParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [FeatureFlagGetPortalStateParams].
         *
         ...
         */
        fun build(): FeatureFlagGetPortalStateParams =
            FeatureFlagGetPortalStateParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeatureFlagGetPortalStateParams &&
            appId == other.appId &&
    ...
    override fun toString() =
        "FeatureFlagGetPortalStateParams{appId=$appId, flagName=$flagName, portalId=$portalId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
