...
package com.hubspot.models.crm.objects.products
 ...
 * endpoint allows for detailed querying of product data within the CRM, enabling users to retrieve
 * specific product information by applying multiple filter groups and sorting criteria.
 */
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProductSearchParams].
         *
    ...
    /** A builder for [ProductSearchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(productSearchParams: ProductSearchParams) = apply {
            publicObjectSearchRequest = productSearchParams.publicObjectSearchRequest
            additionalHeaders = productSearchParams.additionalHeaders.toBuilder()
            additionalQueryParams = productSearchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ProductSearchParams].
         *
    ...
    override fun toString() =
        "ProductSearchParams{publicObjectSearchRequest=$publicObjectSearchRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
