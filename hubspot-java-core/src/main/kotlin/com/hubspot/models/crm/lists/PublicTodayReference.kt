...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicTodayReference].
         *
    ...
    /** A builder for [PublicTodayReference]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicTodayReference: PublicTodayReference) = apply {
            referenceType = publicTodayReference.referenceType
            hour = publicTodayReference.hour
            millisecond = publicTodayReference.millisecond
            minute = publicTodayReference.minute
            second = publicTodayReference.second
            additionalProperties = publicTodayReference.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicTodayReference].
         *
         ...
         */
        fun build(): PublicTodayReference =
    ...
    fun validate(): PublicTodayReference = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicTodayReference &&
    ...
    override fun toString() =
        "PublicTodayReference{referenceType=$referenceType, hour=$hour, millisecond=$millisecond, minute=$minute, second=$second, additionalProperties=$additionalProperties}"
}
