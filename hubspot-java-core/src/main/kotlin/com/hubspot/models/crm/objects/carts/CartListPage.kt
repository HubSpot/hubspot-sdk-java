...
private constructor(
    ...
    override fun nextPage(): CartListPage = service.list(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CartListPage].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(cartListPage: CartListPage) = apply {
            service = cartListPage.service
            params = cartListPage.params
            response = cartListPage.response
        }

        fun service(service: CartService) = apply { this.service = service }
        ...
        /**
         * Returns an immutable instance of [CartListPage].
         *
    ...
    override fun toString() = "CartListPage{service=$service, params=$params, response=$response}"
}
