...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionGetParams: SubscriptionGetParams) = apply {
            subscriptionId = subscriptionGetParams.subscriptionId
            archived = subscriptionGetParams.archived
            associations = subscriptionGetParams.associations?.toMutableList()
            idProperty = subscriptionGetParams.idProperty
            properties = subscriptionGetParams.properties?.toMutableList()
            propertiesWithHistory = subscriptionGetParams.propertiesWithHistory?.toMutableList()
    ...
    override fun toString() =
        "SubscriptionGetParams{subscriptionId=$subscriptionId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
