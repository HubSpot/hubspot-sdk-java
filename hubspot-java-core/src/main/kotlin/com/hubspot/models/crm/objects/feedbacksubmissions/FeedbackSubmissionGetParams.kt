...
package com.hubspot.models.crm.objects.feedbacksubmissions
 ...
 */
class FeedbackSubmissionGetParams
private constructor(
    private val feedbackSubmissionId: String?,
    ...
    fun feedbackSubmissionId(): Optional<String> = Optional.ofNullable(feedbackSubmissionId)
    ...
    companion object {
        ...
        @JvmStatic fun none(): FeedbackSubmissionGetParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [FeedbackSubmissionGetParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FeedbackSubmissionGetParams]. */
    class Builder internal constructor() {

        private var feedbackSubmissionId: String? = null
        ...
        @JvmSynthetic
        internal fun from(feedbackSubmissionGetParams: FeedbackSubmissionGetParams) = apply {
            feedbackSubmissionId = feedbackSubmissionGetParams.feedbackSubmissionId
            archived = feedbackSubmissionGetParams.archived
            associations = feedbackSubmissionGetParams.associations?.toMutableList()
            idProperty = feedbackSubmissionGetParams.idProperty
            properties = feedbackSubmissionGetParams.properties?.toMutableList()
            propertiesWithHistory =
                feedbackSubmissionGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = feedbackSubmissionGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = feedbackSubmissionGetParams.additionalQueryParams.toBuilder()
        }

        fun feedbackSubmissionId(feedbackSubmissionId: String?) = apply {
            this.feedbackSubmissionId = feedbackSubmissionId
        }

        /**
         * Alias for calling [Builder.feedbackSubmissionId] with
         * `feedbackSubmissionId.orElse(null)`.
         */
        fun feedbackSubmissionId(feedbackSubmissionId: Optional<String>) =
            feedbackSubmissionId(feedbackSubmissionId.getOrNull())
        ...
        /**
         * Returns an immutable instance of [FeedbackSubmissionGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FeedbackSubmissionGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeedbackSubmissionGetParams &&
            feedbackSubmissionId == other.feedbackSubmissionId &&
    ...
    override fun toString() =
        "FeedbackSubmissionGetParams{feedbackSubmissionId=$feedbackSubmissionId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
