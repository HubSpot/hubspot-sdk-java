...
import com.hubspot.models.crm.LabelsBetweenObjectPair
...
private constructor(
    ...
    private val results: JsonField<List<LabelsBetweenObjectPair>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<LabelsBetweenObjectPair>> = JsonMissing.of(),
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<LabelsBetweenObjectPair>> = results
    ...
    /** A builder for [BatchResponseLabelsBetweenObjectPairWithErrors]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<LabelsBetweenObjectPair>>? = null
        ...
        internal fun from(
            ...
            completedAt = batchResponseLabelsBetweenObjectPairWithErrors.completedAt
            results =
                batchResponseLabelsBetweenObjectPairWithErrors.results.map { it.toMutableList() }
            startedAt = batchResponseLabelsBetweenObjectPairWithErrors.startedAt
            status = batchResponseLabelsBetweenObjectPairWithErrors.status
            errors =
                batchResponseLabelsBetweenObjectPairWithErrors.errors.map { it.toMutableList() }
            links = batchResponseLabelsBetweenObjectPairWithErrors.links
            numErrors = batchResponseLabelsBetweenObjectPairWithErrors.numErrors
            requestedAt = batchResponseLabelsBetweenObjectPairWithErrors.requestedAt
            additionalProperties =
                batchResponseLabelsBetweenObjectPairWithErrors.additionalProperties.toMutableMap()
        }
        ...
        fun results(results: List<LabelsBetweenObjectPair>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed
         * `List<LabelsBetweenObjectPair>` value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun results(results: JsonField<List<LabelsBetweenObjectPair>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [LabelsBetweenObjectPair] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: LabelsBetweenObjectPair) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [BatchResponseLabelsBetweenObjectPairWithErrors].
         *
         ...
         */
        fun build(): BatchResponseLabelsBetweenObjectPairWithErrors =
            BatchResponseLabelsBetweenObjectPairWithErrors(
    ...
    fun validate(): BatchResponseLabelsBetweenObjectPairWithErrors = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseLabelsBetweenObjectPairWithErrors &&
    ...
    override fun toString() =
        "BatchResponseLabelsBetweenObjectPairWithErrors{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
