...
class ListAddMembershipsParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ListAddMembershipsParams].
         *
    ...
    /** A builder for [ListAddMembershipsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(listAddMembershipsParams: ListAddMembershipsParams) = apply {
            listId = listAddMembershipsParams.listId
            body = listAddMembershipsParams.body.toMutableList()
            additionalHeaders = listAddMembershipsParams.additionalHeaders.toBuilder()
            additionalQueryParams = listAddMembershipsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ListAddMembershipsParams].
         *
         ...
         */
        fun build(): ListAddMembershipsParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ListAddMembershipsParams &&
            listId == other.listId &&
            body == other.body &&
    ...
    override fun toString() =
        "ListAddMembershipsParams{listId=$listId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
