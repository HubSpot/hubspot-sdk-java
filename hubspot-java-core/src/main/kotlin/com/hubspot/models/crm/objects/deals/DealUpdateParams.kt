 ...
 * value as specified by the `idProperty` query param. `{dealId}` refers to the internal object ID
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DealUpdateParams].
         *
    ...
    /** A builder for [DealUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dealUpdateParams: DealUpdateParams) = apply {
            dealId = dealUpdateParams.dealId
            idProperty = dealUpdateParams.idProperty
            simplePublicObjectInput = dealUpdateParams.simplePublicObjectInput
            additionalHeaders = dealUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = dealUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DealUpdateParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DealUpdateParams &&
            dealId == other.dealId &&
    ...
    override fun toString() =
        "DealUpdateParams{dealId=$dealId, idProperty=$idProperty, simplePublicObjectInput=$simplePublicObjectInput, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
