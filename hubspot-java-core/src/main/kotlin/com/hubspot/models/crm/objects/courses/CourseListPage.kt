...
private constructor(
    ...
    override fun nextPage(): CourseListPage = service.list(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CourseListPage].
         *
    ...
    /** A builder for [CourseListPage]. */
    class Builder internal constructor() {

        private var service: CourseService? = null
        ...
        @JvmSynthetic
        internal fun from(courseListPage: CourseListPage) = apply {
            service = courseListPage.service
            params = courseListPage.params
            response = courseListPage.response
        }

        fun service(service: CourseService) = apply { this.service = service }
        ...
        /**
         * Returns an immutable instance of [CourseListPage].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CourseListPage &&
    ...
    override fun toString() = "CourseListPage{service=$service, params=$params, response=$response}"
}
