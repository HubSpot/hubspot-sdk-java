 ...
 * value as specified by the `idProperty` query param. `{taxId}` refers to the internal object ID by
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TaxUpdateParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(taxUpdateParams: TaxUpdateParams) = apply {
            taxId = taxUpdateParams.taxId
            idProperty = taxUpdateParams.idProperty
            simplePublicObjectInput = taxUpdateParams.simplePublicObjectInput
            additionalHeaders = taxUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = taxUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TaxUpdateParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TaxUpdateParams &&
            taxId == other.taxId &&
    ...
    override fun toString() =
        "TaxUpdateParams{taxId=$taxId, idProperty=$idProperty, simplePublicObjectInput=$simplePublicObjectInput, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
