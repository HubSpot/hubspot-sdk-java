...
/**
 * Read an Object identified by `{userId}`. `{userId}` refers to the internal object ID by default,
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(userGetParams: UserGetParams) = apply {
            ...
            archived = userGetParams.archived
            associations = userGetParams.associations?.toMutableList()
            idProperty = userGetParams.idProperty
            properties = userGetParams.properties?.toMutableList()
            propertiesWithHistory = userGetParams.propertiesWithHistory?.toMutableList()
    ...
    override fun toString() =
        "UserGetParams{userId=$userId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
