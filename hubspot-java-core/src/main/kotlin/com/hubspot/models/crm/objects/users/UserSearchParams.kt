...
package com.hubspot.models.crm.objects.users
...
/**
 * Execute a search for users using defined filters, properties, and sorting options. The request
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserSearchParams].
         *
    ...
    /** A builder for [UserSearchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userSearchParams: UserSearchParams) = apply {
            publicObjectSearchRequest = userSearchParams.publicObjectSearchRequest
            additionalHeaders = userSearchParams.additionalHeaders.toBuilder()
            additionalQueryParams = userSearchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [UserSearchParams].
         *
    ...
    override fun toString() =
        "UserSearchParams{publicObjectSearchRequest=$publicObjectSearchRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
