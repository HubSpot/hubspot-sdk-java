...
/**
 * Update a company by ID (`companyId`) or unique property value (`idProperty`). Provided property
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(companyUpdateParams: CompanyUpdateParams) = apply {
            ...
            idProperty = companyUpdateParams.idProperty
            simplePublicObjectInput = companyUpdateParams.simplePublicObjectInput
    ...
    override fun toString() =
        "CompanyUpdateParams{companyId=$companyId, idProperty=$idProperty, simplePublicObjectInput=$simplePublicObjectInput, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
