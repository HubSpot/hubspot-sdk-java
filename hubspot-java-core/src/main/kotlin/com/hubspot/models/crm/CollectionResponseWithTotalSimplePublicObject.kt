...
/**
 * Represents a list of simple objects returned from an API request, along with the total count of
 * objects available.
 */
...
private constructor(
    ...
    /** A builder for [CollectionResponseWithTotalSimplePublicObject]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            results =
                collectionResponseWithTotalSimplePublicObject.results.map { it.toMutableList() }
            total = collectionResponseWithTotalSimplePublicObject.total
            paging = collectionResponseWithTotalSimplePublicObject.paging
            additionalProperties =
                collectionResponseWithTotalSimplePublicObject.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CollectionResponseWithTotalSimplePublicObject].
         *
         ...
         */
        fun build(): CollectionResponseWithTotalSimplePublicObject =
            CollectionResponseWithTotalSimplePublicObject(
    ...
    fun validate(): CollectionResponseWithTotalSimplePublicObject = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionResponseWithTotalSimplePublicObject &&
    ...
    override fun toString() =
        "CollectionResponseWithTotalSimplePublicObject{results=$results, total=$total, paging=$paging, additionalProperties=$additionalProperties}"
}
