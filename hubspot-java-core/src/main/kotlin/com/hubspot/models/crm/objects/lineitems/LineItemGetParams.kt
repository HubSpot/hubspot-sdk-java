...
/**
 * Read an Object identified by `{lineItemId}`. `{lineItemId}` refers to the internal object ID by
...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LineItemGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [LineItemGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LineItemGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(lineItemGetParams: LineItemGetParams) = apply {
            lineItemId = lineItemGetParams.lineItemId
            archived = lineItemGetParams.archived
            associations = lineItemGetParams.associations?.toMutableList()
            idProperty = lineItemGetParams.idProperty
            properties = lineItemGetParams.properties?.toMutableList()
            propertiesWithHistory = lineItemGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = lineItemGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = lineItemGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LineItemGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LineItemGetParams =
            LineItemGetParams(
                lineItemId,
                archived,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LineItemGetParams &&
    ...
    override fun toString() =
        "LineItemGetParams{lineItemId=$lineItemId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
