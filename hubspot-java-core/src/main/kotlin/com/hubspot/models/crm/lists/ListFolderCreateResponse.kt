...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ListFolderCreateResponse].
         *
    ...
    /** A builder for [ListFolderCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(listFolderCreateResponse: ListFolderCreateResponse) = apply {
            folder = listFolderCreateResponse.folder
            additionalProperties = listFolderCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ListFolderCreateResponse].
         *
         ...
         */
        fun build(): ListFolderCreateResponse =
    ...
    fun validate(): ListFolderCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ListFolderCreateResponse &&
            folder == other.folder &&
    ...
    override fun toString() =
        "ListFolderCreateResponse{folder=$folder, additionalProperties=$additionalProperties}"
}
