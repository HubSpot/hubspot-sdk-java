...
private constructor(
    ...
    /** A builder for [BatchInputSimplePublicObjectId]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchInputSimplePublicObjectId: BatchInputSimplePublicObjectId) = apply {
            inputs = batchInputSimplePublicObjectId.inputs.map { it.toMutableList() }
            additionalProperties =
                batchInputSimplePublicObjectId.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BatchInputSimplePublicObjectId].
         *
         ...
         */
        fun build(): BatchInputSimplePublicObjectId =
            BatchInputSimplePublicObjectId(
    ...
    fun validate(): BatchInputSimplePublicObjectId = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchInputSimplePublicObjectId &&
            inputs == other.inputs &&
    ...
    override fun toString() =
        "BatchInputSimplePublicObjectId{inputs=$inputs, additionalProperties=$additionalProperties}"
}
