...
package com.hubspot.models.crm.objects.leads.batch
...
/**
 * Update multiple lead records using their internal IDs or unique property values. This endpoint
 * allows batch processing of updates, where each lead's properties can be modified based on the
 * provided input. Ensure that the properties being updated exist on the lead objects to avoid
 * errors.
 */
