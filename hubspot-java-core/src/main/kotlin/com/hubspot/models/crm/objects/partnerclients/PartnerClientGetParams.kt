...
/**
 * Retrieve detailed information about a specific partner client, including selected properties and
 * associations. This endpoint is useful for accessing comprehensive client data for analysis or
...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PartnerClientGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PartnerClientGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PartnerClientGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(partnerClientGetParams: PartnerClientGetParams) = apply {
            partnerClientId = partnerClientGetParams.partnerClientId
            archived = partnerClientGetParams.archived
            associations = partnerClientGetParams.associations?.toMutableList()
            idProperty = partnerClientGetParams.idProperty
            properties = partnerClientGetParams.properties?.toMutableList()
            propertiesWithHistory = partnerClientGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = partnerClientGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = partnerClientGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /** Alias for calling [Builder.partnerClientId] with `partnerClientId.orElse(null)`. */
        ...
        /**
         * Returns an immutable instance of [PartnerClientGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PartnerClientGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PartnerClientGetParams &&
    ...
    override fun toString() =
        "PartnerClientGetParams{partnerClientId=$partnerClientId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
