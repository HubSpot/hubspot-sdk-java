...
package com.hubspot.models.crm.objects.commercepayments
...
/**
 * Read an Object identified by `{commercePaymentId}`. `{commercePaymentId}` refers to the internal
 ...
 */
class CommercePaymentGetParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): CommercePaymentGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [CommercePaymentGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CommercePaymentGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(commercePaymentGetParams: CommercePaymentGetParams) = apply {
            commercePaymentId = commercePaymentGetParams.commercePaymentId
            archived = commercePaymentGetParams.archived
            associations = commercePaymentGetParams.associations?.toMutableList()
            idProperty = commercePaymentGetParams.idProperty
            properties = commercePaymentGetParams.properties?.toMutableList()
            propertiesWithHistory = commercePaymentGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = commercePaymentGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = commercePaymentGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CommercePaymentGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CommercePaymentGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CommercePaymentGetParams &&
    ...
    override fun toString() =
        "CommercePaymentGetParams{commercePaymentId=$commercePaymentId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
