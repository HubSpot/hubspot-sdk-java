...
/** @see CommercePaymentServiceAsync.list */
class CommercePaymentListPageAsync
private constructor(
    private val service: CommercePaymentServiceAsync,
    ...
    override fun nextPage(): CompletableFuture<CommercePaymentListPageAsync> =
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CommercePaymentListPageAsync].
         *
    ...
    /** A builder for [CommercePaymentListPageAsync]. */
    class Builder internal constructor() {

        private var service: CommercePaymentServiceAsync? = null
        ...
        @JvmSynthetic
        internal fun from(commercePaymentListPageAsync: CommercePaymentListPageAsync) = apply {
            service = commercePaymentListPageAsync.service
            streamHandlerExecutor = commercePaymentListPageAsync.streamHandlerExecutor
            params = commercePaymentListPageAsync.params
            response = commercePaymentListPageAsync.response
        }

        fun service(service: CommercePaymentServiceAsync) = apply { this.service = service }
        ...
        /**
         * Returns an immutable instance of [CommercePaymentListPageAsync].
         *
         ...
         */
        fun build(): CommercePaymentListPageAsync =
            CommercePaymentListPageAsync(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CommercePaymentListPageAsync &&
    ...
    override fun toString() =
        "CommercePaymentListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}
