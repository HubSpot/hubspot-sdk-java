...
/**
 * Perform a partial update of an Object identified by `{courseId}`or optionally a unique property
 * value as specified by the `idProperty` query param. `{courseId}` refers to the internal object ID
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CourseUpdateParams].
         *
    ...
    /** A builder for [CourseUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(courseUpdateParams: CourseUpdateParams) = apply {
            courseId = courseUpdateParams.courseId
            idProperty = courseUpdateParams.idProperty
            simplePublicObjectInput = courseUpdateParams.simplePublicObjectInput
            additionalHeaders = courseUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = courseUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CourseUpdateParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CourseUpdateParams &&
    ...
    override fun toString() =
        "CourseUpdateParams{courseId=$courseId, idProperty=$idProperty, simplePublicObjectInput=$simplePublicObjectInput, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
