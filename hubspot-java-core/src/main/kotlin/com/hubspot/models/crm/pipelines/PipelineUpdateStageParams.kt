...
class PipelineUpdateStageParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PipelineUpdateStageParams].
         *
    ...
    /** A builder for [PipelineUpdateStageParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pipelineUpdateStageParams: PipelineUpdateStageParams) = apply {
            objectType = pipelineUpdateStageParams.objectType
            pipelineId = pipelineUpdateStageParams.pipelineId
            stageId = pipelineUpdateStageParams.stageId
            pipelineStagePatchInput = pipelineUpdateStageParams.pipelineStagePatchInput
            additionalHeaders = pipelineUpdateStageParams.additionalHeaders.toBuilder()
            additionalQueryParams = pipelineUpdateStageParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PipelineUpdateStageParams].
         *
         ...
         */
        fun build(): PipelineUpdateStageParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PipelineUpdateStageParams &&
    ...
    override fun toString() =
        "PipelineUpdateStageParams{objectType=$objectType, pipelineId=$pipelineId, stageId=$stageId, pipelineStagePatchInput=$pipelineStagePatchInput, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
