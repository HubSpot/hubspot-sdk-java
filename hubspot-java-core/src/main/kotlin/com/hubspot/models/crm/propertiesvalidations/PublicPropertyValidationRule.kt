...
private constructor(
    ...
    ) : this(ruleArguments, ruleType, shouldApplyNormalization, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(publicPropertyValidationRule: PublicPropertyValidationRule) = apply {
            ...
            shouldApplyNormalization = publicPropertyValidationRule.shouldApplyNormalization
    ...
    private val hashCode: Int by lazy {
        Objects.hash(ruleArguments, ruleType, shouldApplyNormalization, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "PublicPropertyValidationRule{ruleArguments=$ruleArguments, ruleType=$ruleType, shouldApplyNormalization=$shouldApplyNormalization, additionalProperties=$additionalProperties}"
}
