...
private constructor(
    ...
    /** A builder for [FeedbackSubmissionSearchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(feedbackSubmissionSearchParams: FeedbackSubmissionSearchParams) = apply {
            publicObjectSearchRequest = feedbackSubmissionSearchParams.publicObjectSearchRequest
            additionalHeaders = feedbackSubmissionSearchParams.additionalHeaders.toBuilder()
            additionalQueryParams = feedbackSubmissionSearchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FeedbackSubmissionSearchParams].
         *
         ...
         */
        fun build(): FeedbackSubmissionSearchParams =
            FeedbackSubmissionSearchParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeedbackSubmissionSearchParams &&
    ...
    override fun toString() =
        "FeedbackSubmissionSearchParams{publicObjectSearchRequest=$publicObjectSearchRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
