...
/** @see PartnerClientService.list */
class PartnerClientListPage
private constructor(
    ...
    override fun nextPage(): PartnerClientListPage = service.list(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PartnerClientListPage].
         *
    ...
    /** A builder for [PartnerClientListPage]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(partnerClientListPage: PartnerClientListPage) = apply {
            service = partnerClientListPage.service
            params = partnerClientListPage.params
            response = partnerClientListPage.response
        }
        ...
        /**
         * Returns an immutable instance of [PartnerClientListPage].
         *
         ...
         */
        fun build(): PartnerClientListPage =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PartnerClientListPage &&
    ...
    override fun toString() =
        "PartnerClientListPage{service=$service, params=$params, response=$response}"
}
