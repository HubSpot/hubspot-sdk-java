...
package com.hubspot.models.crm.objects.listings
...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ListingGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ListingGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ListingGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(listingGetParams: ListingGetParams) = apply {
            listingId = listingGetParams.listingId
            archived = listingGetParams.archived
            associations = listingGetParams.associations?.toMutableList()
            idProperty = listingGetParams.idProperty
            properties = listingGetParams.properties?.toMutableList()
            propertiesWithHistory = listingGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = listingGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = listingGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ListingGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ListingGetParams =
            ListingGetParams(
                listingId,
                archived,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ListingGetParams &&
    ...
    override fun toString() =
        "ListingGetParams{listingId=$listingId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
