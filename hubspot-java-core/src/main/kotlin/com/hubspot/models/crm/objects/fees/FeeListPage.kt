...
class FeeListPage
private constructor(
    private val service: FeeService,
    ...
    override fun nextPage(): FeeListPage = service.list(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FeeListPage].
         *
    ...
    /** A builder for [FeeListPage]. */
    class Builder internal constructor() {

        private var service: FeeService? = null
        ...
        @JvmSynthetic
        internal fun from(feeListPage: FeeListPage) = apply {
            service = feeListPage.service
            params = feeListPage.params
            response = feeListPage.response
        }

        fun service(service: FeeService) = apply { this.service = service }
        ...
        /**
         * Returns an immutable instance of [FeeListPage].
         *
    ...
    override fun toString() = "FeeListPage{service=$service, params=$params, response=$response}"
}
