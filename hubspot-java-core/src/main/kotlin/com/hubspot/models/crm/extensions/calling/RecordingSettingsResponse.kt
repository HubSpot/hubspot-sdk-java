...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RecordingSettingsResponse].
         *
    ...
    /** A builder for [RecordingSettingsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(recordingSettingsResponse: RecordingSettingsResponse) = apply {
            urlToRetrieveAuthedRecording = recordingSettingsResponse.urlToRetrieveAuthedRecording
        ...
        /**
         * Returns an immutable instance of [RecordingSettingsResponse].
         *
         ...
         */
        fun build(): RecordingSettingsResponse =
    ...
    fun validate(): RecordingSettingsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RecordingSettingsResponse &&
    ...
    override fun toString() =
        "RecordingSettingsResponse{urlToRetrieveAuthedRecording=$urlToRetrieveAuthedRecording, additionalProperties=$additionalProperties}"
}
