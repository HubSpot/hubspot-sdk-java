...
class PageGetLandingPagesParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PageGetLandingPagesParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [PageGetLandingPagesParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PageGetLandingPagesParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pageGetLandingPagesParams: PageGetLandingPagesParams) = apply {
            after = pageGetLandingPagesParams.after
            archived = pageGetLandingPagesParams.archived
            createdAfter = pageGetLandingPagesParams.createdAfter
            createdAt = pageGetLandingPagesParams.createdAt
            createdBefore = pageGetLandingPagesParams.createdBefore
            limit = pageGetLandingPagesParams.limit
            property = pageGetLandingPagesParams.property
            sort = pageGetLandingPagesParams.sort?.toMutableList()
            updatedAfter = pageGetLandingPagesParams.updatedAfter
            updatedAt = pageGetLandingPagesParams.updatedAt
            updatedBefore = pageGetLandingPagesParams.updatedBefore
            additionalHeaders = pageGetLandingPagesParams.additionalHeaders.toBuilder()
            additionalQueryParams = pageGetLandingPagesParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PageGetLandingPagesParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PageGetLandingPagesParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PageGetLandingPagesParams &&
            after == other.after &&
    ...
    override fun toString() =
        "PageGetLandingPagesParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
