...
class TagListAuthorsCursorParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TagListAuthorsCursorParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [TagListAuthorsCursorParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TagListAuthorsCursorParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tagListAuthorsCursorParams: TagListAuthorsCursorParams) = apply {
            after = tagListAuthorsCursorParams.after
            archived = tagListAuthorsCursorParams.archived
            createdAfter = tagListAuthorsCursorParams.createdAfter
            createdAt = tagListAuthorsCursorParams.createdAt
            createdBefore = tagListAuthorsCursorParams.createdBefore
            limit = tagListAuthorsCursorParams.limit
            property = tagListAuthorsCursorParams.property
            sort = tagListAuthorsCursorParams.sort?.toMutableList()
            updatedAfter = tagListAuthorsCursorParams.updatedAfter
            updatedAt = tagListAuthorsCursorParams.updatedAt
            updatedBefore = tagListAuthorsCursorParams.updatedBefore
            additionalHeaders = tagListAuthorsCursorParams.additionalHeaders.toBuilder()
            additionalQueryParams = tagListAuthorsCursorParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TagListAuthorsCursorParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TagListAuthorsCursorParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TagListAuthorsCursorParams &&
            after == other.after &&
