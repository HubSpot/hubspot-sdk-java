...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RowGetDraftBatchParams].
         *
    ...
    /** A builder for [RowGetDraftBatchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rowGetDraftBatchParams: RowGetDraftBatchParams) = apply {
            tableIdOrName = rowGetDraftBatchParams.tableIdOrName
            batchInputString = rowGetDraftBatchParams.batchInputString
            additionalHeaders = rowGetDraftBatchParams.additionalHeaders.toBuilder()
            additionalQueryParams = rowGetDraftBatchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [RowGetDraftBatchParams].
         *
         ...
         */
        fun build(): RowGetDraftBatchParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RowGetDraftBatchParams &&
    ...
    override fun toString() =
        "RowGetDraftBatchParams{tableIdOrName=$tableIdOrName, batchInputString=$batchInputString, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
