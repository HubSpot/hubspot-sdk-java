...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [StringPropertyVariable].
         *
    ...
    /** A builder for [StringPropertyVariable]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stringPropertyVariable: StringPropertyVariable) = apply {
            operator = stringPropertyVariable.operator
            propertyName = stringPropertyVariable.propertyName
            value = stringPropertyVariable.value
            additionalProperties = stringPropertyVariable.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [StringPropertyVariable].
         *
         ...
         */
        fun build(): StringPropertyVariable =
    ...
    fun validate(): StringPropertyVariable = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val STRING_PROPERTY_VARIABLE = of("STRING_PROPERTY_VARIABLE")
        ...
        fun value(): Value =
            when (this) {
                STRING_PROPERTY_VARIABLE -> Value.STRING_PROPERTY_VARIABLE
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                STRING_PROPERTY_VARIABLE -> Known.STRING_PROPERTY_VARIABLE
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StringPropertyVariable &&
    ...
    override fun toString() =
        "StringPropertyVariable{operator=$operator, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
