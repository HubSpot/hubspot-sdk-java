...
private constructor(
    ...
    /** A builder for [BatchResponseBlogAuthorWithErrors]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchResponseBlogAuthorWithErrors: BatchResponseBlogAuthorWithErrors) =
            apply {
                completedAt = batchResponseBlogAuthorWithErrors.completedAt
                results = batchResponseBlogAuthorWithErrors.results.map { it.toMutableList() }
                startedAt = batchResponseBlogAuthorWithErrors.startedAt
                status = batchResponseBlogAuthorWithErrors.status
                errors = batchResponseBlogAuthorWithErrors.errors.map { it.toMutableList() }
                links = batchResponseBlogAuthorWithErrors.links
                numErrors = batchResponseBlogAuthorWithErrors.numErrors
                requestedAt = batchResponseBlogAuthorWithErrors.requestedAt
                additionalProperties =
                    batchResponseBlogAuthorWithErrors.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BatchResponseBlogAuthorWithErrors].
         *
         ...
         */
        fun build(): BatchResponseBlogAuthorWithErrors =
            BatchResponseBlogAuthorWithErrors(
    ...
    fun validate(): BatchResponseBlogAuthorWithErrors = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseBlogAuthorWithErrors &&
    ...
    override fun toString() =
        "BatchResponseBlogAuthorWithErrors{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
