...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ContentFolderVersion].
         *
    ...
    /** A builder for [ContentFolderVersion]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contentFolderVersion: ContentFolderVersion) = apply {
            id = contentFolderVersion.id
            object_ = contentFolderVersion.object_
            updatedAt = contentFolderVersion.updatedAt
            user = contentFolderVersion.user
            additionalProperties = contentFolderVersion.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ContentFolderVersion].
         *
         ...
         */
        fun build(): ContentFolderVersion =
    ...
    fun validate(): ContentFolderVersion = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ContentFolderVersion &&
            id == other.id &&
    ...
    override fun toString() =
        "ContentFolderVersion{id=$id, object_=$object_, updatedAt=$updatedAt, user=$user, additionalProperties=$additionalProperties}"
}
