...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TagUpdateLangsParams].
         *
    ...
    /** A builder for [TagUpdateLangsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tagUpdateLangsParams: TagUpdateLangsParams) = apply {
            updateLanguagesRequestVNext = tagUpdateLangsParams.updateLanguagesRequestVNext
            additionalHeaders = tagUpdateLangsParams.additionalHeaders.toBuilder()
            additionalQueryParams = tagUpdateLangsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TagUpdateLangsParams].
         *
         ...
         */
        fun build(): TagUpdateLangsParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TagUpdateLangsParams &&
    ...
    override fun toString() =
        "TagUpdateLangsParams{updateLanguagesRequestVNext=$updateLanguagesRequestVNext, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
