...
/**
 * Unpublishes the table, meaning any website pages using data from the table will not render any
 * data.
 */
class TableUnpublishParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TableUnpublishParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TableUnpublishParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TableUnpublishParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tableUnpublishParams: TableUnpublishParams) = apply {
            tableIdOrName = tableUnpublishParams.tableIdOrName
            includeForeignIds = tableUnpublishParams.includeForeignIds
            additionalHeaders = tableUnpublishParams.additionalHeaders.toBuilder()
            additionalQueryParams = tableUnpublishParams.additionalQueryParams.toBuilder()
            additionalBodyProperties = tableUnpublishParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TableUnpublishParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TableUnpublishParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TableUnpublishParams &&
    ...
    override fun toString() =
        "TableUnpublishParams{tableIdOrName=$tableIdOrName, includeForeignIds=$includeForeignIds, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
