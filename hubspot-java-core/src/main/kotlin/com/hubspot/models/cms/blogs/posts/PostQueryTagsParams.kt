...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PostQueryTagsParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PostQueryTagsParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PostQueryTagsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(postQueryTagsParams: PostQueryTagsParams) = apply {
            after = postQueryTagsParams.after
            archived = postQueryTagsParams.archived
            createdAfter = postQueryTagsParams.createdAfter
            createdAt = postQueryTagsParams.createdAt
            createdBefore = postQueryTagsParams.createdBefore
            limit = postQueryTagsParams.limit
            property = postQueryTagsParams.property
            sort = postQueryTagsParams.sort?.toMutableList()
            updatedAfter = postQueryTagsParams.updatedAfter
            updatedAt = postQueryTagsParams.updatedAt
            updatedBefore = postQueryTagsParams.updatedBefore
            additionalHeaders = postQueryTagsParams.additionalHeaders.toBuilder()
            additionalQueryParams = postQueryTagsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PostQueryTagsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PostQueryTagsParams =
            PostQueryTagsParams(
                after,
                archived,
                createdAfter,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PostQueryTagsParams &&
            after == other.after &&
