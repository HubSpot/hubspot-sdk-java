...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AuthorGetCursorParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AuthorGetCursorParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AuthorGetCursorParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(authorGetCursorParams: AuthorGetCursorParams) = apply {
            after = authorGetCursorParams.after
            archived = authorGetCursorParams.archived
            createdAfter = authorGetCursorParams.createdAfter
            createdAt = authorGetCursorParams.createdAt
            createdBefore = authorGetCursorParams.createdBefore
            limit = authorGetCursorParams.limit
            property = authorGetCursorParams.property
            sort = authorGetCursorParams.sort?.toMutableList()
            updatedAfter = authorGetCursorParams.updatedAfter
            updatedAt = authorGetCursorParams.updatedAt
            updatedBefore = authorGetCursorParams.updatedBefore
            additionalHeaders = authorGetCursorParams.additionalHeaders.toBuilder()
            additionalQueryParams = authorGetCursorParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AuthorGetCursorParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AuthorGetCursorParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AuthorGetCursorParams &&
            after == other.after &&
    ...
    override fun toString() =
        "AuthorGetCursorParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
