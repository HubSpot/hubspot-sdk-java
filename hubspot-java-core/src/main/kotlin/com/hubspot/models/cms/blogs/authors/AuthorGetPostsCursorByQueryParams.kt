...
class AuthorGetPostsCursorByQueryParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AuthorGetPostsCursorByQueryParams = builder().build()
    ...
    /** A builder for [AuthorGetPostsCursorByQueryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(authorGetPostsCursorByQueryParams: AuthorGetPostsCursorByQueryParams) =
            apply {
                after = authorGetPostsCursorByQueryParams.after
                archived = authorGetPostsCursorByQueryParams.archived
                createdAfter = authorGetPostsCursorByQueryParams.createdAfter
                createdAt = authorGetPostsCursorByQueryParams.createdAt
                createdBefore = authorGetPostsCursorByQueryParams.createdBefore
                limit = authorGetPostsCursorByQueryParams.limit
                property = authorGetPostsCursorByQueryParams.property
                sort = authorGetPostsCursorByQueryParams.sort?.toMutableList()
                updatedAfter = authorGetPostsCursorByQueryParams.updatedAfter
                updatedAt = authorGetPostsCursorByQueryParams.updatedAt
                updatedBefore = authorGetPostsCursorByQueryParams.updatedBefore
                additionalHeaders = authorGetPostsCursorByQueryParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    authorGetPostsCursorByQueryParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AuthorGetPostsCursorByQueryParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AuthorGetPostsCursorByQueryParams =
            AuthorGetPostsCursorByQueryParams(
                after,
                archived,
                createdAfter,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AuthorGetPostsCursorByQueryParams &&
            after == other.after &&
