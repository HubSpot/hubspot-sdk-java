...
class TagListCursorByQueryParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TagListCursorByQueryParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [TagListCursorByQueryParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TagListCursorByQueryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tagListCursorByQueryParams: TagListCursorByQueryParams) = apply {
            after = tagListCursorByQueryParams.after
            archived = tagListCursorByQueryParams.archived
            createdAfter = tagListCursorByQueryParams.createdAfter
            createdAt = tagListCursorByQueryParams.createdAt
            createdBefore = tagListCursorByQueryParams.createdBefore
            limit = tagListCursorByQueryParams.limit
            property = tagListCursorByQueryParams.property
            sort = tagListCursorByQueryParams.sort?.toMutableList()
            updatedAfter = tagListCursorByQueryParams.updatedAfter
            updatedAt = tagListCursorByQueryParams.updatedAt
            updatedBefore = tagListCursorByQueryParams.updatedBefore
            additionalHeaders = tagListCursorByQueryParams.additionalHeaders.toBuilder()
            additionalQueryParams = tagListCursorByQueryParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TagListCursorByQueryParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TagListCursorByQueryParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TagListCursorByQueryParams &&
            after == other.after &&
    ...
    override fun toString() =
        "TagListCursorByQueryParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
