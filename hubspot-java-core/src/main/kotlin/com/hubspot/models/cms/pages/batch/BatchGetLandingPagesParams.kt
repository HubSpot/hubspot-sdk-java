...
class BatchGetLandingPagesParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchGetLandingPagesParams].
         *
    ...
    /** A builder for [BatchGetLandingPagesParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchGetLandingPagesParams: BatchGetLandingPagesParams) = apply {
            archived = batchGetLandingPagesParams.archived
            batchInputString = batchGetLandingPagesParams.batchInputString
            additionalHeaders = batchGetLandingPagesParams.additionalHeaders.toBuilder()
            additionalQueryParams = batchGetLandingPagesParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BatchGetLandingPagesParams].
         *
         ...
         */
        fun build(): BatchGetLandingPagesParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchGetLandingPagesParams &&
    ...
    override fun toString() =
        "BatchGetLandingPagesParams{archived=$archived, batchInputString=$batchInputString, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
