...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TagGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TagGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TagGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tagGetParams: TagGetParams) = apply {
            objectId = tagGetParams.objectId
            archived = tagGetParams.archived
            property = tagGetParams.property
            additionalHeaders = tagGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = tagGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TagGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TagGetParams =
            TagGetParams(
                objectId,
                archived,
                property,
    ...
    override fun toString() =
        "TagGetParams{objectId=$objectId, archived=$archived, property=$property, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
