...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FiscalYear].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fiscalYear: FiscalYear) = apply {
            day = fiscalYear.day
            month = fiscalYear.month
            referenceType = fiscalYear.referenceType
            hour = fiscalYear.hour
            millisecond = fiscalYear.millisecond
            minute = fiscalYear.minute
            second = fiscalYear.second
            additionalProperties = fiscalYear.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FiscalYear].
         *
    ...
    override fun toString() =
        "FiscalYear{day=$day, month=$month, referenceType=$referenceType, hour=$hour, millisecond=$millisecond, minute=$minute, second=$second, additionalProperties=$additionalProperties}"
}
