...
class EnumerationPropertyOperation
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EnumerationPropertyOperation].
         *
    ...
    /** A builder for [EnumerationPropertyOperation]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(enumerationPropertyOperation: EnumerationPropertyOperation) = apply {
            includeObjectsWithNoValueSet = enumerationPropertyOperation.includeObjectsWithNoValueSet
            operationType = enumerationPropertyOperation.operationType
            operator = enumerationPropertyOperation.operator
            operatorName = enumerationPropertyOperation.operatorName
            propertyType = enumerationPropertyOperation.propertyType
            values = enumerationPropertyOperation.values.map { it.toMutableList() }
            defaultValue = enumerationPropertyOperation.defaultValue
            renderSpec = enumerationPropertyOperation.renderSpec
            additionalProperties = enumerationPropertyOperation.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EnumerationPropertyOperation].
         *
         ...
         */
        fun build(): EnumerationPropertyOperation =
    ...
    fun validate(): EnumerationPropertyOperation = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EnumerationPropertyOperation &&
    ...
    override fun toString() =
        "EnumerationPropertyOperation{includeObjectsWithNoValueSet=$includeObjectsWithNoValueSet, operationType=$operationType, operator=$operator, operatorName=$operatorName, propertyType=$propertyType, values=$values, defaultValue=$defaultValue, renderSpec=$renderSpec, additionalProperties=$additionalProperties}"
}
