...
import com.hubspot.models.files.FileUpdateInput
import java.util.Objects
import java.util.Optional
import kotlin.jvm.optionals.getOrNull

/** Update properties of file by ID. */
class FileAssetUpdateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FileAssetUpdateParams].
         *
    ...
    /** A builder for [FileAssetUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileAssetUpdateParams: FileAssetUpdateParams) = apply {
            fileId = fileAssetUpdateParams.fileId
            fileUpdateInput = fileAssetUpdateParams.fileUpdateInput
            additionalHeaders = fileAssetUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = fileAssetUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FileAssetUpdateParams].
         *
         ...
         */
        fun build(): FileAssetUpdateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FileAssetUpdateParams &&
            fileId == other.fileId &&
    ...
    override fun toString() =
        "FileAssetUpdateParams{fileId=$fileId, fileUpdateInput=$fileUpdateInput, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
