...
private constructor(
     ...
     */
    fun clearExpires(): Boolean = clearExpires.getRequired("clearExpires")
    ...
    class Builder internal constructor() {
        ...
        private var clearExpires: JsonField<Boolean>? = null
        ...
        fun build(): FileUpdateInput =
            FileUpdateInput(
                checkRequired("clearExpires", clearExpires),
                access,
                expiresAt,
                isUsableInContent,
                name,
    ...
    override fun toString() =
        "FileUpdateInput{clearExpires=$clearExpires, access=$access, expiresAt=$expiresAt, isUsableInContent=$isUsableInContent, name=$name, parentFolderId=$parentFolderId, parentFolderPath=$parentFolderPath, additionalProperties=$additionalProperties}"
}
