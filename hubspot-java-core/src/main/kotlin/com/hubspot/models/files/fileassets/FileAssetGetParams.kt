...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): FileAssetGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [FileAssetGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FileAssetGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileAssetGetParams: FileAssetGetParams) = apply {
            fileId = fileAssetGetParams.fileId
            properties = fileAssetGetParams.properties?.toMutableList()
            additionalHeaders = fileAssetGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = fileAssetGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FileAssetGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FileAssetGetParams =
            FileAssetGetParams(
                fileId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FileAssetGetParams &&
            fileId == other.fileId &&
    ...
    override fun toString() =
        "FileAssetGetParams{fileId=$fileId, properties=$properties, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
