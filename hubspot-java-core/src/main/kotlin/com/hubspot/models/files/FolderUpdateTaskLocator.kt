...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FolderUpdateTaskLocator].
         *
    ...
    /** A builder for [FolderUpdateTaskLocator]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(folderUpdateTaskLocator: FolderUpdateTaskLocator) = apply {
            id = folderUpdateTaskLocator.id
            links = folderUpdateTaskLocator.links
            additionalProperties = folderUpdateTaskLocator.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FolderUpdateTaskLocator].
         *
         ...
         */
        fun build(): FolderUpdateTaskLocator =
    ...
    fun validate(): FolderUpdateTaskLocator = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FolderUpdateTaskLocator &&
            id == other.id &&
            links == other.links &&
    ...
    override fun toString() =
        "FolderUpdateTaskLocator{id=$id, links=$links, additionalProperties=$additionalProperties}"
}
