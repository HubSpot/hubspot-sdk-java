...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): FolderGetByIdParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [FolderGetByIdParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FolderGetByIdParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(folderGetByIdParams: FolderGetByIdParams) = apply {
            folderId = folderGetByIdParams.folderId
            properties = folderGetByIdParams.properties?.toMutableList()
            additionalHeaders = folderGetByIdParams.additionalHeaders.toBuilder()
            additionalQueryParams = folderGetByIdParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FolderGetByIdParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FolderGetByIdParams =
            FolderGetByIdParams(
                folderId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FolderGetByIdParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(folderId, properties, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "FolderGetByIdParams{folderId=$folderId, properties=$properties, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
