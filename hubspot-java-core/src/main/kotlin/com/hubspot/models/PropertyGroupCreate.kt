...
private constructor(
    ...
    ) : this(label, name, displayOrder, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PropertyGroupCreate].
         *
    ...
    /** A builder for [PropertyGroupCreate]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(propertyGroupCreate: PropertyGroupCreate) = apply {
            label = propertyGroupCreate.label
            name = propertyGroupCreate.name
            displayOrder = propertyGroupCreate.displayOrder
            additionalProperties = propertyGroupCreate.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PropertyGroupCreate].
         *
    ...
    fun validate(): PropertyGroupCreate = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PropertyGroupCreate &&
            label == other.label &&
            name == other.name &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(label, name, displayOrder, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "PropertyGroupCreate{label=$label, name=$name, displayOrder=$displayOrder, additionalProperties=$additionalProperties}"
}
