...
package com.hubspot.models.scheduler.meetings.basic
...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): BasicListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [BasicListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BasicListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(basicListParams: BasicListParams) = apply {
            after = basicListParams.after
            limit = basicListParams.limit
            name = basicListParams.name
            organizerUserId = basicListParams.organizerUserId
            type = basicListParams.type
            additionalHeaders = basicListParams.additionalHeaders.toBuilder()
            additionalQueryParams = basicListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BasicListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BasicListParams =
            BasicListParams(
                after,
                limit,
                name,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BasicListParams &&
            after == other.after &&
            limit == other.limit &&
            name == other.name &&
    ...
    override fun toString() =
        "BasicListParams{after=$after, limit=$limit, name=$name, organizerUserId=$organizerUserId, type=$type, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
