...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OAuthCreateTokenParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [OAuthCreateTokenParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [OAuthCreateTokenParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(oauthCreateTokenParams: OAuthCreateTokenParams) = apply {
            body = oauthCreateTokenParams.body.toBuilder()
            additionalHeaders = oauthCreateTokenParams.additionalHeaders.toBuilder()
            additionalQueryParams = oauthCreateTokenParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [OAuthCreateTokenParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OAuthCreateTokenParams =
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{clientId=$clientId, clientSecret=$clientSecret, code=$code, codeVerifier=$codeVerifier, grantType=$grantType, redirectUri=$redirectUri, refreshToken=$refreshToken, scope=$scope, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OAuthCreateTokenParams &&
            body == other.body &&
    ...
    override fun toString() =
        "OAuthCreateTokenParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
