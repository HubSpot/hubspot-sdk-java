...
private constructor(
    ...
    /**
     * Defines the operation to be applied in the ranged number property operation (IS_BETWEEN,
     * IS_NOT_BETWEEN).
     *
     * @throws HubSpotInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
    ...
    /** A builder for [PublicRangedNumberPropertyOperation]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            includeObjectsWithNoValueSet =
                publicRangedNumberPropertyOperation.includeObjectsWithNoValueSet
            lowerBound = publicRangedNumberPropertyOperation.lowerBound
            operationType = publicRangedNumberPropertyOperation.operationType
            operator = publicRangedNumberPropertyOperation.operator
            upperBound = publicRangedNumberPropertyOperation.upperBound
            additionalProperties =
                publicRangedNumberPropertyOperation.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicRangedNumberPropertyOperation].
         *
         ...
         */
        fun build(): PublicRangedNumberPropertyOperation =
            PublicRangedNumberPropertyOperation(
    ...
    fun validate(): PublicRangedNumberPropertyOperation = apply {
        if (validated) {
            return@apply
        }
    ...
    class OperationType @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            @JvmField val NUMBER_RANGED = of("NUMBER_RANGED")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicRangedNumberPropertyOperation &&
    ...
    override fun toString() =
        "PublicRangedNumberPropertyOperation{includeObjectsWithNoValueSet=$includeObjectsWithNoValueSet, lowerBound=$lowerBound, operationType=$operationType, operator=$operator, upperBound=$upperBound, additionalProperties=$additionalProperties}"
}
