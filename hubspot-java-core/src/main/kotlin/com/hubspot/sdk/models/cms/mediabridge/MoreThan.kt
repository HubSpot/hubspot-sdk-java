...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MoreThan].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(moreThan: MoreThan) = apply {
            operator = moreThan.operator
            inputs = moreThan.inputs.map { it.toMutableList() }
            propertyName = moreThan.propertyName
            value = moreThan.value
            additionalProperties = moreThan.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MoreThan].
         *
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val MORE_THAN = of("MORE_THAN")
    ...
    override fun toString() =
        "MoreThan{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
