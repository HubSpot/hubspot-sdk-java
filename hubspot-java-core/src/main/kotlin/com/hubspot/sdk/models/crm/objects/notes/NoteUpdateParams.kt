 ...
 * value as specified by the `idProperty` query param. `{noteId}` refers to the internal object ID
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(noteUpdateParams: NoteUpdateParams) = apply {
            ...
            idProperty = noteUpdateParams.idProperty
            simplePublicObjectInput = noteUpdateParams.simplePublicObjectInput
    ...
    override fun toString() =
        "NoteUpdateParams{noteId=$noteId, idProperty=$idProperty, simplePublicObjectInput=$simplePublicObjectInput, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
