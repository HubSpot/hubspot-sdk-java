...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IsMultipleOf].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(isMultipleOf: IsMultipleOf) = apply {
            operator = isMultipleOf.operator
            inputs = isMultipleOf.inputs.map { it.toMutableList() }
            propertyName = isMultipleOf.propertyName
            value = isMultipleOf.value
            additionalProperties = isMultipleOf.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IsMultipleOf].
         *
     ...
     *   expected type.
     */
    fun validate(): IsMultipleOf = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val IS_MULTIPLE_OF = of("IS_MULTIPLE_OF")
        ...
        fun value(): Value =
            when (this) {
                IS_MULTIPLE_OF -> Value.IS_MULTIPLE_OF
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                IS_MULTIPLE_OF -> Known.IS_MULTIPLE_OF
    ...
    override fun toString() =
        "IsMultipleOf{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
