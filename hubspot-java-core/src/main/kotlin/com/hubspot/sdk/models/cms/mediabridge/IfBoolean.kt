...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IfBoolean].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ifBoolean: IfBoolean) = apply {
            enclosedInParentheses = ifBoolean.enclosedInParentheses
            ifExpression = ifBoolean.ifExpression
            operator = ifBoolean.operator
            elseExpression = ifBoolean.elseExpression
            inputs = ifBoolean.inputs.map { it.toMutableList() }
            propertyName = ifBoolean.propertyName
            value = ifBoolean.value
            additionalProperties = ifBoolean.additionalProperties.toMutableMap()
        }
        ...
        /** Alias for calling [ifExpression] with `IfExpression.ofIsBlank(isBlank)`. */
        fun ifExpression(isBlank: IsBlank) = ifExpression(IfExpression.ofIsBlank(isBlank))
        ...
        /** Alias for calling [elseExpression] with `ElseExpression.ofIsBlank(isBlank)`. */
        fun elseExpression(isBlank: IsBlank) = elseExpression(ElseExpression.ofIsBlank(isBlank))
        ...
        /**
         * Returns an immutable instance of [IfBoolean].
         *
    ...
    private constructor(
        ...
        override fun toString(): String =
            when {
                ...
                isBlank != null -> "IfExpression{isBlank=$isBlank}"
        ...
        companion object {
            ...
            @JvmStatic fun ofIsBlank(isBlank: IsBlank) = IfExpression(isBlank = isBlank)
                ...
                val bestMatches =
                    sequenceOf(
                            ...
                            tryDeserialize(node, jacksonTypeRef<IsBlank>())?.let {
                                IfExpression(isBlank = it, _json = json)
                            },
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val IF_BOOLEAN = of("IF_BOOLEAN")
    ...
    private constructor(
        ...
        override fun toString(): String =
            when {
                ...
                isBlank != null -> "ElseExpression{isBlank=$isBlank}"
        ...
        companion object {
            ...
            @JvmStatic fun ofIsBlank(isBlank: IsBlank) = ElseExpression(isBlank = isBlank)
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): ElseExpression {
                ...
                val bestMatches =
                    sequenceOf(
                            ...
                            tryDeserialize(node, jacksonTypeRef<IsBlank>())?.let {
                                ElseExpression(isBlank = it, _json = json)
                            },
                            tryDeserialize(node, jacksonTypeRef<AddTime>())?.let {
    ...
    override fun toString() =
        "IfBoolean{enclosedInParentheses=$enclosedInParentheses, ifExpression=$ifExpression, operator=$operator, elseExpression=$elseExpression, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
