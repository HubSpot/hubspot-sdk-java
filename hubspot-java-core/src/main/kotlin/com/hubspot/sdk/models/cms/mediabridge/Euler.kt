...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [Euler].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(euler: Euler) = apply {
            operator = euler.operator
            propertyName = euler.propertyName
            value = euler.value
            additionalProperties = euler.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [Euler].
         *
    ...
    override fun toString() =
        "Euler{operator=$operator, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
