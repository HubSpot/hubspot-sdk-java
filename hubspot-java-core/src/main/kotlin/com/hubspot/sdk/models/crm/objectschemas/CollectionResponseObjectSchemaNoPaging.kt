...
private constructor(
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<ObjectSchema>> = JsonMissing.of()
     ...
     */
    fun results(): List<ObjectSchema> = results.getRequired("results")
     ...
     */
    @JsonProperty("results") @ExcludeMissing fun _results(): JsonField<List<ObjectSchema>> = results
    ...
    class Builder internal constructor() {
         ...
         *
         * You should usually call [Builder.results] with a well-typed `List<ObjectSchema>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun results(results: JsonField<List<ObjectSchema>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [ObjectSchema] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: ObjectSchema) = apply {
            results =
