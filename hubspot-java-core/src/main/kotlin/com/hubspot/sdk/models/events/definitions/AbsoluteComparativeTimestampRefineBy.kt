...
class AbsoluteComparativeTimestampRefineBy
...
private constructor(
    ...
    /** A builder for [AbsoluteComparativeTimestampRefineBy]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            comparison = absoluteComparativeTimestampRefineBy.comparison
            timestamp = absoluteComparativeTimestampRefineBy.timestamp
            type = absoluteComparativeTimestampRefineBy.type
            additionalProperties =
                absoluteComparativeTimestampRefineBy.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AbsoluteComparativeTimestampRefineBy].
         *
         ...
         */
        fun build(): AbsoluteComparativeTimestampRefineBy =
            AbsoluteComparativeTimestampRefineBy(
     ...
     *   expected type.
     */
    fun validate(): AbsoluteComparativeTimestampRefineBy = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField
            val ABSOLUTE_COMPARATIVE_TIMESTAMP_REFINE_BY =
                of("AbsoluteComparativeTimestampRefineBy")
        ...
        fun value(): Value =
            when (this) {
                ABSOLUTE_COMPARATIVE_TIMESTAMP_REFINE_BY ->
                    Value.ABSOLUTE_COMPARATIVE_TIMESTAMP_REFINE_BY
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                ABSOLUTE_COMPARATIVE_TIMESTAMP_REFINE_BY ->
                    Known.ABSOLUTE_COMPARATIVE_TIMESTAMP_REFINE_BY
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AbsoluteComparativeTimestampRefineBy &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(comparison, timestamp, type, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "AbsoluteComparativeTimestampRefineBy{comparison=$comparison, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
}
