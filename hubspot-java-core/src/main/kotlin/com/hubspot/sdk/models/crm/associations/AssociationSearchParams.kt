...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AssociationSearchParams].
         *
    ...
    /** A builder for [AssociationSearchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(associationSearchParams: AssociationSearchParams) = apply {
            objectType = associationSearchParams.objectType
            publicObjectSearchRequest = associationSearchParams.publicObjectSearchRequest
            additionalHeaders = associationSearchParams.additionalHeaders.toBuilder()
            additionalQueryParams = associationSearchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AssociationSearchParams].
         *
         ...
         */
        fun build(): AssociationSearchParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AssociationSearchParams &&
    ...
    override fun toString() =
        "AssociationSearchParams{objectType=$objectType, publicObjectSearchRequest=$publicObjectSearchRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
