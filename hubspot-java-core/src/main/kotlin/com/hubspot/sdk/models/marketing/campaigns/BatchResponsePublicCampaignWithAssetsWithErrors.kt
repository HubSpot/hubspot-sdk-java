...
class BatchResponsePublicCampaignWithAssetsWithErrors
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val completedAt: JsonField<OffsetDateTime>,
    private val results: JsonField<List<PublicCampaignWithAssets>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<PublicCampaignWithAssets>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<PublicCampaignWithAssets> = results.getRequired("results")
    ...
    /**
     * The current status of the batch operation, which can be CANCELED, COMPLETE, PENDING, or
     * PROCESSING.
     *
     * @throws HubSpotInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
    ...
    /**
     * The list of errors for individual campaign reads that failed within the batch (e.g., campaign
     * not found, permission denied). Only included when non-empty.
     *
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<PublicCampaignWithAssets>> = results
    ...
    /** A builder for [BatchResponsePublicCampaignWithAssetsWithErrors]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<PublicCampaignWithAssets>>? = null
        ...
        internal fun from(
            ...
            completedAt = batchResponsePublicCampaignWithAssetsWithErrors.completedAt
            results =
                batchResponsePublicCampaignWithAssetsWithErrors.results.map { it.toMutableList() }
            startedAt = batchResponsePublicCampaignWithAssetsWithErrors.startedAt
            status = batchResponsePublicCampaignWithAssetsWithErrors.status
            errors =
                batchResponsePublicCampaignWithAssetsWithErrors.errors.map { it.toMutableList() }
            links = batchResponsePublicCampaignWithAssetsWithErrors.links
            numErrors = batchResponsePublicCampaignWithAssetsWithErrors.numErrors
            requestedAt = batchResponsePublicCampaignWithAssetsWithErrors.requestedAt
            additionalProperties =
                batchResponsePublicCampaignWithAssetsWithErrors.additionalProperties.toMutableMap()
        }
        ...
        /** The list of successfully retrieved campaigns with their associated assets. */
        fun results(results: List<PublicCampaignWithAssets>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed
         * `List<PublicCampaignWithAssets>` value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun results(results: JsonField<List<PublicCampaignWithAssets>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [PublicCampaignWithAssets] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: PublicCampaignWithAssets) = apply {
            results =
        ...
        /**
         * The list of errors for individual campaign reads that failed within the batch (e.g.,
         * campaign not found, permission denied). Only included when non-empty.
         */
        ...
        /**
         * Returns an immutable instance of [BatchResponsePublicCampaignWithAssetsWithErrors].
         *
         ...
         */
        fun build(): BatchResponsePublicCampaignWithAssetsWithErrors =
            BatchResponsePublicCampaignWithAssetsWithErrors(
     ...
     *   expected type.
     */
    fun validate(): BatchResponsePublicCampaignWithAssetsWithErrors = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponsePublicCampaignWithAssetsWithErrors &&
    ...
    override fun toString() =
        "BatchResponsePublicCampaignWithAssetsWithErrors{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
