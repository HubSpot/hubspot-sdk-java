...
package com.hubspot.sdk.models.crm.objects.services
...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ServiceGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ServiceGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ServiceGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(serviceGetParams: ServiceGetParams) = apply {
            serviceId = serviceGetParams.serviceId
            archived = serviceGetParams.archived
            associations = serviceGetParams.associations?.toMutableList()
            idProperty = serviceGetParams.idProperty
            properties = serviceGetParams.properties?.toMutableList()
            propertiesWithHistory = serviceGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = serviceGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = serviceGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ServiceGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ServiceGetParams =
            ServiceGetParams(
                serviceId,
                archived,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ServiceGetParams &&
    ...
    override fun toString() =
        "ServiceGetParams{serviceId=$serviceId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
