...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicFiscalYearReference].
         *
    ...
    /** A builder for [PublicFiscalYearReference]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicFiscalYearReference: PublicFiscalYearReference) = apply {
            day = publicFiscalYearReference.day
            month = publicFiscalYearReference.month
            referenceType = publicFiscalYearReference.referenceType
            hour = publicFiscalYearReference.hour
            millisecond = publicFiscalYearReference.millisecond
            minute = publicFiscalYearReference.minute
            second = publicFiscalYearReference.second
            additionalProperties = publicFiscalYearReference.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicFiscalYearReference].
         *
         ...
         */
        fun build(): PublicFiscalYearReference =
     ...
     *   expected type.
     */
    fun validate(): PublicFiscalYearReference = apply {
        if (validated) {
            return@apply
        }
    ...
    class ReferenceType @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            @JvmField val FISCAL_YEAR = of("FISCAL_YEAR")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicFiscalYearReference &&
            day == other.day &&
            month == other.month &&
    ...
    override fun toString() =
        "PublicFiscalYearReference{day=$day, month=$month, referenceType=$referenceType, hour=$hour, millisecond=$millisecond, minute=$minute, second=$second, additionalProperties=$additionalProperties}"
}
