...
class ActionResponseWithResultsSubscriptionDefinition
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val completedAt: JsonField<OffsetDateTime>,
    private val results: JsonField<List<SubscriptionDefinition>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<SubscriptionDefinition>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<SubscriptionDefinition> = results.getRequired("results")
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<SubscriptionDefinition>> = results
    ...
    /** A builder for [ActionResponseWithResultsSubscriptionDefinition]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<SubscriptionDefinition>>? = null
        ...
        internal fun from(
            ...
            completedAt = actionResponseWithResultsSubscriptionDefinition.completedAt
            results =
                actionResponseWithResultsSubscriptionDefinition.results.map { it.toMutableList() }
            startedAt = actionResponseWithResultsSubscriptionDefinition.startedAt
            status = actionResponseWithResultsSubscriptionDefinition.status
            errors =
                actionResponseWithResultsSubscriptionDefinition.errors.map { it.toMutableList() }
            links = actionResponseWithResultsSubscriptionDefinition.links
            numErrors = actionResponseWithResultsSubscriptionDefinition.numErrors
            requestedAt = actionResponseWithResultsSubscriptionDefinition.requestedAt
            additionalProperties =
                actionResponseWithResultsSubscriptionDefinition.additionalProperties.toMutableMap()
        }
        ...
        /** An array containing the results of the operation. */
        fun results(results: List<SubscriptionDefinition>) = results(JsonField.of(results))
         ...
         */
        fun results(results: JsonField<List<SubscriptionDefinition>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [SubscriptionDefinition] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: SubscriptionDefinition) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [ActionResponseWithResultsSubscriptionDefinition].
         *
         ...
         */
        fun build(): ActionResponseWithResultsSubscriptionDefinition =
            ActionResponseWithResultsSubscriptionDefinition(
     ...
     *   expected type.
     */
    fun validate(): ActionResponseWithResultsSubscriptionDefinition = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionResponseWithResultsSubscriptionDefinition &&
    ...
    override fun toString() =
        "ActionResponseWithResultsSubscriptionDefinition{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
