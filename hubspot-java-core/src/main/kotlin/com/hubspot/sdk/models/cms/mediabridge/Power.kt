...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(power: Power) = apply {
            ...
            inputs = power.inputs.map { it.toMutableList() }
    ...
    override fun toString() =
        "Power{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
