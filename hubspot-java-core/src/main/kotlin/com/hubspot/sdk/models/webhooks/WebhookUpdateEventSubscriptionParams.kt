...
class WebhookUpdateEventSubscriptionParams
private constructor(
    ...
    companion object {
         ...
         * [WebhookUpdateEventSubscriptionParams].
         *
    ...
    /** A builder for [WebhookUpdateEventSubscriptionParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            webhookUpdateEventSubscriptionParams: WebhookUpdateEventSubscriptionParams
        ) = apply {
            appId = webhookUpdateEventSubscriptionParams.appId
            subscriptionId = webhookUpdateEventSubscriptionParams.subscriptionId
            subscriptionPatchRequest = webhookUpdateEventSubscriptionParams.subscriptionPatchRequest
            additionalHeaders = webhookUpdateEventSubscriptionParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                webhookUpdateEventSubscriptionParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [WebhookUpdateEventSubscriptionParams].
         *
         ...
         */
        fun build(): WebhookUpdateEventSubscriptionParams =
            WebhookUpdateEventSubscriptionParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebhookUpdateEventSubscriptionParams &&
            appId == other.appId &&
    ...
    override fun toString() =
        "WebhookUpdateEventSubscriptionParams{appId=$appId, subscriptionId=$subscriptionId, subscriptionPatchRequest=$subscriptionPatchRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
