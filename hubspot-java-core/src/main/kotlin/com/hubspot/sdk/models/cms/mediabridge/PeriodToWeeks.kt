...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PeriodToWeeks].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(periodToWeeks: PeriodToWeeks) = apply {
            operator = periodToWeeks.operator
            inputs = periodToWeeks.inputs.map { it.toMutableList() }
            propertyName = periodToWeeks.propertyName
            value = periodToWeeks.value
            additionalProperties = periodToWeeks.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PeriodToWeeks].
         *
     ...
     *   expected type.
     */
    fun validate(): PeriodToWeeks = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val PERIOD_TO_WEEKS = of("PERIOD_TO_WEEKS")
        ...
        fun value(): Value =
            when (this) {
                PERIOD_TO_WEEKS -> Value.PERIOD_TO_WEEKS
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                PERIOD_TO_WEEKS -> Known.PERIOD_TO_WEEKS
    ...
    override fun toString() =
        "PeriodToWeeks{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
