...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SquareRoot].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(squareRoot: SquareRoot) = apply {
            operator = squareRoot.operator
            inputs = squareRoot.inputs.map { it.toMutableList() }
            propertyName = squareRoot.propertyName
            value = squareRoot.value
            additionalProperties = squareRoot.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SquareRoot].
         *
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val SQUARE_ROOT = of("SQUARE_ROOT")
    ...
    override fun toString() =
        "SquareRoot{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
