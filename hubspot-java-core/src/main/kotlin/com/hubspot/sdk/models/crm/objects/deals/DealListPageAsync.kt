...
/** @see DealServiceAsync.list */
class DealListPageAsync
private constructor(
    private val service: DealServiceAsync,
    private val streamHandlerExecutor: Executor,
    private val params: DealListParams,
    ...
    fun nextPageParams(): DealListParams {
        val nextCursor =
            paging()
                .flatMap { it._next().getOptional("next") }
                .flatMap { it._after().getOptional("after") }
    ...
    override fun nextPage(): CompletableFuture<DealListPageAsync> = service.list(nextPageParams())

    fun autoPager(): AutoPagerAsync<SimplePublicObjectWithAssociations> =
        AutoPagerAsync.from(this, streamHandlerExecutor)

    /** The parameters that were used to request this page. */
    fun params(): DealListParams = params
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DealListPageAsync].
         *
    ...
    /** A builder for [DealListPageAsync]. */
    class Builder internal constructor() {

        private var service: DealServiceAsync? = null
        private var streamHandlerExecutor: Executor? = null
        private var params: DealListParams? = null
        private var response: CollectionResponseSimplePublicObjectWithAssociationsForwardPaging? =
            null

        @JvmSynthetic
        internal fun from(dealListPageAsync: DealListPageAsync) = apply {
            service = dealListPageAsync.service
            streamHandlerExecutor = dealListPageAsync.streamHandlerExecutor
            params = dealListPageAsync.params
            response = dealListPageAsync.response
        }

        fun service(service: DealServiceAsync) = apply { this.service = service }
        ...
        /** The parameters that were used to request this page. */
        fun params(params: DealListParams) = apply { this.params = params }
        ...
        /**
         * Returns an immutable instance of [DealListPageAsync].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DealListPageAsync &&
    ...
    override fun toString() =
        "DealListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}
