...
private constructor(
    ...
    private val fromCurrencyCode: FromCurrencyCode?,
    private val limit: Int?,
    private val toCurrencyCode: ToCurrencyCode?,
    ...
    fun fromCurrencyCode(): Optional<FromCurrencyCode> = Optional.ofNullable(fromCurrencyCode)

    /** The maximum number of results to display per page. */
    fun limit(): Optional<Int> = Optional.ofNullable(limit)

    fun toCurrencyCode(): Optional<ToCurrencyCode> = Optional.ofNullable(toCurrencyCode)
    ...
    companion object {
        ...
        @JvmStatic fun none(): ExchangeRateListExchangeRatesParams = builder().build()
    ...
    /** A builder for [ExchangeRateListExchangeRatesParams]. */
    class Builder internal constructor() {

        private var after: String? = null
        private var fromCurrencyCode: FromCurrencyCode? = null
        private var limit: Int? = null
        private var toCurrencyCode: ToCurrencyCode? = null
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        @JvmSynthetic
        internal fun from(
            exchangeRateListExchangeRatesParams: ExchangeRateListExchangeRatesParams
        ) = apply {
            after = exchangeRateListExchangeRatesParams.after
            fromCurrencyCode = exchangeRateListExchangeRatesParams.fromCurrencyCode
            limit = exchangeRateListExchangeRatesParams.limit
            toCurrencyCode = exchangeRateListExchangeRatesParams.toCurrencyCode
            additionalHeaders = exchangeRateListExchangeRatesParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                exchangeRateListExchangeRatesParams.additionalQueryParams.toBuilder()
        }
        ...
        fun fromCurrencyCode(fromCurrencyCode: FromCurrencyCode?) = apply {
            this.fromCurrencyCode = fromCurrencyCode
        }

        /** Alias for calling [Builder.fromCurrencyCode] with `fromCurrencyCode.orElse(null)`. */
        fun fromCurrencyCode(fromCurrencyCode: Optional<FromCurrencyCode>) =
            fromCurrencyCode(fromCurrencyCode.getOrNull())
        ...
        fun toCurrencyCode(toCurrencyCode: ToCurrencyCode?) = apply {
            this.toCurrencyCode = toCurrencyCode
        }

        /** Alias for calling [Builder.toCurrencyCode] with `toCurrencyCode.orElse(null)`. */
        fun toCurrencyCode(toCurrencyCode: Optional<ToCurrencyCode>) =
            toCurrencyCode(toCurrencyCode.getOrNull())
        ...
        /**
         * Returns an immutable instance of [ExchangeRateListExchangeRatesParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ExchangeRateListExchangeRatesParams =
            ExchangeRateListExchangeRatesParams(
                after,
                fromCurrencyCode,
                limit,
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                ...
                fromCurrencyCode?.let { put("fromCurrencyCode", it.toString()) }
                limit?.let { put("limit", it.toString()) }
                toCurrencyCode?.let { put("toCurrencyCode", it.toString()) }
    ...
    class ToCurrencyCode @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            @JvmStatic fun of(value: String) = ToCurrencyCode(JsonField.of(value))
        }

        /** An enum containing [ToCurrencyCode]'s known values. */
        enum class Known {
            AED,
            AFN,
            ALL,
        ...
        /**
         * An enum containing [ToCurrencyCode]'s known values, as well as an [_UNKNOWN] member.
         *
         * An instance of [ToCurrencyCode] can contain an unknown value in a couple of cases:
         * - It was deserialized from data that doesn't match any known member. For example, if the
         *   SDK is on an older version than the API, then the API may respond with new members that
         *   the SDK is unaware of.
         * - It was constructed with an arbitrary value using the [of] method.
        ...
        enum class Value {
            ...
            ZWL,
            /**
             * An enum member indicating that [ToCurrencyCode] was instantiated with an unknown
             * value.
             */
            _UNKNOWN,
        }
         ...
         *   expected type.
         */
        fun validate(): ToCurrencyCode = apply {
            if (validated) {
                return@apply
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is ToCurrencyCode && value == other.value
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExchangeRateListExchangeRatesParams &&
            after == other.after &&
    ...
    override fun toString() =
        "ExchangeRateListExchangeRatesParams{after=$after, fromCurrencyCode=$fromCurrencyCode, limit=$limit, toCurrencyCode=$toCurrencyCode, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
