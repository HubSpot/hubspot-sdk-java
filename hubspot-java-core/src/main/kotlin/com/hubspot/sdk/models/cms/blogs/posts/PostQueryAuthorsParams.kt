...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PostQueryAuthorsParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PostQueryAuthorsParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PostQueryAuthorsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(postQueryAuthorsParams: PostQueryAuthorsParams) = apply {
            after = postQueryAuthorsParams.after
            archived = postQueryAuthorsParams.archived
            createdAfter = postQueryAuthorsParams.createdAfter
            createdAt = postQueryAuthorsParams.createdAt
            createdBefore = postQueryAuthorsParams.createdBefore
            limit = postQueryAuthorsParams.limit
            property = postQueryAuthorsParams.property
            sort = postQueryAuthorsParams.sort?.toMutableList()
            updatedAfter = postQueryAuthorsParams.updatedAfter
            updatedAt = postQueryAuthorsParams.updatedAt
            updatedBefore = postQueryAuthorsParams.updatedBefore
            additionalHeaders = postQueryAuthorsParams.additionalHeaders.toBuilder()
            additionalQueryParams = postQueryAuthorsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PostQueryAuthorsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PostQueryAuthorsParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PostQueryAuthorsParams &&
            after == other.after &&
    ...
    override fun toString() =
        "PostQueryAuthorsParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
