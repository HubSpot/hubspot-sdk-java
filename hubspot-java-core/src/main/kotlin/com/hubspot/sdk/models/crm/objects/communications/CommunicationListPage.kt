...
/** @see CommunicationService.list */
class CommunicationListPage
private constructor(
    ...
    override fun nextPage(): CommunicationListPage = service.list(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CommunicationListPage].
         *
    ...
    /** A builder for [CommunicationListPage]. */
    class Builder internal constructor() {

        private var service: CommunicationService? = null
        ...
        @JvmSynthetic
        internal fun from(communicationListPage: CommunicationListPage) = apply {
            service = communicationListPage.service
            params = communicationListPage.params
            response = communicationListPage.response
        }

        fun service(service: CommunicationService) = apply { this.service = service }
        ...
        /**
         * Returns an immutable instance of [CommunicationListPage].
         *
         ...
         */
        fun build(): CommunicationListPage =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CommunicationListPage &&
    ...
    override fun toString() =
        "CommunicationListPage{service=$service, params=$params, response=$response}"
}
