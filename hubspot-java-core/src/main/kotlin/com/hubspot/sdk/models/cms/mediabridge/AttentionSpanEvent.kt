...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AttentionSpanEvent].
         *
    ...
    /** A builder for [AttentionSpanEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(attentionSpanEvent: AttentionSpanEvent) = apply {
            contactId = attentionSpanEvent.contactId
            mediaBridgeId = attentionSpanEvent.mediaBridgeId
            mediaBridgeObjectCoordinates = attentionSpanEvent.mediaBridgeObjectCoordinates
            mediaBridgeObjectTypeId = attentionSpanEvent.mediaBridgeObjectTypeId
            mediaName = attentionSpanEvent.mediaName
            mediaType = attentionSpanEvent.mediaType
            occurredTimestamp = attentionSpanEvent.occurredTimestamp
            percentRange = attentionSpanEvent.percentRange
            portalId = attentionSpanEvent.portalId
            providerId = attentionSpanEvent.providerId
            sessionId = attentionSpanEvent.sessionId
            totalPercentPlayed = attentionSpanEvent.totalPercentPlayed
            externalPlayContext = attentionSpanEvent.externalPlayContext
            mediaUrl = attentionSpanEvent.mediaUrl
            pageId = attentionSpanEvent.pageId
            pageName = attentionSpanEvent.pageName
            pageObjectCoordinates = attentionSpanEvent.pageObjectCoordinates
            pageUrl = attentionSpanEvent.pageUrl
            rawData = attentionSpanEvent.rawData
            totalSecondsPlayed = attentionSpanEvent.totalSecondsPlayed
            additionalProperties = attentionSpanEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AttentionSpanEvent].
         *
    ...
    fun validate(): AttentionSpanEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AttentionSpanEvent &&
    ...
    override fun toString() =
        "AttentionSpanEvent{contactId=$contactId, mediaBridgeId=$mediaBridgeId, mediaBridgeObjectCoordinates=$mediaBridgeObjectCoordinates, mediaBridgeObjectTypeId=$mediaBridgeObjectTypeId, mediaName=$mediaName, mediaType=$mediaType, occurredTimestamp=$occurredTimestamp, percentRange=$percentRange, portalId=$portalId, providerId=$providerId, sessionId=$sessionId, totalPercentPlayed=$totalPercentPlayed, externalPlayContext=$externalPlayContext, mediaUrl=$mediaUrl, pageId=$pageId, pageName=$pageName, pageObjectCoordinates=$pageObjectCoordinates, pageUrl=$pageUrl, rawData=$rawData, totalSecondsPlayed=$totalSecondsPlayed, additionalProperties=$additionalProperties}"
}
