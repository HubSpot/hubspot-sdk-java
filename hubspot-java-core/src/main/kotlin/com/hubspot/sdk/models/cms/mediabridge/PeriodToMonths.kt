...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PeriodToMonths].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(periodToMonths: PeriodToMonths) = apply {
            operator = periodToMonths.operator
            inputs = periodToMonths.inputs.map { it.toMutableList() }
            propertyName = periodToMonths.propertyName
            value = periodToMonths.value
            additionalProperties = periodToMonths.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PeriodToMonths].
         *
     ...
     *   expected type.
     */
    fun validate(): PeriodToMonths = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val PERIOD_TO_MONTHS = of("PERIOD_TO_MONTHS")
        ...
        fun value(): Value =
            when (this) {
                PERIOD_TO_MONTHS -> Value.PERIOD_TO_MONTHS
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                PERIOD_TO_MONTHS -> Known.PERIOD_TO_MONTHS
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PeriodToMonths &&
    ...
    override fun toString() =
        "PeriodToMonths{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
