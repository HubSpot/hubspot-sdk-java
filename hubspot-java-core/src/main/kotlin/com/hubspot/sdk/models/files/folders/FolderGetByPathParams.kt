...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): FolderGetByPathParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [FolderGetByPathParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FolderGetByPathParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(folderGetByPathParams: FolderGetByPathParams) = apply {
            folderPath = folderGetByPathParams.folderPath
            properties = folderGetByPathParams.properties?.toMutableList()
            additionalHeaders = folderGetByPathParams.additionalHeaders.toBuilder()
            additionalQueryParams = folderGetByPathParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FolderGetByPathParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FolderGetByPathParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FolderGetByPathParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(folderPath, properties, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "FolderGetByPathParams{folderPath=$folderPath, properties=$properties, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
