...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IsPipelineStageClosed].
         *
    ...
    /** A builder for [IsPipelineStageClosed]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(isPipelineStageClosed: IsPipelineStageClosed) = apply {
            operator = isPipelineStageClosed.operator
            inputs = isPipelineStageClosed.inputs.map { it.toMutableList() }
            propertyName = isPipelineStageClosed.propertyName
            value = isPipelineStageClosed.value
            additionalProperties = isPipelineStageClosed.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IsPipelineStageClosed].
         *
         ...
         */
        fun build(): IsPipelineStageClosed =
     ...
     *   expected type.
     */
    fun validate(): IsPipelineStageClosed = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val IS_PIPELINE_STAGE_CLOSED = of("IS_PIPELINE_STAGE_CLOSED")
        ...
        fun value(): Value =
            when (this) {
                IS_PIPELINE_STAGE_CLOSED -> Value.IS_PIPELINE_STAGE_CLOSED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                IS_PIPELINE_STAGE_CLOSED -> Known.IS_PIPELINE_STAGE_CLOSED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IsPipelineStageClosed &&
    ...
    override fun toString() =
        "IsPipelineStageClosed{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
