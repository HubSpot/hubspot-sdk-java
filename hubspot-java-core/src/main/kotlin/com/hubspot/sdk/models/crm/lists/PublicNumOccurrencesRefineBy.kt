...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicNumOccurrencesRefineBy].
         *
    ...
    /** A builder for [PublicNumOccurrencesRefineBy]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicNumOccurrencesRefineBy: PublicNumOccurrencesRefineBy) = apply {
            type = publicNumOccurrencesRefineBy.type
            maxOccurrences = publicNumOccurrencesRefineBy.maxOccurrences
            minOccurrences = publicNumOccurrencesRefineBy.minOccurrences
            additionalProperties = publicNumOccurrencesRefineBy.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicNumOccurrencesRefineBy].
         *
         ...
         */
        fun build(): PublicNumOccurrencesRefineBy =
    ...
    fun validate(): PublicNumOccurrencesRefineBy = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val NUM_OCCURRENCES = of("NUM_OCCURRENCES")
        ...
        fun value(): Value =
            when (this) {
                NUM_OCCURRENCES -> Value.NUM_OCCURRENCES
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                NUM_OCCURRENCES -> Known.NUM_OCCURRENCES
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicNumOccurrencesRefineBy &&
            type == other.type &&
    ...
    override fun toString() =
        "PublicNumOccurrencesRefineBy{type=$type, maxOccurrences=$maxOccurrences, minOccurrences=$minOccurrences, additionalProperties=$additionalProperties}"
}
