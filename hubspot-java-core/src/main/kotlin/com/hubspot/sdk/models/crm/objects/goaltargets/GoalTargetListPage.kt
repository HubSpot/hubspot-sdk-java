...
/** @see GoalTargetService.list */
class GoalTargetListPage
private constructor(
    private val service: GoalTargetService,
    ...
    override fun nextPage(): GoalTargetListPage = service.list(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GoalTargetListPage].
         *
    ...
    /** A builder for [GoalTargetListPage]. */
    class Builder internal constructor() {

        private var service: GoalTargetService? = null
        ...
        @JvmSynthetic
        internal fun from(goalTargetListPage: GoalTargetListPage) = apply {
            service = goalTargetListPage.service
            params = goalTargetListPage.params
            response = goalTargetListPage.response
        }

        fun service(service: GoalTargetService) = apply { this.service = service }
        ...
        /**
         * Returns an immutable instance of [GoalTargetListPage].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GoalTargetListPage &&
    ...
    override fun toString() =
        "GoalTargetListPage{service=$service, params=$params, response=$response}"
}
