...
private constructor(
    ...
    private val primaryLanguage: JsonField<PrimaryLanguage>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        primaryLanguage: JsonField<PrimaryLanguage> = JsonMissing.of(),
     ...
     */
    fun primaryLanguage(): Optional<PrimaryLanguage> =
        primaryLanguage.getOptional("primaryLanguage")
    ...
    @JsonProperty("primaryLanguage")
    @ExcludeMissing
    fun _primaryLanguage(): JsonField<PrimaryLanguage> = primaryLanguage
    ...
    class Builder internal constructor() {
        ...
        private var primaryLanguage: JsonField<PrimaryLanguage> = JsonMissing.of()
        ...
        /** Primary language of the multi-language group. */
        fun primaryLanguage(primaryLanguage: PrimaryLanguage) =
            primaryLanguage(JsonField.of(primaryLanguage))

        /**
         * Sets [Builder.primaryLanguage] to an arbitrary JSON value.
         *
         * You should usually call [Builder.primaryLanguage] with a well-typed [PrimaryLanguage]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun primaryLanguage(primaryLanguage: JsonField<PrimaryLanguage>) = apply {
    ...
    fun validate(): AttachToLangPrimaryRequestVNext = apply {
        ...
        language().validate()
        primaryId()
        primaryLanguage().ifPresent { it.validate() }
        validated = true
    }
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (primaryLanguage.asKnown().getOrNull()?.validity() ?: 0)
    ...
    /** Primary language of the multi-language group. */
    class PrimaryLanguage @JsonCreator private constructor(private val value: JsonField<String>) :
        Enum {
        ...
        companion object {
            ...
            @JvmStatic fun of(value: String) = PrimaryLanguage(JsonField.of(value))
        }

        /** An enum containing [PrimaryLanguage]'s known values. */
        enum class Known {
            AA,
            AB,
            AE,
        ...
        /**
         * An enum containing [PrimaryLanguage]'s known values, as well as an [_UNKNOWN] member.
         *
         * An instance of [PrimaryLanguage] can contain an unknown value in a couple of cases:
         * - It was deserialized from data that doesn't match any known member. For example, if the
         *   SDK is on an older version than the API, then the API may respond with new members that
         *   the SDK is unaware of.
         * - It was constructed with an arbitrary value using the [of] method.
        ...
        enum class Value {
            ...
            ZU_ZA,
            /**
             * An enum member indicating that [PrimaryLanguage] was instantiated with an unknown
             * value.
             */
            _UNKNOWN,
        }
        ...
        fun known(): Known =
            when (this) {
                ...
                ZU -> Known.ZU
                ZU_ZA -> Known.ZU_ZA
                else -> throw HubSpotInvalidDataException("Unknown PrimaryLanguage: $value")
            }
        ...
        fun validate(): PrimaryLanguage = apply {
            if (validated) {
                return@apply
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is PrimaryLanguage && value == other.value
        }
