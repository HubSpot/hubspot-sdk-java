...
private constructor(
    ...
    /**
     * Defines the operation to be applied in the boolean property operation (IS_EQUAL_TO,
     * IS_NOT_EQUAL_TO, HAS_EVER_BEEN_EQUAL_TO, HAS_NEVER_BEEN_EQUAL_TO).
     *
     * @throws HubSpotInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicBoolPropertyOperation].
         *
    ...
    /** A builder for [PublicBoolPropertyOperation]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicBoolPropertyOperation: PublicBoolPropertyOperation) = apply {
            includeObjectsWithNoValueSet = publicBoolPropertyOperation.includeObjectsWithNoValueSet
            operationType = publicBoolPropertyOperation.operationType
            operator = publicBoolPropertyOperation.operator
            value = publicBoolPropertyOperation.value
            additionalProperties = publicBoolPropertyOperation.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicBoolPropertyOperation].
         *
         ...
         */
        fun build(): PublicBoolPropertyOperation =
     ...
     *   expected type.
     */
    fun validate(): PublicBoolPropertyOperation = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicBoolPropertyOperation &&
    ...
    override fun toString() =
        "PublicBoolPropertyOperation{includeObjectsWithNoValueSet=$includeObjectsWithNoValueSet, operationType=$operationType, operator=$operator, value=$value, additionalProperties=$additionalProperties}"
}
