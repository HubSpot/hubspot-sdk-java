...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicNowReference].
         *
    ...
    /** A builder for [PublicNowReference]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicNowReference: PublicNowReference) = apply {
            referenceType = publicNowReference.referenceType
            hour = publicNowReference.hour
            millisecond = publicNowReference.millisecond
            minute = publicNowReference.minute
            second = publicNowReference.second
            additionalProperties = publicNowReference.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicNowReference].
         *
    ...
    fun validate(): PublicNowReference = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicNowReference &&
    ...
    override fun toString() =
        "PublicNowReference{referenceType=$referenceType, hour=$hour, millisecond=$millisecond, minute=$minute, second=$second, additionalProperties=$additionalProperties}"
}
