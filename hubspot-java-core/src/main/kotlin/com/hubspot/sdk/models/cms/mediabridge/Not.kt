...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [Not].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(not: Not) = apply {
            operator = not.operator
            inputs = not.inputs.map { it.toMutableList() }
            propertyName = not.propertyName
            value = not.value
            additionalProperties = not.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [Not].
         *
    ...
    override fun toString() =
        "Not{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
