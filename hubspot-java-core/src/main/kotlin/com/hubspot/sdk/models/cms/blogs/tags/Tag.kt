...
private constructor(
    ...
    override fun toString() =
        "Tag{id=$id, created=$created, deletedAt=$deletedAt, language=$language, name=$name, slug=$slug, translatedFromId=$translatedFromId, updated=$updated, additionalProperties=$additionalProperties}"
}
