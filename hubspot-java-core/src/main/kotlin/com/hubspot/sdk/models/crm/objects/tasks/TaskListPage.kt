...
private constructor(
    ...
    override fun nextPage(): TaskListPage = service.list(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TaskListPage].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(taskListPage: TaskListPage) = apply {
            service = taskListPage.service
            params = taskListPage.params
            response = taskListPage.response
        }

        fun service(service: TaskService) = apply { this.service = service }
        ...
        /**
         * Returns an immutable instance of [TaskListPage].
         *
    ...
    override fun toString() = "TaskListPage{service=$service, params=$params, response=$response}"
}
