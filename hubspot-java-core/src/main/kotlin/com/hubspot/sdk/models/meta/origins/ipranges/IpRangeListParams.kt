...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): IpRangeListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [IpRangeListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [IpRangeListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ipRangeListParams: IpRangeListParams) = apply {
            direction = ipRangeListParams.direction?.toMutableList()
            service = ipRangeListParams.service?.toMutableList()
            additionalHeaders = ipRangeListParams.additionalHeaders.toBuilder()
        ...
        /**
         * Returns an immutable instance of [IpRangeListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): IpRangeListParams =
            IpRangeListParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IpRangeListParams &&
    ...
    override fun toString() =
        "IpRangeListParams{direction=$direction, service=$service, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
