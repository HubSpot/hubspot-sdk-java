...
class MultiStringPropertyOperation
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MultiStringPropertyOperation].
         *
    ...
    /** A builder for [MultiStringPropertyOperation]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(multiStringPropertyOperation: MultiStringPropertyOperation) = apply {
            coalescingRefineBy = multiStringPropertyOperation.coalescingRefineBy
            includeObjectsWithNoValueSet = multiStringPropertyOperation.includeObjectsWithNoValueSet
            operationType = multiStringPropertyOperation.operationType
            operator = multiStringPropertyOperation.operator
            operatorName = multiStringPropertyOperation.operatorName
            propertyType = multiStringPropertyOperation.propertyType
            values = multiStringPropertyOperation.values.map { it.toMutableList() }
            defaultValue = multiStringPropertyOperation.defaultValue
            pruningRefineBy = multiStringPropertyOperation.pruningRefineBy
            renderSpec = multiStringPropertyOperation.renderSpec
            additionalProperties = multiStringPropertyOperation.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MultiStringPropertyOperation].
         *
         ...
         */
        fun build(): MultiStringPropertyOperation =
     ...
     *   expected type.
     */
    fun validate(): MultiStringPropertyOperation = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *     @Override
         *     public Optional<String> visitNumOccurrences(NumOccurrencesRefineBy numOccurrences) {
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CONTAINS_EXACTLY = of("CONTAINS_EXACTLY")

            @JvmField val DOES_NOT_CONTAIN = of("DOES_NOT_CONTAIN")

            @JvmField val DOES_NOT_CONTAIN_EXACTLY = of("DOES_NOT_CONTAIN_EXACTLY")
        ...
        fun value(): Value =
            when (this) {
                ...
                CONTAINS_EXACTLY -> Value.CONTAINS_EXACTLY
                DOES_NOT_CONTAIN -> Value.DOES_NOT_CONTAIN
                DOES_NOT_CONTAIN_EXACTLY -> Value.DOES_NOT_CONTAIN_EXACTLY
        ...
        fun known(): Known =
            when (this) {
                ...
                CONTAINS_EXACTLY -> Known.CONTAINS_EXACTLY
                DOES_NOT_CONTAIN -> Known.DOES_NOT_CONTAIN
                DOES_NOT_CONTAIN_EXACTLY -> Known.DOES_NOT_CONTAIN_EXACTLY
    ...
    class PropertyType @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            @JvmField val MULTISTRING = of("multistring")
    ...
    private constructor(
         ...
         *     @Override
         *     public Optional<String> visitRelativeComparativeTimestamp(RelativeComparativeTimestampRefineBy relativeComparativeTimestamp) {
         *         return Optional.of(relativeComparativeTimestamp.toString());
         *     }
         *
         *     // ...
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MultiStringPropertyOperation &&
    ...
    override fun toString() =
        "MultiStringPropertyOperation{coalescingRefineBy=$coalescingRefineBy, includeObjectsWithNoValueSet=$includeObjectsWithNoValueSet, operationType=$operationType, operator=$operator, operatorName=$operatorName, propertyType=$propertyType, values=$values, defaultValue=$defaultValue, pruningRefineBy=$pruningRefineBy, renderSpec=$renderSpec, additionalProperties=$additionalProperties}"
}
