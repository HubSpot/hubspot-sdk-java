...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SitePageListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [SitePageListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SitePageListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sitePageListParams: SitePageListParams) = apply {
            after = sitePageListParams.after
            archived = sitePageListParams.archived
            createdAfter = sitePageListParams.createdAfter
            createdAt = sitePageListParams.createdAt
            createdBefore = sitePageListParams.createdBefore
            limit = sitePageListParams.limit
            property = sitePageListParams.property
            sort = sitePageListParams.sort?.toMutableList()
            updatedAfter = sitePageListParams.updatedAfter
            updatedAt = sitePageListParams.updatedAt
            updatedBefore = sitePageListParams.updatedBefore
            additionalHeaders = sitePageListParams.additionalHeaders.toBuilder()
            additionalQueryParams = sitePageListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SitePageListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SitePageListParams =
            SitePageListParams(
                after,
                archived,
                createdAfter,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SitePageListParams &&
            after == other.after &&
    ...
    override fun toString() =
        "SitePageListParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
