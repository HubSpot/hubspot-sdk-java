...
/**
 * Retrieve the latest batch of webhook journal entries up to the specified count. This endpoint is
 * useful for fetching recent webhook data for analysis or processing. The count parameter
...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): WebhookGetLatestJournalBatchParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of
         * [WebhookGetLatestJournalBatchParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [WebhookGetLatestJournalBatchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(webhookGetLatestJournalBatchParams: WebhookGetLatestJournalBatchParams) =
            apply {
                count = webhookGetLatestJournalBatchParams.count
                installPortalId = webhookGetLatestJournalBatchParams.installPortalId
                additionalHeaders = webhookGetLatestJournalBatchParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    webhookGetLatestJournalBatchParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [WebhookGetLatestJournalBatchParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): WebhookGetLatestJournalBatchParams =
            WebhookGetLatestJournalBatchParams(
                count,
                installPortalId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebhookGetLatestJournalBatchParams &&
            count == other.count &&
    ...
    override fun toString() =
        "WebhookGetLatestJournalBatchParams{count=$count, installPortalId=$installPortalId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
