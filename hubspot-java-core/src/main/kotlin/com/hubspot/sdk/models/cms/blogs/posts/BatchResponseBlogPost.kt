...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchResponseBlogPost].
         *
    ...
    /** A builder for [BatchResponseBlogPost]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchResponseBlogPost: BatchResponseBlogPost) = apply {
            completedAt = batchResponseBlogPost.completedAt
            results = batchResponseBlogPost.results.map { it.toMutableList() }
            startedAt = batchResponseBlogPost.startedAt
            status = batchResponseBlogPost.status
            links = batchResponseBlogPost.links
            requestedAt = batchResponseBlogPost.requestedAt
            additionalProperties = batchResponseBlogPost.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BatchResponseBlogPost].
         *
         ...
         */
        fun build(): BatchResponseBlogPost =
    ...
    fun validate(): BatchResponseBlogPost = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseBlogPost &&
    ...
    override fun toString() =
        "BatchResponseBlogPost{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, links=$links, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
