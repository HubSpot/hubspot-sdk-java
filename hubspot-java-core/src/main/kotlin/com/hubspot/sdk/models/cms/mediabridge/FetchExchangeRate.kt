...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FetchExchangeRate].
         *
    ...
    /** A builder for [FetchExchangeRate]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fetchExchangeRate: FetchExchangeRate) = apply {
            operator = fetchExchangeRate.operator
            inputs = fetchExchangeRate.inputs.map { it.toMutableList() }
            propertyName = fetchExchangeRate.propertyName
            value = fetchExchangeRate.value
            additionalProperties = fetchExchangeRate.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FetchExchangeRate].
         *
     ...
     *   expected type.
     */
    fun validate(): FetchExchangeRate = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val FETCH_EXCHANGE_RATE = of("FETCH_EXCHANGE_RATE")
        ...
        fun value(): Value =
            when (this) {
                FETCH_EXCHANGE_RATE -> Value.FETCH_EXCHANGE_RATE
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                FETCH_EXCHANGE_RATE -> Known.FETCH_EXCHANGE_RATE
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FetchExchangeRate &&
    ...
    override fun toString() =
        "FetchExchangeRate{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
