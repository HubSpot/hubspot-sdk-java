...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SubtractNumbers].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(subtractNumbers: SubtractNumbers) = apply {
            enclosedInParentheses = subtractNumbers.enclosedInParentheses
            operator = subtractNumbers.operator
            inputs = subtractNumbers.inputs.map { it.toMutableList() }
            propertyName = subtractNumbers.propertyName
            value = subtractNumbers.value
            additionalProperties = subtractNumbers.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SubtractNumbers].
         *
     ...
     *   expected type.
     */
    fun validate(): SubtractNumbers = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val SUBTRACT_NUMBERS = of("SUBTRACT_NUMBERS")
        ...
        fun value(): Value =
            when (this) {
                SUBTRACT_NUMBERS -> Value.SUBTRACT_NUMBERS
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                SUBTRACT_NUMBERS -> Known.SUBTRACT_NUMBERS
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubtractNumbers &&
    ...
    override fun toString() =
        "SubtractNumbers{enclosedInParentheses=$enclosedInParentheses, operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
