...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RecordLimitResponse].
         *
    ...
    /** A builder for [RecordLimitResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(recordLimitResponse: RecordLimitResponse) = apply {
            customObjectTypes = recordLimitResponse.customObjectTypes
            hubSpotDefinedObjectTypes =
                recordLimitResponse.hubSpotDefinedObjectTypes.map { it.toMutableList() }
            additionalProperties = recordLimitResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RecordLimitResponse].
         *
    ...
    fun validate(): RecordLimitResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RecordLimitResponse &&
    ...
    override fun toString() =
        "RecordLimitResponse{customObjectTypes=$customObjectTypes, hubSpotDefinedObjectTypes=$hubSpotDefinedObjectTypes, additionalProperties=$additionalProperties}"
}
