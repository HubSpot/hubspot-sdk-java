...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [StringEquals].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stringEquals: StringEquals) = apply {
            operator = stringEquals.operator
            inputs = stringEquals.inputs.map { it.toMutableList() }
            propertyName = stringEquals.propertyName
            value = stringEquals.value
            additionalProperties = stringEquals.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [StringEquals].
         *
     ...
     *   expected type.
     */
    fun validate(): StringEquals = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val STRING_EQUALS = of("STRING_EQUALS")
        ...
        fun known(): Known =
            when (this) {
                STRING_EQUALS -> Known.STRING_EQUALS
    ...
    override fun toString() =
        "StringEquals{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
