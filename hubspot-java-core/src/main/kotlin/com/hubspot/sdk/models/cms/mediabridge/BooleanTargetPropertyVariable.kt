...
class BooleanTargetPropertyVariable
...
private constructor(
    ...
    /** A builder for [BooleanTargetPropertyVariable]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(booleanTargetPropertyVariable: BooleanTargetPropertyVariable) = apply {
            operator = booleanTargetPropertyVariable.operator
            propertyName = booleanTargetPropertyVariable.propertyName
            value = booleanTargetPropertyVariable.value
            additionalProperties = booleanTargetPropertyVariable.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BooleanTargetPropertyVariable].
         *
         ...
         */
        fun build(): BooleanTargetPropertyVariable =
            BooleanTargetPropertyVariable(
     ...
     *   expected type.
     */
    fun validate(): BooleanTargetPropertyVariable = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val BOOLEAN_TARGET_PROPERTY_VARIABLE = of("BOOLEAN_TARGET_PROPERTY_VARIABLE")
        ...
        fun value(): Value =
            when (this) {
                BOOLEAN_TARGET_PROPERTY_VARIABLE -> Value.BOOLEAN_TARGET_PROPERTY_VARIABLE
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                BOOLEAN_TARGET_PROPERTY_VARIABLE -> Known.BOOLEAN_TARGET_PROPERTY_VARIABLE
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BooleanTargetPropertyVariable &&
    ...
    override fun toString() =
        "BooleanTargetPropertyVariable{operator=$operator, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
