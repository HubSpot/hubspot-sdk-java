...
class FormatSearchablePhoneNumber
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FormatSearchablePhoneNumber].
         *
    ...
    /** A builder for [FormatSearchablePhoneNumber]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(formatSearchablePhoneNumber: FormatSearchablePhoneNumber) = apply {
            operator = formatSearchablePhoneNumber.operator
            inputs = formatSearchablePhoneNumber.inputs.map { it.toMutableList() }
            propertyName = formatSearchablePhoneNumber.propertyName
            value = formatSearchablePhoneNumber.value
            additionalProperties = formatSearchablePhoneNumber.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FormatSearchablePhoneNumber].
         *
         ...
         */
        fun build(): FormatSearchablePhoneNumber =
     ...
     *   expected type.
     */
    fun validate(): FormatSearchablePhoneNumber = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val FORMAT_SEARCHABLE_PHONE_NUMBER = of("FORMAT_SEARCHABLE_PHONE_NUMBER")
        ...
        fun value(): Value =
            when (this) {
                FORMAT_SEARCHABLE_PHONE_NUMBER -> Value.FORMAT_SEARCHABLE_PHONE_NUMBER
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                FORMAT_SEARCHABLE_PHONE_NUMBER -> Known.FORMAT_SEARCHABLE_PHONE_NUMBER
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FormatSearchablePhoneNumber &&
    ...
    override fun toString() =
        "FormatSearchablePhoneNumber{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
