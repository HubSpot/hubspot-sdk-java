...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TaskGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TaskGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TaskGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(taskGetParams: TaskGetParams) = apply {
            taskId = taskGetParams.taskId
            archived = taskGetParams.archived
            associations = taskGetParams.associations?.toMutableList()
            idProperty = taskGetParams.idProperty
            properties = taskGetParams.properties?.toMutableList()
            propertiesWithHistory = taskGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = taskGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = taskGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TaskGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TaskGetParams =
            TaskGetParams(
                taskId,
                archived,
    ...
    override fun toString() =
        "TaskGetParams{taskId=$taskId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
