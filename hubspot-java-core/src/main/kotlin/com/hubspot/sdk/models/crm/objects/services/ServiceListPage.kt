...
private constructor(
    ...
    override fun nextPage(): ServiceListPage = service.list(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ServiceListPage].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(serviceListPage: ServiceListPage) = apply {
            service = serviceListPage.service
            params = serviceListPage.params
            response = serviceListPage.response
        }

        fun service(service: ServiceService) = apply { this.service = service }
        ...
        /**
         * Returns an immutable instance of [ServiceListPage].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ServiceListPage &&
    ...
    override fun toString() =
        "ServiceListPage{service=$service, params=$params, response=$response}"
}
