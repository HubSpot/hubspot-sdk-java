...
class ComparativeBoolPropertyOperation
...
private constructor(
    ...
    /** A builder for [ComparativeBoolPropertyOperation]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(comparativeBoolPropertyOperation: ComparativeBoolPropertyOperation) =
            apply {
                comparisonPropertyName = comparativeBoolPropertyOperation.comparisonPropertyName
                includeObjectsWithNoValueSet =
                    comparativeBoolPropertyOperation.includeObjectsWithNoValueSet
                operationType = comparativeBoolPropertyOperation.operationType
                operator = comparativeBoolPropertyOperation.operator
                operatorName = comparativeBoolPropertyOperation.operatorName
                propertyType = comparativeBoolPropertyOperation.propertyType
                defaultValue = comparativeBoolPropertyOperation.defaultValue
                renderSpec = comparativeBoolPropertyOperation.renderSpec
                additionalProperties =
                    comparativeBoolPropertyOperation.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ComparativeBoolPropertyOperation].
         *
         ...
         */
        fun build(): ComparativeBoolPropertyOperation =
            ComparativeBoolPropertyOperation(
     ...
     *   expected type.
     */
    fun validate(): ComparativeBoolPropertyOperation = apply {
        if (validated) {
            return@apply
        }
    ...
    class PropertyType @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            @JvmField val BOOL_COMPARATIVE = of("bool-comparative")
        ...
        fun value(): Value =
            when (this) {
                BOOL_COMPARATIVE -> Value.BOOL_COMPARATIVE
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                BOOL_COMPARATIVE -> Known.BOOL_COMPARATIVE
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ComparativeBoolPropertyOperation &&
