...
class FunctionCreateOrReplaceParams
private constructor(
    ...
    /** A builder for [FunctionCreateOrReplaceParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(functionCreateOrReplaceParams: FunctionCreateOrReplaceParams) = apply {
            appId = functionCreateOrReplaceParams.appId
            definitionId = functionCreateOrReplaceParams.definitionId
            functionType = functionCreateOrReplaceParams.functionType
            functionId = functionCreateOrReplaceParams.functionId
            body = functionCreateOrReplaceParams.body
            additionalHeaders = functionCreateOrReplaceParams.additionalHeaders.toBuilder()
            additionalQueryParams = functionCreateOrReplaceParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FunctionCreateOrReplaceParams].
         *
         ...
         */
        fun build(): FunctionCreateOrReplaceParams =
            FunctionCreateOrReplaceParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FunctionCreateOrReplaceParams &&
            appId == other.appId &&
    ...
    override fun toString() =
        "FunctionCreateOrReplaceParams{appId=$appId, definitionId=$definitionId, functionType=$functionType, functionId=$functionId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
