...
private constructor(
    ...
    private val results: JsonField<List<MarketingEventPublicDefaultResponse>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<MarketingEventPublicDefaultResponse>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<MarketingEventPublicDefaultResponse> = results.getRequired("results")
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<MarketingEventPublicDefaultResponse>> = results
    ...
    /** A builder for [BatchResponseMarketingEventPublicDefaultResponse]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<MarketingEventPublicDefaultResponse>>? = null
        ...
        internal fun from(
            ...
            completedAt = batchResponseMarketingEventPublicDefaultResponse.completedAt
            results =
                batchResponseMarketingEventPublicDefaultResponse.results.map { it.toMutableList() }
            startedAt = batchResponseMarketingEventPublicDefaultResponse.startedAt
            status = batchResponseMarketingEventPublicDefaultResponse.status
            errors =
                batchResponseMarketingEventPublicDefaultResponse.errors.map { it.toMutableList() }
            links = batchResponseMarketingEventPublicDefaultResponse.links
            numErrors = batchResponseMarketingEventPublicDefaultResponse.numErrors
            requestedAt = batchResponseMarketingEventPublicDefaultResponse.requestedAt
            additionalProperties =
                batchResponseMarketingEventPublicDefaultResponse.additionalProperties.toMutableMap()
        }
        ...
        fun results(results: List<MarketingEventPublicDefaultResponse>) =
         ...
         * `List<MarketingEventPublicDefaultResponse>` value instead. This method is primarily for
         * setting the field to an undocumented or not yet supported value.
         */
        fun results(results: JsonField<List<MarketingEventPublicDefaultResponse>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [MarketingEventPublicDefaultResponse] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: MarketingEventPublicDefaultResponse) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [BatchResponseMarketingEventPublicDefaultResponse].
         *
         ...
         */
        fun build(): BatchResponseMarketingEventPublicDefaultResponse =
            BatchResponseMarketingEventPublicDefaultResponse(
    ...
    fun validate(): BatchResponseMarketingEventPublicDefaultResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseMarketingEventPublicDefaultResponse &&
    ...
    override fun toString() =
        "BatchResponseMarketingEventPublicDefaultResponse{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
