 ...
 * endpoint allows you to retrieve multiple entries from the webhooks journal in a single request,
 * which can be useful for processing large amounts of data efficiently. Ensure that the request
 * body is provided in the required format.
 */
class WebhookGetJournalBatchByRequestParams
private constructor(
    ...
    /**
     * An integer representing the ID of the portal installation for which the webhooks journal data
     * should be retrieved.
     */
    ...
    companion object {
         ...
         * [WebhookGetJournalBatchByRequestParams].
         *
    ...
    /** A builder for [WebhookGetJournalBatchByRequestParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            webhookGetJournalBatchByRequestParams: WebhookGetJournalBatchByRequestParams
        ) = apply {
            installPortalId = webhookGetJournalBatchByRequestParams.installPortalId
            batchInputString = webhookGetJournalBatchByRequestParams.batchInputString
            additionalHeaders = webhookGetJournalBatchByRequestParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                webhookGetJournalBatchByRequestParams.additionalQueryParams.toBuilder()
        }

        /**
         * An integer representing the ID of the portal installation for which the webhooks journal
        ...
        /**
         * Returns an immutable instance of [WebhookGetJournalBatchByRequestParams].
         *
         ...
         */
        fun build(): WebhookGetJournalBatchByRequestParams =
            WebhookGetJournalBatchByRequestParams(
                installPortalId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebhookGetJournalBatchByRequestParams &&
    ...
    override fun toString() =
        "WebhookGetJournalBatchByRequestParams{installPortalId=$installPortalId, batchInputString=$batchInputString, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
