...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HubdbOption].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(hubdbOption: HubdbOption) = apply {
            id = hubdbOption.id
            createdAt = hubdbOption.createdAt
            label = hubdbOption.label
            name = hubdbOption.name
            order = hubdbOption.order
            type = hubdbOption.type
            updatedAt = hubdbOption.updatedAt
            createdBy = hubdbOption.createdBy
            createdByUserId = hubdbOption.createdByUserId
            updatedBy = hubdbOption.updatedBy
            updatedByUserId = hubdbOption.updatedByUserId
            additionalProperties = hubdbOption.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [HubdbOption].
         *
     ...
     *   expected type.
     */
    fun validate(): HubdbOption = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "HubdbOption{id=$id, createdAt=$createdAt, label=$label, name=$name, order=$order, type=$type, updatedAt=$updatedAt, createdBy=$createdBy, createdByUserId=$createdByUserId, updatedBy=$updatedBy, updatedByUserId=$updatedByUserId, additionalProperties=$additionalProperties}"
}
