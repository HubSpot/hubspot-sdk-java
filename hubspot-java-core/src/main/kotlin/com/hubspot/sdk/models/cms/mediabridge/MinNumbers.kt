...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MinNumbers].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(minNumbers: MinNumbers) = apply {
            operator = minNumbers.operator
            inputs = minNumbers.inputs.map { it.toMutableList() }
            propertyName = minNumbers.propertyName
            value = minNumbers.value
            additionalProperties = minNumbers.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MinNumbers].
         *
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val MIN_NUMBERS = of("MIN_NUMBERS")
    ...
    override fun toString() =
        "MinNumbers{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
