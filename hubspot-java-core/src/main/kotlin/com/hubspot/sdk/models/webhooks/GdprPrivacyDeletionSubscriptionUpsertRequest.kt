...
class GdprPrivacyDeletionSubscriptionUpsertRequest
...
private constructor(
    ...
    ) : this(actions, objectTypeId, portalId, subscriptionType, mutableMapOf())
    ...
    /** A builder for [GdprPrivacyDeletionSubscriptionUpsertRequest]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            actions =
                gdprPrivacyDeletionSubscriptionUpsertRequest.actions.map { it.toMutableList() }
            objectTypeId = gdprPrivacyDeletionSubscriptionUpsertRequest.objectTypeId
            portalId = gdprPrivacyDeletionSubscriptionUpsertRequest.portalId
            subscriptionType = gdprPrivacyDeletionSubscriptionUpsertRequest.subscriptionType
            additionalProperties =
                gdprPrivacyDeletionSubscriptionUpsertRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [GdprPrivacyDeletionSubscriptionUpsertRequest].
         *
         ...
         */
        fun build(): GdprPrivacyDeletionSubscriptionUpsertRequest =
            GdprPrivacyDeletionSubscriptionUpsertRequest(
    ...
    fun validate(): GdprPrivacyDeletionSubscriptionUpsertRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GdprPrivacyDeletionSubscriptionUpsertRequest &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(actions, objectTypeId, portalId, subscriptionType, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "GdprPrivacyDeletionSubscriptionUpsertRequest{actions=$actions, objectTypeId=$objectTypeId, portalId=$portalId, subscriptionType=$subscriptionType, additionalProperties=$additionalProperties}"
}
