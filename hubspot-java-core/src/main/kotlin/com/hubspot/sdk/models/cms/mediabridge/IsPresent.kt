...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /**
         * Alias for calling [expressionToEvaluate] with `ExpressionToEvaluate.ofIsBlank(isBlank)`.
         */
        fun expressionToEvaluate(isBlank: IsBlank) =
            expressionToEvaluate(ExpressionToEvaluate.ofIsBlank(isBlank))
    ...
    private constructor(
        ...
        override fun toString(): String =
            when {
                ...
                isBlank != null -> "ExpressionToEvaluate{isBlank=$isBlank}"
        ...
        companion object {
            ...
            @JvmStatic fun ofIsBlank(isBlank: IsBlank) = ExpressionToEvaluate(isBlank = isBlank)
                ...
                val bestMatches =
                    sequenceOf(
                            ...
                            tryDeserialize(node, jacksonTypeRef<IsBlank>())?.let {
                                ExpressionToEvaluate(isBlank = it, _json = json)
                            },
