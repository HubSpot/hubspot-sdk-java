...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchResponsePage].
         *
    ...
    /** A builder for [BatchResponsePage]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchResponsePage: BatchResponsePage) = apply {
            completedAt = batchResponsePage.completedAt
            results = batchResponsePage.results.map { it.toMutableList() }
            startedAt = batchResponsePage.startedAt
            status = batchResponsePage.status
            links = batchResponsePage.links
            requestedAt = batchResponsePage.requestedAt
            additionalProperties = batchResponsePage.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BatchResponsePage].
         *
     ...
     *   expected type.
     */
    fun validate(): BatchResponsePage = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponsePage &&
    ...
    override fun toString() =
        "BatchResponsePage{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, links=$links, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
