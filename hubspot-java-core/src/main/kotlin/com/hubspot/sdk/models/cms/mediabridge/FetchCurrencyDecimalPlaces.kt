...
class FetchCurrencyDecimalPlaces
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FetchCurrencyDecimalPlaces].
         *
    ...
    /** A builder for [FetchCurrencyDecimalPlaces]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fetchCurrencyDecimalPlaces: FetchCurrencyDecimalPlaces) = apply {
            operator = fetchCurrencyDecimalPlaces.operator
            inputs = fetchCurrencyDecimalPlaces.inputs.map { it.toMutableList() }
            propertyName = fetchCurrencyDecimalPlaces.propertyName
            value = fetchCurrencyDecimalPlaces.value
            additionalProperties = fetchCurrencyDecimalPlaces.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FetchCurrencyDecimalPlaces].
         *
         ...
         */
        fun build(): FetchCurrencyDecimalPlaces =
     ...
     *   expected type.
     */
    fun validate(): FetchCurrencyDecimalPlaces = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val FETCH_CURRENCY_DECIMAL_PLACES = of("FETCH_CURRENCY_DECIMAL_PLACES")
        ...
        fun value(): Value =
            when (this) {
                FETCH_CURRENCY_DECIMAL_PLACES -> Value.FETCH_CURRENCY_DECIMAL_PLACES
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                FETCH_CURRENCY_DECIMAL_PLACES -> Known.FETCH_CURRENCY_DECIMAL_PLACES
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FetchCurrencyDecimalPlaces &&
    ...
    override fun toString() =
        "FetchCurrencyDecimalPlaces{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
