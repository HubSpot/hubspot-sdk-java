...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IsBlank].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(isBlank: IsBlank) = apply {
            operator = isBlank.operator
            inputs = isBlank.inputs.map { it.toMutableList() }
            propertyName = isBlank.propertyName
            value = isBlank.value
            additionalProperties = isBlank.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IsBlank].
         *
    ...
    override fun toString() =
        "IsBlank{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
