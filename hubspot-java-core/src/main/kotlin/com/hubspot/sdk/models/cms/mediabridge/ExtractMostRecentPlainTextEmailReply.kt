...
private constructor(
    ...
    /** A builder for [ExtractMostRecentPlainTextEmailReply]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            operator = extractMostRecentPlainTextEmailReply.operator
            inputs = extractMostRecentPlainTextEmailReply.inputs.map { it.toMutableList() }
            propertyName = extractMostRecentPlainTextEmailReply.propertyName
            value = extractMostRecentPlainTextEmailReply.value
            additionalProperties =
                extractMostRecentPlainTextEmailReply.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExtractMostRecentPlainTextEmailReply].
         *
         ...
         */
        fun build(): ExtractMostRecentPlainTextEmailReply =
            ExtractMostRecentPlainTextEmailReply(
     ...
     *   expected type.
     */
    fun validate(): ExtractMostRecentPlainTextEmailReply = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField
            val EXTRACT_MOST_RECENT_PLAIN_TEXT_EMAIL_REPLY =
                of("EXTRACT_MOST_RECENT_PLAIN_TEXT_EMAIL_REPLY")
        ...
        fun value(): Value =
            when (this) {
                EXTRACT_MOST_RECENT_PLAIN_TEXT_EMAIL_REPLY ->
                    Value.EXTRACT_MOST_RECENT_PLAIN_TEXT_EMAIL_REPLY
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                EXTRACT_MOST_RECENT_PLAIN_TEXT_EMAIL_REPLY ->
                    Known.EXTRACT_MOST_RECENT_PLAIN_TEXT_EMAIL_REPLY
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExtractMostRecentPlainTextEmailReply &&
    ...
    override fun toString() =
        "ExtractMostRecentPlainTextEmailReply{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
