...
class ComparativePropertyUpdatedOperation
...
private constructor(
    ...
    /** A builder for [ComparativePropertyUpdatedOperation]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            comparisonPropertyName = comparativePropertyUpdatedOperation.comparisonPropertyName
            includeObjectsWithNoValueSet =
                comparativePropertyUpdatedOperation.includeObjectsWithNoValueSet
            operationType = comparativePropertyUpdatedOperation.operationType
            operator = comparativePropertyUpdatedOperation.operator
            operatorName = comparativePropertyUpdatedOperation.operatorName
            propertyType = comparativePropertyUpdatedOperation.propertyType
            defaultComparisonValue = comparativePropertyUpdatedOperation.defaultComparisonValue
            defaultValue = comparativePropertyUpdatedOperation.defaultValue
            renderSpec = comparativePropertyUpdatedOperation.renderSpec
            additionalProperties =
                comparativePropertyUpdatedOperation.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ComparativePropertyUpdatedOperation].
         *
         ...
         */
        fun build(): ComparativePropertyUpdatedOperation =
            ComparativePropertyUpdatedOperation(
     ...
     *   expected type.
     */
    fun validate(): ComparativePropertyUpdatedOperation = apply {
        if (validated) {
            return@apply
        }
    ...
    class PropertyType @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            @JvmField val PROPERTY_UPDATED_COMPARATIVE = of("property-updated-comparative")
        ...
        fun value(): Value =
            when (this) {
                PROPERTY_UPDATED_COMPARATIVE -> Value.PROPERTY_UPDATED_COMPARATIVE
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                PROPERTY_UPDATED_COMPARATIVE -> Known.PROPERTY_UPDATED_COMPARATIVE
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ComparativePropertyUpdatedOperation &&
