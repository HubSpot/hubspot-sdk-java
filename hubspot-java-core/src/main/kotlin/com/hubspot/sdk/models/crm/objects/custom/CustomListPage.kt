...
private constructor(
    ...
    override fun nextPage(): CustomListPage = service.list(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CustomListPage].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(customListPage: CustomListPage) = apply {
            service = customListPage.service
            params = customListPage.params
            response = customListPage.response
        }

        fun service(service: CustomService) = apply { this.service = service }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomListPage &&
    ...
    override fun toString() = "CustomListPage{service=$service, params=$params, response=$response}"
}
