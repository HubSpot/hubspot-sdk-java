...
class DeveloperQualifiedSymbol
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DeveloperQualifiedSymbol].
         *
    ...
    /** A builder for [DeveloperQualifiedSymbol]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(developerQualifiedSymbol: DeveloperQualifiedSymbol) = apply {
            developerSymbol = developerQualifiedSymbol.developerSymbol
            projectName = developerQualifiedSymbol.projectName
            additionalProperties = developerQualifiedSymbol.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DeveloperQualifiedSymbol].
         *
         ...
         */
        fun build(): DeveloperQualifiedSymbol =
     ...
     *   expected type.
     */
    fun validate(): DeveloperQualifiedSymbol = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DeveloperQualifiedSymbol &&
    ...
    override fun toString() =
        "DeveloperQualifiedSymbol{developerSymbol=$developerSymbol, projectName=$projectName, additionalProperties=$additionalProperties}"
}
