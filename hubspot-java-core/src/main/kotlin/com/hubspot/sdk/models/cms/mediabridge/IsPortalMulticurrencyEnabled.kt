...
class IsPortalMulticurrencyEnabled
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IsPortalMulticurrencyEnabled].
         *
    ...
    /** A builder for [IsPortalMulticurrencyEnabled]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(isPortalMulticurrencyEnabled: IsPortalMulticurrencyEnabled) = apply {
            operator = isPortalMulticurrencyEnabled.operator
            propertyName = isPortalMulticurrencyEnabled.propertyName
            value = isPortalMulticurrencyEnabled.value
            additionalProperties = isPortalMulticurrencyEnabled.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IsPortalMulticurrencyEnabled].
         *
         ...
         */
        fun build(): IsPortalMulticurrencyEnabled =
     ...
     *   expected type.
     */
    fun validate(): IsPortalMulticurrencyEnabled = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val IS_PORTAL_MULTICURRENCY_ENABLED = of("IS_PORTAL_MULTICURRENCY_ENABLED")
        ...
        fun value(): Value =
            when (this) {
                IS_PORTAL_MULTICURRENCY_ENABLED -> Value.IS_PORTAL_MULTICURRENCY_ENABLED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                IS_PORTAL_MULTICURRENCY_ENABLED -> Known.IS_PORTAL_MULTICURRENCY_ENABLED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IsPortalMulticurrencyEnabled &&
    ...
    override fun toString() =
        "IsPortalMulticurrencyEnabled{operator=$operator, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
