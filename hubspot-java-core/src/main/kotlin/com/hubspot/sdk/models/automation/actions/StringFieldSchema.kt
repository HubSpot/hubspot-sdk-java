...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [StringFieldSchema].
         *
    ...
    /** A builder for [StringFieldSchema]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(stringFieldSchema: StringFieldSchema) = apply {
            type = stringFieldSchema.type
            format = stringFieldSchema.format
        ...
        /**
         * Returns an immutable instance of [StringFieldSchema].
         *
     ...
     *   expected type.
     */
    fun validate(): StringFieldSchema = apply {
        if (validated) {
            return@apply
        }
    ...
    class Format @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val OBJECT_COORDINATE = of("OBJECT_COORDINATE")
        ...
        fun value(): Value =
            when (this) {
                ...
                OBJECT_COORDINATE -> Value.OBJECT_COORDINATE
                TIME -> Value.TIME
                URI -> Value.URI
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                ...
                OBJECT_COORDINATE -> Known.OBJECT_COORDINATE
                TIME -> Known.TIME
                URI -> Known.URI
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StringFieldSchema &&
            type == other.type &&
            format == other.format &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(type, format, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "StringFieldSchema{type=$type, format=$format, additionalProperties=$additionalProperties}"
}
