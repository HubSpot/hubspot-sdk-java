...
class CollectionResponsePublicCampaignAsset
...
private constructor(
    ...
    /**
     * An array of public campaign assets. Each item in the array is an object representing a
     * campaign asset.
     *
    ...
    /** A builder for [CollectionResponsePublicCampaignAsset]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            collectionResponsePublicCampaignAsset: CollectionResponsePublicCampaignAsset
        ) = apply {
            results = collectionResponsePublicCampaignAsset.results.map { it.toMutableList() }
            paging = collectionResponsePublicCampaignAsset.paging
            additionalProperties =
                collectionResponsePublicCampaignAsset.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CollectionResponsePublicCampaignAsset].
         *
         ...
         */
        fun build(): CollectionResponsePublicCampaignAsset =
            CollectionResponsePublicCampaignAsset(
    ...
    fun validate(): CollectionResponsePublicCampaignAsset = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionResponsePublicCampaignAsset &&
    ...
    override fun toString() =
        "CollectionResponsePublicCampaignAsset{results=$results, paging=$paging, additionalProperties=$additionalProperties}"
}
