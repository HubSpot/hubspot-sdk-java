...
/**
 * Perform a partial update of an Object identified by `{quoteId}`or optionally a unique property
 * value as specified by the `idProperty` query param. `{quoteId}` refers to the internal object ID
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(quoteUpdateParams: QuoteUpdateParams) = apply {
            ...
            idProperty = quoteUpdateParams.idProperty
            simplePublicObjectInput = quoteUpdateParams.simplePublicObjectInput
    ...
    override fun toString() =
        "QuoteUpdateParams{quoteId=$quoteId, idProperty=$idProperty, simplePublicObjectInput=$simplePublicObjectInput, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
