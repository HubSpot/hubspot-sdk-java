...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AuthorGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AuthorGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AuthorGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(authorGetParams: AuthorGetParams) = apply {
            objectId = authorGetParams.objectId
            archived = authorGetParams.archived
            property = authorGetParams.property
            additionalHeaders = authorGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = authorGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AuthorGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AuthorGetParams =
            AuthorGetParams(
                objectId,
                archived,
                property,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AuthorGetParams &&
    ...
    override fun toString() =
        "AuthorGetParams{objectId=$objectId, archived=$archived, property=$property, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
