...
class ExternalObjectResolutionMappingResponse
...
private constructor(
    ...
    /** A builder for [ExternalObjectResolutionMappingResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            externalObjectResolutionMappingResponse: ExternalObjectResolutionMappingResponse
        ) = apply {
            primaryObjectRule = externalObjectResolutionMappingResponse.primaryObjectRule
            additionalProperties =
                externalObjectResolutionMappingResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExternalObjectResolutionMappingResponse].
         *
         ...
         */
        fun build(): ExternalObjectResolutionMappingResponse =
            ExternalObjectResolutionMappingResponse(
    ...
    fun validate(): ExternalObjectResolutionMappingResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExternalObjectResolutionMappingResponse &&
    ...
    override fun toString() =
        "ExternalObjectResolutionMappingResponse{primaryObjectRule=$primaryObjectRule, additionalProperties=$additionalProperties}"
}
