...
/**
 * Replace a single row in the draft version of a table. All column values must be specified. If a
 * column has a value in the target table and this request doesn't define that value, it will be
 * deleted. See the "Create a row" endpoint for instructions on how to format the JSON row
 * definitions.
 */
class RowReplaceDraftParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RowReplaceDraftParams].
         *
    ...
    /** A builder for [RowReplaceDraftParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rowReplaceDraftParams: RowReplaceDraftParams) = apply {
            tableIdOrName = rowReplaceDraftParams.tableIdOrName
            rowId = rowReplaceDraftParams.rowId
            hubDbTableRowV3Request = rowReplaceDraftParams.hubDbTableRowV3Request
            additionalHeaders = rowReplaceDraftParams.additionalHeaders.toBuilder()
            additionalQueryParams = rowReplaceDraftParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [RowReplaceDraftParams].
         *
         ...
         */
        fun build(): RowReplaceDraftParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RowReplaceDraftParams &&
    ...
    override fun toString() =
        "RowReplaceDraftParams{tableIdOrName=$tableIdOrName, rowId=$rowId, hubDbTableRowV3Request=$hubDbTableRowV3Request, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
