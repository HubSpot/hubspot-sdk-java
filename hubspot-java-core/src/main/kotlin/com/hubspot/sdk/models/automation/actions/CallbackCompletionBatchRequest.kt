...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(callbackCompletionBatchRequest: CallbackCompletionBatchRequest) = apply {
            ...
            typedOutputs = callbackCompletionBatchRequest.typedOutputs
            failureReasonType = callbackCompletionBatchRequest.failureReasonType
            requestContext = callbackCompletionBatchRequest.requestContext
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = requestContext.accept(new RequestContext.Visitor<Optional<String>>() {
         *     @Override
         *     public Optional<String> visitWorkflows(WorkflowsRequestContext workflows) {
         *         return Optional.of(workflows.toString());
         *     }
         *
         *     // ...
         *
    ...
    override fun toString() =
        "CallbackCompletionBatchRequest{callbackId=$callbackId, outputFields=$outputFields, typedOutputs=$typedOutputs, failureReasonType=$failureReasonType, requestContext=$requestContext, additionalProperties=$additionalProperties}"
}
