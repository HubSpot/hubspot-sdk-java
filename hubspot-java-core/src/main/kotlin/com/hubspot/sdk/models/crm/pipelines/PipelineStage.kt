...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun writePermissions(): WritePermissions = writePermissions.getRequired("writePermissions")
    ...
    class Builder internal constructor() {
        ...
        private var writePermissions: JsonField<WritePermissions>? = null
        ...
        fun build(): PipelineStage =
            PipelineStage(
                ...
                checkRequired("writePermissions", writePermissions),
                archivedAt,
    ...
    override fun toString() =
        "PipelineStage{id=$id, archived=$archived, createdAt=$createdAt, displayOrder=$displayOrder, label=$label, metadata=$metadata, updatedAt=$updatedAt, writePermissions=$writePermissions, archivedAt=$archivedAt, additionalProperties=$additionalProperties}"
}
