...
/**
 * Read an Object identified by `{dealId}`. `{dealId}` refers to the internal object ID by default,
...
private constructor(
    ...
    fun dealId(): Optional<String> = Optional.ofNullable(dealId)
    ...
    companion object {
        ...
        @JvmStatic fun none(): DealGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [DealGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DealGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dealGetParams: DealGetParams) = apply {
            dealId = dealGetParams.dealId
            archived = dealGetParams.archived
            associations = dealGetParams.associations?.toMutableList()
            idProperty = dealGetParams.idProperty
            properties = dealGetParams.properties?.toMutableList()
            propertiesWithHistory = dealGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = dealGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = dealGetParams.additionalQueryParams.toBuilder()
        }

        fun dealId(dealId: String?) = apply { this.dealId = dealId }

        /** Alias for calling [Builder.dealId] with `dealId.orElse(null)`. */
        fun dealId(dealId: Optional<String>) = dealId(dealId.getOrNull())
        ...
        /**
         * Returns an immutable instance of [DealGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DealGetParams =
            DealGetParams(
                dealId,
                archived,
    ...
    override fun toString() =
        "DealGetParams{dealId=$dealId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
