...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CrmFilter].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(crmFilter: CrmFilter) = apply {
            operator = crmFilter.operator
            propertyName = crmFilter.propertyName
            highValue = crmFilter.highValue
            value = crmFilter.value
            values = crmFilter.values.map { it.toMutableList() }
            additionalProperties = crmFilter.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CrmFilter].
         *
    ...
    override fun toString() =
        "CrmFilter{operator=$operator, propertyName=$propertyName, highValue=$highValue, value=$value, values=$values, additionalProperties=$additionalProperties}"
}
