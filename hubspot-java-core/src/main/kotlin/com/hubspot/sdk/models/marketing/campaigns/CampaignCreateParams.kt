 ...
 * including its ID. Note that the 'hs_goal' property is deprecated and will be ignored if provided.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(campaignCreateParams: CampaignCreateParams) = apply {
            publicCampaignInput = campaignCreateParams.publicCampaignInput
    ...
    override fun hashCode(): Int =
        Objects.hash(publicCampaignInput, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "CampaignCreateParams{publicCampaignInput=$publicCampaignInput, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
