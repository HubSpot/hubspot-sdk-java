...
private constructor(
    ...
    ) : this(enclosedInParentheses, operator, inputs, propertyName, value, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MultiplyNumbers].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(multiplyNumbers: MultiplyNumbers) = apply {
            enclosedInParentheses = multiplyNumbers.enclosedInParentheses
            operator = multiplyNumbers.operator
            inputs = multiplyNumbers.inputs.map { it.toMutableList() }
            propertyName = multiplyNumbers.propertyName
            value = multiplyNumbers.value
            additionalProperties = multiplyNumbers.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MultiplyNumbers].
         *
     ...
     *   expected type.
     */
    fun validate(): MultiplyNumbers = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val MULTIPLY_NUMBERS = of("MULTIPLY_NUMBERS")
        ...
        fun value(): Value =
            when (this) {
                MULTIPLY_NUMBERS -> Value.MULTIPLY_NUMBERS
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                MULTIPLY_NUMBERS -> Known.MULTIPLY_NUMBERS
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MultiplyNumbers &&
    ...
    override fun toString() =
        "MultiplyNumbers{enclosedInParentheses=$enclosedInParentheses, operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
