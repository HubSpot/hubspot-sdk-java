...
class CollectionResponseWithTotalParticipationBreakdown
...
private constructor(
    ...
    /** A builder for [CollectionResponseWithTotalParticipationBreakdown]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            results =
                collectionResponseWithTotalParticipationBreakdown.results.map { it.toMutableList() }
            total = collectionResponseWithTotalParticipationBreakdown.total
            paging = collectionResponseWithTotalParticipationBreakdown.paging
            additionalProperties =
                collectionResponseWithTotalParticipationBreakdown.additionalProperties
                    .toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CollectionResponseWithTotalParticipationBreakdown].
         *
         ...
         */
        fun build(): CollectionResponseWithTotalParticipationBreakdown =
            CollectionResponseWithTotalParticipationBreakdown(
    ...
    fun validate(): CollectionResponseWithTotalParticipationBreakdown = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionResponseWithTotalParticipationBreakdown &&
    ...
    override fun toString() =
        "CollectionResponseWithTotalParticipationBreakdown{results=$results, total=$total, paging=$paging, additionalProperties=$additionalProperties}"
}
