...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PostalMailSearchParams].
         *
    ...
    /** A builder for [PostalMailSearchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(postalMailSearchParams: PostalMailSearchParams) = apply {
            publicObjectSearchRequest = postalMailSearchParams.publicObjectSearchRequest
            additionalHeaders = postalMailSearchParams.additionalHeaders.toBuilder()
            additionalQueryParams = postalMailSearchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PostalMailSearchParams].
         *
         ...
         */
        fun build(): PostalMailSearchParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PostalMailSearchParams &&
    ...
    override fun toString() =
        "PostalMailSearchParams{publicObjectSearchRequest=$publicObjectSearchRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
