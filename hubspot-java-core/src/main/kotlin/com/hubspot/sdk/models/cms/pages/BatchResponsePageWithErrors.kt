...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchResponsePageWithErrors].
         *
    ...
    /** A builder for [BatchResponsePageWithErrors]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchResponsePageWithErrors: BatchResponsePageWithErrors) = apply {
            completedAt = batchResponsePageWithErrors.completedAt
            results = batchResponsePageWithErrors.results.map { it.toMutableList() }
            startedAt = batchResponsePageWithErrors.startedAt
            status = batchResponsePageWithErrors.status
            errors = batchResponsePageWithErrors.errors.map { it.toMutableList() }
            links = batchResponsePageWithErrors.links
            numErrors = batchResponsePageWithErrors.numErrors
            requestedAt = batchResponsePageWithErrors.requestedAt
            additionalProperties = batchResponsePageWithErrors.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BatchResponsePageWithErrors].
         *
         ...
         */
        fun build(): BatchResponsePageWithErrors =
     ...
     *   expected type.
     */
    fun validate(): BatchResponsePageWithErrors = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponsePageWithErrors &&
    ...
    override fun toString() =
        "BatchResponsePageWithErrors{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
