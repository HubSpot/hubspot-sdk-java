...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FetchPortalHomeCurrency].
         *
    ...
    /** A builder for [FetchPortalHomeCurrency]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fetchPortalHomeCurrency: FetchPortalHomeCurrency) = apply {
            operator = fetchPortalHomeCurrency.operator
            propertyName = fetchPortalHomeCurrency.propertyName
            value = fetchPortalHomeCurrency.value
            additionalProperties = fetchPortalHomeCurrency.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FetchPortalHomeCurrency].
         *
         ...
         */
        fun build(): FetchPortalHomeCurrency =
     ...
     *   expected type.
     */
    fun validate(): FetchPortalHomeCurrency = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val FETCH_PORTAL_HOME_CURRENCY = of("FETCH_PORTAL_HOME_CURRENCY")
        ...
        fun value(): Value =
            when (this) {
                FETCH_PORTAL_HOME_CURRENCY -> Value.FETCH_PORTAL_HOME_CURRENCY
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                FETCH_PORTAL_HOME_CURRENCY -> Known.FETCH_PORTAL_HOME_CURRENCY
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FetchPortalHomeCurrency &&
    ...
    override fun toString() =
        "FetchPortalHomeCurrency{operator=$operator, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
