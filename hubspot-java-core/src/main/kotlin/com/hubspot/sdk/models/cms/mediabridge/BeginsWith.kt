...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BeginsWith].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(beginsWith: BeginsWith) = apply {
            operator = beginsWith.operator
            stringToCheck = beginsWith.stringToCheck
            inputs = beginsWith.inputs.map { it.toMutableList() }
            propertyName = beginsWith.propertyName
            value = beginsWith.value
            additionalProperties = beginsWith.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BeginsWith].
         *
    ...
    override fun toString() =
        "BeginsWith{operator=$operator, stringToCheck=$stringToCheck, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
