...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TaskListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TaskListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TaskListParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(taskListParams: TaskListParams) = apply {
            after = taskListParams.after
            archived = taskListParams.archived
            associations = taskListParams.associations?.toMutableList()
            limit = taskListParams.limit
            properties = taskListParams.properties?.toMutableList()
            propertiesWithHistory = taskListParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = taskListParams.additionalHeaders.toBuilder()
            additionalQueryParams = taskListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TaskListParams].
         *
    ...
    override fun toString() =
        "TaskListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
