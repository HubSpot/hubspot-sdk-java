...
private constructor(
    ...
    companion object {
         ...
         * [WebhookGetJournalBatchFromOffsetParams].
         *
    ...
    /** A builder for [WebhookGetJournalBatchFromOffsetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            webhookGetJournalBatchFromOffsetParams: WebhookGetJournalBatchFromOffsetParams
        ) = apply {
            offset = webhookGetJournalBatchFromOffsetParams.offset
            count = webhookGetJournalBatchFromOffsetParams.count
            installPortalId = webhookGetJournalBatchFromOffsetParams.installPortalId
            additionalHeaders = webhookGetJournalBatchFromOffsetParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                webhookGetJournalBatchFromOffsetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [WebhookGetJournalBatchFromOffsetParams].
         *
         ...
         */
        fun build(): WebhookGetJournalBatchFromOffsetParams =
            WebhookGetJournalBatchFromOffsetParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebhookGetJournalBatchFromOffsetParams &&
            offset == other.offset &&
            count == other.count &&
    ...
    override fun toString() =
        "WebhookGetJournalBatchFromOffsetParams{offset=$offset, count=$count, installPortalId=$installPortalId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
