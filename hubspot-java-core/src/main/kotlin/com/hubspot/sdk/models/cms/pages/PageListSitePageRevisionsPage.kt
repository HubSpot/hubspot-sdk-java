...
/** @see PageService.listSitePageRevisions */
class PageListSitePageRevisionsPage
private constructor(
    ...
    override fun nextPage(): PageListSitePageRevisionsPage =
    ...
    /** A builder for [PageListSitePageRevisionsPage]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pageListSitePageRevisionsPage: PageListSitePageRevisionsPage) = apply {
            service = pageListSitePageRevisionsPage.service
            params = pageListSitePageRevisionsPage.params
            response = pageListSitePageRevisionsPage.response
        }
        ...
        /**
         * Returns an immutable instance of [PageListSitePageRevisionsPage].
         *
         ...
         */
        fun build(): PageListSitePageRevisionsPage =
            PageListSitePageRevisionsPage(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PageListSitePageRevisionsPage &&
    ...
    override fun toString() =
        "PageListSitePageRevisionsPage{service=$service, params=$params, response=$response}"
}
