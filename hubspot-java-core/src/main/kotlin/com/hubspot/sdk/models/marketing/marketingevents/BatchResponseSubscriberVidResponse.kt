...
private constructor(
    ...
    private val results: JsonField<List<SubscriberVidResponse>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<SubscriberVidResponse>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<SubscriberVidResponse> = results.getRequired("results")
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<SubscriberVidResponse>> = results
    ...
    /** A builder for [BatchResponseSubscriberVidResponse]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<SubscriberVidResponse>>? = null
        ...
        @JvmSynthetic
        internal fun from(batchResponseSubscriberVidResponse: BatchResponseSubscriberVidResponse) =
            apply {
                completedAt = batchResponseSubscriberVidResponse.completedAt
                results = batchResponseSubscriberVidResponse.results.map { it.toMutableList() }
                startedAt = batchResponseSubscriberVidResponse.startedAt
                status = batchResponseSubscriberVidResponse.status
                errors = batchResponseSubscriberVidResponse.errors.map { it.toMutableList() }
                links = batchResponseSubscriberVidResponse.links
                numErrors = batchResponseSubscriberVidResponse.numErrors
                requestedAt = batchResponseSubscriberVidResponse.requestedAt
                additionalProperties =
                    batchResponseSubscriberVidResponse.additionalProperties.toMutableMap()
            }
        ...
        fun results(results: List<SubscriberVidResponse>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed `List<SubscriberVidResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun results(results: JsonField<List<SubscriberVidResponse>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [SubscriberVidResponse] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: SubscriberVidResponse) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [BatchResponseSubscriberVidResponse].
         *
         ...
         */
        fun build(): BatchResponseSubscriberVidResponse =
            BatchResponseSubscriberVidResponse(
     ...
     *   expected type.
     */
    fun validate(): BatchResponseSubscriberVidResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseSubscriberVidResponse &&
    ...
    override fun toString() =
        "BatchResponseSubscriberVidResponse{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
