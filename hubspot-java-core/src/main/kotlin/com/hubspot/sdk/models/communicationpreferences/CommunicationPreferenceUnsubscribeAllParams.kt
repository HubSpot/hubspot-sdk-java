...
private constructor(
    ...
    /**
     * The ID of the business unit associated with the request. This is an optional integer
     * parameter.
     */
    ...
    companion object {
         ...
         * [CommunicationPreferenceUnsubscribeAllParams].
         *
    ...
    /** A builder for [CommunicationPreferenceUnsubscribeAllParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            communicationPreferenceUnsubscribeAllParams: CommunicationPreferenceUnsubscribeAllParams
        ) = apply {
            subscriberIdString = communicationPreferenceUnsubscribeAllParams.subscriberIdString
            channel = communicationPreferenceUnsubscribeAllParams.channel
            businessUnitId = communicationPreferenceUnsubscribeAllParams.businessUnitId
            verbose = communicationPreferenceUnsubscribeAllParams.verbose
            additionalHeaders =
                communicationPreferenceUnsubscribeAllParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                communicationPreferenceUnsubscribeAllParams.additionalQueryParams.toBuilder()
            additionalBodyProperties =
                communicationPreferenceUnsubscribeAllParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CommunicationPreferenceUnsubscribeAllParams].
         *
         ...
         */
        fun build(): CommunicationPreferenceUnsubscribeAllParams =
            CommunicationPreferenceUnsubscribeAllParams(
                subscriberIdString,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CommunicationPreferenceUnsubscribeAllParams &&
    ...
    override fun toString() =
        "CommunicationPreferenceUnsubscribeAllParams{subscriberIdString=$subscriberIdString, channel=$channel, businessUnitId=$businessUnitId, verbose=$verbose, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
