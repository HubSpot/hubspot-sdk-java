...
private constructor(
    ...
    /** A builder for [PublicPropertyAssociationFilterBranch]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            filterBranches =
                publicPropertyAssociationFilterBranch.filterBranches.map { it.toMutableList() }
            filterBranchOperator = publicPropertyAssociationFilterBranch.filterBranchOperator
            filterBranchType = publicPropertyAssociationFilterBranch.filterBranchType
            filters = publicPropertyAssociationFilterBranch.filters.map { it.toMutableList() }
            objectTypeId = publicPropertyAssociationFilterBranch.objectTypeId
            operator = publicPropertyAssociationFilterBranch.operator
            propertyWithObjectId = publicPropertyAssociationFilterBranch.propertyWithObjectId
            additionalProperties =
                publicPropertyAssociationFilterBranch.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicPropertyAssociationFilterBranch].
         *
         ...
         */
        fun build(): PublicPropertyAssociationFilterBranch =
            PublicPropertyAssociationFilterBranch(
     ...
     *   expected type.
     */
    fun validate(): PublicPropertyAssociationFilterBranch = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicPropertyAssociationFilterBranch &&
    ...
    override fun toString() =
        "PublicPropertyAssociationFilterBranch{filterBranches=$filterBranches, filterBranchOperator=$filterBranchOperator, filterBranchType=$filterBranchType, filters=$filters, objectTypeId=$objectTypeId, operator=$operator, propertyWithObjectId=$propertyWithObjectId, additionalProperties=$additionalProperties}"
}
