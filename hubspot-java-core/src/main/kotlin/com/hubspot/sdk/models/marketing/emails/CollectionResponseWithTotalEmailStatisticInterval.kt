...
private constructor(
    ...
    /** A builder for [CollectionResponseWithTotalEmailStatisticInterval]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            results =
                collectionResponseWithTotalEmailStatisticInterval.results.map { it.toMutableList() }
            total = collectionResponseWithTotalEmailStatisticInterval.total
            paging = collectionResponseWithTotalEmailStatisticInterval.paging
            additionalProperties =
                collectionResponseWithTotalEmailStatisticInterval.additionalProperties
                    .toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CollectionResponseWithTotalEmailStatisticInterval].
         *
         ...
         */
        fun build(): CollectionResponseWithTotalEmailStatisticInterval =
            CollectionResponseWithTotalEmailStatisticInterval(
     ...
     *   expected type.
     */
    fun validate(): CollectionResponseWithTotalEmailStatisticInterval = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionResponseWithTotalEmailStatisticInterval &&
    ...
    override fun toString() =
        "CollectionResponseWithTotalEmailStatisticInterval{results=$results, total=$total, paging=$paging, additionalProperties=$additionalProperties}"
}
