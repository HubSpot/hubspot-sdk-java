...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [YearReference].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(yearReference: YearReference) = apply {
            day = yearReference.day
            month = yearReference.month
            referenceType = yearReference.referenceType
            hour = yearReference.hour
            millisecond = yearReference.millisecond
            minute = yearReference.minute
            second = yearReference.second
            additionalProperties = yearReference.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [YearReference].
         *
     ...
     *   expected type.
     */
    fun validate(): YearReference = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "YearReference{day=$day, month=$month, referenceType=$referenceType, hour=$hour, millisecond=$millisecond, minute=$minute, second=$second, additionalProperties=$additionalProperties}"
}
