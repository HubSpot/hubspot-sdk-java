...
class ListUpdateListNameParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ListUpdateListNameParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ListUpdateListNameParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ListUpdateListNameParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(listUpdateListNameParams: ListUpdateListNameParams) = apply {
            listId = listUpdateListNameParams.listId
            includeFilters = listUpdateListNameParams.includeFilters
            listName = listUpdateListNameParams.listName
            additionalHeaders = listUpdateListNameParams.additionalHeaders.toBuilder()
            additionalQueryParams = listUpdateListNameParams.additionalQueryParams.toBuilder()
            additionalBodyProperties =
                listUpdateListNameParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ListUpdateListNameParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ListUpdateListNameParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ListUpdateListNameParams &&
            listId == other.listId &&
    ...
    override fun toString() =
        "ListUpdateListNameParams{listId=$listId, includeFilters=$includeFilters, listName=$listName, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
