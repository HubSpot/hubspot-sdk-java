...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FormatPhoneNumber].
         *
    ...
    /** A builder for [FormatPhoneNumber]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(formatPhoneNumber: FormatPhoneNumber) = apply {
            operator = formatPhoneNumber.operator
            inputs = formatPhoneNumber.inputs.map { it.toMutableList() }
            propertyName = formatPhoneNumber.propertyName
            value = formatPhoneNumber.value
            additionalProperties = formatPhoneNumber.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FormatPhoneNumber].
         *
     ...
     *   expected type.
     */
    fun validate(): FormatPhoneNumber = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val FORMAT_PHONE_NUMBER = of("FORMAT_PHONE_NUMBER")
        ...
        fun value(): Value =
            when (this) {
                FORMAT_PHONE_NUMBER -> Value.FORMAT_PHONE_NUMBER
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                FORMAT_PHONE_NUMBER -> Known.FORMAT_PHONE_NUMBER
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FormatPhoneNumber &&
    ...
    override fun toString() =
        "FormatPhoneNumber{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
