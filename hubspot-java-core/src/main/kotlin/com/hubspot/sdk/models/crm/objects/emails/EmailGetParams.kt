...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(emailGetParams: EmailGetParams) = apply {
            ...
            associations = emailGetParams.associations?.toMutableList()
            idProperty = emailGetParams.idProperty
            properties = emailGetParams.properties?.toMutableList()
            propertiesWithHistory = emailGetParams.propertiesWithHistory?.toMutableList()
    ...
    override fun toString() =
        "EmailGetParams{emailId=$emailId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
