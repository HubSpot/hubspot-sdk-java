...
private constructor(
    ...
    private val results: JsonField<List<MediaBridgeProperty>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<MediaBridgeProperty>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<MediaBridgeProperty> = results.getRequired("results")
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<MediaBridgeProperty>> = results
    ...
    /** A builder for [BatchResponsePropertyWithErrors]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<MediaBridgeProperty>>? = null
        ...
        @JvmSynthetic
        internal fun from(batchResponsePropertyWithErrors: BatchResponsePropertyWithErrors) =
            apply {
                completedAt = batchResponsePropertyWithErrors.completedAt
                results = batchResponsePropertyWithErrors.results.map { it.toMutableList() }
                startedAt = batchResponsePropertyWithErrors.startedAt
                status = batchResponsePropertyWithErrors.status
                errors = batchResponsePropertyWithErrors.errors.map { it.toMutableList() }
                links = batchResponsePropertyWithErrors.links
                numErrors = batchResponsePropertyWithErrors.numErrors
                requestedAt = batchResponsePropertyWithErrors.requestedAt
                additionalProperties =
                    batchResponsePropertyWithErrors.additionalProperties.toMutableMap()
            }
        ...
        fun results(results: List<MediaBridgeProperty>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed `List<MediaBridgeProperty>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun results(results: JsonField<List<MediaBridgeProperty>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [MediaBridgeProperty] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: MediaBridgeProperty) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [BatchResponsePropertyWithErrors].
         *
         ...
         */
        fun build(): BatchResponsePropertyWithErrors =
            BatchResponsePropertyWithErrors(
     ...
     *   expected type.
     */
    fun validate(): BatchResponsePropertyWithErrors = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponsePropertyWithErrors &&
    ...
    override fun toString() =
        "BatchResponsePropertyWithErrors{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
