...
class WebhookCreateBatchEventSubscriptionsParams
private constructor(
    ...
    companion object {
         ...
         * [WebhookCreateBatchEventSubscriptionsParams].
         *
    ...
    /** A builder for [WebhookCreateBatchEventSubscriptionsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            webhookCreateBatchEventSubscriptionsParams: WebhookCreateBatchEventSubscriptionsParams
        ) = apply {
            appId = webhookCreateBatchEventSubscriptionsParams.appId
            batchInputSubscriptionBatchUpdateRequest =
                webhookCreateBatchEventSubscriptionsParams.batchInputSubscriptionBatchUpdateRequest
            additionalHeaders =
                webhookCreateBatchEventSubscriptionsParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                webhookCreateBatchEventSubscriptionsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [WebhookCreateBatchEventSubscriptionsParams].
         *
         ...
         */
        fun build(): WebhookCreateBatchEventSubscriptionsParams =
            WebhookCreateBatchEventSubscriptionsParams(
                appId,
                checkRequired(
                    "batchInputSubscriptionBatchUpdateRequest",
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebhookCreateBatchEventSubscriptionsParams &&
            appId == other.appId &&
            batchInputSubscriptionBatchUpdateRequest ==
    ...
    override fun toString() =
        "WebhookCreateBatchEventSubscriptionsParams{appId=$appId, batchInputSubscriptionBatchUpdateRequest=$batchInputSubscriptionBatchUpdateRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
