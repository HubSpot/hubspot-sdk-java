...
private constructor(
    ...
    /** A builder for [BatchResponsePublicAssociationMultiWithLabelWithErrors]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            completedAt = batchResponsePublicAssociationMultiWithLabelWithErrors.completedAt
            results =
                batchResponsePublicAssociationMultiWithLabelWithErrors.results.map {
                    it.toMutableList()
                }
            startedAt = batchResponsePublicAssociationMultiWithLabelWithErrors.startedAt
            status = batchResponsePublicAssociationMultiWithLabelWithErrors.status
            errors =
                batchResponsePublicAssociationMultiWithLabelWithErrors.errors.map {
                    it.toMutableList()
                }
            links = batchResponsePublicAssociationMultiWithLabelWithErrors.links
            numErrors = batchResponsePublicAssociationMultiWithLabelWithErrors.numErrors
            requestedAt = batchResponsePublicAssociationMultiWithLabelWithErrors.requestedAt
            additionalProperties =
                batchResponsePublicAssociationMultiWithLabelWithErrors.additionalProperties
                    .toMutableMap()
        }
         ...
         */
        fun build(): BatchResponsePublicAssociationMultiWithLabelWithErrors =
            BatchResponsePublicAssociationMultiWithLabelWithErrors(
     ...
     *   expected type.
     */
    fun validate(): BatchResponsePublicAssociationMultiWithLabelWithErrors = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponsePublicAssociationMultiWithLabelWithErrors &&
    ...
    override fun toString() =
        "BatchResponsePublicAssociationMultiWithLabelWithErrors{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
