...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PostQueryParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PostQueryParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PostQueryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(postQueryParams: PostQueryParams) = apply {
            after = postQueryParams.after
            archived = postQueryParams.archived
            createdAfter = postQueryParams.createdAfter
            createdAt = postQueryParams.createdAt
            createdBefore = postQueryParams.createdBefore
            limit = postQueryParams.limit
            property = postQueryParams.property
            sort = postQueryParams.sort?.toMutableList()
            updatedAfter = postQueryParams.updatedAfter
            updatedAt = postQueryParams.updatedAt
            updatedBefore = postQueryParams.updatedBefore
            additionalHeaders = postQueryParams.additionalHeaders.toBuilder()
            additionalQueryParams = postQueryParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PostQueryParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PostQueryParams =
            PostQueryParams(
                after,
                archived,
                createdAfter,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PostQueryParams &&
            after == other.after &&
    ...
    override fun toString() =
        "PostQueryParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
