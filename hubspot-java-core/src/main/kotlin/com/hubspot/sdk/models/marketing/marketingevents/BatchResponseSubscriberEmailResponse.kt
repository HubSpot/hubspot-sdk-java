...
private constructor(
    ...
    private val results: JsonField<List<SubscriberEmailResponse>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<SubscriberEmailResponse>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<SubscriberEmailResponse> = results.getRequired("results")
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<SubscriberEmailResponse>> = results
    ...
    /** A builder for [BatchResponseSubscriberEmailResponse]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<SubscriberEmailResponse>>? = null
        ...
        internal fun from(
            ...
            completedAt = batchResponseSubscriberEmailResponse.completedAt
            results = batchResponseSubscriberEmailResponse.results.map { it.toMutableList() }
            startedAt = batchResponseSubscriberEmailResponse.startedAt
            status = batchResponseSubscriberEmailResponse.status
            errors = batchResponseSubscriberEmailResponse.errors.map { it.toMutableList() }
            links = batchResponseSubscriberEmailResponse.links
            numErrors = batchResponseSubscriberEmailResponse.numErrors
            requestedAt = batchResponseSubscriberEmailResponse.requestedAt
            additionalProperties =
                batchResponseSubscriberEmailResponse.additionalProperties.toMutableMap()
        }
        ...
        fun results(results: List<SubscriberEmailResponse>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed
         * `List<SubscriberEmailResponse>` value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun results(results: JsonField<List<SubscriberEmailResponse>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [SubscriberEmailResponse] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: SubscriberEmailResponse) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [BatchResponseSubscriberEmailResponse].
         *
         ...
         */
        fun build(): BatchResponseSubscriberEmailResponse =
            BatchResponseSubscriberEmailResponse(
    ...
    fun validate(): BatchResponseSubscriberEmailResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseSubscriberEmailResponse &&
    ...
    override fun toString() =
        "BatchResponseSubscriberEmailResponse{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
