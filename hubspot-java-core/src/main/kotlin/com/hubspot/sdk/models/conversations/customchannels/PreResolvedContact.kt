...
private constructor(
    ...
    private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val HS_NUM_ASSOCIATED_OPEN_DEALS = of("hs_num_associated_open_deals")
            ...
            @JvmField
            val HS_PROSPECTING_AGENT_ENROLLMENT_STATUS =
                of("hs_prospecting_agent_enrollment_status")

            @JvmField
            val HS_PROSPECTING_AGENT_LAST_ENROLLED = of("hs_prospecting_agent_last_enrolled")

            @JvmField val HS_PROSPECTING_AGENT_SENDER = of("hs_prospecting_agent_sender")
            ...
            @JvmField val HS_WHY_THIS_CONTACT = of("hs_why_this_contact")
        ...
        fun value(): Value =
            when (this) {
                ...
                HS_NUM_ASSOCIATED_OPEN_DEALS -> Value.HS_NUM_ASSOCIATED_OPEN_DEALS
                ...
                HS_PROSPECTING_AGENT_ENROLLMENT_STATUS ->
                    Value.HS_PROSPECTING_AGENT_ENROLLMENT_STATUS
                HS_PROSPECTING_AGENT_LAST_ENROLLED -> Value.HS_PROSPECTING_AGENT_LAST_ENROLLED
                HS_PROSPECTING_AGENT_SENDER -> Value.HS_PROSPECTING_AGENT_SENDER
                HS_PROSPECTING_AGENT_TOTAL_ENROLLED_COUNT ->
                ...
                HS_WHY_THIS_CONTACT -> Value.HS_WHY_THIS_CONTACT
        ...
        fun known(): Known =
            when (this) {
                ...
                HS_NUM_ASSOCIATED_OPEN_DEALS -> Known.HS_NUM_ASSOCIATED_OPEN_DEALS
                ...
                HS_PROSPECTING_AGENT_ENROLLMENT_STATUS ->
                    Known.HS_PROSPECTING_AGENT_ENROLLMENT_STATUS
                HS_PROSPECTING_AGENT_LAST_ENROLLED -> Known.HS_PROSPECTING_AGENT_LAST_ENROLLED
                HS_PROSPECTING_AGENT_SENDER -> Known.HS_PROSPECTING_AGENT_SENDER
                HS_PROSPECTING_AGENT_TOTAL_ENROLLED_COUNT ->
                ...
                HS_WHY_THIS_CONTACT -> Known.HS_WHY_THIS_CONTACT
