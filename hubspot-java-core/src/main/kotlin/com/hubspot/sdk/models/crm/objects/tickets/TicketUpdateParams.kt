...
/**
 * Perform a partial update of an Object identified by `{ticketId}`or optionally a unique property
 * value as specified by the `idProperty` query param. `{ticketId}` refers to the internal object ID
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ticketUpdateParams: TicketUpdateParams) = apply {
            ticketId = ticketUpdateParams.ticketId
            idProperty = ticketUpdateParams.idProperty
            simplePublicObjectInput = ticketUpdateParams.simplePublicObjectInput
    ...
    override fun toString() =
        "TicketUpdateParams{ticketId=$ticketId, idProperty=$idProperty, simplePublicObjectInput=$simplePublicObjectInput, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
