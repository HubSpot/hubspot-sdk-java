...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AbsoluteValue].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(absoluteValue: AbsoluteValue) = apply {
            operator = absoluteValue.operator
            inputs = absoluteValue.inputs.map { it.toMutableList() }
            propertyName = absoluteValue.propertyName
            value = absoluteValue.value
            additionalProperties = absoluteValue.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AbsoluteValue].
         *
     ...
     *   expected type.
     */
    fun validate(): AbsoluteValue = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val ABSOLUTE_VALUE = of("ABSOLUTE_VALUE")
        ...
        fun known(): Known =
            when (this) {
                ABSOLUTE_VALUE -> Known.ABSOLUTE_VALUE
    ...
    override fun toString() =
        "AbsoluteValue{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
