...
private constructor(
    ...
    ) : this(category, typeId, label, userEnforcedMaxToObjectIds, mutableMapOf())
    ...
    /** A builder for [PublicAssociationDefinitionUserConfiguration]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            category = publicAssociationDefinitionUserConfiguration.category
            typeId = publicAssociationDefinitionUserConfiguration.typeId
            label = publicAssociationDefinitionUserConfiguration.label
            userEnforcedMaxToObjectIds =
                publicAssociationDefinitionUserConfiguration.userEnforcedMaxToObjectIds
            additionalProperties =
                publicAssociationDefinitionUserConfiguration.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicAssociationDefinitionUserConfiguration].
         *
         ...
         */
        fun build(): PublicAssociationDefinitionUserConfiguration =
            PublicAssociationDefinitionUserConfiguration(
     ...
     *   expected type.
     */
    fun validate(): PublicAssociationDefinitionUserConfiguration = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicAssociationDefinitionUserConfiguration &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(category, typeId, label, userEnforcedMaxToObjectIds, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "PublicAssociationDefinitionUserConfiguration{category=$category, typeId=$typeId, label=$label, userEnforcedMaxToObjectIds=$userEnforcedMaxToObjectIds, additionalProperties=$additionalProperties}"
}
