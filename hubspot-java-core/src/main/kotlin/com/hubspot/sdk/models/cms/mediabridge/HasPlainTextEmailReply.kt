...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HasPlainTextEmailReply].
         *
    ...
    /** A builder for [HasPlainTextEmailReply]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(hasPlainTextEmailReply: HasPlainTextEmailReply) = apply {
            operator = hasPlainTextEmailReply.operator
            inputs = hasPlainTextEmailReply.inputs.map { it.toMutableList() }
            propertyName = hasPlainTextEmailReply.propertyName
            value = hasPlainTextEmailReply.value
            additionalProperties = hasPlainTextEmailReply.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [HasPlainTextEmailReply].
         *
         ...
         */
        fun build(): HasPlainTextEmailReply =
     ...
     *   expected type.
     */
    fun validate(): HasPlainTextEmailReply = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val HAS_PLAIN_TEXT_EMAIL_REPLY = of("HAS_PLAIN_TEXT_EMAIL_REPLY")
        ...
        fun value(): Value =
            when (this) {
                HAS_PLAIN_TEXT_EMAIL_REPLY -> Value.HAS_PLAIN_TEXT_EMAIL_REPLY
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                HAS_PLAIN_TEXT_EMAIL_REPLY -> Known.HAS_PLAIN_TEXT_EMAIL_REPLY
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is HasPlainTextEmailReply &&
    ...
    override fun toString() =
        "HasPlainTextEmailReply{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
