...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [WebsitePageGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [WebsitePageGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(websitePageGetParams: WebsitePageGetParams) = apply {
            objectId = websitePageGetParams.objectId
            archived = websitePageGetParams.archived
            property = websitePageGetParams.property
            additionalHeaders = websitePageGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = websitePageGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [WebsitePageGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): WebsitePageGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebsitePageGetParams &&
    ...
    override fun toString() =
        "WebsitePageGetParams{objectId=$objectId, archived=$archived, property=$property, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
