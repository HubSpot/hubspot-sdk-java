...
package com.hubspot.sdk.models.crm.objects.tasks
...
/** @see TaskServiceAsync.list */
class TaskListPageAsync
private constructor(
    private val service: TaskServiceAsync,
    ...
    override fun nextPage(): CompletableFuture<TaskListPageAsync> = service.list(nextPageParams())

    fun autoPager(): AutoPagerAsync<SimplePublicObjectWithAssociations> =
        AutoPagerAsync.from(this, streamHandlerExecutor)

    /** The parameters that were used to request this page. */
    fun params(): TaskListParams = params
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TaskListPageAsync].
         *
    ...
    /** A builder for [TaskListPageAsync]. */
    class Builder internal constructor() {

        private var service: TaskServiceAsync? = null
        private var streamHandlerExecutor: Executor? = null
        private var params: TaskListParams? = null
        private var response: CollectionResponseSimplePublicObjectWithAssociationsForwardPaging? =
            null

        @JvmSynthetic
        internal fun from(taskListPageAsync: TaskListPageAsync) = apply {
            service = taskListPageAsync.service
            streamHandlerExecutor = taskListPageAsync.streamHandlerExecutor
            params = taskListPageAsync.params
            response = taskListPageAsync.response
        }

        fun service(service: TaskServiceAsync) = apply { this.service = service }
        ...
        /** The parameters that were used to request this page. */
        fun params(params: TaskListParams) = apply { this.params = params }
        ...
        /**
         * Returns an immutable instance of [TaskListPageAsync].
         *
    ...
    override fun toString() =
        "TaskListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}
