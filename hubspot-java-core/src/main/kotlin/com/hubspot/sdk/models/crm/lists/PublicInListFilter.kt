...
private constructor(
    ...
    private val metadata: JsonField<PublicInListFilterMetadata>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        metadata: JsonField<PublicInListFilterMetadata> = JsonMissing.of(),
    ) : this(filterType, listId, operator, metadata, mutableMapOf())
     ...
     */
    fun metadata(): Optional<PublicInListFilterMetadata> = metadata.getOptional("metadata")
    ...
    @JsonProperty("metadata")
    @ExcludeMissing
    fun _metadata(): JsonField<PublicInListFilterMetadata> = metadata
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicInListFilter].
         *
    ...
    /** A builder for [PublicInListFilter]. */
    class Builder internal constructor() {
        ...
        private var metadata: JsonField<PublicInListFilterMetadata> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(publicInListFilter: PublicInListFilter) = apply {
            filterType = publicInListFilter.filterType
            listId = publicInListFilter.listId
            operator = publicInListFilter.operator
            metadata = publicInListFilter.metadata
            additionalProperties = publicInListFilter.additionalProperties.toMutableMap()
        }
        ...
        fun metadata(metadata: PublicInListFilterMetadata) = metadata(JsonField.of(metadata))

        /**
         * Sets [Builder.metadata] to an arbitrary JSON value.
         *
         * You should usually call [Builder.metadata] with a well-typed [PublicInListFilterMetadata]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun metadata(metadata: JsonField<PublicInListFilterMetadata>) = apply {
        ...
        /**
         * Returns an immutable instance of [PublicInListFilter].
         *
     ...
     *   expected type.
     */
    fun validate(): PublicInListFilter = apply {
        if (validated) {
            return@apply
        }
    ...
    class FilterType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val IN_LIST = of("IN_LIST")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicInListFilter &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(filterType, listId, operator, metadata, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "PublicInListFilter{filterType=$filterType, listId=$listId, operator=$operator, metadata=$metadata, additionalProperties=$additionalProperties}"
}
