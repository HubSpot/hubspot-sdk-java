...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicRestrictedFilterBranch].
         *
    ...
    /** A builder for [PublicRestrictedFilterBranch]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicRestrictedFilterBranch: PublicRestrictedFilterBranch) = apply {
            filterBranches = publicRestrictedFilterBranch.filterBranches.map { it.toMutableList() }
            filterBranchOperator = publicRestrictedFilterBranch.filterBranchOperator
            filterBranchType = publicRestrictedFilterBranch.filterBranchType
            filters = publicRestrictedFilterBranch.filters.map { it.toMutableList() }
            additionalProperties = publicRestrictedFilterBranch.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicRestrictedFilterBranch].
         *
         ...
         */
        fun build(): PublicRestrictedFilterBranch =
    ...
    fun validate(): PublicRestrictedFilterBranch = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicRestrictedFilterBranch &&
    ...
    override fun toString() =
        "PublicRestrictedFilterBranch{filterBranches=$filterBranches, filterBranchOperator=$filterBranchOperator, filterBranchType=$filterBranchType, filters=$filters, additionalProperties=$additionalProperties}"
}
