...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AddNumbers].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(addNumbers: AddNumbers) = apply {
            enclosedInParentheses = addNumbers.enclosedInParentheses
            operator = addNumbers.operator
            inputs = addNumbers.inputs.map { it.toMutableList() }
            propertyName = addNumbers.propertyName
            value = addNumbers.value
            additionalProperties = addNumbers.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AddNumbers].
         *
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val ADD_NUMBERS = of("ADD_NUMBERS")
    ...
    override fun toString() =
        "AddNumbers{enclosedInParentheses=$enclosedInParentheses, operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
