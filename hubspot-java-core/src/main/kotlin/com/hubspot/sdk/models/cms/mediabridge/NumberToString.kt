...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NumberToString].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(numberToString: NumberToString) = apply {
            operator = numberToString.operator
            inputs = numberToString.inputs.map { it.toMutableList() }
            propertyName = numberToString.propertyName
            value = numberToString.value
            additionalProperties = numberToString.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NumberToString].
         *
     ...
     *   expected type.
     */
    fun validate(): NumberToString = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val NUMBER_TO_STRING = of("NUMBER_TO_STRING")
        ...
        fun value(): Value =
            when (this) {
                NUMBER_TO_STRING -> Value.NUMBER_TO_STRING
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                NUMBER_TO_STRING -> Known.NUMBER_TO_STRING
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NumberToString &&
    ...
    override fun toString() =
        "NumberToString{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
