...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DivideNumbers].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(divideNumbers: DivideNumbers) = apply {
            enclosedInParentheses = divideNumbers.enclosedInParentheses
            operator = divideNumbers.operator
            inputs = divideNumbers.inputs.map { it.toMutableList() }
            propertyName = divideNumbers.propertyName
            value = divideNumbers.value
            additionalProperties = divideNumbers.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DivideNumbers].
         *
     ...
     *   expected type.
     */
    fun validate(): DivideNumbers = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val DIVIDE_NUMBERS = of("DIVIDE_NUMBERS")
        ...
        fun value(): Value =
            when (this) {
                DIVIDE_NUMBERS -> Value.DIVIDE_NUMBERS
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                DIVIDE_NUMBERS -> Known.DIVIDE_NUMBERS
    ...
    override fun toString() =
        "DivideNumbers{enclosedInParentheses=$enclosedInParentheses, operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
