...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LessThanOrEqual].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(lessThanOrEqual: LessThanOrEqual) = apply {
            operator = lessThanOrEqual.operator
            inputs = lessThanOrEqual.inputs.map { it.toMutableList() }
            propertyName = lessThanOrEqual.propertyName
            value = lessThanOrEqual.value
            additionalProperties = lessThanOrEqual.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LessThanOrEqual].
         *
     ...
     *   expected type.
     */
    fun validate(): LessThanOrEqual = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LessThanOrEqual &&
    ...
    override fun toString() =
        "LessThanOrEqual{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
