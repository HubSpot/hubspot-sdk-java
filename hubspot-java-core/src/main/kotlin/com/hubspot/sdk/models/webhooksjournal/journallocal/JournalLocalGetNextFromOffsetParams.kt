 ...
 */
class JournalLocalGetNextFromOffsetParams
private constructor(
    ...
    /** A builder for [JournalLocalGetNextFromOffsetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            journalLocalGetNextFromOffsetParams: JournalLocalGetNextFromOffsetParams
        ) = apply {
            offset = journalLocalGetNextFromOffsetParams.offset
            installPortalId = journalLocalGetNextFromOffsetParams.installPortalId
            additionalHeaders = journalLocalGetNextFromOffsetParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                journalLocalGetNextFromOffsetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [JournalLocalGetNextFromOffsetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): JournalLocalGetNextFromOffsetParams =
            JournalLocalGetNextFromOffsetParams(
                offset,
                installPortalId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is JournalLocalGetNextFromOffsetParams &&
            offset == other.offset &&
    ...
    override fun toString() =
        "JournalLocalGetNextFromOffsetParams{offset=$offset, installPortalId=$installPortalId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
