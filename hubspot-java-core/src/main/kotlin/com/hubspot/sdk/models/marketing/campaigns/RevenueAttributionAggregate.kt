...
class RevenueAttributionAggregate
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val contactsNumber: JsonField<Int>,
    private val currencyCode: JsonField<CurrencyCode>,
    private val dealAmount: JsonField<Double>,
    private val dealsNumber: JsonField<Int>,
    private val revenueAmount: JsonField<Double>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        contactsNumber: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("currencyCode")
        @ExcludeMissing
        currencyCode: JsonField<CurrencyCode> = JsonMissing.of(),
        @JsonProperty("dealAmount")
        @ExcludeMissing
        dealAmount: JsonField<Double> = JsonMissing.of(),
        @JsonProperty("dealsNumber") @ExcludeMissing dealsNumber: JsonField<Int> = JsonMissing.of(),
        @JsonProperty("revenueAmount")
        @ExcludeMissing
        revenueAmount: JsonField<Double> = JsonMissing.of(),
    ) : this(contactsNumber, currencyCode, dealAmount, dealsNumber, revenueAmount, mutableMapOf())
    ...
    /**
     * Returns the raw JSON value of [contactsNumber].
     *
     * Unlike [contactsNumber], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("contactsNumber")
    @ExcludeMissing
    fun _contactsNumber(): JsonField<Int> = contactsNumber
    ...
    /**
     * Returns the raw JSON value of [dealAmount].
     *
     * Unlike [dealAmount], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("dealAmount") @ExcludeMissing fun _dealAmount(): JsonField<Double> = dealAmount

    /**
     * Returns the raw JSON value of [dealsNumber].
     *
     * Unlike [dealsNumber], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("dealsNumber") @ExcludeMissing fun _dealsNumber(): JsonField<Int> = dealsNumber

    /**
     * Returns the raw JSON value of [revenueAmount].
     *
     * Unlike [revenueAmount], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("revenueAmount")
    @ExcludeMissing
    fun _revenueAmount(): JsonField<Double> = revenueAmount
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RevenueAttributionAggregate].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [RevenueAttributionAggregate]. */
    class Builder internal constructor() {

        private var contactsNumber: JsonField<Int> = JsonMissing.of()
        private var currencyCode: JsonField<CurrencyCode> = JsonMissing.of()
        private var dealAmount: JsonField<Double> = JsonMissing.of()
        private var dealsNumber: JsonField<Int> = JsonMissing.of()
        private var revenueAmount: JsonField<Double> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(revenueAttributionAggregate: RevenueAttributionAggregate) = apply {
            contactsNumber = revenueAttributionAggregate.contactsNumber
            currencyCode = revenueAttributionAggregate.currencyCode
            dealAmount = revenueAttributionAggregate.dealAmount
            dealsNumber = revenueAttributionAggregate.dealsNumber
            revenueAmount = revenueAttributionAggregate.revenueAmount
            additionalProperties = revenueAttributionAggregate.additionalProperties.toMutableMap()
        }

        /** The number of contacts attributed to the campaign. */
        fun contactsNumber(contactsNumber: Int) = contactsNumber(JsonField.of(contactsNumber))

        /**
         * Sets [Builder.contactsNumber] to an arbitrary JSON value.
         *
         * You should usually call [Builder.contactsNumber] with a well-typed [Int] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun contactsNumber(contactsNumber: JsonField<Int>) = apply {
            this.contactsNumber = contactsNumber
        }

        /**
         * The currency code used for the revenue attribution, with accepted values including AED,
         * AFN, ALL, and others.
         */
        ...
        /** The total amount of deals attributed to the campaign. */
        fun dealAmount(dealAmount: Double) = dealAmount(JsonField.of(dealAmount))

        /**
         * Sets [Builder.dealAmount] to an arbitrary JSON value.
         *
         * You should usually call [Builder.dealAmount] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun dealAmount(dealAmount: JsonField<Double>) = apply { this.dealAmount = dealAmount }

        /** The number of deals attributed to the campaign. */
        fun dealsNumber(dealsNumber: Int) = dealsNumber(JsonField.of(dealsNumber))

        /**
         * Sets [Builder.dealsNumber] to an arbitrary JSON value.
         *
         * You should usually call [Builder.dealsNumber] with a well-typed [Int] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun dealsNumber(dealsNumber: JsonField<Int>) = apply { this.dealsNumber = dealsNumber }

        /** The total revenue amount attributed to the campaign. */
        fun revenueAmount(revenueAmount: Double) = revenueAmount(JsonField.of(revenueAmount))

        /**
         * Sets [Builder.revenueAmount] to an arbitrary JSON value.
         *
         * You should usually call [Builder.revenueAmount] with a well-typed [Double] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun revenueAmount(revenueAmount: JsonField<Double>) = apply {
        ...
        /**
         * Returns an immutable instance of [RevenueAttributionAggregate].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RevenueAttributionAggregate =
    ...
    fun validate(): RevenueAttributionAggregate = apply {
        if (validated) {
            return@apply
        }

        contactsNumber()
        currencyCode().ifPresent { it.validate() }
        dealAmount()
        dealsNumber()
        revenueAmount()
        validated = true
    ...
    internal fun validity(): Int =
        (if (contactsNumber.asKnown().isPresent) 1 else 0) +
            (currencyCode.asKnown().getOrNull()?.validity() ?: 0) +
            (if (dealAmount.asKnown().isPresent) 1 else 0) +
            (if (dealsNumber.asKnown().isPresent) 1 else 0) +
            (if (revenueAmount.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RevenueAttributionAggregate &&
            contactsNumber == other.contactsNumber &&
            currencyCode == other.currencyCode &&
            dealAmount == other.dealAmount &&
            dealsNumber == other.dealsNumber &&
    ...
    override fun toString() =
        "RevenueAttributionAggregate{contactsNumber=$contactsNumber, currencyCode=$currencyCode, dealAmount=$dealAmount, dealsNumber=$dealsNumber, revenueAmount=$revenueAmount, additionalProperties=$additionalProperties}"
}
