...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchInputPropertyName].
         *
    ...
    /** A builder for [BatchInputPropertyName]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchInputPropertyName: BatchInputPropertyName) = apply {
            inputs = batchInputPropertyName.inputs.map { it.toMutableList() }
            additionalProperties = batchInputPropertyName.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BatchInputPropertyName].
         *
         ...
         */
        fun build(): BatchInputPropertyName =
     ...
     *   expected type.
     */
    fun validate(): BatchInputPropertyName = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchInputPropertyName &&
            inputs == other.inputs &&
    ...
    override fun toString() =
        "BatchInputPropertyName{inputs=$inputs, additionalProperties=$additionalProperties}"
}
