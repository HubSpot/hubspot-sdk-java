...
private constructor(
     ...
     *
     * Unlike [contactProfile], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("contactProfile")
    @ExcludeMissing
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ContactAttachment].
         *
    ...
    /** A builder for [ContactAttachment]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contactAttachment: ContactAttachment) = apply {
            contactProfile = contactAttachment.contactProfile
            type = contactAttachment.type
            additionalProperties = contactAttachment.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.contactProfile] with a well-typed [ContactProfile] value
        ...
        /**
         * Returns an immutable instance of [ContactAttachment].
         *
     ...
     *   expected type.
     */
    fun validate(): ContactAttachment = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ContactAttachment &&
            contactProfile == other.contactProfile &&
            type == other.type &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(contactProfile, type, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ContactAttachment{contactProfile=$contactProfile, type=$type, additionalProperties=$additionalProperties}"
}
