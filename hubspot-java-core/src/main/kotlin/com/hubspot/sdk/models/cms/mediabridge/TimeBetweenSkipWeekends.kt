...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TimeBetweenSkipWeekends].
         *
    ...
    /** A builder for [TimeBetweenSkipWeekends]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(timeBetweenSkipWeekends: TimeBetweenSkipWeekends) = apply {
            operator = timeBetweenSkipWeekends.operator
            inputs = timeBetweenSkipWeekends.inputs.map { it.toMutableList() }
            propertyName = timeBetweenSkipWeekends.propertyName
            value = timeBetweenSkipWeekends.value
            additionalProperties = timeBetweenSkipWeekends.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TimeBetweenSkipWeekends].
         *
         ...
         */
        fun build(): TimeBetweenSkipWeekends =
     ...
     *   expected type.
     */
    fun validate(): TimeBetweenSkipWeekends = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val TIME_BETWEEN_SKIP_WEEKENDS = of("TIME_BETWEEN_SKIP_WEEKENDS")
        ...
        fun value(): Value =
            when (this) {
                TIME_BETWEEN_SKIP_WEEKENDS -> Value.TIME_BETWEEN_SKIP_WEEKENDS
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                TIME_BETWEEN_SKIP_WEEKENDS -> Known.TIME_BETWEEN_SKIP_WEEKENDS
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TimeBetweenSkipWeekends &&
    ...
    override fun toString() =
        "TimeBetweenSkipWeekends{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
