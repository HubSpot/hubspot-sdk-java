...
private constructor(
    ...
    /** A builder for [BatchGetLatestParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchGetLatestParams: BatchGetLatestParams) = apply {
            count = batchGetLatestParams.count
            installPortalId = batchGetLatestParams.installPortalId
            additionalHeaders = batchGetLatestParams.additionalHeaders.toBuilder()
            additionalQueryParams = batchGetLatestParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BatchGetLatestParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BatchGetLatestParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchGetLatestParams &&
            count == other.count &&
    ...
    override fun toString() =
        "BatchGetLatestParams{count=$count, installPortalId=$installPortalId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
