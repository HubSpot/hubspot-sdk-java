...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MaxNumbers].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(maxNumbers: MaxNumbers) = apply {
            operator = maxNumbers.operator
            inputs = maxNumbers.inputs.map { it.toMutableList() }
            propertyName = maxNumbers.propertyName
            value = maxNumbers.value
            additionalProperties = maxNumbers.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MaxNumbers].
         *
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val MAX_NUMBERS = of("MAX_NUMBERS")
    ...
    override fun toString() =
        "MaxNumbers{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
