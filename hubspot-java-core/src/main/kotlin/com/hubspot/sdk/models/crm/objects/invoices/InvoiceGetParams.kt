...
package com.hubspot.sdk.models.crm.objects.invoices
...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): InvoiceGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [InvoiceGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [InvoiceGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(invoiceGetParams: InvoiceGetParams) = apply {
            invoiceId = invoiceGetParams.invoiceId
            archived = invoiceGetParams.archived
            associations = invoiceGetParams.associations?.toMutableList()
            idProperty = invoiceGetParams.idProperty
            properties = invoiceGetParams.properties?.toMutableList()
            propertiesWithHistory = invoiceGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = invoiceGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = invoiceGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [InvoiceGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): InvoiceGetParams =
            InvoiceGetParams(
                invoiceId,
                archived,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InvoiceGetParams &&
    ...
    override fun toString() =
        "InvoiceGetParams{invoiceId=$invoiceId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
