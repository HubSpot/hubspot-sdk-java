...
package com.hubspot.sdk.models.crm.objects.tickets
...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TicketGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TicketGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TicketGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ticketGetParams: TicketGetParams) = apply {
            ticketId = ticketGetParams.ticketId
            archived = ticketGetParams.archived
            associations = ticketGetParams.associations?.toMutableList()
            idProperty = ticketGetParams.idProperty
            properties = ticketGetParams.properties?.toMutableList()
            propertiesWithHistory = ticketGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = ticketGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = ticketGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TicketGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TicketGetParams =
            TicketGetParams(
                ticketId,
                archived,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TicketGetParams &&
    ...
    override fun toString() =
        "TicketGetParams{ticketId=$ticketId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
