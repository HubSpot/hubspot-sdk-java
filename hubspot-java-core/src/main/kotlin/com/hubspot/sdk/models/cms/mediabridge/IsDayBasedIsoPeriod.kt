...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IsDayBasedIsoPeriod].
         *
    ...
    /** A builder for [IsDayBasedIsoPeriod]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(isDayBasedIsoPeriod: IsDayBasedIsoPeriod) = apply {
            operator = isDayBasedIsoPeriod.operator
            inputs = isDayBasedIsoPeriod.inputs.map { it.toMutableList() }
            propertyName = isDayBasedIsoPeriod.propertyName
            value = isDayBasedIsoPeriod.value
            additionalProperties = isDayBasedIsoPeriod.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IsDayBasedIsoPeriod].
         *
     ...
     *   expected type.
     */
    fun validate(): IsDayBasedIsoPeriod = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val IS_DAY_BASED_ISO_PERIOD = of("IS_DAY_BASED_ISO_PERIOD")
        ...
        fun value(): Value =
            when (this) {
                IS_DAY_BASED_ISO_PERIOD -> Value.IS_DAY_BASED_ISO_PERIOD
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                IS_DAY_BASED_ISO_PERIOD -> Known.IS_DAY_BASED_ISO_PERIOD
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IsDayBasedIsoPeriod &&
    ...
    override fun toString() =
        "IsDayBasedIsoPeriod{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
