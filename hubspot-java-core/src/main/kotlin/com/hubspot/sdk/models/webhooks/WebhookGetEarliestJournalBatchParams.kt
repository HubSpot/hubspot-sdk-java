...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): WebhookGetEarliestJournalBatchParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of
         * [WebhookGetEarliestJournalBatchParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [WebhookGetEarliestJournalBatchParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            count = webhookGetEarliestJournalBatchParams.count
            installPortalId = webhookGetEarliestJournalBatchParams.installPortalId
            additionalHeaders = webhookGetEarliestJournalBatchParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                webhookGetEarliestJournalBatchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [WebhookGetEarliestJournalBatchParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): WebhookGetEarliestJournalBatchParams =
            WebhookGetEarliestJournalBatchParams(
                count,
                installPortalId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebhookGetEarliestJournalBatchParams &&
            count == other.count &&
    ...
    override fun toString() =
        "WebhookGetEarliestJournalBatchParams{count=$count, installPortalId=$installPortalId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
