...
private constructor(
    ...
    private val results: JsonField<List<PublicDefaultAssociation>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<PublicDefaultAssociation>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<PublicDefaultAssociation> = results.getRequired("results")
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<PublicDefaultAssociation>> = results
    ...
    /** A builder for [BatchResponsePublicDefaultAssociation]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<PublicDefaultAssociation>>? = null
        ...
        internal fun from(
            ...
            completedAt = batchResponsePublicDefaultAssociation.completedAt
            results = batchResponsePublicDefaultAssociation.results.map { it.toMutableList() }
            startedAt = batchResponsePublicDefaultAssociation.startedAt
            status = batchResponsePublicDefaultAssociation.status
            errors = batchResponsePublicDefaultAssociation.errors.map { it.toMutableList() }
            links = batchResponsePublicDefaultAssociation.links
            numErrors = batchResponsePublicDefaultAssociation.numErrors
            requestedAt = batchResponsePublicDefaultAssociation.requestedAt
            additionalProperties =
                batchResponsePublicDefaultAssociation.additionalProperties.toMutableMap()
        }
        ...
        fun results(results: List<PublicDefaultAssociation>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed
         * `List<PublicDefaultAssociation>` value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun results(results: JsonField<List<PublicDefaultAssociation>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [PublicDefaultAssociation] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: PublicDefaultAssociation) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [BatchResponsePublicDefaultAssociation].
         *
         ...
         */
        fun build(): BatchResponsePublicDefaultAssociation =
            BatchResponsePublicDefaultAssociation(
     ...
     *   expected type.
     */
    fun validate(): BatchResponsePublicDefaultAssociation = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponsePublicDefaultAssociation &&
    ...
    override fun toString() =
        "BatchResponsePublicDefaultAssociation{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
