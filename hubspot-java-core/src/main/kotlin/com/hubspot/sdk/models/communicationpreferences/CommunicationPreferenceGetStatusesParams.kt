...
class CommunicationPreferenceGetStatusesParams
private constructor(
    ...
    /**
     * The communication channel for which the subscription status is being retrieved. This
     * parameter is required and currently supports only 'EMAIL'.
     */
    fun channel(): Channel = channel

    /**
     * The ID of the business unit to filter the subscription status by. This is an optional
     * parameter.
     */
    ...
    /** A builder for [CommunicationPreferenceGetStatusesParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            communicationPreferenceGetStatusesParams: CommunicationPreferenceGetStatusesParams
        ) = apply {
            subscriberIdString = communicationPreferenceGetStatusesParams.subscriberIdString
            channel = communicationPreferenceGetStatusesParams.channel
            businessUnitId = communicationPreferenceGetStatusesParams.businessUnitId
            additionalHeaders =
                communicationPreferenceGetStatusesParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                communicationPreferenceGetStatusesParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CommunicationPreferenceGetStatusesParams].
         *
         ...
         */
        fun build(): CommunicationPreferenceGetStatusesParams =
            CommunicationPreferenceGetStatusesParams(
                subscriberIdString,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CommunicationPreferenceGetStatusesParams &&
    ...
    override fun toString() =
        "CommunicationPreferenceGetStatusesParams{subscriberIdString=$subscriberIdString, channel=$channel, businessUnitId=$businessUnitId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
