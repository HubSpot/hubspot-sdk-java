...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LowerCase].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(lowerCase: LowerCase) = apply {
            operator = lowerCase.operator
            inputs = lowerCase.inputs.map { it.toMutableList() }
            propertyName = lowerCase.propertyName
            value = lowerCase.value
            additionalProperties = lowerCase.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LowerCase].
         *
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val LOWER_CASE = of("LOWER_CASE")
    ...
    override fun toString() =
        "LowerCase{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
