...
/** @see PartnerServiceServiceAsync.list */
class PartnerServiceListPageAsync
private constructor(
    private val service: PartnerServiceServiceAsync,
    ...
    override fun nextPage(): CompletableFuture<PartnerServiceListPageAsync> =
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PartnerServiceListPageAsync].
         *
    ...
    /** A builder for [PartnerServiceListPageAsync]. */
    class Builder internal constructor() {

        private var service: PartnerServiceServiceAsync? = null
        ...
        @JvmSynthetic
        internal fun from(partnerServiceListPageAsync: PartnerServiceListPageAsync) = apply {
            service = partnerServiceListPageAsync.service
            streamHandlerExecutor = partnerServiceListPageAsync.streamHandlerExecutor
            params = partnerServiceListPageAsync.params
            response = partnerServiceListPageAsync.response
        }

        fun service(service: PartnerServiceServiceAsync) = apply { this.service = service }
        ...
        /**
         * Returns an immutable instance of [PartnerServiceListPageAsync].
         *
         ...
         */
        fun build(): PartnerServiceListPageAsync =
            PartnerServiceListPageAsync(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PartnerServiceListPageAsync &&
    ...
    override fun toString() =
        "PartnerServiceListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}
