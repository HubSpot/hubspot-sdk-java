...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [Now].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(now: Now) = apply {
            operator = now.operator
            propertyName = now.propertyName
            value = now.value
            additionalProperties = now.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [Now].
         *
    ...
    override fun toString() =
        "Now{operator=$operator, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
