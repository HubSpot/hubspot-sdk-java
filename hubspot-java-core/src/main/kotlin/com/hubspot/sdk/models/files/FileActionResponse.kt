...
private constructor(
    ...
    private val result: JsonField<File>,
    ...
    private constructor(
        ...
        @JsonProperty("result") @ExcludeMissing result: JsonField<File> = JsonMissing.of(),
    ) : this(
        completedAt,
        startedAt,
        status,
     ...
     *   server responded with an unexpected value).
     */
    fun result(): Optional<File> = result.getOptional("result")
     ...
     */
    @JsonProperty("result") @ExcludeMissing fun _result(): JsonField<File> = result
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FileActionResponse].
         *
    ...
    /** A builder for [FileActionResponse]. */
    class Builder internal constructor() {
        ...
        private var result: JsonField<File> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(fileActionResponse: FileActionResponse) = apply {
            completedAt = fileActionResponse.completedAt
            startedAt = fileActionResponse.startedAt
            status = fileActionResponse.status
            taskId = fileActionResponse.taskId
            errors = fileActionResponse.errors.map { it.toMutableList() }
            links = fileActionResponse.links
            numErrors = fileActionResponse.numErrors
            requestedAt = fileActionResponse.requestedAt
            result = fileActionResponse.result
            additionalProperties = fileActionResponse.additionalProperties.toMutableMap()
        }
        ...
        fun result(result: File) = result(JsonField.of(result))

        /**
         * Sets [Builder.result] to an arbitrary JSON value.
         *
         * You should usually call [Builder.result] with a well-typed [File] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun result(result: JsonField<File>) = apply { this.result = result }
        ...
        /**
         * Returns an immutable instance of [FileActionResponse].
         *
    ...
    fun validate(): FileActionResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FileActionResponse &&
    ...
    override fun toString() =
        "FileActionResponse{completedAt=$completedAt, startedAt=$startedAt, status=$status, taskId=$taskId, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, result=$result, additionalProperties=$additionalProperties}"
}
