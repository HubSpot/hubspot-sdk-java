...
class PublicChannelAccountUpdateRequest
...
private constructor(
    ...
    /** A builder for [PublicChannelAccountUpdateRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicChannelAccountUpdateRequest: PublicChannelAccountUpdateRequest) =
            apply {
                authorized = publicChannelAccountUpdateRequest.authorized
                name = publicChannelAccountUpdateRequest.name
                additionalProperties =
                    publicChannelAccountUpdateRequest.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [PublicChannelAccountUpdateRequest].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PublicChannelAccountUpdateRequest =
            PublicChannelAccountUpdateRequest(authorized, name, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): PublicChannelAccountUpdateRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (authorized.asKnown().isPresent) 1 else 0) + (if (name.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicChannelAccountUpdateRequest &&
    ...
    override fun toString() =
        "PublicChannelAccountUpdateRequest{authorized=$authorized, name=$name, additionalProperties=$additionalProperties}"
}
