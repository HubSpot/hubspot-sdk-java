...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchResponseProperty].
         *
    ...
    /** A builder for [BatchResponseProperty]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchResponseProperty: BatchResponseProperty) = apply {
            completedAt = batchResponseProperty.completedAt
        ...
        /**
         * Returns an immutable instance of [BatchResponseProperty].
         *
         ...
         */
        fun build(): BatchResponseProperty =
    ...
    fun validate(): BatchResponseProperty = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseProperty &&
