...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [EmailCreateRequest]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [EmailCreateRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emailCreateRequest: EmailCreateRequest) = apply {
            activeDomain = emailCreateRequest.activeDomain
            archived = emailCreateRequest.archived
            businessUnitId = emailCreateRequest.businessUnitId
            campaign = emailCreateRequest.campaign
            content = emailCreateRequest.content
            feedbackSurveyId = emailCreateRequest.feedbackSurveyId
            folderIdV2 = emailCreateRequest.folderIdV2
            from = emailCreateRequest.from
            jitterSendTime = emailCreateRequest.jitterSendTime
            language = emailCreateRequest.language
            name = emailCreateRequest.name
            publishDate = emailCreateRequest.publishDate
            rssData = emailCreateRequest.rssData
            sendOnPublish = emailCreateRequest.sendOnPublish
            state = emailCreateRequest.state
            subcategory = emailCreateRequest.subcategory
            subject = emailCreateRequest.subject
            subscriptionDetails = emailCreateRequest.subscriptionDetails
            testing = emailCreateRequest.testing
            to = emailCreateRequest.to
            webversion = emailCreateRequest.webversion
            additionalProperties = emailCreateRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EmailCreateRequest].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EmailCreateRequest =
            EmailCreateRequest(
                activeDomain,
                archived,
                businessUnitId,
     ...
     *   expected type.
     */
    fun validate(): EmailCreateRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmailCreateRequest &&
    ...
    override fun toString() =
        "EmailCreateRequest{activeDomain=$activeDomain, archived=$archived, businessUnitId=$businessUnitId, campaign=$campaign, content=$content, feedbackSurveyId=$feedbackSurveyId, folderIdV2=$folderIdV2, from=$from, jitterSendTime=$jitterSendTime, language=$language, name=$name, publishDate=$publishDate, rssData=$rssData, sendOnPublish=$sendOnPublish, state=$state, subcategory=$subcategory, subject=$subject, subscriptionDetails=$subscriptionDetails, testing=$testing, to=$to, webversion=$webversion, additionalProperties=$additionalProperties}"
}
