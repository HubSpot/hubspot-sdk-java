...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RegexMatches].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(regexMatches: RegexMatches) = apply {
            operator = regexMatches.operator
            inputs = regexMatches.inputs.map { it.toMutableList() }
            propertyName = regexMatches.propertyName
            value = regexMatches.value
            additionalProperties = regexMatches.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RegexMatches].
         *
     ...
     *   expected type.
     */
    fun validate(): RegexMatches = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val REGEX_MATCHES = of("REGEX_MATCHES")
        ...
        fun value(): Value =
            when (this) {
                REGEX_MATCHES -> Value.REGEX_MATCHES
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                REGEX_MATCHES -> Known.REGEX_MATCHES
    ...
    override fun toString() =
        "RegexMatches{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
