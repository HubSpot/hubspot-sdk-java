 ...
 */
class JournalLocalGetEarliestParams
private constructor(
    ...
    /** A builder for [JournalLocalGetEarliestParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(journalLocalGetEarliestParams: JournalLocalGetEarliestParams) = apply {
            installPortalId = journalLocalGetEarliestParams.installPortalId
            additionalHeaders = journalLocalGetEarliestParams.additionalHeaders.toBuilder()
            additionalQueryParams = journalLocalGetEarliestParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [JournalLocalGetEarliestParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): JournalLocalGetEarliestParams =
            JournalLocalGetEarliestParams(
                installPortalId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is JournalLocalGetEarliestParams &&
    ...
    override fun toString() =
        "JournalLocalGetEarliestParams{installPortalId=$installPortalId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
