...
private constructor(
    ...
    /** A builder for [ExtractMostRecentEmailReplyHtml]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(extractMostRecentEmailReplyHtml: ExtractMostRecentEmailReplyHtml) =
            apply {
                operator = extractMostRecentEmailReplyHtml.operator
                inputs = extractMostRecentEmailReplyHtml.inputs.map { it.toMutableList() }
                propertyName = extractMostRecentEmailReplyHtml.propertyName
                value = extractMostRecentEmailReplyHtml.value
                additionalProperties =
                    extractMostRecentEmailReplyHtml.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ExtractMostRecentEmailReplyHtml].
         *
         ...
         */
        fun build(): ExtractMostRecentEmailReplyHtml =
            ExtractMostRecentEmailReplyHtml(
     ...
     *   expected type.
     */
    fun validate(): ExtractMostRecentEmailReplyHtml = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField
            val EXTRACT_MOST_RECENT_EMAIL_REPLY_HTML = of("EXTRACT_MOST_RECENT_EMAIL_REPLY_HTML")
        ...
        fun value(): Value =
            when (this) {
                EXTRACT_MOST_RECENT_EMAIL_REPLY_HTML -> Value.EXTRACT_MOST_RECENT_EMAIL_REPLY_HTML
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                EXTRACT_MOST_RECENT_EMAIL_REPLY_HTML -> Known.EXTRACT_MOST_RECENT_EMAIL_REPLY_HTML
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExtractMostRecentEmailReplyHtml &&
    ...
    override fun toString() =
        "ExtractMostRecentEmailReplyHtml{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
