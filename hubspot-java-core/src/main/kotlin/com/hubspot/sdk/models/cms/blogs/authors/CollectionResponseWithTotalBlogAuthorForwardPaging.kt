...
private constructor(
    ...
    /** A builder for [CollectionResponseWithTotalBlogAuthorForwardPaging]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            results =
                collectionResponseWithTotalBlogAuthorForwardPaging.results.map {
                    it.toMutableList()
                }
            total = collectionResponseWithTotalBlogAuthorForwardPaging.total
            paging = collectionResponseWithTotalBlogAuthorForwardPaging.paging
            additionalProperties =
                collectionResponseWithTotalBlogAuthorForwardPaging.additionalProperties
                    .toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CollectionResponseWithTotalBlogAuthorForwardPaging].
         *
         ...
         */
        fun build(): CollectionResponseWithTotalBlogAuthorForwardPaging =
            CollectionResponseWithTotalBlogAuthorForwardPaging(
    ...
    fun validate(): CollectionResponseWithTotalBlogAuthorForwardPaging = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionResponseWithTotalBlogAuthorForwardPaging &&
    ...
    override fun toString() =
        "CollectionResponseWithTotalBlogAuthorForwardPaging{results=$results, total=$total, paging=$paging, additionalProperties=$additionalProperties}"
}
