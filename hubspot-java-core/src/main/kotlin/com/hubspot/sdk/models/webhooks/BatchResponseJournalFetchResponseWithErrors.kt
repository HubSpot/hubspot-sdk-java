...
class BatchResponseJournalFetchResponseWithErrors
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val completedAt: JsonField<OffsetDateTime>,
    private val results: JsonField<List<JournalFetchResponse>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<JournalFetchResponse>> = JsonMissing.of(),
    ...
    /**
     * An array of errors that occurred during the batch operation, each represented by a
    ...
    /**
     * A map of link names to associated URIs, which may provide additional information or resources
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<JournalFetchResponse>> = results
    ...
    /** A builder for [BatchResponseJournalFetchResponseWithErrors]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<JournalFetchResponse>>? = null
        ...
        @JvmSynthetic
        internal fun from(
            batchResponseJournalFetchResponseWithErrors: BatchResponseJournalFetchResponseWithErrors
        ) = apply {
            completedAt = batchResponseJournalFetchResponseWithErrors.completedAt
            results = batchResponseJournalFetchResponseWithErrors.results.map { it.toMutableList() }
            startedAt = batchResponseJournalFetchResponseWithErrors.startedAt
            status = batchResponseJournalFetchResponseWithErrors.status
            errors = batchResponseJournalFetchResponseWithErrors.errors.map { it.toMutableList() }
            links = batchResponseJournalFetchResponseWithErrors.links
            numErrors = batchResponseJournalFetchResponseWithErrors.numErrors
            requestedAt = batchResponseJournalFetchResponseWithErrors.requestedAt
         ...
         *
         * You should usually call [Builder.results] with a well-typed `List<JournalFetchResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun results(results: JsonField<List<JournalFetchResponse>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [JournalFetchResponse] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: JournalFetchResponse) = apply {
            results =
        ...
        /**
         * A map of link names to associated URIs, which may provide additional information or
        ...
        /**
         * Returns an immutable instance of [BatchResponseJournalFetchResponseWithErrors].
         *
         ...
         */
        fun build(): BatchResponseJournalFetchResponseWithErrors =
            BatchResponseJournalFetchResponseWithErrors(
    ...
    fun validate(): BatchResponseJournalFetchResponseWithErrors = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseJournalFetchResponseWithErrors &&
    ...
    override fun toString() =
        "BatchResponseJournalFetchResponseWithErrors{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
