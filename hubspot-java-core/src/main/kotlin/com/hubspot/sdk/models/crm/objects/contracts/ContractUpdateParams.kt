...
/**
 * Perform a partial update of an Object identified by `{contractId}`or optionally a unique property
 * value as specified by the `idProperty` query param. `{contractId}` refers to the internal object
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(contractUpdateParams: ContractUpdateParams) = apply {
            contractId = contractUpdateParams.contractId
            idProperty = contractUpdateParams.idProperty
            simplePublicObjectInput = contractUpdateParams.simplePublicObjectInput
    ...
    override fun toString() =
        "ContractUpdateParams{contractId=$contractId, idProperty=$idProperty, simplePublicObjectInput=$simplePublicObjectInput, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
