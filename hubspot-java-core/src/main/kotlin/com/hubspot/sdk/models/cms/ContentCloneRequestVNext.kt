...
private constructor(
    ...
    ) : this(id, cloneName, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ContentCloneRequestVNext].
         *
    ...
    /** A builder for [ContentCloneRequestVNext]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contentCloneRequestVNext: ContentCloneRequestVNext) = apply {
            id = contentCloneRequestVNext.id
            cloneName = contentCloneRequestVNext.cloneName
            additionalProperties = contentCloneRequestVNext.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ContentCloneRequestVNext].
         *
         ...
         */
        fun build(): ContentCloneRequestVNext =
     ...
     *   expected type.
     */
    fun validate(): ContentCloneRequestVNext = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) + (if (cloneName.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ContentCloneRequestVNext &&
            id == other.id &&
            cloneName == other.cloneName &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(id, cloneName, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ContentCloneRequestVNext{id=$id, cloneName=$cloneName, additionalProperties=$additionalProperties}"
}
