...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TimeBetween].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(timeBetween: TimeBetween) = apply {
            operator = timeBetween.operator
            inputs = timeBetween.inputs.map { it.toMutableList() }
            propertyName = timeBetween.propertyName
            value = timeBetween.value
            additionalProperties = timeBetween.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TimeBetween].
         *
     ...
     *   expected type.
     */
    fun validate(): TimeBetween = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val TIME_BETWEEN = of("TIME_BETWEEN")
        ...
        fun value(): Value =
            when (this) {
                TIME_BETWEEN -> Value.TIME_BETWEEN
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                TIME_BETWEEN -> Known.TIME_BETWEEN
    ...
    override fun toString() =
        "TimeBetween{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
