...
class BatchResponseAppEventOccurrence
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val completedAt: JsonField<OffsetDateTime>,
    private val results: JsonField<List<AppEventOccurrence>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<AppEventOccurrence>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<AppEventOccurrence> = results.getRequired("results")
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<AppEventOccurrence>> = results
    ...
    /** A builder for [BatchResponseAppEventOccurrence]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<AppEventOccurrence>>? = null
        ...
        @JvmSynthetic
        internal fun from(batchResponseAppEventOccurrence: BatchResponseAppEventOccurrence) =
            apply {
                completedAt = batchResponseAppEventOccurrence.completedAt
                results = batchResponseAppEventOccurrence.results.map { it.toMutableList() }
                startedAt = batchResponseAppEventOccurrence.startedAt
                status = batchResponseAppEventOccurrence.status
                errors = batchResponseAppEventOccurrence.errors.map { it.toMutableList() }
                links = batchResponseAppEventOccurrence.links
                numErrors = batchResponseAppEventOccurrence.numErrors
                requestedAt = batchResponseAppEventOccurrence.requestedAt
                additionalProperties =
                    batchResponseAppEventOccurrence.additionalProperties.toMutableMap()
            }
        ...
        fun results(results: List<AppEventOccurrence>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed `List<AppEventOccurrence>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun results(results: JsonField<List<AppEventOccurrence>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [AppEventOccurrence] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: AppEventOccurrence) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [BatchResponseAppEventOccurrence].
         *
         ...
         */
        fun build(): BatchResponseAppEventOccurrence =
            BatchResponseAppEventOccurrence(
    ...
    fun validate(): BatchResponseAppEventOccurrence = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseAppEventOccurrence &&
    ...
    override fun toString() =
        "BatchResponseAppEventOccurrence{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
