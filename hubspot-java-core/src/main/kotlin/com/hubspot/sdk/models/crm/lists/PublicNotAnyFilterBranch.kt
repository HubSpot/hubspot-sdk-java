...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicNotAnyFilterBranch].
         *
    ...
    /** A builder for [PublicNotAnyFilterBranch]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicNotAnyFilterBranch: PublicNotAnyFilterBranch) = apply {
            filterBranches = publicNotAnyFilterBranch.filterBranches.map { it.toMutableList() }
            filterBranchOperator = publicNotAnyFilterBranch.filterBranchOperator
            filterBranchType = publicNotAnyFilterBranch.filterBranchType
            filters = publicNotAnyFilterBranch.filters.map { it.toMutableList() }
            additionalProperties = publicNotAnyFilterBranch.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicNotAnyFilterBranch].
         *
         ...
         */
        fun build(): PublicNotAnyFilterBranch =
    ...
    fun validate(): PublicNotAnyFilterBranch = apply {
        if (validated) {
            return@apply
        }
    ...
    class FilterBranchType @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            @JvmField val NOT_ANY = of("NOT_ANY")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicNotAnyFilterBranch &&
    ...
    override fun toString() =
        "PublicNotAnyFilterBranch{filterBranches=$filterBranches, filterBranchOperator=$filterBranchOperator, filterBranchType=$filterBranchType, filters=$filters, additionalProperties=$additionalProperties}"
}
