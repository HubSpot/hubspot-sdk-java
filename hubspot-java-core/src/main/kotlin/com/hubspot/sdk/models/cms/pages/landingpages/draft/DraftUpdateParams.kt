...
/**
 * Partially updates the draft version of a single landing page, specified by its ID. You only need
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(draftUpdateParams: DraftUpdateParams) = apply {
            objectId = draftUpdateParams.objectId
            pagesPage = draftUpdateParams.pagesPage
    ...
    override fun toString() =
        "DraftUpdateParams{objectId=$objectId, pagesPage=$pagesPage, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
