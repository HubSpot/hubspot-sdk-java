...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LessThan].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(lessThan: LessThan) = apply {
            operator = lessThan.operator
            inputs = lessThan.inputs.map { it.toMutableList() }
            propertyName = lessThan.propertyName
            value = lessThan.value
            additionalProperties = lessThan.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LessThan].
         *
    ...
    override fun toString() =
        "LessThan{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
