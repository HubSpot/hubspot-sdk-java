...
/** @see FeeServiceAsync.list */
class FeeListPageAsync
private constructor(
    private val service: FeeServiceAsync,
    private val streamHandlerExecutor: Executor,
    private val params: FeeListParams,
    ...
    fun nextPageParams(): FeeListParams {
        val nextCursor =
            paging()
                .flatMap { it._next().getOptional("next") }
                .flatMap { it._after().getOptional("after") }
    ...
    override fun nextPage(): CompletableFuture<FeeListPageAsync> = service.list(nextPageParams())

    fun autoPager(): AutoPagerAsync<SimplePublicObjectWithAssociations> =
        AutoPagerAsync.from(this, streamHandlerExecutor)

    /** The parameters that were used to request this page. */
    fun params(): FeeListParams = params
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FeeListPageAsync].
         *
    ...
    /** A builder for [FeeListPageAsync]. */
    class Builder internal constructor() {

        private var service: FeeServiceAsync? = null
        private var streamHandlerExecutor: Executor? = null
        private var params: FeeListParams? = null
        private var response: CollectionResponseSimplePublicObjectWithAssociationsForwardPaging? =
            null

        @JvmSynthetic
        internal fun from(feeListPageAsync: FeeListPageAsync) = apply {
            service = feeListPageAsync.service
            streamHandlerExecutor = feeListPageAsync.streamHandlerExecutor
            params = feeListPageAsync.params
            response = feeListPageAsync.response
        }

        fun service(service: FeeServiceAsync) = apply { this.service = service }
        ...
        /** The parameters that were used to request this page. */
        fun params(params: FeeListParams) = apply { this.params = params }
        ...
        /**
         * Returns an immutable instance of [FeeListPageAsync].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeeListPageAsync &&
    ...
    override fun toString() =
        "FeeListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}
