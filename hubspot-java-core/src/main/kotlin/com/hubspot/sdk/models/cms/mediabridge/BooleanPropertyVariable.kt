...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BooleanPropertyVariable].
         *
    ...
    /** A builder for [BooleanPropertyVariable]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(booleanPropertyVariable: BooleanPropertyVariable) = apply {
            operator = booleanPropertyVariable.operator
            propertyName = booleanPropertyVariable.propertyName
            value = booleanPropertyVariable.value
            additionalProperties = booleanPropertyVariable.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BooleanPropertyVariable].
         *
         ...
         */
        fun build(): BooleanPropertyVariable =
     ...
     *   expected type.
     */
    fun validate(): BooleanPropertyVariable = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val BOOLEAN_PROPERTY_VARIABLE = of("BOOLEAN_PROPERTY_VARIABLE")
        ...
        fun value(): Value =
            when (this) {
                BOOLEAN_PROPERTY_VARIABLE -> Value.BOOLEAN_PROPERTY_VARIABLE
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                BOOLEAN_PROPERTY_VARIABLE -> Known.BOOLEAN_PROPERTY_VARIABLE
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BooleanPropertyVariable &&
    ...
    override fun toString() =
        "BooleanPropertyVariable{operator=$operator, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
