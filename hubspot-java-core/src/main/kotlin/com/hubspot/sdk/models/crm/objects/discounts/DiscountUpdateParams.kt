...
/**
 * Perform a partial update of an Object identified by `{discountId}`or optionally a unique property
 * value as specified by the `idProperty` query param. `{discountId}` refers to the internal object
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(discountUpdateParams: DiscountUpdateParams) = apply {
            ...
            idProperty = discountUpdateParams.idProperty
            simplePublicObjectInput = discountUpdateParams.simplePublicObjectInput
    ...
    override fun toString() =
        "DiscountUpdateParams{discountId=$discountId, idProperty=$idProperty, simplePublicObjectInput=$simplePublicObjectInput, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
