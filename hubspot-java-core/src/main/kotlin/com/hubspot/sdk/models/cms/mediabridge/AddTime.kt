...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AddTime].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(addTime: AddTime) = apply {
            operator = addTime.operator
            stringToCheck = addTime.stringToCheck
            inputs = addTime.inputs.map { it.toMutableList() }
            propertyName = addTime.propertyName
            value = addTime.value
            additionalProperties = addTime.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AddTime].
         *
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val ADD_TIME = of("ADD_TIME")
    ...
    override fun toString() =
        "AddTime{operator=$operator, stringToCheck=$stringToCheck, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
