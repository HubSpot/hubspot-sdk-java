...
private constructor(
    ...
    /** A builder for [ExtractMostRecentEmailReplyText]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(extractMostRecentEmailReplyText: ExtractMostRecentEmailReplyText) =
            apply {
                operator = extractMostRecentEmailReplyText.operator
                inputs = extractMostRecentEmailReplyText.inputs.map { it.toMutableList() }
                propertyName = extractMostRecentEmailReplyText.propertyName
                value = extractMostRecentEmailReplyText.value
                additionalProperties =
                    extractMostRecentEmailReplyText.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ExtractMostRecentEmailReplyText].
         *
         ...
         */
        fun build(): ExtractMostRecentEmailReplyText =
            ExtractMostRecentEmailReplyText(
     ...
     *   expected type.
     */
    fun validate(): ExtractMostRecentEmailReplyText = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField
            val EXTRACT_MOST_RECENT_EMAIL_REPLY_TEXT = of("EXTRACT_MOST_RECENT_EMAIL_REPLY_TEXT")
        ...
        fun value(): Value =
            when (this) {
                EXTRACT_MOST_RECENT_EMAIL_REPLY_TEXT -> Value.EXTRACT_MOST_RECENT_EMAIL_REPLY_TEXT
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                EXTRACT_MOST_RECENT_EMAIL_REPLY_TEXT -> Known.EXTRACT_MOST_RECENT_EMAIL_REPLY_TEXT
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExtractMostRecentEmailReplyText &&
    ...
    override fun toString() =
        "ExtractMostRecentEmailReplyText{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
