...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /**
         * Alias for calling [conditionalExpression] with
         * `ConditionalExpression.ofIsBlank(isBlank)`.
         */
        fun conditionalExpression(isBlank: IsBlank) =
            conditionalExpression(ConditionalExpression.ofIsBlank(isBlank))
    ...
    private constructor(
        ...
        override fun toString(): String =
            when {
                ...
                isBlank != null -> "ConditionalExpression{isBlank=$isBlank}"
        ...
        companion object {
            ...
            @JvmStatic fun ofIsBlank(isBlank: IsBlank) = ConditionalExpression(isBlank = isBlank)
                ...
                val bestMatches =
                    sequenceOf(
                            ...
                            tryDeserialize(node, jacksonTypeRef<IsBlank>())?.let {
                                ConditionalExpression(isBlank = it, _json = json)
                            },
