...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IsMonthBasedIsoPeriod].
         *
    ...
    /** A builder for [IsMonthBasedIsoPeriod]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(isMonthBasedIsoPeriod: IsMonthBasedIsoPeriod) = apply {
            operator = isMonthBasedIsoPeriod.operator
            inputs = isMonthBasedIsoPeriod.inputs.map { it.toMutableList() }
            propertyName = isMonthBasedIsoPeriod.propertyName
            value = isMonthBasedIsoPeriod.value
            additionalProperties = isMonthBasedIsoPeriod.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IsMonthBasedIsoPeriod].
         *
         ...
         */
        fun build(): IsMonthBasedIsoPeriod =
     ...
     *   expected type.
     */
    fun validate(): IsMonthBasedIsoPeriod = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val IS_MONTH_BASED_ISO_PERIOD = of("IS_MONTH_BASED_ISO_PERIOD")
        ...
        fun value(): Value =
            when (this) {
                IS_MONTH_BASED_ISO_PERIOD -> Value.IS_MONTH_BASED_ISO_PERIOD
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                IS_MONTH_BASED_ISO_PERIOD -> Known.IS_MONTH_BASED_ISO_PERIOD
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IsMonthBasedIsoPeriod &&
    ...
    override fun toString() =
        "IsMonthBasedIsoPeriod{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
