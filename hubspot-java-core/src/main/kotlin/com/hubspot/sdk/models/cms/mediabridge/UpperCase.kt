...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UpperCase].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(upperCase: UpperCase) = apply {
            operator = upperCase.operator
            inputs = upperCase.inputs.map { it.toMutableList() }
            propertyName = upperCase.propertyName
            value = upperCase.value
            additionalProperties = upperCase.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UpperCase].
         *
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val UPPER_CASE = of("UPPER_CASE")
    ...
    override fun toString() =
        "UpperCase{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
