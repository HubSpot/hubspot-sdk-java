...
class ComparativeStringPropertyOperation
...
private constructor(
    ...
    /** A builder for [ComparativeStringPropertyOperation]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(comparativeStringPropertyOperation: ComparativeStringPropertyOperation) =
            apply {
                comparisonPropertyName = comparativeStringPropertyOperation.comparisonPropertyName
                includeObjectsWithNoValueSet =
                    comparativeStringPropertyOperation.includeObjectsWithNoValueSet
                operationType = comparativeStringPropertyOperation.operationType
                operator = comparativeStringPropertyOperation.operator
                operatorName = comparativeStringPropertyOperation.operatorName
                propertyType = comparativeStringPropertyOperation.propertyType
                defaultValue = comparativeStringPropertyOperation.defaultValue
                renderSpec = comparativeStringPropertyOperation.renderSpec
                additionalProperties =
                    comparativeStringPropertyOperation.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ComparativeStringPropertyOperation].
         *
         ...
         */
        fun build(): ComparativeStringPropertyOperation =
            ComparativeStringPropertyOperation(
     ...
     *   expected type.
     */
    fun validate(): ComparativeStringPropertyOperation = apply {
        if (validated) {
            return@apply
        }
    ...
    class PropertyType @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            @JvmField val STRING_COMPARATIVE = of("string-comparative")
        ...
        fun value(): Value =
            when (this) {
                STRING_COMPARATIVE -> Value.STRING_COMPARATIVE
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                STRING_COMPARATIVE -> Known.STRING_COMPARATIVE
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ComparativeStringPropertyOperation &&
