...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [Month].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(month: Month) = apply {
            operator = month.operator
            inputs = month.inputs.map { it.toMutableList() }
            propertyName = month.propertyName
            value = month.value
            additionalProperties = month.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [Month].
         *
    ...
    override fun toString() =
        "Month{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
