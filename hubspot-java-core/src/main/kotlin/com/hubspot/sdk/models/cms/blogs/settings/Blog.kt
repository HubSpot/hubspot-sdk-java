...
private constructor(
    ...
    private val allowComments: JsonField<Boolean>,
    ...
    private val listingPageId: JsonField<String>,
    ...
    private val publicTitle: JsonField<String>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        allowComments: JsonField<Boolean> = JsonMissing.of(),
        ...
        @JsonProperty("listingPageId")
        @ExcludeMissing
        listingPageId: JsonField<String> = JsonMissing.of(),
        ...
        @ExcludeMissing
        publicTitle: JsonField<String> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun allowComments(): Boolean = allowComments.getRequired("allowComments")
     ...
     */
    @JsonProperty("absoluteUrl") @ExcludeMissing fun _absoluteUrl(): JsonField<String> = absoluteUrl

    /**
     * Returns the raw JSON value of [allowComments].
     *
     * Unlike [allowComments], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("allowComments")
    @ExcludeMissing
    fun _allowComments(): JsonField<Boolean> = allowComments
    ...
    /**
     * Returns the raw JSON value of [listingPageId].
     *
     * Unlike [listingPageId], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("listingPageId")
    @ExcludeMissing
    fun _listingPageId(): JsonField<String> = listingPageId
    ...
    /**
     * Returns the raw JSON value of [publicTitle].
     *
     * Unlike [publicTitle], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("publicTitle") @ExcludeMissing fun _publicTitle(): JsonField<String> = publicTitle
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [Blog].
         *
    ...
    class Builder internal constructor() {
        ...
        private var absoluteUrl: JsonField<String>? = null
        private var allowComments: JsonField<Boolean>? = null
        ...
        private var listingPageId: JsonField<String>? = null
        ...
        private var publicTitle: JsonField<String>? = null
        ...
        @JvmSynthetic
        internal fun from(blog: Blog) = apply {
            id = blog.id
            ...
            listingPageId = blog.listingPageId
            name = blog.name
            publicAccessRules = blog.publicAccessRules.map { it.toMutableList() }
            publicAccessRulesEnabled = blog.publicAccessRulesEnabled
            publicTitle = blog.publicTitle
            slug = blog.slug
            translatedFromId = blog.translatedFromId
        ...
        /**
         * Sets [Builder.allowComments] to an arbitrary JSON value.
         *
         * You should usually call [Builder.allowComments] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun allowComments(allowComments: JsonField<Boolean>) = apply {
        ...
        fun listingPageId(listingPageId: String) = listingPageId(JsonField.of(listingPageId))

        /**
         * Sets [Builder.listingPageId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.listingPageId] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun listingPageId(listingPageId: JsonField<String>) = apply {
        ...
        /**
         * Sets [Builder.publicTitle] to an arbitrary JSON value.
         *
         * You should usually call [Builder.publicTitle] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        ...
        /**
         * Returns an immutable instance of [Blog].
         *
        ...
        fun build(): Blog =
            Blog(
                checkRequired("id", id),
                checkRequired("absoluteUrl", absoluteUrl),
                checkRequired("allowComments", allowComments),
                checkRequired("created", created),
                checkRequired("deletedAt", deletedAt),
                checkRequired("description", description),
                checkRequired("htmlTitle", htmlTitle),
                checkRequired("language", language),
                checkRequired("listingPageId", listingPageId),
                ...
                checkRequired("publicTitle", publicTitle),
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            (if (absoluteUrl.asKnown().isPresent) 1 else 0) +
            (if (allowComments.asKnown().isPresent) 1 else 0) +
            ...
            (if (listingPageId.asKnown().isPresent) 1 else 0) +
            ...
            (if (publicTitle.asKnown().isPresent) 1 else 0) +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is Blog &&
            ...
            listingPageId == other.listingPageId &&
            name == other.name &&
    ...
    override fun toString() =
        "Blog{id=$id, absoluteUrl=$absoluteUrl, allowComments=$allowComments, created=$created, deletedAt=$deletedAt, description=$description, htmlTitle=$htmlTitle, language=$language, listingPageId=$listingPageId, name=$name, publicAccessRules=$publicAccessRules, publicAccessRulesEnabled=$publicAccessRulesEnabled, publicTitle=$publicTitle, slug=$slug, translatedFromId=$translatedFromId, updated=$updated, additionalProperties=$additionalProperties}"
}
