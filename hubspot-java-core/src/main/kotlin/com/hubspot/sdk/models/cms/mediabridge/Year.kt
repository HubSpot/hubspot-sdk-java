...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [Year].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(year: Year) = apply {
            operator = year.operator
            inputs = year.inputs.map { it.toMutableList() }
            propertyName = year.propertyName
            value = year.value
            additionalProperties = year.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [Year].
         *
    ...
    override fun toString() =
        "Year{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
