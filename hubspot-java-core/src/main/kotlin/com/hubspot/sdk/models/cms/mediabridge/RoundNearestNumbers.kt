...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RoundNearestNumbers].
         *
    ...
    /** A builder for [RoundNearestNumbers]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(roundNearestNumbers: RoundNearestNumbers) = apply {
            operator = roundNearestNumbers.operator
            inputs = roundNearestNumbers.inputs.map { it.toMutableList() }
            propertyName = roundNearestNumbers.propertyName
            value = roundNearestNumbers.value
            additionalProperties = roundNearestNumbers.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RoundNearestNumbers].
         *
     ...
     *   expected type.
     */
    fun validate(): RoundNearestNumbers = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val ROUND_NEAREST = of("ROUND_NEAREST")
        ...
        fun value(): Value =
            when (this) {
                ROUND_NEAREST -> Value.ROUND_NEAREST
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                ROUND_NEAREST -> Known.ROUND_NEAREST
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RoundNearestNumbers &&
    ...
    override fun toString() =
        "RoundNearestNumbers{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
