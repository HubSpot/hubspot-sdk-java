...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [IndexOffset]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [IndexOffset]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(indexOffset: IndexOffset) = apply {
            days = indexOffset.days
            hours = indexOffset.hours
            milliseconds = indexOffset.milliseconds
            minutes = indexOffset.minutes
            months = indexOffset.months
            quarters = indexOffset.quarters
            seconds = indexOffset.seconds
            weeks = indexOffset.weeks
            years = indexOffset.years
            additionalProperties = indexOffset.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IndexOffset].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): IndexOffset =
            IndexOffset(
                days,
                hours,
                milliseconds,
    ...
    fun validate(): IndexOffset = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "IndexOffset{days=$days, hours=$hours, milliseconds=$milliseconds, minutes=$minutes, months=$months, quarters=$quarters, seconds=$seconds, weeks=$weeks, years=$years, additionalProperties=$additionalProperties}"
}
