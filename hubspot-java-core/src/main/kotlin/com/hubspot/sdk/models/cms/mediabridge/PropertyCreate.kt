...
private constructor(
    ...
    override fun toString() =
        "PropertyCreate{fieldType=$fieldType, groupName=$groupName, label=$label, name=$name, type=$type, calculationFormula=$calculationFormula, dataSensitivity=$dataSensitivity, description=$description, displayOrder=$displayOrder, externalOptions=$externalOptions, formField=$formField, hasUniqueValue=$hasUniqueValue, hidden=$hidden, options=$options, referencedObjectType=$referencedObjectType, additionalProperties=$additionalProperties}"
}
