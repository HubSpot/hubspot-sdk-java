...
private constructor(
    ...
    /** A builder for [CollectionResponseAssociationSpecWithLabelNoPaging]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            results =
                collectionResponseAssociationSpecWithLabelNoPaging.results.map {
                    it.toMutableList()
                }
            additionalProperties =
                collectionResponseAssociationSpecWithLabelNoPaging.additionalProperties
                    .toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CollectionResponseAssociationSpecWithLabelNoPaging].
         *
         ...
         */
        fun build(): CollectionResponseAssociationSpecWithLabelNoPaging =
            CollectionResponseAssociationSpecWithLabelNoPaging(
    ...
    fun validate(): CollectionResponseAssociationSpecWithLabelNoPaging = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionResponseAssociationSpecWithLabelNoPaging &&
    ...
    override fun toString() =
        "CollectionResponseAssociationSpecWithLabelNoPaging{results=$results, additionalProperties=$additionalProperties}"
}
