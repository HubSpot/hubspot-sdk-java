...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [And].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(and: And) = apply {
            enclosedInParentheses = and.enclosedInParentheses
            operator = and.operator
            inputs = and.inputs.map { it.toMutableList() }
            propertyName = and.propertyName
            value = and.value
            additionalProperties = and.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [And].
         *
    ...
    override fun toString() =
        "And{enclosedInParentheses=$enclosedInParentheses, operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
