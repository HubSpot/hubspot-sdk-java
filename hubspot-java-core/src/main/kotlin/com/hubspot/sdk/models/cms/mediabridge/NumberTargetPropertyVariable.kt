...
class NumberTargetPropertyVariable
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NumberTargetPropertyVariable].
         *
    ...
    /** A builder for [NumberTargetPropertyVariable]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(numberTargetPropertyVariable: NumberTargetPropertyVariable) = apply {
            operator = numberTargetPropertyVariable.operator
            propertyName = numberTargetPropertyVariable.propertyName
            value = numberTargetPropertyVariable.value
            additionalProperties = numberTargetPropertyVariable.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NumberTargetPropertyVariable].
         *
         ...
         */
        fun build(): NumberTargetPropertyVariable =
    ...
    fun validate(): NumberTargetPropertyVariable = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val NUMBER_TARGET_PROPERTY_VARIABLE = of("NUMBER_TARGET_PROPERTY_VARIABLE")
        ...
        fun value(): Value =
            when (this) {
                NUMBER_TARGET_PROPERTY_VARIABLE -> Value.NUMBER_TARGET_PROPERTY_VARIABLE
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                NUMBER_TARGET_PROPERTY_VARIABLE -> Known.NUMBER_TARGET_PROPERTY_VARIABLE
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NumberTargetPropertyVariable &&
    ...
    override fun toString() =
        "NumberTargetPropertyVariable{operator=$operator, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
