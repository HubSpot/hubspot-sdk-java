...
/**
 * Perform a partial update of an Object identified by `{emailId}`or optionally a unique property
 * value as specified by the `idProperty` query param. `{emailId}` refers to the internal object ID
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(emailUpdateParams: EmailUpdateParams) = apply {
            ...
            idProperty = emailUpdateParams.idProperty
            simplePublicObjectInput = emailUpdateParams.simplePublicObjectInput
    ...
    override fun toString() =
        "EmailUpdateParams{emailId=$emailId, idProperty=$idProperty, simplePublicObjectInput=$simplePublicObjectInput, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
