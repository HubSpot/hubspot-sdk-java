...
class BatchUpdateLandingPagesParams
private constructor(
    ...
    /** A builder for [BatchUpdateLandingPagesParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchUpdateLandingPagesParams: BatchUpdateLandingPagesParams) = apply {
            archived = batchUpdateLandingPagesParams.archived
            batchInputJsonNode = batchUpdateLandingPagesParams.batchInputJsonNode
            additionalHeaders = batchUpdateLandingPagesParams.additionalHeaders.toBuilder()
            additionalQueryParams = batchUpdateLandingPagesParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BatchUpdateLandingPagesParams].
         *
         ...
         */
        fun build(): BatchUpdateLandingPagesParams =
            BatchUpdateLandingPagesParams(
                archived,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchUpdateLandingPagesParams &&
    ...
    override fun toString() =
        "BatchUpdateLandingPagesParams{archived=$archived, batchInputJsonNode=$batchInputJsonNode, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
