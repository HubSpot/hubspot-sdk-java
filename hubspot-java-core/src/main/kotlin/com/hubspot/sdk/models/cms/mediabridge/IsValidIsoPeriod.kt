...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IsValidIsoPeriod].
         *
    ...
    /** A builder for [IsValidIsoPeriod]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(isValidIsoPeriod: IsValidIsoPeriod) = apply {
            operator = isValidIsoPeriod.operator
            inputs = isValidIsoPeriod.inputs.map { it.toMutableList() }
            propertyName = isValidIsoPeriod.propertyName
            value = isValidIsoPeriod.value
            additionalProperties = isValidIsoPeriod.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IsValidIsoPeriod].
         *
     ...
     *   expected type.
     */
    fun validate(): IsValidIsoPeriod = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val IS_VALID_ISO_PERIOD = of("IS_VALID_ISO_PERIOD")
        ...
        fun value(): Value =
            when (this) {
                IS_VALID_ISO_PERIOD -> Value.IS_VALID_ISO_PERIOD
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                IS_VALID_ISO_PERIOD -> Known.IS_VALID_ISO_PERIOD
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IsValidIsoPeriod &&
    ...
    override fun toString() =
        "IsValidIsoPeriod{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
