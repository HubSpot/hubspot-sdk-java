...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RoundUpNumbers].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(roundUpNumbers: RoundUpNumbers) = apply {
            operator = roundUpNumbers.operator
            inputs = roundUpNumbers.inputs.map { it.toMutableList() }
            propertyName = roundUpNumbers.propertyName
            value = roundUpNumbers.value
            additionalProperties = roundUpNumbers.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RoundUpNumbers].
         *
     ...
     *   expected type.
     */
    fun validate(): RoundUpNumbers = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RoundUpNumbers &&
    ...
    override fun toString() =
        "RoundUpNumbers{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
