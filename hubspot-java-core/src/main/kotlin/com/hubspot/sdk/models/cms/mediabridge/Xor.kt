...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [Xor].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(xor: Xor) = apply {
            enclosedInParentheses = xor.enclosedInParentheses
            operator = xor.operator
            inputs = xor.inputs.map { it.toMutableList() }
            propertyName = xor.propertyName
            value = xor.value
            additionalProperties = xor.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [Xor].
         *
    ...
    override fun toString() =
        "Xor{enclosedInParentheses=$enclosedInParentheses, operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
