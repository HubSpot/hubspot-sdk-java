...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ObjectFieldSchema].
         *
    ...
    /** A builder for [ObjectFieldSchema]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(objectFieldSchema: ObjectFieldSchema) = apply {
            properties = objectFieldSchema.properties
            type = objectFieldSchema.type
        ...
        /**
         * Returns an immutable instance of [ObjectFieldSchema].
         *
     ...
     *   expected type.
     */
    fun validate(): ObjectFieldSchema = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ObjectFieldSchema &&
            properties == other.properties &&
            type == other.type &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(properties, type, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ObjectFieldSchema{properties=$properties, type=$type, additionalProperties=$additionalProperties}"
}
