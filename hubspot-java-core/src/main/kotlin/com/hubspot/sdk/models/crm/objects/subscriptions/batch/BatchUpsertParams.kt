...
package com.hubspot.sdk.models.crm.objects.subscriptions.batch
...
/**
 * This endpoint allows you to perform a batch upsert operation on subscription objects, which will
 * either update existing records or create new ones if they do not already exist. The operation
 * returns the status, timestamps, and a list of successfully processed objects.
 */
