...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicBudgetItem].
         *
    ...
    /** A builder for [PublicBudgetItem]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicBudgetItem: PublicBudgetItem) = apply {
            id = publicBudgetItem.id
            amount = publicBudgetItem.amount
            createdAt = publicBudgetItem.createdAt
            name = publicBudgetItem.name
            order = publicBudgetItem.order
            updatedAt = publicBudgetItem.updatedAt
            description = publicBudgetItem.description
            additionalProperties = publicBudgetItem.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicBudgetItem].
         *
     ...
     *   expected type.
     */
    fun validate(): PublicBudgetItem = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicBudgetItem &&
            id == other.id &&
            amount == other.amount &&
    ...
    override fun toString() =
        "PublicBudgetItem{id=$id, amount=$amount, createdAt=$createdAt, name=$name, order=$order, updatedAt=$updatedAt, description=$description, additionalProperties=$additionalProperties}"
}
