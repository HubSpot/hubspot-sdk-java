...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicEmailVersion].
         *
    ...
    /** A builder for [PublicEmailVersion]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicEmailVersion: PublicEmailVersion) = apply {
            id = publicEmailVersion.id
            object_ = publicEmailVersion.object_
            updatedAt = publicEmailVersion.updatedAt
            user = publicEmailVersion.user
            additionalProperties = publicEmailVersion.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicEmailVersion].
         *
    ...
    fun validate(): PublicEmailVersion = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicEmailVersion &&
            id == other.id &&
    ...
    override fun toString() =
        "PublicEmailVersion{id=$id, object_=$object_, updatedAt=$updatedAt, user=$user, additionalProperties=$additionalProperties}"
}
