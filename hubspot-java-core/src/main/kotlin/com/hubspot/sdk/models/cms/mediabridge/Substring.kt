...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [Substring].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(substring: Substring) = apply {
            operator = substring.operator
            stringToCheck = substring.stringToCheck
            inputs = substring.inputs.map { it.toMutableList() }
            propertyName = substring.propertyName
            value = substring.value
            additionalProperties = substring.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [Substring].
         *
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val SUBSTRING = of("SUBSTRING")
    ...
    override fun toString() =
        "Substring{operator=$operator, stringToCheck=$stringToCheck, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
