...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(attentionSpanEventRequest: AttentionSpanEventRequest) = apply {
            ...
            externalPlayContext = attentionSpanEventRequest.externalPlayContext
    ...
    override fun toString() =
        "AttentionSpanEventRequest{mediaType=$mediaType, occurredTimestamp=$occurredTimestamp, rawDataMap=$rawDataMap, sessionId=$sessionId, _hsenc=$_hsenc, contactId=$contactId, contactUtk=$contactUtk, derivedValues=$derivedValues, externalId=$externalId, externalPlayContext=$externalPlayContext, mediaBridgeId=$mediaBridgeId, mediaName=$mediaName, mediaUrl=$mediaUrl, pageId=$pageId, pageName=$pageName, pageUrl=$pageUrl, rawDataString=$rawDataString, additionalProperties=$additionalProperties}"
}
