...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TagListCursorParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TagListCursorParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TagListCursorParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tagListCursorParams: TagListCursorParams) = apply {
            after = tagListCursorParams.after
            archived = tagListCursorParams.archived
            createdAfter = tagListCursorParams.createdAfter
            createdAt = tagListCursorParams.createdAt
            createdBefore = tagListCursorParams.createdBefore
            limit = tagListCursorParams.limit
            property = tagListCursorParams.property
            sort = tagListCursorParams.sort?.toMutableList()
            updatedAfter = tagListCursorParams.updatedAfter
            updatedAt = tagListCursorParams.updatedAt
            updatedBefore = tagListCursorParams.updatedBefore
            additionalHeaders = tagListCursorParams.additionalHeaders.toBuilder()
            additionalQueryParams = tagListCursorParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TagListCursorParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TagListCursorParams =
            TagListCursorParams(
                after,
                archived,
                createdAfter,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TagListCursorParams &&
            after == other.after &&
    ...
    override fun toString() =
        "TagListCursorParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
