...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RoundDownNumbers].
         *
    ...
    /** A builder for [RoundDownNumbers]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(roundDownNumbers: RoundDownNumbers) = apply {
            operator = roundDownNumbers.operator
            inputs = roundDownNumbers.inputs.map { it.toMutableList() }
            propertyName = roundDownNumbers.propertyName
            value = roundDownNumbers.value
            additionalProperties = roundDownNumbers.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RoundDownNumbers].
         *
     ...
     *   expected type.
     */
    fun validate(): RoundDownNumbers = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RoundDownNumbers &&
    ...
    override fun toString() =
        "RoundDownNumbers{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
