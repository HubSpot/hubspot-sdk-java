...
private constructor(
    ...
    private val authorFullName: JsonField<String>,
    private val category: JsonField<String>,
    private val combinedId: JsonField<String>,
    private val contentType: JsonField<String>,
    private val description: JsonField<String>,
    private val featuredImageUrl: JsonField<String>,
    private val inBeta: JsonField<Boolean>,
    private val isPrivate: JsonField<Boolean>,
    private val language: JsonField<Language>,
    private val publishedDate: JsonField<Long>,
    private val rowId: JsonField<Long>,
    private val subcategory: JsonField<String>,
    private val tableId: JsonField<Long>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        featuredImageUrl: JsonField<String> = JsonMissing.of(),
        @JsonProperty("inBeta") @ExcludeMissing inBeta: JsonField<Boolean> = JsonMissing.of(),
        ...
        @ExcludeMissing
        publishedDate: JsonField<Long> = JsonMissing.of(),
        @JsonProperty("rowId") @ExcludeMissing rowId: JsonField<Long> = JsonMissing.of(),
        @JsonProperty("subcategory")
        @ExcludeMissing
        subcategory: JsonField<String> = JsonMissing.of(),
        @JsonProperty("tableId") @ExcludeMissing tableId: JsonField<Long> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun combinedId(): Optional<String> = combinedId.getOptional("combinedId")
     ...
     *   server responded with an unexpected value).
     */
    fun featuredImageUrl(): Optional<String> = featuredImageUrl.getOptional("featuredImageUrl")

    /**
     * @throws HubSpotInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun inBeta(): Optional<Boolean> = inBeta.getOptional("inBeta")
     ...
     *   server responded with an unexpected value).
     */
    fun publishedDate(): Optional<Long> = publishedDate.getOptional("publishedDate")
     ...
     *   server responded with an unexpected value).
     */
    fun rowId(): Optional<Long> = rowId.getOptional("rowId")
     ...
     *   server responded with an unexpected value).
     */
    fun tableId(): Optional<Long> = tableId.getOptional("tableId")
    ...
    @JsonProperty("authorFullName")
    @ExcludeMissing
    fun _authorFullName(): JsonField<String> = authorFullName
     ...
     */
    @JsonProperty("combinedId") @ExcludeMissing fun _combinedId(): JsonField<String> = combinedId
    ...
    @JsonProperty("featuredImageUrl")
    @ExcludeMissing
    fun _featuredImageUrl(): JsonField<String> = featuredImageUrl
     ...
     */
    @JsonProperty("inBeta") @ExcludeMissing fun _inBeta(): JsonField<Boolean> = inBeta
    ...
    @JsonProperty("publishedDate")
    @ExcludeMissing
    fun _publishedDate(): JsonField<Long> = publishedDate
     ...
     */
    @JsonProperty("rowId") @ExcludeMissing fun _rowId(): JsonField<Long> = rowId
     ...
     */
    @JsonProperty("tableId") @ExcludeMissing fun _tableId(): JsonField<Long> = tableId
    ...
    class Builder internal constructor() {
        ...
        private var authorFullName: JsonField<String> = JsonMissing.of()
        private var category: JsonField<String> = JsonMissing.of()
        private var combinedId: JsonField<String> = JsonMissing.of()
        private var contentType: JsonField<String> = JsonMissing.of()
        private var description: JsonField<String> = JsonMissing.of()
        private var featuredImageUrl: JsonField<String> = JsonMissing.of()
        private var inBeta: JsonField<Boolean> = JsonMissing.of()
        private var isPrivate: JsonField<Boolean> = JsonMissing.of()
        private var language: JsonField<Language> = JsonMissing.of()
        private var publishedDate: JsonField<Long> = JsonMissing.of()
        private var rowId: JsonField<Long> = JsonMissing.of()
        private var subcategory: JsonField<String> = JsonMissing.of()
        private var tableId: JsonField<Long> = JsonMissing.of()
        private var tags: JsonField<MutableList<String>>? = null
        private var title: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(contentSearchResult: ContentSearchResult) = apply {
            id = contentSearchResult.id
            domain = contentSearchResult.domain
            score = contentSearchResult.score
            type = contentSearchResult.type
            url = contentSearchResult.url
            authorFullName = contentSearchResult.authorFullName
            category = contentSearchResult.category
            combinedId = contentSearchResult.combinedId
            contentType = contentSearchResult.contentType
            description = contentSearchResult.description
            featuredImageUrl = contentSearchResult.featuredImageUrl
            inBeta = contentSearchResult.inBeta
            isPrivate = contentSearchResult.isPrivate
            language = contentSearchResult.language
            publishedDate = contentSearchResult.publishedDate
            rowId = contentSearchResult.rowId
            subcategory = contentSearchResult.subcategory
            tableId = contentSearchResult.tableId
            tags = contentSearchResult.tags.map { it.toMutableList() }
            title = contentSearchResult.title
            additionalProperties = contentSearchResult.additionalProperties.toMutableMap()
        }
        ...
        /** Name of the author. */
        fun authorFullName(authorFullName: String) = authorFullName(JsonField.of(authorFullName))

        /**
         * Sets [Builder.authorFullName] to an arbitrary JSON value.
         *
         * You should usually call [Builder.authorFullName] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun authorFullName(authorFullName: JsonField<String>) = apply {
        ...
        /** The ID of the document in HubSpot. */
        fun combinedId(combinedId: String) = combinedId(JsonField.of(combinedId))

        /**
         * Sets [Builder.combinedId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.combinedId] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun combinedId(combinedId: JsonField<String>) = apply { this.combinedId = combinedId }
        ...
        /** URL of the featured image. */
        fun featuredImageUrl(featuredImageUrl: String) =
            featuredImageUrl(JsonField.of(featuredImageUrl))

        /**
         * Sets [Builder.featuredImageUrl] to an arbitrary JSON value.
         *
         * You should usually call [Builder.featuredImageUrl] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun featuredImageUrl(featuredImageUrl: JsonField<String>) = apply {
            this.featuredImageUrl = featuredImageUrl
        }

        fun inBeta(inBeta: Boolean) = inBeta(JsonField.of(inBeta))

        /**
         * Sets [Builder.inBeta] to an arbitrary JSON value.
         *
         * You should usually call [Builder.inBeta] with a well-typed [Boolean] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun inBeta(inBeta: JsonField<Boolean>) = apply { this.inBeta = inBeta }
        ...
        /** The date the content was published. */
        fun publishedDate(publishedDate: Long) = publishedDate(JsonField.of(publishedDate))

        /**
         * Sets [Builder.publishedDate] to an arbitrary JSON value.
         *
         * You should usually call [Builder.publishedDate] with a well-typed [Long] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun publishedDate(publishedDate: JsonField<Long>) = apply {
            this.publishedDate = publishedDate
        }

        /** If a dynamic page, the row ID in the HubDB table. */
        fun rowId(rowId: Long) = rowId(JsonField.of(rowId))

        /**
         * Sets [Builder.rowId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.rowId] with a well-typed [Long] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun rowId(rowId: JsonField<Long>) = apply { this.rowId = rowId }
        ...
        /** If a dynamic page, the ID of the HubDB table. */
        fun tableId(tableId: Long) = tableId(JsonField.of(tableId))

        /**
         * Sets [Builder.tableId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.tableId] with a well-typed [Long] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun tableId(tableId: JsonField<Long>) = apply { this.tableId = tableId }
        ...
        /**
         * Returns an immutable instance of [ContentSearchResult].
         *
     ...
     *   expected type.
     */
    fun validate(): ContentSearchResult = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (if (authorFullName.asKnown().isPresent) 1 else 0) +
            (if (category.asKnown().isPresent) 1 else 0) +
            (if (combinedId.asKnown().isPresent) 1 else 0) +
            (if (contentType.asKnown().isPresent) 1 else 0) +
            (if (description.asKnown().isPresent) 1 else 0) +
            (if (featuredImageUrl.asKnown().isPresent) 1 else 0) +
            (if (inBeta.asKnown().isPresent) 1 else 0) +
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        fun known(): Known =
            when (this) {
                ...
                STRUCTURED_CONTENT -> Known.STRUCTURED_CONTENT
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ContentSearchResult &&
            id == other.id &&
            domain == other.domain &&
            score == other.score &&
            type == other.type &&
    ...
    override fun toString() =
        "ContentSearchResult{id=$id, domain=$domain, score=$score, type=$type, url=$url, authorFullName=$authorFullName, category=$category, combinedId=$combinedId, contentType=$contentType, description=$description, featuredImageUrl=$featuredImageUrl, inBeta=$inBeta, isPrivate=$isPrivate, language=$language, publishedDate=$publishedDate, rowId=$rowId, subcategory=$subcategory, tableId=$tableId, tags=$tags, title=$title, additionalProperties=$additionalProperties}"
}
