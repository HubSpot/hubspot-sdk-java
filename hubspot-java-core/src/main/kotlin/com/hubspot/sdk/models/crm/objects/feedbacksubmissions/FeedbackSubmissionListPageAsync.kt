...
/** @see FeedbackSubmissionServiceAsync.list */
class FeedbackSubmissionListPageAsync
private constructor(
    private val service: FeedbackSubmissionServiceAsync,
    ...
    override fun nextPage(): CompletableFuture<FeedbackSubmissionListPageAsync> =
    ...
    companion object {
         ...
         * [FeedbackSubmissionListPageAsync].
         *
    ...
    /** A builder for [FeedbackSubmissionListPageAsync]. */
    class Builder internal constructor() {

        private var service: FeedbackSubmissionServiceAsync? = null
        ...
        @JvmSynthetic
        internal fun from(feedbackSubmissionListPageAsync: FeedbackSubmissionListPageAsync) =
            apply {
                service = feedbackSubmissionListPageAsync.service
                streamHandlerExecutor = feedbackSubmissionListPageAsync.streamHandlerExecutor
                params = feedbackSubmissionListPageAsync.params
                response = feedbackSubmissionListPageAsync.response
            }

        fun service(service: FeedbackSubmissionServiceAsync) = apply { this.service = service }
        ...
        /**
         * Returns an immutable instance of [FeedbackSubmissionListPageAsync].
         *
         ...
         */
        fun build(): FeedbackSubmissionListPageAsync =
            FeedbackSubmissionListPageAsync(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeedbackSubmissionListPageAsync &&
    ...
    override fun toString() =
        "FeedbackSubmissionListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}
