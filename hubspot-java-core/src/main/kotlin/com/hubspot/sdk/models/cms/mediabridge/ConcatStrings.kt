...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ConcatStrings].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(concatStrings: ConcatStrings) = apply {
            operator = concatStrings.operator
            inputs = concatStrings.inputs.map { it.toMutableList() }
            propertyName = concatStrings.propertyName
            value = concatStrings.value
            additionalProperties = concatStrings.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConcatStrings].
         *
     ...
     *   expected type.
     */
    fun validate(): ConcatStrings = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CONCAT_STRINGS = of("CONCAT_STRINGS")
        ...
        fun value(): Value =
            when (this) {
                CONCAT_STRINGS -> Value.CONCAT_STRINGS
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CONCAT_STRINGS -> Known.CONCAT_STRINGS
    ...
    override fun toString() =
        "ConcatStrings{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
