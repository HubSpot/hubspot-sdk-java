...
package com.hubspot.sdk.models.crm.objects.notes
...
/**
 * Read an Object identified by `{noteId}`. `{noteId}` refers to the internal object ID by default,
...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): NoteGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [NoteGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [NoteGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(noteGetParams: NoteGetParams) = apply {
            noteId = noteGetParams.noteId
            archived = noteGetParams.archived
            associations = noteGetParams.associations?.toMutableList()
            idProperty = noteGetParams.idProperty
            properties = noteGetParams.properties?.toMutableList()
            propertiesWithHistory = noteGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = noteGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = noteGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [NoteGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): NoteGetParams =
            NoteGetParams(
                noteId,
                archived,
    ...
    override fun toString() =
        "NoteGetParams{noteId=$noteId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
