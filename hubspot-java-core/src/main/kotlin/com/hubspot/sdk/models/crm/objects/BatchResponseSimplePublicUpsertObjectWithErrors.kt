...
/**
 * Represents the response from a batch upsert operation, including the status, timestamps,
 * successfully processed objects, and any errors that occurred during processing.
 */
class BatchResponseSimplePublicUpsertObjectWithErrors
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val completedAt: JsonField<OffsetDateTime>,
    private val results: JsonField<List<SimplePublicUpsertObject>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<SimplePublicUpsertObject>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<SimplePublicUpsertObject> = results.getRequired("results")
    ...
    /**
     * The status of the batch processing request. Can be: "PENDING", "PROCESSING", "CANCELLED", or
     * "COMPLETE".
     *
     * @throws HubSpotInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<SimplePublicUpsertObject>> = results
    ...
    /** A builder for [BatchResponseSimplePublicUpsertObjectWithErrors]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<SimplePublicUpsertObject>>? = null
        ...
        internal fun from(
            ...
            completedAt = batchResponseSimplePublicUpsertObjectWithErrors.completedAt
            results =
                batchResponseSimplePublicUpsertObjectWithErrors.results.map { it.toMutableList() }
            startedAt = batchResponseSimplePublicUpsertObjectWithErrors.startedAt
            status = batchResponseSimplePublicUpsertObjectWithErrors.status
            errors =
                batchResponseSimplePublicUpsertObjectWithErrors.errors.map { it.toMutableList() }
            links = batchResponseSimplePublicUpsertObjectWithErrors.links
            numErrors = batchResponseSimplePublicUpsertObjectWithErrors.numErrors
            requestedAt = batchResponseSimplePublicUpsertObjectWithErrors.requestedAt
            additionalProperties =
                batchResponseSimplePublicUpsertObjectWithErrors.additionalProperties.toMutableMap()
        }
        ...
        fun results(results: List<SimplePublicUpsertObject>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed
         * `List<SimplePublicUpsertObject>` value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun results(results: JsonField<List<SimplePublicUpsertObject>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [SimplePublicUpsertObject] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: SimplePublicUpsertObject) = apply {
            results =
        ...
        /**
         * The status of the batch processing request. Can be: "PENDING", "PROCESSING", "CANCELLED",
         * or "COMPLETE".
         */
        ...
        /**
         * Returns an immutable instance of [BatchResponseSimplePublicUpsertObjectWithErrors].
         *
         ...
         */
        fun build(): BatchResponseSimplePublicUpsertObjectWithErrors =
            BatchResponseSimplePublicUpsertObjectWithErrors(
     ...
     *   expected type.
     */
    fun validate(): BatchResponseSimplePublicUpsertObjectWithErrors = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseSimplePublicUpsertObjectWithErrors &&
    ...
    override fun toString() =
        "BatchResponseSimplePublicUpsertObjectWithErrors{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
