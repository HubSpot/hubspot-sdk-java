...
private constructor(
    ...
    private val enableTracking: JsonField<Boolean>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        enableTracking: JsonField<Boolean> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun pageUrl(): String = pageUrl.getRequired("pageUrl")
     ...
     *   server responded with an unexpected value).
     */
    fun enableTracking(): Optional<Boolean> = enableTracking.getOptional("enableTracking")
    ...
    /**
     * Returns the raw JSON value of [enableTracking].
     *
     * Unlike [enableTracking], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("enableTracking")
    @ExcludeMissing
    fun _enableTracking(): JsonField<Boolean> = enableTracking
    ...
    /** A builder for [PublicPageViewAnalyticsFilter]. */
    class Builder internal constructor() {

        private var filterType: JsonField<FilterType>? = null
        private var operator: JsonField<String>? = null
        private var pageUrl: JsonField<String>? = null
        private var coalescingRefineBy: JsonField<CoalescingRefineBy> = JsonMissing.of()
        private var enableTracking: JsonField<Boolean> = JsonMissing.of()
        private var pruningRefineBy: JsonField<PruningRefineBy> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(publicPageViewAnalyticsFilter: PublicPageViewAnalyticsFilter) = apply {
            filterType = publicPageViewAnalyticsFilter.filterType
            operator = publicPageViewAnalyticsFilter.operator
            pageUrl = publicPageViewAnalyticsFilter.pageUrl
            coalescingRefineBy = publicPageViewAnalyticsFilter.coalescingRefineBy
            enableTracking = publicPageViewAnalyticsFilter.enableTracking
            pruningRefineBy = publicPageViewAnalyticsFilter.pruningRefineBy
            additionalProperties = publicPageViewAnalyticsFilter.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Sets [Builder.enableTracking] to an arbitrary JSON value.
         *
         * You should usually call [Builder.enableTracking] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun enableTracking(enableTracking: JsonField<Boolean>) = apply {
        ...
        /**
         * Returns an immutable instance of [PublicPageViewAnalyticsFilter].
         *
         ...
         */
        fun build(): PublicPageViewAnalyticsFilter =
            PublicPageViewAnalyticsFilter(
                checkRequired("filterType", filterType),
                checkRequired("operator", operator),
                checkRequired("pageUrl", pageUrl),
                coalescingRefineBy,
                enableTracking,
                pruningRefineBy,
    ...
    fun validate(): PublicPageViewAnalyticsFilter = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (filterType.asKnown().getOrNull()?.validity() ?: 0) +
            ...
            (if (enableTracking.asKnown().isPresent) 1 else 0) +
    ...
    class FilterType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val PAGE_VIEW = of("PAGE_VIEW")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicPageViewAnalyticsFilter &&
    ...
    override fun toString() =
        "PublicPageViewAnalyticsFilter{filterType=$filterType, operator=$operator, pageUrl=$pageUrl, coalescingRefineBy=$coalescingRefineBy, enableTracking=$enableTracking, pruningRefineBy=$pruningRefineBy, additionalProperties=$additionalProperties}"
}
