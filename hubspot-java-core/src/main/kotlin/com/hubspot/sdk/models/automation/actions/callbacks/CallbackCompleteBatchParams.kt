...
class CallbackCompleteBatchParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CallbackCompleteBatchParams].
         *
    ...
    /** A builder for [CallbackCompleteBatchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callbackCompleteBatchParams: CallbackCompleteBatchParams) = apply {
            batchInputCallbackCompletionBatchRequest =
                callbackCompleteBatchParams.batchInputCallbackCompletionBatchRequest
            additionalHeaders = callbackCompleteBatchParams.additionalHeaders.toBuilder()
            additionalQueryParams = callbackCompleteBatchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CallbackCompleteBatchParams].
         *
         ...
         */
        fun build(): CallbackCompleteBatchParams =
            CallbackCompleteBatchParams(
                checkRequired(
                    "batchInputCallbackCompletionBatchRequest",
                    batchInputCallbackCompletionBatchRequest,
                ),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CallbackCompleteBatchParams &&
            batchInputCallbackCompletionBatchRequest ==
    ...
    override fun toString() =
        "CallbackCompleteBatchParams{batchInputCallbackCompletionBatchRequest=$batchInputCallbackCompletionBatchRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
