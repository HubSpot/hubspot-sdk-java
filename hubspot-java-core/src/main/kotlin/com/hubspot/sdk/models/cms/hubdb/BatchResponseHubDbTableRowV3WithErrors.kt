...
private constructor(
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<HubDbTableRowV3>> = results
    ...
    /** A builder for [BatchResponseHubDbTableRowV3WithErrors]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            completedAt = batchResponseHubDbTableRowV3WithErrors.completedAt
            results = batchResponseHubDbTableRowV3WithErrors.results.map { it.toMutableList() }
            startedAt = batchResponseHubDbTableRowV3WithErrors.startedAt
            status = batchResponseHubDbTableRowV3WithErrors.status
            errors = batchResponseHubDbTableRowV3WithErrors.errors.map { it.toMutableList() }
            links = batchResponseHubDbTableRowV3WithErrors.links
            numErrors = batchResponseHubDbTableRowV3WithErrors.numErrors
            requestedAt = batchResponseHubDbTableRowV3WithErrors.requestedAt
            additionalProperties =
                batchResponseHubDbTableRowV3WithErrors.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.results] with a well-typed `List<HubDbTableRowV3>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun results(results: JsonField<List<HubDbTableRowV3>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [HubDbTableRowV3] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: HubDbTableRowV3) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [BatchResponseHubDbTableRowV3WithErrors].
         *
         ...
         */
        fun build(): BatchResponseHubDbTableRowV3WithErrors =
            BatchResponseHubDbTableRowV3WithErrors(
    ...
    fun validate(): BatchResponseHubDbTableRowV3WithErrors = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseHubDbTableRowV3WithErrors &&
    ...
    override fun toString() =
        "BatchResponseHubDbTableRowV3WithErrors{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
