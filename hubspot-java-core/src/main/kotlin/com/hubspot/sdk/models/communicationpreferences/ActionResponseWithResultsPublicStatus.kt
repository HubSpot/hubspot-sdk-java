...
class ActionResponseWithResultsPublicStatus
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val completedAt: JsonField<OffsetDateTime>,
    private val results: JsonField<List<PublicStatus>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<PublicStatus>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<PublicStatus> = results.getRequired("results")
    ...
    /**
     * Indicates the current status of the operation, with possible values: PENDING, PROCESSING,
     * CANCELED, COMPLETE.
     *
     * @throws HubSpotInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     ...
     */
    @JsonProperty("results") @ExcludeMissing fun _results(): JsonField<List<PublicStatus>> = results
    ...
    /** A builder for [ActionResponseWithResultsPublicStatus]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<PublicStatus>>? = null
        ...
        @JvmSynthetic
        internal fun from(
            actionResponseWithResultsPublicStatus: ActionResponseWithResultsPublicStatus
        ) = apply {
            completedAt = actionResponseWithResultsPublicStatus.completedAt
            results = actionResponseWithResultsPublicStatus.results.map { it.toMutableList() }
            startedAt = actionResponseWithResultsPublicStatus.startedAt
            status = actionResponseWithResultsPublicStatus.status
            errors = actionResponseWithResultsPublicStatus.errors.map { it.toMutableList() }
            links = actionResponseWithResultsPublicStatus.links
            numErrors = actionResponseWithResultsPublicStatus.numErrors
            requestedAt = actionResponseWithResultsPublicStatus.requestedAt
            additionalProperties =
                actionResponseWithResultsPublicStatus.additionalProperties.toMutableMap()
        }
        ...
        /** An array of results from the operation. */
        fun results(results: List<PublicStatus>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed `List<PublicStatus>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun results(results: JsonField<List<PublicStatus>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [PublicStatus] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: PublicStatus) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [ActionResponseWithResultsPublicStatus].
         *
         ...
         */
        fun build(): ActionResponseWithResultsPublicStatus =
            ActionResponseWithResultsPublicStatus(
    ...
    fun validate(): ActionResponseWithResultsPublicStatus = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionResponseWithResultsPublicStatus &&
    ...
    override fun toString() =
        "ActionResponseWithResultsPublicStatus{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
