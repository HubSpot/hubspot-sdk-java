...
class FolderUpdateFoldersParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FolderUpdateFoldersParams].
         *
    ...
    /** A builder for [FolderUpdateFoldersParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(folderUpdateFoldersParams: FolderUpdateFoldersParams) = apply {
            archived = folderUpdateFoldersParams.archived
            batchInputJsonNode = folderUpdateFoldersParams.batchInputJsonNode
            additionalHeaders = folderUpdateFoldersParams.additionalHeaders.toBuilder()
            additionalQueryParams = folderUpdateFoldersParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FolderUpdateFoldersParams].
         *
         ...
         */
        fun build(): FolderUpdateFoldersParams =
            FolderUpdateFoldersParams(
                archived,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FolderUpdateFoldersParams &&
    ...
    override fun toString() =
        "FolderUpdateFoldersParams{archived=$archived, batchInputJsonNode=$batchInputJsonNode, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
