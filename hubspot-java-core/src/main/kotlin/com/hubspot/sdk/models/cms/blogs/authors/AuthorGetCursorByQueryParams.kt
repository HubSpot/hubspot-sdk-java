...
class AuthorGetCursorByQueryParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AuthorGetCursorByQueryParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [AuthorGetCursorByQueryParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AuthorGetCursorByQueryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(authorGetCursorByQueryParams: AuthorGetCursorByQueryParams) = apply {
            after = authorGetCursorByQueryParams.after
            archived = authorGetCursorByQueryParams.archived
            createdAfter = authorGetCursorByQueryParams.createdAfter
            createdAt = authorGetCursorByQueryParams.createdAt
            createdBefore = authorGetCursorByQueryParams.createdBefore
            limit = authorGetCursorByQueryParams.limit
            property = authorGetCursorByQueryParams.property
            sort = authorGetCursorByQueryParams.sort?.toMutableList()
            updatedAfter = authorGetCursorByQueryParams.updatedAfter
            updatedAt = authorGetCursorByQueryParams.updatedAt
            updatedBefore = authorGetCursorByQueryParams.updatedBefore
            additionalHeaders = authorGetCursorByQueryParams.additionalHeaders.toBuilder()
            additionalQueryParams = authorGetCursorByQueryParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AuthorGetCursorByQueryParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AuthorGetCursorByQueryParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AuthorGetCursorByQueryParams &&
            after == other.after &&
    ...
    override fun toString() =
        "AuthorGetCursorByQueryParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
