...
/**
 * Perform a partial update of an Object identified by `{serviceId}`or optionally a unique property
 * value as specified by the `idProperty` query param. `{serviceId}` refers to the internal object
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ServiceUpdateParams].
         *
    ...
    /** A builder for [ServiceUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(serviceUpdateParams: ServiceUpdateParams) = apply {
            serviceId = serviceUpdateParams.serviceId
            idProperty = serviceUpdateParams.idProperty
            simplePublicObjectInput = serviceUpdateParams.simplePublicObjectInput
            additionalHeaders = serviceUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = serviceUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ServiceUpdateParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ServiceUpdateParams &&
    ...
    override fun toString() =
        "ServiceUpdateParams{serviceId=$serviceId, idProperty=$idProperty, simplePublicObjectInput=$simplePublicObjectInput, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
