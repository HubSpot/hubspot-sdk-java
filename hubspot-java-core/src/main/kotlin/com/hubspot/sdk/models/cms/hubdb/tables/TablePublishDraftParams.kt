...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TablePublishDraftParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TablePublishDraftParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TablePublishDraftParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tablePublishDraftParams: TablePublishDraftParams) = apply {
            tableIdOrName = tablePublishDraftParams.tableIdOrName
            includeForeignIds = tablePublishDraftParams.includeForeignIds
            additionalHeaders = tablePublishDraftParams.additionalHeaders.toBuilder()
            additionalQueryParams = tablePublishDraftParams.additionalQueryParams.toBuilder()
            additionalBodyProperties =
                tablePublishDraftParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TablePublishDraftParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TablePublishDraftParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TablePublishDraftParams &&
    ...
    override fun toString() =
        "TablePublishDraftParams{tableIdOrName=$tableIdOrName, includeForeignIds=$includeForeignIds, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
