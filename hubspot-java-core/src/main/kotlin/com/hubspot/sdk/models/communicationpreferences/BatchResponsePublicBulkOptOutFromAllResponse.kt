...
class BatchResponsePublicBulkOptOutFromAllResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val completedAt: JsonField<OffsetDateTime>,
    private val results: JsonField<List<PublicBulkOptOutFromAllResponse>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<PublicBulkOptOutFromAllResponse>> = JsonMissing.of(),
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<PublicBulkOptOutFromAllResponse>> = results
    ...
    /** A builder for [BatchResponsePublicBulkOptOutFromAllResponse]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<PublicBulkOptOutFromAllResponse>>? = null
        ...
        internal fun from(
            ...
            completedAt = batchResponsePublicBulkOptOutFromAllResponse.completedAt
            results =
                batchResponsePublicBulkOptOutFromAllResponse.results.map { it.toMutableList() }
            startedAt = batchResponsePublicBulkOptOutFromAllResponse.startedAt
            status = batchResponsePublicBulkOptOutFromAllResponse.status
            errors = batchResponsePublicBulkOptOutFromAllResponse.errors.map { it.toMutableList() }
            links = batchResponsePublicBulkOptOutFromAllResponse.links
            numErrors = batchResponsePublicBulkOptOutFromAllResponse.numErrors
            requestedAt = batchResponsePublicBulkOptOutFromAllResponse.requestedAt
            additionalProperties =
                batchResponsePublicBulkOptOutFromAllResponse.additionalProperties.toMutableMap()
        }
         ...
         * An array containing the results of the bulk opt-out from all communications operation.
         */
        fun results(results: List<PublicBulkOptOutFromAllResponse>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed
         * `List<PublicBulkOptOutFromAllResponse>` value instead. This method is primarily for
         * setting the field to an undocumented or not yet supported value.
         */
        fun results(results: JsonField<List<PublicBulkOptOutFromAllResponse>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [PublicBulkOptOutFromAllResponse] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: PublicBulkOptOutFromAllResponse) = apply {
            results =
        ...
        /**
         * The current status of the bulk opt-out operation, which can be PENDING, PROCESSING,
        ...
        /**
         * An array of error objects detailing any issues encountered during the bulk opt-out
         * operation.
         */
        ...
        /**
         * Returns an immutable instance of [BatchResponsePublicBulkOptOutFromAllResponse].
         *
         ...
         */
        fun build(): BatchResponsePublicBulkOptOutFromAllResponse =
            BatchResponsePublicBulkOptOutFromAllResponse(
    ...
    fun validate(): BatchResponsePublicBulkOptOutFromAllResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponsePublicBulkOptOutFromAllResponse &&
    ...
    override fun toString() =
        "BatchResponsePublicBulkOptOutFromAllResponse{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
