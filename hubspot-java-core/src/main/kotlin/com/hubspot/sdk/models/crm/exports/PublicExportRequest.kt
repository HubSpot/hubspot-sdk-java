...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = publicExportRequest.accept(new PublicExportRequest.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitView(PublicExportViewRequest view) {
