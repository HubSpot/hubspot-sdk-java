...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NumberEquals].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(numberEquals: NumberEquals) = apply {
            operator = numberEquals.operator
            inputs = numberEquals.inputs.map { it.toMutableList() }
            propertyName = numberEquals.propertyName
            value = numberEquals.value
            additionalProperties = numberEquals.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NumberEquals].
         *
     ...
     *   expected type.
     */
    fun validate(): NumberEquals = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val NUMBER_EQUALS = of("NUMBER_EQUALS")
        ...
        fun value(): Value =
            when (this) {
                NUMBER_EQUALS -> Value.NUMBER_EQUALS
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                NUMBER_EQUALS -> Known.NUMBER_EQUALS
    ...
    override fun toString() =
        "NumberEquals{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
