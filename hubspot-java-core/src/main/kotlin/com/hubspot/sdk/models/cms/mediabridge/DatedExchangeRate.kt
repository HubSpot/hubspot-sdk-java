...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DatedExchangeRate].
         *
    ...
    /** A builder for [DatedExchangeRate]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(datedExchangeRate: DatedExchangeRate) = apply {
            operator = datedExchangeRate.operator
            inputs = datedExchangeRate.inputs.map { it.toMutableList() }
            propertyName = datedExchangeRate.propertyName
            value = datedExchangeRate.value
            additionalProperties = datedExchangeRate.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DatedExchangeRate].
         *
     ...
     *   expected type.
     */
    fun validate(): DatedExchangeRate = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val DATED_EXCHANGE_RATE = of("DATED_EXCHANGE_RATE")
        ...
        fun value(): Value =
            when (this) {
                DATED_EXCHANGE_RATE -> Value.DATED_EXCHANGE_RATE
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                DATED_EXCHANGE_RATE -> Known.DATED_EXCHANGE_RATE
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DatedExchangeRate &&
    ...
    override fun toString() =
        "DatedExchangeRate{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
