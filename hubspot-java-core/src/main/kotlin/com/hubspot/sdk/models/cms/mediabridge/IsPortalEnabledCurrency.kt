...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IsPortalEnabledCurrency].
         *
    ...
    /** A builder for [IsPortalEnabledCurrency]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(isPortalEnabledCurrency: IsPortalEnabledCurrency) = apply {
            operator = isPortalEnabledCurrency.operator
            inputs = isPortalEnabledCurrency.inputs.map { it.toMutableList() }
            propertyName = isPortalEnabledCurrency.propertyName
            value = isPortalEnabledCurrency.value
            additionalProperties = isPortalEnabledCurrency.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IsPortalEnabledCurrency].
         *
         ...
         */
        fun build(): IsPortalEnabledCurrency =
     ...
     *   expected type.
     */
    fun validate(): IsPortalEnabledCurrency = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val IS_PORTAL_ENABLED_CURRENCY = of("IS_PORTAL_ENABLED_CURRENCY")
        ...
        fun value(): Value =
            when (this) {
                IS_PORTAL_ENABLED_CURRENCY -> Value.IS_PORTAL_ENABLED_CURRENCY
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                IS_PORTAL_ENABLED_CURRENCY -> Known.IS_PORTAL_ENABLED_CURRENCY
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IsPortalEnabledCurrency &&
    ...
    override fun toString() =
        "IsPortalEnabledCurrency{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
