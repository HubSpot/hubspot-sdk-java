...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TaskLocator].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(taskLocator: TaskLocator) = apply {
            id = taskLocator.id
            links = taskLocator.links
            additionalProperties = taskLocator.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TaskLocator].
         *
         ...
         */
        fun build(): TaskLocator =
            TaskLocator(checkRequired("id", id), links, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): TaskLocator = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "TaskLocator{id=$id, links=$links, additionalProperties=$additionalProperties}"
}
