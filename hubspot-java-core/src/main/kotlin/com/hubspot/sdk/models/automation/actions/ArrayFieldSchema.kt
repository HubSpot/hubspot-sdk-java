...
private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("items") @ExcludeMissing items: JsonValue = JsonMissing.of(),
     ...
     * ```java
     * MyClass myObject = arrayFieldSchema.items().convert(MyClass.class);
     * ```
     */
    @JsonProperty("items") @ExcludeMissing fun _items(): JsonValue = items
    ...
    class Builder internal constructor() {
        ...
        private var items: JsonValue? = null
        ...
        fun items(items: JsonValue) = apply { this.items = items }
