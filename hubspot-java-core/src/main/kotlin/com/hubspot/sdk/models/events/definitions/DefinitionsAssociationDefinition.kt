...
class DefinitionsAssociationDefinition
...
private constructor(
    ...
    /** A builder for [DefinitionsAssociationDefinition]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(definitionsAssociationDefinition: DefinitionsAssociationDefinition) =
            apply {
                id = definitionsAssociationDefinition.id
                allowsCustomLabels = definitionsAssociationDefinition.allowsCustomLabels
                cardinality = definitionsAssociationDefinition.cardinality
                category = definitionsAssociationDefinition.category
                fromObjectTypeId = definitionsAssociationDefinition.fromObjectTypeId
                hasAllAssociatedObjects = definitionsAssociationDefinition.hasAllAssociatedObjects
                hasCascadingDeletes = definitionsAssociationDefinition.hasCascadingDeletes
                hasUserEnforcedMaxFromObjectIds =
                    definitionsAssociationDefinition.hasUserEnforcedMaxFromObjectIds
                hasUserEnforcedMaxToObjectIds =
                    definitionsAssociationDefinition.hasUserEnforcedMaxToObjectIds
                hidden = definitionsAssociationDefinition.hidden
                inverseAllowsCustomLabels =
                    definitionsAssociationDefinition.inverseAllowsCustomLabels
                inverseCardinality = definitionsAssociationDefinition.inverseCardinality
                inverseHasAllAssociatedObjects =
                    definitionsAssociationDefinition.inverseHasAllAssociatedObjects
                inverseId = definitionsAssociationDefinition.inverseId
                inverseName = definitionsAssociationDefinition.inverseName
                isDefault = definitionsAssociationDefinition.isDefault
                isInversePrimary = definitionsAssociationDefinition.isInversePrimary
                isPrimary = definitionsAssociationDefinition.isPrimary
                maxFromObjectIds = definitionsAssociationDefinition.maxFromObjectIds
                maxToObjectIds = definitionsAssociationDefinition.maxToObjectIds
                name = definitionsAssociationDefinition.name
                portalUniqueIdentifier = definitionsAssociationDefinition.portalUniqueIdentifier
                readOnly = definitionsAssociationDefinition.readOnly
                toObjectTypeId = definitionsAssociationDefinition.toObjectTypeId
                fromObjectType = definitionsAssociationDefinition.fromObjectType
                hiddenReason = definitionsAssociationDefinition.hiddenReason
                inverseLabel = definitionsAssociationDefinition.inverseLabel
                label = definitionsAssociationDefinition.label
                toObjectType = definitionsAssociationDefinition.toObjectType
                additionalProperties =
                    definitionsAssociationDefinition.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [DefinitionsAssociationDefinition].
         *
         ...
         */
        fun build(): DefinitionsAssociationDefinition =
            DefinitionsAssociationDefinition(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): DefinitionsAssociationDefinition = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DefinitionsAssociationDefinition &&
            id == other.id &&
