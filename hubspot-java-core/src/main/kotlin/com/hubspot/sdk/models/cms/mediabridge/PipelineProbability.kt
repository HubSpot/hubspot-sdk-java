...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PipelineProbability].
         *
    ...
    /** A builder for [PipelineProbability]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pipelineProbability: PipelineProbability) = apply {
            operator = pipelineProbability.operator
            inputs = pipelineProbability.inputs.map { it.toMutableList() }
            propertyName = pipelineProbability.propertyName
            value = pipelineProbability.value
            additionalProperties = pipelineProbability.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PipelineProbability].
         *
     ...
     *   expected type.
     */
    fun validate(): PipelineProbability = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val PIPELINE_PROBABILITY = of("PIPELINE_PROBABILITY")
        ...
        fun value(): Value =
            when (this) {
                PIPELINE_PROBABILITY -> Value.PIPELINE_PROBABILITY
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                PIPELINE_PROBABILITY -> Known.PIPELINE_PROBABILITY
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PipelineProbability &&
    ...
    override fun toString() =
        "PipelineProbability{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
