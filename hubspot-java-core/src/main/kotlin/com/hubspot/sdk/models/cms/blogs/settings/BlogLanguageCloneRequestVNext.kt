...
class BlogLanguageCloneRequestVNext
...
private constructor(
    ...
    /** A builder for [BlogLanguageCloneRequestVNext]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(blogLanguageCloneRequestVNext: BlogLanguageCloneRequestVNext) = apply {
            id = blogLanguageCloneRequestVNext.id
        ...
        /**
         * Returns an immutable instance of [BlogLanguageCloneRequestVNext].
         *
         ...
         */
        fun build(): BlogLanguageCloneRequestVNext =
            BlogLanguageCloneRequestVNext(
                checkRequired("id", id),
                language,
                primaryLanguage,
    ...
    fun validate(): BlogLanguageCloneRequestVNext = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BlogLanguageCloneRequestVNext &&
            id == other.id &&
