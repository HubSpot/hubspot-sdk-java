...
class WebhookGetJournalBatchParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [WebhookGetJournalBatchParams].
         *
    ...
    /** A builder for [WebhookGetJournalBatchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(webhookGetJournalBatchParams: WebhookGetJournalBatchParams) = apply {
            installPortalId = webhookGetJournalBatchParams.installPortalId
            batchInputString = webhookGetJournalBatchParams.batchInputString
            additionalHeaders = webhookGetJournalBatchParams.additionalHeaders.toBuilder()
            additionalQueryParams = webhookGetJournalBatchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [WebhookGetJournalBatchParams].
         *
         ...
         */
        fun build(): WebhookGetJournalBatchParams =
            WebhookGetJournalBatchParams(
                installPortalId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebhookGetJournalBatchParams &&
    ...
    override fun toString() =
        "WebhookGetJournalBatchParams{installPortalId=$installPortalId, batchInputString=$batchInputString, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
