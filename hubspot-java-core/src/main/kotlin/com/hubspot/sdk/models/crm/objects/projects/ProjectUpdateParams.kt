...
/**
 * Perform a partial update of an Object identified by `{projectId}`or optionally a unique property
 * value as specified by the `idProperty` query param. `{projectId}` refers to the internal object
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(projectUpdateParams: ProjectUpdateParams) = apply {
            ...
            idProperty = projectUpdateParams.idProperty
            simplePublicObjectInput = projectUpdateParams.simplePublicObjectInput
    ...
    override fun toString() =
        "ProjectUpdateParams{projectId=$projectId, idProperty=$idProperty, simplePublicObjectInput=$simplePublicObjectInput, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
