...
class AuthorGetTagsCursorParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AuthorGetTagsCursorParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [AuthorGetTagsCursorParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AuthorGetTagsCursorParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(authorGetTagsCursorParams: AuthorGetTagsCursorParams) = apply {
            after = authorGetTagsCursorParams.after
            archived = authorGetTagsCursorParams.archived
            createdAfter = authorGetTagsCursorParams.createdAfter
            createdAt = authorGetTagsCursorParams.createdAt
            createdBefore = authorGetTagsCursorParams.createdBefore
            limit = authorGetTagsCursorParams.limit
            property = authorGetTagsCursorParams.property
            sort = authorGetTagsCursorParams.sort?.toMutableList()
            updatedAfter = authorGetTagsCursorParams.updatedAfter
            updatedAt = authorGetTagsCursorParams.updatedAt
            updatedBefore = authorGetTagsCursorParams.updatedBefore
            additionalHeaders = authorGetTagsCursorParams.additionalHeaders.toBuilder()
            additionalQueryParams = authorGetTagsCursorParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AuthorGetTagsCursorParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AuthorGetTagsCursorParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AuthorGetTagsCursorParams &&
            after == other.after &&
    ...
    override fun toString() =
        "AuthorGetTagsCursorParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
