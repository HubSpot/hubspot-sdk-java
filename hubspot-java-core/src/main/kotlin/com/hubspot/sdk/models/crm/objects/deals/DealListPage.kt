...
private constructor(
    ...
    override fun nextPage(): DealListPage = service.list(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DealListPage].
         *
    ...
    /** A builder for [DealListPage]. */
    class Builder internal constructor() {

        private var service: DealService? = null
        ...
        @JvmSynthetic
        internal fun from(dealListPage: DealListPage) = apply {
            service = dealListPage.service
            params = dealListPage.params
            response = dealListPage.response
        }

        fun service(service: DealService) = apply { this.service = service }
        ...
        /**
         * Returns an immutable instance of [DealListPage].
         *
    ...
    override fun toString() = "DealListPage{service=$service, params=$params, response=$response}"
}
