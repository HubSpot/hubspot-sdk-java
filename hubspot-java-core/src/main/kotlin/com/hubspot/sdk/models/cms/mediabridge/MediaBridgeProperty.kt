...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MediaBridgeProperty].
         *
    ...
    /** A builder for [MediaBridgeProperty]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(mediaBridgeProperty: MediaBridgeProperty) = apply {
            allowedObjectTypes = mediaBridgeProperty.allowedObjectTypes.map { it.toMutableList() }
            calculated = mediaBridgeProperty.calculated
            canArchive = mediaBridgeProperty.canArchive
            canRestore = mediaBridgeProperty.canRestore
            createdAt = mediaBridgeProperty.createdAt
            createdUserId = mediaBridgeProperty.createdUserId
            currencyPropertyName = mediaBridgeProperty.currencyPropertyName
            dataSensitivity = mediaBridgeProperty.dataSensitivity
            dateDisplayHint = mediaBridgeProperty.dateDisplayHint
            deleted = mediaBridgeProperty.deleted
            description = mediaBridgeProperty.description
            displayMode = mediaBridgeProperty.displayMode
            displayOrder = mediaBridgeProperty.displayOrder
            enforceMultivalueUniqueness = mediaBridgeProperty.enforceMultivalueUniqueness
            externalOptions = mediaBridgeProperty.externalOptions
            externalOptionsReferenceType = mediaBridgeProperty.externalOptionsReferenceType
            favorited = mediaBridgeProperty.favorited
            favoritedOrder = mediaBridgeProperty.favoritedOrder
            fieldType = mediaBridgeProperty.fieldType
            formField = mediaBridgeProperty.formField
            fromUserId = mediaBridgeProperty.fromUserId
            groupName = mediaBridgeProperty.groupName
            hasUniqueValue = mediaBridgeProperty.hasUniqueValue
            hidden = mediaBridgeProperty.hidden
            hubSpotDefined = mediaBridgeProperty.hubSpotDefined
            isCustomizedDefault = mediaBridgeProperty.isCustomizedDefault
            isMultiValued = mediaBridgeProperty.isMultiValued
            isPartial = mediaBridgeProperty.isPartial
            label = mediaBridgeProperty.label
            mutableDefinitionNotDeletable = mediaBridgeProperty.mutableDefinitionNotDeletable
            name = mediaBridgeProperty.name
            numberDisplayHint = mediaBridgeProperty.numberDisplayHint
            options = mediaBridgeProperty.options.map { it.toMutableList() }
            optionsAreMutable = mediaBridgeProperty.optionsAreMutable
            optionSortStrategy = mediaBridgeProperty.optionSortStrategy
            owningAppId = mediaBridgeProperty.owningAppId
            portalId = mediaBridgeProperty.portalId
            readOnlyDefinition = mediaBridgeProperty.readOnlyDefinition
            readOnlyValue = mediaBridgeProperty.readOnlyValue
            referencedObjectType = mediaBridgeProperty.referencedObjectType
            searchableInGlobalSearch = mediaBridgeProperty.searchableInGlobalSearch
            searchTextAnalysisMode = mediaBridgeProperty.searchTextAnalysisMode
            sensitiveDataCategories =
                mediaBridgeProperty.sensitiveDataCategories.map { it.toMutableList() }
            showCurrencySymbol = mediaBridgeProperty.showCurrencySymbol
            textDisplayHint = mediaBridgeProperty.textDisplayHint
            type = mediaBridgeProperty.type
            updatedAt = mediaBridgeProperty.updatedAt
            additionalProperties = mediaBridgeProperty.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MediaBridgeProperty].
         *
    ...
    fun validate(): MediaBridgeProperty = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MediaBridgeProperty &&
