...
/**
 * Perform a partial update of an Object identified by `{invoiceId}`or optionally a unique property
 * value as specified by the `idProperty` query param. `{invoiceId}` refers to the internal object
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(invoiceUpdateParams: InvoiceUpdateParams) = apply {
            ...
            idProperty = invoiceUpdateParams.idProperty
            simplePublicObjectInput = invoiceUpdateParams.simplePublicObjectInput
    ...
    override fun toString() =
        "InvoiceUpdateParams{invoiceId=$invoiceId, idProperty=$idProperty, simplePublicObjectInput=$simplePublicObjectInput, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
