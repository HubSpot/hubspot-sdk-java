...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicFiscalQuarterReference].
         *
    ...
    /** A builder for [PublicFiscalQuarterReference]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicFiscalQuarterReference: PublicFiscalQuarterReference) = apply {
            day = publicFiscalQuarterReference.day
            month = publicFiscalQuarterReference.month
            referenceType = publicFiscalQuarterReference.referenceType
            hour = publicFiscalQuarterReference.hour
            millisecond = publicFiscalQuarterReference.millisecond
            minute = publicFiscalQuarterReference.minute
            second = publicFiscalQuarterReference.second
            additionalProperties = publicFiscalQuarterReference.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicFiscalQuarterReference].
         *
         ...
         */
        fun build(): PublicFiscalQuarterReference =
     ...
     *   expected type.
     */
    fun validate(): PublicFiscalQuarterReference = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicFiscalQuarterReference &&
            day == other.day &&
            month == other.month &&
    ...
    override fun toString() =
        "PublicFiscalQuarterReference{day=$day, month=$month, referenceType=$referenceType, hour=$hour, millisecond=$millisecond, minute=$minute, second=$second, additionalProperties=$additionalProperties}"
}
