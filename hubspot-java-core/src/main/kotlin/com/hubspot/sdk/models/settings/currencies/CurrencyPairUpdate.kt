...
class CurrencyPairUpdate
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val fromCurrencyCode: JsonField<FromCurrencyCode>,
    private val toCurrencyCode: JsonField<ToCurrencyCode>,
    private val visibleInUi: JsonField<Boolean>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        toCurrencyCode: JsonField<ToCurrencyCode> = JsonMissing.of(),
        @JsonProperty("visibleInUI")
        @ExcludeMissing
        visibleInUi: JsonField<Boolean> = JsonMissing.of(),
     ...
     *
     * Unlike [toCurrencyCode], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("toCurrencyCode")
    @ExcludeMissing
    fun _toCurrencyCode(): JsonField<ToCurrencyCode> = toCurrencyCode

    /**
     * Returns the raw JSON value of [visibleInUi].
     *
     * Unlike [visibleInUi], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("visibleInUI")
    @ExcludeMissing
    fun _visibleInUi(): JsonField<Boolean> = visibleInUi
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CurrencyPairUpdate].
         *
    ...
    /** A builder for [CurrencyPairUpdate]. */
    class Builder internal constructor() {

        private var fromCurrencyCode: JsonField<FromCurrencyCode>? = null
        private var toCurrencyCode: JsonField<ToCurrencyCode>? = null
        private var visibleInUi: JsonField<Boolean>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(currencyPairUpdate: CurrencyPairUpdate) = apply {
            fromCurrencyCode = currencyPairUpdate.fromCurrencyCode
            toCurrencyCode = currencyPairUpdate.toCurrencyCode
            visibleInUi = currencyPairUpdate.visibleInUi
         ...
         *
         * You should usually call [Builder.toCurrencyCode] with a well-typed [ToCurrencyCode] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun toCurrencyCode(toCurrencyCode: JsonField<ToCurrencyCode>) = apply {
        ...
        /**
         * Sets [Builder.visibleInUi] to an arbitrary JSON value.
         *
         * You should usually call [Builder.visibleInUi] with a well-typed [Boolean] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun visibleInUi(visibleInUi: JsonField<Boolean>) = apply { this.visibleInUi = visibleInUi }
        ...
        /**
         * Returns an immutable instance of [CurrencyPairUpdate].
         *
         ...
         */
        fun build(): CurrencyPairUpdate =
            CurrencyPairUpdate(
                checkRequired("fromCurrencyCode", fromCurrencyCode),
                checkRequired("toCurrencyCode", toCurrencyCode),
                checkRequired("visibleInUi", visibleInUi),
    ...
    fun validate(): CurrencyPairUpdate = apply {
        if (validated) {
            return@apply
        }

        fromCurrencyCode().validate()
        toCurrencyCode().validate()
        visibleInUi()
        validated = true
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CurrencyPairUpdate &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(fromCurrencyCode, toCurrencyCode, visibleInUi, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "CurrencyPairUpdate{fromCurrencyCode=$fromCurrencyCode, toCurrencyCode=$toCurrencyCode, visibleInUi=$visibleInUi, additionalProperties=$additionalProperties}"
}
