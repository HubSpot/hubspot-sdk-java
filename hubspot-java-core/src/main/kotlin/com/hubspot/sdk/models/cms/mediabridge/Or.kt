...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [Or].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(or: Or) = apply {
            enclosedInParentheses = or.enclosedInParentheses
            operator = or.operator
            inputs = or.inputs.map { it.toMutableList() }
            propertyName = or.propertyName
            value = or.value
            additionalProperties = or.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [Or].
         *
    ...
    override fun toString() =
        "Or{enclosedInParentheses=$enclosedInParentheses, operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
