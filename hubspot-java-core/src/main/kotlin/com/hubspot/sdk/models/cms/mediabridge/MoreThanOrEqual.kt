...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MoreThanOrEqual].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(moreThanOrEqual: MoreThanOrEqual) = apply {
            operator = moreThanOrEqual.operator
            inputs = moreThanOrEqual.inputs.map { it.toMutableList() }
            propertyName = moreThanOrEqual.propertyName
            value = moreThanOrEqual.value
            additionalProperties = moreThanOrEqual.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MoreThanOrEqual].
         *
     ...
     *   expected type.
     */
    fun validate(): MoreThanOrEqual = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val MORE_THAN_OR_EQUAL = of("MORE_THAN_OR_EQUAL")
        ...
        fun value(): Value =
            when (this) {
                MORE_THAN_OR_EQUAL -> Value.MORE_THAN_OR_EQUAL
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                MORE_THAN_OR_EQUAL -> Known.MORE_THAN_OR_EQUAL
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MoreThanOrEqual &&
    ...
    override fun toString() =
        "MoreThanOrEqual{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
