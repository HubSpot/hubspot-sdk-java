...
private constructor(
    ...
    /**
     * The ID of the portal installation to filter the journal entries by. This is an optional
     * parameter.
     */
    ...
    companion object {
        ...
        @JvmStatic fun none(): WebhookGetNextLocalJournalEntriesParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of
         * [WebhookGetNextLocalJournalEntriesParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [WebhookGetNextLocalJournalEntriesParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            webhookGetNextLocalJournalEntriesParams: WebhookGetNextLocalJournalEntriesParams
        ) = apply {
            offset = webhookGetNextLocalJournalEntriesParams.offset
            installPortalId = webhookGetNextLocalJournalEntriesParams.installPortalId
            additionalHeaders =
                webhookGetNextLocalJournalEntriesParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                webhookGetNextLocalJournalEntriesParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [WebhookGetNextLocalJournalEntriesParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): WebhookGetNextLocalJournalEntriesParams =
            WebhookGetNextLocalJournalEntriesParams(
                offset,
                installPortalId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebhookGetNextLocalJournalEntriesParams &&
            offset == other.offset &&
    ...
    override fun toString() =
        "WebhookGetNextLocalJournalEntriesParams{offset=$offset, installPortalId=$installPortalId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
