...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HasEmailReply].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(hasEmailReply: HasEmailReply) = apply {
            operator = hasEmailReply.operator
            inputs = hasEmailReply.inputs.map { it.toMutableList() }
            propertyName = hasEmailReply.propertyName
            value = hasEmailReply.value
            additionalProperties = hasEmailReply.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [HasEmailReply].
         *
     ...
     *   expected type.
     */
    fun validate(): HasEmailReply = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val HAS_EMAIL_REPLY = of("HAS_EMAIL_REPLY")
        ...
        fun value(): Value =
            when (this) {
                HAS_EMAIL_REPLY -> Value.HAS_EMAIL_REPLY
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                HAS_EMAIL_REPLY -> Known.HAS_EMAIL_REPLY
    ...
    override fun toString() =
        "HasEmailReply{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
