...
class TagListPostsCursorByQueryParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TagListPostsCursorByQueryParams = builder().build()
    ...
    /** A builder for [TagListPostsCursorByQueryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tagListPostsCursorByQueryParams: TagListPostsCursorByQueryParams) =
            apply {
                after = tagListPostsCursorByQueryParams.after
                archived = tagListPostsCursorByQueryParams.archived
                createdAfter = tagListPostsCursorByQueryParams.createdAfter
                createdAt = tagListPostsCursorByQueryParams.createdAt
                createdBefore = tagListPostsCursorByQueryParams.createdBefore
                limit = tagListPostsCursorByQueryParams.limit
                property = tagListPostsCursorByQueryParams.property
                sort = tagListPostsCursorByQueryParams.sort?.toMutableList()
                updatedAfter = tagListPostsCursorByQueryParams.updatedAfter
                updatedAt = tagListPostsCursorByQueryParams.updatedAt
                updatedBefore = tagListPostsCursorByQueryParams.updatedBefore
                additionalHeaders = tagListPostsCursorByQueryParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    tagListPostsCursorByQueryParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [TagListPostsCursorByQueryParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TagListPostsCursorByQueryParams =
            TagListPostsCursorByQueryParams(
                after,
                archived,
                createdAfter,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TagListPostsCursorByQueryParams &&
            after == other.after &&
    ...
    override fun toString() =
        "TagListPostsCursorByQueryParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
