...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FormatFullName].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(formatFullName: FormatFullName) = apply {
            operator = formatFullName.operator
            inputs = formatFullName.inputs.map { it.toMutableList() }
            propertyName = formatFullName.propertyName
            value = formatFullName.value
            additionalProperties = formatFullName.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FormatFullName].
         *
     ...
     *   expected type.
     */
    fun validate(): FormatFullName = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val FORMAT_FULL_NAME = of("FORMAT_FULL_NAME")
        ...
        fun value(): Value =
            when (this) {
                FORMAT_FULL_NAME -> Value.FORMAT_FULL_NAME
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                FORMAT_FULL_NAME -> Known.FORMAT_FULL_NAME
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FormatFullName &&
    ...
    override fun toString() =
        "FormatFullName{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
