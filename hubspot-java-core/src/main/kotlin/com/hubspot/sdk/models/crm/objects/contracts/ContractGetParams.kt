...
package com.hubspot.sdk.models.crm.objects.contracts
...
/**
 * Read an Object identified by `{contractId}`. `{contractId}` refers to the internal object ID by
...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ContractGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ContractGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ContractGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contractGetParams: ContractGetParams) = apply {
            contractId = contractGetParams.contractId
            archived = contractGetParams.archived
            associations = contractGetParams.associations?.toMutableList()
            idProperty = contractGetParams.idProperty
            properties = contractGetParams.properties?.toMutableList()
            propertiesWithHistory = contractGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = contractGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = contractGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ContractGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ContractGetParams =
            ContractGetParams(
                contractId,
                archived,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ContractGetParams &&
    ...
    override fun toString() =
        "ContractGetParams{contractId=$contractId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
