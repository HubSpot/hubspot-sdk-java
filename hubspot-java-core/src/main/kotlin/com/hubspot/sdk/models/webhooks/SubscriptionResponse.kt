...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionResponse: SubscriptionResponse) = apply {
            ...
            eventTypeName = subscriptionResponse.eventTypeName
    ...
    override fun toString() =
        "SubscriptionResponse{id=$id, active=$active, createdAt=$createdAt, eventType=$eventType, eventTypeName=$eventTypeName, objectTypeId=$objectTypeId, propertyName=$propertyName, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
