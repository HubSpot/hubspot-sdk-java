...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PageGetLandingPageFoldersByQueryParams = builder().build()
    ...
    /** A builder for [PageGetLandingPageFoldersByQueryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            pageGetLandingPageFoldersByQueryParams: PageGetLandingPageFoldersByQueryParams
        ) = apply {
            after = pageGetLandingPageFoldersByQueryParams.after
            archived = pageGetLandingPageFoldersByQueryParams.archived
            createdAfter = pageGetLandingPageFoldersByQueryParams.createdAfter
            createdAt = pageGetLandingPageFoldersByQueryParams.createdAt
            createdBefore = pageGetLandingPageFoldersByQueryParams.createdBefore
            limit = pageGetLandingPageFoldersByQueryParams.limit
            property = pageGetLandingPageFoldersByQueryParams.property
            sort = pageGetLandingPageFoldersByQueryParams.sort?.toMutableList()
            updatedAfter = pageGetLandingPageFoldersByQueryParams.updatedAfter
            updatedAt = pageGetLandingPageFoldersByQueryParams.updatedAt
            updatedBefore = pageGetLandingPageFoldersByQueryParams.updatedBefore
            additionalHeaders = pageGetLandingPageFoldersByQueryParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                pageGetLandingPageFoldersByQueryParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PageGetLandingPageFoldersByQueryParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PageGetLandingPageFoldersByQueryParams =
            PageGetLandingPageFoldersByQueryParams(
                after,
                archived,
                createdAfter,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PageGetLandingPageFoldersByQueryParams &&
            after == other.after &&
