...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SubtractTime].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(subtractTime: SubtractTime) = apply {
            operator = subtractTime.operator
            stringToCheck = subtractTime.stringToCheck
            inputs = subtractTime.inputs.map { it.toMutableList() }
            propertyName = subtractTime.propertyName
            value = subtractTime.value
            additionalProperties = subtractTime.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SubtractTime].
         *
    ...
    fun validate(): SubtractTime = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val SUBTRACT_TIME = of("SUBTRACT_TIME")
        ...
        fun value(): Value =
            when (this) {
                SUBTRACT_TIME -> Value.SUBTRACT_TIME
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                SUBTRACT_TIME -> Known.SUBTRACT_TIME
    ...
    override fun toString() =
        "SubtractTime{operator=$operator, stringToCheck=$stringToCheck, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
