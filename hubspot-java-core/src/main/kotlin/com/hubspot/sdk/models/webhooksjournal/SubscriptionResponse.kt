...
private constructor(
    ...
    /**
     * An array of actions associated with the subscription. Valid actions include 'CREATE',
    ...
    /**
     * The identifier for the type of object associated with the subscription, represented as a
     * string.
     *
     * @throws HubSpotInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
    ...
    /**
     * The type of subscription, indicating the nature of events it pertains to. Valid values
     * include 'OBJECT', 'ASSOCIATION', 'EVENT', 'APP_LIFECYCLE_EVENT', 'LIST_MEMBERSHIP', and
    ...
    /**
     * An object containing overrides for actions, where each key is an action and the value is an
     * ActionOverrideRequest object.
     *
    ...
    class Builder internal constructor() {
        ...
        /**
         * An object containing overrides for actions, where each key is an action and the value is
         * an ActionOverrideRequest object.
         */
        ...
        /**
         * The unique identifier of the user who created the subscription, represented as an
         * integer.
         */
