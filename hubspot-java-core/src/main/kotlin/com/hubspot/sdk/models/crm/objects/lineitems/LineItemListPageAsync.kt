...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(lineItemListPageAsync: LineItemListPageAsync) = apply {
            ...
            response = lineItemListPageAsync.response
        }
    ...
    override fun toString() =
        "LineItemListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}
