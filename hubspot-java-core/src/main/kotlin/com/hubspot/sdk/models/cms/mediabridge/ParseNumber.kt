...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ParseNumber].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(parseNumber: ParseNumber) = apply {
            operator = parseNumber.operator
            inputs = parseNumber.inputs.map { it.toMutableList() }
            propertyName = parseNumber.propertyName
            value = parseNumber.value
            additionalProperties = parseNumber.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ParseNumber].
         *
     ...
     *   expected type.
     */
    fun validate(): ParseNumber = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val PARSE_NUMBER = of("PARSE_NUMBER")
        ...
        fun value(): Value =
            when (this) {
                PARSE_NUMBER -> Value.PARSE_NUMBER
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                PARSE_NUMBER -> Known.PARSE_NUMBER
    ...
    override fun toString() =
        "ParseNumber{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
