...
/**
 * Represents the result of a batch operation on CRM objects, including the processing status, batch
 * results, timestamps, and a list of any errors encountered during the operation.
 */
...
private constructor(
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<SimplePublicObject>> = JsonMissing.of(),
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<SimplePublicObject>> = results
    ...
    /** A builder for [BatchResponseSimplePublicObjectWithErrors]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            completedAt = batchResponseSimplePublicObjectWithErrors.completedAt
            results = batchResponseSimplePublicObjectWithErrors.results.map { it.toMutableList() }
            startedAt = batchResponseSimplePublicObjectWithErrors.startedAt
            status = batchResponseSimplePublicObjectWithErrors.status
            errors = batchResponseSimplePublicObjectWithErrors.errors.map { it.toMutableList() }
            links = batchResponseSimplePublicObjectWithErrors.links
            numErrors = batchResponseSimplePublicObjectWithErrors.numErrors
            requestedAt = batchResponseSimplePublicObjectWithErrors.requestedAt
            additionalProperties =
                batchResponseSimplePublicObjectWithErrors.additionalProperties.toMutableMap()
        }
        ...
        fun results(results: List<SimplePublicObject>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed `List<SimplePublicObject>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun results(results: JsonField<List<SimplePublicObject>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [SimplePublicObject] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: SimplePublicObject) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [BatchResponseSimplePublicObjectWithErrors].
         *
         ...
         */
        fun build(): BatchResponseSimplePublicObjectWithErrors =
            BatchResponseSimplePublicObjectWithErrors(
     ...
     *   expected type.
     */
    fun validate(): BatchResponseSimplePublicObjectWithErrors = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseSimplePublicObjectWithErrors &&
    ...
    override fun toString() =
        "BatchResponseSimplePublicObjectWithErrors{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
