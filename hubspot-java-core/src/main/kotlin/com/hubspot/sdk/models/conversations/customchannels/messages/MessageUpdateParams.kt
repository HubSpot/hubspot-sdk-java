...
private constructor(
    ...
    fun publicChannelIntegrationMessageUpdateRequest():
        PublicChannelIntegrationMessageUpdateRequest = publicChannelIntegrationMessageUpdateRequest

    fun _additionalBodyProperties(): Map<String, JsonValue> =
        publicChannelIntegrationMessageUpdateRequest._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(messageUpdateParams: MessageUpdateParams) = apply {
            ...
            publicChannelIntegrationMessageUpdateRequest =
                messageUpdateParams.publicChannelIntegrationMessageUpdateRequest
    ...
    fun _body(): PublicChannelIntegrationMessageUpdateRequest =
        publicChannelIntegrationMessageUpdateRequest
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageUpdateParams &&
            ...
            publicChannelIntegrationMessageUpdateRequest ==
                other.publicChannelIntegrationMessageUpdateRequest &&
    ...
    override fun toString() =
        "MessageUpdateParams{channelId=$channelId, messageId=$messageId, publicChannelIntegrationMessageUpdateRequest=$publicChannelIntegrationMessageUpdateRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
