...
class SetContainsString
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val operator: JsonField<Operator>,
    private val stringToCheck: JsonField<StringToCheck>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        stringToCheck: JsonField<StringToCheck> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun stringToCheck(): StringToCheck = stringToCheck.getRequired("stringToCheck")
    ...
    @JsonProperty("stringToCheck")
    @ExcludeMissing
    fun _stringToCheck(): JsonField<StringToCheck> = stringToCheck
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SetContainsString].
         *
    ...
    /** A builder for [SetContainsString]. */
    class Builder internal constructor() {

        private var operator: JsonField<Operator>? = null
        private var stringToCheck: JsonField<StringToCheck>? = null
        ...
        @JvmSynthetic
        internal fun from(setContainsString: SetContainsString) = apply {
            operator = setContainsString.operator
            stringToCheck = setContainsString.stringToCheck
            inputs = setContainsString.inputs.map { it.toMutableList() }
            propertyName = setContainsString.propertyName
            value = setContainsString.value
            additionalProperties = setContainsString.additionalProperties.toMutableMap()
        }
        ...
        fun stringToCheck(stringToCheck: StringToCheck) = stringToCheck(JsonField.of(stringToCheck))

        /**
         * Sets [Builder.stringToCheck] to an arbitrary JSON value.
         *
         * You should usually call [Builder.stringToCheck] with a well-typed [StringToCheck] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun stringToCheck(stringToCheck: JsonField<StringToCheck>) = apply {
            this.stringToCheck = stringToCheck
        }

        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofConstantBoolean(constantBoolean)`.
         */
        fun stringToCheck(constantBoolean: ConstantBoolean) =
            stringToCheck(StringToCheck.ofConstantBoolean(constantBoolean))

        /**
         * Alias for calling [stringToCheck] with `StringToCheck.ofConstantNumber(constantNumber)`.
         */
        fun stringToCheck(constantNumber: ConstantNumber) =
            stringToCheck(StringToCheck.ofConstantNumber(constantNumber))

        /**
         * Alias for calling [stringToCheck] with `StringToCheck.ofConstantString(constantString)`.
         */
        fun stringToCheck(constantString: ConstantString) =
            stringToCheck(StringToCheck.ofConstantString(constantString))

        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofBooleanPropertyVariable(booleanPropertyVariable)`.
         */
        fun stringToCheck(booleanPropertyVariable: BooleanPropertyVariable) =
            stringToCheck(StringToCheck.ofBooleanPropertyVariable(booleanPropertyVariable))

        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofPropertyVariable(propertyVariable)`.
         */
        fun stringToCheck(propertyVariable: StringPropertyVariable) =
            stringToCheck(StringToCheck.ofPropertyVariable(propertyVariable))

        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofNumberPropertyVariable(numberPropertyVariable)`.
         */
        fun stringToCheck(numberPropertyVariable: NumberPropertyVariable) =
            stringToCheck(StringToCheck.ofNumberPropertyVariable(numberPropertyVariable))

        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofTimestampOfPropertyVariable(timestampOfPropertyVariable)`.
         */
        fun stringToCheck(timestampOfPropertyVariable: TimestampOfPropertyVariable) =
            stringToCheck(StringToCheck.ofTimestampOfPropertyVariable(timestampOfPropertyVariable))

        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofBooleanTargetPropertyVariable(booleanTargetPropertyVariable)`.
         */
        ...
        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofTargetPropertyVariable(targetPropertyVariable)`.
         */
        fun stringToCheck(targetPropertyVariable: StringTargetPropertyVariable) =
            stringToCheck(StringToCheck.ofTargetPropertyVariable(targetPropertyVariable))

        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofNumberTargetPropertyVariable(numberTargetPropertyVariable)`.
         */
        ...
        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofTimestampOfTargetPropertyVariable(timestampOfTargetPropertyVariable)`.
         */
        ...
        /** Alias for calling [stringToCheck] with `StringToCheck.ofAddNumbers(addNumbers)`. */
        fun stringToCheck(addNumbers: AddNumbers) =
            stringToCheck(StringToCheck.ofAddNumbers(addNumbers))

        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofSubtractNumbers(subtractNumbers)`.
         */
        fun stringToCheck(subtractNumbers: SubtractNumbers) =
            stringToCheck(StringToCheck.ofSubtractNumbers(subtractNumbers))

        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofMultiplyNumbers(multiplyNumbers)`.
         */
        fun stringToCheck(multiplyNumbers: MultiplyNumbers) =
            stringToCheck(StringToCheck.ofMultiplyNumbers(multiplyNumbers))

        /**
         * Alias for calling [stringToCheck] with `StringToCheck.ofDivideNumbers(divideNumbers)`.
         */
        fun stringToCheck(divideNumbers: DivideNumbers) =
            stringToCheck(StringToCheck.ofDivideNumbers(divideNumbers))

        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofRoundDownNumbers(roundDownNumbers)`.
         */
        fun stringToCheck(roundDownNumbers: RoundDownNumbers) =
            stringToCheck(StringToCheck.ofRoundDownNumbers(roundDownNumbers))

        /**
         * Alias for calling [stringToCheck] with `StringToCheck.ofRoundUpNumbers(roundUpNumbers)`.
         */
        fun stringToCheck(roundUpNumbers: RoundUpNumbers) =
            stringToCheck(StringToCheck.ofRoundUpNumbers(roundUpNumbers))

        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofRoundNearestNumbers(roundNearestNumbers)`.
         */
        fun stringToCheck(roundNearestNumbers: RoundNearestNumbers) =
            stringToCheck(StringToCheck.ofRoundNearestNumbers(roundNearestNumbers))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofUpperCase(upperCase)`. */
        fun stringToCheck(upperCase: UpperCase) =
            stringToCheck(StringToCheck.ofUpperCase(upperCase))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofLowerCase(lowerCase)`. */
        fun stringToCheck(lowerCase: LowerCase) =
            stringToCheck(StringToCheck.ofLowerCase(lowerCase))

        /**
         * Alias for calling [stringToCheck] with `StringToCheck.ofConcatStrings(concatStrings)`.
         */
        fun stringToCheck(concatStrings: ConcatStrings) =
            stringToCheck(StringToCheck.ofConcatStrings(concatStrings))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofContains(contains)`. */
        fun stringToCheck(contains: Contains) = stringToCheck(StringToCheck.ofContains(contains))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofBeginsWith(beginsWith)`. */
        fun stringToCheck(beginsWith: BeginsWith) =
            stringToCheck(StringToCheck.ofBeginsWith(beginsWith))

        /**
         * Alias for calling [stringToCheck] with `StringToCheck.ofNumberToString(numberToString)`.
         */
        fun stringToCheck(numberToString: NumberToString) =
            stringToCheck(StringToCheck.ofNumberToString(numberToString))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofParseNumber(parseNumber)`. */
        fun stringToCheck(parseNumber: ParseNumber) =
            stringToCheck(StringToCheck.ofParseNumber(parseNumber))

        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofFetchExchangeRate(fetchExchangeRate)`.
         */
        fun stringToCheck(fetchExchangeRate: FetchExchangeRate) =
            stringToCheck(StringToCheck.ofFetchExchangeRate(fetchExchangeRate))

        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofFetchCurrencyDecimalPlaces(fetchCurrencyDecimalPlaces)`.
         */
        fun stringToCheck(fetchCurrencyDecimalPlaces: FetchCurrencyDecimalPlaces) =
            stringToCheck(StringToCheck.ofFetchCurrencyDecimalPlaces(fetchCurrencyDecimalPlaces))

        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofFetchSingleCurrencyPortalCurrency(fetchSingleCurrencyPortalCurrency)`.
         */
        ...
        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofDatedExchangeRate(datedExchangeRate)`.
         */
        fun stringToCheck(datedExchangeRate: DatedExchangeRate) =
            stringToCheck(StringToCheck.ofDatedExchangeRate(datedExchangeRate))

        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofPipelineProbability(pipelineProbability)`.
         */
        fun stringToCheck(pipelineProbability: PipelineProbability) =
            stringToCheck(StringToCheck.ofPipelineProbability(pipelineProbability))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofMaxNumbers(maxNumbers)`. */
        fun stringToCheck(maxNumbers: MaxNumbers) =
            stringToCheck(StringToCheck.ofMaxNumbers(maxNumbers))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofMinNumbers(minNumbers)`. */
        fun stringToCheck(minNumbers: MinNumbers) =
            stringToCheck(StringToCheck.ofMinNumbers(minNumbers))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofLessThan(lessThan)`. */
        fun stringToCheck(lessThan: LessThan) = stringToCheck(StringToCheck.ofLessThan(lessThan))

        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofLessThanOrEqual(lessThanOrEqual)`.
         */
        fun stringToCheck(lessThanOrEqual: LessThanOrEqual) =
            stringToCheck(StringToCheck.ofLessThanOrEqual(lessThanOrEqual))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofMoreThan(moreThan)`. */
        fun stringToCheck(moreThan: MoreThan) = stringToCheck(StringToCheck.ofMoreThan(moreThan))

        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofMoreThanOrEqual(moreThanOrEqual)`.
         */
        fun stringToCheck(moreThanOrEqual: MoreThanOrEqual) =
            stringToCheck(StringToCheck.ofMoreThanOrEqual(moreThanOrEqual))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofNumberEquals(numberEquals)`. */
        fun stringToCheck(numberEquals: NumberEquals) =
            stringToCheck(StringToCheck.ofNumberEquals(numberEquals))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofEquals(equals)`. */
        fun stringToCheck(equals: StringEquals) = stringToCheck(StringToCheck.ofEquals(equals))

        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofIsPipelineStageClosed(isPipelineStageClosed)`.
         */
        fun stringToCheck(isPipelineStageClosed: IsPipelineStageClosed) =
            stringToCheck(StringToCheck.ofIsPipelineStageClosed(isPipelineStageClosed))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofNot(not)`. */
        fun stringToCheck(not: Not) = stringToCheck(StringToCheck.ofNot(not))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofDate(date)`. */
        fun stringToCheck(date: Date) = stringToCheck(StringToCheck.ofDate(date))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofMonth(month)`. */
        fun stringToCheck(month: Month) = stringToCheck(StringToCheck.ofMonth(month))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofYear(year)`. */
        fun stringToCheck(year: Year) = stringToCheck(StringToCheck.ofYear(year))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofNow(now)`. */
        fun stringToCheck(now: Now) = stringToCheck(StringToCheck.ofNow(now))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofTimeBetween(timeBetween)`. */
        fun stringToCheck(timeBetween: TimeBetween) =
            stringToCheck(StringToCheck.ofTimeBetween(timeBetween))

        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofTimeBetweenSkipWeekends(timeBetweenSkipWeekends)`.
         */
        fun stringToCheck(timeBetweenSkipWeekends: TimeBetweenSkipWeekends) =
            stringToCheck(StringToCheck.ofTimeBetweenSkipWeekends(timeBetweenSkipWeekends))

        /**
         * Alias for calling [stringToCheck] with `StringToCheck.ofPeriodToMonths(periodToMonths)`.
         */
        fun stringToCheck(periodToMonths: PeriodToMonths) =
            stringToCheck(StringToCheck.ofPeriodToMonths(periodToMonths))

        /**
         * Alias for calling [stringToCheck] with `StringToCheck.ofPeriodToWeeks(periodToWeeks)`.
         */
        fun stringToCheck(periodToWeeks: PeriodToWeeks) =
            stringToCheck(StringToCheck.ofPeriodToWeeks(periodToWeeks))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofAnd(and)`. */
        fun stringToCheck(and: And) = stringToCheck(StringToCheck.ofAnd(and))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofOr(or)`. */
        fun stringToCheck(or: Or) = stringToCheck(StringToCheck.ofOr(or))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofXor(xor)`. */
        fun stringToCheck(xor: Xor) = stringToCheck(StringToCheck.ofXor(xor))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofIfString(ifString)`. */
        fun stringToCheck(ifString: IfString) = stringToCheck(StringToCheck.ofIfString(ifString))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofIfNumber(ifNumber)`. */
        fun stringToCheck(ifNumber: IfNumber) = stringToCheck(StringToCheck.ofIfNumber(ifNumber))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofIfBoolean(ifBoolean)`. */
        fun stringToCheck(ifBoolean: IfBoolean) =
            stringToCheck(StringToCheck.ofIfBoolean(ifBoolean))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofIsPresent(isPresent)`. */
        fun stringToCheck(isPresent: IsPresent) =
            stringToCheck(StringToCheck.ofIsPresent(isPresent))

        /**
         * Alias for calling [stringToCheck] with `StringToCheck.ofHasEmailReply(hasEmailReply)`.
         */
        fun stringToCheck(hasEmailReply: HasEmailReply) =
            stringToCheck(StringToCheck.ofHasEmailReply(hasEmailReply))

        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofHasPlainTextEmailReply(hasPlainTextEmailReply)`.
         */
        fun stringToCheck(hasPlainTextEmailReply: HasPlainTextEmailReply) =
            stringToCheck(StringToCheck.ofHasPlainTextEmailReply(hasPlainTextEmailReply))

        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofExtractMostRecentEmailReplyHtml(extractMostRecentEmailReplyHtml)`.
         */
        ...
        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofExtractMostRecentEmailReplyText(extractMostRecentEmailReplyText)`.
         */
        ...
        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofExtractMostRecentPlainTextEmailReply(extractMostRecentPlainTextEmailReply)`.
         */
        fun stringToCheck(
            extractMostRecentPlainTextEmailReply: ExtractMostRecentPlainTextEmailReply
        ) =
            stringToCheck(
                StringToCheck.ofExtractMostRecentPlainTextEmailReply(
        ...
        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofSetContainsString(setContainsString)`.
         */
        fun stringToCheck(setContainsString: SetContainsString) =
            stringToCheck(StringToCheck.ofSetContainsString(setContainsString))

        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofIsEngagementType(isEngagementType)`.
         */
        fun stringToCheck(isEngagementType: IsEngagementType) =
            stringToCheck(StringToCheck.ofIsEngagementType(isEngagementType))

        /**
         * Alias for calling [stringToCheck] with `StringToCheck.ofFormatFullName(formatFullName)`.
         */
        fun stringToCheck(formatFullName: FormatFullName) =
            stringToCheck(StringToCheck.ofFormatFullName(formatFullName))

        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofFormatPhoneNumber(formatPhoneNumber)`.
         */
        fun stringToCheck(formatPhoneNumber: FormatPhoneNumber) =
            stringToCheck(StringToCheck.ofFormatPhoneNumber(formatPhoneNumber))

        /**
         * Alias for calling [stringToCheck] with
         * `StringToCheck.ofFormatSearchablePhoneNumber(formatSearchablePhoneNumber)`.
         */
        fun stringToCheck(formatSearchablePhoneNumber: FormatSearchablePhoneNumber) =
            stringToCheck(StringToCheck.ofFormatSearchablePhoneNumber(formatSearchablePhoneNumber))

        /**
         * Alias for calling [stringToCheck] with `StringToCheck.ofAbsoluteValue(absoluteValue)`.
         */
        fun stringToCheck(absoluteValue: AbsoluteValue) =
            stringToCheck(StringToCheck.ofAbsoluteValue(absoluteValue))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofSquareRoot(squareRoot)`. */
        fun stringToCheck(squareRoot: SquareRoot) =
            stringToCheck(StringToCheck.ofSquareRoot(squareRoot))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofPower(power)`. */
        fun stringToCheck(power: Power) = stringToCheck(StringToCheck.ofPower(power))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofSubstring(substring)`. */
        fun stringToCheck(substring: Substring) =
            stringToCheck(StringToCheck.ofSubstring(substring))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofEuler(euler)`. */
        fun stringToCheck(euler: Euler) = stringToCheck(StringToCheck.ofEuler(euler))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofLength(length)`. */
        fun stringToCheck(length: StringLength) = stringToCheck(StringToCheck.ofLength(length))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofIsBlank(isBlank)`. */
        fun stringToCheck(isBlank: IsBlank) = stringToCheck(StringToCheck.ofIsBlank(isBlank))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofAddTime(addTime)`. */
        fun stringToCheck(addTime: AddTime) = stringToCheck(StringToCheck.ofAddTime(addTime))

        /** Alias for calling [stringToCheck] with `StringToCheck.ofSubtractTime(subtractTime)`. */
        fun stringToCheck(subtractTime: SubtractTime) =
            stringToCheck(StringToCheck.ofSubtractTime(subtractTime))
        ...
        /** Alias for calling [addInput] with `Input.ofIsBlank(isBlank)`. */
        fun addInput(isBlank: IsBlank) = addInput(Input.ofIsBlank(isBlank))
        ...
        /**
         * Returns an immutable instance of [SetContainsString].
         *
    ...
    fun validate(): SetContainsString = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val SET_CONTAINS_STRING = of("SET_CONTAINS_STRING")
        ...
        fun value(): Value =
            when (this) {
                SET_CONTAINS_STRING -> Value.SET_CONTAINS_STRING
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                SET_CONTAINS_STRING -> Known.SET_CONTAINS_STRING
    ...
    @JsonDeserialize(using = StringToCheck.Deserializer::class)
    @JsonSerialize(using = StringToCheck.Serializer::class)
    class StringToCheck
    private constructor(
        ...
        private val propertyVariable: StringPropertyVariable? = null,
        ...
        private val targetPropertyVariable: StringTargetPropertyVariable? = null,
        ...
        private val equals: StringEquals? = null,
        ...
        private val length: StringLength? = null,
        ...
        fun propertyVariable(): Optional<StringPropertyVariable> =
            Optional.ofNullable(propertyVariable)
        ...
        fun targetPropertyVariable(): Optional<StringTargetPropertyVariable> =
            Optional.ofNullable(targetPropertyVariable)
        ...
        fun equals(): Optional<StringEquals> = Optional.ofNullable(equals)
        ...
        fun length(): Optional<StringLength> = Optional.ofNullable(length)
        ...
        fun isPropertyVariable(): Boolean = propertyVariable != null
        ...
        fun isTargetPropertyVariable(): Boolean = targetPropertyVariable != null
        ...
        fun isEquals(): Boolean = equals != null
        ...
        fun isLength(): Boolean = length != null
        ...
        fun asPropertyVariable(): StringPropertyVariable =
            propertyVariable.getOrThrow("propertyVariable")
        ...
        fun asTargetPropertyVariable(): StringTargetPropertyVariable =
            targetPropertyVariable.getOrThrow("targetPropertyVariable")
        ...
        fun asEquals(): StringEquals = equals.getOrThrow("equals")
        ...
        fun asLength(): StringLength = length.getOrThrow("length")
        ...
        fun <T> accept(visitor: Visitor<T>): T =
            when {
                ...
                propertyVariable != null -> visitor.visitPropertyVariable(propertyVariable)
                ...
                targetPropertyVariable != null ->
                    visitor.visitTargetPropertyVariable(targetPropertyVariable)
                ...
                equals != null -> visitor.visitEquals(equals)
                ...
                length != null -> visitor.visitLength(length)
        ...
        fun validate(): StringToCheck = apply {
            if (validated) {
                return@apply
            }
            ...
            accept(
                object : Visitor<Unit> {
                    ...
                    override fun visitPropertyVariable(propertyVariable: StringPropertyVariable) {
                        propertyVariable.validate()
                    }
                    ...
                    override fun visitTargetPropertyVariable(
                        targetPropertyVariable: StringTargetPropertyVariable
                    ) {
                        targetPropertyVariable.validate()
                    }
                    ...
                    override fun visitEquals(equals: StringEquals) {
                        equals.validate()
                    }
                    ...
                    override fun visitLength(length: StringLength) {
                        length.validate()
                    }
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    ...
                    override fun visitTargetPropertyVariable(
                        targetPropertyVariable: StringTargetPropertyVariable
                    ) = targetPropertyVariable.validity()
                    ...
                    override fun visitEquals(equals: StringEquals) = equals.validity()
                    ...
                    override fun visitLength(length: StringLength) = length.validity()
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is StringToCheck &&
                ...
                propertyVariable == other.propertyVariable &&
                ...
                targetPropertyVariable == other.targetPropertyVariable &&
        ...
        override fun toString(): String =
            when {
                constantBoolean != null -> "StringToCheck{constantBoolean=$constantBoolean}"
                constantNumber != null -> "StringToCheck{constantNumber=$constantNumber}"
                constantString != null -> "StringToCheck{constantString=$constantString}"
                booleanPropertyVariable != null ->
                    "StringToCheck{booleanPropertyVariable=$booleanPropertyVariable}"
                propertyVariable != null -> "StringToCheck{propertyVariable=$propertyVariable}"
                numberPropertyVariable != null ->
                    "StringToCheck{numberPropertyVariable=$numberPropertyVariable}"
                timestampOfPropertyVariable != null ->
                    "StringToCheck{timestampOfPropertyVariable=$timestampOfPropertyVariable}"
                booleanTargetPropertyVariable != null ->
                    "StringToCheck{booleanTargetPropertyVariable=$booleanTargetPropertyVariable}"
                targetPropertyVariable != null ->
                    "StringToCheck{targetPropertyVariable=$targetPropertyVariable}"
                numberTargetPropertyVariable != null ->
                    "StringToCheck{numberTargetPropertyVariable=$numberTargetPropertyVariable}"
                timestampOfTargetPropertyVariable != null ->
                    "StringToCheck{timestampOfTargetPropertyVariable=$timestampOfTargetPropertyVariable}"
                addNumbers != null -> "StringToCheck{addNumbers=$addNumbers}"
                subtractNumbers != null -> "StringToCheck{subtractNumbers=$subtractNumbers}"
                multiplyNumbers != null -> "StringToCheck{multiplyNumbers=$multiplyNumbers}"
                divideNumbers != null -> "StringToCheck{divideNumbers=$divideNumbers}"
                roundDownNumbers != null -> "StringToCheck{roundDownNumbers=$roundDownNumbers}"
                roundUpNumbers != null -> "StringToCheck{roundUpNumbers=$roundUpNumbers}"
                roundNearestNumbers != null ->
                    "StringToCheck{roundNearestNumbers=$roundNearestNumbers}"
                upperCase != null -> "StringToCheck{upperCase=$upperCase}"
                lowerCase != null -> "StringToCheck{lowerCase=$lowerCase}"
                concatStrings != null -> "StringToCheck{concatStrings=$concatStrings}"
                contains != null -> "StringToCheck{contains=$contains}"
                beginsWith != null -> "StringToCheck{beginsWith=$beginsWith}"
                numberToString != null -> "StringToCheck{numberToString=$numberToString}"
                parseNumber != null -> "StringToCheck{parseNumber=$parseNumber}"
                fetchExchangeRate != null -> "StringToCheck{fetchExchangeRate=$fetchExchangeRate}"
                fetchCurrencyDecimalPlaces != null ->
                    "StringToCheck{fetchCurrencyDecimalPlaces=$fetchCurrencyDecimalPlaces}"
                fetchSingleCurrencyPortalCurrency != null ->
                    "StringToCheck{fetchSingleCurrencyPortalCurrency=$fetchSingleCurrencyPortalCurrency}"
                datedExchangeRate != null -> "StringToCheck{datedExchangeRate=$datedExchangeRate}"
                pipelineProbability != null ->
                    "StringToCheck{pipelineProbability=$pipelineProbability}"
                maxNumbers != null -> "StringToCheck{maxNumbers=$maxNumbers}"
                minNumbers != null -> "StringToCheck{minNumbers=$minNumbers}"
                lessThan != null -> "StringToCheck{lessThan=$lessThan}"
                lessThanOrEqual != null -> "StringToCheck{lessThanOrEqual=$lessThanOrEqual}"
                moreThan != null -> "StringToCheck{moreThan=$moreThan}"
                moreThanOrEqual != null -> "StringToCheck{moreThanOrEqual=$moreThanOrEqual}"
                numberEquals != null -> "StringToCheck{numberEquals=$numberEquals}"
                equals != null -> "StringToCheck{equals=$equals}"
                isPipelineStageClosed != null ->
                    "StringToCheck{isPipelineStageClosed=$isPipelineStageClosed}"
                not != null -> "StringToCheck{not=$not}"
                date != null -> "StringToCheck{date=$date}"
                month != null -> "StringToCheck{month=$month}"
                year != null -> "StringToCheck{year=$year}"
                now != null -> "StringToCheck{now=$now}"
                timeBetween != null -> "StringToCheck{timeBetween=$timeBetween}"
                timeBetweenSkipWeekends != null ->
                    "StringToCheck{timeBetweenSkipWeekends=$timeBetweenSkipWeekends}"
                periodToMonths != null -> "StringToCheck{periodToMonths=$periodToMonths}"
                periodToWeeks != null -> "StringToCheck{periodToWeeks=$periodToWeeks}"
                and != null -> "StringToCheck{and=$and}"
                or != null -> "StringToCheck{or=$or}"
                xor != null -> "StringToCheck{xor=$xor}"
                ifString != null -> "StringToCheck{ifString=$ifString}"
                ifNumber != null -> "StringToCheck{ifNumber=$ifNumber}"
                ifBoolean != null -> "StringToCheck{ifBoolean=$ifBoolean}"
                isPresent != null -> "StringToCheck{isPresent=$isPresent}"
                hasEmailReply != null -> "StringToCheck{hasEmailReply=$hasEmailReply}"
                hasPlainTextEmailReply != null ->
                    "StringToCheck{hasPlainTextEmailReply=$hasPlainTextEmailReply}"
                extractMostRecentEmailReplyHtml != null ->
                    "StringToCheck{extractMostRecentEmailReplyHtml=$extractMostRecentEmailReplyHtml}"
                extractMostRecentEmailReplyText != null ->
                    "StringToCheck{extractMostRecentEmailReplyText=$extractMostRecentEmailReplyText}"
                extractMostRecentPlainTextEmailReply != null ->
                    "StringToCheck{extractMostRecentPlainTextEmailReply=$extractMostRecentPlainTextEmailReply}"
                setContainsString != null -> "StringToCheck{setContainsString=$setContainsString}"
                isEngagementType != null -> "StringToCheck{isEngagementType=$isEngagementType}"
                formatFullName != null -> "StringToCheck{formatFullName=$formatFullName}"
                formatPhoneNumber != null -> "StringToCheck{formatPhoneNumber=$formatPhoneNumber}"
                formatSearchablePhoneNumber != null ->
                    "StringToCheck{formatSearchablePhoneNumber=$formatSearchablePhoneNumber}"
                absoluteValue != null -> "StringToCheck{absoluteValue=$absoluteValue}"
                squareRoot != null -> "StringToCheck{squareRoot=$squareRoot}"
                power != null -> "StringToCheck{power=$power}"
                substring != null -> "StringToCheck{substring=$substring}"
                euler != null -> "StringToCheck{euler=$euler}"
                length != null -> "StringToCheck{length=$length}"
                isBlank != null -> "StringToCheck{isBlank=$isBlank}"
                addTime != null -> "StringToCheck{addTime=$addTime}"
                subtractTime != null -> "StringToCheck{subtractTime=$subtractTime}"
                _json != null -> "StringToCheck{_unknown=$_json}"
                else -> throw IllegalStateException("Invalid StringToCheck")
            }
        ...
        companion object {
            ...
            fun ofConstantBoolean(constantBoolean: ConstantBoolean) =
                StringToCheck(constantBoolean = constantBoolean)

            @JvmStatic
            fun ofConstantNumber(constantNumber: ConstantNumber) =
                StringToCheck(constantNumber = constantNumber)

            @JvmStatic
            fun ofConstantString(constantString: ConstantString) =
                StringToCheck(constantString = constantString)
            ...
            @JvmStatic
            fun ofPropertyVariable(propertyVariable: StringPropertyVariable) =
                StringToCheck(propertyVariable = propertyVariable)
            ...
            @JvmStatic
            fun ofTargetPropertyVariable(targetPropertyVariable: StringTargetPropertyVariable) =
                StringToCheck(targetPropertyVariable = targetPropertyVariable)
            ...
            @JvmStatic
            fun ofAddNumbers(addNumbers: AddNumbers) = StringToCheck(addNumbers = addNumbers)

            @JvmStatic
            fun ofSubtractNumbers(subtractNumbers: SubtractNumbers) =
                StringToCheck(subtractNumbers = subtractNumbers)

            @JvmStatic
            fun ofMultiplyNumbers(multiplyNumbers: MultiplyNumbers) =
                StringToCheck(multiplyNumbers = multiplyNumbers)

            @JvmStatic
            fun ofDivideNumbers(divideNumbers: DivideNumbers) =
                StringToCheck(divideNumbers = divideNumbers)

            @JvmStatic
            fun ofRoundDownNumbers(roundDownNumbers: RoundDownNumbers) =
                StringToCheck(roundDownNumbers = roundDownNumbers)

            @JvmStatic
            fun ofRoundUpNumbers(roundUpNumbers: RoundUpNumbers) =
                StringToCheck(roundUpNumbers = roundUpNumbers)

            @JvmStatic
            fun ofRoundNearestNumbers(roundNearestNumbers: RoundNearestNumbers) =
                StringToCheck(roundNearestNumbers = roundNearestNumbers)

            @JvmStatic fun ofUpperCase(upperCase: UpperCase) = StringToCheck(upperCase = upperCase)

            @JvmStatic fun ofLowerCase(lowerCase: LowerCase) = StringToCheck(lowerCase = lowerCase)

            @JvmStatic
            fun ofConcatStrings(concatStrings: ConcatStrings) =
                StringToCheck(concatStrings = concatStrings)

            @JvmStatic fun ofContains(contains: Contains) = StringToCheck(contains = contains)

            @JvmStatic
            fun ofBeginsWith(beginsWith: BeginsWith) = StringToCheck(beginsWith = beginsWith)

            @JvmStatic
            fun ofNumberToString(numberToString: NumberToString) =
                StringToCheck(numberToString = numberToString)

            @JvmStatic
            fun ofParseNumber(parseNumber: ParseNumber) = StringToCheck(parseNumber = parseNumber)

            @JvmStatic
            fun ofFetchExchangeRate(fetchExchangeRate: FetchExchangeRate) =
                StringToCheck(fetchExchangeRate = fetchExchangeRate)
            ...
            fun ofDatedExchangeRate(datedExchangeRate: DatedExchangeRate) =
                StringToCheck(datedExchangeRate = datedExchangeRate)
            ...
            @JvmStatic
            fun ofMaxNumbers(maxNumbers: MaxNumbers) = StringToCheck(maxNumbers = maxNumbers)

            @JvmStatic
            fun ofMinNumbers(minNumbers: MinNumbers) = StringToCheck(minNumbers = minNumbers)

            @JvmStatic fun ofLessThan(lessThan: LessThan) = StringToCheck(lessThan = lessThan)

            @JvmStatic
            fun ofLessThanOrEqual(lessThanOrEqual: LessThanOrEqual) =
                StringToCheck(lessThanOrEqual = lessThanOrEqual)

            @JvmStatic fun ofMoreThan(moreThan: MoreThan) = StringToCheck(moreThan = moreThan)

            @JvmStatic
            fun ofMoreThanOrEqual(moreThanOrEqual: MoreThanOrEqual) =
                StringToCheck(moreThanOrEqual = moreThanOrEqual)

            @JvmStatic
            fun ofNumberEquals(numberEquals: NumberEquals) =
                StringToCheck(numberEquals = numberEquals)

            @JvmStatic fun ofEquals(equals: StringEquals) = StringToCheck(equals = equals)

            @JvmStatic
            fun ofIsPipelineStageClosed(isPipelineStageClosed: IsPipelineStageClosed) =
                StringToCheck(isPipelineStageClosed = isPipelineStageClosed)

            @JvmStatic fun ofNot(not: Not) = StringToCheck(not = not)

            @JvmStatic fun ofDate(date: Date) = StringToCheck(date = date)

            @JvmStatic fun ofMonth(month: Month) = StringToCheck(month = month)

            @JvmStatic fun ofYear(year: Year) = StringToCheck(year = year)

            @JvmStatic fun ofNow(now: Now) = StringToCheck(now = now)

            @JvmStatic
            fun ofTimeBetween(timeBetween: TimeBetween) = StringToCheck(timeBetween = timeBetween)
            ...
            fun ofPeriodToMonths(periodToMonths: PeriodToMonths) =
                StringToCheck(periodToMonths = periodToMonths)

            @JvmStatic
            fun ofPeriodToWeeks(periodToWeeks: PeriodToWeeks) =
                StringToCheck(periodToWeeks = periodToWeeks)

            @JvmStatic fun ofAnd(and: And) = StringToCheck(and = and)

            @JvmStatic fun ofOr(or: Or) = StringToCheck(or = or)

            @JvmStatic fun ofXor(xor: Xor) = StringToCheck(xor = xor)

            @JvmStatic fun ofIfString(ifString: IfString) = StringToCheck(ifString = ifString)

            @JvmStatic fun ofIfNumber(ifNumber: IfNumber) = StringToCheck(ifNumber = ifNumber)

            @JvmStatic fun ofIfBoolean(ifBoolean: IfBoolean) = StringToCheck(ifBoolean = ifBoolean)

            @JvmStatic fun ofIsPresent(isPresent: IsPresent) = StringToCheck(isPresent = isPresent)

            @JvmStatic
            fun ofHasEmailReply(hasEmailReply: HasEmailReply) =
                StringToCheck(hasEmailReply = hasEmailReply)
            ...
            fun ofSetContainsString(setContainsString: SetContainsString) =
                StringToCheck(setContainsString = setContainsString)

            @JvmStatic
            fun ofIsEngagementType(isEngagementType: IsEngagementType) =
                StringToCheck(isEngagementType = isEngagementType)

            @JvmStatic
            fun ofFormatFullName(formatFullName: FormatFullName) =
                StringToCheck(formatFullName = formatFullName)

            @JvmStatic
            fun ofFormatPhoneNumber(formatPhoneNumber: FormatPhoneNumber) =
                StringToCheck(formatPhoneNumber = formatPhoneNumber)
            ...
            fun ofAbsoluteValue(absoluteValue: AbsoluteValue) =
                StringToCheck(absoluteValue = absoluteValue)

            @JvmStatic
            fun ofSquareRoot(squareRoot: SquareRoot) = StringToCheck(squareRoot = squareRoot)

            @JvmStatic fun ofPower(power: Power) = StringToCheck(power = power)

            @JvmStatic fun ofSubstring(substring: Substring) = StringToCheck(substring = substring)

            @JvmStatic fun ofEuler(euler: Euler) = StringToCheck(euler = euler)

            @JvmStatic fun ofLength(length: StringLength) = StringToCheck(length = length)

            @JvmStatic fun ofIsBlank(isBlank: IsBlank) = StringToCheck(isBlank = isBlank)

            @JvmStatic fun ofAddTime(addTime: AddTime) = StringToCheck(addTime = addTime)

            @JvmStatic
            fun ofSubtractTime(subtractTime: SubtractTime) =
                StringToCheck(subtractTime = subtractTime)
        }

        /**
         * An interface that defines how to map each variant of [StringToCheck] to a value of type
         * [T].
         */
        interface Visitor<out T> {
            ...
            fun visitPropertyVariable(propertyVariable: StringPropertyVariable): T
            ...
            fun visitTargetPropertyVariable(targetPropertyVariable: StringTargetPropertyVariable): T
            ...
            fun visitEquals(equals: StringEquals): T
            ...
            fun visitLength(length: StringLength): T
            ...
            /**
             * Maps an unknown variant of [StringToCheck] to a value of type [T].
             *
             * An instance of [StringToCheck] can contain an unknown variant if it was deserialized
            ...
            fun unknown(json: JsonValue?): T {
                throw HubSpotInvalidDataException("Unknown StringToCheck: $json")
            }
        }

        internal class Deserializer : BaseDeserializer<StringToCheck>(StringToCheck::class) {

            override fun ObjectCodec.deserialize(node: JsonNode): StringToCheck {
                val json = JsonValue.fromJsonNode(node)

                val bestMatches =
                    sequenceOf(
                            tryDeserialize(node, jacksonTypeRef<ConstantBoolean>())?.let {
                                StringToCheck(constantBoolean = it, _json = json)
                            },
                            tryDeserialize(node, jacksonTypeRef<ConstantNumber>())?.let {
                                StringToCheck(constantNumber = it, _json = json)
                            },
                            tryDeserialize(node, jacksonTypeRef<ConstantString>())?.let {
                                StringToCheck(constantString = it, _json = json)
                            },
                            tryDeserialize(node, jacksonTypeRef<BooleanPropertyVariable>())?.let {
                                StringToCheck(booleanPropertyVariable = it, _json = json)
                            },
                            tryDeserialize(node, jacksonTypeRef<StringPropertyVariable>())?.let {
                                StringToCheck(propertyVariable = it, _json = json)
                            },
                            tryDeserialize(node, jacksonTypeRef<NumberPropertyVariable>())?.let {
                                StringToCheck(numberPropertyVariable = it, _json = json)
                            },
                            tryDeserialize(node, jacksonTypeRef<TimestampOfPropertyVariable>())
                                ?.let {
                                    StringToCheck(timestampOfPropertyVariable = it, _json = json)
                                },
                            tryDeserialize(node, jacksonTypeRef<BooleanTargetPropertyVariable>())
                                ?.let {
                                    StringToCheck(booleanTargetPropertyVariable = it, _json = json)
                                },
                            tryDeserialize(node, jacksonTypeRef<StringTargetPropertyVariable>())
                                ?.let { StringToCheck(targetPropertyVariable = it, _json = json) },
                            tryDeserialize(node, jacksonTypeRef<NumberTargetPropertyVariable>())
                                ?.let {
                                    StringToCheck(numberTargetPropertyVariable = it, _json = json)
                                },
                            tryDeserialize(
                                    node,
        ...
        internal class Serializer : BaseSerializer<StringToCheck>(StringToCheck::class) {
            ...
            override fun serialize(
                ...
                when {
                    ...
                    value.propertyVariable != null -> generator.writeObject(value.propertyVariable)
                    ...
                    value.targetPropertyVariable != null ->
                        generator.writeObject(value.targetPropertyVariable)
                    ...
                    value.equals != null -> generator.writeObject(value.equals)
                    ...
                    value.length != null -> generator.writeObject(value.length)
    ...
    private constructor(
        ...
        override fun toString(): String =
            when {
                ...
                isBlank != null -> "Input{isBlank=$isBlank}"
        ...
        companion object {
            ...
            @JvmStatic fun ofIsBlank(isBlank: IsBlank) = Input(isBlank = isBlank)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SetContainsString &&
    ...
    override fun toString() =
        "SetContainsString{operator=$operator, stringToCheck=$stringToCheck, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
