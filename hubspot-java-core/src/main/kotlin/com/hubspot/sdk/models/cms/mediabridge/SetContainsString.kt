...
private constructor(
    ...
    private val stringToCheck: JsonValue,
    ...
    private constructor(
        ...
        @JsonProperty("stringToCheck") @ExcludeMissing stringToCheck: JsonValue = JsonMissing.of(),
     ...
     * ```java
     * MyClass myObject = setContainsString.stringToCheck().convert(MyClass.class);
     * ```
     */
    @JsonProperty("stringToCheck") @ExcludeMissing fun _stringToCheck(): JsonValue = stringToCheck
    ...
    class Builder internal constructor() {
        ...
        private var stringToCheck: JsonValue? = null
        ...
        fun stringToCheck(stringToCheck: JsonValue) = apply { this.stringToCheck = stringToCheck }
    ...
    private constructor(
         ...
         *     @Override
         *     public Optional<String> visitConstantBoolean(ConstantBoolean constantBoolean) {
         *         return Optional.of(constantBoolean.toString());
         *     }
         *
         *     // ...
         *
