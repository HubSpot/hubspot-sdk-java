...
import com.hubspot.sdk.models.crm.objects.discounts.DiscountCreateParams
...
import com.hubspot.sdk.models.crm.objects.discounts.DiscountListPageAsync
import com.hubspot.sdk.models.crm.objects.discounts.DiscountListParams
import com.hubspot.sdk.models.crm.objects.discounts.DiscountSearchParams
import com.hubspot.sdk.models.crm.objects.discounts.DiscountUpdateParams
import com.hubspot.sdk.services.async.crm.objects.discounts.BatchServiceAsync
import com.hubspot.sdk.services.async.crm.objects.discounts.BatchServiceAsyncImpl
        ...
        override fun create(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("crm", "objects", "2026-03", "discounts")
        ...
        override fun update(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("crm", "objects", "2026-03", "discounts", params._pathParam(0))
                    .body(json(clientOptions.jsonMapper, params._body()))
                    .build()
                    .prepareAsync(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
        ...
        override fun search(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.POST)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("crm", "objects", "2026-03", "discounts", "search")
                    .body(json(clientOptions.jsonMapper, params._body()))
                    .build()
                    .prepareAsync(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
