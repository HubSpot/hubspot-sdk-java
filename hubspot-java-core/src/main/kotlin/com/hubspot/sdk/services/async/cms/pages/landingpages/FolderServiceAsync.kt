...
import com.hubspot.sdk.models.cms.pages.landingpages.folders.FolderCreateFoldersParams
import com.hubspot.sdk.models.cms.pages.landingpages.folders.FolderCreateParams
import com.hubspot.sdk.models.cms.pages.landingpages.folders.FolderDeleteFoldersParams
...
import com.hubspot.sdk.models.cms.pages.landingpages.folders.FolderListPageAsync
import com.hubspot.sdk.models.cms.pages.landingpages.folders.FolderListParams
import com.hubspot.sdk.models.cms.pages.landingpages.folders.FolderListRevisionsPageAsync
...
interface FolderServiceAsync {
    ...
    fun createFolders(
        params: FolderCreateFoldersParams
    ...
    fun createFolders(
        ...
        createFolders(
            FolderCreateFoldersParams.builder()
                .batchInputContentFolder(batchInputContentFolder)
                .build(),
            requestOptions,
        )
    ...
    fun deleteFolders(params: FolderDeleteFoldersParams): CompletableFuture<Void?> =
        deleteFolders(params, RequestOptions.none())

    /** @see deleteFolders */
    fun deleteFolders(
        params: FolderDeleteFoldersParams,
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<Void?>
    ...
    fun deleteFolders(
        ...
        deleteFolders(
            FolderDeleteFoldersParams.builder().batchInputString(batchInputString).build(),
            requestOptions,
        )
    ...
    fun updateFolders(
        ...
        updateFolders(
            FolderUpdateFoldersParams.builder().batchInputJsonNode(batchInputJsonNode).build(),
            requestOptions,
        )
    ...
    interface WithRawResponse {
         ...
         * [FolderServiceAsync.deleteFolders].
         */
        fun deleteFolders(params: FolderDeleteFoldersParams): CompletableFuture<HttpResponse> =
            deleteFolders(params, RequestOptions.none())
