...
import com.hubspot.sdk.models.crm.objects.orders.OrderCreateParams
...
import com.hubspot.sdk.models.crm.objects.orders.OrderListPageAsync
import com.hubspot.sdk.models.crm.objects.orders.OrderListParams
import com.hubspot.sdk.models.crm.objects.orders.OrderSearchParams
import com.hubspot.sdk.models.crm.objects.orders.OrderUpdateParams
import com.hubspot.sdk.services.async.crm.objects.orders.BatchServiceAsync
...
interface OrderServiceAsync {
     ...
     */
    fun create(params: OrderCreateParams): CompletableFuture<SimplePublicObject> =
    ...
    interface WithRawResponse {
         ...
         * same as [OrderServiceAsync.create].
         */
        fun create(
            params: OrderCreateParams
         ...
         * same as [OrderServiceAsync.list].
         */
         ...
         * otherwise the same as [OrderServiceAsync.get].
         */
        fun get(
            orderId: String
         ...
         * otherwise the same as [OrderServiceAsync.search].
         */
        fun search(
            params: OrderSearchParams
