...
import com.hubspot.sdk.models.crm.objects.carts.CartCreateParams
...
import com.hubspot.sdk.models.crm.objects.carts.CartSearchParams
import com.hubspot.sdk.models.crm.objects.carts.CartUpdateParams
import com.hubspot.sdk.services.blocking.crm.objects.carts.BatchService
import com.hubspot.sdk.services.blocking.crm.objects.carts.BatchServiceImpl
...
class CartServiceImpl internal constructor(private val clientOptions: ClientOptions) : CartService {
    ...
    override fun list(params: CartListParams, requestOptions: RequestOptions): CartListPage =
        // get /crm/objects/2026-03/carts
        withRawResponse().list(params, requestOptions).parse()

    override fun delete(params: CartDeleteParams, requestOptions: RequestOptions) {
        ...
        override fun list(
            ...
            return errorHandler.handle(response).parseable {
                response
                    ...
                    .let {
                        CartListPage.builder()
                            .service(CartServiceImpl(clientOptions))
                            .params(params)
                            .response(it)
                            .build()
                    }
