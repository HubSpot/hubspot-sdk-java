...
import com.hubspot.sdk.models.crm.objects.quotes.QuoteCreateParams
...
import com.hubspot.sdk.models.crm.objects.quotes.QuoteSearchParams
import com.hubspot.sdk.models.crm.objects.quotes.QuoteUpdateParams
import com.hubspot.sdk.services.blocking.crm.objects.quotes.BatchService
...
interface QuoteService {
     ...
     */
    fun create(params: QuoteCreateParams): SimplePublicObject =
    ...
    interface WithRawResponse {
         ...
         * same as [QuoteService.create].
         */
        @MustBeClosed
        fun create(params: QuoteCreateParams): HttpResponseFor<SimplePublicObject> =
            create(params, RequestOptions.none())
         ...
         * otherwise the same as [QuoteService.get].
         */
        @MustBeClosed
         ...
         * otherwise the same as [QuoteService.search].
         */
        @MustBeClosed
        fun search(
            params: QuoteSearchParams
