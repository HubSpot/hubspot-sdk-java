...
package com.hubspot.sdk.services.blocking.crm.objects.leads
...
import com.hubspot.sdk.models.crm.objects.leads.batch.BatchCreateParams
import com.hubspot.sdk.models.crm.objects.leads.batch.BatchDeleteParams
import com.hubspot.sdk.models.crm.objects.leads.batch.BatchGetParams
import com.hubspot.sdk.models.crm.objects.leads.batch.BatchUpdateParams
import com.hubspot.sdk.models.crm.objects.leads.batch.BatchUpsertParams
...
interface BatchService {
    ...
    /**
     * Create multiple lead records in a single request by providing a batch of lead data. This
     * endpoint allows for efficient creation of leads by processing them together, which can be
     * useful for syncing data from other systems or importing large datasets.
     */
    ...
    /**
     * Update multiple lead records using their internal IDs or unique property values. This
     * endpoint allows batch processing of updates, where each lead's properties can be modified
     * based on the provided input. Ensure that the properties being updated exist on the lead
     * objects to avoid errors.
     */
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /crm/objects/2026-03/leads/batch/create`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/objects/2026-03/leads/batch/update`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/objects/2026-03/leads/batch/archive`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/objects/2026-03/leads/batch/read`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/objects/2026-03/leads/batch/upsert`, but is
