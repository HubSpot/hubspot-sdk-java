...
import com.hubspot.sdk.models.crm.objects.taxes.TaxListPageAsync
...
import com.hubspot.sdk.services.async.crm.objects.taxes.BatchServiceAsync
import com.hubspot.sdk.services.async.crm.objects.taxes.BatchServiceAsyncImpl
...
class TaxServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val withRawResponse: TaxServiceAsync.WithRawResponse by lazy {
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            TaxServiceAsyncImpl.WithRawResponseImpl(
                ...
                .thenApply { response ->
                    errorHandler.handle(response).parseable {
                        response
                            ...
                            .let {
                                TaxListPageAsync.builder()
                                    .service(TaxServiceAsyncImpl(clientOptions))
