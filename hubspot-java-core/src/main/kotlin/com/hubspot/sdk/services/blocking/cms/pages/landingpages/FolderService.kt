...
interface FolderService {
    ...
    fun createFolders(params: FolderCreateFoldersParams): BatchResponseContentFolder =
    ...
    fun deleteFolders(params: FolderDeleteFoldersParams) =
    ...
    fun updateFolders(params: FolderUpdateFoldersParams): BatchResponseContentFolder =
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun deleteFolders(params: FolderDeleteFoldersParams): HttpResponse =
            deleteFolders(params, RequestOptions.none())
