...
package com.hubspot.sdk.services.blocking.conversations.customchannels
...
interface ChannelAccountService {
    ...
    fun updateStagingToken(
        params: ChannelAccountUpdateStagingTokenParams
    ): PublicChannelAccountStagingToken = updateStagingToken(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         * the same as [ChannelAccountService.create].
         */
        @MustBeClosed
        fun create(
            channelId: Int,
         ...
         * but is otherwise the same as [ChannelAccountService.update].
         */
        @MustBeClosed
        fun update(
            channelAccountId: Long,
         ...
         * /conversations/custom-channels/2026-03/{channelId}/channel-accounts`, but is otherwise
         * the same as [ChannelAccountService.list].
         */
        @MustBeClosed
         ...
         * but is otherwise the same as [ChannelAccountService.updateStagingToken].
         */
        @MustBeClosed
        fun updateStagingToken(
            accountToken: String,
