...
package com.hubspot.sdk.services.blocking.crm.objects.calls
...
import com.hubspot.sdk.models.crm.objects.calls.batch.BatchCreateParams
import com.hubspot.sdk.models.crm.objects.calls.batch.BatchDeleteParams
import com.hubspot.sdk.models.crm.objects.calls.batch.BatchGetParams
import com.hubspot.sdk.models.crm.objects.calls.batch.BatchUpdateParams
import com.hubspot.sdk.models.crm.objects.calls.batch.BatchUpsertParams
...
interface BatchService {
    ...
    /**
     * Create a batch of calls. The `inputs` array can contain a `properties` object to define
    ...
    /**
     * Archive a batch of calls by ID. Deleted calls can be restored within 90 days of being
     * deleted, but call recordings recording will be permanently deleted. Learn more about
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /crm/objects/2026-03/calls/batch/create`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/objects/2026-03/calls/batch/update`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/objects/2026-03/calls/batch/archive`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/objects/2026-03/calls/batch/read`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/objects/2026-03/calls/batch/upsert`, but is
