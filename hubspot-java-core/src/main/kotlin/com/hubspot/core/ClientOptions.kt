...
package com.hubspot.core

import com.fasterxml.jackson.databind.json.JsonMapper
import com.hubspot.core.http.AsyncStreamResponse
import com.hubspot.core.http.Headers
import com.hubspot.core.http.HttpClient
import com.hubspot.core.http.PhantomReachableClosingHttpClient
import com.hubspot.core.http.QueryParams
import com.hubspot.core.http.RetryingHttpClient
...
private constructor(
     ...
     *
     * Use the one published in `hubspot-java-client-okhttp` or implement your own.
     *
     ...
     *
     * Defaults to [com.hubspot.core.jsonMapper]. The default is usually sufficient and rarely needs
     * to be overridden.
     */
    ...
    class Builder internal constructor() {
         ...
         * The Jackson JSON mapper to use for serializing and deserializing JSON.
         *
         * Defaults to [com.hubspot.core.jsonMapper]. The default is usually sufficient and rarely
        ...
        fun build(): ClientOptions {
                            ...
                            object : ThreadFactory {
                                ...
                                override fun newThread(runnable: Runnable): Thread =
                                    threadFactory.newThread(runnable).also {
                                        it.name =
                                            "hubspot-stream-handler-thread-${count.getAndIncrement()}"
                                    }
                            }
                        )
                    )
            ...
            developerApiKey?.let {
                if (!it.isEmpty()) {
                    queryParams.replace("hapikey", it)
                }
            }
