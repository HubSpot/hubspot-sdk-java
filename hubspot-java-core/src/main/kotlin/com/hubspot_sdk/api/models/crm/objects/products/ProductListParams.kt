...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of products that can
    ...
    class Builder internal constructor() {
        ...
        internal fun from(productListParams: ProductListParams) = apply {
            after = productListParams.after
            archived = productListParams.archived
            associations = productListParams.associations?.toMutableList()
            limit = productListParams.limit
            properties = productListParams.properties?.toMutableList()
            propertiesWithHistory = productListParams.propertiesWithHistory?.toMutableList()
         ...
         * of products that can be read by a single request.
         */
    ...
    override fun toString() =
        "ProductListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
