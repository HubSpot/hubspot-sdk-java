...
/**
 * Retrieve a meeting by its ID (`objectId`) or by a unique property (`idProperty`). You can specify
 * what is returned using the `properties` query parameter.
 */
class MeetingGetParams
private constructor(
    ...
    fun meetingId(): Optional<String> = Optional.ofNullable(meetingId)
    ...
    companion object {
        ...
        @JvmStatic fun none(): MeetingGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [MeetingGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MeetingGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(meetingGetParams: MeetingGetParams) = apply {
            meetingId = meetingGetParams.meetingId
            archived = meetingGetParams.archived
            associations = meetingGetParams.associations?.toMutableList()
            idProperty = meetingGetParams.idProperty
            properties = meetingGetParams.properties?.toMutableList()
            propertiesWithHistory = meetingGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = meetingGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = meetingGetParams.additionalQueryParams.toBuilder()
        }

        fun meetingId(meetingId: String?) = apply { this.meetingId = meetingId }

        /** Alias for calling [Builder.meetingId] with `meetingId.orElse(null)`. */
        fun meetingId(meetingId: Optional<String>) = meetingId(meetingId.getOrNull())
        ...
        /**
         * Returns an immutable instance of [MeetingGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MeetingGetParams =
            MeetingGetParams(
                meetingId,
                archived,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MeetingGetParams &&
    ...
    override fun toString() =
        "MeetingGetParams{meetingId=$meetingId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
