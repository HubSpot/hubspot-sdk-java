...
private constructor(
    ...
    private val functions: JsonField<List<PublicActionFunction>>,
    private val inputFields: JsonField<List<PublicInputFieldDefinition>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        functions: JsonField<List<PublicActionFunction>> = JsonMissing.of(),
        @JsonProperty("inputFields")
        @ExcludeMissing
        inputFields: JsonField<List<PublicInputFieldDefinition>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun functions(): List<PublicActionFunction> = functions.getRequired("functions")
    ...
    @JsonProperty("functions")
    @ExcludeMissing
    fun _functions(): JsonField<List<PublicActionFunction>> = functions
    ...
    @JsonProperty("inputFields")
    @ExcludeMissing
    fun _inputFields(): JsonField<List<PublicInputFieldDefinition>> = inputFields
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicActionDefinitionEgg].
         *
    ...
    /** A builder for [PublicActionDefinitionEgg]. */
    class Builder internal constructor() {

        private var actionUrl: JsonField<String>? = null
        private var functions: JsonField<MutableList<PublicActionFunction>>? = null
        private var inputFields: JsonField<MutableList<PublicInputFieldDefinition>>? = null
        ...
        @JvmSynthetic
        internal fun from(publicActionDefinitionEgg: PublicActionDefinitionEgg) = apply {
            actionUrl = publicActionDefinitionEgg.actionUrl
            functions = publicActionDefinitionEgg.functions.map { it.toMutableList() }
            inputFields = publicActionDefinitionEgg.inputFields.map { it.toMutableList() }
            labels = publicActionDefinitionEgg.labels
            objectTypes = publicActionDefinitionEgg.objectTypes.map { it.toMutableList() }
            published = publicActionDefinitionEgg.published
            archivedAt = publicActionDefinitionEgg.archivedAt
            executionRules = publicActionDefinitionEgg.executionRules.map { it.toMutableList() }
            inputFieldDependencies =
                publicActionDefinitionEgg.inputFieldDependencies.map { it.toMutableList() }
            objectRequestOptions = publicActionDefinitionEgg.objectRequestOptions
            outputFields = publicActionDefinitionEgg.outputFields.map { it.toMutableList() }
        ...
        fun functions(functions: List<PublicActionFunction>) = functions(JsonField.of(functions))

        /**
         * Sets [Builder.functions] to an arbitrary JSON value.
         *
         * You should usually call [Builder.functions] with a well-typed
         * `List<PublicActionFunction>` value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun functions(functions: JsonField<List<PublicActionFunction>>) = apply {
            this.functions = functions.map { it.toMutableList() }
        }

        /**
         * Adds a single [PublicActionFunction] to [functions].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addFunction(function: PublicActionFunction) = apply {
            functions =
        ...
        fun inputFields(inputFields: List<PublicInputFieldDefinition>) =
         ...
         * `List<PublicInputFieldDefinition>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun inputFields(inputFields: JsonField<List<PublicInputFieldDefinition>>) = apply {
            this.inputFields = inputFields.map { it.toMutableList() }
        }

        /**
         * Adds a single [PublicInputFieldDefinition] to [inputFields].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addInputField(inputField: PublicInputFieldDefinition) = apply {
            inputFields =
        ...
        /**
         * Returns an immutable instance of [PublicActionDefinitionEgg].
         *
         ...
         */
        fun build(): PublicActionDefinitionEgg =
    ...
    fun validate(): PublicActionDefinitionEgg = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicActionDefinitionEgg &&
    ...
    override fun toString() =
        "PublicActionDefinitionEgg{actionUrl=$actionUrl, functions=$functions, inputFields=$inputFields, labels=$labels, objectTypes=$objectTypes, published=$published, archivedAt=$archivedAt, executionRules=$executionRules, inputFieldDependencies=$inputFieldDependencies, objectRequestOptions=$objectRequestOptions, outputFields=$outputFields, additionalProperties=$additionalProperties}"
}
