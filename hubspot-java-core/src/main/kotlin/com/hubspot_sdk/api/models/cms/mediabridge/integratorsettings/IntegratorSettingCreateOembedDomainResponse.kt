...
class IntegratorSettingCreateOembedDomainResponse
...
private constructor(
    ...
    /** A builder for [IntegratorSettingCreateOembedDomainResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            integratorSettingCreateOembedDomainResponse: IntegratorSettingCreateOembedDomainResponse
        ) = apply {
            id = integratorSettingCreateOembedDomainResponse.id
            appId = integratorSettingCreateOembedDomainResponse.appId
            createdAt = integratorSettingCreateOembedDomainResponse.createdAt
            deletedAt = integratorSettingCreateOembedDomainResponse.deletedAt
            endpoints = integratorSettingCreateOembedDomainResponse.endpoints
            portalId = integratorSettingCreateOembedDomainResponse.portalId
            updatedAt = integratorSettingCreateOembedDomainResponse.updatedAt
            additionalProperties =
                integratorSettingCreateOembedDomainResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IntegratorSettingCreateOembedDomainResponse].
         *
         ...
         */
        fun build(): IntegratorSettingCreateOembedDomainResponse =
            IntegratorSettingCreateOembedDomainResponse(
                checkRequired("id", id),
    ...
    fun validate(): IntegratorSettingCreateOembedDomainResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IntegratorSettingCreateOembedDomainResponse &&
            id == other.id &&
            appId == other.appId &&
    ...
    override fun toString() =
        "IntegratorSettingCreateOembedDomainResponse{id=$id, appId=$appId, createdAt=$createdAt, deletedAt=$deletedAt, endpoints=$endpoints, portalId=$portalId, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
