...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EnablementGetResponse].
         *
    ...
    /** A builder for [EnablementGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(enablementGetResponse: EnablementGetResponse) = apply {
            enablement = enablementGetResponse.enablement
            additionalProperties = enablementGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EnablementGetResponse].
         *
         ...
         */
        fun build(): EnablementGetResponse =
    ...
    fun validate(): EnablementGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EnablementGetResponse &&
    ...
    override fun toString() =
        "EnablementGetResponse{enablement=$enablement, additionalProperties=$additionalProperties}"
}
