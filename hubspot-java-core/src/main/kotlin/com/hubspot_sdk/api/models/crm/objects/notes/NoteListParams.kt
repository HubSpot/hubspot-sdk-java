...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of notes that can be
    ...
    companion object {
        ...
        @JvmStatic fun none(): NoteListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [NoteListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [NoteListParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(noteListParams: NoteListParams) = apply {
            after = noteListParams.after
            archived = noteListParams.archived
            associations = noteListParams.associations?.toMutableList()
            limit = noteListParams.limit
            properties = noteListParams.properties?.toMutableList()
            propertiesWithHistory = noteListParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = noteListParams.additionalHeaders.toBuilder()
            additionalQueryParams = noteListParams.additionalQueryParams.toBuilder()
        }
         ...
         * of notes that can be read by a single request.
         */
        ...
        /**
         * Returns an immutable instance of [NoteListParams].
         *
    ...
    override fun toString() =
        "NoteListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
