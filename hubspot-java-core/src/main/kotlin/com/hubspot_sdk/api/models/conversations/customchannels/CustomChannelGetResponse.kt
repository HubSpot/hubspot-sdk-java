...
class CustomChannelGetResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CustomChannelGetResponse].
         *
    ...
    /** A builder for [CustomChannelGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customChannelGetResponse: CustomChannelGetResponse) = apply {
            id = customChannelGetResponse.id
            capabilities = customChannelGetResponse.capabilities
            createdAt = customChannelGetResponse.createdAt
            name = customChannelGetResponse.name
            channelAccountConnectionRedirectUrl =
                customChannelGetResponse.channelAccountConnectionRedirectUrl
            channelDescription = customChannelGetResponse.channelDescription
            channelLogoUrl = customChannelGetResponse.channelLogoUrl
            webhookUrl = customChannelGetResponse.webhookUrl
            additionalProperties = customChannelGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CustomChannelGetResponse].
         *
         ...
         */
        fun build(): CustomChannelGetResponse =
    ...
    fun validate(): CustomChannelGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomChannelGetResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "CustomChannelGetResponse{id=$id, capabilities=$capabilities, createdAt=$createdAt, name=$name, channelAccountConnectionRedirectUrl=$channelAccountConnectionRedirectUrl, channelDescription=$channelDescription, channelLogoUrl=$channelLogoUrl, webhookUrl=$webhookUrl, additionalProperties=$additionalProperties}"
}
