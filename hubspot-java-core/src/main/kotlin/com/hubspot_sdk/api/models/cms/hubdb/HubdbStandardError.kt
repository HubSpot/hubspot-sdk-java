...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [HubdbStandardError].
         *
    ...
    /** A builder for [HubdbStandardError]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(hubdbStandardError: HubdbStandardError) = apply {
            category = hubdbStandardError.category
            context = hubdbStandardError.context
            errors = hubdbStandardError.errors.map { it.toMutableList() }
            links = hubdbStandardError.links
            message = hubdbStandardError.message
            status = hubdbStandardError.status
            subCategory = hubdbStandardError.subCategory
            id = hubdbStandardError.id
            additionalProperties = hubdbStandardError.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [HubdbStandardError].
         *
    ...
    fun validate(): HubdbStandardError = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is HubdbStandardError &&
    ...
    override fun toString() =
        "HubdbStandardError{category=$category, context=$context, errors=$errors, links=$links, message=$message, status=$status, subCategory=$subCategory, id=$id, additionalProperties=$additionalProperties}"
}
