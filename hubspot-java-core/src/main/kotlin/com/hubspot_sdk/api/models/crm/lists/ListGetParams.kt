...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ListGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ListGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ListGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(listGetParams: ListGetParams) = apply {
            listId = listGetParams.listId
            includeFilters = listGetParams.includeFilters
            additionalHeaders = listGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = listGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ListGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ListGetParams =
            ListGetParams(
                listId,
                includeFilters,
    ...
    override fun hashCode(): Int =
        Objects.hash(listId, includeFilters, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ListGetParams{listId=$listId, includeFilters=$includeFilters, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
