...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PageGetSitePagesParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PageGetSitePagesParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PageGetSitePagesParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pageGetSitePagesParams: PageGetSitePagesParams) = apply {
            after = pageGetSitePagesParams.after
            archived = pageGetSitePagesParams.archived
            createdAfter = pageGetSitePagesParams.createdAfter
            createdAt = pageGetSitePagesParams.createdAt
            createdBefore = pageGetSitePagesParams.createdBefore
            limit = pageGetSitePagesParams.limit
            property = pageGetSitePagesParams.property
            sort = pageGetSitePagesParams.sort?.toMutableList()
            updatedAfter = pageGetSitePagesParams.updatedAfter
            updatedAt = pageGetSitePagesParams.updatedAt
            updatedBefore = pageGetSitePagesParams.updatedBefore
            additionalHeaders = pageGetSitePagesParams.additionalHeaders.toBuilder()
            additionalQueryParams = pageGetSitePagesParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PageGetSitePagesParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PageGetSitePagesParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PageGetSitePagesParams &&
            after == other.after &&
    ...
    override fun toString() =
        "PageGetSitePagesParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
