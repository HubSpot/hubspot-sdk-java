...
class ConversationsPublicConversationsMessage
...
private constructor(
    ...
    /** A builder for [ConversationsPublicConversationsMessage]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            conversationsPublicConversationsMessage: ConversationsPublicConversationsMessage
        ) = apply {
            id = conversationsPublicConversationsMessage.id
            archived = conversationsPublicConversationsMessage.archived
            attachments =
                conversationsPublicConversationsMessage.attachments.map { it.toMutableList() }
            channelAccountId = conversationsPublicConversationsMessage.channelAccountId
            channelId = conversationsPublicConversationsMessage.channelId
            client = conversationsPublicConversationsMessage.client
            conversationsThreadId = conversationsPublicConversationsMessage.conversationsThreadId
            createdAt = conversationsPublicConversationsMessage.createdAt
            createdBy = conversationsPublicConversationsMessage.createdBy
            direction = conversationsPublicConversationsMessage.direction
            recipients =
                conversationsPublicConversationsMessage.recipients.map { it.toMutableList() }
            senders = conversationsPublicConversationsMessage.senders.map { it.toMutableList() }
            text = conversationsPublicConversationsMessage.text
            truncationStatus = conversationsPublicConversationsMessage.truncationStatus
            type = conversationsPublicConversationsMessage.type
            inReplyToId = conversationsPublicConversationsMessage.inReplyToId
            richText = conversationsPublicConversationsMessage.richText
            status = conversationsPublicConversationsMessage.status
            subject = conversationsPublicConversationsMessage.subject
            updatedAt = conversationsPublicConversationsMessage.updatedAt
            additionalProperties =
                conversationsPublicConversationsMessage.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConversationsPublicConversationsMessage].
         *
         ...
         */
        fun build(): ConversationsPublicConversationsMessage =
            ConversationsPublicConversationsMessage(
                checkRequired("id", id),
    ...
    fun validate(): ConversationsPublicConversationsMessage = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConversationsPublicConversationsMessage &&
            id == other.id &&
    ...
    override fun toString() =
        "ConversationsPublicConversationsMessage{id=$id, archived=$archived, attachments=$attachments, channelAccountId=$channelAccountId, channelId=$channelId, client=$client, conversationsThreadId=$conversationsThreadId, createdAt=$createdAt, createdBy=$createdBy, direction=$direction, recipients=$recipients, senders=$senders, text=$text, truncationStatus=$truncationStatus, type=$type, inReplyToId=$inReplyToId, richText=$richText, status=$status, subject=$subject, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
