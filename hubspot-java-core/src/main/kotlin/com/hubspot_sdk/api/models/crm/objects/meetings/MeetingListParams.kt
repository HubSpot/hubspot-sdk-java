...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of meetings that can
    ...
    companion object {
        ...
        @JvmStatic fun none(): MeetingListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [MeetingListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MeetingListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(meetingListParams: MeetingListParams) = apply {
            after = meetingListParams.after
            archived = meetingListParams.archived
            associations = meetingListParams.associations?.toMutableList()
            limit = meetingListParams.limit
            properties = meetingListParams.properties?.toMutableList()
            propertiesWithHistory = meetingListParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = meetingListParams.additionalHeaders.toBuilder()
            additionalQueryParams = meetingListParams.additionalQueryParams.toBuilder()
        }
         ...
         * of meetings that can be read by a single request.
         */
        ...
        /**
         * Returns an immutable instance of [MeetingListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MeetingListParams =
            MeetingListParams(
                after,
                archived,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MeetingListParams &&
            after == other.after &&
    ...
    override fun toString() =
        "MeetingListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
