...
class CreatedResponseLabelsBetweenObjectPair
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val createdResourceId: JsonField<String>,
    private val entity: JsonField<LabelsBetweenObjectPair>,
    ...
    private constructor(
        ...
        @JsonProperty("entity")
        @ExcludeMissing
        entity: JsonField<LabelsBetweenObjectPair> = JsonMissing.of(),
    ...
    @JsonProperty("entity")
    @ExcludeMissing
    fun _entity(): JsonField<LabelsBetweenObjectPair> = entity
    ...
    /** A builder for [CreatedResponseLabelsBetweenObjectPair]. */
    class Builder internal constructor() {

        private var createdResourceId: JsonField<String>? = null
        private var entity: JsonField<LabelsBetweenObjectPair>? = null
        private var location: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            createdResponseLabelsBetweenObjectPair: CreatedResponseLabelsBetweenObjectPair
        ) = apply {
            createdResourceId = createdResponseLabelsBetweenObjectPair.createdResourceId
            entity = createdResponseLabelsBetweenObjectPair.entity
            location = createdResponseLabelsBetweenObjectPair.location
        ...
        fun entity(entity: LabelsBetweenObjectPair) = entity(JsonField.of(entity))

        /**
         * Sets [Builder.entity] to an arbitrary JSON value.
         *
         * You should usually call [Builder.entity] with a well-typed [LabelsBetweenObjectPair]
        ...
        /**
         * Returns an immutable instance of [CreatedResponseLabelsBetweenObjectPair].
         *
         ...
         */
        fun build(): CreatedResponseLabelsBetweenObjectPair =
            CreatedResponseLabelsBetweenObjectPair(
    ...
    fun validate(): CreatedResponseLabelsBetweenObjectPair = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CreatedResponseLabelsBetweenObjectPair &&
    ...
    override fun toString() =
        "CreatedResponseLabelsBetweenObjectPair{createdResourceId=$createdResourceId, entity=$entity, location=$location, additionalProperties=$additionalProperties}"
}
