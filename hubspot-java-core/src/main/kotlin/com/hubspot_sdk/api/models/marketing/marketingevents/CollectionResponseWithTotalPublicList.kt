...
class CollectionResponseWithTotalPublicList
...
private constructor(
    ...
    /** A builder for [CollectionResponseWithTotalPublicList]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            results = collectionResponseWithTotalPublicList.results.map { it.toMutableList() }
            total = collectionResponseWithTotalPublicList.total
            paging = collectionResponseWithTotalPublicList.paging
            additionalProperties =
                collectionResponseWithTotalPublicList.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CollectionResponseWithTotalPublicList].
         *
         ...
         */
        fun build(): CollectionResponseWithTotalPublicList =
            CollectionResponseWithTotalPublicList(
    ...
    fun validate(): CollectionResponseWithTotalPublicList = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionResponseWithTotalPublicList &&
    ...
    override fun toString() =
        "CollectionResponseWithTotalPublicList{results=$results, total=$total, paging=$paging, additionalProperties=$additionalProperties}"
}
