...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UrlRedirectListResponse].
         *
    ...
    /** A builder for [UrlRedirectListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(urlRedirectListResponse: UrlRedirectListResponse) = apply {
            id = urlRedirectListResponse.id
            destination = urlRedirectListResponse.destination
            isMatchFullUrl = urlRedirectListResponse.isMatchFullUrl
            isMatchQueryString = urlRedirectListResponse.isMatchQueryString
            isOnlyAfterNotFound = urlRedirectListResponse.isOnlyAfterNotFound
            isPattern = urlRedirectListResponse.isPattern
            isProtocolAgnostic = urlRedirectListResponse.isProtocolAgnostic
            isTrailingSlashOptional = urlRedirectListResponse.isTrailingSlashOptional
            precedence = urlRedirectListResponse.precedence
            redirectStyle = urlRedirectListResponse.redirectStyle
            routePrefix = urlRedirectListResponse.routePrefix
            created = urlRedirectListResponse.created
            updated = urlRedirectListResponse.updated
            additionalProperties = urlRedirectListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UrlRedirectListResponse].
         *
         ...
         */
        fun build(): UrlRedirectListResponse =
    ...
    fun validate(): UrlRedirectListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UrlRedirectListResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "UrlRedirectListResponse{id=$id, destination=$destination, isMatchFullUrl=$isMatchFullUrl, isMatchQueryString=$isMatchQueryString, isOnlyAfterNotFound=$isOnlyAfterNotFound, isPattern=$isPattern, isProtocolAgnostic=$isProtocolAgnostic, isTrailingSlashOptional=$isTrailingSlashOptional, precedence=$precedence, redirectStyle=$redirectStyle, routePrefix=$routePrefix, created=$created, updated=$updated, additionalProperties=$additionalProperties}"
}
