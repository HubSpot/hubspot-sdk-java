...
class ChannelAccountStagingTokenUpdateResponse
...
private constructor(
    ...
    /** A builder for [ChannelAccountStagingTokenUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            channelAccountStagingTokenUpdateResponse: ChannelAccountStagingTokenUpdateResponse
        ) = apply {
            accountToken = channelAccountStagingTokenUpdateResponse.accountToken
            createdAt = channelAccountStagingTokenUpdateResponse.createdAt
            genericChannelId = channelAccountStagingTokenUpdateResponse.genericChannelId
            inboxId = channelAccountStagingTokenUpdateResponse.inboxId
            userId = channelAccountStagingTokenUpdateResponse.userId
            accountName = channelAccountStagingTokenUpdateResponse.accountName
            deliveryIdentifier = channelAccountStagingTokenUpdateResponse.deliveryIdentifier
            additionalProperties =
                channelAccountStagingTokenUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ChannelAccountStagingTokenUpdateResponse].
         *
         ...
         */
        fun build(): ChannelAccountStagingTokenUpdateResponse =
            ChannelAccountStagingTokenUpdateResponse(
    ...
    fun validate(): ChannelAccountStagingTokenUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ChannelAccountStagingTokenUpdateResponse &&
    ...
    override fun toString() =
        "ChannelAccountStagingTokenUpdateResponse{accountToken=$accountToken, createdAt=$createdAt, genericChannelId=$genericChannelId, inboxId=$inboxId, userId=$userId, accountName=$accountName, deliveryIdentifier=$deliveryIdentifier, additionalProperties=$additionalProperties}"
}
