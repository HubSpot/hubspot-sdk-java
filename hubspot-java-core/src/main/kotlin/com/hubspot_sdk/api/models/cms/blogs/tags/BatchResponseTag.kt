...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchResponseTag].
         *
    ...
    /** A builder for [BatchResponseTag]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchResponseTag: BatchResponseTag) = apply {
            completedAt = batchResponseTag.completedAt
            results = batchResponseTag.results.map { it.toMutableList() }
            startedAt = batchResponseTag.startedAt
            status = batchResponseTag.status
            links = batchResponseTag.links
            requestedAt = batchResponseTag.requestedAt
            additionalProperties = batchResponseTag.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BatchResponseTag].
         *
    ...
    fun validate(): BatchResponseTag = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseTag &&
    ...
    override fun toString() =
        "BatchResponseTag{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, links=$links, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
