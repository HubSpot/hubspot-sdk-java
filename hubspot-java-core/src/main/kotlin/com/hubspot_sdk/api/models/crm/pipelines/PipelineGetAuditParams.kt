...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PipelineGetAuditParams].
         *
    ...
    /** A builder for [PipelineGetAuditParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pipelineGetAuditParams: PipelineGetAuditParams) = apply {
            objectType = pipelineGetAuditParams.objectType
            pipelineId = pipelineGetAuditParams.pipelineId
            stageId = pipelineGetAuditParams.stageId
            additionalHeaders = pipelineGetAuditParams.additionalHeaders.toBuilder()
            additionalQueryParams = pipelineGetAuditParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PipelineGetAuditParams].
         *
         ...
         */
        fun build(): PipelineGetAuditParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PipelineGetAuditParams &&
    ...
    override fun toString() =
        "PipelineGetAuditParams{objectType=$objectType, pipelineId=$pipelineId, stageId=$stageId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
