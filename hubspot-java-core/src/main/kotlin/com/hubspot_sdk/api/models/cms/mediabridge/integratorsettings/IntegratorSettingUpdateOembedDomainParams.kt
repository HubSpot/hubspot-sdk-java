...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            integratorSettingUpdateOembedDomainParams: IntegratorSettingUpdateOembedDomainParams
        ) = apply {
            appId = integratorSettingUpdateOembedDomainParams.appId
            oEmbedDomainId = integratorSettingUpdateOembedDomainParams.oEmbedDomainId
            body = integratorSettingUpdateOembedDomainParams.body.toBuilder()
            additionalHeaders =
                integratorSettingUpdateOembedDomainParams.additionalHeaders.toBuilder()
        ...
        /**
         * Returns an immutable instance of [IntegratorSettingUpdateOembedDomainParams].
         *
         ...
         */
        fun build(): IntegratorSettingUpdateOembedDomainParams =
            IntegratorSettingUpdateOembedDomainParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IntegratorSettingUpdateOembedDomainParams &&
            appId == other.appId &&
    ...
    override fun hashCode(): Int =
        Objects.hash(appId, oEmbedDomainId, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "IntegratorSettingUpdateOembedDomainParams{appId=$appId, oEmbedDomainId=$oEmbedDomainId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
