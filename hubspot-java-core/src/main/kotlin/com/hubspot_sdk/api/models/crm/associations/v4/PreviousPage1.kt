...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PreviousPage1].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(previousPage1: PreviousPage1) = apply {
            before = previousPage1.before
            link = previousPage1.link
            additionalProperties = previousPage1.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PreviousPage1].
         *
    ...
    fun validate(): PreviousPage1 = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "PreviousPage1{before=$before, link=$link, additionalProperties=$additionalProperties}"
}
