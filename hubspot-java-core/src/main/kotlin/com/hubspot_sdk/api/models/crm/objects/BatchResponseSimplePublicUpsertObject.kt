...
/**
 * Represents the result of a batch upsert operation, including the operation’s status, timestamps,
 * and a list of successfully created or updated objects.
 */
...
private constructor(
    ...
    /** A builder for [BatchResponseSimplePublicUpsertObject]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            completedAt = batchResponseSimplePublicUpsertObject.completedAt
            results = batchResponseSimplePublicUpsertObject.results.map { it.toMutableList() }
            startedAt = batchResponseSimplePublicUpsertObject.startedAt
            status = batchResponseSimplePublicUpsertObject.status
            errors = batchResponseSimplePublicUpsertObject.errors.map { it.toMutableList() }
            links = batchResponseSimplePublicUpsertObject.links
            numErrors = batchResponseSimplePublicUpsertObject.numErrors
            requestedAt = batchResponseSimplePublicUpsertObject.requestedAt
            additionalProperties =
                batchResponseSimplePublicUpsertObject.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BatchResponseSimplePublicUpsertObject].
         *
         ...
         */
        fun build(): BatchResponseSimplePublicUpsertObject =
            BatchResponseSimplePublicUpsertObject(
    ...
    fun validate(): BatchResponseSimplePublicUpsertObject = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseSimplePublicUpsertObject &&
    ...
    override fun toString() =
        "BatchResponseSimplePublicUpsertObject{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
