...
private constructor(
    ...
    /** A builder for [SettingDetachFromLangGroupParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(settingDetachFromLangGroupParams: SettingDetachFromLangGroupParams) =
            apply {
                detachFromLangGroupRequestVNext =
                    settingDetachFromLangGroupParams.detachFromLangGroupRequestVNext
                additionalHeaders = settingDetachFromLangGroupParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    settingDetachFromLangGroupParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SettingDetachFromLangGroupParams].
         *
         ...
         */
        fun build(): SettingDetachFromLangGroupParams =
            SettingDetachFromLangGroupParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SettingDetachFromLangGroupParams &&
    ...
    override fun toString() =
        "SettingDetachFromLangGroupParams{detachFromLangGroupRequestVNext=$detachFromLangGroupRequestVNext, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
