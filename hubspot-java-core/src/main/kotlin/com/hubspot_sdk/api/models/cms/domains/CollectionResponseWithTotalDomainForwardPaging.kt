...
private constructor(
    private val results: JsonField<List<Domain>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<Domain>> = JsonMissing.of(),
     ...
     */
    fun results(): List<Domain> = results.getRequired("results")
     ...
     */
    @JsonProperty("results") @ExcludeMissing fun _results(): JsonField<List<Domain>> = results
    ...
    /** A builder for [CollectionResponseWithTotalDomainForwardPaging]. */
    class Builder internal constructor() {

        private var results: JsonField<MutableList<Domain>>? = null
        ...
        internal fun from(
            ...
            results =
                collectionResponseWithTotalDomainForwardPaging.results.map { it.toMutableList() }
            total = collectionResponseWithTotalDomainForwardPaging.total
            paging = collectionResponseWithTotalDomainForwardPaging.paging
            additionalProperties =
                collectionResponseWithTotalDomainForwardPaging.additionalProperties.toMutableMap()
        }

        fun results(results: List<Domain>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed `List<Domain>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun results(results: JsonField<List<Domain>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [Domain] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: Domain) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [CollectionResponseWithTotalDomainForwardPaging].
         *
         ...
         */
        fun build(): CollectionResponseWithTotalDomainForwardPaging =
            CollectionResponseWithTotalDomainForwardPaging(
    ...
    fun validate(): CollectionResponseWithTotalDomainForwardPaging = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionResponseWithTotalDomainForwardPaging &&
    ...
    override fun toString() =
        "CollectionResponseWithTotalDomainForwardPaging{results=$results, total=$total, paging=$paging, additionalProperties=$additionalProperties}"
}
