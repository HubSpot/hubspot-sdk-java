...
class FileOperationUploadParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): FileOperationUploadParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [FileOperationUploadParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FileOperationUploadParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileOperationUploadParams: FileOperationUploadParams) = apply {
            body = fileOperationUploadParams.body.toBuilder()
            additionalHeaders = fileOperationUploadParams.additionalHeaders.toBuilder()
            additionalQueryParams = fileOperationUploadParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FileOperationUploadParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FileOperationUploadParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FileOperationUploadParams &&
            body == other.body &&
    ...
    override fun toString() =
        "FileOperationUploadParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
