...
private constructor(
    ...
    /** A builder for [CollectionResponseWithTotalVersionPublicEmail]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            results =
                collectionResponseWithTotalVersionPublicEmail.results.map { it.toMutableList() }
            total = collectionResponseWithTotalVersionPublicEmail.total
            paging = collectionResponseWithTotalVersionPublicEmail.paging
            additionalProperties =
                collectionResponseWithTotalVersionPublicEmail.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CollectionResponseWithTotalVersionPublicEmail].
         *
         ...
         */
        fun build(): CollectionResponseWithTotalVersionPublicEmail =
            CollectionResponseWithTotalVersionPublicEmail(
    ...
    fun validate(): CollectionResponseWithTotalVersionPublicEmail = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionResponseWithTotalVersionPublicEmail &&
    ...
    override fun toString() =
        "CollectionResponseWithTotalVersionPublicEmail{results=$results, total=$total, paging=$paging, additionalProperties=$additionalProperties}"
}
