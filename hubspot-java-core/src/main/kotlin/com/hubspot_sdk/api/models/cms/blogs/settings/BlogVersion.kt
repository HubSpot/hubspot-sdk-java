...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BlogVersion].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(blogVersion: BlogVersion) = apply {
            id = blogVersion.id
            object_ = blogVersion.object_
            updatedAt = blogVersion.updatedAt
            user = blogVersion.user
            additionalProperties = blogVersion.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BlogVersion].
         *
    ...
    fun validate(): BlogVersion = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "BlogVersion{id=$id, object_=$object_, updatedAt=$updatedAt, user=$user, additionalProperties=$additionalProperties}"
}
