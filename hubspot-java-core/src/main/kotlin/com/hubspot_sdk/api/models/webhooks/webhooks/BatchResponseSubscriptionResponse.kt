...
private constructor(
    ...
    /** A builder for [BatchResponseSubscriptionResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchResponseSubscriptionResponse: BatchResponseSubscriptionResponse) =
            apply {
                completedAt = batchResponseSubscriptionResponse.completedAt
                results = batchResponseSubscriptionResponse.results.map { it.toMutableList() }
                startedAt = batchResponseSubscriptionResponse.startedAt
                status = batchResponseSubscriptionResponse.status
                errors = batchResponseSubscriptionResponse.errors.map { it.toMutableList() }
                links = batchResponseSubscriptionResponse.links
                numErrors = batchResponseSubscriptionResponse.numErrors
                requestedAt = batchResponseSubscriptionResponse.requestedAt
        ...
        /**
         * Returns an immutable instance of [BatchResponseSubscriptionResponse].
         *
         ...
         */
        fun build(): BatchResponseSubscriptionResponse =
            BatchResponseSubscriptionResponse(
    ...
    fun validate(): BatchResponseSubscriptionResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseSubscriptionResponse &&
    ...
    override fun toString() =
        "BatchResponseSubscriptionResponse{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
