...
class DealSplitBatchUpsertResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DealSplitBatchUpsertResponse].
         *
    ...
    /** A builder for [DealSplitBatchUpsertResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dealSplitBatchUpsertResponse: DealSplitBatchUpsertResponse) = apply {
            completedAt = dealSplitBatchUpsertResponse.completedAt
            results = dealSplitBatchUpsertResponse.results.map { it.toMutableList() }
            startedAt = dealSplitBatchUpsertResponse.startedAt
            status = dealSplitBatchUpsertResponse.status
            links = dealSplitBatchUpsertResponse.links
            requestedAt = dealSplitBatchUpsertResponse.requestedAt
            additionalProperties = dealSplitBatchUpsertResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DealSplitBatchUpsertResponse].
         *
         ...
         */
        fun build(): DealSplitBatchUpsertResponse =
    ...
    fun validate(): DealSplitBatchUpsertResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(result: Result) = apply {
                id = result.id
                splits = result.splits.map { it.toMutableList() }
        ...
        override fun toString() =
            "Result{id=$id, splits=$splits, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DealSplitBatchUpsertResponse &&
    ...
    override fun toString() =
        "DealSplitBatchUpsertResponse{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, links=$links, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
