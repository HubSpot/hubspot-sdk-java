...
class IntegratorSettingRegisterAppNameResponse
...
private constructor(
    ...
    /** A builder for [IntegratorSettingRegisterAppNameResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            integratorSettingRegisterAppNameResponse: IntegratorSettingRegisterAppNameResponse
        ) = apply {
            appId = integratorSettingRegisterAppNameResponse.appId
            name = integratorSettingRegisterAppNameResponse.name
            additionalProperties =
                integratorSettingRegisterAppNameResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IntegratorSettingRegisterAppNameResponse].
         *
         ...
         */
        fun build(): IntegratorSettingRegisterAppNameResponse =
            IntegratorSettingRegisterAppNameResponse(
    ...
    fun validate(): IntegratorSettingRegisterAppNameResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IntegratorSettingRegisterAppNameResponse &&
            appId == other.appId &&
            name == other.name &&
    ...
    override fun toString() =
        "IntegratorSettingRegisterAppNameResponse{appId=$appId, name=$name, additionalProperties=$additionalProperties}"
}
