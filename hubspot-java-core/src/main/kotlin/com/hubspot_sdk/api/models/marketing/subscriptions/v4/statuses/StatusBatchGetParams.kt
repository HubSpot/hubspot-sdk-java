...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [StatusBatchGetParams].
         *
    ...
    /** A builder for [StatusBatchGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(statusBatchGetParams: StatusBatchGetParams) = apply {
            channel = statusBatchGetParams.channel
            businessUnitId = statusBatchGetParams.businessUnitId
            batchInputString = statusBatchGetParams.batchInputString
            additionalHeaders = statusBatchGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = statusBatchGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [StatusBatchGetParams].
         *
         ...
         */
        fun build(): StatusBatchGetParams =
            StatusBatchGetParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StatusBatchGetParams &&
    ...
    override fun toString() =
        "StatusBatchGetParams{channel=$channel, businessUnitId=$businessUnitId, batchInputString=$batchInputString, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
