...
class SourceCodeGetMetadataResponse
...
private constructor(
    ...
    /** A builder for [SourceCodeGetMetadataResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sourceCodeGetMetadataResponse: SourceCodeGetMetadataResponse) = apply {
            id = sourceCodeGetMetadataResponse.id
            createdAt = sourceCodeGetMetadataResponse.createdAt
            folder = sourceCodeGetMetadataResponse.folder
            name = sourceCodeGetMetadataResponse.name
            updatedAt = sourceCodeGetMetadataResponse.updatedAt
            archivedAt = sourceCodeGetMetadataResponse.archivedAt
            children = sourceCodeGetMetadataResponse.children.map { it.toMutableList() }
            hash = sourceCodeGetMetadataResponse.hash
            additionalProperties = sourceCodeGetMetadataResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SourceCodeGetMetadataResponse].
         *
         ...
         */
        fun build(): SourceCodeGetMetadataResponse =
            SourceCodeGetMetadataResponse(
                checkRequired("id", id),
    ...
    fun validate(): SourceCodeGetMetadataResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SourceCodeGetMetadataResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "SourceCodeGetMetadataResponse{id=$id, createdAt=$createdAt, folder=$folder, name=$name, updatedAt=$updatedAt, archivedAt=$archivedAt, children=$children, hash=$hash, additionalProperties=$additionalProperties}"
}
