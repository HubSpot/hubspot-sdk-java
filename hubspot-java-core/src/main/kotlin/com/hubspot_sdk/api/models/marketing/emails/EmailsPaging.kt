...
private constructor(
     ...
     */
    fun next(): NextPage = next.getRequired("next")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmailsPaging].
         *
    ...
    /** A builder for [EmailsPaging]. */
    class Builder internal constructor() {

        private var next: JsonField<NextPage>? = null
        private var prev: JsonField<PreviousPage> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(emailsPaging: EmailsPaging) = apply {
            next = emailsPaging.next
            prev = emailsPaging.prev
            additionalProperties = emailsPaging.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EmailsPaging].
         *
         ...
         */
        fun build(): EmailsPaging =
            EmailsPaging(checkRequired("next", next), prev, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): EmailsPaging = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "EmailsPaging{next=$next, prev=$prev, additionalProperties=$additionalProperties}"
}
