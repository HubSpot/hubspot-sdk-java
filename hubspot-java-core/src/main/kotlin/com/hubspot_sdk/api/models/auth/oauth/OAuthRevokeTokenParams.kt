...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OAuthRevokeTokenParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [OAuthRevokeTokenParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [OAuthRevokeTokenParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(oauthRevokeTokenParams: OAuthRevokeTokenParams) = apply {
            body = oauthRevokeTokenParams.body.toBuilder()
            additionalHeaders = oauthRevokeTokenParams.additionalHeaders.toBuilder()
            additionalQueryParams = oauthRevokeTokenParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [OAuthRevokeTokenParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OAuthRevokeTokenParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OAuthRevokeTokenParams &&
            body == other.body &&
    ...
    override fun toString() =
        "OAuthRevokeTokenParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
