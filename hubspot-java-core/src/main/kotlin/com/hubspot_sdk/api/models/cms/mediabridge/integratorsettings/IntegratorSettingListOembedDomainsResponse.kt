...
class IntegratorSettingListOembedDomainsResponse
...
private constructor(
    ...
    /** A builder for [IntegratorSettingListOembedDomainsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            integratorSettingListOembedDomainsResponse: IntegratorSettingListOembedDomainsResponse
        ) = apply {
            results = integratorSettingListOembedDomainsResponse.results.map { it.toMutableList() }
            totalCount = integratorSettingListOembedDomainsResponse.totalCount
            additionalProperties =
                integratorSettingListOembedDomainsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IntegratorSettingListOembedDomainsResponse].
         *
         ...
         */
        fun build(): IntegratorSettingListOembedDomainsResponse =
            IntegratorSettingListOembedDomainsResponse(
    ...
    fun validate(): IntegratorSettingListOembedDomainsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            deletedAt: JsonField<Long> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.deletedAt] with a well-typed [Long] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        private constructor(
             ...
             *
             * Unlike [discovery], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("discovery")
            @ExcludeMissing
            fun _discovery(): JsonField<Boolean> = discovery
            ...
            @JsonProperty("schemes")
            @ExcludeMissing
            fun _schemes(): JsonField<List<String>> = schemes
        ...
        override fun toString() =
            "Result{id=$id, appId=$appId, createdAt=$createdAt, deletedAt=$deletedAt, endpoints=$endpoints, portalId=$portalId, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IntegratorSettingListOembedDomainsResponse &&
    ...
    override fun toString() =
        "IntegratorSettingListOembedDomainsResponse{results=$results, totalCount=$totalCount, additionalProperties=$additionalProperties}"
}
