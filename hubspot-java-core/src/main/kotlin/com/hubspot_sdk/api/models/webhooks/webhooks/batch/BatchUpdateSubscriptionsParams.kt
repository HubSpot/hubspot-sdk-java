...
class BatchUpdateSubscriptionsParams
private constructor(
    ...
    /** A builder for [BatchUpdateSubscriptionsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchUpdateSubscriptionsParams: BatchUpdateSubscriptionsParams) = apply {
            appId = batchUpdateSubscriptionsParams.appId
            batchInputSubscriptionBatchUpdateRequest =
                batchUpdateSubscriptionsParams.batchInputSubscriptionBatchUpdateRequest
            additionalHeaders = batchUpdateSubscriptionsParams.additionalHeaders.toBuilder()
            additionalQueryParams = batchUpdateSubscriptionsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BatchUpdateSubscriptionsParams].
         *
         ...
         */
        fun build(): BatchUpdateSubscriptionsParams =
            BatchUpdateSubscriptionsParams(
                appId,
                checkRequired(
                    "batchInputSubscriptionBatchUpdateRequest",
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchUpdateSubscriptionsParams &&
            appId == other.appId &&
            batchInputSubscriptionBatchUpdateRequest ==
    ...
    override fun toString() =
        "BatchUpdateSubscriptionsParams{appId=$appId, batchInputSubscriptionBatchUpdateRequest=$batchInputSubscriptionBatchUpdateRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
