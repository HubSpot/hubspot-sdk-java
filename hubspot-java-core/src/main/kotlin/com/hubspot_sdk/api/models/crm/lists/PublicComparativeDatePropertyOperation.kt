...
private constructor(
    ...
    /**
     * Defines the operation to be applied in the comparative date property operation (IS_BEFORE,
     * IS_AFTER).
     *
     * @throws HubSpotInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
    ...
    /** A builder for [PublicComparativeDatePropertyOperation]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            comparisonPropertyName = publicComparativeDatePropertyOperation.comparisonPropertyName
            includeObjectsWithNoValueSet =
                publicComparativeDatePropertyOperation.includeObjectsWithNoValueSet
            operationType = publicComparativeDatePropertyOperation.operationType
            operator = publicComparativeDatePropertyOperation.operator
            defaultComparisonValue = publicComparativeDatePropertyOperation.defaultComparisonValue
            additionalProperties =
                publicComparativeDatePropertyOperation.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicComparativeDatePropertyOperation].
         *
         ...
         */
        fun build(): PublicComparativeDatePropertyOperation =
            PublicComparativeDatePropertyOperation(
    ...
    fun validate(): PublicComparativeDatePropertyOperation = apply {
        if (validated) {
            return@apply
        }
    ...
    class OperationType @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            @JvmField val COMPARATIVE_DATE = of("COMPARATIVE_DATE")
        ...
        fun value(): Value =
            when (this) {
                COMPARATIVE_DATE -> Value.COMPARATIVE_DATE
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                COMPARATIVE_DATE -> Known.COMPARATIVE_DATE
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicComparativeDatePropertyOperation &&
    ...
    override fun toString() =
        "PublicComparativeDatePropertyOperation{comparisonPropertyName=$comparisonPropertyName, includeObjectsWithNoValueSet=$includeObjectsWithNoValueSet, operationType=$operationType, operator=$operator, defaultComparisonValue=$defaultComparisonValue, additionalProperties=$additionalProperties}"
}
