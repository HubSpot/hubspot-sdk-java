...
/** @see PageServiceAsync.listRevisions */
class PageListRevisionsPageAsync
private constructor(
    ...
    override fun nextPage(): CompletableFuture<PageListRevisionsPageAsync> =
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PageListRevisionsPageAsync].
         *
    ...
    /** A builder for [PageListRevisionsPageAsync]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pageListRevisionsPageAsync: PageListRevisionsPageAsync) = apply {
            service = pageListRevisionsPageAsync.service
            streamHandlerExecutor = pageListRevisionsPageAsync.streamHandlerExecutor
            params = pageListRevisionsPageAsync.params
            response = pageListRevisionsPageAsync.response
        }
        ...
        /**
         * Returns an immutable instance of [PageListRevisionsPageAsync].
         *
         ...
         */
        fun build(): PageListRevisionsPageAsync =
            PageListRevisionsPageAsync(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PageListRevisionsPageAsync &&
    ...
    override fun toString() =
        "PageListRevisionsPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}
