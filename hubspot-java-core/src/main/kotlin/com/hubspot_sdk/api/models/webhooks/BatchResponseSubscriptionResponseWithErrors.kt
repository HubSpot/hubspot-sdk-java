...
private constructor(
    ...
    /** A builder for [BatchResponseSubscriptionResponseWithErrors]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            completedAt = batchResponseSubscriptionResponseWithErrors.completedAt
            results = batchResponseSubscriptionResponseWithErrors.results.map { it.toMutableList() }
            startedAt = batchResponseSubscriptionResponseWithErrors.startedAt
            status = batchResponseSubscriptionResponseWithErrors.status
            errors = batchResponseSubscriptionResponseWithErrors.errors.map { it.toMutableList() }
            links = batchResponseSubscriptionResponseWithErrors.links
            numErrors = batchResponseSubscriptionResponseWithErrors.numErrors
            requestedAt = batchResponseSubscriptionResponseWithErrors.requestedAt
        ...
        /**
         * Returns an immutable instance of [BatchResponseSubscriptionResponseWithErrors].
         *
         ...
         */
        fun build(): BatchResponseSubscriptionResponseWithErrors =
            BatchResponseSubscriptionResponseWithErrors(
    ...
    fun validate(): BatchResponseSubscriptionResponseWithErrors = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseSubscriptionResponseWithErrors &&
    ...
    override fun toString() =
        "BatchResponseSubscriptionResponseWithErrors{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
