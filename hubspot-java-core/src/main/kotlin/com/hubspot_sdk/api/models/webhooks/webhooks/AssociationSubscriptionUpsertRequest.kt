...
class AssociationSubscriptionUpsertRequest
...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun associatedObjectTypeIds(): List<String> =
        associatedObjectTypeIds.getRequired("associatedObjectTypeIds")
    ...
    /** A builder for [AssociationSubscriptionUpsertRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            associationSubscriptionUpsertRequest: AssociationSubscriptionUpsertRequest
        ) = apply {
            actions = associationSubscriptionUpsertRequest.actions.map { it.toMutableList() }
            associatedObjectTypeIds =
                associationSubscriptionUpsertRequest.associatedObjectTypeIds.map {
                    it.toMutableList()
                }
            objectIds = associationSubscriptionUpsertRequest.objectIds.map { it.toMutableList() }
            objectTypeId = associationSubscriptionUpsertRequest.objectTypeId
            portalId = associationSubscriptionUpsertRequest.portalId
            subscriptionType = associationSubscriptionUpsertRequest.subscriptionType
            additionalProperties =
                associationSubscriptionUpsertRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AssociationSubscriptionUpsertRequest].
         *
         ...
         */
        fun build(): AssociationSubscriptionUpsertRequest =
            AssociationSubscriptionUpsertRequest(
                checkRequired("actions", actions).map { it.toImmutable() },
                checkRequired("associatedObjectTypeIds", associatedObjectTypeIds).map {
                    it.toImmutable()
                },
    ...
    fun validate(): AssociationSubscriptionUpsertRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AssociationSubscriptionUpsertRequest &&
    ...
    override fun toString() =
        "AssociationSubscriptionUpsertRequest{actions=$actions, associatedObjectTypeIds=$associatedObjectTypeIds, objectIds=$objectIds, objectTypeId=$objectTypeId, portalId=$portalId, subscriptionType=$subscriptionType, additionalProperties=$additionalProperties}"
}
