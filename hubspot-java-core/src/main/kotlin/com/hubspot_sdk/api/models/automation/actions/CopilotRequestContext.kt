...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CopilotRequestContext].
         *
    ...
    /** A builder for [CopilotRequestContext]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(copilotRequestContext: CopilotRequestContext) = apply {
            source = copilotRequestContext.source
            trajectoryId = copilotRequestContext.trajectoryId
        ...
        /**
         * Returns an immutable instance of [CopilotRequestContext].
         *
         ...
         */
        fun build(): CopilotRequestContext =
    ...
    fun validate(): CopilotRequestContext = apply {
        if (validated) {
            return@apply
        }
    ...
    class Source @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val COPILOT = of("COPILOT")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CopilotRequestContext &&
            source == other.source &&
            trajectoryId == other.trajectoryId &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(source, trajectoryId, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "CopilotRequestContext{source=$source, trajectoryId=$trajectoryId, additionalProperties=$additionalProperties}"
}
