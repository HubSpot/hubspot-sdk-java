...
class IntegratorSettingGetOembedDomainResponse
...
private constructor(
    ...
    /** A builder for [IntegratorSettingGetOembedDomainResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            integratorSettingGetOembedDomainResponse: IntegratorSettingGetOembedDomainResponse
        ) = apply {
            id = integratorSettingGetOembedDomainResponse.id
            appId = integratorSettingGetOembedDomainResponse.appId
            createdAt = integratorSettingGetOembedDomainResponse.createdAt
            deletedAt = integratorSettingGetOembedDomainResponse.deletedAt
            endpoints = integratorSettingGetOembedDomainResponse.endpoints
            portalId = integratorSettingGetOembedDomainResponse.portalId
            updatedAt = integratorSettingGetOembedDomainResponse.updatedAt
            additionalProperties =
                integratorSettingGetOembedDomainResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IntegratorSettingGetOembedDomainResponse].
         *
         ...
         */
        fun build(): IntegratorSettingGetOembedDomainResponse =
            IntegratorSettingGetOembedDomainResponse(
                checkRequired("id", id),
    ...
    fun validate(): IntegratorSettingGetOembedDomainResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IntegratorSettingGetOembedDomainResponse &&
            id == other.id &&
            appId == other.appId &&
    ...
    override fun toString() =
        "IntegratorSettingGetOembedDomainResponse{id=$id, appId=$appId, createdAt=$createdAt, deletedAt=$deletedAt, endpoints=$endpoints, portalId=$portalId, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
