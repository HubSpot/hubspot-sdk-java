...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): CompanyGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [CompanyGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CompanyGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(companyGetParams: CompanyGetParams) = apply {
            companyId = companyGetParams.companyId
            archived = companyGetParams.archived
            associations = companyGetParams.associations?.toMutableList()
            idProperty = companyGetParams.idProperty
            properties = companyGetParams.properties?.toMutableList()
            propertiesWithHistory = companyGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = companyGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = companyGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CompanyGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CompanyGetParams =
            CompanyGetParams(
                companyId,
                archived,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CompanyGetParams &&
    ...
    override fun toString() =
        "CompanyGetParams{companyId=$companyId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
