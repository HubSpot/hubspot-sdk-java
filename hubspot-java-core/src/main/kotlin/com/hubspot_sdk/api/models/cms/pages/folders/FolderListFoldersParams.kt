...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): FolderListFoldersParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [FolderListFoldersParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FolderListFoldersParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(folderListFoldersParams: FolderListFoldersParams) = apply {
            after = folderListFoldersParams.after
            archived = folderListFoldersParams.archived
            createdAfter = folderListFoldersParams.createdAfter
            createdAt = folderListFoldersParams.createdAt
            createdBefore = folderListFoldersParams.createdBefore
            limit = folderListFoldersParams.limit
            property = folderListFoldersParams.property
            sort = folderListFoldersParams.sort?.toMutableList()
            updatedAfter = folderListFoldersParams.updatedAfter
            updatedAt = folderListFoldersParams.updatedAt
            updatedBefore = folderListFoldersParams.updatedBefore
            additionalHeaders = folderListFoldersParams.additionalHeaders.toBuilder()
            additionalQueryParams = folderListFoldersParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FolderListFoldersParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FolderListFoldersParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FolderListFoldersParams &&
            after == other.after &&
    ...
    override fun toString() =
        "FolderListFoldersParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
