...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DefinitionSendParams].
         *
    ...
    /** A builder for [DefinitionSendParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(definitionSendParams: DefinitionSendParams) = apply {
            behavioralEventHttpCompletionRequest =
                definitionSendParams.behavioralEventHttpCompletionRequest
            additionalHeaders = definitionSendParams.additionalHeaders.toBuilder()
            additionalQueryParams = definitionSendParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DefinitionSendParams].
         *
         ...
         */
        fun build(): DefinitionSendParams =
            DefinitionSendParams(
                checkRequired(
                    "behavioralEventHttpCompletionRequest",
                    behavioralEventHttpCompletionRequest,
                ),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DefinitionSendParams &&
    ...
    override fun toString() =
        "DefinitionSendParams{behavioralEventHttpCompletionRequest=$behavioralEventHttpCompletionRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
