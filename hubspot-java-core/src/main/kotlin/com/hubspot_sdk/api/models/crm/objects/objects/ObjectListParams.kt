...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(objectListParams: ObjectListParams) = apply {
            objectType = objectListParams.objectType
            after = objectListParams.after
            archived = objectListParams.archived
            associations = objectListParams.associations?.toMutableList()
            limit = objectListParams.limit
            properties = objectListParams.properties?.toMutableList()
            propertiesWithHistory = objectListParams.propertiesWithHistory?.toMutableList()
    ...
    override fun toString() =
        "ObjectListParams{objectType=$objectType, after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
