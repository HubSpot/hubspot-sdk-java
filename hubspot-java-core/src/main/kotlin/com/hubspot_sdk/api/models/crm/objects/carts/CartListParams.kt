...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of carts that can be
    ...
    companion object {
        ...
        @JvmStatic fun none(): CartListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [CartListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CartListParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(cartListParams: CartListParams) = apply {
            after = cartListParams.after
            archived = cartListParams.archived
            associations = cartListParams.associations?.toMutableList()
            limit = cartListParams.limit
            properties = cartListParams.properties?.toMutableList()
            propertiesWithHistory = cartListParams.propertiesWithHistory?.toMutableList()
         ...
         * of carts that can be read by a single request.
         */
        ...
        /**
         * Returns an immutable instance of [CartListParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CartListParams &&
            after == other.after &&
    ...
    override fun toString() =
        "CartListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
