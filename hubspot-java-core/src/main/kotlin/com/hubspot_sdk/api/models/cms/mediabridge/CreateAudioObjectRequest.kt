...
class CreateAudioObjectRequest
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CreateAudioObjectRequest].
         *
    ...
    /** A builder for [CreateAudioObjectRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(createAudioObjectRequest: CreateAudioObjectRequest) = apply {
            mediaType = createAudioObjectRequest.mediaType
            title = createAudioObjectRequest.title
            detailsPageLink = createAudioObjectRequest.detailsPageLink
            duration = createAudioObjectRequest.duration
            externalId = createAudioObjectRequest.externalId
            fileUrl = createAudioObjectRequest.fileUrl
            oembedUrl = createAudioObjectRequest.oembedUrl
            posterUrl = createAudioObjectRequest.posterUrl
            thumbnailUrl = createAudioObjectRequest.thumbnailUrl
            additionalProperties = createAudioObjectRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CreateAudioObjectRequest].
         *
         ...
         */
        fun build(): CreateAudioObjectRequest =
    ...
    fun validate(): CreateAudioObjectRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CreateAudioObjectRequest &&
    ...
    override fun toString() =
        "CreateAudioObjectRequest{mediaType=$mediaType, title=$title, detailsPageLink=$detailsPageLink, duration=$duration, externalId=$externalId, fileUrl=$fileUrl, oembedUrl=$oembedUrl, posterUrl=$posterUrl, thumbnailUrl=$thumbnailUrl, additionalProperties=$additionalProperties}"
}
