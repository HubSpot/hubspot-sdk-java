...
class PageListLandingPageFoldersParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PageListLandingPageFoldersParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of
         * [PageListLandingPageFoldersParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PageListLandingPageFoldersParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pageListLandingPageFoldersParams: PageListLandingPageFoldersParams) =
            apply {
                after = pageListLandingPageFoldersParams.after
                archived = pageListLandingPageFoldersParams.archived
                createdAfter = pageListLandingPageFoldersParams.createdAfter
                createdAt = pageListLandingPageFoldersParams.createdAt
                createdBefore = pageListLandingPageFoldersParams.createdBefore
                limit = pageListLandingPageFoldersParams.limit
                property = pageListLandingPageFoldersParams.property
                sort = pageListLandingPageFoldersParams.sort?.toMutableList()
                updatedAfter = pageListLandingPageFoldersParams.updatedAfter
                updatedAt = pageListLandingPageFoldersParams.updatedAt
                updatedBefore = pageListLandingPageFoldersParams.updatedBefore
                additionalHeaders = pageListLandingPageFoldersParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    pageListLandingPageFoldersParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [PageListLandingPageFoldersParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PageListLandingPageFoldersParams =
            PageListLandingPageFoldersParams(
                after,
                archived,
                createdAfter,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PageListLandingPageFoldersParams &&
            after == other.after &&
    ...
    override fun toString() =
        "PageListLandingPageFoldersParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
