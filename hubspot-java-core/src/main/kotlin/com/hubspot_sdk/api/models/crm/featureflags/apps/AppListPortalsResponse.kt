...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AppListPortalsResponse].
         *
    ...
    /** A builder for [AppListPortalsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(appListPortalsResponse: AppListPortalsResponse) = apply {
            portalFlagStates = appListPortalsResponse.portalFlagStates.map { it.toMutableList() }
            additionalProperties = appListPortalsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AppListPortalsResponse].
         *
         ...
         */
        fun build(): AppListPortalsResponse =
    ...
    fun validate(): AppListPortalsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AppListPortalsResponse &&
    ...
    override fun toString() =
        "AppListPortalsResponse{portalFlagStates=$portalFlagStates, additionalProperties=$additionalProperties}"
}
