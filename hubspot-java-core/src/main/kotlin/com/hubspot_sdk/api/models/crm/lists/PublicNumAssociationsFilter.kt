...
private constructor(
    ...
    ) : this(associationCategory, associationTypeId, coalescingRefineBy, filterType, mutableMapOf())

    /**
     * Defines the category of the association (HUBSPOT_DEFINED, USER_DEFINED, INTEGRATOR_DEFINED,
     * WORK).
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicNumAssociationsFilter].
         *
    ...
    /** A builder for [PublicNumAssociationsFilter]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicNumAssociationsFilter: PublicNumAssociationsFilter) = apply {
            associationCategory = publicNumAssociationsFilter.associationCategory
            associationTypeId = publicNumAssociationsFilter.associationTypeId
            coalescingRefineBy = publicNumAssociationsFilter.coalescingRefineBy
            filterType = publicNumAssociationsFilter.filterType
            additionalProperties = publicNumAssociationsFilter.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicNumAssociationsFilter].
         *
         ...
         */
        fun build(): PublicNumAssociationsFilter =
    ...
    fun validate(): PublicNumAssociationsFilter = apply {
        if (validated) {
            return@apply
        }
    ...
    class FilterType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val NUM_ASSOCIATIONS = of("NUM_ASSOCIATIONS")
        ...
        fun value(): Value =
            when (this) {
                NUM_ASSOCIATIONS -> Value.NUM_ASSOCIATIONS
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                NUM_ASSOCIATIONS -> Known.NUM_ASSOCIATIONS
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicNumAssociationsFilter &&
    ...
    override fun toString() =
        "PublicNumAssociationsFilter{associationCategory=$associationCategory, associationTypeId=$associationTypeId, coalescingRefineBy=$coalescingRefineBy, filterType=$filterType, additionalProperties=$additionalProperties}"
}
