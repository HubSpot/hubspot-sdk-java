...
class PortalBatchDeleteResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val portalFlagStates: JsonField<List<PortalFlagState>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        portalFlagStates: JsonField<List<PortalFlagState>> = JsonMissing.of()
     ...
     */
    fun portalFlagStates(): List<PortalFlagState> = portalFlagStates.getRequired("portalFlagStates")
    ...
    @JsonProperty("portalFlagStates")
    @ExcludeMissing
    fun _portalFlagStates(): JsonField<List<PortalFlagState>> = portalFlagStates
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PortalBatchDeleteResponse].
         *
    ...
    /** A builder for [PortalBatchDeleteResponse]. */
    class Builder internal constructor() {

        private var portalFlagStates: JsonField<MutableList<PortalFlagState>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(portalBatchDeleteResponse: PortalBatchDeleteResponse) = apply {
            portalFlagStates = portalBatchDeleteResponse.portalFlagStates.map { it.toMutableList() }
            additionalProperties = portalBatchDeleteResponse.additionalProperties.toMutableMap()
        }

        fun portalFlagStates(portalFlagStates: List<PortalFlagState>) =
         ...
         * `List<PortalFlagState>` value instead. This method is primarily for setting the field to
         * an undocumented or not yet supported value.
         */
        fun portalFlagStates(portalFlagStates: JsonField<List<PortalFlagState>>) = apply {
            this.portalFlagStates = portalFlagStates.map { it.toMutableList() }
        }

        /**
         * Adds a single [PortalFlagState] to [portalFlagStates].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addPortalFlagState(portalFlagState: PortalFlagState) = apply {
            portalFlagStates =
        ...
        /**
         * Returns an immutable instance of [PortalBatchDeleteResponse].
         *
         ...
         */
        fun build(): PortalBatchDeleteResponse =
    ...
    fun validate(): PortalBatchDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            flagName: JsonField<String> = JsonMissing.of(),
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [PortalFlagState].
             *
             * The following fields are required:
             * ```java
             * .appId()
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(portalFlagState: PortalFlagState) = apply {
                appId = portalFlagState.appId
                flagName = portalFlagState.flagName
                flagState = portalFlagState.flagState
                portalId = portalFlagState.portalId
                additionalProperties = portalFlagState.additionalProperties.toMutableMap()
            }
             ...
             *
             * You should usually call [Builder.flagName] with a well-typed [String] value instead.
            ...
            /**
             * Returns an immutable instance of [PortalFlagState].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
        ...
        fun validate(): PortalFlagState = apply {
            if (validated) {
                return@apply
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is PortalFlagState &&
                appId == other.appId &&
        ...
        override fun toString() =
            "PortalFlagState{appId=$appId, flagName=$flagName, flagState=$flagState, portalId=$portalId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PortalBatchDeleteResponse &&
    ...
    override fun toString() =
        "PortalBatchDeleteResponse{portalFlagStates=$portalFlagStates, additionalProperties=$additionalProperties}"
}
