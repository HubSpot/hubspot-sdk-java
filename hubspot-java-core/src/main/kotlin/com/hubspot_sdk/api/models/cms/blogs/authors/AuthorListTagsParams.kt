...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AuthorListTagsParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AuthorListTagsParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AuthorListTagsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(authorListTagsParams: AuthorListTagsParams) = apply {
            after = authorListTagsParams.after
            archived = authorListTagsParams.archived
            createdAfter = authorListTagsParams.createdAfter
            createdAt = authorListTagsParams.createdAt
            createdBefore = authorListTagsParams.createdBefore
            limit = authorListTagsParams.limit
            property = authorListTagsParams.property
            sort = authorListTagsParams.sort?.toMutableList()
            updatedAfter = authorListTagsParams.updatedAfter
            updatedAt = authorListTagsParams.updatedAt
            updatedBefore = authorListTagsParams.updatedBefore
            additionalHeaders = authorListTagsParams.additionalHeaders.toBuilder()
            additionalQueryParams = authorListTagsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AuthorListTagsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AuthorListTagsParams =
            AuthorListTagsParams(
                after,
                archived,
                createdAfter,
                createdAt,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AuthorListTagsParams &&
            after == other.after &&
    ...
    override fun toString() =
        "AuthorListTagsParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
