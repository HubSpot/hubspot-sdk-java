...
class SiteSearchSearchResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SiteSearchSearchResponse].
         *
    ...
    /** A builder for [SiteSearchSearchResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteSearchSearchResponse: SiteSearchSearchResponse) = apply {
            limit = siteSearchSearchResponse.limit
            offset = siteSearchSearchResponse.offset
            page = siteSearchSearchResponse.page
            results = siteSearchSearchResponse.results.map { it.toMutableList() }
            total = siteSearchSearchResponse.total
            searchTerm = siteSearchSearchResponse.searchTerm
            additionalProperties = siteSearchSearchResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SiteSearchSearchResponse].
         *
         ...
         */
        fun build(): SiteSearchSearchResponse =
    ...
    fun validate(): SiteSearchSearchResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *
         * Unlike [authorFullName], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("authorFullName")
        @ExcludeMissing
        ...
        @JsonProperty("combinedId")
        @ExcludeMissing
        fun _combinedId(): JsonField<String> = combinedId
        ...
        class Builder internal constructor() {
            ...
            /** Name of the author. */
            fun authorFullName(authorFullName: String) =
                authorFullName(JsonField.of(authorFullName))
             ...
             *
             * You should usually call [Builder.combinedId] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * The result's description. The content will be determined by the value of `length` in
             * the request.
             */
             ...
             *
             * You should usually call [Builder.publishedDate] with a well-typed [Long] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.tableId] with a well-typed [Long] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        override fun toString() =
            "Result{id=$id, domain=$domain, score=$score, type=$type, url=$url, authorFullName=$authorFullName, category=$category, combinedId=$combinedId, description=$description, featuredImageUrl=$featuredImageUrl, language=$language, publishedDate=$publishedDate, rowId=$rowId, subcategory=$subcategory, tableId=$tableId, tags=$tags, title=$title, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SiteSearchSearchResponse &&
            limit == other.limit &&
            offset == other.offset &&
            page == other.page &&
    ...
    override fun toString() =
        "SiteSearchSearchResponse{limit=$limit, offset=$offset, page=$page, results=$results, total=$total, searchTerm=$searchTerm, additionalProperties=$additionalProperties}"
}
