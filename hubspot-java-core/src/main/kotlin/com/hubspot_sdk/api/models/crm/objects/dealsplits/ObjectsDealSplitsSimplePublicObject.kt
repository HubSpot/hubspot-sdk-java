...
class ObjectsDealSplitsSimplePublicObject
...
private constructor(
    ...
    /** A builder for [ObjectsDealSplitsSimplePublicObject]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            objectsDealSplitsSimplePublicObject: ObjectsDealSplitsSimplePublicObject
        ) = apply {
            id = objectsDealSplitsSimplePublicObject.id
            createdAt = objectsDealSplitsSimplePublicObject.createdAt
            properties = objectsDealSplitsSimplePublicObject.properties
            updatedAt = objectsDealSplitsSimplePublicObject.updatedAt
            archived = objectsDealSplitsSimplePublicObject.archived
            archivedAt = objectsDealSplitsSimplePublicObject.archivedAt
            propertiesWithHistory = objectsDealSplitsSimplePublicObject.propertiesWithHistory
            additionalProperties =
                objectsDealSplitsSimplePublicObject.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ObjectsDealSplitsSimplePublicObject].
         *
         ...
         */
        fun build(): ObjectsDealSplitsSimplePublicObject =
            ObjectsDealSplitsSimplePublicObject(
                checkRequired("id", id),
    ...
    fun validate(): ObjectsDealSplitsSimplePublicObject = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ObjectsDealSplitsSimplePublicObject &&
            id == other.id &&
    ...
    override fun toString() =
        "ObjectsDealSplitsSimplePublicObject{id=$id, createdAt=$createdAt, properties=$properties, updatedAt=$updatedAt, archived=$archived, archivedAt=$archivedAt, propertiesWithHistory=$propertiesWithHistory, additionalProperties=$additionalProperties}"
}
