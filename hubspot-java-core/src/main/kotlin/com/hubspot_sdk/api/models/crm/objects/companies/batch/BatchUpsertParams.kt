...
/**
 * Create or update companies identified by a unique property value as specified by the `idProperty`
 * query parameter. `idProperty` query param refers to a property whose values are unique for the
 * object.
 */
