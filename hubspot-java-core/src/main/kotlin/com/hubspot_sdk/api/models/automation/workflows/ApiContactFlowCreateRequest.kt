...
class ApiContactFlowCreateRequest
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ApiContactFlowCreateRequest].
         *
    ...
    /** A builder for [ApiContactFlowCreateRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(apiContactFlowCreateRequest: ApiContactFlowCreateRequest) = apply {
            actions = apiContactFlowCreateRequest.actions.map { it.toMutableList() }
            blockedDates = apiContactFlowCreateRequest.blockedDates.map { it.toMutableList() }
            canEnrollFromSalesforce = apiContactFlowCreateRequest.canEnrollFromSalesforce
            customProperties = apiContactFlowCreateRequest.customProperties
            dataSources = apiContactFlowCreateRequest.dataSources.map { it.toMutableList() }
            flowType = apiContactFlowCreateRequest.flowType
            isEnabled = apiContactFlowCreateRequest.isEnabled
            objectTypeId = apiContactFlowCreateRequest.objectTypeId
            suppressionListIds =
                apiContactFlowCreateRequest.suppressionListIds.map { it.toMutableList() }
            timeWindows = apiContactFlowCreateRequest.timeWindows.map { it.toMutableList() }
            type = apiContactFlowCreateRequest.type
            description = apiContactFlowCreateRequest.description
            enrollmentCriteria = apiContactFlowCreateRequest.enrollmentCriteria
            enrollmentSchedule = apiContactFlowCreateRequest.enrollmentSchedule
            eventAnchor = apiContactFlowCreateRequest.eventAnchor
            goalFilterBranch = apiContactFlowCreateRequest.goalFilterBranch
            name = apiContactFlowCreateRequest.name
            startActionId = apiContactFlowCreateRequest.startActionId
            unEnrollmentSetting = apiContactFlowCreateRequest.unEnrollmentSetting
            uuid = apiContactFlowCreateRequest.uuid
            additionalProperties = apiContactFlowCreateRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ApiContactFlowCreateRequest].
         *
         ...
         */
        fun build(): ApiContactFlowCreateRequest =
    ...
    fun validate(): ApiContactFlowCreateRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ApiContactFlowCreateRequest &&
