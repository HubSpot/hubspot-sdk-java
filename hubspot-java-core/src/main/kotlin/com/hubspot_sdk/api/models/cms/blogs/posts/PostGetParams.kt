...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PostGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PostGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PostGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(postGetParams: PostGetParams) = apply {
            objectId = postGetParams.objectId
            archived = postGetParams.archived
            property = postGetParams.property
            additionalHeaders = postGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = postGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PostGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PostGetParams =
            PostGetParams(
                objectId,
                archived,
                property,
    ...
    override fun toString() =
        "PostGetParams{objectId=$objectId, archived=$archived, property=$property, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
