...
/**
 * Update multiple invoices in a single request using either their internal IDs or unique property
 * values. This endpoint allows for efficient batch processing of invoice updates, ensuring that
 * changes are applied consistently across multiple records.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(invoiceUpdateParams: InvoiceUpdateParams) = apply {
            batchInputSimplePublicObjectBatchInput =
                invoiceUpdateParams.batchInputSimplePublicObjectBatchInput
    ...
    override fun toString() =
        "InvoiceUpdateParams{batchInputSimplePublicObjectBatchInput=$batchInputSimplePublicObjectBatchInput, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
