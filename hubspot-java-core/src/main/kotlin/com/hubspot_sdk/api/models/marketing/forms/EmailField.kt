...
private constructor(
    ...
    private val validation: JsonField<EmailFieldValidation>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        validation: JsonField<EmailFieldValidation> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun validation(): EmailFieldValidation = validation.getRequired("validation")
    ...
    @JsonProperty("validation")
    @ExcludeMissing
    fun _validation(): JsonField<EmailFieldValidation> = validation
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmailField].
         *
    ...
    class Builder internal constructor() {
        ...
        private var validation: JsonField<EmailFieldValidation>? = null
        ...
        @JvmSynthetic
        internal fun from(emailField: EmailField) = apply {
            dependentFields = emailField.dependentFields.map { it.toMutableList() }
            fieldType = emailField.fieldType
            hidden = emailField.hidden
            label = emailField.label
            name = emailField.name
            objectTypeId = emailField.objectTypeId
            required = emailField.required
            validation = emailField.validation
            defaultValue = emailField.defaultValue
            description = emailField.description
            placeholder = emailField.placeholder
            additionalProperties = emailField.additionalProperties.toMutableMap()
        }
        ...
        /** Describes how an email address should be validated. */
        fun validation(validation: EmailFieldValidation) = validation(JsonField.of(validation))

        /**
         * Sets [Builder.validation] to an arbitrary JSON value.
         *
         * You should usually call [Builder.validation] with a well-typed [EmailFieldValidation]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun validation(validation: JsonField<EmailFieldValidation>) = apply {
        ...
        /**
         * Returns an immutable instance of [EmailField].
         *
    ...
    override fun toString() =
        "EmailField{dependentFields=$dependentFields, fieldType=$fieldType, hidden=$hidden, label=$label, name=$name, objectTypeId=$objectTypeId, required=$required, validation=$validation, defaultValue=$defaultValue, description=$description, placeholder=$placeholder, additionalProperties=$additionalProperties}"
}
