...
class AuthorGetPostsCursorParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AuthorGetPostsCursorParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [AuthorGetPostsCursorParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AuthorGetPostsCursorParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(authorGetPostsCursorParams: AuthorGetPostsCursorParams) = apply {
            after = authorGetPostsCursorParams.after
            archived = authorGetPostsCursorParams.archived
            createdAfter = authorGetPostsCursorParams.createdAfter
            createdAt = authorGetPostsCursorParams.createdAt
            createdBefore = authorGetPostsCursorParams.createdBefore
            limit = authorGetPostsCursorParams.limit
            property = authorGetPostsCursorParams.property
            sort = authorGetPostsCursorParams.sort?.toMutableList()
            updatedAfter = authorGetPostsCursorParams.updatedAfter
            updatedAt = authorGetPostsCursorParams.updatedAt
            updatedBefore = authorGetPostsCursorParams.updatedBefore
            additionalHeaders = authorGetPostsCursorParams.additionalHeaders.toBuilder()
            additionalQueryParams = authorGetPostsCursorParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AuthorGetPostsCursorParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AuthorGetPostsCursorParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AuthorGetPostsCursorParams &&
            after == other.after &&
