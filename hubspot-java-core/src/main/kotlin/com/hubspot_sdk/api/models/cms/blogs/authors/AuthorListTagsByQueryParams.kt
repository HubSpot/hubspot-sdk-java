...
class AuthorListTagsByQueryParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AuthorListTagsByQueryParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [AuthorListTagsByQueryParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AuthorListTagsByQueryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(authorListTagsByQueryParams: AuthorListTagsByQueryParams) = apply {
            after = authorListTagsByQueryParams.after
            archived = authorListTagsByQueryParams.archived
            createdAfter = authorListTagsByQueryParams.createdAfter
            createdAt = authorListTagsByQueryParams.createdAt
            createdBefore = authorListTagsByQueryParams.createdBefore
            limit = authorListTagsByQueryParams.limit
            property = authorListTagsByQueryParams.property
            sort = authorListTagsByQueryParams.sort?.toMutableList()
            updatedAfter = authorListTagsByQueryParams.updatedAfter
            updatedAt = authorListTagsByQueryParams.updatedAt
            updatedBefore = authorListTagsByQueryParams.updatedBefore
            additionalHeaders = authorListTagsByQueryParams.additionalHeaders.toBuilder()
            additionalQueryParams = authorListTagsByQueryParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AuthorListTagsByQueryParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AuthorListTagsByQueryParams =
            AuthorListTagsByQueryParams(
                after,
                archived,
                createdAfter,
                createdAt,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AuthorListTagsByQueryParams &&
            after == other.after &&
    ...
    override fun toString() =
        "AuthorListTagsByQueryParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
