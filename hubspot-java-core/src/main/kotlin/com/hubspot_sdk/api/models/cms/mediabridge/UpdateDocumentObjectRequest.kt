...
class UpdateDocumentObjectRequest
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UpdateDocumentObjectRequest].
         *
    ...
    /** A builder for [UpdateDocumentObjectRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(updateDocumentObjectRequest: UpdateDocumentObjectRequest) = apply {
            mediaType = updateDocumentObjectRequest.mediaType
            detailsPageLink = updateDocumentObjectRequest.detailsPageLink
            duration = updateDocumentObjectRequest.duration
            externalId = updateDocumentObjectRequest.externalId
            fileUrl = updateDocumentObjectRequest.fileUrl
            oembedUrl = updateDocumentObjectRequest.oembedUrl
            posterUrl = updateDocumentObjectRequest.posterUrl
            thumbnailUrl = updateDocumentObjectRequest.thumbnailUrl
            title = updateDocumentObjectRequest.title
            additionalProperties = updateDocumentObjectRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UpdateDocumentObjectRequest].
         *
         ...
         */
        fun build(): UpdateDocumentObjectRequest =
    ...
    fun validate(): UpdateDocumentObjectRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UpdateDocumentObjectRequest &&
    ...
    override fun toString() =
        "UpdateDocumentObjectRequest{mediaType=$mediaType, detailsPageLink=$detailsPageLink, duration=$duration, externalId=$externalId, fileUrl=$fileUrl, oembedUrl=$oembedUrl, posterUrl=$posterUrl, thumbnailUrl=$thumbnailUrl, title=$title, additionalProperties=$additionalProperties}"
}
