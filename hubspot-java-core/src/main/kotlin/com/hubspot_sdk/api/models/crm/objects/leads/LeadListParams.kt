...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of leads that can be
    ...
    companion object {
        ...
        @JvmStatic fun none(): LeadListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [LeadListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LeadListParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(leadListParams: LeadListParams) = apply {
            after = leadListParams.after
            archived = leadListParams.archived
            associations = leadListParams.associations?.toMutableList()
            limit = leadListParams.limit
            properties = leadListParams.properties?.toMutableList()
            propertiesWithHistory = leadListParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = leadListParams.additionalHeaders.toBuilder()
            additionalQueryParams = leadListParams.additionalQueryParams.toBuilder()
        }
         ...
         * of leads that can be read by a single request.
         */
        ...
        /**
         * Returns an immutable instance of [LeadListParams].
         *
    ...
    override fun toString() =
        "LeadListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
