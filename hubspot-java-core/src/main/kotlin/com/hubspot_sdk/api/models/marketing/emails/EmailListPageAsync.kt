...
private constructor(
    ...
    private val response: CollectionResponseWithTotalPublicEmailForwardPaging,
) : PageAsync<PublicEmail> {

    /**
     * Delegates to [CollectionResponseWithTotalPublicEmailForwardPaging], but gracefully handles
     * missing data.
     *
     * @see CollectionResponseWithTotalPublicEmailForwardPaging.results
     */
     ...
     * missing data.
     *
     * @see CollectionResponseWithTotalPublicEmailForwardPaging.paging
     */
    ...
    fun autoPager(): AutoPagerAsync<PublicEmail> = AutoPagerAsync.from(this, streamHandlerExecutor)

    /** The parameters that were used to request this page. */
    fun params(): EmailListParams = params

    /** The response that this page was parsed from. */
    fun response(): CollectionResponseWithTotalPublicEmailForwardPaging = response
    ...
    class Builder internal constructor() {
        ...
        private var response: CollectionResponseWithTotalPublicEmailForwardPaging? = null
        ...
        /** The response that this page was parsed from. */
        fun response(response: CollectionResponseWithTotalPublicEmailForwardPaging) = apply {
