...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of postal mail that
    ...
    companion object {
        ...
        @JvmStatic fun none(): PostalMailListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PostalMailListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PostalMailListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(postalMailListParams: PostalMailListParams) = apply {
            after = postalMailListParams.after
            archived = postalMailListParams.archived
            associations = postalMailListParams.associations?.toMutableList()
            limit = postalMailListParams.limit
            properties = postalMailListParams.properties?.toMutableList()
            propertiesWithHistory = postalMailListParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = postalMailListParams.additionalHeaders.toBuilder()
            additionalQueryParams = postalMailListParams.additionalQueryParams.toBuilder()
        }
         ...
         * of postal mail that can be read by a single request.
         */
        ...
        /**
         * Returns an immutable instance of [PostalMailListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PostalMailListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PostalMailListParams &&
            after == other.after &&
    ...
    override fun toString() =
        "PostalMailListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
