...
class CustomChannelCreateResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CustomChannelCreateResponse].
         *
    ...
    /** A builder for [CustomChannelCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customChannelCreateResponse: CustomChannelCreateResponse) = apply {
            id = customChannelCreateResponse.id
            capabilities = customChannelCreateResponse.capabilities
            createdAt = customChannelCreateResponse.createdAt
            name = customChannelCreateResponse.name
            channelAccountConnectionRedirectUrl =
                customChannelCreateResponse.channelAccountConnectionRedirectUrl
            channelDescription = customChannelCreateResponse.channelDescription
            channelLogoUrl = customChannelCreateResponse.channelLogoUrl
            webhookUrl = customChannelCreateResponse.webhookUrl
            additionalProperties = customChannelCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CustomChannelCreateResponse].
         *
         ...
         */
        fun build(): CustomChannelCreateResponse =
    ...
    fun validate(): CustomChannelCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomChannelCreateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "CustomChannelCreateResponse{id=$id, capabilities=$capabilities, createdAt=$createdAt, name=$name, channelAccountConnectionRedirectUrl=$channelAccountConnectionRedirectUrl, channelDescription=$channelDescription, channelLogoUrl=$channelLogoUrl, webhookUrl=$webhookUrl, additionalProperties=$additionalProperties}"
}
