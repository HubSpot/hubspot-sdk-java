 ...
 */
class PostSetLangPrimaryParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PostSetLangPrimaryParams].
         *
    ...
    /** A builder for [PostSetLangPrimaryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(postSetLangPrimaryParams: PostSetLangPrimaryParams) = apply {
            setNewLanguagePrimaryRequestVNext =
                postSetLangPrimaryParams.setNewLanguagePrimaryRequestVNext
            additionalHeaders = postSetLangPrimaryParams.additionalHeaders.toBuilder()
            additionalQueryParams = postSetLangPrimaryParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PostSetLangPrimaryParams].
         *
         ...
         */
        fun build(): PostSetLangPrimaryParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PostSetLangPrimaryParams &&
    ...
    override fun toString() =
        "PostSetLangPrimaryParams{setNewLanguagePrimaryRequestVNext=$setNewLanguagePrimaryRequestVNext, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
