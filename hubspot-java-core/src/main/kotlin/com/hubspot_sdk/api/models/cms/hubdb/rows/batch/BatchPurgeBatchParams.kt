...
/**
 * Permanently deletes rows from the draft version of the table, given a set of row IDs. Maximum of
 * 100 row IDs per call.
 */
class BatchPurgeBatchParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchPurgeBatchParams].
         *
    ...
    /** A builder for [BatchPurgeBatchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchPurgeBatchParams: BatchPurgeBatchParams) = apply {
            tableIdOrName = batchPurgeBatchParams.tableIdOrName
            batchInputString = batchPurgeBatchParams.batchInputString
            additionalHeaders = batchPurgeBatchParams.additionalHeaders.toBuilder()
            additionalQueryParams = batchPurgeBatchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BatchPurgeBatchParams].
         *
         ...
         */
        fun build(): BatchPurgeBatchParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchPurgeBatchParams &&
    ...
    override fun toString() =
        "BatchPurgeBatchParams{tableIdOrName=$tableIdOrName, batchInputString=$batchInputString, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
