...
private constructor(
    ...
    override fun toString() =
        "ContentLanguageVariation{id=$id, archivedInDashboard=$archivedInDashboard, authorName=$authorName, campaign=$campaign, created=$created, name=$name, password=$password, publicAccessRules=$publicAccessRules, publicAccessRulesEnabled=$publicAccessRulesEnabled, publishDate=$publishDate, slug=$slug, state=$state, updated=$updated, tagIds=$tagIds, additionalProperties=$additionalProperties}"
}
