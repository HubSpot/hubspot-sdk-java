...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun attendees(): Int = attendees.getRequired("attendees")

    /**
     * The number of HubSpot contacts that registered for this marketing event, but later cancelled
     * their registration.
     *
     * @throws HubSpotInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun cancellations(): Int = cancellations.getRequired("cancellations")
     ...
     * This field only had a value when the event is over.
     *
     * @throws HubSpotInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun registrants(): Int = registrants.getRequired("registrants")
    ...
    /** A builder for [MarketingEventPublicReadResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(marketingEventPublicReadResponse: MarketingEventPublicReadResponse) =
            apply {
                id = marketingEventPublicReadResponse.id
                ...
                eventDescription = marketingEventPublicReadResponse.eventDescription
                eventType = marketingEventPublicReadResponse.eventType
                eventUrl = marketingEventPublicReadResponse.eventUrl
                objectId = marketingEventPublicReadResponse.objectId
                startDateTime = marketingEventPublicReadResponse.startDateTime
                additionalProperties =
                    marketingEventPublicReadResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * The number of HubSpot contacts that registered for this marketing event, but later
        ...
        /**
         * The number of HubSpot contacts that registered for this marketing event, but did not
         * attend. This field only had a value when the event is over.
         */
        ...
        /**
         * Returns an immutable instance of [MarketingEventPublicReadResponse].
         *
         ...
         */
        fun build(): MarketingEventPublicReadResponse =
            MarketingEventPublicReadResponse(
                checkRequired("id", id),
    ...
    fun validate(): MarketingEventPublicReadResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MarketingEventPublicReadResponse &&
            id == other.id &&
