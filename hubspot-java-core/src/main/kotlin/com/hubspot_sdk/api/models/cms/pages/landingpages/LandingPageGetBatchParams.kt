...
class LandingPageGetBatchParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LandingPageGetBatchParams].
         *
    ...
    /** A builder for [LandingPageGetBatchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(landingPageGetBatchParams: LandingPageGetBatchParams) = apply {
            archived = landingPageGetBatchParams.archived
            batchInputString = landingPageGetBatchParams.batchInputString
            additionalHeaders = landingPageGetBatchParams.additionalHeaders.toBuilder()
            additionalQueryParams = landingPageGetBatchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LandingPageGetBatchParams].
         *
         ...
         */
        fun build(): LandingPageGetBatchParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LandingPageGetBatchParams &&
    ...
    override fun toString() =
        "LandingPageGetBatchParams{archived=$archived, batchInputString=$batchInputString, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
