...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PortalDeleteResponse].
         *
    ...
    /** A builder for [PortalDeleteResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portalDeleteResponse: PortalDeleteResponse) = apply {
            appId = portalDeleteResponse.appId
            flagName = portalDeleteResponse.flagName
            flagState = portalDeleteResponse.flagState
            portalId = portalDeleteResponse.portalId
            additionalProperties = portalDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PortalDeleteResponse].
         *
         ...
         */
        fun build(): PortalDeleteResponse =
    ...
    fun validate(): PortalDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PortalDeleteResponse &&
            appId == other.appId &&
    ...
    override fun toString() =
        "PortalDeleteResponse{appId=$appId, flagName=$flagName, flagState=$flagState, portalId=$portalId, additionalProperties=$additionalProperties}"
}
