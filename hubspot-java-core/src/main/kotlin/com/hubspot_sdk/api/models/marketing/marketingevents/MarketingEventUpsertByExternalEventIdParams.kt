 ...
 */
class MarketingEventUpsertByExternalEventIdParams
private constructor(
    ...
    /** A builder for [MarketingEventUpsertByExternalEventIdParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            marketingEventUpsertByExternalEventIdParams: MarketingEventUpsertByExternalEventIdParams
        ) = apply {
            pathExternalEventId = marketingEventUpsertByExternalEventIdParams.pathExternalEventId
            marketingEventCreateRequestParams =
                marketingEventUpsertByExternalEventIdParams.marketingEventCreateRequestParams
            additionalHeaders =
                marketingEventUpsertByExternalEventIdParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                marketingEventUpsertByExternalEventIdParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [MarketingEventUpsertByExternalEventIdParams].
         *
         ...
         */
        fun build(): MarketingEventUpsertByExternalEventIdParams =
            MarketingEventUpsertByExternalEventIdParams(
                pathExternalEventId,
                checkRequired(
                    "marketingEventCreateRequestParams",
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MarketingEventUpsertByExternalEventIdParams &&
    ...
    override fun toString() =
        "MarketingEventUpsertByExternalEventIdParams{pathExternalEventId=$pathExternalEventId, marketingEventCreateRequestParams=$marketingEventCreateRequestParams, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
