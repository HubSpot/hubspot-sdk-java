...
private constructor(
    ...
    private val assignedFrom: JsonField<String>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        assignedFrom: JsonField<String> = JsonMissing.of(),
     ...
     */
    fun assignedFrom(): Optional<String> = assignedFrom.getOptional("assignedFrom")
    ...
    /**
     * Returns the raw JSON value of [assignedFrom].
     *
     * Unlike [assignedFrom], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("assignedFrom")
    @ExcludeMissing
    fun _assignedFrom(): JsonField<String> = assignedFrom
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicAssignmentMessage].
         *
    ...
    /** A builder for [PublicAssignmentMessage]. */
    class Builder internal constructor() {
        ...
        private var assignedFrom: JsonField<String> = JsonMissing.of()
        private var assignedTo: JsonField<String> = JsonMissing.of()
        private var updatedAt: JsonField<OffsetDateTime> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(publicAssignmentMessage: PublicAssignmentMessage) = apply {
            id = publicAssignmentMessage.id
            archived = publicAssignmentMessage.archived
            client = publicAssignmentMessage.client
            conversationsThreadId = publicAssignmentMessage.conversationsThreadId
            createdAt = publicAssignmentMessage.createdAt
            createdBy = publicAssignmentMessage.createdBy
            recipients = publicAssignmentMessage.recipients.map { it.toMutableList() }
            senders = publicAssignmentMessage.senders.map { it.toMutableList() }
            type = publicAssignmentMessage.type
            assignedFrom = publicAssignmentMessage.assignedFrom
            assignedTo = publicAssignmentMessage.assignedTo
            updatedAt = publicAssignmentMessage.updatedAt
            additionalProperties = publicAssignmentMessage.additionalProperties.toMutableMap()
        }
        ...
        fun assignedFrom(assignedFrom: String) = assignedFrom(JsonField.of(assignedFrom))

        /**
         * Sets [Builder.assignedFrom] to an arbitrary JSON value.
         *
         * You should usually call [Builder.assignedFrom] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun assignedFrom(assignedFrom: JsonField<String>) = apply {
        ...
        /**
         * Returns an immutable instance of [PublicAssignmentMessage].
         *
         ...
         */
        fun build(): PublicAssignmentMessage =
    ...
    fun validate(): PublicAssignmentMessage = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (if (assignedFrom.asKnown().isPresent) 1 else 0) +
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val ASSIGNMENT = of("ASSIGNMENT")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicAssignmentMessage &&
            id == other.id &&
            ...
            type == other.type &&
            assignedFrom == other.assignedFrom &&
    ...
    override fun toString() =
        "PublicAssignmentMessage{id=$id, archived=$archived, client=$client, conversationsThreadId=$conversationsThreadId, createdAt=$createdAt, createdBy=$createdBy, recipients=$recipients, senders=$senders, type=$type, assignedFrom=$assignedFrom, assignedTo=$assignedTo, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
