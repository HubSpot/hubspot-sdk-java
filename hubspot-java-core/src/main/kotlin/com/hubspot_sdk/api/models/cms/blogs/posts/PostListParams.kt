...
/**
 * Retrieve all blog posts, with paging and filtering options. This method would be useful for an
 * integration that ingests posts and suggests edits.
 */
...
private constructor(
    ...
    /**
     * Specifies which fields to use for sorting results. Valid fields are `createdAt` (default),
     * `name`, `updatedAt`, `createdBy`, `updatedBy`.
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(postListParams: PostListParams) = apply {
            after = postListParams.after
            archived = postListParams.archived
            createdAfter = postListParams.createdAfter
            createdAt = postListParams.createdAt
            createdBefore = postListParams.createdBefore
            limit = postListParams.limit
            property = postListParams.property
            sort = postListParams.sort?.toMutableList()
            updatedAfter = postListParams.updatedAfter
            updatedAt = postListParams.updatedAt
            updatedBefore = postListParams.updatedBefore
    ...
    override fun toString() =
        "PostListParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
