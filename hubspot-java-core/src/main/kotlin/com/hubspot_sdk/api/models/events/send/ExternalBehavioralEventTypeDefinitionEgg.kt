...
private constructor(
    ...
    /**
     * Internal event name, which must be used when referencing the event from the API. If a name is
     * not supplied, one will be generated based on the label. The name does not include the
     * `pe<PORTAL_ID>_` prefix used when sending event completions.
     *
     * @throws HubspotInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
     ...
     * `TICKET`. If no value is supplied, will default to `CONTACT`.
     *
     * @throws HubspotInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    ...
    class Builder internal constructor() {
        ...
        /**
         * Internal event name, which must be used when referencing the event from the API. If a
         * name is not supplied, one will be generated based on the label. The name does not include
         * the `pe<PORTAL_ID>_` prefix used when sending event completions.
         */
