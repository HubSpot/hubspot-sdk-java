...
class CalculatedPropertyLimitResponse
...
private constructor(
    ...
    /** A builder for [CalculatedPropertyLimitResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(calculatedPropertyLimitResponse: CalculatedPropertyLimitResponse) =
            apply {
                byObjectType =
                    calculatedPropertyLimitResponse.byObjectType.map { it.toMutableList() }
                overallLimit = calculatedPropertyLimitResponse.overallLimit
                overallPercentage = calculatedPropertyLimitResponse.overallPercentage
                overallUsage = calculatedPropertyLimitResponse.overallUsage
                additionalProperties =
                    calculatedPropertyLimitResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CalculatedPropertyLimitResponse].
         *
         ...
         */
        fun build(): CalculatedPropertyLimitResponse =
            CalculatedPropertyLimitResponse(
    ...
    fun validate(): CalculatedPropertyLimitResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CalculatedPropertyLimitResponse &&
    ...
    override fun toString() =
        "CalculatedPropertyLimitResponse{byObjectType=$byObjectType, overallLimit=$overallLimit, overallPercentage=$overallPercentage, overallUsage=$overallUsage, additionalProperties=$additionalProperties}"
}
