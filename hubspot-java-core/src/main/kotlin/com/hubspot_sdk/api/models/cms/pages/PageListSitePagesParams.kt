...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PageListSitePagesParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PageListSitePagesParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PageListSitePagesParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pageListSitePagesParams: PageListSitePagesParams) = apply {
            after = pageListSitePagesParams.after
            archived = pageListSitePagesParams.archived
            createdAfter = pageListSitePagesParams.createdAfter
            createdAt = pageListSitePagesParams.createdAt
            createdBefore = pageListSitePagesParams.createdBefore
            limit = pageListSitePagesParams.limit
            property = pageListSitePagesParams.property
            sort = pageListSitePagesParams.sort?.toMutableList()
            updatedAfter = pageListSitePagesParams.updatedAfter
            updatedAt = pageListSitePagesParams.updatedAt
            updatedBefore = pageListSitePagesParams.updatedBefore
            additionalHeaders = pageListSitePagesParams.additionalHeaders.toBuilder()
            additionalQueryParams = pageListSitePagesParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PageListSitePagesParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PageListSitePagesParams =
            PageListSitePagesParams(
                after,
                archived,
                createdAfter,
                createdAt,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PageListSitePagesParams &&
            after == other.after &&
    ...
    override fun toString() =
        "PageListSitePagesParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
