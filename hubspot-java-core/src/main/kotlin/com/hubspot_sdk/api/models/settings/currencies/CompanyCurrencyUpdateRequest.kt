...
class CompanyCurrencyUpdateRequest
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CompanyCurrencyUpdateRequest].
         *
    ...
    /** A builder for [CompanyCurrencyUpdateRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(companyCurrencyUpdateRequest: CompanyCurrencyUpdateRequest) = apply {
            currencyCode = companyCurrencyUpdateRequest.currencyCode
        ...
        /**
         * Returns an immutable instance of [CompanyCurrencyUpdateRequest].
         *
         ...
         */
        fun build(): CompanyCurrencyUpdateRequest =
    ...
    fun validate(): CompanyCurrencyUpdateRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CompanyCurrencyUpdateRequest &&
            currencyCode == other.currencyCode &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(currencyCode, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "CompanyCurrencyUpdateRequest{currencyCode=$currencyCode, additionalProperties=$additionalProperties}"
}
