...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of goal targets that
    ...
    companion object {
        ...
        @JvmStatic fun none(): GoalTargetListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [GoalTargetListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [GoalTargetListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(goalTargetListParams: GoalTargetListParams) = apply {
            after = goalTargetListParams.after
            archived = goalTargetListParams.archived
            associations = goalTargetListParams.associations?.toMutableList()
            limit = goalTargetListParams.limit
            properties = goalTargetListParams.properties?.toMutableList()
            propertiesWithHistory = goalTargetListParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = goalTargetListParams.additionalHeaders.toBuilder()
            additionalQueryParams = goalTargetListParams.additionalQueryParams.toBuilder()
        }
         ...
         * of goal targets that can be read by a single request.
         */
        ...
        /**
         * Returns an immutable instance of [GoalTargetListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): GoalTargetListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GoalTargetListParams &&
            after == other.after &&
    ...
    override fun toString() =
        "GoalTargetListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
