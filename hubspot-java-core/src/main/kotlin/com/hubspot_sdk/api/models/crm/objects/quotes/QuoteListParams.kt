...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of quotes that can be
    ...
    class Builder internal constructor() {
        ...
        internal fun from(quoteListParams: QuoteListParams) = apply {
            after = quoteListParams.after
            archived = quoteListParams.archived
            associations = quoteListParams.associations?.toMutableList()
            limit = quoteListParams.limit
            properties = quoteListParams.properties?.toMutableList()
            propertiesWithHistory = quoteListParams.propertiesWithHistory?.toMutableList()
         ...
         * of quotes that can be read by a single request.
         */
    ...
    override fun toString() =
        "QuoteListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
