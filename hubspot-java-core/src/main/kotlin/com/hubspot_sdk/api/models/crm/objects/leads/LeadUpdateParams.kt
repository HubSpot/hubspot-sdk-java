...
/**
 * Perform a partial update of an Object identified by `{leadsId}`or optionally a unique property
 * value as specified by the `idProperty` query param. `{leadsId}` refers to the internal object ID
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LeadUpdateParams].
         *
    ...
    /** A builder for [LeadUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(leadUpdateParams: LeadUpdateParams) = apply {
            leadsId = leadUpdateParams.leadsId
            idProperty = leadUpdateParams.idProperty
            simplePublicObjectInput = leadUpdateParams.simplePublicObjectInput
            additionalHeaders = leadUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = leadUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LeadUpdateParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LeadUpdateParams &&
    ...
    override fun toString() =
        "LeadUpdateParams{leadsId=$leadsId, idProperty=$idProperty, simplePublicObjectInput=$simplePublicObjectInput, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
