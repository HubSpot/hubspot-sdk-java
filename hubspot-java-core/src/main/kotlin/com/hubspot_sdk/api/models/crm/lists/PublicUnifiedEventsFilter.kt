...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun eventTypeId(): Optional<String> = eventTypeId.getOptional("eventTypeId")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicUnifiedEventsFilter].
         *
    ...
    /** A builder for [PublicUnifiedEventsFilter]. */
    class Builder internal constructor() {
        ...
        private var eventTypeId: JsonField<String> = JsonMissing.of()
        private var pruningRefineBy: JsonField<PruningRefineBy> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(publicUnifiedEventsFilter: PublicUnifiedEventsFilter) = apply {
            filterLines = publicUnifiedEventsFilter.filterLines.map { it.toMutableList() }
            filterType = publicUnifiedEventsFilter.filterType
            coalescingRefineBy = publicUnifiedEventsFilter.coalescingRefineBy
            eventTypeId = publicUnifiedEventsFilter.eventTypeId
            pruningRefineBy = publicUnifiedEventsFilter.pruningRefineBy
            additionalProperties = publicUnifiedEventsFilter.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicUnifiedEventsFilter].
         *
         ...
         */
        fun build(): PublicUnifiedEventsFilter =
    ...
    fun validate(): PublicUnifiedEventsFilter = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicUnifiedEventsFilter &&
    ...
    override fun toString() =
        "PublicUnifiedEventsFilter{filterLines=$filterLines, filterType=$filterType, coalescingRefineBy=$coalescingRefineBy, eventTypeId=$eventTypeId, pruningRefineBy=$pruningRefineBy, additionalProperties=$additionalProperties}"
}
