...
private constructor(
    ...
    private val results: JsonField<List<PublicAssociationMultiWithLabel>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<PublicAssociationMultiWithLabel>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<PublicAssociationMultiWithLabel> = results.getRequired("results")
    ...
    /**
     * The status of the batch processing request: "PENDING", "PROCESSING", "CANCELED", or
     * "COMPLETE".
     *
     * @throws HubspotInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<PublicAssociationMultiWithLabel>> = results
    ...
    /** A builder for [BatchResponsePublicAssociationMultiWithLabel]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<PublicAssociationMultiWithLabel>>? = null
        ...
        internal fun from(
            ...
            completedAt = batchResponsePublicAssociationMultiWithLabel.completedAt
            results =
                batchResponsePublicAssociationMultiWithLabel.results.map { it.toMutableList() }
            startedAt = batchResponsePublicAssociationMultiWithLabel.startedAt
            status = batchResponsePublicAssociationMultiWithLabel.status
            errors = batchResponsePublicAssociationMultiWithLabel.errors.map { it.toMutableList() }
            links = batchResponsePublicAssociationMultiWithLabel.links
            numErrors = batchResponsePublicAssociationMultiWithLabel.numErrors
            requestedAt = batchResponsePublicAssociationMultiWithLabel.requestedAt
            additionalProperties =
                batchResponsePublicAssociationMultiWithLabel.additionalProperties.toMutableMap()
        }
        ...
        fun results(results: List<PublicAssociationMultiWithLabel>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed
         * `List<PublicAssociationMultiWithLabel>` value instead. This method is primarily for
         * setting the field to an undocumented or not yet supported value.
         */
        fun results(results: JsonField<List<PublicAssociationMultiWithLabel>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [PublicAssociationMultiWithLabel] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: PublicAssociationMultiWithLabel) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [BatchResponsePublicAssociationMultiWithLabel].
         *
         ...
         */
        fun build(): BatchResponsePublicAssociationMultiWithLabel =
            BatchResponsePublicAssociationMultiWithLabel(
    ...
    fun validate(): BatchResponsePublicAssociationMultiWithLabel = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponsePublicAssociationMultiWithLabel &&
    ...
    override fun toString() =
        "BatchResponsePublicAssociationMultiWithLabel{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
