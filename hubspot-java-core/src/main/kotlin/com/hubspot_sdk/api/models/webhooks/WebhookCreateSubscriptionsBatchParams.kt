...
class WebhookCreateSubscriptionsBatchParams
private constructor(
    ...
    companion object {
         ...
         * [WebhookCreateSubscriptionsBatchParams].
         *
    ...
    /** A builder for [WebhookCreateSubscriptionsBatchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            webhookCreateSubscriptionsBatchParams: WebhookCreateSubscriptionsBatchParams
        ) = apply {
            appId = webhookCreateSubscriptionsBatchParams.appId
            batchInputSubscriptionBatchUpdateRequest =
                webhookCreateSubscriptionsBatchParams.batchInputSubscriptionBatchUpdateRequest
            additionalHeaders = webhookCreateSubscriptionsBatchParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                webhookCreateSubscriptionsBatchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [WebhookCreateSubscriptionsBatchParams].
         *
         ...
         */
        fun build(): WebhookCreateSubscriptionsBatchParams =
            WebhookCreateSubscriptionsBatchParams(
                appId,
                checkRequired(
                    "batchInputSubscriptionBatchUpdateRequest",
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebhookCreateSubscriptionsBatchParams &&
            appId == other.appId &&
            batchInputSubscriptionBatchUpdateRequest ==
    ...
    override fun toString() =
        "WebhookCreateSubscriptionsBatchParams{appId=$appId, batchInputSubscriptionBatchUpdateRequest=$batchInputSubscriptionBatchUpdateRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
