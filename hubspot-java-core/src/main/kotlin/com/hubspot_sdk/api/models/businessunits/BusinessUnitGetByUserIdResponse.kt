...
class BusinessUnitGetByUserIdResponse
...
private constructor(
    ...
    /** A builder for [BusinessUnitGetByUserIdResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(businessUnitGetByUserIdResponse: BusinessUnitGetByUserIdResponse) =
            apply {
                results = businessUnitGetByUserIdResponse.results.map { it.toMutableList() }
                additionalProperties =
                    businessUnitGetByUserIdResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BusinessUnitGetByUserIdResponse].
         *
         ...
         */
        fun build(): BusinessUnitGetByUserIdResponse =
            BusinessUnitGetByUserIdResponse(
    ...
    fun validate(): BusinessUnitGetByUserIdResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BusinessUnitGetByUserIdResponse &&
    ...
    override fun toString() =
        "BusinessUnitGetByUserIdResponse{results=$results, additionalProperties=$additionalProperties}"
}
