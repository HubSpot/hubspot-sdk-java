...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AppUpdateResponse].
         *
    ...
    /** A builder for [AppUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(appUpdateResponse: AppUpdateResponse) = apply {
            appId = appUpdateResponse.appId
            defaultState = appUpdateResponse.defaultState
            flagName = appUpdateResponse.flagName
            overrideState = appUpdateResponse.overrideState
            additionalProperties = appUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AppUpdateResponse].
         *
    ...
    fun validate(): AppUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AppUpdateResponse &&
            appId == other.appId &&
    ...
    override fun toString() =
        "AppUpdateResponse{appId=$appId, defaultState=$defaultState, flagName=$flagName, overrideState=$overrideState, additionalProperties=$additionalProperties}"
}
