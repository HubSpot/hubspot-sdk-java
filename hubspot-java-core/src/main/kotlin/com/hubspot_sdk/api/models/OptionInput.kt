...
private constructor(
    ...
    ) : this(displayOrder, hidden, label, value, description, mutableMapOf())
    ...
    private val hashCode: Int by lazy {
        Objects.hash(displayOrder, hidden, label, value, description, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "OptionInput{displayOrder=$displayOrder, hidden=$hidden, label=$label, value=$value, description=$description, additionalProperties=$additionalProperties}"
}
