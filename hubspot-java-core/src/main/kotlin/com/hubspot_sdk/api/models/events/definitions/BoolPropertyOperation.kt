...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BoolPropertyOperation].
         *
    ...
    /** A builder for [BoolPropertyOperation]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(boolPropertyOperation: BoolPropertyOperation) = apply {
            includeObjectsWithNoValueSet = boolPropertyOperation.includeObjectsWithNoValueSet
            operationType = boolPropertyOperation.operationType
            operator = boolPropertyOperation.operator
            operatorName = boolPropertyOperation.operatorName
            propertyType = boolPropertyOperation.propertyType
            value = boolPropertyOperation.value
            defaultValue = boolPropertyOperation.defaultValue
            renderSpec = boolPropertyOperation.renderSpec
            additionalProperties = boolPropertyOperation.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BoolPropertyOperation].
         *
         ...
         */
        fun build(): BoolPropertyOperation =
    ...
    fun validate(): BoolPropertyOperation = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BoolPropertyOperation &&
    ...
    override fun toString() =
        "BoolPropertyOperation{includeObjectsWithNoValueSet=$includeObjectsWithNoValueSet, operationType=$operationType, operator=$operator, operatorName=$operatorName, propertyType=$propertyType, value=$value, defaultValue=$defaultValue, renderSpec=$renderSpec, additionalProperties=$additionalProperties}"
}
