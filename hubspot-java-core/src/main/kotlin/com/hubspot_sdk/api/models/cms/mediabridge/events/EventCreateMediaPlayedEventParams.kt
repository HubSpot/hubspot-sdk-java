...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun iframeUrl(): Optional<String> = body.iframeUrl()
     ...
     */
    fun _iframeUrl(): JsonField<String> = body._iframeUrl()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(eventCreateMediaPlayedEventParams: EventCreateMediaPlayedEventParams) =
            apply {
                body = eventCreateMediaPlayedEventParams.body.toBuilder()
        ...
        fun iframeUrl(iframeUrl: String) = apply { body.iframeUrl(iframeUrl) }
         ...
         * value.
         */
        fun iframeUrl(iframeUrl: JsonField<String>) = apply { body.iframeUrl(iframeUrl) }
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            iframeUrl: JsonField<String> = JsonMissing.of(),
        ...
        override fun toString() =
            "Body{mediaType=$mediaType, occurredTimestamp=$occurredTimestamp, sessionId=$sessionId, state=$state, _hsenc=$_hsenc, contactId=$contactId, contactUtk=$contactUtk, externalId=$externalId, iframeUrl=$iframeUrl, mediaBridgeId=$mediaBridgeId, mediaName=$mediaName, mediaUrl=$mediaUrl, pageId=$pageId, pageName=$pageName, pageUrl=$pageUrl, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "EventCreateMediaPlayedEventParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
