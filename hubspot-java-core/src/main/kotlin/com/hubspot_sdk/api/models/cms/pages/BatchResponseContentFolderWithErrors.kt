...
private constructor(
    ...
    private val results: JsonField<List<ContentFolder>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<ContentFolder>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<ContentFolder> = results.getRequired("results")
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<ContentFolder>> = results
    ...
    /** A builder for [BatchResponseContentFolderWithErrors]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<ContentFolder>>? = null
        ...
        internal fun from(
            ...
            completedAt = batchResponseContentFolderWithErrors.completedAt
            results = batchResponseContentFolderWithErrors.results.map { it.toMutableList() }
            startedAt = batchResponseContentFolderWithErrors.startedAt
            status = batchResponseContentFolderWithErrors.status
            errors = batchResponseContentFolderWithErrors.errors.map { it.toMutableList() }
            links = batchResponseContentFolderWithErrors.links
            numErrors = batchResponseContentFolderWithErrors.numErrors
            requestedAt = batchResponseContentFolderWithErrors.requestedAt
            additionalProperties =
                batchResponseContentFolderWithErrors.additionalProperties.toMutableMap()
        }
        ...
        /** Results of batch operation. */
        fun results(results: List<ContentFolder>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed `List<ContentFolder>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun results(results: JsonField<List<ContentFolder>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [ContentFolder] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: ContentFolder) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [BatchResponseContentFolderWithErrors].
         *
         ...
         */
        fun build(): BatchResponseContentFolderWithErrors =
            BatchResponseContentFolderWithErrors(
    ...
    fun validate(): BatchResponseContentFolderWithErrors = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseContentFolderWithErrors &&
    ...
    override fun toString() =
        "BatchResponseContentFolderWithErrors{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
