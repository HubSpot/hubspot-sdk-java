...
class UrlRedirectUpdateResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UrlRedirectUpdateResponse].
         *
    ...
    /** A builder for [UrlRedirectUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(urlRedirectUpdateResponse: UrlRedirectUpdateResponse) = apply {
            id = urlRedirectUpdateResponse.id
            destination = urlRedirectUpdateResponse.destination
            isMatchFullUrl = urlRedirectUpdateResponse.isMatchFullUrl
            isMatchQueryString = urlRedirectUpdateResponse.isMatchQueryString
            isOnlyAfterNotFound = urlRedirectUpdateResponse.isOnlyAfterNotFound
            isPattern = urlRedirectUpdateResponse.isPattern
            isProtocolAgnostic = urlRedirectUpdateResponse.isProtocolAgnostic
            isTrailingSlashOptional = urlRedirectUpdateResponse.isTrailingSlashOptional
            precedence = urlRedirectUpdateResponse.precedence
            redirectStyle = urlRedirectUpdateResponse.redirectStyle
            routePrefix = urlRedirectUpdateResponse.routePrefix
            created = urlRedirectUpdateResponse.created
            updated = urlRedirectUpdateResponse.updated
            additionalProperties = urlRedirectUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UrlRedirectUpdateResponse].
         *
         ...
         */
        fun build(): UrlRedirectUpdateResponse =
    ...
    fun validate(): UrlRedirectUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UrlRedirectUpdateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "UrlRedirectUpdateResponse{id=$id, destination=$destination, isMatchFullUrl=$isMatchFullUrl, isMatchQueryString=$isMatchQueryString, isOnlyAfterNotFound=$isOnlyAfterNotFound, isPattern=$isPattern, isProtocolAgnostic=$isProtocolAgnostic, isTrailingSlashOptional=$isTrailingSlashOptional, precedence=$precedence, redirectStyle=$redirectStyle, routePrefix=$routePrefix, created=$created, updated=$updated, additionalProperties=$additionalProperties}"
}
