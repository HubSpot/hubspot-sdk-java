...
class AppWebhookBatchUpdateSubscriptionsParams
private constructor(
    ...
    companion object {
         ...
         * [AppWebhookBatchUpdateSubscriptionsParams].
         *
    ...
    /** A builder for [AppWebhookBatchUpdateSubscriptionsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            appWebhookBatchUpdateSubscriptionsParams: AppWebhookBatchUpdateSubscriptionsParams
        ) = apply {
            appId = appWebhookBatchUpdateSubscriptionsParams.appId
            batchInputSubscriptionBatchUpdateRequest =
                appWebhookBatchUpdateSubscriptionsParams.batchInputSubscriptionBatchUpdateRequest
            additionalHeaders =
                appWebhookBatchUpdateSubscriptionsParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                appWebhookBatchUpdateSubscriptionsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AppWebhookBatchUpdateSubscriptionsParams].
         *
         ...
         */
        fun build(): AppWebhookBatchUpdateSubscriptionsParams =
            AppWebhookBatchUpdateSubscriptionsParams(
                appId,
                checkRequired(
                    "batchInputSubscriptionBatchUpdateRequest",
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AppWebhookBatchUpdateSubscriptionsParams &&
            appId == other.appId &&
            batchInputSubscriptionBatchUpdateRequest ==
    ...
    override fun toString() =
        "AppWebhookBatchUpdateSubscriptionsParams{appId=$appId, batchInputSubscriptionBatchUpdateRequest=$batchInputSubscriptionBatchUpdateRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
