...
class SourceCodeCreateResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SourceCodeCreateResponse].
         *
    ...
    /** A builder for [SourceCodeCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sourceCodeCreateResponse: SourceCodeCreateResponse) = apply {
            id = sourceCodeCreateResponse.id
            createdAt = sourceCodeCreateResponse.createdAt
            folder = sourceCodeCreateResponse.folder
            name = sourceCodeCreateResponse.name
            updatedAt = sourceCodeCreateResponse.updatedAt
            archivedAt = sourceCodeCreateResponse.archivedAt
            children = sourceCodeCreateResponse.children.map { it.toMutableList() }
            hash = sourceCodeCreateResponse.hash
            additionalProperties = sourceCodeCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SourceCodeCreateResponse].
         *
         ...
         */
        fun build(): SourceCodeCreateResponse =
    ...
    fun validate(): SourceCodeCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SourceCodeCreateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "SourceCodeCreateResponse{id=$id, createdAt=$createdAt, folder=$folder, name=$name, updatedAt=$updatedAt, archivedAt=$archivedAt, children=$children, hash=$hash, additionalProperties=$additionalProperties}"
}
