...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): QuoteGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [QuoteGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [QuoteGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(quoteGetParams: QuoteGetParams) = apply {
            quoteId = quoteGetParams.quoteId
            archived = quoteGetParams.archived
            associations = quoteGetParams.associations?.toMutableList()
            idProperty = quoteGetParams.idProperty
            properties = quoteGetParams.properties?.toMutableList()
            propertiesWithHistory = quoteGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = quoteGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = quoteGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [QuoteGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): QuoteGetParams =
            QuoteGetParams(
                quoteId,
                archived,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is QuoteGetParams &&
    ...
    override fun toString() =
        "QuoteGetParams{quoteId=$quoteId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
