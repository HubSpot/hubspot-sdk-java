...
/**
 * Read an Object identified by `{postalMailId}`. `{postalMailId}` refers to the internal object ID
...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PostalMailGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PostalMailGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PostalMailGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(postalMailGetParams: PostalMailGetParams) = apply {
            postalMailId = postalMailGetParams.postalMailId
            archived = postalMailGetParams.archived
            associations = postalMailGetParams.associations?.toMutableList()
            idProperty = postalMailGetParams.idProperty
            properties = postalMailGetParams.properties?.toMutableList()
            propertiesWithHistory = postalMailGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = postalMailGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = postalMailGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PostalMailGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PostalMailGetParams =
            PostalMailGetParams(
                postalMailId,
                archived,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PostalMailGetParams &&
    ...
    override fun toString() =
        "PostalMailGetParams{postalMailId=$postalMailId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
