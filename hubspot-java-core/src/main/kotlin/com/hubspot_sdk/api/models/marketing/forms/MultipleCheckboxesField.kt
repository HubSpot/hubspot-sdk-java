...
/**
 * A form field consisting of a set of checkboxes allowing multiple choices to be selected at one
 * time.
 */
...
private constructor(
    ...
    /**
     * The values selected by default. Those values will be submitted unless the customer modifies
     * them.
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MultipleCheckboxesField].
         *
    ...
    /** A builder for [MultipleCheckboxesField]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(multipleCheckboxesField: MultipleCheckboxesField) = apply {
            defaultValues = multipleCheckboxesField.defaultValues.map { it.toMutableList() }
            dependentFields = multipleCheckboxesField.dependentFields.map { it.toMutableList() }
            fieldType = multipleCheckboxesField.fieldType
            hidden = multipleCheckboxesField.hidden
            label = multipleCheckboxesField.label
            name = multipleCheckboxesField.name
            objectTypeId = multipleCheckboxesField.objectTypeId
            options = multipleCheckboxesField.options.map { it.toMutableList() }
            required = multipleCheckboxesField.required
            description = multipleCheckboxesField.description
            additionalProperties = multipleCheckboxesField.additionalProperties.toMutableMap()
        }

        /**
         * The values selected by default. Those values will be submitted unless the customer
         * modifies them.
         */
        ...
        /**
         * Returns an immutable instance of [MultipleCheckboxesField].
         *
         ...
         */
        fun build(): MultipleCheckboxesField =
    ...
    fun validate(): MultipleCheckboxesField = apply {
        if (validated) {
            return@apply
        }
    ...
    class FieldType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val MULTIPLE_CHECKBOXES = of("multiple_checkboxes")
        ...
        fun value(): Value =
            when (this) {
                MULTIPLE_CHECKBOXES -> Value.MULTIPLE_CHECKBOXES
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                MULTIPLE_CHECKBOXES -> Known.MULTIPLE_CHECKBOXES
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MultipleCheckboxesField &&
    ...
    override fun toString() =
        "MultipleCheckboxesField{defaultValues=$defaultValues, dependentFields=$dependentFields, fieldType=$fieldType, hidden=$hidden, label=$label, name=$name, objectTypeId=$objectTypeId, options=$options, required=$required, description=$description, additionalProperties=$additionalProperties}"
}
