...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(apiError: ApiError) = apply {
            ...
            errors = apiError.errors.map { it.toMutableList() }
            links = apiError.links
            subCategory = apiError.subCategory
    ...
    override fun toString() =
        "ApiError{category=$category, correlationId=$correlationId, message=$message, context=$context, errors=$errors, links=$links, subCategory=$subCategory, additionalProperties=$additionalProperties}"
}
