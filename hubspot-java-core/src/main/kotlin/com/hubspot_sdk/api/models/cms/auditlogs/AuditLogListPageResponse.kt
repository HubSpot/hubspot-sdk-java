...
private constructor(
    private val results: JsonField<List<AuditLogListResponse>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<AuditLogListResponse>> = JsonMissing.of(),
     ...
     */
    fun results(): List<AuditLogListResponse> = results.getRequired("results")
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<AuditLogListResponse>> = results
    ...
    class Builder internal constructor() {
        ...
        private var results: JsonField<MutableList<AuditLogListResponse>>? = null
        private var paging: JsonField<Paging> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(auditLogListPageResponse: AuditLogListPageResponse) = apply {
            results = auditLogListPageResponse.results.map { it.toMutableList() }
            paging = auditLogListPageResponse.paging
            additionalProperties = auditLogListPageResponse.additionalProperties.toMutableMap()
        }

        fun results(results: List<AuditLogListResponse>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed `List<AuditLogListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun results(results: JsonField<List<AuditLogListResponse>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [AuditLogListResponse] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: AuditLogListResponse) = apply {
            results =
    ...
    override fun toString() =
        "AuditLogListPageResponse{results=$results, paging=$paging, additionalProperties=$additionalProperties}"
}
