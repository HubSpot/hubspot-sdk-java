...
package com.hubspot_sdk.api.models.crm.objects.goaltargets
...
private constructor(
    ...
    fun goalTargetId(): Optional<String> = Optional.ofNullable(goalTargetId)
    ...
    companion object {
        ...
        @JvmStatic fun none(): GoalTargetGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [GoalTargetGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [GoalTargetGetParams]. */
    class Builder internal constructor() {

        private var goalTargetId: String? = null
        ...
        @JvmSynthetic
        internal fun from(goalTargetGetParams: GoalTargetGetParams) = apply {
            goalTargetId = goalTargetGetParams.goalTargetId
            archived = goalTargetGetParams.archived
            associations = goalTargetGetParams.associations?.toMutableList()
            idProperty = goalTargetGetParams.idProperty
            properties = goalTargetGetParams.properties?.toMutableList()
            propertiesWithHistory = goalTargetGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = goalTargetGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = goalTargetGetParams.additionalQueryParams.toBuilder()
        }

        fun goalTargetId(goalTargetId: String?) = apply { this.goalTargetId = goalTargetId }

        /** Alias for calling [Builder.goalTargetId] with `goalTargetId.orElse(null)`. */
        fun goalTargetId(goalTargetId: Optional<String>) = goalTargetId(goalTargetId.getOrNull())
        ...
        /**
         * Returns an immutable instance of [GoalTargetGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): GoalTargetGetParams =
            GoalTargetGetParams(
                goalTargetId,
                archived,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GoalTargetGetParams &&
            goalTargetId == other.goalTargetId &&
    ...
    override fun toString() =
        "GoalTargetGetParams{goalTargetId=$goalTargetId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
