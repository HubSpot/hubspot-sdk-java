...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MonthReference].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(monthReference: MonthReference) = apply {
            day = monthReference.day
            referenceType = monthReference.referenceType
            hour = monthReference.hour
            millisecond = monthReference.millisecond
            minute = monthReference.minute
            second = monthReference.second
            additionalProperties = monthReference.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MonthReference].
         *
    ...
    fun validate(): MonthReference = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "MonthReference{day=$day, referenceType=$referenceType, hour=$hour, millisecond=$millisecond, minute=$minute, second=$second, additionalProperties=$additionalProperties}"
}
