...
private constructor(
    ...
    /**
     * If true, the option will not be shown in forms, bots, or meeting scheduling pages. Supported
     * for contact, company, ticket, and custom object enumeration properties.
     *
    ...
    /**
     * Options are shown in order starting with the lowest positive integer value. Values of -1 will
     * cause the option to be displayed after any positive values.
     *
     * @throws HubspotInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PropertiesOptionInput].
         *
    ...
    /** A builder for [PropertiesOptionInput]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(propertiesOptionInput: PropertiesOptionInput) = apply {
            hidden = propertiesOptionInput.hidden
            label = propertiesOptionInput.label
            value = propertiesOptionInput.value
            description = propertiesOptionInput.description
            displayOrder = propertiesOptionInput.displayOrder
            additionalProperties = propertiesOptionInput.additionalProperties.toMutableMap()
        }

        /**
         * If true, the option will not be shown in forms, bots, or meeting scheduling pages.
        ...
        /**
         * Options are shown in order starting with the lowest positive integer value. Values of -1
        ...
        /**
         * Returns an immutable instance of [PropertiesOptionInput].
         *
         ...
         */
        fun build(): PropertiesOptionInput =
    ...
    fun validate(): PropertiesOptionInput = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PropertiesOptionInput &&
            hidden == other.hidden &&
            label == other.label &&
            value == other.value &&
    ...
    override fun toString() =
        "PropertiesOptionInput{hidden=$hidden, label=$label, value=$value, description=$description, displayOrder=$displayOrder, additionalProperties=$additionalProperties}"
}
