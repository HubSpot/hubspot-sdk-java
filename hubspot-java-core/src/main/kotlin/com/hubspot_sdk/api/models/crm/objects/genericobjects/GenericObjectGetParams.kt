...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GenericObjectGetParams].
         *
    ...
    /** A builder for [GenericObjectGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(genericObjectGetParams: GenericObjectGetParams) = apply {
            objectType = genericObjectGetParams.objectType
            objectId = genericObjectGetParams.objectId
            archived = genericObjectGetParams.archived
            associations = genericObjectGetParams.associations?.toMutableList()
            idProperty = genericObjectGetParams.idProperty
            properties = genericObjectGetParams.properties?.toMutableList()
            propertiesWithHistory = genericObjectGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = genericObjectGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = genericObjectGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [GenericObjectGetParams].
         *
         ...
         */
        fun build(): GenericObjectGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GenericObjectGetParams &&
    ...
    override fun toString() =
        "GenericObjectGetParams{objectType=$objectType, objectId=$objectId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
