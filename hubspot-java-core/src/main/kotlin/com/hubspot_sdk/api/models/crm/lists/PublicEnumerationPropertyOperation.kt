...
private constructor(
    ...
    ) : this(includeObjectsWithNoValueSet, operationType, operator, values, mutableMapOf())
    ...
    /**
     * Defines the operation to be applied in the enumeration property operation (IS_ANY_OF,
     * IS_NONE_OF, IS_EXACTLY, IS_NOT_EXACTLY, CONTAINS_ALL, DOES_NOT_CONTAIN_ALL,
     * HAS_EVER_BEEN_ANY_OF, HAS_NEVER_BEEN_ANY_OF, HAS_EVER_BEEN_EXACTLY, HAS_NEVER_BEEN_EXACTLY,
     * HAS_EVER_CONTAINED_ALL, HAS_NEVER_CONTAINED_ALL).
     *
     * @throws HubspotInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    ...
    /** A builder for [PublicEnumerationPropertyOperation]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicEnumerationPropertyOperation: PublicEnumerationPropertyOperation) =
            apply {
                includeObjectsWithNoValueSet =
                    publicEnumerationPropertyOperation.includeObjectsWithNoValueSet
                operationType = publicEnumerationPropertyOperation.operationType
                operator = publicEnumerationPropertyOperation.operator
                values = publicEnumerationPropertyOperation.values.map { it.toMutableList() }
                additionalProperties =
                    publicEnumerationPropertyOperation.additionalProperties.toMutableMap()
            }
         ...
         * Defines the operation to be applied in the enumeration property operation (IS_ANY_OF,
         * IS_NONE_OF, IS_EXACTLY, IS_NOT_EXACTLY, CONTAINS_ALL, DOES_NOT_CONTAIN_ALL,
         * HAS_EVER_BEEN_ANY_OF, HAS_NEVER_BEEN_ANY_OF, HAS_EVER_BEEN_EXACTLY,
         * HAS_NEVER_BEEN_EXACTLY, HAS_EVER_CONTAINED_ALL, HAS_NEVER_CONTAINED_ALL).
         */
        ...
        /**
         * Returns an immutable instance of [PublicEnumerationPropertyOperation].
         *
         ...
         */
        fun build(): PublicEnumerationPropertyOperation =
            PublicEnumerationPropertyOperation(
    ...
    fun validate(): PublicEnumerationPropertyOperation = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicEnumerationPropertyOperation &&
    ...
    override fun toString() =
        "PublicEnumerationPropertyOperation{includeObjectsWithNoValueSet=$includeObjectsWithNoValueSet, operationType=$operationType, operator=$operator, values=$values, additionalProperties=$additionalProperties}"
}
