...
/**
 * Create a single communication (WhatsApp, SMS, LinkedIn message). Include a `properties` object to
 * define [property values](https://developers.hubspot.com/docs/guides/api/crm/properties) for the
 * {objectName}, along with an `associations` array to define
 * [associations](https://developers.hubspot.com/docs/guides/api/crm/associations/associations-v4)
 * with other CRM records.
 */
class CommunicationCreateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CommunicationCreateParams].
         *
    ...
    /** A builder for [CommunicationCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(communicationCreateParams: CommunicationCreateParams) = apply {
            simplePublicObjectInputForCreate =
                communicationCreateParams.simplePublicObjectInputForCreate
            additionalHeaders = communicationCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = communicationCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CommunicationCreateParams].
         *
         ...
         */
        fun build(): CommunicationCreateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CommunicationCreateParams &&
    ...
    override fun toString() =
        "CommunicationCreateParams{simplePublicObjectInputForCreate=$simplePublicObjectInputForCreate, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
