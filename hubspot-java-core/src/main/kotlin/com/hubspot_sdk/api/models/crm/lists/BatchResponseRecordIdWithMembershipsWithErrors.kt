...
class BatchResponseRecordIdWithMembershipsWithErrors
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val completedAt: JsonField<OffsetDateTime>,
    private val results: JsonField<List<RecordIdWithMemberships>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<RecordIdWithMemberships>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<RecordIdWithMemberships> = results.getRequired("results")
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<RecordIdWithMemberships>> = results
    ...
    /** A builder for [BatchResponseRecordIdWithMembershipsWithErrors]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<RecordIdWithMemberships>>? = null
        ...
        internal fun from(
            ...
            completedAt = batchResponseRecordIdWithMembershipsWithErrors.completedAt
            results =
                batchResponseRecordIdWithMembershipsWithErrors.results.map { it.toMutableList() }
            startedAt = batchResponseRecordIdWithMembershipsWithErrors.startedAt
            status = batchResponseRecordIdWithMembershipsWithErrors.status
            errors =
                batchResponseRecordIdWithMembershipsWithErrors.errors.map { it.toMutableList() }
            links = batchResponseRecordIdWithMembershipsWithErrors.links
            numErrors = batchResponseRecordIdWithMembershipsWithErrors.numErrors
            requestedAt = batchResponseRecordIdWithMembershipsWithErrors.requestedAt
            additionalProperties =
                batchResponseRecordIdWithMembershipsWithErrors.additionalProperties.toMutableMap()
        }
        ...
        fun results(results: List<RecordIdWithMemberships>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed
         * `List<RecordIdWithMemberships>` value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun results(results: JsonField<List<RecordIdWithMemberships>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [RecordIdWithMemberships] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: RecordIdWithMemberships) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [BatchResponseRecordIdWithMembershipsWithErrors].
         *
         ...
         */
        fun build(): BatchResponseRecordIdWithMembershipsWithErrors =
            BatchResponseRecordIdWithMembershipsWithErrors(
    ...
    fun validate(): BatchResponseRecordIdWithMembershipsWithErrors = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseRecordIdWithMembershipsWithErrors &&
    ...
    override fun toString() =
        "BatchResponseRecordIdWithMembershipsWithErrors{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
