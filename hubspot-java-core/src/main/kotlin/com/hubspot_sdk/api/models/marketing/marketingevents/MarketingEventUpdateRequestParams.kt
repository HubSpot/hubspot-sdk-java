...
private constructor(
    ...
    /** A builder for [MarketingEventUpdateRequestParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(marketingEventUpdateRequestParams: MarketingEventUpdateRequestParams) =
            apply {
                customProperties =
                    marketingEventUpdateRequestParams.customProperties.map { it.toMutableList() }
                endDateTime = marketingEventUpdateRequestParams.endDateTime
                eventCancelled = marketingEventUpdateRequestParams.eventCancelled
                eventCompleted = marketingEventUpdateRequestParams.eventCompleted
                eventDescription = marketingEventUpdateRequestParams.eventDescription
                eventName = marketingEventUpdateRequestParams.eventName
                eventOrganizer = marketingEventUpdateRequestParams.eventOrganizer
                eventType = marketingEventUpdateRequestParams.eventType
                eventUrl = marketingEventUpdateRequestParams.eventUrl
                startDateTime = marketingEventUpdateRequestParams.startDateTime
                additionalProperties =
                    marketingEventUpdateRequestParams.additionalProperties.toMutableMap()
            }
    ...
    fun validate(): MarketingEventUpdateRequestParams = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MarketingEventUpdateRequestParams &&
