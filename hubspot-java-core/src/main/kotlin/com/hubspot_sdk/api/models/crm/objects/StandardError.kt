...
private constructor(
    ...
    override fun toString() =
        "StandardError{category=$category, context=$context, errors=$errors, links=$links, message=$message, status=$status, id=$id, subCategory=$subCategory, additionalProperties=$additionalProperties}"
}
