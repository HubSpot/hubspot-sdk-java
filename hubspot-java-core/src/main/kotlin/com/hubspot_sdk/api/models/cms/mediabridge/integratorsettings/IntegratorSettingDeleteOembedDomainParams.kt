...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): IntegratorSettingDeleteOembedDomainParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            additionalQueryParams =
                integratorSettingDeleteOembedDomainParams.additionalQueryParams.toBuilder()
        ...
        /**
         * Returns an immutable instance of [IntegratorSettingDeleteOembedDomainParams].
         *
