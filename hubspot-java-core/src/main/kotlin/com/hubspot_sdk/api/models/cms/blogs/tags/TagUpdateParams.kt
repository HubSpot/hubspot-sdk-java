...
/**
 * Sparse updates a single Blog Tag object identified by the id in the path. All the column values
 * need not be specified. Only the that need to be modified can be specified.
 */
...
private constructor(
    ...
    fun _additionalBodyProperties(): Map<String, JsonValue> = tag._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(tagUpdateParams: TagUpdateParams) = apply {
            objectId = tagUpdateParams.objectId
            archived = tagUpdateParams.archived
            tag = tagUpdateParams.tag
    ...
    override fun hashCode(): Int =
        Objects.hash(objectId, archived, tag, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "TagUpdateParams{objectId=$objectId, archived=$archived, tag=$tag, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
