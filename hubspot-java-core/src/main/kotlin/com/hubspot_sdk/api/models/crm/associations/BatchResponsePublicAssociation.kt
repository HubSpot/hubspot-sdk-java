...
private constructor(
    ...
    private val results: JsonField<List<PublicAssociation>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<PublicAssociation>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<PublicAssociation> = results.getRequired("results")
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<PublicAssociation>> = results
    ...
    /** A builder for [BatchResponsePublicAssociation]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<PublicAssociation>>? = null
        ...
        @JvmSynthetic
        internal fun from(batchResponsePublicAssociation: BatchResponsePublicAssociation) = apply {
            completedAt = batchResponsePublicAssociation.completedAt
            results = batchResponsePublicAssociation.results.map { it.toMutableList() }
            startedAt = batchResponsePublicAssociation.startedAt
            status = batchResponsePublicAssociation.status
            errors = batchResponsePublicAssociation.errors.map { it.toMutableList() }
            links = batchResponsePublicAssociation.links
            numErrors = batchResponsePublicAssociation.numErrors
            requestedAt = batchResponsePublicAssociation.requestedAt
            additionalProperties =
                batchResponsePublicAssociation.additionalProperties.toMutableMap()
        }
        ...
        fun results(results: List<PublicAssociation>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed `List<PublicAssociation>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun results(results: JsonField<List<PublicAssociation>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [PublicAssociation] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: PublicAssociation) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [BatchResponsePublicAssociation].
         *
         ...
         */
        fun build(): BatchResponsePublicAssociation =
            BatchResponsePublicAssociation(
    ...
    fun validate(): BatchResponsePublicAssociation = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponsePublicAssociation &&
    ...
    override fun toString() =
        "BatchResponsePublicAssociation{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
