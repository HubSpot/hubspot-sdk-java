...
private constructor(
    ...
    /**
     * The email address of the user whose subscription status is being updated. It is a required
     * field and must be a string.
     *
    ...
    /**
     * The unique identifier of the subscription for which the status is being updated. It is a
    ...
    /**
     * The legal basis for processing the subscription status change. It is an optional field and
     * must be a string with valid values including 'LEGITIMATE_INTEREST_PQL',
    ...
    class Builder internal constructor() {
        ...
        /**
         * The email address of the user whose subscription status is being updated. It is a
         * required field and must be a string.
         */
        ...
        /**
         * The legal basis for processing the subscription status change. It is an optional field
         * and must be a string with valid values including 'LEGITIMATE_INTEREST_PQL',
