...
class BatchResponsePublicCampaign
...
private constructor(
    ...
    /**
     * An array of errors that occurred during the batch operation, each item detailing a specific
     * error.
     *
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchResponsePublicCampaign].
         *
    ...
    /** A builder for [BatchResponsePublicCampaign]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchResponsePublicCampaign: BatchResponsePublicCampaign) = apply {
            completedAt = batchResponsePublicCampaign.completedAt
            results = batchResponsePublicCampaign.results.map { it.toMutableList() }
            startedAt = batchResponsePublicCampaign.startedAt
            status = batchResponsePublicCampaign.status
            errors = batchResponsePublicCampaign.errors.map { it.toMutableList() }
            links = batchResponsePublicCampaign.links
            numErrors = batchResponsePublicCampaign.numErrors
            requestedAt = batchResponsePublicCampaign.requestedAt
            additionalProperties = batchResponsePublicCampaign.additionalProperties.toMutableMap()
        }

        /**
         * The date and time when the batch operation was completed, formatted as a date-time
         * string.
         */
        ...
        /**
         * An array of errors that occurred during the batch operation, each item detailing a
         * specific error.
         */
        ...
        /**
         * The date and time when the batch operation was requested, formatted as a date-time
         * string.
         */
        ...
        /**
         * Returns an immutable instance of [BatchResponsePublicCampaign].
         *
         ...
         */
        fun build(): BatchResponsePublicCampaign =
    ...
    fun validate(): BatchResponsePublicCampaign = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponsePublicCampaign &&
    ...
    override fun toString() =
        "BatchResponsePublicCampaign{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
