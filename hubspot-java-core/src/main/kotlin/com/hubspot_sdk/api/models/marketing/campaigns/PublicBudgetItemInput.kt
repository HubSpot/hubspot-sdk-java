...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicBudgetItemInput].
         *
    ...
    /** A builder for [PublicBudgetItemInput]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicBudgetItemInput: PublicBudgetItemInput) = apply {
            amount = publicBudgetItemInput.amount
            name = publicBudgetItemInput.name
            order = publicBudgetItemInput.order
            description = publicBudgetItemInput.description
            additionalProperties = publicBudgetItemInput.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicBudgetItemInput].
         *
         ...
         */
        fun build(): PublicBudgetItemInput =
    ...
    fun validate(): PublicBudgetItemInput = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicBudgetItemInput &&
            amount == other.amount &&
            name == other.name &&
            order == other.order &&
    ...
    override fun toString() =
        "PublicBudgetItemInput{amount=$amount, name=$name, order=$order, description=$description, additionalProperties=$additionalProperties}"
}
