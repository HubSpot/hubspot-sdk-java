...
class AssociationsV4SimplePublicUpsertObject
...
private constructor(
    ...
    /** A builder for [AssociationsV4SimplePublicUpsertObject]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            associationsV4SimplePublicUpsertObject: AssociationsV4SimplePublicUpsertObject
        ) = apply {
            id = associationsV4SimplePublicUpsertObject.id
            archived = associationsV4SimplePublicUpsertObject.archived
            createdAt = associationsV4SimplePublicUpsertObject.createdAt
            new_ = associationsV4SimplePublicUpsertObject.new_
            properties = associationsV4SimplePublicUpsertObject.properties
            updatedAt = associationsV4SimplePublicUpsertObject.updatedAt
            archivedAt = associationsV4SimplePublicUpsertObject.archivedAt
            objectWriteTraceId = associationsV4SimplePublicUpsertObject.objectWriteTraceId
            propertiesWithHistory = associationsV4SimplePublicUpsertObject.propertiesWithHistory
            additionalProperties =
                associationsV4SimplePublicUpsertObject.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AssociationsV4SimplePublicUpsertObject].
         *
         ...
         */
        fun build(): AssociationsV4SimplePublicUpsertObject =
            AssociationsV4SimplePublicUpsertObject(
                checkRequired("id", id),
    ...
    fun validate(): AssociationsV4SimplePublicUpsertObject = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AssociationsV4SimplePublicUpsertObject &&
            id == other.id &&
    ...
    override fun toString() =
        "AssociationsV4SimplePublicUpsertObject{id=$id, archived=$archived, createdAt=$createdAt, new_=$new_, properties=$properties, updatedAt=$updatedAt, archivedAt=$archivedAt, objectWriteTraceId=$objectWriteTraceId, propertiesWithHistory=$propertiesWithHistory, additionalProperties=$additionalProperties}"
}
