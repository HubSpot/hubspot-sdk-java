...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AuthorListByQueryParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AuthorListByQueryParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AuthorListByQueryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(authorListByQueryParams: AuthorListByQueryParams) = apply {
            after = authorListByQueryParams.after
            archived = authorListByQueryParams.archived
            createdAfter = authorListByQueryParams.createdAfter
            createdAt = authorListByQueryParams.createdAt
            createdBefore = authorListByQueryParams.createdBefore
            limit = authorListByQueryParams.limit
            property = authorListByQueryParams.property
            sort = authorListByQueryParams.sort?.toMutableList()
            updatedAfter = authorListByQueryParams.updatedAfter
            updatedAt = authorListByQueryParams.updatedAt
            updatedBefore = authorListByQueryParams.updatedBefore
            additionalHeaders = authorListByQueryParams.additionalHeaders.toBuilder()
            additionalQueryParams = authorListByQueryParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AuthorListByQueryParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AuthorListByQueryParams =
            AuthorListByQueryParams(
                after,
                archived,
                createdAfter,
                createdAt,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AuthorListByQueryParams &&
            after == other.after &&
    ...
    override fun toString() =
        "AuthorListByQueryParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
