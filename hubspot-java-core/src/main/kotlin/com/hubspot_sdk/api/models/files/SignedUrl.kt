...
private constructor(
    ...
    ) : this(expiresAt, extension, name, size, type, url, height, width, mutableMapOf())
    ...
    override fun toString() =
        "SignedUrl{expiresAt=$expiresAt, extension=$extension, name=$name, size=$size, type=$type, url=$url, height=$height, width=$width, additionalProperties=$additionalProperties}"
}
