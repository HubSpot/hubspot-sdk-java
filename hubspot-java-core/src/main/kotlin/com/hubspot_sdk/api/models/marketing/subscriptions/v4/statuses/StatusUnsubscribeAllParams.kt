...
class StatusUnsubscribeAllParams
private constructor(
     ...
     * include this parameter to filter results by business unit ID. The default Account business
     * unit will always use `0`.
     */
    fun businessUnitId(): Optional<Long> = Optional.ofNullable(businessUnitId)

    /**
     * Set to `true` to include the details of the updated subscription statuses in the response.
     * Not including this parameter will result in an empty response.
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [StatusUnsubscribeAllParams].
         *
    ...
    /** A builder for [StatusUnsubscribeAllParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(statusUnsubscribeAllParams: StatusUnsubscribeAllParams) = apply {
            subscriberIdString = statusUnsubscribeAllParams.subscriberIdString
            channel = statusUnsubscribeAllParams.channel
            businessUnitId = statusUnsubscribeAllParams.businessUnitId
            verbose = statusUnsubscribeAllParams.verbose
            additionalHeaders = statusUnsubscribeAllParams.additionalHeaders.toBuilder()
            additionalQueryParams = statusUnsubscribeAllParams.additionalQueryParams.toBuilder()
            additionalBodyProperties =
                statusUnsubscribeAllParams.additionalBodyProperties.toMutableMap()
        }
         ...
         * If you have the
         * [business unit add-on](https://developers.hubspot.com/beta-docs/guides/api/settings/business-units-api),
         * include this parameter to filter results by business unit ID. The default Account
         * business unit will always use `0`.
         */
        ...
        /**
         * Returns an immutable instance of [StatusUnsubscribeAllParams].
         *
         ...
         */
        fun build(): StatusUnsubscribeAllParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StatusUnsubscribeAllParams &&
    ...
    override fun toString() =
        "StatusUnsubscribeAllParams{subscriberIdString=$subscriberIdString, channel=$channel, businessUnitId=$businessUnitId, verbose=$verbose, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
