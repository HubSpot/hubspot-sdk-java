...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): FileAssetUploadParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [FileAssetUploadParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FileAssetUploadParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileAssetUploadParams: FileAssetUploadParams) = apply {
            body = fileAssetUploadParams.body.toBuilder()
            additionalHeaders = fileAssetUploadParams.additionalHeaders.toBuilder()
            additionalQueryParams = fileAssetUploadParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FileAssetUploadParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FileAssetUploadParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FileAssetUploadParams &&
            body == other.body &&
    ...
    override fun toString() =
        "FileAssetUploadParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
