...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(marketingEventDefaultResponse: MarketingEventDefaultResponse) = apply {
            ...
            eventDescription = marketingEventDefaultResponse.eventDescription
            eventType = marketingEventDefaultResponse.eventType
            eventUrl = marketingEventDefaultResponse.eventUrl
        ...
        /**
         * Returns an immutable instance of [MarketingEventDefaultResponse].
         *
    ...
    fun validate(): MarketingEventDefaultResponse = apply {
        if (validated) {
            return@apply
        }
