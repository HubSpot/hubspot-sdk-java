...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IndexedData].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(indexedData: IndexedData) = apply {
            id = indexedData.id
            fields = indexedData.fields
            type = indexedData.type
            additionalProperties = indexedData.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IndexedData].
         *
    ...
    fun validate(): IndexedData = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "IndexedData{id=$id, fields=$fields, type=$type, additionalProperties=$additionalProperties}"
}
