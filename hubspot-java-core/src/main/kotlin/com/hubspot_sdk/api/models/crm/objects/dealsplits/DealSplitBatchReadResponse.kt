...
class DealSplitBatchReadResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DealSplitBatchReadResponse].
         *
    ...
    /** A builder for [DealSplitBatchReadResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dealSplitBatchReadResponse: DealSplitBatchReadResponse) = apply {
            completedAt = dealSplitBatchReadResponse.completedAt
            results = dealSplitBatchReadResponse.results.map { it.toMutableList() }
            startedAt = dealSplitBatchReadResponse.startedAt
            status = dealSplitBatchReadResponse.status
            links = dealSplitBatchReadResponse.links
            requestedAt = dealSplitBatchReadResponse.requestedAt
            additionalProperties = dealSplitBatchReadResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DealSplitBatchReadResponse].
         *
         ...
         */
        fun build(): DealSplitBatchReadResponse =
    ...
    fun validate(): DealSplitBatchReadResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DealSplitBatchReadResponse &&
    ...
    override fun toString() =
        "DealSplitBatchReadResponse{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, links=$links, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
