...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FormDefinitionBase].
         *
    ...
    /** A builder for [FormDefinitionBase]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(formDefinitionBase: FormDefinitionBase) = apply {
            id = formDefinitionBase.id
            archived = formDefinitionBase.archived
            configuration = formDefinitionBase.configuration
            createdAt = formDefinitionBase.createdAt
            displayOptions = formDefinitionBase.displayOptions
            fieldGroups = formDefinitionBase.fieldGroups.map { it.toMutableList() }
            formType = formDefinitionBase.formType
            legalConsentOptions = formDefinitionBase.legalConsentOptions
            name = formDefinitionBase.name
            updatedAt = formDefinitionBase.updatedAt
            archivedAt = formDefinitionBase.archivedAt
            additionalProperties = formDefinitionBase.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FormDefinitionBase].
         *
    ...
    fun validate(): FormDefinitionBase = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FormDefinitionBase &&
            id == other.id &&
    ...
    override fun toString() =
        "FormDefinitionBase{id=$id, archived=$archived, configuration=$configuration, createdAt=$createdAt, displayOptions=$displayOptions, fieldGroups=$fieldGroups, formType=$formType, legalConsentOptions=$legalConsentOptions, name=$name, updatedAt=$updatedAt, archivedAt=$archivedAt, additionalProperties=$additionalProperties}"
}
