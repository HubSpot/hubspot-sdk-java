...
class SourceCodeUpsertResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SourceCodeUpsertResponse].
         *
    ...
    /** A builder for [SourceCodeUpsertResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sourceCodeUpsertResponse: SourceCodeUpsertResponse) = apply {
            id = sourceCodeUpsertResponse.id
            createdAt = sourceCodeUpsertResponse.createdAt
            folder = sourceCodeUpsertResponse.folder
            name = sourceCodeUpsertResponse.name
            updatedAt = sourceCodeUpsertResponse.updatedAt
            archivedAt = sourceCodeUpsertResponse.archivedAt
            children = sourceCodeUpsertResponse.children.map { it.toMutableList() }
            hash = sourceCodeUpsertResponse.hash
            additionalProperties = sourceCodeUpsertResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SourceCodeUpsertResponse].
         *
         ...
         */
        fun build(): SourceCodeUpsertResponse =
    ...
    fun validate(): SourceCodeUpsertResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SourceCodeUpsertResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "SourceCodeUpsertResponse{id=$id, createdAt=$createdAt, folder=$folder, name=$name, updatedAt=$updatedAt, archivedAt=$archivedAt, children=$children, hash=$hash, additionalProperties=$additionalProperties}"
}
