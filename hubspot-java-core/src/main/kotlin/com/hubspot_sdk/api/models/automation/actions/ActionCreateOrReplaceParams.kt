...
class ActionCreateOrReplaceParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ActionCreateOrReplaceParams].
         *
    ...
    /** A builder for [ActionCreateOrReplaceParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionCreateOrReplaceParams: ActionCreateOrReplaceParams) = apply {
            appId = actionCreateOrReplaceParams.appId
            definitionId = actionCreateOrReplaceParams.definitionId
            functionType = actionCreateOrReplaceParams.functionType
            functionId = actionCreateOrReplaceParams.functionId
            body = actionCreateOrReplaceParams.body
            additionalHeaders = actionCreateOrReplaceParams.additionalHeaders.toBuilder()
            additionalQueryParams = actionCreateOrReplaceParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ActionCreateOrReplaceParams].
         *
         ...
         */
        fun build(): ActionCreateOrReplaceParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionCreateOrReplaceParams &&
            appId == other.appId &&
    ...
    override fun toString() =
        "ActionCreateOrReplaceParams{appId=$appId, definitionId=$definitionId, functionType=$functionType, functionId=$functionId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
