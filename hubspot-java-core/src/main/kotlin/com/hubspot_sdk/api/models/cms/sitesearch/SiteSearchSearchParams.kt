...
private constructor(
    ...
    fun analytics(): Optional<Boolean> = Optional.ofNullable(analytics)
    ...
    fun type(): Optional<List<String>> = Optional.ofNullable(type)
    ...
    class Builder internal constructor() {
        ...
        private var analytics: Boolean? = null
        ...
        internal fun from(siteSearchSearchParams: SiteSearchSearchParams) = apply {
            analytics = siteSearchSearchParams.analytics
            ...
            types = siteSearchSearchParams.types?.toMutableList()
        ...
        /**
         * Alias for [Builder.analytics].
         *
         * This unboxed primitive overload exists for backwards compatibility.
         */
        fun analytics(analytics: Boolean) = analytics(analytics as Boolean?)

        /** Alias for calling [Builder.analytics] with `analytics.orElse(null)`. */
        fun analytics(analytics: Optional<Boolean>) = analytics(analytics.getOrNull())
        ...
        fun type(type: List<String>?) = apply { this.type = type?.toMutableList() }

        /** Alias for calling [Builder.type] with `type.orElse(null)`. */
        fun type(type: Optional<List<String>>) = type(type.getOrNull())

        /**
         * Adds a single [String] to [Builder.type].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                analytics?.let { put("analytics", it.toString()) }
    ...
    override fun toString() =
        "SiteSearchSearchParams{analytics=$analytics, autocomplete=$autocomplete, boostLimit=$boostLimit, boostRecent=$boostRecent, domain=$domain, groupId=$groupId, hubdbQuery=$hubdbQuery, language=$language, length=$length, limit=$limit, matchPrefix=$matchPrefix, offset=$offset, pathPrefix=$pathPrefix, popularityBoost=$popularityBoost, property=$property, q=$q, tableId=$tableId, type=$type, types=$types, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
