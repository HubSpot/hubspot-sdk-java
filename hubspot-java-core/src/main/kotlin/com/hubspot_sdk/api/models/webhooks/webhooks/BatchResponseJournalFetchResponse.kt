...
private constructor(
    ...
    /** A builder for [BatchResponseJournalFetchResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchResponseJournalFetchResponse: BatchResponseJournalFetchResponse) =
            apply {
                completedAt = batchResponseJournalFetchResponse.completedAt
                results = batchResponseJournalFetchResponse.results.map { it.toMutableList() }
                startedAt = batchResponseJournalFetchResponse.startedAt
                status = batchResponseJournalFetchResponse.status
                errors = batchResponseJournalFetchResponse.errors.map { it.toMutableList() }
                links = batchResponseJournalFetchResponse.links
                numErrors = batchResponseJournalFetchResponse.numErrors
                requestedAt = batchResponseJournalFetchResponse.requestedAt
        ...
        /**
         * Returns an immutable instance of [BatchResponseJournalFetchResponse].
         *
         ...
         */
        fun build(): BatchResponseJournalFetchResponse =
            BatchResponseJournalFetchResponse(
    ...
    fun validate(): BatchResponseJournalFetchResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseJournalFetchResponse &&
    ...
    override fun toString() =
        "BatchResponseJournalFetchResponse{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
