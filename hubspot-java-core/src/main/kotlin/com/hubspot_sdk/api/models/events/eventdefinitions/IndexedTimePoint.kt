...
private constructor(
    ...
    ) : this(indexReference, timeType, timezoneSource, zoneId, offset, mutableMapOf())
    ...
    private val hashCode: Int by lazy {
        Objects.hash(indexReference, timeType, timezoneSource, zoneId, offset, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "IndexedTimePoint{indexReference=$indexReference, timeType=$timeType, timezoneSource=$timezoneSource, zoneId=$zoneId, offset=$offset, additionalProperties=$additionalProperties}"
}
