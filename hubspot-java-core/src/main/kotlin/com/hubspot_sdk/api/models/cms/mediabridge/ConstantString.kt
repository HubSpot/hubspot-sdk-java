...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(constantString: ConstantString) = apply {
            ...
            inputs = constantString.inputs.map { it.toMutableList() }
    ...
    override fun toString() =
        "ConstantString{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
