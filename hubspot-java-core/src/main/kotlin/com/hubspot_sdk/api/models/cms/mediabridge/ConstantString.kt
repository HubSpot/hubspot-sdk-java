...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ConstantString].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(constantString: ConstantString) = apply {
            operator = constantString.operator
            propertyName = constantString.propertyName
            value = constantString.value
            additionalProperties = constantString.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConstantString].
         *
    ...
    fun validate(): ConstantString = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CONSTANT_STRING = of("CONSTANT_STRING")
        ...
        fun value(): Value =
            when (this) {
                CONSTANT_STRING -> Value.CONSTANT_STRING
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CONSTANT_STRING -> Known.CONSTANT_STRING
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConstantString &&
    ...
    override fun toString() =
        "ConstantString{operator=$operator, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
