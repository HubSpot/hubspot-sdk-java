...
/**
 * Get the list of Landing Page Folders. Supports paging and filtering. This method would be useful
 * for an integration that examined these models and used an external service to suggest edits.
 */
class LandingPageListFoldersParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LandingPageListFoldersParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [LandingPageListFoldersParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LandingPageListFoldersParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(landingPageListFoldersParams: LandingPageListFoldersParams) = apply {
            after = landingPageListFoldersParams.after
            archived = landingPageListFoldersParams.archived
            createdAfter = landingPageListFoldersParams.createdAfter
            createdAt = landingPageListFoldersParams.createdAt
            createdBefore = landingPageListFoldersParams.createdBefore
            limit = landingPageListFoldersParams.limit
            property = landingPageListFoldersParams.property
            sort = landingPageListFoldersParams.sort?.toMutableList()
            updatedAfter = landingPageListFoldersParams.updatedAfter
            updatedAt = landingPageListFoldersParams.updatedAt
            updatedBefore = landingPageListFoldersParams.updatedBefore
            additionalHeaders = landingPageListFoldersParams.additionalHeaders.toBuilder()
            additionalQueryParams = landingPageListFoldersParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LandingPageListFoldersParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LandingPageListFoldersParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LandingPageListFoldersParams &&
            after == other.after &&
    ...
    override fun toString() =
        "LandingPageListFoldersParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
