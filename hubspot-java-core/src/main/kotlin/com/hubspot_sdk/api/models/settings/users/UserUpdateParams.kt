...
private constructor(
    ...
    private val publicUserUpdate: PublicUserUpdate,
    ...
    /**
     * The name of a property with unique user values. Valid values are `USER_ID`(default) or
     * `EMAIL`
     */
    fun idProperty(): Optional<IdProperty> = Optional.ofNullable(idProperty)

    /** A user to update */
    fun publicUserUpdate(): PublicUserUpdate = publicUserUpdate

    fun _additionalBodyProperties(): Map<String, JsonValue> =
        publicUserUpdate._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        private var publicUserUpdate: PublicUserUpdate? = null
        ...
        internal fun from(userUpdateParams: UserUpdateParams) = apply {
            ...
            idProperty = userUpdateParams.idProperty
            publicUserUpdate = userUpdateParams.publicUserUpdate
        ...
        /** A user to update */
        fun publicUserUpdate(publicUserUpdate: PublicUserUpdate) = apply {
            this.publicUserUpdate = publicUserUpdate
        }
        ...
        fun build(): UserUpdateParams =
            UserUpdateParams(
                userId,
                idProperty,
                checkRequired("publicUserUpdate", publicUserUpdate),
                additionalHeaders.build(),
                additionalQueryParams.build(),
            )
    }

    fun _body(): PublicUserUpdate = publicUserUpdate
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserUpdateParams &&
            ...
            publicUserUpdate == other.publicUserUpdate &&
            additionalHeaders == other.additionalHeaders &&
            additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int =
        Objects.hash(userId, idProperty, publicUserUpdate, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "UserUpdateParams{userId=$userId, idProperty=$idProperty, publicUserUpdate=$publicUserUpdate, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
