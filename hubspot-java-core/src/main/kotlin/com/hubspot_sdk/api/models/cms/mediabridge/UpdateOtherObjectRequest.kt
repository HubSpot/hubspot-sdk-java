...
class UpdateOtherObjectRequest
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UpdateOtherObjectRequest].
         *
    ...
    /** A builder for [UpdateOtherObjectRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(updateOtherObjectRequest: UpdateOtherObjectRequest) = apply {
            mediaType = updateOtherObjectRequest.mediaType
            detailsPageLink = updateOtherObjectRequest.detailsPageLink
            duration = updateOtherObjectRequest.duration
            externalId = updateOtherObjectRequest.externalId
            fileUrl = updateOtherObjectRequest.fileUrl
            oembedUrl = updateOtherObjectRequest.oembedUrl
            posterUrl = updateOtherObjectRequest.posterUrl
            thumbnailUrl = updateOtherObjectRequest.thumbnailUrl
            title = updateOtherObjectRequest.title
            additionalProperties = updateOtherObjectRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UpdateOtherObjectRequest].
         *
         ...
         */
        fun build(): UpdateOtherObjectRequest =
    ...
    fun validate(): UpdateOtherObjectRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UpdateOtherObjectRequest &&
    ...
    override fun toString() =
        "UpdateOtherObjectRequest{mediaType=$mediaType, detailsPageLink=$detailsPageLink, duration=$duration, externalId=$externalId, fileUrl=$fileUrl, oembedUrl=$oembedUrl, posterUrl=$posterUrl, thumbnailUrl=$thumbnailUrl, title=$title, additionalProperties=$additionalProperties}"
}
