...
class ComparativeDatePropertyOperation
...
private constructor(
    ...
    /** A builder for [ComparativeDatePropertyOperation]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(comparativeDatePropertyOperation: ComparativeDatePropertyOperation) =
            apply {
                comparisonPropertyName = comparativeDatePropertyOperation.comparisonPropertyName
                includeObjectsWithNoValueSet =
                    comparativeDatePropertyOperation.includeObjectsWithNoValueSet
                operationType = comparativeDatePropertyOperation.operationType
                operator = comparativeDatePropertyOperation.operator
                operatorName = comparativeDatePropertyOperation.operatorName
                propertyType = comparativeDatePropertyOperation.propertyType
                defaultComparisonValue = comparativeDatePropertyOperation.defaultComparisonValue
                defaultValue = comparativeDatePropertyOperation.defaultValue
                renderSpec = comparativeDatePropertyOperation.renderSpec
                additionalProperties =
                    comparativeDatePropertyOperation.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ComparativeDatePropertyOperation].
         *
         ...
         */
        fun build(): ComparativeDatePropertyOperation =
            ComparativeDatePropertyOperation(
    ...
    fun validate(): ComparativeDatePropertyOperation = apply {
        if (validated) {
            return@apply
        }
    ...
    class PropertyType @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            @JvmField val DATETIME_COMPARATIVE = of("datetime-comparative")
        ...
        fun value(): Value =
            when (this) {
                DATETIME_COMPARATIVE -> Value.DATETIME_COMPARATIVE
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                DATETIME_COMPARATIVE -> Known.DATETIME_COMPARATIVE
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ComparativeDatePropertyOperation &&
    ...
    override fun toString() =
        "ComparativeDatePropertyOperation{comparisonPropertyName=$comparisonPropertyName, includeObjectsWithNoValueSet=$includeObjectsWithNoValueSet, operationType=$operationType, operator=$operator, operatorName=$operatorName, propertyType=$propertyType, defaultComparisonValue=$defaultComparisonValue, defaultValue=$defaultValue, renderSpec=$renderSpec, additionalProperties=$additionalProperties}"
}
