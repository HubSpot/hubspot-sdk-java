...
class UpdateVideoObjectRequest
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UpdateVideoObjectRequest].
         *
    ...
    /** A builder for [UpdateVideoObjectRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(updateVideoObjectRequest: UpdateVideoObjectRequest) = apply {
            mediaType = updateVideoObjectRequest.mediaType
            bearerToken = updateVideoObjectRequest.bearerToken
            detailsPageLink = updateVideoObjectRequest.detailsPageLink
            duration = updateVideoObjectRequest.duration
            externalId = updateVideoObjectRequest.externalId
            fileUrl = updateVideoObjectRequest.fileUrl
            oembedUrl = updateVideoObjectRequest.oembedUrl
            posterUrl = updateVideoObjectRequest.posterUrl
            thumbnailUrl = updateVideoObjectRequest.thumbnailUrl
            title = updateVideoObjectRequest.title
            transcriptUrl = updateVideoObjectRequest.transcriptUrl
            additionalProperties = updateVideoObjectRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UpdateVideoObjectRequest].
         *
         ...
         */
        fun build(): UpdateVideoObjectRequest =
    ...
    fun validate(): UpdateVideoObjectRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UpdateVideoObjectRequest &&
    ...
    override fun toString() =
        "UpdateVideoObjectRequest{mediaType=$mediaType, bearerToken=$bearerToken, detailsPageLink=$detailsPageLink, duration=$duration, externalId=$externalId, fileUrl=$fileUrl, oembedUrl=$oembedUrl, posterUrl=$posterUrl, thumbnailUrl=$thumbnailUrl, title=$title, transcriptUrl=$transcriptUrl, additionalProperties=$additionalProperties}"
}
