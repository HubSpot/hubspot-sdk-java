...
private constructor(
    ...
    /** A builder for [ConversationsPublicChannelAccount]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(conversationsPublicChannelAccount: ConversationsPublicChannelAccount) =
            apply {
                archived = conversationsPublicChannelAccount.archived
                id = conversationsPublicChannelAccount.id
                active = conversationsPublicChannelAccount.active
                archivedAt = conversationsPublicChannelAccount.archivedAt
                authorized = conversationsPublicChannelAccount.authorized
                channelId = conversationsPublicChannelAccount.channelId
                createdAt = conversationsPublicChannelAccount.createdAt
                deliveryIdentifier = conversationsPublicChannelAccount.deliveryIdentifier
                inboxId = conversationsPublicChannelAccount.inboxId
                name = conversationsPublicChannelAccount.name
                additionalProperties =
                    conversationsPublicChannelAccount.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ConversationsPublicChannelAccount].
         *
         ...
         */
        fun build(): ConversationsPublicChannelAccount =
            ConversationsPublicChannelAccount(
    ...
    fun validate(): ConversationsPublicChannelAccount = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConversationsPublicChannelAccount &&
    ...
    override fun toString() =
        "ConversationsPublicChannelAccount{archived=$archived, id=$id, active=$active, archivedAt=$archivedAt, authorized=$authorized, channelId=$channelId, createdAt=$createdAt, deliveryIdentifier=$deliveryIdentifier, inboxId=$inboxId, name=$name, additionalProperties=$additionalProperties}"
}
