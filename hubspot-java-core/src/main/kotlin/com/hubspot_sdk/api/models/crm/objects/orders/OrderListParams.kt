...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of orders that can be
    ...
    class Builder internal constructor() {
        ...
        internal fun from(orderListParams: OrderListParams) = apply {
            ...
            archived = orderListParams.archived
            associations = orderListParams.associations?.toMutableList()
            limit = orderListParams.limit
            properties = orderListParams.properties?.toMutableList()
            propertiesWithHistory = orderListParams.propertiesWithHistory?.toMutableList()
         ...
         * of orders that can be read by a single request.
         */
    ...
    override fun toString() =
        "OrderListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
