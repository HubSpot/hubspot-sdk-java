...
private constructor(
    ...
    private val eligibleFollowUpDays: JsonField<String>,
    private val individualTaskRemindersEnabled: JsonField<Boolean>,
    private val sellingStrategy: JsonField<String>,
    ...
    private val unenrollmentSettings: JsonField<UnenrollmentSettingsResponse>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        eligibleFollowUpDays: JsonField<String> = JsonMissing.of(),
        ...
        @ExcludeMissing
        sellingStrategy: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("unenrollmentSettings")
        @ExcludeMissing
        unenrollmentSettings: JsonField<UnenrollmentSettingsResponse> = JsonMissing.of(),
    ) : this(
        id,
        createdAt,
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun eligibleFollowUpDays(): String = eligibleFollowUpDays.getRequired("eligibleFollowUpDays")
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun sellingStrategy(): String = sellingStrategy.getRequired("sellingStrategy")
     ...
     */
    fun unenrollmentSettings(): Optional<UnenrollmentSettingsResponse> =
        unenrollmentSettings.getOptional("unenrollmentSettings")
    ...
    @JsonProperty("eligibleFollowUpDays")
    @ExcludeMissing
    fun _eligibleFollowUpDays(): JsonField<String> = eligibleFollowUpDays
    ...
    @JsonProperty("sellingStrategy")
    @ExcludeMissing
    fun _sellingStrategy(): JsonField<String> = sellingStrategy
    ...
    /**
     * Returns the raw JSON value of [unenrollmentSettings].
     *
     * Unlike [unenrollmentSettings], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("unenrollmentSettings")
    @ExcludeMissing
    fun _unenrollmentSettings(): JsonField<UnenrollmentSettingsResponse> = unenrollmentSettings
    ...
    class Builder internal constructor() {
        ...
        private var eligibleFollowUpDays: JsonField<String>? = null
        private var individualTaskRemindersEnabled: JsonField<Boolean>? = null
        private var sellingStrategy: JsonField<String>? = null
        ...
        private var unenrollmentSettings: JsonField<UnenrollmentSettingsResponse> = JsonMissing.of()
        ...
        internal fun from(publicSequenceSettingsResponse: PublicSequenceSettingsResponse) = apply {
            ...
            unenrollmentSettings = publicSequenceSettingsResponse.unenrollmentSettings
        ...
        fun eligibleFollowUpDays(eligibleFollowUpDays: String) =
            eligibleFollowUpDays(JsonField.of(eligibleFollowUpDays))

        /**
         * Sets [Builder.eligibleFollowUpDays] to an arbitrary JSON value.
         *
         * You should usually call [Builder.eligibleFollowUpDays] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun eligibleFollowUpDays(eligibleFollowUpDays: JsonField<String>) = apply {
        ...
        fun sellingStrategy(sellingStrategy: String) =
            sellingStrategy(JsonField.of(sellingStrategy))

        /**
         * Sets [Builder.sellingStrategy] to an arbitrary JSON value.
         *
         * You should usually call [Builder.sellingStrategy] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun sellingStrategy(sellingStrategy: JsonField<String>) = apply {
        ...
        fun unenrollmentSettings(unenrollmentSettings: UnenrollmentSettingsResponse) =
            unenrollmentSettings(JsonField.of(unenrollmentSettings))

        /**
         * Sets [Builder.unenrollmentSettings] to an arbitrary JSON value.
         *
         * You should usually call [Builder.unenrollmentSettings] with a well-typed
         * [UnenrollmentSettingsResponse] value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun unenrollmentSettings(unenrollmentSettings: JsonField<UnenrollmentSettingsResponse>) =
            apply {
                this.unenrollmentSettings = unenrollmentSettings
            }
    ...
    fun validate(): PublicSequenceSettingsResponse = apply {
        ...
        taskReminderMinute()
        updatedAt()
        unenrollmentSettings().ifPresent { it.validate() }
        validated = true
    }
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (if (eligibleFollowUpDays.asKnown().isPresent) 1 else 0) +
            (if (individualTaskRemindersEnabled.asKnown().isPresent) 1 else 0) +
            (if (sellingStrategy.asKnown().isPresent) 1 else 0) +
            ...
            (unenrollmentSettings.asKnown().getOrNull()?.validity() ?: 0)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicSequenceSettingsResponse &&
            ...
            unenrollmentSettings == other.unenrollmentSettings &&
