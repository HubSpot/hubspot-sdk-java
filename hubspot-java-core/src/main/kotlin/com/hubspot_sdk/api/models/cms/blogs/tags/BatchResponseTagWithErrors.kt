...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("results") @ExcludeMissing results: JsonField<List<Tag>> = JsonMissing.of(),
     ...
     */
    @JsonProperty("results") @ExcludeMissing fun _results(): JsonField<List<Tag>> = results
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchResponseTagWithErrors].
         *
    ...
    /** A builder for [BatchResponseTagWithErrors]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<Tag>>? = null
        ...
        @JvmSynthetic
        internal fun from(batchResponseTagWithErrors: BatchResponseTagWithErrors) = apply {
            completedAt = batchResponseTagWithErrors.completedAt
            results = batchResponseTagWithErrors.results.map { it.toMutableList() }
            startedAt = batchResponseTagWithErrors.startedAt
            status = batchResponseTagWithErrors.status
            errors = batchResponseTagWithErrors.errors.map { it.toMutableList() }
            links = batchResponseTagWithErrors.links
            numErrors = batchResponseTagWithErrors.numErrors
            requestedAt = batchResponseTagWithErrors.requestedAt
            additionalProperties = batchResponseTagWithErrors.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.results] with a well-typed `List<Tag>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun results(results: JsonField<List<Tag>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [Tag] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: Tag) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [BatchResponseTagWithErrors].
         *
         ...
         */
        fun build(): BatchResponseTagWithErrors =
    ...
    fun validate(): BatchResponseTagWithErrors = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseTagWithErrors &&
    ...
    override fun toString() =
        "BatchResponseTagWithErrors{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
