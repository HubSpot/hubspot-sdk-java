...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of projects that can
    ...
    class Builder internal constructor() {
        ...
        internal fun from(projectListParams: ProjectListParams) = apply {
            ...
            archived = projectListParams.archived
            associations = projectListParams.associations?.toMutableList()
            limit = projectListParams.limit
            properties = projectListParams.properties?.toMutableList()
            propertiesWithHistory = projectListParams.propertiesWithHistory?.toMutableList()
         ...
         * of projects that can be read by a single request.
         */
    ...
    override fun toString() =
        "ProjectListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
