...
package com.hubspot_sdk.api.models.crm.featureflags.batch
...
private constructor(
    ...
    private val portalFlagStateBatchPutRequest: PortalFlagStateBatchPutRequest,
    ...
    fun portalFlagStateBatchPutRequest(): PortalFlagStateBatchPutRequest =
        portalFlagStateBatchPutRequest

    fun _additionalBodyProperties(): Map<String, JsonValue> =
        portalFlagStateBatchPutRequest._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        private var portalFlagStateBatchPutRequest: PortalFlagStateBatchPutRequest? = null
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        @JvmSynthetic
        internal fun from(batchUpsertParams: BatchUpsertParams) = apply {
            appId = batchUpsertParams.appId
            flagName = batchUpsertParams.flagName
            portalFlagStateBatchPutRequest = batchUpsertParams.portalFlagStateBatchPutRequest
        ...
        fun portalFlagStateBatchPutRequest(
            portalFlagStateBatchPutRequest: PortalFlagStateBatchPutRequest
        ) = apply { this.portalFlagStateBatchPutRequest = portalFlagStateBatchPutRequest }
        ...
        /**
         * Returns an immutable instance of [BatchUpsertParams].
         *
        ...
        fun build(): BatchUpsertParams =
            BatchUpsertParams(
                ...
                flagName,
                checkRequired("portalFlagStateBatchPutRequest", portalFlagStateBatchPutRequest),
                additionalHeaders.build(),
                additionalQueryParams.build(),
            )
    }

    fun _body(): PortalFlagStateBatchPutRequest = portalFlagStateBatchPutRequest
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchUpsertParams &&
            ...
            portalFlagStateBatchPutRequest == other.portalFlagStateBatchPutRequest &&
    ...
    override fun toString() =
        "BatchUpsertParams{appId=$appId, flagName=$flagName, portalFlagStateBatchPutRequest=$portalFlagStateBatchPutRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
