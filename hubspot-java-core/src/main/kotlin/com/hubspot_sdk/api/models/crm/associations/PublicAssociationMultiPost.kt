...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicAssociationMultiPost].
         *
    ...
    /** A builder for [PublicAssociationMultiPost]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicAssociationMultiPost: PublicAssociationMultiPost) = apply {
            from = publicAssociationMultiPost.from
            to = publicAssociationMultiPost.to
            types = publicAssociationMultiPost.types.map { it.toMutableList() }
            additionalProperties = publicAssociationMultiPost.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicAssociationMultiPost].
         *
         ...
         */
        fun build(): PublicAssociationMultiPost =
    ...
    fun validate(): PublicAssociationMultiPost = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicAssociationMultiPost &&
            from == other.from &&
            to == other.to &&
            types == other.types &&
    ...
    private val hashCode: Int by lazy { Objects.hash(from, to, types, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "PublicAssociationMultiPost{from=$from, to=$to, types=$types, additionalProperties=$additionalProperties}"
}
