...
private constructor(
    ...
    /**
     * Defines the operation to be applied in the number property operation (IS_EQUAL_TO,
     * IS_NOT_EQUAL_TO, IS_GREATER_THAN, IS_GREATER_THAN_OR_EQUAL_TO, IS_LESS_THAN,
     * IS_LESS_THAN_OR_EQUAL_TO, HAS_EVER_BEEN_EQUAL_TO, HAS_NEVER_BEEN_EQUAL_TO).
     *
     * @throws HubspotInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    ...
    /** A builder for [PublicNumberPropertyOperation]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicNumberPropertyOperation: PublicNumberPropertyOperation) = apply {
            includeObjectsWithNoValueSet =
                publicNumberPropertyOperation.includeObjectsWithNoValueSet
            operationType = publicNumberPropertyOperation.operationType
            operator = publicNumberPropertyOperation.operator
            value = publicNumberPropertyOperation.value
            additionalProperties = publicNumberPropertyOperation.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicNumberPropertyOperation].
         *
         ...
         */
        fun build(): PublicNumberPropertyOperation =
            PublicNumberPropertyOperation(
    ...
    fun validate(): PublicNumberPropertyOperation = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicNumberPropertyOperation &&
    ...
    override fun toString() =
        "PublicNumberPropertyOperation{includeObjectsWithNoValueSet=$includeObjectsWithNoValueSet, operationType=$operationType, operator=$operator, value=$value, additionalProperties=$additionalProperties}"
}
