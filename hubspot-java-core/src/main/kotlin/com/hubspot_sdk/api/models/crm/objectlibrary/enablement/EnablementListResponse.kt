...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EnablementListResponse].
         *
    ...
    /** A builder for [EnablementListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(enablementListResponse: EnablementListResponse) = apply {
            enablementByObjectTypeId = enablementListResponse.enablementByObjectTypeId
            additionalProperties = enablementListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EnablementListResponse].
         *
         ...
         */
        fun build(): EnablementListResponse =
    ...
    fun validate(): EnablementListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EnablementListResponse &&
    ...
    override fun toString() =
        "EnablementListResponse{enablementByObjectTypeId=$enablementByObjectTypeId, additionalProperties=$additionalProperties}"
}
