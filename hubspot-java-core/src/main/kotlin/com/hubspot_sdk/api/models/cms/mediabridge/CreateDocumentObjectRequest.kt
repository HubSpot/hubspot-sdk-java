...
class CreateDocumentObjectRequest
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CreateDocumentObjectRequest].
         *
    ...
    /** A builder for [CreateDocumentObjectRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(createDocumentObjectRequest: CreateDocumentObjectRequest) = apply {
            mediaType = createDocumentObjectRequest.mediaType
            title = createDocumentObjectRequest.title
            detailsPageLink = createDocumentObjectRequest.detailsPageLink
            duration = createDocumentObjectRequest.duration
            externalId = createDocumentObjectRequest.externalId
            fileUrl = createDocumentObjectRequest.fileUrl
            oembedUrl = createDocumentObjectRequest.oembedUrl
            posterUrl = createDocumentObjectRequest.posterUrl
            thumbnailUrl = createDocumentObjectRequest.thumbnailUrl
            additionalProperties = createDocumentObjectRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CreateDocumentObjectRequest].
         *
         ...
         */
        fun build(): CreateDocumentObjectRequest =
    ...
    fun validate(): CreateDocumentObjectRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CreateDocumentObjectRequest &&
    ...
    override fun toString() =
        "CreateDocumentObjectRequest{mediaType=$mediaType, title=$title, detailsPageLink=$detailsPageLink, duration=$duration, externalId=$externalId, fileUrl=$fileUrl, oembedUrl=$oembedUrl, posterUrl=$posterUrl, thumbnailUrl=$thumbnailUrl, additionalProperties=$additionalProperties}"
}
