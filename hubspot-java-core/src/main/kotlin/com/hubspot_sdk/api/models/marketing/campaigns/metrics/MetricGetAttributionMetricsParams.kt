...
package com.hubspot_sdk.api.models.marketing.campaigns.metrics
...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): MetricGetAttributionMetricsParams = builder().build()
    ...
    /** A builder for [MetricGetAttributionMetricsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(metricGetAttributionMetricsParams: MetricGetAttributionMetricsParams) =
            apply {
                campaignGuid = metricGetAttributionMetricsParams.campaignGuid
                endDate = metricGetAttributionMetricsParams.endDate
                startDate = metricGetAttributionMetricsParams.startDate
                additionalHeaders = metricGetAttributionMetricsParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    metricGetAttributionMetricsParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [MetricGetAttributionMetricsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MetricGetAttributionMetricsParams =
            MetricGetAttributionMetricsParams(
                campaignGuid,
                endDate,
                startDate,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MetricGetAttributionMetricsParams &&
    ...
    override fun toString() =
        "MetricGetAttributionMetricsParams{campaignGuid=$campaignGuid, endDate=$endDate, startDate=$startDate, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
