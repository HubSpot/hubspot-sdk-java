...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DropdownField].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dropdownField: DropdownField) = apply {
            defaultValues = dropdownField.defaultValues.map { it.toMutableList() }
            dependentFields = dropdownField.dependentFields.map { it.toMutableList() }
            fieldType = dropdownField.fieldType
            hidden = dropdownField.hidden
            label = dropdownField.label
            name = dropdownField.name
            objectTypeId = dropdownField.objectTypeId
            options = dropdownField.options.map { it.toMutableList() }
            required = dropdownField.required
            description = dropdownField.description
            placeholder = dropdownField.placeholder
            additionalProperties = dropdownField.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DropdownField].
         *
    ...
    fun validate(): DropdownField = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "DropdownField{defaultValues=$defaultValues, dependentFields=$dependentFields, fieldType=$fieldType, hidden=$hidden, label=$label, name=$name, objectTypeId=$objectTypeId, options=$options, required=$required, description=$description, placeholder=$placeholder, additionalProperties=$additionalProperties}"
}
