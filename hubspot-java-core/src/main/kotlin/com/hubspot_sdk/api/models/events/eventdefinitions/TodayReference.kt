...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TodayReference].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(todayReference: TodayReference) = apply {
            referenceType = todayReference.referenceType
            hour = todayReference.hour
            millisecond = todayReference.millisecond
            minute = todayReference.minute
            second = todayReference.second
            additionalProperties = todayReference.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TodayReference].
         *
    ...
    fun validate(): TodayReference = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TodayReference &&
    ...
    override fun toString() =
        "TodayReference{referenceType=$referenceType, hour=$hour, millisecond=$millisecond, minute=$minute, second=$second, additionalProperties=$additionalProperties}"
}
