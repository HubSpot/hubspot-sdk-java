...
class WebhookGetLocalJournalBatchParams
private constructor(
    ...
    companion object {
         ...
         * [WebhookGetLocalJournalBatchParams].
         *
    ...
    /** A builder for [WebhookGetLocalJournalBatchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(webhookGetLocalJournalBatchParams: WebhookGetLocalJournalBatchParams) =
            apply {
                installPortalId = webhookGetLocalJournalBatchParams.installPortalId
                batchInputString = webhookGetLocalJournalBatchParams.batchInputString
                additionalHeaders = webhookGetLocalJournalBatchParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    webhookGetLocalJournalBatchParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [WebhookGetLocalJournalBatchParams].
         *
         ...
         */
        fun build(): WebhookGetLocalJournalBatchParams =
            WebhookGetLocalJournalBatchParams(
                installPortalId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebhookGetLocalJournalBatchParams &&
    ...
    override fun toString() =
        "WebhookGetLocalJournalBatchParams{installPortalId=$installPortalId, batchInputString=$batchInputString, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
