...
/**
 * The URLs of the various actions provided by the video conferencing application. All URLs must use
 * the `https` protocol.
 */
...
private constructor(
    ...
    /**
     * The URL that HubSpot will send updates to existing meetings. Typically called when the user
     * changes the topic or times of a meeting.
     *
     * @throws HubspotInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    ...
    /**
     * The URL that HubSpot will use to verify that a user exists in the video conference
     * application.
     *
     * @throws HubspotInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
    ...
    class Builder internal constructor() {
        ...
        /**
         * The URL that HubSpot will send notifications of meetings that have been deleted in
         * HubSpot.
         */
        ...
        /**
         * The URL that HubSpot will send updates to existing meetings. Typically called when the
         * user changes the topic or times of a meeting.
         */
