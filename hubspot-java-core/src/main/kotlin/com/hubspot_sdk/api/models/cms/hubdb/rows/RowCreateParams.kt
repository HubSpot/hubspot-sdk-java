...
/**
 * Add a new row to a HubDB table. New rows will be added to the draft version of the table. Use the
 * `/publish` endpoint to push these changes to published version.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(rowCreateParams: RowCreateParams) = apply {
            tableIdOrName = rowCreateParams.tableIdOrName
            hubDbTableRowV3Request = rowCreateParams.hubDbTableRowV3Request
    ...
    override fun toString() =
        "RowCreateParams{tableIdOrName=$tableIdOrName, hubDbTableRowV3Request=$hubDbTableRowV3Request, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
