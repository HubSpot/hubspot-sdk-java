...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PropertyListResponse].
         *
    ...
    /** A builder for [PropertyListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(propertyListResponse: PropertyListResponse) = apply {
            results = propertyListResponse.results.map { it.toMutableList() }
            additionalProperties = propertyListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PropertyListResponse].
         *
         ...
         */
        fun build(): PropertyListResponse =
    ...
    fun validate(): PropertyListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        @JsonProperty("calculated")
        @ExcludeMissing
        fun _calculated(): JsonField<Boolean> = calculated
         ...
         *
         * Unlike [createdUserId], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("createdUserId")
        @ExcludeMissing
         ...
         *
         * Unlike [dataSensitivity], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("dataSensitivity")
        @ExcludeMissing
         ...
         *
         * Unlike [dateDisplayHint], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("dateDisplayHint")
        @ExcludeMissing
         ...
         *
         * Unlike [externalOptions], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("externalOptions")
        @ExcludeMissing
         ...
         *
         * Unlike [hubspotDefined], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("hubspotDefined")
        @ExcludeMissing
         ...
         *
         * Unlike [modificationMetadata], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("modificationMetadata")
        @ExcludeMissing
         ...
         *
         * Unlike [referencedObjectType], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("referencedObjectType")
        @ExcludeMissing
         ...
         *
         * Unlike [showCurrencySymbol], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("showCurrencySymbol")
        @ExcludeMissing
         ...
         *
         * Unlike [updatedUserId], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("updatedUserId")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            private var modificationMetadata: JsonField<PropertyModificationMetadata> =
                JsonMissing.of()
            ...
            internal fun from(result: Result) = apply {
                ...
                label = result.label
                name = result.name
                options = result.options.map { it.toMutableList() }
                type = result.type
                ...
                dateDisplayHint = result.dateDisplayHint
                displayOrder = result.displayOrder
                externalOptions = result.externalOptions
                formField = result.formField
                hasUniqueValue = result.hasUniqueValue
                hidden = result.hidden
                hubspotDefined = result.hubspotDefined
                modificationMetadata = result.modificationMetadata
                referencedObjectType = result.referencedObjectType
                sensitiveDataCategories = result.sensitiveDataCategories.map { it.toMutableList() }
                showCurrencySymbol = result.showCurrencySymbol
             ...
             *
             * You should usually call [Builder.calculated] with a well-typed [Boolean] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.createdUserId] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            fun hubspotDefined(hubspotDefined: Boolean) =
                hubspotDefined(JsonField.of(hubspotDefined))
             ...
             * [PropertyModificationMetadata] value instead. This method is primarily for setting
             * the field to an undocumented or not yet supported value.
             */
            fun modificationMetadata(
                modificationMetadata: JsonField<PropertyModificationMetadata>
            ) = apply { this.modificationMetadata = modificationMetadata }
             ...
             *
             * You should usually call [Builder.referencedObjectType] with a well-typed [String]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
             ...
             *
             * You should usually call [Builder.showCurrencySymbol] with a well-typed [Boolean]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
             ...
             *
             * You should usually call [Builder.updatedUserId] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        private constructor(
            ...
            private constructor(
                @JsonProperty("hidden")
                @ExcludeMissing
                hidden: JsonField<Boolean> = JsonMissing.of(),
                @JsonProperty("label") @ExcludeMissing label: JsonField<String> = JsonMissing.of(),
            ...
            class Builder internal constructor() {
                 ...
                 * Sets [Builder.hidden] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.hidden] with a well-typed [Boolean] value
                 ...
                 * Sets [Builder.displayOrder] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.displayOrder] with a well-typed [Int] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun displayOrder(displayOrder: JsonField<Int>) = apply {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PropertyListResponse &&
    ...
    override fun toString() =
        "PropertyListResponse{results=$results, additionalProperties=$additionalProperties}"
}
