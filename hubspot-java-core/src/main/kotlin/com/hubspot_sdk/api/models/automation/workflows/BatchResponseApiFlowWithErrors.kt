...
class BatchResponseApiFlowWithErrors
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val completedAt: JsonField<OffsetDateTime>,
    private val results: JsonField<List<ApiFlow>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<ApiFlow>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<ApiFlow> = results.getRequired("results")
     ...
     */
    @JsonProperty("results") @ExcludeMissing fun _results(): JsonField<List<ApiFlow>> = results
    ...
    /** A builder for [BatchResponseApiFlowWithErrors]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<ApiFlow>>? = null
        ...
        @JvmSynthetic
        internal fun from(batchResponseApiFlowWithErrors: BatchResponseApiFlowWithErrors) = apply {
            completedAt = batchResponseApiFlowWithErrors.completedAt
            results = batchResponseApiFlowWithErrors.results.map { it.toMutableList() }
            startedAt = batchResponseApiFlowWithErrors.startedAt
            status = batchResponseApiFlowWithErrors.status
            errors = batchResponseApiFlowWithErrors.errors.map { it.toMutableList() }
            links = batchResponseApiFlowWithErrors.links
            numErrors = batchResponseApiFlowWithErrors.numErrors
            requestedAt = batchResponseApiFlowWithErrors.requestedAt
            additionalProperties =
                batchResponseApiFlowWithErrors.additionalProperties.toMutableMap()
        }
        ...
        fun results(results: List<ApiFlow>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed `List<ApiFlow>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun results(results: JsonField<List<ApiFlow>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [ApiFlow] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: ApiFlow) = apply {
            results =
        ...
        /** Alias for calling [addResult] with `ApiFlow.ofContact(contact)`. */
        fun addResult(contact: ApiContactFlow) = addResult(ApiFlow.ofContact(contact))

        /** Alias for calling [addResult] with `ApiFlow.ofPlatform(platform)`. */
        fun addResult(platform: ApiPlatformFlow) = addResult(ApiFlow.ofPlatform(platform))
        ...
        /**
         * Returns an immutable instance of [BatchResponseApiFlowWithErrors].
         *
         ...
         */
        fun build(): BatchResponseApiFlowWithErrors =
            BatchResponseApiFlowWithErrors(
    ...
    fun validate(): BatchResponseApiFlowWithErrors = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseApiFlowWithErrors &&
    ...
    override fun toString() =
        "BatchResponseApiFlowWithErrors{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
