...
private constructor(
    private val results: JsonField<List<SubscriptionResponse1>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<SubscriptionResponse1>> = JsonMissing.of()
     ...
     */
    fun results(): List<SubscriptionResponse1> = results.getRequired("results")
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<SubscriptionResponse1>> = results
    ...
    class Builder internal constructor() {
        ...
        private var results: JsonField<MutableList<SubscriptionResponse1>>? = null
         ...
         *
         * You should usually call [Builder.results] with a well-typed `List<SubscriptionResponse1>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun results(results: JsonField<List<SubscriptionResponse1>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [SubscriptionResponse1] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: SubscriptionResponse1) = apply {
            results =
