...
class AssociationSpecWithLabel1
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AssociationSpecWithLabel1].
         *
    ...
    /** A builder for [AssociationSpecWithLabel1]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(associationSpecWithLabel1: AssociationSpecWithLabel1) = apply {
            category = associationSpecWithLabel1.category
            typeId = associationSpecWithLabel1.typeId
            label = associationSpecWithLabel1.label
            additionalProperties = associationSpecWithLabel1.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AssociationSpecWithLabel1].
         *
         ...
         */
        fun build(): AssociationSpecWithLabel1 =
    ...
    fun validate(): AssociationSpecWithLabel1 = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AssociationSpecWithLabel1 &&
    ...
    override fun toString() =
        "AssociationSpecWithLabel1{category=$category, typeId=$typeId, label=$label, additionalProperties=$additionalProperties}"
}
