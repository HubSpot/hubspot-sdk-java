...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PostListAuthorsParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PostListAuthorsParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PostListAuthorsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(postListAuthorsParams: PostListAuthorsParams) = apply {
            after = postListAuthorsParams.after
            archived = postListAuthorsParams.archived
            createdAfter = postListAuthorsParams.createdAfter
            createdAt = postListAuthorsParams.createdAt
            createdBefore = postListAuthorsParams.createdBefore
            limit = postListAuthorsParams.limit
            property = postListAuthorsParams.property
            sort = postListAuthorsParams.sort?.toMutableList()
            updatedAfter = postListAuthorsParams.updatedAfter
            updatedAt = postListAuthorsParams.updatedAt
            updatedBefore = postListAuthorsParams.updatedBefore
            additionalHeaders = postListAuthorsParams.additionalHeaders.toBuilder()
            additionalQueryParams = postListAuthorsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PostListAuthorsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PostListAuthorsParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PostListAuthorsParams &&
            after == other.after &&
    ...
    override fun toString() =
        "PostListAuthorsParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
