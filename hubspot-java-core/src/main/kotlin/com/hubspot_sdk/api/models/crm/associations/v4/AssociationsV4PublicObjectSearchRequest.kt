...
class AssociationsV4PublicObjectSearchRequest
...
private constructor(
    ...
    /** A builder for [AssociationsV4PublicObjectSearchRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            associationsV4PublicObjectSearchRequest: AssociationsV4PublicObjectSearchRequest
        ) = apply {
            after = associationsV4PublicObjectSearchRequest.after
            filterGroups =
                associationsV4PublicObjectSearchRequest.filterGroups.map { it.toMutableList() }
            limit = associationsV4PublicObjectSearchRequest.limit
            properties =
                associationsV4PublicObjectSearchRequest.properties.map { it.toMutableList() }
            sorts = associationsV4PublicObjectSearchRequest.sorts.map { it.toMutableList() }
            query = associationsV4PublicObjectSearchRequest.query
            additionalProperties =
                associationsV4PublicObjectSearchRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AssociationsV4PublicObjectSearchRequest].
         *
         ...
         */
        fun build(): AssociationsV4PublicObjectSearchRequest =
            AssociationsV4PublicObjectSearchRequest(
    ...
    fun validate(): AssociationsV4PublicObjectSearchRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AssociationsV4PublicObjectSearchRequest &&
            after == other.after &&
    ...
    override fun toString() =
        "AssociationsV4PublicObjectSearchRequest{after=$after, filterGroups=$filterGroups, limit=$limit, properties=$properties, sorts=$sorts, query=$query, additionalProperties=$additionalProperties}"
}
