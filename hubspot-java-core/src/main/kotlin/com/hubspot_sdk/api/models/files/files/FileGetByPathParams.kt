...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): FileGetByPathParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [FileGetByPathParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FileGetByPathParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileGetByPathParams: FileGetByPathParams) = apply {
            path = fileGetByPathParams.path
            properties = fileGetByPathParams.properties?.toMutableList()
            additionalHeaders = fileGetByPathParams.additionalHeaders.toBuilder()
            additionalQueryParams = fileGetByPathParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FileGetByPathParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FileGetByPathParams =
            FileGetByPathParams(
                path,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FileGetByPathParams &&
            path == other.path &&
    ...
    override fun toString() =
        "FileGetByPathParams{path=$path, properties=$properties, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
