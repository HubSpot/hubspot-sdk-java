...
private constructor(
    ...
    private val timelineEventTemplateToken: TimelineEventTemplateToken,
    ...
    fun timelineEventTemplateToken(): TimelineEventTemplateToken = timelineEventTemplateToken

    fun _additionalBodyProperties(): Map<String, JsonValue> =
        timelineEventTemplateToken._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        private var timelineEventTemplateToken: TimelineEventTemplateToken? = null
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        @JvmSynthetic
        internal fun from(tokenCreateParams: TokenCreateParams) = apply {
            appId = tokenCreateParams.appId
            eventTemplateId = tokenCreateParams.eventTemplateId
            timelineEventTemplateToken = tokenCreateParams.timelineEventTemplateToken
        ...
        fun timelineEventTemplateToken(timelineEventTemplateToken: TimelineEventTemplateToken) =
            apply {
                this.timelineEventTemplateToken = timelineEventTemplateToken
            }
        ...
        fun build(): TokenCreateParams =
            TokenCreateParams(
                ...
                eventTemplateId,
                checkRequired("timelineEventTemplateToken", timelineEventTemplateToken),
                additionalHeaders.build(),
                additionalQueryParams.build(),
            )
    }

    fun _body(): TimelineEventTemplateToken = timelineEventTemplateToken
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TokenCreateParams &&
            ...
            timelineEventTemplateToken == other.timelineEventTemplateToken &&
    ...
    override fun toString() =
        "TokenCreateParams{appId=$appId, eventTemplateId=$eventTemplateId, timelineEventTemplateToken=$timelineEventTemplateToken, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
