...
/**
 * Returns rows in the draft version of the specified table. Row results can be filtered and sorted.
 * Filtering and sorting options will be sent as query parameters to the API request. For example,
 * by adding the query parameters `column1__gt=5&sort=-column1`, API returns the rows with values
 * for column `column1` greater than 5 and in the descending order of `column1` values. Refer to the
...
private constructor(
    ...
    /**
     * Specify the column names to get results containing only the required columns instead of all
     * column details. If you want to include multiple columns in the result, use this query param
     * as many times.
     */
    ...
    companion object {
        ...
        @JvmStatic fun none(): RowListDraftParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [RowListDraftParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [RowListDraftParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rowListDraftParams: RowListDraftParams) = apply {
            tableIdOrName = rowListDraftParams.tableIdOrName
            after = rowListDraftParams.after
            archived = rowListDraftParams.archived
            limit = rowListDraftParams.limit
            offset = rowListDraftParams.offset
            properties = rowListDraftParams.properties?.toMutableList()
            sort = rowListDraftParams.sort?.toMutableList()
            additionalHeaders = rowListDraftParams.additionalHeaders.toBuilder()
            additionalQueryParams = rowListDraftParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Specify the column names to get results containing only the required columns instead of
         * all column details. If you want to include multiple columns in the result, use this query
         * param as many times.
         */
        ...
        /**
         * Returns an immutable instance of [RowListDraftParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RowListDraftParams =
            RowListDraftParams(
                tableIdOrName,
                after,
                archived,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RowListDraftParams &&
    ...
    override fun toString() =
        "RowListDraftParams{tableIdOrName=$tableIdOrName, after=$after, archived=$archived, limit=$limit, offset=$offset, properties=$properties, sort=$sort, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
