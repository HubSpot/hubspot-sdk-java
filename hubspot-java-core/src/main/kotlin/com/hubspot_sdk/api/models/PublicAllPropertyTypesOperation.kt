...
private constructor(
    ...
    ) : this(includeObjectsWithNoValueSet, operationType, operator, mutableMapOf())
    ...
    /** A builder for [PublicAllPropertyTypesOperation]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicAllPropertyTypesOperation: PublicAllPropertyTypesOperation) =
            apply {
                includeObjectsWithNoValueSet =
                    publicAllPropertyTypesOperation.includeObjectsWithNoValueSet
                operationType = publicAllPropertyTypesOperation.operationType
                operator = publicAllPropertyTypesOperation.operator
                additionalProperties =
                    publicAllPropertyTypesOperation.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [PublicAllPropertyTypesOperation].
         *
         ...
         */
        fun build(): PublicAllPropertyTypesOperation =
            PublicAllPropertyTypesOperation(
    ...
    fun validate(): PublicAllPropertyTypesOperation = apply {
        if (validated) {
            return@apply
        }
    ...
    class OperationType @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            @JvmField val ALL_PROPERTY = of("ALL_PROPERTY")
        ...
        fun value(): Value =
            when (this) {
                ALL_PROPERTY -> Value.ALL_PROPERTY
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                ALL_PROPERTY -> Known.ALL_PROPERTY
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicAllPropertyTypesOperation &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(includeObjectsWithNoValueSet, operationType, operator, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "PublicAllPropertyTypesOperation{includeObjectsWithNoValueSet=$includeObjectsWithNoValueSet, operationType=$operationType, operator=$operator, additionalProperties=$additionalProperties}"
}
