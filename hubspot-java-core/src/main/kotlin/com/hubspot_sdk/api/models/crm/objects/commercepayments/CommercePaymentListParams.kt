...
class CommercePaymentListParams
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of commerce payments
    ...
    companion object {
        ...
        @JvmStatic fun none(): CommercePaymentListParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [CommercePaymentListParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CommercePaymentListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(commercePaymentListParams: CommercePaymentListParams) = apply {
            after = commercePaymentListParams.after
            archived = commercePaymentListParams.archived
            associations = commercePaymentListParams.associations?.toMutableList()
            limit = commercePaymentListParams.limit
            properties = commercePaymentListParams.properties?.toMutableList()
            propertiesWithHistory = commercePaymentListParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = commercePaymentListParams.additionalHeaders.toBuilder()
            additionalQueryParams = commercePaymentListParams.additionalQueryParams.toBuilder()
        }
         ...
         * of commerce payments that can be read by a single request.
         */
        ...
        /**
         * Returns an immutable instance of [CommercePaymentListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CommercePaymentListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CommercePaymentListParams &&
            after == other.after &&
    ...
    override fun toString() =
        "CommercePaymentListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
