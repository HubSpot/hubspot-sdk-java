...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicChannel: PublicChannel) = apply {
            id = publicChannel.id
            name = publicChannel.name
            additionalProperties = publicChannel.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): PublicChannel = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "PublicChannel{id=$id, name=$name, additionalProperties=$additionalProperties}"
}
