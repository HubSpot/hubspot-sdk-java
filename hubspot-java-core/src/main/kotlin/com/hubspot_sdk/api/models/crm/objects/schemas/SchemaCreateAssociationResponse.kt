...
class SchemaCreateAssociationResponse
...
private constructor(
    ...
    /** A builder for [SchemaCreateAssociationResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(schemaCreateAssociationResponse: SchemaCreateAssociationResponse) =
            apply {
                id = schemaCreateAssociationResponse.id
                allowsCustomLabels = schemaCreateAssociationResponse.allowsCustomLabels
                cardinality = schemaCreateAssociationResponse.cardinality
                category = schemaCreateAssociationResponse.category
                fromObjectTypeId = schemaCreateAssociationResponse.fromObjectTypeId
                hasAllAssociatedObjects = schemaCreateAssociationResponse.hasAllAssociatedObjects
                hasCascadingDeletes = schemaCreateAssociationResponse.hasCascadingDeletes
                hasUserEnforcedMaxFromObjectIds =
                    schemaCreateAssociationResponse.hasUserEnforcedMaxFromObjectIds
                hasUserEnforcedMaxToObjectIds =
                    schemaCreateAssociationResponse.hasUserEnforcedMaxToObjectIds
                hidden = schemaCreateAssociationResponse.hidden
                inverseAllowsCustomLabels =
                    schemaCreateAssociationResponse.inverseAllowsCustomLabels
                inverseCardinality = schemaCreateAssociationResponse.inverseCardinality
                inverseHasAllAssociatedObjects =
                    schemaCreateAssociationResponse.inverseHasAllAssociatedObjects
                inverseId = schemaCreateAssociationResponse.inverseId
                inverseName = schemaCreateAssociationResponse.inverseName
                isInversePrimary = schemaCreateAssociationResponse.isInversePrimary
                isPrimary = schemaCreateAssociationResponse.isPrimary
                maxFromObjectIds = schemaCreateAssociationResponse.maxFromObjectIds
                maxToObjectIds = schemaCreateAssociationResponse.maxToObjectIds
                name = schemaCreateAssociationResponse.name
                portalUniqueIdentifier = schemaCreateAssociationResponse.portalUniqueIdentifier
                toObjectTypeId = schemaCreateAssociationResponse.toObjectTypeId
                fromObjectType = schemaCreateAssociationResponse.fromObjectType
                inverseLabel = schemaCreateAssociationResponse.inverseLabel
                label = schemaCreateAssociationResponse.label
                toObjectType = schemaCreateAssociationResponse.toObjectType
                additionalProperties =
                    schemaCreateAssociationResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SchemaCreateAssociationResponse].
         *
         ...
         */
        fun build(): SchemaCreateAssociationResponse =
            SchemaCreateAssociationResponse(
                checkRequired("id", id),
    ...
    fun validate(): SchemaCreateAssociationResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SchemaCreateAssociationResponse &&
            id == other.id &&
