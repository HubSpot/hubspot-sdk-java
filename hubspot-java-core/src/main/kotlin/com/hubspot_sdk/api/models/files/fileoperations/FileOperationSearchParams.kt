...
class FileOperationSearchParams
private constructor(
    ...
    /**
     * Search files by less than or equal to expires time. Can be used with `expiresAtGte` to create
     * a range.
     */
    ...
    /**
     * If `true`, shows files that have been marked to be used in new content. If `false`, shows
     * files that should not be used in new content.
     */
    ...
    companion object {
        ...
        @JvmStatic fun none(): FileOperationSearchParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [FileOperationSearchParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FileOperationSearchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileOperationSearchParams: FileOperationSearchParams) = apply {
            after = fileOperationSearchParams.after
            allowsAnonymousAccess = fileOperationSearchParams.allowsAnonymousAccess
            before = fileOperationSearchParams.before
            createdAt = fileOperationSearchParams.createdAt
            createdAtGte = fileOperationSearchParams.createdAtGte
            createdAtLte = fileOperationSearchParams.createdAtLte
            encoding = fileOperationSearchParams.encoding
            expiresAt = fileOperationSearchParams.expiresAt
            expiresAtGte = fileOperationSearchParams.expiresAtGte
            expiresAtLte = fileOperationSearchParams.expiresAtLte
            extension = fileOperationSearchParams.extension
            fileMd5 = fileOperationSearchParams.fileMd5
            height = fileOperationSearchParams.height
            heightGte = fileOperationSearchParams.heightGte
            heightLte = fileOperationSearchParams.heightLte
            idGte = fileOperationSearchParams.idGte
            idLte = fileOperationSearchParams.idLte
            ids = fileOperationSearchParams.ids?.toMutableList()
            isUsableInContent = fileOperationSearchParams.isUsableInContent
            limit = fileOperationSearchParams.limit
            name = fileOperationSearchParams.name
            parentFolderIds = fileOperationSearchParams.parentFolderIds?.toMutableList()
            path = fileOperationSearchParams.path
            properties = fileOperationSearchParams.properties?.toMutableList()
            size = fileOperationSearchParams.size
            sizeGte = fileOperationSearchParams.sizeGte
            sizeLte = fileOperationSearchParams.sizeLte
            sort = fileOperationSearchParams.sort?.toMutableList()
            type = fileOperationSearchParams.type
            updatedAt = fileOperationSearchParams.updatedAt
            updatedAtGte = fileOperationSearchParams.updatedAtGte
            updatedAtLte = fileOperationSearchParams.updatedAtLte
            url = fileOperationSearchParams.url
            width = fileOperationSearchParams.width
            widthGte = fileOperationSearchParams.widthGte
            widthLte = fileOperationSearchParams.widthLte
            additionalHeaders = fileOperationSearchParams.additionalHeaders.toBuilder()
            additionalQueryParams = fileOperationSearchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Search files by access. If `true`, will show only public files. If `false`, will show
         * only private files.
         */
        ...
        /**
         * Search files by greater than or equal to file size. Can be used with `sizeLte` to create
         * a range.
         */
        ...
        /**
         * Returns an immutable instance of [FileOperationSearchParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FileOperationSearchParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FileOperationSearchParams &&
            after == other.after &&
