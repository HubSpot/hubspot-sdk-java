...
package com.hubspot_sdk.api.models.crm.objects.fees
...
/**
 * Read an Object identified by `{feeId}`. `{feeId}` refers to the internal object ID by default, or
 * optionally any unique property value as specified by the `idProperty` query param. Control what
 * is returned via the `properties` query param.
 */
class FeeGetParams
private constructor(
    ...
    fun feeId(): Optional<String> = Optional.ofNullable(feeId)
    ...
    companion object {
        ...
        @JvmStatic fun none(): FeeGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [FeeGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FeeGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(feeGetParams: FeeGetParams) = apply {
            feeId = feeGetParams.feeId
            archived = feeGetParams.archived
            associations = feeGetParams.associations?.toMutableList()
            idProperty = feeGetParams.idProperty
            properties = feeGetParams.properties?.toMutableList()
            propertiesWithHistory = feeGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = feeGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = feeGetParams.additionalQueryParams.toBuilder()
        }

        fun feeId(feeId: String?) = apply { this.feeId = feeId }

        /** Alias for calling [Builder.feeId] with `feeId.orElse(null)`. */
        fun feeId(feeId: Optional<String>) = feeId(feeId.getOrNull())
        ...
        /**
         * Returns an immutable instance of [FeeGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FeeGetParams =
            FeeGetParams(
                feeId,
                archived,
    ...
    override fun toString() =
        "FeeGetParams{feeId=$feeId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
