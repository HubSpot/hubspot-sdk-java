...
class IntegratorSettingUpdateAppNameParams
private constructor(
    ...
    /** A builder for [IntegratorSettingUpdateAppNameParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            integratorSettingUpdateAppNameParams: IntegratorSettingUpdateAppNameParams
        ) = apply {
            appId = integratorSettingUpdateAppNameParams.appId
            mediaBridgeProviderPartial =
                integratorSettingUpdateAppNameParams.mediaBridgeProviderPartial
            additionalHeaders = integratorSettingUpdateAppNameParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                integratorSettingUpdateAppNameParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [IntegratorSettingUpdateAppNameParams].
         *
         ...
         */
        fun build(): IntegratorSettingUpdateAppNameParams =
            IntegratorSettingUpdateAppNameParams(
                appId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IntegratorSettingUpdateAppNameParams &&
            appId == other.appId &&
    ...
    override fun toString() =
        "IntegratorSettingUpdateAppNameParams{appId=$appId, mediaBridgeProviderPartial=$mediaBridgeProviderPartial, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
