...
private constructor(
    ...
    private val blogAuthorId: JsonField<String>,
    ...
    private val enableGoogleAmpOutputOverride: JsonField<Boolean>,
    ...
    private val postBody: JsonField<String>,
    private val postSummary: JsonField<String>,
    ...
    private val rssBody: JsonField<String>,
    private val rssSummary: JsonField<String>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        blogAuthorId: JsonField<String> = JsonMissing.of(),
        ...
        @ExcludeMissing
        enableGoogleAmpOutputOverride: JsonField<Boolean> = JsonMissing.of(),
        ...
        @JsonProperty("postBody") @ExcludeMissing postBody: JsonField<String> = JsonMissing.of(),
        @JsonProperty("postSummary")
        @ExcludeMissing
        postSummary: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("rssBody") @ExcludeMissing rssBody: JsonField<String> = JsonMissing.of(),
        @JsonProperty("rssSummary")
        @ExcludeMissing
        rssSummary: JsonField<String> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun archivedAt(): Long = archivedAt.getRequired("archivedAt")
    ...
    /**
     * List of stylesheets to attach to this blog post. These stylesheets are attached to just this
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun enableGoogleAmpOutputOverride(): Boolean =
        enableGoogleAmpOutputOverride.getRequired("enableGoogleAmpOutputOverride")
    ...
    /**
     * The URL this blog post's url should redirect to once it expires. Should only set this or
     * pageExpiryRedirectId.
     *
     * @throws HubSpotInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun postBody(): String = postBody.getRequired("postBody")
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun postSummary(): String = postSummary.getRequired("postSummary")
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun rssBody(): String = rssBody.getRequired("rssBody")
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun tagIds(): List<Long> = tagIds.getRequired("tagIds")
    ...
    /**
     * Returns the raw JSON value of [blogAuthorId].
     *
     * Unlike [blogAuthorId], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("blogAuthorId")
    @ExcludeMissing
    fun _blogAuthorId(): JsonField<String> = blogAuthorId
    ...
    /**
     * Returns the raw JSON value of [enableGoogleAmpOutputOverride].
     *
     * Unlike [enableGoogleAmpOutputOverride], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("enableGoogleAmpOutputOverride")
    @ExcludeMissing
    fun _enableGoogleAmpOutputOverride(): JsonField<Boolean> = enableGoogleAmpOutputOverride
    ...
    /**
     * Returns the raw JSON value of [postBody].
     *
     * Unlike [postBody], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("postBody") @ExcludeMissing fun _postBody(): JsonField<String> = postBody

    /**
     * Returns the raw JSON value of [postSummary].
     *
     * Unlike [postSummary], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("postSummary") @ExcludeMissing fun _postSummary(): JsonField<String> = postSummary
    ...
    /**
     * Returns the raw JSON value of [rssBody].
     *
     * Unlike [rssBody], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("rssBody") @ExcludeMissing fun _rssBody(): JsonField<String> = rssBody

    /**
     * Returns the raw JSON value of [rssSummary].
     *
     * Unlike [rssSummary], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("rssSummary") @ExcludeMissing fun _rssSummary(): JsonField<String> = rssSummary
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BlogPost].
         *
    ...
    class Builder internal constructor() {
        ...
        private var blogAuthorId: JsonField<String>? = null
        ...
        private var enableGoogleAmpOutputOverride: JsonField<Boolean>? = null
        ...
        private var postBody: JsonField<String>? = null
        private var postSummary: JsonField<String>? = null
        ...
        private var rssBody: JsonField<String>? = null
        private var rssSummary: JsonField<String>? = null
        ...
        @JvmSynthetic
        internal fun from(blogPost: BlogPost) = apply {
            id = blogPost.id
            abStatus = blogPost.abStatus
            abTestId = blogPost.abTestId
            archivedAt = blogPost.archivedAt
            archivedInDashboard = blogPost.archivedInDashboard
            attachedStylesheets = blogPost.attachedStylesheets.map { it.toMutableList() }
            authorName = blogPost.authorName
            blogAuthorId = blogPost.blogAuthorId
            campaign = blogPost.campaign
            categoryId = blogPost.categoryId
            contentGroupId = blogPost.contentGroupId
            contentTypeCategory = blogPost.contentTypeCategory
            created = blogPost.created
            createdById = blogPost.createdById
            currentlyPublished = blogPost.currentlyPublished
            currentState = blogPost.currentState
            domain = blogPost.domain
            dynamicPageDataSourceId = blogPost.dynamicPageDataSourceId
            dynamicPageDataSourceType = blogPost.dynamicPageDataSourceType
            dynamicPageHubDbTableId = blogPost.dynamicPageHubDbTableId
            enableDomainStylesheets = blogPost.enableDomainStylesheets
            enableGoogleAmpOutputOverride = blogPost.enableGoogleAmpOutputOverride
            enableLayoutStylesheets = blogPost.enableLayoutStylesheets
            featuredImage = blogPost.featuredImage
            featuredImageAltText = blogPost.featuredImageAltText
            folderId = blogPost.folderId
            footerHtml = blogPost.footerHtml
            headHtml = blogPost.headHtml
            htmlTitle = blogPost.htmlTitle
            includeDefaultCustomCss = blogPost.includeDefaultCustomCss
            language = blogPost.language
            layoutSections = blogPost.layoutSections
            linkRelCanonicalUrl = blogPost.linkRelCanonicalUrl
            mabExperimentId = blogPost.mabExperimentId
            metaDescription = blogPost.metaDescription
            name = blogPost.name
            pageExpiryDate = blogPost.pageExpiryDate
            pageExpiryEnabled = blogPost.pageExpiryEnabled
            pageExpiryRedirectId = blogPost.pageExpiryRedirectId
            pageExpiryRedirectUrl = blogPost.pageExpiryRedirectUrl
            password = blogPost.password
            postBody = blogPost.postBody
            postSummary = blogPost.postSummary
            publicAccessRules = blogPost.publicAccessRules.map { it.toMutableList() }
            publicAccessRulesEnabled = blogPost.publicAccessRulesEnabled
            publishDate = blogPost.publishDate
            publishImmediately = blogPost.publishImmediately
            rssBody = blogPost.rssBody
            rssSummary = blogPost.rssSummary
            slug = blogPost.slug
            state = blogPost.state
            tagIds = blogPost.tagIds.map { it.toMutableList() }
            themeSettingsValues = blogPost.themeSettingsValues
            ...
            url = blogPost.url
            useFeaturedImage = blogPost.useFeaturedImage
            widgetContainers = blogPost.widgetContainers
            widgets = blogPost.widgets
        ...
        /**
         * If True, the post will not show up in your dashboard, although the post could still be
         * live.
         */
        ...
        /**
         * List of stylesheets to attach to this blog post. These stylesheets are attached to just
         * this page. Order of precedence is bottom to top, just like in the HTML.
         */
        ...
        /**
         * Sets [Builder.blogAuthorId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.blogAuthorId] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun blogAuthorId(blogAuthorId: JsonField<String>) = apply {
        ...
        /**
         * A generated ENUM descibing the current state of this Blog Post. Should always match
         * state.
         */
        ...
        /** Boolean to allow overriding the AMP settings for the blog. */
        fun enableGoogleAmpOutputOverride(enableGoogleAmpOutputOverride: Boolean) =
            enableGoogleAmpOutputOverride(JsonField.of(enableGoogleAmpOutputOverride))

        /**
         * Sets [Builder.enableGoogleAmpOutputOverride] to an arbitrary JSON value.
         *
         * You should usually call [Builder.enableGoogleAmpOutputOverride] with a well-typed
         * [Boolean] value instead. This method is primarily for setting the field to an
         * undocumented or not yet supported value.
         */
        fun enableGoogleAmpOutputOverride(enableGoogleAmpOutputOverride: JsonField<Boolean>) =
            apply {
        ...
        /**
         * The date at which this blog post should expire and begin redirecting to another url or
         * page.
         */
        ...
        /**
         * The ID of another page this blog post's url should redirect to once this blog post
        ...
        /** The HTML of the main post body. */
        fun postBody(postBody: String) = postBody(JsonField.of(postBody))

        /**
         * Sets [Builder.postBody] to an arbitrary JSON value.
         *
         * You should usually call [Builder.postBody] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun postBody(postBody: JsonField<String>) = apply { this.postBody = postBody }

        /** The summary of the blog post that will appear on the main listing page. */
        fun postSummary(postSummary: String) = postSummary(JsonField.of(postSummary))

        /**
         * Sets [Builder.postSummary] to an arbitrary JSON value.
         *
         * You should usually call [Builder.postSummary] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun postSummary(postSummary: JsonField<String>) = apply { this.postSummary = postSummary }
        ...
        /** The contents of the RSS body for this Blog Post. */
        fun rssBody(rssBody: String) = rssBody(JsonField.of(rssBody))

        /**
         * Sets [Builder.rssBody] to an arbitrary JSON value.
         *
         * You should usually call [Builder.rssBody] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun rssBody(rssBody: JsonField<String>) = apply { this.rssBody = rssBody }

        /** The contents of the RSS summary for this Blog Post. */
        fun rssSummary(rssSummary: String) = rssSummary(JsonField.of(rssSummary))

        /**
         * Sets [Builder.rssSummary] to an arbitrary JSON value.
         *
         * You should usually call [Builder.rssSummary] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        ...
        /**
         * A map of translations for the blog post, each associated with a specific language
         * variation.
         */
         ...
         * post. This will only be populated if the page has widget containers.
         */
        ...
        /**
         * Returns an immutable instance of [BlogPost].
         *
        ...
        fun build(): BlogPost =
            BlogPost(
                ...
                checkRequired("blogAuthorId", blogAuthorId),
                ...
                checkRequired("enableGoogleAmpOutputOverride", enableGoogleAmpOutputOverride),
                ...
                checkRequired("postBody", postBody),
                checkRequired("postSummary", postSummary),
                ...
                checkRequired("rssBody", rssBody),
                checkRequired("rssSummary", rssSummary),
                checkRequired("slug", slug),
                checkRequired("state", state),
                checkRequired("tagIds", tagIds).map { it.toImmutable() },
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (if (blogAuthorId.asKnown().isPresent) 1 else 0) +
            ...
            (if (enableGoogleAmpOutputOverride.asKnown().isPresent) 1 else 0) +
            ...
            (if (postBody.asKnown().isPresent) 1 else 0) +
            (if (postSummary.asKnown().isPresent) 1 else 0) +
            ...
            (if (rssBody.asKnown().isPresent) 1 else 0) +
            (if (rssSummary.asKnown().isPresent) 1 else 0) +
    ...
    private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val _16 = of("16")

            @JvmField val _17 = of("17")

            @JvmField val _18 = of("18")

            @JvmField val _19 = of("19")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BlogPost &&
            ...
            blogAuthorId == other.blogAuthorId &&
            ...
            enableGoogleAmpOutputOverride == other.enableGoogleAmpOutputOverride &&
            ...
            rssBody == other.rssBody &&
            rssSummary == other.rssSummary &&
            slug == other.slug &&
            state == other.state &&
            tagIds == other.tagIds &&
    ...
    override fun toString() =
        "BlogPost{id=$id, abStatus=$abStatus, abTestId=$abTestId, archivedAt=$archivedAt, archivedInDashboard=$archivedInDashboard, attachedStylesheets=$attachedStylesheets, authorName=$authorName, blogAuthorId=$blogAuthorId, campaign=$campaign, categoryId=$categoryId, contentGroupId=$contentGroupId, contentTypeCategory=$contentTypeCategory, created=$created, createdById=$createdById, currentlyPublished=$currentlyPublished, currentState=$currentState, domain=$domain, dynamicPageDataSourceId=$dynamicPageDataSourceId, dynamicPageDataSourceType=$dynamicPageDataSourceType, dynamicPageHubDbTableId=$dynamicPageHubDbTableId, enableDomainStylesheets=$enableDomainStylesheets, enableGoogleAmpOutputOverride=$enableGoogleAmpOutputOverride, enableLayoutStylesheets=$enableLayoutStylesheets, featuredImage=$featuredImage, featuredImageAltText=$featuredImageAltText, folderId=$folderId, footerHtml=$footerHtml, headHtml=$headHtml, htmlTitle=$htmlTitle, includeDefaultCustomCss=$includeDefaultCustomCss, language=$language, layoutSections=$layoutSections, linkRelCanonicalUrl=$linkRelCanonicalUrl, mabExperimentId=$mabExperimentId, metaDescription=$metaDescription, name=$name, pageExpiryDate=$pageExpiryDate, pageExpiryEnabled=$pageExpiryEnabled, pageExpiryRedirectId=$pageExpiryRedirectId, pageExpiryRedirectUrl=$pageExpiryRedirectUrl, password=$password, postBody=$postBody, postSummary=$postSummary, publicAccessRules=$publicAccessRules, publicAccessRulesEnabled=$publicAccessRulesEnabled, publishDate=$publishDate, publishImmediately=$publishImmediately, rssBody=$rssBody, rssSummary=$rssSummary, slug=$slug, state=$state, tagIds=$tagIds, themeSettingsValues=$themeSettingsValues, translatedFromId=$translatedFromId, translations=$translations, updated=$updated, updatedById=$updatedById, url=$url, useFeaturedImage=$useFeaturedImage, widgetContainers=$widgetContainers, widgets=$widgets, additionalProperties=$additionalProperties}"
}
