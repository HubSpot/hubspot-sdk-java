...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PropertyGetBatchParams].
         *
    ...
    /** A builder for [PropertyGetBatchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(propertyGetBatchParams: PropertyGetBatchParams) = apply {
            appId = propertyGetBatchParams.appId
            objectType = propertyGetBatchParams.objectType
            batchReadInputPropertyName = propertyGetBatchParams.batchReadInputPropertyName
            additionalHeaders = propertyGetBatchParams.additionalHeaders.toBuilder()
            additionalQueryParams = propertyGetBatchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PropertyGetBatchParams].
         *
         ...
         */
        fun build(): PropertyGetBatchParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PropertyGetBatchParams &&
            appId == other.appId &&
    ...
    override fun toString() =
        "PropertyGetBatchParams{appId=$appId, objectType=$objectType, batchReadInputPropertyName=$batchReadInputPropertyName, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
