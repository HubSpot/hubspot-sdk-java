...
class CreateOtherObjectRequest
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CreateOtherObjectRequest].
         *
    ...
    /** A builder for [CreateOtherObjectRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(createOtherObjectRequest: CreateOtherObjectRequest) = apply {
            mediaType = createOtherObjectRequest.mediaType
            title = createOtherObjectRequest.title
            detailsPageLink = createOtherObjectRequest.detailsPageLink
            duration = createOtherObjectRequest.duration
            externalId = createOtherObjectRequest.externalId
            fileUrl = createOtherObjectRequest.fileUrl
            oembedUrl = createOtherObjectRequest.oembedUrl
            posterUrl = createOtherObjectRequest.posterUrl
            thumbnailUrl = createOtherObjectRequest.thumbnailUrl
            additionalProperties = createOtherObjectRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CreateOtherObjectRequest].
         *
         ...
         */
        fun build(): CreateOtherObjectRequest =
    ...
    fun validate(): CreateOtherObjectRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CreateOtherObjectRequest &&
    ...
    override fun toString() =
        "CreateOtherObjectRequest{mediaType=$mediaType, title=$title, detailsPageLink=$detailsPageLink, duration=$duration, externalId=$externalId, fileUrl=$fileUrl, oembedUrl=$oembedUrl, posterUrl=$posterUrl, thumbnailUrl=$thumbnailUrl, additionalProperties=$additionalProperties}"
}
