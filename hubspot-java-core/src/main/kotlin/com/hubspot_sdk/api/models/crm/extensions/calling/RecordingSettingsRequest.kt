...
private constructor(
     ...
     */
    fun urlToRetrieveAuthedRecording(): String =
        urlToRetrieveAuthedRecording.getRequired("urlToRetrieveAuthedRecording")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RecordingSettingsRequest].
         *
    ...
    /** A builder for [RecordingSettingsRequest]. */
    class Builder internal constructor() {

        private var urlToRetrieveAuthedRecording: JsonField<String>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(recordingSettingsRequest: RecordingSettingsRequest) = apply {
            urlToRetrieveAuthedRecording = recordingSettingsRequest.urlToRetrieveAuthedRecording
            additionalProperties = recordingSettingsRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RecordingSettingsRequest].
         *
         ...
         */
        fun build(): RecordingSettingsRequest =
            RecordingSettingsRequest(
                checkRequired("urlToRetrieveAuthedRecording", urlToRetrieveAuthedRecording),
    ...
    fun validate(): RecordingSettingsRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RecordingSettingsRequest &&
    ...
    override fun toString() =
        "RecordingSettingsRequest{urlToRetrieveAuthedRecording=$urlToRetrieveAuthedRecording, additionalProperties=$additionalProperties}"
}
