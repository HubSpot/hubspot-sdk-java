...
class BatchResponsePublicCampaignWithAssets
...
private constructor(
    ...
    /**
     * An array of results from the batch operation, each representing a public campaign with
     * assets.
     *
     * @throws HubspotInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
    ...
    /**
     * An array of errors encountered during the batch operation, each described by a StandardError
     * object.
     *
    ...
    /**
     * A map of link names to associated URIs that provide additional information about the batch
     * operation.
     *
     * @throws HubspotInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
    ...
    /** A builder for [BatchResponsePublicCampaignWithAssets]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            batchResponsePublicCampaignWithAssets: BatchResponsePublicCampaignWithAssets
        ) = apply {
            completedAt = batchResponsePublicCampaignWithAssets.completedAt
            results = batchResponsePublicCampaignWithAssets.results.map { it.toMutableList() }
            startedAt = batchResponsePublicCampaignWithAssets.startedAt
            status = batchResponsePublicCampaignWithAssets.status
            errors = batchResponsePublicCampaignWithAssets.errors.map { it.toMutableList() }
            links = batchResponsePublicCampaignWithAssets.links
            numErrors = batchResponsePublicCampaignWithAssets.numErrors
            requestedAt = batchResponsePublicCampaignWithAssets.requestedAt
            additionalProperties =
                batchResponsePublicCampaignWithAssets.additionalProperties.toMutableMap()
        }
        ...
        /**
         * A map of link names to associated URIs that provide additional information about the
         * batch operation.
         */
        ...
        /**
         * Returns an immutable instance of [BatchResponsePublicCampaignWithAssets].
         *
         ...
         */
        fun build(): BatchResponsePublicCampaignWithAssets =
            BatchResponsePublicCampaignWithAssets(
    ...
    fun validate(): BatchResponsePublicCampaignWithAssets = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponsePublicCampaignWithAssets &&
    ...
    override fun toString() =
        "BatchResponsePublicCampaignWithAssets{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
