...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DatepickerField].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(datepickerField: DatepickerField) = apply {
            dependentFields = datepickerField.dependentFields.map { it.toMutableList() }
            fieldType = datepickerField.fieldType
            hidden = datepickerField.hidden
            label = datepickerField.label
            name = datepickerField.name
            objectTypeId = datepickerField.objectTypeId
            required = datepickerField.required
            defaultValue = datepickerField.defaultValue
            description = datepickerField.description
            placeholder = datepickerField.placeholder
            additionalProperties = datepickerField.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DatepickerField].
         *
    ...
    fun validate(): DatepickerField = apply {
        if (validated) {
            return@apply
        }
    ...
    class FieldType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val DATEPICKER = of("datepicker")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DatepickerField &&
    ...
    override fun toString() =
        "DatepickerField{dependentFields=$dependentFields, fieldType=$fieldType, hidden=$hidden, label=$label, name=$name, objectTypeId=$objectTypeId, required=$required, defaultValue=$defaultValue, description=$description, placeholder=$placeholder, additionalProperties=$additionalProperties}"
}
