...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of calls that can be
    ...
    class Builder internal constructor() {
        ...
        internal fun from(callListParams: CallListParams) = apply {
            after = callListParams.after
            archived = callListParams.archived
            associations = callListParams.associations?.toMutableList()
            limit = callListParams.limit
            properties = callListParams.properties?.toMutableList()
            propertiesWithHistory = callListParams.propertiesWithHistory?.toMutableList()
         ...
         * of calls that can be read by a single request.
         */
    ...
    override fun toString() =
        "CallListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
