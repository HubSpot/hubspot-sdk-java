...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(isEngagementType: IsEngagementType) = apply {
            ...
            inputs = isEngagementType.inputs.map { it.toMutableList() }
    ...
    override fun toString() =
        "IsEngagementType{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
