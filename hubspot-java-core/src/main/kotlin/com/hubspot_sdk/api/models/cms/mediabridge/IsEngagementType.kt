...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IsEngagementType].
         *
    ...
    /** A builder for [IsEngagementType]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(isEngagementType: IsEngagementType) = apply {
            operator = isEngagementType.operator
            propertyName = isEngagementType.propertyName
            value = isEngagementType.value
            additionalProperties = isEngagementType.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IsEngagementType].
         *
    ...
    fun validate(): IsEngagementType = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val IS_ENGAGEMENT_TYPE = of("IS_ENGAGEMENT_TYPE")
        ...
        fun value(): Value =
            when (this) {
                IS_ENGAGEMENT_TYPE -> Value.IS_ENGAGEMENT_TYPE
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                IS_ENGAGEMENT_TYPE -> Known.IS_ENGAGEMENT_TYPE
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IsEngagementType &&
    ...
    override fun toString() =
        "IsEngagementType{operator=$operator, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
