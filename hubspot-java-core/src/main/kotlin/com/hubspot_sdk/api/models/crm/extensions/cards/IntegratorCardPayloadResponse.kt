...
/**
 * The card details payload, sent to HubSpot by an app in response to a data fetch request when a
 * user visits a CRM record page.
 */
...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun responseVersion(): Optional<ResponseVersion> =
        responseVersion.getOptional("responseVersion")
     ...
     *   server responded with an unexpected value).
     */
    fun sections(): Optional<List<IntegratorObjectResult>> = sections.getOptional("sections")
    ...
    class Builder internal constructor() {
        ...
        private var responseVersion: JsonField<ResponseVersion> = JsonMissing.of()
    ...
    fun validate(): IntegratorCardPayloadResponse = apply {
        ...
        allItemsLinkUrl()
        cardLabel()
        responseVersion().ifPresent { it.validate() }
    ...
    override fun toString() =
        "IntegratorCardPayloadResponse{totalCount=$totalCount, allItemsLinkUrl=$allItemsLinkUrl, cardLabel=$cardLabel, responseVersion=$responseVersion, sections=$sections, topLevelActions=$topLevelActions, additionalProperties=$additionalProperties}"
}
