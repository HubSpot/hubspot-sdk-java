...
private constructor(
    ...
    private val bio: JsonField<String>,
    private val created: JsonField<OffsetDateTime>,
    private val deletedAt: JsonField<OffsetDateTime>,
    private val displayName: JsonField<String>,
    private val email: JsonField<String>,
    private val facebook: JsonField<String>,
    private val fullName: JsonField<String>,
    private val language: JsonField<Language>,
    private val linkedin: JsonField<String>,
    private val name: JsonField<String>,
    private val slug: JsonField<String>,
    private val translatedFromId: JsonField<Long>,
    private val twitter: JsonField<String>,
    ...
    private constructor(
        ...
        @JsonProperty("bio") @ExcludeMissing bio: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("facebook") @ExcludeMissing facebook: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("linkedin") @ExcludeMissing linkedin: JsonField<String> = JsonMissing.of(),
        @JsonProperty("name") @ExcludeMissing name: JsonField<String> = JsonMissing.of(),
        @JsonProperty("slug") @ExcludeMissing slug: JsonField<String> = JsonMissing.of(),
        @JsonProperty("translatedFromId")
        @ExcludeMissing
        translatedFromId: JsonField<Long> = JsonMissing.of(),
        @JsonProperty("twitter") @ExcludeMissing twitter: JsonField<String> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun bio(): String = bio.getRequired("bio")
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun facebook(): String = facebook.getRequired("facebook")

    /**
     * The full, unabbreviated name of the blog author, typically their first and last name
     * combined.
     *
     * @throws HubSpotInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun linkedin(): String = linkedin.getRequired("linkedin")

    /**
     * The name field for the blog author. (This appears to be a shorter or alternative name field
     * compared to fullName.)
     *
     * @throws HubSpotInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    ...
    /**
     * A URL-friendly identifier for the blog author that can be used to reference the author in
     * URLs. Typically generated from the author's name and contains lowercase letters, hyphens, and
     * underscores.
     *
     * @throws HubSpotInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun translatedFromId(): Long = translatedFromId.getRequired("translatedFromId")

    /**
     * URL or username of the Twitter account associated with the Blog Author. This will be
     * normalized into the Twitter url for said user.
     *
     * @throws HubSpotInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun twitter(): String = twitter.getRequired("twitter")
    ...
    /**
     * Returns the raw JSON value of [bio].
     *
     * Unlike [bio], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("bio") @ExcludeMissing fun _bio(): JsonField<String> = bio
     ...
     */
    @JsonProperty("facebook") @ExcludeMissing fun _facebook(): JsonField<String> = facebook
     ...
     */
    @JsonProperty("linkedin") @ExcludeMissing fun _linkedin(): JsonField<String> = linkedin
    ...
    @JsonProperty("translatedFromId")
    @ExcludeMissing
    fun _translatedFromId(): JsonField<Long> = translatedFromId
     ...
     */
    @JsonProperty("twitter") @ExcludeMissing fun _twitter(): JsonField<String> = twitter
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BlogAuthor].
         *
    ...
    /** A builder for [BlogAuthor]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var avatar: JsonField<String>? = null
        private var bio: JsonField<String>? = null
        private var created: JsonField<OffsetDateTime>? = null
        private var deletedAt: JsonField<OffsetDateTime>? = null
        private var displayName: JsonField<String>? = null
        private var email: JsonField<String>? = null
        private var facebook: JsonField<String>? = null
        private var fullName: JsonField<String>? = null
        private var language: JsonField<Language>? = null
        private var linkedin: JsonField<String>? = null
        private var name: JsonField<String>? = null
        private var slug: JsonField<String>? = null
        private var translatedFromId: JsonField<Long>? = null
        private var twitter: JsonField<String>? = null
        private var updated: JsonField<OffsetDateTime>? = null
        private var website: JsonField<String>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(blogAuthor: BlogAuthor) = apply {
            id = blogAuthor.id
            avatar = blogAuthor.avatar
            bio = blogAuthor.bio
            created = blogAuthor.created
            deletedAt = blogAuthor.deletedAt
            displayName = blogAuthor.displayName
            email = blogAuthor.email
            facebook = blogAuthor.facebook
            fullName = blogAuthor.fullName
            language = blogAuthor.language
            linkedin = blogAuthor.linkedin
            name = blogAuthor.name
            slug = blogAuthor.slug
            translatedFromId = blogAuthor.translatedFromId
            twitter = blogAuthor.twitter
            updated = blogAuthor.updated
            website = blogAuthor.website
            additionalProperties = blogAuthor.additionalProperties.toMutableMap()
        }
        ...
        /** A short biography of the blog author. */
        fun bio(bio: String) = bio(JsonField.of(bio))

        /**
         * Sets [Builder.bio] to an arbitrary JSON value.
         *
         * You should usually call [Builder.bio] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun bio(bio: JsonField<String>) = apply { this.bio = bio }
        ...
        /** URL to the Blog Author's Facebook page. */
        fun facebook(facebook: String) = facebook(JsonField.of(facebook))

        /**
         * Sets [Builder.facebook] to an arbitrary JSON value.
         *
         * You should usually call [Builder.facebook] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun facebook(facebook: JsonField<String>) = apply { this.facebook = facebook }
        ...
        /** URL to the blog author's LinkedIn page. */
        fun linkedin(linkedin: String) = linkedin(JsonField.of(linkedin))

        /**
         * Sets [Builder.linkedin] to an arbitrary JSON value.
         *
         * You should usually call [Builder.linkedin] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun linkedin(linkedin: JsonField<String>) = apply { this.linkedin = linkedin }

        /**
         * The name field for the blog author. (This appears to be a shorter or alternative name
         * field compared to fullName.)
         */
        ...
        /**
         * A URL-friendly identifier for the blog author that can be used to reference the author in
         * URLs. Typically generated from the author's name and contains lowercase letters, hyphens,
         * and underscores.
         */
        ...
        /** ID of the primary blog author this object was translated from. */
        fun translatedFromId(translatedFromId: Long) =
            translatedFromId(JsonField.of(translatedFromId))

        /**
         * Sets [Builder.translatedFromId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.translatedFromId] with a well-typed [Long] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun translatedFromId(translatedFromId: JsonField<Long>) = apply {
         ...
         * normalized into the Twitter url for said user.
         */
        fun twitter(twitter: String) = twitter(JsonField.of(twitter))

        /**
         * Sets [Builder.twitter] to an arbitrary JSON value.
         *
         * You should usually call [Builder.twitter] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun twitter(twitter: JsonField<String>) = apply { this.twitter = twitter }
        ...
        /**
         * Returns an immutable instance of [BlogAuthor].
         *
    ...
    override fun toString() =
        "BlogAuthor{id=$id, avatar=$avatar, bio=$bio, created=$created, deletedAt=$deletedAt, displayName=$displayName, email=$email, facebook=$facebook, fullName=$fullName, language=$language, linkedin=$linkedin, name=$name, slug=$slug, translatedFromId=$translatedFromId, twitter=$twitter, updated=$updated, website=$website, additionalProperties=$additionalProperties}"
}
