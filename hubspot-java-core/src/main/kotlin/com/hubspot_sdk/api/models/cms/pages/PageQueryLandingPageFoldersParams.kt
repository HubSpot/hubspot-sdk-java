...
class PageQueryLandingPageFoldersParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PageQueryLandingPageFoldersParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of
         * [PageQueryLandingPageFoldersParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PageQueryLandingPageFoldersParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pageQueryLandingPageFoldersParams: PageQueryLandingPageFoldersParams) =
            apply {
                after = pageQueryLandingPageFoldersParams.after
                archived = pageQueryLandingPageFoldersParams.archived
                createdAfter = pageQueryLandingPageFoldersParams.createdAfter
                createdAt = pageQueryLandingPageFoldersParams.createdAt
                createdBefore = pageQueryLandingPageFoldersParams.createdBefore
                limit = pageQueryLandingPageFoldersParams.limit
                property = pageQueryLandingPageFoldersParams.property
                sort = pageQueryLandingPageFoldersParams.sort?.toMutableList()
                updatedAfter = pageQueryLandingPageFoldersParams.updatedAfter
                updatedAt = pageQueryLandingPageFoldersParams.updatedAt
                updatedBefore = pageQueryLandingPageFoldersParams.updatedBefore
                additionalHeaders = pageQueryLandingPageFoldersParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    pageQueryLandingPageFoldersParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [PageQueryLandingPageFoldersParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PageQueryLandingPageFoldersParams =
            PageQueryLandingPageFoldersParams(
                after,
                archived,
                createdAfter,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PageQueryLandingPageFoldersParams &&
            after == other.after &&
    ...
    override fun toString() =
        "PageQueryLandingPageFoldersParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
