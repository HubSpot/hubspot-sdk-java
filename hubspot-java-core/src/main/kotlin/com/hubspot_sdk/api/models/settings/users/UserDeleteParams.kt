...
/**
 * Removes a user identified by `userId`. `userId` refers to the user's ID by default, or optionally
 * email as specified by the `IdProperty` query param.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(userDeleteParams: UserDeleteParams) = apply {
            ...
            idProperty = userDeleteParams.idProperty
    ...
    override fun toString() =
        "UserDeleteParams{userId=$userId, idProperty=$idProperty, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
