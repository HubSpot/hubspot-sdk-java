...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of contracts that can
    ...
    class Builder internal constructor() {
        ...
        internal fun from(contractListParams: ContractListParams) = apply {
            ...
            archived = contractListParams.archived
            associations = contractListParams.associations?.toMutableList()
            limit = contractListParams.limit
            properties = contractListParams.properties?.toMutableList()
            propertiesWithHistory = contractListParams.propertiesWithHistory?.toMutableList()
         ...
         * of contracts that can be read by a single request.
         */
    ...
    override fun toString() =
        "ContractListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
