...
private constructor(
    ...
    /** A builder for [CollectionResponseWithTotalContentFolderForwardPaging]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            results =
                collectionResponseWithTotalContentFolderForwardPaging.results.map {
                    it.toMutableList()
                }
            total = collectionResponseWithTotalContentFolderForwardPaging.total
            paging = collectionResponseWithTotalContentFolderForwardPaging.paging
            additionalProperties =
                collectionResponseWithTotalContentFolderForwardPaging.additionalProperties
                    .toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CollectionResponseWithTotalContentFolderForwardPaging].
         *
         ...
         */
        fun build(): CollectionResponseWithTotalContentFolderForwardPaging =
            CollectionResponseWithTotalContentFolderForwardPaging(
    ...
    fun validate(): CollectionResponseWithTotalContentFolderForwardPaging = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionResponseWithTotalContentFolderForwardPaging &&
    ...
    override fun toString() =
        "CollectionResponseWithTotalContentFolderForwardPaging{results=$results, total=$total, paging=$paging, additionalProperties=$additionalProperties}"
}
