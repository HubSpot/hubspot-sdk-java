 ...
 * property to identify the call by using the `idProperty` query parameter. Provided property values
 * will be overwritten. Read-only and non-existent properties will be ignored. Properties values can
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(callUpdateParams: CallUpdateParams) = apply {
            callId = callUpdateParams.callId
            idProperty = callUpdateParams.idProperty
            simplePublicObjectInput = callUpdateParams.simplePublicObjectInput
    ...
    override fun toString() =
        "CallUpdateParams{callId=$callId, idProperty=$idProperty, simplePublicObjectInput=$simplePublicObjectInput, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
