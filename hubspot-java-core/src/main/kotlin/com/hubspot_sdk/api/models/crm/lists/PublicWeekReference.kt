...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicWeekReference].
         *
    ...
    /** A builder for [PublicWeekReference]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicWeekReference: PublicWeekReference) = apply {
            dayOfWeek = publicWeekReference.dayOfWeek
            referenceType = publicWeekReference.referenceType
            hour = publicWeekReference.hour
            millisecond = publicWeekReference.millisecond
            minute = publicWeekReference.minute
            second = publicWeekReference.second
            additionalProperties = publicWeekReference.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicWeekReference].
         *
    ...
    fun validate(): PublicWeekReference = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicWeekReference &&
    ...
    override fun toString() =
        "PublicWeekReference{dayOfWeek=$dayOfWeek, referenceType=$referenceType, hour=$hour, millisecond=$millisecond, minute=$minute, second=$second, additionalProperties=$additionalProperties}"
}
