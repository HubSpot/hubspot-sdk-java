...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PortalUpdateResponse].
         *
    ...
    /** A builder for [PortalUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portalUpdateResponse: PortalUpdateResponse) = apply {
            appId = portalUpdateResponse.appId
            flagName = portalUpdateResponse.flagName
            flagState = portalUpdateResponse.flagState
            portalId = portalUpdateResponse.portalId
            additionalProperties = portalUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PortalUpdateResponse].
         *
         ...
         */
        fun build(): PortalUpdateResponse =
    ...
    fun validate(): PortalUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PortalUpdateResponse &&
            appId == other.appId &&
    ...
    override fun toString() =
        "PortalUpdateResponse{appId=$appId, flagName=$flagName, flagState=$flagState, portalId=$portalId, additionalProperties=$additionalProperties}"
}
