 ...
 */
class AssociationsV4SimplePublicObjectInputForCreate
...
private constructor(
    ...
    /** A builder for [AssociationsV4SimplePublicObjectInputForCreate]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            associations =
                associationsV4SimplePublicObjectInputForCreate.associations.map {
                    it.toMutableList()
                }
            properties = associationsV4SimplePublicObjectInputForCreate.properties
            additionalProperties =
                associationsV4SimplePublicObjectInputForCreate.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AssociationsV4SimplePublicObjectInputForCreate].
         *
         ...
         */
        fun build(): AssociationsV4SimplePublicObjectInputForCreate =
            AssociationsV4SimplePublicObjectInputForCreate(
    ...
    fun validate(): AssociationsV4SimplePublicObjectInputForCreate = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AssociationsV4SimplePublicObjectInputForCreate &&
    ...
    override fun toString() =
        "AssociationsV4SimplePublicObjectInputForCreate{associations=$associations, properties=$properties, additionalProperties=$additionalProperties}"
}
