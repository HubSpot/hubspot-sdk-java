...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchResponseApiFlow].
         *
    ...
    /** A builder for [BatchResponseApiFlow]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchResponseApiFlow: BatchResponseApiFlow) = apply {
            completedAt = batchResponseApiFlow.completedAt
            results = batchResponseApiFlow.results.map { it.toMutableList() }
            startedAt = batchResponseApiFlow.startedAt
            status = batchResponseApiFlow.status
            links = batchResponseApiFlow.links
            requestedAt = batchResponseApiFlow.requestedAt
            additionalProperties = batchResponseApiFlow.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BatchResponseApiFlow].
         *
         ...
         */
        fun build(): BatchResponseApiFlow =
    ...
    fun validate(): BatchResponseApiFlow = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseApiFlow &&
    ...
    override fun toString() =
        "BatchResponseApiFlow{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, links=$links, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
