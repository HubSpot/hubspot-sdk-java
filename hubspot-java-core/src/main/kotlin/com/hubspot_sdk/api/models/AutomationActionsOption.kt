...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AutomationActionsOption].
         *
    ...
    /** A builder for [AutomationActionsOption]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(automationActionsOption: AutomationActionsOption) = apply {
            description = automationActionsOption.description
            displayOrder = automationActionsOption.displayOrder
            doubleData = automationActionsOption.doubleData
            hidden = automationActionsOption.hidden
            label = automationActionsOption.label
            readOnly = automationActionsOption.readOnly
            value = automationActionsOption.value
            additionalProperties = automationActionsOption.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AutomationActionsOption].
         *
         ...
         */
        fun build(): AutomationActionsOption =
    ...
    fun validate(): AutomationActionsOption = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AutomationActionsOption &&
    ...
    override fun toString() =
        "AutomationActionsOption{description=$description, displayOrder=$displayOrder, doubleData=$doubleData, hidden=$hidden, label=$label, readOnly=$readOnly, value=$value, additionalProperties=$additionalProperties}"
}
