...
private constructor(
    ...
    /** A builder for [BatchResponseMarketingEventPublicDefaultResponseV2WithErrors]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            completedAt = batchResponseMarketingEventPublicDefaultResponseV2WithErrors.completedAt
            results =
                batchResponseMarketingEventPublicDefaultResponseV2WithErrors.results.map {
                    it.toMutableList()
                }
            startedAt = batchResponseMarketingEventPublicDefaultResponseV2WithErrors.startedAt
            status = batchResponseMarketingEventPublicDefaultResponseV2WithErrors.status
            errors =
                batchResponseMarketingEventPublicDefaultResponseV2WithErrors.errors.map {
                    it.toMutableList()
                }
            links = batchResponseMarketingEventPublicDefaultResponseV2WithErrors.links
            numErrors = batchResponseMarketingEventPublicDefaultResponseV2WithErrors.numErrors
            requestedAt = batchResponseMarketingEventPublicDefaultResponseV2WithErrors.requestedAt
            additionalProperties =
                batchResponseMarketingEventPublicDefaultResponseV2WithErrors.additionalProperties
                    .toMutableMap()
        }
         ...
         */
        fun build(): BatchResponseMarketingEventPublicDefaultResponseV2WithErrors =
            BatchResponseMarketingEventPublicDefaultResponseV2WithErrors(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseMarketingEventPublicDefaultResponseV2WithErrors &&
    ...
    override fun toString() =
        "BatchResponseMarketingEventPublicDefaultResponseV2WithErrors{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
