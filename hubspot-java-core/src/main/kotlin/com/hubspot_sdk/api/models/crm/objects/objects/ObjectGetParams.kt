...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(objectGetParams: ObjectGetParams) = apply {
            objectType = objectGetParams.objectType
            objectId = objectGetParams.objectId
            archived = objectGetParams.archived
            associations = objectGetParams.associations?.toMutableList()
            idProperty = objectGetParams.idProperty
            properties = objectGetParams.properties?.toMutableList()
            propertiesWithHistory = objectGetParams.propertiesWithHistory?.toMutableList()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ObjectGetParams &&
    ...
    override fun toString() =
        "ObjectGetParams{objectType=$objectType, objectId=$objectId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
