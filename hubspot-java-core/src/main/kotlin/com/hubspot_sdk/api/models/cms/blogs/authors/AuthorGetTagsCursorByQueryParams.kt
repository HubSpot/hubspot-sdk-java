...
class AuthorGetTagsCursorByQueryParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AuthorGetTagsCursorByQueryParams = builder().build()
    ...
    /** A builder for [AuthorGetTagsCursorByQueryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(authorGetTagsCursorByQueryParams: AuthorGetTagsCursorByQueryParams) =
            apply {
                after = authorGetTagsCursorByQueryParams.after
                archived = authorGetTagsCursorByQueryParams.archived
                createdAfter = authorGetTagsCursorByQueryParams.createdAfter
                createdAt = authorGetTagsCursorByQueryParams.createdAt
                createdBefore = authorGetTagsCursorByQueryParams.createdBefore
                limit = authorGetTagsCursorByQueryParams.limit
                property = authorGetTagsCursorByQueryParams.property
                sort = authorGetTagsCursorByQueryParams.sort?.toMutableList()
                updatedAfter = authorGetTagsCursorByQueryParams.updatedAfter
                updatedAt = authorGetTagsCursorByQueryParams.updatedAt
                updatedBefore = authorGetTagsCursorByQueryParams.updatedBefore
                additionalHeaders = authorGetTagsCursorByQueryParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    authorGetTagsCursorByQueryParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [AuthorGetTagsCursorByQueryParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AuthorGetTagsCursorByQueryParams =
            AuthorGetTagsCursorByQueryParams(
                after,
                archived,
                createdAfter,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AuthorGetTagsCursorByQueryParams &&
            after == other.after &&
    ...
    override fun toString() =
        "AuthorGetTagsCursorByQueryParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
