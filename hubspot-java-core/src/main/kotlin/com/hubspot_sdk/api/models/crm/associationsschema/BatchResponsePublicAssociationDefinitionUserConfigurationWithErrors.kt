...
private constructor(
    ...
    /** A builder for [BatchResponsePublicAssociationDefinitionUserConfigurationWithErrors]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            completedAt =
                batchResponsePublicAssociationDefinitionUserConfigurationWithErrors.completedAt
            results =
                batchResponsePublicAssociationDefinitionUserConfigurationWithErrors.results.map {
                    it.toMutableList()
                }
            startedAt =
                batchResponsePublicAssociationDefinitionUserConfigurationWithErrors.startedAt
            status = batchResponsePublicAssociationDefinitionUserConfigurationWithErrors.status
            errors =
                batchResponsePublicAssociationDefinitionUserConfigurationWithErrors.errors.map {
                    it.toMutableList()
                }
            links = batchResponsePublicAssociationDefinitionUserConfigurationWithErrors.links
            numErrors =
                batchResponsePublicAssociationDefinitionUserConfigurationWithErrors.numErrors
            requestedAt =
                batchResponsePublicAssociationDefinitionUserConfigurationWithErrors.requestedAt
         ...
         */
        fun build(): BatchResponsePublicAssociationDefinitionUserConfigurationWithErrors =
            BatchResponsePublicAssociationDefinitionUserConfigurationWithErrors(
    ...
    fun validate(): BatchResponsePublicAssociationDefinitionUserConfigurationWithErrors = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponsePublicAssociationDefinitionUserConfigurationWithErrors &&
    ...
    override fun toString() =
        "BatchResponsePublicAssociationDefinitionUserConfigurationWithErrors{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
