...
class PageGetSitePagesByQueryParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PageGetSitePagesByQueryParams = builder().build()
    ...
    /** A builder for [PageGetSitePagesByQueryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pageGetSitePagesByQueryParams: PageGetSitePagesByQueryParams) = apply {
            after = pageGetSitePagesByQueryParams.after
            archived = pageGetSitePagesByQueryParams.archived
            createdAfter = pageGetSitePagesByQueryParams.createdAfter
            createdAt = pageGetSitePagesByQueryParams.createdAt
            createdBefore = pageGetSitePagesByQueryParams.createdBefore
            limit = pageGetSitePagesByQueryParams.limit
            property = pageGetSitePagesByQueryParams.property
            sort = pageGetSitePagesByQueryParams.sort?.toMutableList()
            updatedAfter = pageGetSitePagesByQueryParams.updatedAfter
            updatedAt = pageGetSitePagesByQueryParams.updatedAt
            updatedBefore = pageGetSitePagesByQueryParams.updatedBefore
            additionalHeaders = pageGetSitePagesByQueryParams.additionalHeaders.toBuilder()
            additionalQueryParams = pageGetSitePagesByQueryParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PageGetSitePagesByQueryParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PageGetSitePagesByQueryParams =
            PageGetSitePagesByQueryParams(
                after,
                archived,
                createdAfter,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PageGetSitePagesByQueryParams &&
            after == other.after &&
    ...
    override fun toString() =
        "PageGetSitePagesByQueryParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
