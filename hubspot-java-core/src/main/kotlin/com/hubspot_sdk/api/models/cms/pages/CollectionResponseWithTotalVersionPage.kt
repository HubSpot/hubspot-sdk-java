...
private constructor(
    private val results: JsonField<List<VersionPage>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<VersionPage>> = JsonMissing.of(),
     ...
     */
    fun results(): List<VersionPage> = results.getRequired("results")
     ...
     */
    @JsonProperty("results") @ExcludeMissing fun _results(): JsonField<List<VersionPage>> = results
    ...
    /** A builder for [CollectionResponseWithTotalVersionPage]. */
    class Builder internal constructor() {

        private var results: JsonField<MutableList<VersionPage>>? = null
        ...
        internal fun from(
            ...
            results = collectionResponseWithTotalVersionPage.results.map { it.toMutableList() }
            total = collectionResponseWithTotalVersionPage.total
            paging = collectionResponseWithTotalVersionPage.paging
            additionalProperties =
                collectionResponseWithTotalVersionPage.additionalProperties.toMutableMap()
        }

        /** Collection of page versions. */
        fun results(results: List<VersionPage>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed `List<VersionPage>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun results(results: JsonField<List<VersionPage>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [VersionPage] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: VersionPage) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [CollectionResponseWithTotalVersionPage].
         *
         ...
         */
        fun build(): CollectionResponseWithTotalVersionPage =
            CollectionResponseWithTotalVersionPage(
    ...
    fun validate(): CollectionResponseWithTotalVersionPage = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionResponseWithTotalVersionPage &&
    ...
    override fun toString() =
        "CollectionResponseWithTotalVersionPage{results=$results, total=$total, paging=$paging, additionalProperties=$additionalProperties}"
}
