...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TaxRateListResponse].
         *
    ...
    /** A builder for [TaxRateListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(taxRateListResponse: TaxRateListResponse) = apply {
            results = taxRateListResponse.results.map { it.toMutableList() }
            paging = taxRateListResponse.paging
            additionalProperties = taxRateListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TaxRateListResponse].
         *
    ...
    fun validate(): TaxRateListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *
         * Unlike [percentageRate], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("percentageRate")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            fun percentageRate(percentageRate: Double) =
                percentageRate(JsonField.of(percentageRate))
        ...
        override fun toString() =
            "Result{id=$id, active=$active, createdAt=$createdAt, label=$label, name=$name, percentageRate=$percentageRate, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TaxRateListResponse &&
    ...
    override fun toString() =
        "TaxRateListResponse{results=$results, paging=$paging, additionalProperties=$additionalProperties}"
}
