...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(batchResponseHubDbTableRowV3: BatchResponseHubDbTableRowV3) = apply {
            ...
            errors = batchResponseHubDbTableRowV3.errors.map { it.toMutableList() }
            links = batchResponseHubDbTableRowV3.links
            numErrors = batchResponseHubDbTableRowV3.numErrors
    ...
    fun validate(): BatchResponseHubDbTableRowV3 = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "BatchResponseHubDbTableRowV3{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
