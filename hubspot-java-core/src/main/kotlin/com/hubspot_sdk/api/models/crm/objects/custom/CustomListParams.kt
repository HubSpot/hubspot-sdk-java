...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(customListParams: CustomListParams) = apply {
            objectType = customListParams.objectType
            after = customListParams.after
            archived = customListParams.archived
            associations = customListParams.associations?.toMutableList()
            limit = customListParams.limit
            properties = customListParams.properties?.toMutableList()
            propertiesWithHistory = customListParams.propertiesWithHistory?.toMutableList()
    ...
    override fun toString() =
        "CustomListParams{objectType=$objectType, after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
