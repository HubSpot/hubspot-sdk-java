...
private constructor(
    ...
    /**
     * The event's fully qualified name. This value (formatted as `pe{HubID}_{name}`) can be
    ...
    /**
     * Include a universally unique identifier to assign a unique ID to the event occurrence. Can be
    ...
    class Builder internal constructor() {
        ...
        /**
         * Include a universally unique identifier to assign a unique ID to the event occurrence.
