...
private constructor(
    ...
    private val results: JsonField<List<JsonValue>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<JsonValue>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<JsonValue> = results.getRequired("results")
     ...
     */
    @JsonProperty("results") @ExcludeMissing fun _results(): JsonField<List<JsonValue>> = results
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchResponseVoid].
         *
    ...
    /** A builder for [BatchResponseVoid]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<JsonValue>>? = null
        ...
        @JvmSynthetic
        internal fun from(batchResponseVoid: BatchResponseVoid) = apply {
            completedAt = batchResponseVoid.completedAt
            results = batchResponseVoid.results.map { it.toMutableList() }
            startedAt = batchResponseVoid.startedAt
            status = batchResponseVoid.status
            errors = batchResponseVoid.errors.map { it.toMutableList() }
            links = batchResponseVoid.links
            numErrors = batchResponseVoid.numErrors
            requestedAt = batchResponseVoid.requestedAt
            additionalProperties = batchResponseVoid.additionalProperties.toMutableMap()
        }
        ...
        fun results(results: List<JsonValue>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed `List<JsonValue>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun results(results: JsonField<List<JsonValue>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [JsonValue] to [results].
         *
        ...
        /**
         * Returns an immutable instance of [BatchResponseVoid].
         *
    ...
    fun validate(): BatchResponseVoid = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (completedAt.asKnown().isPresent) 1 else 0) +
            (results.asKnown().getOrNull()?.size ?: 0) +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseVoid &&
    ...
    override fun toString() =
        "BatchResponseVoid{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
