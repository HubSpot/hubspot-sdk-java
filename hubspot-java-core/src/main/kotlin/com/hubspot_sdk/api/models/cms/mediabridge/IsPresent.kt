...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(isPresent: IsPresent) = apply {
            ...
            inputs = isPresent.inputs.map { it.toMutableList() }
    ...
    private constructor(
        ...
        companion object {
            ...
            /** Returns a mutable builder for constructing an instance of [ExpressionToEvaluate]. */
            @JvmStatic fun builder() = Builder()
        }

        /** A builder for [ExpressionToEvaluate]. */
        class Builder internal constructor() {

            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

            @JvmSynthetic
            internal fun from(expressionToEvaluate: ExpressionToEvaluate) = apply {
                additionalProperties = expressionToEvaluate.additionalProperties.toMutableMap()
            }
            ...
            /**
             * Returns an immutable instance of [ExpressionToEvaluate].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): ExpressionToEvaluate =
                ExpressionToEvaluate(additionalProperties.toImmutable())
        }
        ...
        override fun toString() = "ExpressionToEvaluate{additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "IsPresent{expressionToEvaluate=$expressionToEvaluate, operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
