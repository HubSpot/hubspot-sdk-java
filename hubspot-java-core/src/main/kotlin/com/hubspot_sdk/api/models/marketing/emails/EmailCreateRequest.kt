...
private constructor(
    ...
    override fun toString() =
        "EmailCreateRequest{name=$name, activeDomain=$activeDomain, archived=$archived, businessUnitId=$businessUnitId, campaign=$campaign, content=$content, feedbackSurveyId=$feedbackSurveyId, folderIdV2=$folderIdV2, from=$from, jitterSendTime=$jitterSendTime, language=$language, publishDate=$publishDate, rssData=$rssData, sendOnPublish=$sendOnPublish, state=$state, subcategory=$subcategory, subject=$subject, subscriptionDetails=$subscriptionDetails, testing=$testing, to=$to, webversion=$webversion, additionalProperties=$additionalProperties}"
}
