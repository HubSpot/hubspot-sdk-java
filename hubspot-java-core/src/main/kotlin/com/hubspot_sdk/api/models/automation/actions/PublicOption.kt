...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicOption].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicOption: PublicOption) = apply {
            label = publicOption.label
            value = publicOption.value
            description = publicOption.description
            displayOrder = publicOption.displayOrder
        ...
        /**
         * Returns an immutable instance of [PublicOption].
         *
    ...
    fun validate(): PublicOption = apply {
        if (validated) {
            return@apply
        }
    ...
    private val hashCode: Int by lazy {
        Objects.hash(label, value, description, displayOrder, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "PublicOption{label=$label, value=$value, description=$description, displayOrder=$displayOrder, additionalProperties=$additionalProperties}"
}
