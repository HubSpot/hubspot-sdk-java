...
class PagesContentLanguageVariation
...
private constructor(
    ...
    /** A builder for [PagesContentLanguageVariation]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pagesContentLanguageVariation: PagesContentLanguageVariation) = apply {
            id = pagesContentLanguageVariation.id
            archivedInDashboard = pagesContentLanguageVariation.archivedInDashboard
            authorName = pagesContentLanguageVariation.authorName
            campaign = pagesContentLanguageVariation.campaign
            created = pagesContentLanguageVariation.created
            name = pagesContentLanguageVariation.name
            password = pagesContentLanguageVariation.password
            publicAccessRules =
                pagesContentLanguageVariation.publicAccessRules.map { it.toMutableList() }
            publicAccessRulesEnabled = pagesContentLanguageVariation.publicAccessRulesEnabled
            publishDate = pagesContentLanguageVariation.publishDate
            slug = pagesContentLanguageVariation.slug
            state = pagesContentLanguageVariation.state
            updated = pagesContentLanguageVariation.updated
            tagIds = pagesContentLanguageVariation.tagIds.map { it.toMutableList() }
            additionalProperties = pagesContentLanguageVariation.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PagesContentLanguageVariation].
         *
         ...
         */
        fun build(): PagesContentLanguageVariation =
            PagesContentLanguageVariation(
                checkRequired("id", id),
    ...
    fun validate(): PagesContentLanguageVariation = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PagesContentLanguageVariation &&
            id == other.id &&
    ...
    override fun toString() =
        "PagesContentLanguageVariation{id=$id, archivedInDashboard=$archivedInDashboard, authorName=$authorName, campaign=$campaign, created=$created, name=$name, password=$password, publicAccessRules=$publicAccessRules, publicAccessRulesEnabled=$publicAccessRulesEnabled, publishDate=$publishDate, slug=$slug, state=$state, updated=$updated, tagIds=$tagIds, additionalProperties=$additionalProperties}"
}
