...
class ApiManualEnrollmentCriteria
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ApiManualEnrollmentCriteria].
         *
    ...
    /** A builder for [ApiManualEnrollmentCriteria]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(apiManualEnrollmentCriteria: ApiManualEnrollmentCriteria) = apply {
            shouldReEnroll = apiManualEnrollmentCriteria.shouldReEnroll
            type = apiManualEnrollmentCriteria.type
        ...
        /**
         * Returns an immutable instance of [ApiManualEnrollmentCriteria].
         *
         ...
         */
        fun build(): ApiManualEnrollmentCriteria =
    ...
    fun validate(): ApiManualEnrollmentCriteria = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ApiManualEnrollmentCriteria &&
            shouldReEnroll == other.shouldReEnroll &&
            type == other.type &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(shouldReEnroll, type, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ApiManualEnrollmentCriteria{shouldReEnroll=$shouldReEnroll, type=$type, additionalProperties=$additionalProperties}"
}
