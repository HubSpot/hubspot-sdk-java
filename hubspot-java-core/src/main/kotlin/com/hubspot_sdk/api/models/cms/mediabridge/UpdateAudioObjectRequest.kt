...
class UpdateAudioObjectRequest
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UpdateAudioObjectRequest].
         *
    ...
    /** A builder for [UpdateAudioObjectRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(updateAudioObjectRequest: UpdateAudioObjectRequest) = apply {
            mediaType = updateAudioObjectRequest.mediaType
            detailsPageLink = updateAudioObjectRequest.detailsPageLink
            duration = updateAudioObjectRequest.duration
            externalId = updateAudioObjectRequest.externalId
            fileUrl = updateAudioObjectRequest.fileUrl
            oembedUrl = updateAudioObjectRequest.oembedUrl
            posterUrl = updateAudioObjectRequest.posterUrl
            thumbnailUrl = updateAudioObjectRequest.thumbnailUrl
            title = updateAudioObjectRequest.title
            additionalProperties = updateAudioObjectRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UpdateAudioObjectRequest].
         *
         ...
         */
        fun build(): UpdateAudioObjectRequest =
    ...
    fun validate(): UpdateAudioObjectRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UpdateAudioObjectRequest &&
    ...
    override fun toString() =
        "UpdateAudioObjectRequest{mediaType=$mediaType, detailsPageLink=$detailsPageLink, duration=$duration, externalId=$externalId, fileUrl=$fileUrl, oembedUrl=$oembedUrl, posterUrl=$posterUrl, thumbnailUrl=$thumbnailUrl, title=$title, additionalProperties=$additionalProperties}"
}
