...
private constructor(
    ...
    private val results: JsonField<List<PublicAssociationDefinitionUserConfiguration>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<PublicAssociationDefinitionUserConfiguration>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<PublicAssociationDefinitionUserConfiguration> =
        results.getRequired("results")
    ...
    /**
     * A collection of URLs linking to related documentation or resources associated with the batch
     * operation.
     *
     * @throws HubspotInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<PublicAssociationDefinitionUserConfiguration>> = results
    ...
    /** A builder for [BatchResponsePublicAssociationDefinitionUserConfiguration]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<PublicAssociationDefinitionUserConfiguration>>? =
            null
        ...
        internal fun from(
            ...
            completedAt = batchResponsePublicAssociationDefinitionUserConfiguration.completedAt
            results =
                batchResponsePublicAssociationDefinitionUserConfiguration.results.map {
                    it.toMutableList()
                }
            startedAt = batchResponsePublicAssociationDefinitionUserConfiguration.startedAt
            status = batchResponsePublicAssociationDefinitionUserConfiguration.status
            errors =
                batchResponsePublicAssociationDefinitionUserConfiguration.errors.map {
                    it.toMutableList()
                }
            links = batchResponsePublicAssociationDefinitionUserConfiguration.links
            numErrors = batchResponsePublicAssociationDefinitionUserConfiguration.numErrors
            requestedAt = batchResponsePublicAssociationDefinitionUserConfiguration.requestedAt
            additionalProperties =
                batchResponsePublicAssociationDefinitionUserConfiguration.additionalProperties
                    .toMutableMap()
        }
        ...
        fun results(results: List<PublicAssociationDefinitionUserConfiguration>) =
         ...
         * `List<PublicAssociationDefinitionUserConfiguration>` value instead. This method is
         * primarily for setting the field to an undocumented or not yet supported value.
         */
        fun results(results: JsonField<List<PublicAssociationDefinitionUserConfiguration>>) =
            apply {
                this.results = results.map { it.toMutableList() }
            }

        /**
         * Adds a single [PublicAssociationDefinitionUserConfiguration] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: PublicAssociationDefinitionUserConfiguration) = apply {
            results =
        ...
        /**
         * A collection of URLs linking to related documentation or resources associated with the
         * batch operation.
         */
         ...
         */
        fun build(): BatchResponsePublicAssociationDefinitionUserConfiguration =
            BatchResponsePublicAssociationDefinitionUserConfiguration(
    ...
    fun validate(): BatchResponsePublicAssociationDefinitionUserConfiguration = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponsePublicAssociationDefinitionUserConfiguration &&
    ...
    override fun toString() =
        "BatchResponsePublicAssociationDefinitionUserConfiguration{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
