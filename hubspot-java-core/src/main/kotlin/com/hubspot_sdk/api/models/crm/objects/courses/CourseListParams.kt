...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of courses that can
    ...
    companion object {
        ...
        @JvmStatic fun none(): CourseListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [CourseListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CourseListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(courseListParams: CourseListParams) = apply {
            after = courseListParams.after
            archived = courseListParams.archived
            associations = courseListParams.associations?.toMutableList()
            limit = courseListParams.limit
            properties = courseListParams.properties?.toMutableList()
            propertiesWithHistory = courseListParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = courseListParams.additionalHeaders.toBuilder()
            additionalQueryParams = courseListParams.additionalQueryParams.toBuilder()
        }
         ...
         * of courses that can be read by a single request.
         */
        ...
        /**
         * Returns an immutable instance of [CourseListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CourseListParams =
            CourseListParams(
                after,
                archived,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CourseListParams &&
            after == other.after &&
    ...
    override fun toString() =
        "CourseListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
