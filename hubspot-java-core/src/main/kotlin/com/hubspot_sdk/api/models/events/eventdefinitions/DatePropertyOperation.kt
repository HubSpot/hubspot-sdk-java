...
private constructor(
    ...
    override fun toString() =
        "DatePropertyOperation{day=$day, includeObjectsWithNoValueSet=$includeObjectsWithNoValueSet, month=$month, operationType=$operationType, operator=$operator, operatorName=$operatorName, propertyType=$propertyType, year=$year, defaultValue=$defaultValue, additionalProperties=$additionalProperties}"
}
