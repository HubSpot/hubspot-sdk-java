...
class BatchResponsePublicWideStatusBulkResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val completedAt: JsonField<OffsetDateTime>,
    private val results: JsonField<List<PublicWideStatusBulkResponse>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<PublicWideStatusBulkResponse>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<PublicWideStatusBulkResponse> = results.getRequired("results")
    ...
    /**
     * The current status of the batch process, with possible values: PENDING, PROCESSING, CANCELED,
     * COMPLETE.
     *
     * @throws HubspotInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
    ...
    /**
     * An array of errors encountered during the batch operation, each item providing details about
     * a specific error.
     *
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<PublicWideStatusBulkResponse>> = results
    ...
    /** A builder for [BatchResponsePublicWideStatusBulkResponse]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<PublicWideStatusBulkResponse>>? = null
        ...
        @JvmSynthetic
        internal fun from(
            batchResponsePublicWideStatusBulkResponse: BatchResponsePublicWideStatusBulkResponse
        ) = apply {
            completedAt = batchResponsePublicWideStatusBulkResponse.completedAt
            results = batchResponsePublicWideStatusBulkResponse.results.map { it.toMutableList() }
            startedAt = batchResponsePublicWideStatusBulkResponse.startedAt
            status = batchResponsePublicWideStatusBulkResponse.status
            errors = batchResponsePublicWideStatusBulkResponse.errors.map { it.toMutableList() }
            links = batchResponsePublicWideStatusBulkResponse.links
            numErrors = batchResponsePublicWideStatusBulkResponse.numErrors
            requestedAt = batchResponsePublicWideStatusBulkResponse.requestedAt
            additionalProperties =
                batchResponsePublicWideStatusBulkResponse.additionalProperties.toMutableMap()
        }
         ...
         * information.
         */
        fun results(results: List<PublicWideStatusBulkResponse>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed
         * `List<PublicWideStatusBulkResponse>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun results(results: JsonField<List<PublicWideStatusBulkResponse>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [PublicWideStatusBulkResponse] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: PublicWideStatusBulkResponse) = apply {
            results =
        ...
        /**
         * The current status of the batch process, with possible values: PENDING, PROCESSING,
         * CANCELED, COMPLETE.
         */
        ...
        /**
         * An array of errors encountered during the batch operation, each item providing details
        ...
        /**
         * Returns an immutable instance of [BatchResponsePublicWideStatusBulkResponse].
         *
         ...
         */
        fun build(): BatchResponsePublicWideStatusBulkResponse =
            BatchResponsePublicWideStatusBulkResponse(
    ...
    fun validate(): BatchResponsePublicWideStatusBulkResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponsePublicWideStatusBulkResponse &&
    ...
    override fun toString() =
        "BatchResponsePublicWideStatusBulkResponse{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
