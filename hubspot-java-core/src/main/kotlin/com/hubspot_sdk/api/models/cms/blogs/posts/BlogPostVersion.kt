...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BlogPostVersion].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(blogPostVersion: BlogPostVersion) = apply {
            id = blogPostVersion.id
            object_ = blogPostVersion.object_
            updatedAt = blogPostVersion.updatedAt
            user = blogPostVersion.user
            additionalProperties = blogPostVersion.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BlogPostVersion].
         *
    ...
    fun validate(): BlogPostVersion = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BlogPostVersion &&
            id == other.id &&
    ...
    override fun toString() =
        "BlogPostVersion{id=$id, object_=$object_, updatedAt=$updatedAt, user=$user, additionalProperties=$additionalProperties}"
}
