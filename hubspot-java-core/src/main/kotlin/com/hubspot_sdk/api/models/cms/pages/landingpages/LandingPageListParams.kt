...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LandingPageListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [LandingPageListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LandingPageListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(landingPageListParams: LandingPageListParams) = apply {
            after = landingPageListParams.after
            archived = landingPageListParams.archived
            createdAfter = landingPageListParams.createdAfter
            createdAt = landingPageListParams.createdAt
            createdBefore = landingPageListParams.createdBefore
            limit = landingPageListParams.limit
            property = landingPageListParams.property
            sort = landingPageListParams.sort?.toMutableList()
            updatedAfter = landingPageListParams.updatedAfter
            updatedAt = landingPageListParams.updatedAt
            updatedBefore = landingPageListParams.updatedBefore
            additionalHeaders = landingPageListParams.additionalHeaders.toBuilder()
            additionalQueryParams = landingPageListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LandingPageListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LandingPageListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LandingPageListParams &&
            after == other.after &&
    ...
    override fun toString() =
        "LandingPageListParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
