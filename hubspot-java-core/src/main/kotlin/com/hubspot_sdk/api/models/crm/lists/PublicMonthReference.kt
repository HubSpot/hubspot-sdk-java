...
private constructor(
    ...
    ) : this(day, referenceType, hour, millisecond, minute, second, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicMonthReference].
         *
    ...
    /** A builder for [PublicMonthReference]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicMonthReference: PublicMonthReference) = apply {
            day = publicMonthReference.day
            referenceType = publicMonthReference.referenceType
            hour = publicMonthReference.hour
            millisecond = publicMonthReference.millisecond
            minute = publicMonthReference.minute
            second = publicMonthReference.second
            additionalProperties = publicMonthReference.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicMonthReference].
         *
         ...
         */
        fun build(): PublicMonthReference =
    ...
    fun validate(): PublicMonthReference = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicMonthReference &&
            day == other.day &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(day, referenceType, hour, millisecond, minute, second, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "PublicMonthReference{day=$day, referenceType=$referenceType, hour=$hour, millisecond=$millisecond, minute=$minute, second=$second, additionalProperties=$additionalProperties}"
}
