...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of fees that can be
    ...
    companion object {
        ...
        @JvmStatic fun none(): FeeListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [FeeListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FeeListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(feeListParams: FeeListParams) = apply {
            after = feeListParams.after
            archived = feeListParams.archived
            associations = feeListParams.associations?.toMutableList()
            limit = feeListParams.limit
            properties = feeListParams.properties?.toMutableList()
            propertiesWithHistory = feeListParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = feeListParams.additionalHeaders.toBuilder()
            additionalQueryParams = feeListParams.additionalQueryParams.toBuilder()
        }
         ...
         * of fees that can be read by a single request.
         */
        ...
        /**
         * Returns an immutable instance of [FeeListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FeeListParams =
            FeeListParams(
                after,
                archived,
    ...
    override fun toString() =
        "FeeListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
