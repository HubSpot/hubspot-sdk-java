...
class BatchGetLocalEarliestParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): BatchGetLocalEarliestParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [BatchGetLocalEarliestParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BatchGetLocalEarliestParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchGetLocalEarliestParams: BatchGetLocalEarliestParams) = apply {
            count = batchGetLocalEarliestParams.count
            installPortalId = batchGetLocalEarliestParams.installPortalId
            additionalHeaders = batchGetLocalEarliestParams.additionalHeaders.toBuilder()
            additionalQueryParams = batchGetLocalEarliestParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BatchGetLocalEarliestParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BatchGetLocalEarliestParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchGetLocalEarliestParams &&
            count == other.count &&
    ...
    override fun toString() =
        "BatchGetLocalEarliestParams{count=$count, installPortalId=$installPortalId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
