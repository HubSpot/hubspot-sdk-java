...
private constructor(
    ...
    private val useCountryCodeSelect: JsonField<Boolean>,
    private val validation: JsonField<PhoneFieldValidation>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        useCountryCodeSelect: JsonField<Boolean> = JsonMissing.of(),
        @JsonProperty("validation")
        @ExcludeMissing
        validation: JsonField<PhoneFieldValidation> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun useCountryCodeSelect(): Boolean = useCountryCodeSelect.getRequired("useCountryCodeSelect")
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun validation(): PhoneFieldValidation = validation.getRequired("validation")
    ...
    /**
     * Returns the raw JSON value of [useCountryCodeSelect].
     *
     * Unlike [useCountryCodeSelect], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("useCountryCodeSelect")
    @ExcludeMissing
    fun _useCountryCodeSelect(): JsonField<Boolean> = useCountryCodeSelect
    ...
    @JsonProperty("validation")
    @ExcludeMissing
    fun _validation(): JsonField<PhoneFieldValidation> = validation
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PhoneField].
         *
    ...
    class Builder internal constructor() {
        ...
        private var useCountryCodeSelect: JsonField<Boolean>? = null
        private var validation: JsonField<PhoneFieldValidation>? = null
        ...
        @JvmSynthetic
        internal fun from(phoneField: PhoneField) = apply {
            dependentFields = phoneField.dependentFields.map { it.toMutableList() }
            fieldType = phoneField.fieldType
            hidden = phoneField.hidden
            label = phoneField.label
            name = phoneField.name
            objectTypeId = phoneField.objectTypeId
            required = phoneField.required
            useCountryCodeSelect = phoneField.useCountryCodeSelect
            validation = phoneField.validation
            defaultValue = phoneField.defaultValue
            description = phoneField.description
            placeholder = phoneField.placeholder
            additionalProperties = phoneField.additionalProperties.toMutableMap()
        }
        ...
        /** Whether to display a country code drop down next to the phone field. */
        fun useCountryCodeSelect(useCountryCodeSelect: Boolean) =
            useCountryCodeSelect(JsonField.of(useCountryCodeSelect))

        /**
         * Sets [Builder.useCountryCodeSelect] to an arbitrary JSON value.
         *
         * You should usually call [Builder.useCountryCodeSelect] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun useCountryCodeSelect(useCountryCodeSelect: JsonField<Boolean>) = apply {
            this.useCountryCodeSelect = useCountryCodeSelect
        }

        /** Describes how a phone number should be validated. */
        fun validation(validation: PhoneFieldValidation) = validation(JsonField.of(validation))

        /**
         * Sets [Builder.validation] to an arbitrary JSON value.
         *
         * You should usually call [Builder.validation] with a well-typed [PhoneFieldValidation]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun validation(validation: JsonField<PhoneFieldValidation>) = apply {
        ...
        /** The prompt text showing when the field isn't filled in. */
        fun placeholder(placeholder: String) = placeholder(JsonField.of(placeholder))
        ...
        /**
         * Returns an immutable instance of [PhoneField].
         *
        ...
        fun build(): PhoneField =
            PhoneField(
                ...
                checkRequired("useCountryCodeSelect", useCountryCodeSelect),
    ...
    internal fun validity(): Int =
        (dependentFields.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
            ...
            (if (useCountryCodeSelect.asKnown().isPresent) 1 else 0) +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneField &&
            ...
            useCountryCodeSelect == other.useCountryCodeSelect &&
    ...
    override fun toString() =
        "PhoneField{dependentFields=$dependentFields, fieldType=$fieldType, hidden=$hidden, label=$label, name=$name, objectTypeId=$objectTypeId, required=$required, useCountryCodeSelect=$useCountryCodeSelect, validation=$validation, defaultValue=$defaultValue, description=$description, placeholder=$placeholder, additionalProperties=$additionalProperties}"
}
