...
private constructor(
    ...
    /**
     * An object representing the entity of the multipart form data, containing the actual data to
     * be processed.
     *
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = formDataMultiPart.entity().convert(MyClass.class);
     * ```
     */
    @JsonProperty("entity") @ExcludeMissing fun _entity(): JsonValue = entity

    /**
     * An object containing fields of the multipart form data, where each field can have multiple
     * FormDataBodyPart items.
     *
     * @throws HubspotInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    ...
    /**
     * An object containing headers associated with the multipart form data, where each header can
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = formDataMultiPart.messageBodyWorkers().convert(MyClass.class);
     * ```
     */
    @JsonProperty("messageBodyWorkers")
    @ExcludeMissing
     ...
     * This arbitrary value can be deserialized into a custom type using the `convert` method:
     * ```java
     * MyClass myObject = formDataMultiPart.providers().convert(MyClass.class);
     * ```
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FormDataMultiPart].
         *
    ...
    /** A builder for [FormDataMultiPart]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(formDataMultiPart: FormDataMultiPart) = apply {
            bodyParts = formDataMultiPart.bodyParts.map { it.toMutableList() }
            contentDisposition = formDataMultiPart.contentDisposition
            entity = formDataMultiPart.entity
            fields = formDataMultiPart.fields
            headers = formDataMultiPart.headers
            mediaType = formDataMultiPart.mediaType
            messageBodyWorkers = formDataMultiPart.messageBodyWorkers
            parameterizedHeaders = formDataMultiPart.parameterizedHeaders
            providers = formDataMultiPart.providers
            parent = formDataMultiPart.parent
            additionalProperties = formDataMultiPart.additionalProperties.toMutableMap()
        }
        ...
        /**
         * An object representing the entity of the multipart form data, containing the actual data
         * to be processed.
         */
        fun entity(entity: JsonValue) = apply { this.entity = entity }

        /**
         * An object containing fields of the multipart form data, where each field can have
         * multiple FormDataBodyPart items.
         */
        ...
        /**
         * An object containing headers associated with the multipart form data, where each header
        ...
        /**
         * Returns an immutable instance of [FormDataMultiPart].
         *
    ...
    fun validate(): FormDataMultiPart = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FormDataMultiPart &&
    ...
    override fun toString() =
        "FormDataMultiPart{bodyParts=$bodyParts, contentDisposition=$contentDisposition, entity=$entity, fields=$fields, headers=$headers, mediaType=$mediaType, messageBodyWorkers=$messageBodyWorkers, parameterizedHeaders=$parameterizedHeaders, providers=$providers, parent=$parent, additionalProperties=$additionalProperties}"
}
