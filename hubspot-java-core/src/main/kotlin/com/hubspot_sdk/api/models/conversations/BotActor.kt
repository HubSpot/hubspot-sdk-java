...
private constructor(
    ...
    ) : this(id, type, avatar, name, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BotActor].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(botActor: BotActor) = apply {
            id = botActor.id
            type = botActor.type
            avatar = botActor.avatar
            name = botActor.name
            additionalProperties = botActor.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BotActor].
         *
    ...
    private val hashCode: Int by lazy { Objects.hash(id, type, avatar, name, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BotActor{id=$id, type=$type, avatar=$avatar, name=$name, additionalProperties=$additionalProperties}"
}
