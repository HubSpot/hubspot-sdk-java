...
package com.hubspot_sdk.api.models.businessunits.businessunitentries
...
class BusinessUnitEntryGetByUserIdParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): BusinessUnitEntryGetByUserIdParams = builder().build()
    ...
    /** A builder for [BusinessUnitEntryGetByUserIdParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(businessUnitEntryGetByUserIdParams: BusinessUnitEntryGetByUserIdParams) =
            apply {
                userId = businessUnitEntryGetByUserIdParams.userId
                name = businessUnitEntryGetByUserIdParams.name?.toMutableList()
                properties = businessUnitEntryGetByUserIdParams.properties?.toMutableList()
                additionalHeaders = businessUnitEntryGetByUserIdParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    businessUnitEntryGetByUserIdParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [BusinessUnitEntryGetByUserIdParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BusinessUnitEntryGetByUserIdParams =
            BusinessUnitEntryGetByUserIdParams(
                userId,
                name?.toImmutable(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BusinessUnitEntryGetByUserIdParams &&
            userId == other.userId &&
            name == other.name &&
    ...
    override fun toString() =
        "BusinessUnitEntryGetByUserIdParams{userId=$userId, name=$name, properties=$properties, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
