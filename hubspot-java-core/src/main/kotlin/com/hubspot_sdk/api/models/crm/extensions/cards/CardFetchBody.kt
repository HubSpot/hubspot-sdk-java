...
private constructor(
    ...
    ) : this(objectTypes, targetUrl, cardType, serverlessFunction, mutableMapOf())
    ...
    private val hashCode: Int by lazy {
        Objects.hash(objectTypes, targetUrl, cardType, serverlessFunction, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "CardFetchBody{objectTypes=$objectTypes, targetUrl=$targetUrl, cardType=$cardType, serverlessFunction=$serverlessFunction, additionalProperties=$additionalProperties}"
}
