...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of line items that
    ...
    companion object {
        ...
        @JvmStatic fun none(): LineItemListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(lineItemListParams: LineItemListParams) = apply {
            after = lineItemListParams.after
            archived = lineItemListParams.archived
            associations = lineItemListParams.associations?.toMutableList()
            limit = lineItemListParams.limit
            properties = lineItemListParams.properties?.toMutableList()
            propertiesWithHistory = lineItemListParams.propertiesWithHistory?.toMutableList()
         ...
         * of line items that can be read by a single request.
         */
    ...
    override fun toString() =
        "LineItemListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
