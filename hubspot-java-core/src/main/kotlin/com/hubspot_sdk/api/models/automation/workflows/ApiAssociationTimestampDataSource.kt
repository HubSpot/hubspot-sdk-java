...
class ApiAssociationTimestampDataSource
...
private constructor(
    ...
    ) : this(associationCategory, associationTypeId, name, objectTypeId, type, mutableMapOf())
    ...
    /** A builder for [ApiAssociationTimestampDataSource]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(apiAssociationTimestampDataSource: ApiAssociationTimestampDataSource) =
            apply {
                associationCategory = apiAssociationTimestampDataSource.associationCategory
                associationTypeId = apiAssociationTimestampDataSource.associationTypeId
                name = apiAssociationTimestampDataSource.name
                objectTypeId = apiAssociationTimestampDataSource.objectTypeId
                type = apiAssociationTimestampDataSource.type
                additionalProperties =
                    apiAssociationTimestampDataSource.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ApiAssociationTimestampDataSource].
         *
         ...
         */
        fun build(): ApiAssociationTimestampDataSource =
            ApiAssociationTimestampDataSource(
    ...
    fun validate(): ApiAssociationTimestampDataSource = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val ASSOCIATION_TIMESTAMP = of("ASSOCIATION_TIMESTAMP")
        ...
        fun value(): Value =
            when (this) {
                ASSOCIATION_TIMESTAMP -> Value.ASSOCIATION_TIMESTAMP
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                ASSOCIATION_TIMESTAMP -> Known.ASSOCIATION_TIMESTAMP
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ApiAssociationTimestampDataSource &&
    ...
    override fun toString() =
        "ApiAssociationTimestampDataSource{associationCategory=$associationCategory, associationTypeId=$associationTypeId, name=$name, objectTypeId=$objectTypeId, type=$type, additionalProperties=$additionalProperties}"
}
