...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NumberPropertyVariable].
         *
    ...
    /** A builder for [NumberPropertyVariable]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(numberPropertyVariable: NumberPropertyVariable) = apply {
            operator = numberPropertyVariable.operator
            propertyName = numberPropertyVariable.propertyName
            value = numberPropertyVariable.value
            additionalProperties = numberPropertyVariable.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NumberPropertyVariable].
         *
         ...
         */
        fun build(): NumberPropertyVariable =
    ...
    fun validate(): NumberPropertyVariable = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val NUMBER_PROPERTY_VARIABLE = of("NUMBER_PROPERTY_VARIABLE")
        ...
        fun value(): Value =
            when (this) {
                NUMBER_PROPERTY_VARIABLE -> Value.NUMBER_PROPERTY_VARIABLE
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                NUMBER_PROPERTY_VARIABLE -> Known.NUMBER_PROPERTY_VARIABLE
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NumberPropertyVariable &&
    ...
    override fun toString() =
        "NumberPropertyVariable{operator=$operator, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
