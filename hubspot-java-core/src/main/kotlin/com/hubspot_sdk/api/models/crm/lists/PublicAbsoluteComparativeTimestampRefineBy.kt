...
private constructor(
    ...
    /** A builder for [PublicAbsoluteComparativeTimestampRefineBy]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            comparison = publicAbsoluteComparativeTimestampRefineBy.comparison
            timestamp = publicAbsoluteComparativeTimestampRefineBy.timestamp
            type = publicAbsoluteComparativeTimestampRefineBy.type
            additionalProperties =
                publicAbsoluteComparativeTimestampRefineBy.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicAbsoluteComparativeTimestampRefineBy].
         *
         ...
         */
        fun build(): PublicAbsoluteComparativeTimestampRefineBy =
            PublicAbsoluteComparativeTimestampRefineBy(
    ...
    fun validate(): PublicAbsoluteComparativeTimestampRefineBy = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val ABSOLUTE_COMPARATIVE = of("ABSOLUTE_COMPARATIVE")
        ...
        fun value(): Value =
            when (this) {
                ABSOLUTE_COMPARATIVE -> Value.ABSOLUTE_COMPARATIVE
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                ABSOLUTE_COMPARATIVE -> Known.ABSOLUTE_COMPARATIVE
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicAbsoluteComparativeTimestampRefineBy &&
    ...
    override fun toString() =
        "PublicAbsoluteComparativeTimestampRefineBy{comparison=$comparison, timestamp=$timestamp, type=$type, additionalProperties=$additionalProperties}"
}
