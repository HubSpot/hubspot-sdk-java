...
private constructor(
    ...
    ) : this(ruleArguments, mutableMapOf())
     ...
     */
    @JvmSynthetic internal fun validity(): Int = (ruleArguments.asKnown().getOrNull()?.size ?: 0)
    ...
    private val hashCode: Int by lazy { Objects.hash(ruleArguments, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "PublicPropertyValidationRuleUpdate{ruleArguments=$ruleArguments, additionalProperties=$additionalProperties}"
}
