...
class BatchResponsePublicActor
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchResponsePublicActor].
         *
    ...
    /** A builder for [BatchResponsePublicActor]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchResponsePublicActor: BatchResponsePublicActor) = apply {
            completedAt = batchResponsePublicActor.completedAt
            results = batchResponsePublicActor.results.map { it.toMutableList() }
            startedAt = batchResponsePublicActor.startedAt
            status = batchResponsePublicActor.status
            links = batchResponsePublicActor.links
            requestedAt = batchResponsePublicActor.requestedAt
            additionalProperties = batchResponsePublicActor.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BatchResponsePublicActor].
         *
         ...
         */
        fun build(): BatchResponsePublicActor =
    ...
    fun validate(): BatchResponsePublicActor = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponsePublicActor &&
    ...
    override fun toString() =
        "BatchResponsePublicActor{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, links=$links, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
