...
private constructor(
    ...
    private val results: JsonField<List<PublicAssociationDefinitionConfigurationUpdateResult>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<PublicAssociationDefinitionConfigurationUpdateResult>> =
            JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<PublicAssociationDefinitionConfigurationUpdateResult> =
    ...
    /**
     * The current status of the batch update operation, which can be CANCELED, COMPLETE, PENDING,
     * or PROCESSING.
     *
     * @throws HubspotInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<PublicAssociationDefinitionConfigurationUpdateResult>> = results
    ...
    /** A builder for [BatchResponsePublicAssociationDefinitionConfigurationUpdateResult]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results:
            JsonField<MutableList<PublicAssociationDefinitionConfigurationUpdateResult>>? =
            null
        ...
        internal fun from(
            ...
            results =
                batchResponsePublicAssociationDefinitionConfigurationUpdateResult.results.map {
                    it.toMutableList()
                }
            startedAt = batchResponsePublicAssociationDefinitionConfigurationUpdateResult.startedAt
            status = batchResponsePublicAssociationDefinitionConfigurationUpdateResult.status
            errors =
                batchResponsePublicAssociationDefinitionConfigurationUpdateResult.errors.map {
                    it.toMutableList()
                }
            links = batchResponsePublicAssociationDefinitionConfigurationUpdateResult.links
            numErrors = batchResponsePublicAssociationDefinitionConfigurationUpdateResult.numErrors
            requestedAt =
                batchResponsePublicAssociationDefinitionConfigurationUpdateResult.requestedAt
        ...
        fun results(results: List<PublicAssociationDefinitionConfigurationUpdateResult>) =
         ...
         * `List<PublicAssociationDefinitionConfigurationUpdateResult>` value instead. This method
         * is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun results(
            results: JsonField<List<PublicAssociationDefinitionConfigurationUpdateResult>>
        ) = apply { this.results = results.map { it.toMutableList() } }

        /**
         * Adds a single [PublicAssociationDefinitionConfigurationUpdateResult] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: PublicAssociationDefinitionConfigurationUpdateResult) = apply {
            results =
        ...
        /**
         * The current status of the batch update operation, which can be CANCELED, COMPLETE,
         ...
         */
        fun build(): BatchResponsePublicAssociationDefinitionConfigurationUpdateResult =
            BatchResponsePublicAssociationDefinitionConfigurationUpdateResult(
    ...
    fun validate(): BatchResponsePublicAssociationDefinitionConfigurationUpdateResult = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponsePublicAssociationDefinitionConfigurationUpdateResult &&
    ...
    override fun toString() =
        "BatchResponsePublicAssociationDefinitionConfigurationUpdateResult{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
