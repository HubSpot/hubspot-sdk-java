...
private constructor(
    private val results: JsonField<List<HubDbTableV3>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<HubDbTableV3>> = JsonMissing.of(),
     ...
     */
    fun results(): List<HubDbTableV3> = results.getRequired("results")
     ...
     */
    @JsonProperty("results") @ExcludeMissing fun _results(): JsonField<List<HubDbTableV3>> = results
    ...
    /** A builder for [CollectionResponseWithTotalHubDbTableV3ForwardPaging]. */
    class Builder internal constructor() {

        private var results: JsonField<MutableList<HubDbTableV3>>? = null
        ...
        internal fun from(
            ...
            results =
                collectionResponseWithTotalHubDbTableV3ForwardPaging.results.map {
                    it.toMutableList()
                }
            total = collectionResponseWithTotalHubDbTableV3ForwardPaging.total
            paging = collectionResponseWithTotalHubDbTableV3ForwardPaging.paging
            additionalProperties =
                collectionResponseWithTotalHubDbTableV3ForwardPaging.additionalProperties
                    .toMutableMap()
        }

        fun results(results: List<HubDbTableV3>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed `List<HubDbTableV3>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun results(results: JsonField<List<HubDbTableV3>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [HubDbTableV3] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: HubDbTableV3) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [CollectionResponseWithTotalHubDbTableV3ForwardPaging].
         *
         ...
         */
        fun build(): CollectionResponseWithTotalHubDbTableV3ForwardPaging =
            CollectionResponseWithTotalHubDbTableV3ForwardPaging(
    ...
    fun validate(): CollectionResponseWithTotalHubDbTableV3ForwardPaging = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionResponseWithTotalHubDbTableV3ForwardPaging &&
    ...
    override fun toString() =
        "CollectionResponseWithTotalHubDbTableV3ForwardPaging{results=$results, total=$total, paging=$paging, additionalProperties=$additionalProperties}"
}
