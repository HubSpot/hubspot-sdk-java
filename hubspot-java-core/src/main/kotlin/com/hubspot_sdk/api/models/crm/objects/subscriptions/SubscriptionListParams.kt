...
/**
 * Retrieve a list of subscription objects, with options to filter by properties, associations, and
 * archived status.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionListParams: SubscriptionListParams) = apply {
            ...
            archived = subscriptionListParams.archived
            associations = subscriptionListParams.associations?.toMutableList()
            limit = subscriptionListParams.limit
            properties = subscriptionListParams.properties?.toMutableList()
            propertiesWithHistory = subscriptionListParams.propertiesWithHistory?.toMutableList()
    ...
    override fun toString() =
        "SubscriptionListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
