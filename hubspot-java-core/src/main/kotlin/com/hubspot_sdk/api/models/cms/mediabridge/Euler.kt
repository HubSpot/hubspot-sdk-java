...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(euler: Euler) = apply {
            ...
            inputs = euler.inputs.map { it.toMutableList() }
    ...
    override fun toString() =
        "Euler{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
