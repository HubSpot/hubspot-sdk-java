...
private constructor(
    ...
    /** A builder for [CollectionResponseWithTotalVersionBlogPost]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            results = collectionResponseWithTotalVersionBlogPost.results.map { it.toMutableList() }
            total = collectionResponseWithTotalVersionBlogPost.total
            paging = collectionResponseWithTotalVersionBlogPost.paging
            additionalProperties =
                collectionResponseWithTotalVersionBlogPost.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CollectionResponseWithTotalVersionBlogPost].
         *
         ...
         */
        fun build(): CollectionResponseWithTotalVersionBlogPost =
            CollectionResponseWithTotalVersionBlogPost(
    ...
    fun validate(): CollectionResponseWithTotalVersionBlogPost = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionResponseWithTotalVersionBlogPost &&
    ...
    override fun toString() =
        "CollectionResponseWithTotalVersionBlogPost{results=$results, total=$total, paging=$paging, additionalProperties=$additionalProperties}"
}
