...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TableListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TableListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TableListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tableListParams: TableListParams) = apply {
            after = tableListParams.after
            archived = tableListParams.archived
            contentType = tableListParams.contentType
            createdAfter = tableListParams.createdAfter
            createdAt = tableListParams.createdAt
            createdBefore = tableListParams.createdBefore
            isGetLocalizedSchema = tableListParams.isGetLocalizedSchema
            limit = tableListParams.limit
            sort = tableListParams.sort?.toMutableList()
            updatedAfter = tableListParams.updatedAfter
            updatedAt = tableListParams.updatedAt
            updatedBefore = tableListParams.updatedBefore
            additionalHeaders = tableListParams.additionalHeaders.toBuilder()
            additionalQueryParams = tableListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TableListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TableListParams =
            TableListParams(
                after,
                archived,
                contentType,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TableListParams &&
            after == other.after &&
    ...
    override fun toString() =
        "TableListParams{after=$after, archived=$archived, contentType=$contentType, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, isGetLocalizedSchema=$isGetLocalizedSchema, limit=$limit, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
