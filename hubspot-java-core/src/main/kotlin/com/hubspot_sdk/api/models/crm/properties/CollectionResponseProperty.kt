...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CollectionResponseProperty].
         *
    ...
    /** A builder for [CollectionResponseProperty]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(collectionResponseProperty: CollectionResponseProperty) = apply {
            results = collectionResponseProperty.results.map { it.toMutableList() }
            paging = collectionResponseProperty.paging
            additionalProperties = collectionResponseProperty.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CollectionResponseProperty].
         *
         ...
         */
        fun build(): CollectionResponseProperty =
    ...
    fun validate(): CollectionResponseProperty = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionResponseProperty &&
    ...
    override fun toString() =
        "CollectionResponseProperty{results=$results, paging=$paging, additionalProperties=$additionalProperties}"
}
