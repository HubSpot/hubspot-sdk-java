...
/**
 * Read an Object identified by `{taxId}`. `{taxId}` refers to the internal object ID by default, or
...
private constructor(
    ...
    fun taxId(): Optional<String> = Optional.ofNullable(taxId)
    ...
    companion object {
        ...
        @JvmStatic fun none(): TaxGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TaxGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TaxGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(taxGetParams: TaxGetParams) = apply {
            taxId = taxGetParams.taxId
            archived = taxGetParams.archived
            associations = taxGetParams.associations?.toMutableList()
            idProperty = taxGetParams.idProperty
            properties = taxGetParams.properties?.toMutableList()
            propertiesWithHistory = taxGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = taxGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = taxGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TaxGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TaxGetParams =
            TaxGetParams(
                taxId,
                archived,
    ...
    override fun toString() =
        "TaxGetParams{taxId=$taxId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
