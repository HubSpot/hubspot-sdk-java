...
class PortalBatchUpsertResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PortalBatchUpsertResponse].
         *
    ...
    /** A builder for [PortalBatchUpsertResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portalBatchUpsertResponse: PortalBatchUpsertResponse) = apply {
            portalFlagStates = portalBatchUpsertResponse.portalFlagStates.map { it.toMutableList() }
            additionalProperties = portalBatchUpsertResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PortalBatchUpsertResponse].
         *
         ...
         */
        fun build(): PortalBatchUpsertResponse =
    ...
    fun validate(): PortalBatchUpsertResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PortalBatchUpsertResponse &&
    ...
    override fun toString() =
        "PortalBatchUpsertResponse{portalFlagStates=$portalFlagStates, additionalProperties=$additionalProperties}"
}
