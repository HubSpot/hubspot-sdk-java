...
private constructor(
    ...
    private val consentToProcessCheckboxLabel: JsonField<String>,
    private val consentToProcessFooterText: JsonField<String>,
    ...
    private constructor(
        ...
        @JsonProperty("consentToProcessCheckboxLabel")
        @ExcludeMissing
        consentToProcessCheckboxLabel: JsonField<String> = JsonMissing.of(),
        @JsonProperty("consentToProcessFooterText")
        @ExcludeMissing
        consentToProcessFooterText: JsonField<String> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun consentToProcessCheckboxLabel(): Optional<String> =
        consentToProcessCheckboxLabel.getOptional("consentToProcessCheckboxLabel")

    /**
     * @throws HubspotInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun consentToProcessFooterText(): Optional<String> =
        consentToProcessFooterText.getOptional("consentToProcessFooterText")
    ...
    /**
     * Returns the raw JSON value of [consentToProcessCheckboxLabel].
     *
     * Unlike [consentToProcessCheckboxLabel], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("consentToProcessCheckboxLabel")
    @ExcludeMissing
    fun _consentToProcessCheckboxLabel(): JsonField<String> = consentToProcessCheckboxLabel

    /**
     * Returns the raw JSON value of [consentToProcessFooterText].
     *
     * Unlike [consentToProcessFooterText], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("consentToProcessFooterText")
    @ExcludeMissing
    fun _consentToProcessFooterText(): JsonField<String> = consentToProcessFooterText
    ...
    /** A builder for [LegalConsentOptionsExplicitConsentToProcess]. */
    class Builder internal constructor() {
        ...
        private var consentToProcessCheckboxLabel: JsonField<String> = JsonMissing.of()
        private var consentToProcessFooterText: JsonField<String> = JsonMissing.of()
        ...
        internal fun from(
            ...
            communicationsCheckboxes =
                legalConsentOptionsExplicitConsentToProcess.communicationsCheckboxes.map {
                    it.toMutableList()
                }
            privacyText = legalConsentOptionsExplicitConsentToProcess.privacyText
            type = legalConsentOptionsExplicitConsentToProcess.type
            communicationConsentText =
                legalConsentOptionsExplicitConsentToProcess.communicationConsentText
            consentToProcessCheckboxLabel =
                legalConsentOptionsExplicitConsentToProcess.consentToProcessCheckboxLabel
            consentToProcessFooterText =
                legalConsentOptionsExplicitConsentToProcess.consentToProcessFooterText
            consentToProcessText = legalConsentOptionsExplicitConsentToProcess.consentToProcessText
            additionalProperties =
                legalConsentOptionsExplicitConsentToProcess.additionalProperties.toMutableMap()
        }
        ...
        fun consentToProcessCheckboxLabel(consentToProcessCheckboxLabel: String) =
            consentToProcessCheckboxLabel(JsonField.of(consentToProcessCheckboxLabel))

        /**
         * Sets [Builder.consentToProcessCheckboxLabel] to an arbitrary JSON value.
         *
         * You should usually call [Builder.consentToProcessCheckboxLabel] with a well-typed
         * [String] value instead. This method is primarily for setting the field to an undocumented
         * or not yet supported value.
         */
        fun consentToProcessCheckboxLabel(consentToProcessCheckboxLabel: JsonField<String>) =
            apply {
                this.consentToProcessCheckboxLabel = consentToProcessCheckboxLabel
            }

        fun consentToProcessFooterText(consentToProcessFooterText: String) =
            consentToProcessFooterText(JsonField.of(consentToProcessFooterText))

        /**
         * Sets [Builder.consentToProcessFooterText] to an arbitrary JSON value.
         *
         * You should usually call [Builder.consentToProcessFooterText] with a well-typed [String]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun consentToProcessFooterText(consentToProcessFooterText: JsonField<String>) = apply {
            this.consentToProcessFooterText = consentToProcessFooterText
        }
        ...
        /**
         * Returns an immutable instance of [LegalConsentOptionsExplicitConsentToProcess].
         *
         ...
         */
        fun build(): LegalConsentOptionsExplicitConsentToProcess =
            LegalConsentOptionsExplicitConsentToProcess(
    ...
    fun validate(): LegalConsentOptionsExplicitConsentToProcess = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (communicationsCheckboxes.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
            ...
            (if (consentToProcessCheckboxLabel.asKnown().isPresent) 1 else 0) +
            (if (consentToProcessFooterText.asKnown().isPresent) 1 else 0) +
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val EXPLICIT_CONSENT_TO_PROCESS = of("explicit_consent_to_process")
        ...
        fun value(): Value =
            when (this) {
                EXPLICIT_CONSENT_TO_PROCESS -> Value.EXPLICIT_CONSENT_TO_PROCESS
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                EXPLICIT_CONSENT_TO_PROCESS -> Known.EXPLICIT_CONSENT_TO_PROCESS
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LegalConsentOptionsExplicitConsentToProcess &&
            ...
            consentToProcessCheckboxLabel == other.consentToProcessCheckboxLabel &&
            consentToProcessFooterText == other.consentToProcessFooterText &&
    ...
    override fun toString() =
        "LegalConsentOptionsExplicitConsentToProcess{communicationsCheckboxes=$communicationsCheckboxes, privacyText=$privacyText, type=$type, communicationConsentText=$communicationConsentText, consentToProcessCheckboxLabel=$consentToProcessCheckboxLabel, consentToProcessFooterText=$consentToProcessFooterText, consentToProcessText=$consentToProcessText, additionalProperties=$additionalProperties}"
}
