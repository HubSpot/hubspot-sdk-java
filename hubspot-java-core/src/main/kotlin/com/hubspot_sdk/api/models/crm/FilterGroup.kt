...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FilterGroup].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(filterGroup: FilterGroup) = apply {
            filters = filterGroup.filters.map { it.toMutableList() }
        ...
        /**
         * Returns an immutable instance of [FilterGroup].
         *
    ...
    fun validate(): FilterGroup = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "FilterGroup{filters=$filters, additionalProperties=$additionalProperties}"
}
