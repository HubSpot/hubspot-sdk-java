...
private constructor(
    ...
    private val results: JsonField<List<PublicAssociationMulti>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<PublicAssociationMulti>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<PublicAssociationMulti> = results.getRequired("results")
    ...
    /**
     * The current status of the batch operation, with possible values: PENDING, PROCESSING,
     * CANCELED, COMPLETE.
     *
     * @throws HubspotInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<PublicAssociationMulti>> = results
    ...
    /** A builder for [BatchResponsePublicAssociationMulti]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<PublicAssociationMulti>>? = null
        ...
        internal fun from(
            ...
            completedAt = batchResponsePublicAssociationMulti.completedAt
            results = batchResponsePublicAssociationMulti.results.map { it.toMutableList() }
            startedAt = batchResponsePublicAssociationMulti.startedAt
            status = batchResponsePublicAssociationMulti.status
            errors = batchResponsePublicAssociationMulti.errors.map { it.toMutableList() }
            links = batchResponsePublicAssociationMulti.links
            numErrors = batchResponsePublicAssociationMulti.numErrors
            requestedAt = batchResponsePublicAssociationMulti.requestedAt
            additionalProperties =
                batchResponsePublicAssociationMulti.additionalProperties.toMutableMap()
        }
        ...
        fun results(results: List<PublicAssociationMulti>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed
         * `List<PublicAssociationMulti>` value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun results(results: JsonField<List<PublicAssociationMulti>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [PublicAssociationMulti] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: PublicAssociationMulti) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [BatchResponsePublicAssociationMulti].
         *
         ...
         */
        fun build(): BatchResponsePublicAssociationMulti =
            BatchResponsePublicAssociationMulti(
    ...
    fun validate(): BatchResponsePublicAssociationMulti = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponsePublicAssociationMulti &&
    ...
    override fun toString() =
        "BatchResponsePublicAssociationMulti{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
