...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(publicExportListRequest: PublicExportListRequest) = apply {
            ...
            associatedObjectType = publicExportListRequest.associatedObjectType
    ...
    override fun toString() =
        "PublicExportListRequest{exportInternalValuesOptions=$exportInternalValuesOptions, exportName=$exportName, exportType=$exportType, format=$format, language=$language, listId=$listId, objectProperties=$objectProperties, objectType=$objectType, overrideAssociatedObjectsPerDefinitionPerRowLimit=$overrideAssociatedObjectsPerDefinitionPerRowLimit, associatedObjectType=$associatedObjectType, additionalProperties=$additionalProperties}"
}
