...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(templateListParams: TemplateListParams) = apply {
            appId = templateListParams.appId
        ...
        fun build(): TemplateListParams =
            TemplateListParams(appId, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "TemplateListParams{appId=$appId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
