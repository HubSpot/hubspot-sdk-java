...
class SitePageUpdateBatchParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SitePageUpdateBatchParams].
         *
    ...
    /** A builder for [SitePageUpdateBatchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sitePageUpdateBatchParams: SitePageUpdateBatchParams) = apply {
            archived = sitePageUpdateBatchParams.archived
            batchInputJsonNode = sitePageUpdateBatchParams.batchInputJsonNode
            additionalHeaders = sitePageUpdateBatchParams.additionalHeaders.toBuilder()
            additionalQueryParams = sitePageUpdateBatchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SitePageUpdateBatchParams].
         *
         ...
         */
        fun build(): SitePageUpdateBatchParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SitePageUpdateBatchParams &&
    ...
    override fun toString() =
        "SitePageUpdateBatchParams{archived=$archived, batchInputJsonNode=$batchInputJsonNode, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
