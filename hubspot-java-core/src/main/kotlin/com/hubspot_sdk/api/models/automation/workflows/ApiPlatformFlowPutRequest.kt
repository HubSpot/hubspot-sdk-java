...
class ApiPlatformFlowPutRequest
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ApiPlatformFlowPutRequest].
         *
    ...
    /** A builder for [ApiPlatformFlowPutRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(apiPlatformFlowPutRequest: ApiPlatformFlowPutRequest) = apply {
            actions = apiPlatformFlowPutRequest.actions.map { it.toMutableList() }
            blockedDates = apiPlatformFlowPutRequest.blockedDates.map { it.toMutableList() }
            customProperties = apiPlatformFlowPutRequest.customProperties
            isEnabled = apiPlatformFlowPutRequest.isEnabled
            revisionId = apiPlatformFlowPutRequest.revisionId
            timeWindows = apiPlatformFlowPutRequest.timeWindows.map { it.toMutableList() }
            type = apiPlatformFlowPutRequest.type
            description = apiPlatformFlowPutRequest.description
            enrollmentCriteria = apiPlatformFlowPutRequest.enrollmentCriteria
            enrollmentSchedule = apiPlatformFlowPutRequest.enrollmentSchedule
            name = apiPlatformFlowPutRequest.name
            startActionId = apiPlatformFlowPutRequest.startActionId
            suppressionFilterBranch = apiPlatformFlowPutRequest.suppressionFilterBranch
            uuid = apiPlatformFlowPutRequest.uuid
            additionalProperties = apiPlatformFlowPutRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ApiPlatformFlowPutRequest].
         *
         ...
         */
        fun build(): ApiPlatformFlowPutRequest =
    ...
    fun validate(): ApiPlatformFlowPutRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ApiPlatformFlowPutRequest &&
    ...
    override fun toString() =
        "ApiPlatformFlowPutRequest{actions=$actions, blockedDates=$blockedDates, customProperties=$customProperties, isEnabled=$isEnabled, revisionId=$revisionId, timeWindows=$timeWindows, type=$type, description=$description, enrollmentCriteria=$enrollmentCriteria, enrollmentSchedule=$enrollmentSchedule, name=$name, startActionId=$startActionId, suppressionFilterBranch=$suppressionFilterBranch, uuid=$uuid, additionalProperties=$additionalProperties}"
}
