...
private constructor(
    ...
    @JsonProperty("to")
    @ExcludeMissing
    fun _to(): JsonField<List<MultiAssociatedObjectWithLabel>> = to
    ...
    /** A builder for [PublicAssociationMultiWithLabel]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicAssociationMultiWithLabel: PublicAssociationMultiWithLabel) =
            apply {
                from = publicAssociationMultiWithLabel.from
                to = publicAssociationMultiWithLabel.to.map { it.toMutableList() }
                paging = publicAssociationMultiWithLabel.paging
                additionalProperties =
                    publicAssociationMultiWithLabel.additionalProperties.toMutableMap()
            }
        ...
        fun to(to: List<MultiAssociatedObjectWithLabel>) = to(JsonField.of(to))

        /**
         * Sets [Builder.to] to an arbitrary JSON value.
         *
         * You should usually call [Builder.to] with a well-typed
         * `List<MultiAssociatedObjectWithLabel>` value instead. This method is primarily for
         * setting the field to an undocumented or not yet supported value.
         */
        fun to(to: JsonField<List<MultiAssociatedObjectWithLabel>>) = apply {
            this.to = to.map { it.toMutableList() }
        }

        /**
         * Adds a single [MultiAssociatedObjectWithLabel] to [Builder.to].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addTo(to: MultiAssociatedObjectWithLabel) = apply {
            this.to =
        ...
        /**
         * Returns an immutable instance of [PublicAssociationMultiWithLabel].
         *
         ...
         */
        fun build(): PublicAssociationMultiWithLabel =
            PublicAssociationMultiWithLabel(
    ...
    fun validate(): PublicAssociationMultiWithLabel = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicAssociationMultiWithLabel &&
            from == other.from &&
            to == other.to &&
            paging == other.paging &&
    ...
    override fun toString() =
        "PublicAssociationMultiWithLabel{from=$from, to=$to, paging=$paging, additionalProperties=$additionalProperties}"
}
