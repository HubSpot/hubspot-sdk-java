...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UrlMapping].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(urlMapping: UrlMapping) = apply {
            id = urlMapping.id
            created = urlMapping.created
            destination = urlMapping.destination
            isMatchFullUrl = urlMapping.isMatchFullUrl
            isMatchQueryString = urlMapping.isMatchQueryString
            isOnlyAfterNotFound = urlMapping.isOnlyAfterNotFound
            isPattern = urlMapping.isPattern
            isProtocolAgnostic = urlMapping.isProtocolAgnostic
            isTrailingSlashOptional = urlMapping.isTrailingSlashOptional
            precedence = urlMapping.precedence
            redirectStyle = urlMapping.redirectStyle
            routePrefix = urlMapping.routePrefix
            updated = urlMapping.updated
            additionalProperties = urlMapping.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UrlMapping].
         *
    ...
    override fun toString() =
        "UrlMapping{id=$id, created=$created, destination=$destination, isMatchFullUrl=$isMatchFullUrl, isMatchQueryString=$isMatchQueryString, isOnlyAfterNotFound=$isOnlyAfterNotFound, isPattern=$isPattern, isProtocolAgnostic=$isProtocolAgnostic, isTrailingSlashOptional=$isTrailingSlashOptional, precedence=$precedence, redirectStyle=$redirectStyle, routePrefix=$routePrefix, updated=$updated, additionalProperties=$additionalProperties}"
}
