...
class RangedDatePropertyOperation
...
private constructor(
    ...
    /**
     * Returns the raw JSON value of [lowerBoundTimestamp].
     *
     * Unlike [lowerBoundTimestamp], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("lowerBoundTimestamp")
    @ExcludeMissing
    ...
    /**
     * Returns the raw JSON value of [upperBoundTimestamp].
     *
     * Unlike [upperBoundTimestamp], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("upperBoundTimestamp")
    @ExcludeMissing
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RangedDatePropertyOperation].
         *
    ...
    /** A builder for [RangedDatePropertyOperation]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rangedDatePropertyOperation: RangedDatePropertyOperation) = apply {
            includeObjectsWithNoValueSet = rangedDatePropertyOperation.includeObjectsWithNoValueSet
            lowerBoundTimestamp = rangedDatePropertyOperation.lowerBoundTimestamp
            operationType = rangedDatePropertyOperation.operationType
            operator = rangedDatePropertyOperation.operator
            operatorName = rangedDatePropertyOperation.operatorName
            propertyType = rangedDatePropertyOperation.propertyType
            requiresTimeZoneConversion = rangedDatePropertyOperation.requiresTimeZoneConversion
            upperBoundTimestamp = rangedDatePropertyOperation.upperBoundTimestamp
            defaultValue = rangedDatePropertyOperation.defaultValue
            renderSpec = rangedDatePropertyOperation.renderSpec
            additionalProperties = rangedDatePropertyOperation.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RangedDatePropertyOperation].
         *
        ...
        fun build(): RangedDatePropertyOperation =
            RangedDatePropertyOperation(
                ...
                checkRequired("upperBoundTimestamp", upperBoundTimestamp),
                defaultValue,
                renderSpec,
    ...
    fun validate(): RangedDatePropertyOperation = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (includeObjectsWithNoValueSet.asKnown().isPresent) 1 else 0) +
            (if (lowerBoundTimestamp.asKnown().isPresent) 1 else 0) +
            ...
            (if (upperBoundTimestamp.asKnown().isPresent) 1 else 0) +
    ...
    class PropertyType @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            @JvmField val DATETIME_RANGED = of("datetime-ranged")
        ...
        fun value(): Value =
            when (this) {
                DATETIME_RANGED -> Value.DATETIME_RANGED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                DATETIME_RANGED -> Known.DATETIME_RANGED
    ...
    override fun toString() =
        "RangedDatePropertyOperation{includeObjectsWithNoValueSet=$includeObjectsWithNoValueSet, lowerBoundTimestamp=$lowerBoundTimestamp, operationType=$operationType, operator=$operator, operatorName=$operatorName, propertyType=$propertyType, requiresTimeZoneConversion=$requiresTimeZoneConversion, upperBoundTimestamp=$upperBoundTimestamp, defaultValue=$defaultValue, renderSpec=$renderSpec, additionalProperties=$additionalProperties}"
}
