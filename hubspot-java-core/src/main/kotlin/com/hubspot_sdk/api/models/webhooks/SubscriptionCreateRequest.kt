...
private constructor(
    ...
    ) : this(eventType, active, objectTypeId, propertyName, mutableMapOf())
    ...
    private val hashCode: Int by lazy {
        Objects.hash(eventType, active, objectTypeId, propertyName, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "SubscriptionCreateRequest{eventType=$eventType, active=$active, objectTypeId=$objectTypeId, propertyName=$propertyName, additionalProperties=$additionalProperties}"
}
