...
private constructor(
    ...
    private val response: CollectionResponsePublicImportResponse,
) : PageAsync<PublicImportResponse> {

    /**
     * Delegates to [CollectionResponsePublicImportResponse], but gracefully handles missing data.
     *
     * @see CollectionResponsePublicImportResponse.results
     */
    ...
    fun response(): CollectionResponsePublicImportResponse = response
    ...
    class Builder internal constructor() {
        ...
        private var response: CollectionResponsePublicImportResponse? = null
        ...
        /** The response that this page was parsed from. */
        fun response(response: CollectionResponsePublicImportResponse) = apply {
