...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fetchSingleCurrencyPortalCurrency: FetchSingleCurrencyPortalCurrency) =
            apply {
                ...
                inputs = fetchSingleCurrencyPortalCurrency.inputs.map { it.toMutableList() }
    ...
    override fun toString() =
        "FetchSingleCurrencyPortalCurrency{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
