...
/**
 * Get the list of blog authors. Supports paging and filtering. This method would be useful for an
...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AuthorListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AuthorListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AuthorListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(authorListParams: AuthorListParams) = apply {
            after = authorListParams.after
            archived = authorListParams.archived
            createdAfter = authorListParams.createdAfter
            createdAt = authorListParams.createdAt
            createdBefore = authorListParams.createdBefore
            limit = authorListParams.limit
            property = authorListParams.property
            sort = authorListParams.sort?.toMutableList()
            updatedAfter = authorListParams.updatedAfter
            updatedAt = authorListParams.updatedAt
            updatedBefore = authorListParams.updatedBefore
            additionalHeaders = authorListParams.additionalHeaders.toBuilder()
            additionalQueryParams = authorListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AuthorListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AuthorListParams =
            AuthorListParams(
                after,
                archived,
                createdAfter,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AuthorListParams &&
            after == other.after &&
    ...
    override fun toString() =
        "AuthorListParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
