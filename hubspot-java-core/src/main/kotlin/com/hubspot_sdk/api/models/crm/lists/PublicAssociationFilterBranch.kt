...
private constructor(
    ...
    /**
     * Specifies the category of the association for the filter branch (HUBSPOT_DEFINED,
    ...
    /** A builder for [PublicAssociationFilterBranch]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicAssociationFilterBranch: PublicAssociationFilterBranch) = apply {
            associationCategory = publicAssociationFilterBranch.associationCategory
            associationTypeId = publicAssociationFilterBranch.associationTypeId
            filterBranches = publicAssociationFilterBranch.filterBranches.map { it.toMutableList() }
            filterBranchOperator = publicAssociationFilterBranch.filterBranchOperator
            filterBranchType = publicAssociationFilterBranch.filterBranchType
            filters = publicAssociationFilterBranch.filters.map { it.toMutableList() }
            objectTypeId = publicAssociationFilterBranch.objectTypeId
            operator = publicAssociationFilterBranch.operator
            additionalProperties = publicAssociationFilterBranch.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicAssociationFilterBranch].
         *
         ...
         */
        fun build(): PublicAssociationFilterBranch =
            PublicAssociationFilterBranch(
    ...
    fun validate(): PublicAssociationFilterBranch = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicAssociationFilterBranch &&
    ...
    override fun toString() =
        "PublicAssociationFilterBranch{associationCategory=$associationCategory, associationTypeId=$associationTypeId, filterBranches=$filterBranches, filterBranchOperator=$filterBranchOperator, filterBranchType=$filterBranchType, filters=$filters, objectTypeId=$objectTypeId, operator=$operator, additionalProperties=$additionalProperties}"
}
