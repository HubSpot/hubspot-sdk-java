...
class SiteSearchGetIndexedDataResponse
...
private constructor(
    ...
    ) : this(id, fields, type, mutableMapOf())
    ...
    /** A builder for [SiteSearchGetIndexedDataResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(siteSearchGetIndexedDataResponse: SiteSearchGetIndexedDataResponse) =
            apply {
                id = siteSearchGetIndexedDataResponse.id
                fields = siteSearchGetIndexedDataResponse.fields
                type = siteSearchGetIndexedDataResponse.type
                additionalProperties =
                    siteSearchGetIndexedDataResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SiteSearchGetIndexedDataResponse].
         *
         ...
         */
        fun build(): SiteSearchGetIndexedDataResponse =
            SiteSearchGetIndexedDataResponse(
                checkRequired("id", id),
    ...
    fun validate(): SiteSearchGetIndexedDataResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SiteSearchGetIndexedDataResponse &&
            id == other.id &&
            fields == other.fields &&
            type == other.type &&
    ...
    private val hashCode: Int by lazy { Objects.hash(id, fields, type, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "SiteSearchGetIndexedDataResponse{id=$id, fields=$fields, type=$type, additionalProperties=$additionalProperties}"
}
