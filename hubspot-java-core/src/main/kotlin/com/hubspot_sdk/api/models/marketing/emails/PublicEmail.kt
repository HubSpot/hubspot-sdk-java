...
private constructor(
    ...
    private val emailCampaignGroupId: JsonField<String>,
    private val emailTemplateMode: JsonField<EmailTemplateMode>,
    ...
    private val publishedByEmail: JsonField<String>,
    ...
    private val usersWithAccess: JsonField<List<String>>,
    private val webversion: JsonField<PublicWebversionDetails>,
    private val workflowNames: JsonField<List<String>>,
    ...
    private constructor(
        ...
        @JsonProperty("allEmailCampaignIds")
        @ExcludeMissing
        allEmailCampaignIds: JsonField<List<String>> = JsonMissing.of(),
        ...
        @JsonProperty("campaignUtm")
        @ExcludeMissing
        campaignUtm: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("emailCampaignGroupId")
        @ExcludeMissing
        emailCampaignGroupId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("emailTemplateMode")
        @ExcludeMissing
        emailTemplateMode: JsonField<EmailTemplateMode> = JsonMissing.of(),
        @JsonProperty("feedbackSurveyId")
        @ExcludeMissing
        ...
        @ExcludeMissing
        isTransactional: JsonField<Boolean> = JsonMissing.of(),
        ...
        @JsonProperty("primaryEmailCampaignId")
        @ExcludeMissing
        primaryEmailCampaignId: JsonField<String> = JsonMissing.of(),
        ...
        @ExcludeMissing
        publishedByEmail: JsonField<String> = JsonMissing.of(),
        @JsonProperty("publishedById")
        @ExcludeMissing
        publishedById: JsonField<String> = JsonMissing.of(),
        @JsonProperty("publishedByName")
        @ExcludeMissing
        publishedByName: JsonField<String> = JsonMissing.of(),
        ...
        @JsonProperty("teamsWithAccess")
        @ExcludeMissing
        teamsWithAccess: JsonField<List<String>> = JsonMissing.of(),
        ...
        @ExcludeMissing
        unpublishedAt: JsonField<OffsetDateTime> = JsonMissing.of(),
        ...
        @JsonProperty("usersWithAccess")
        @ExcludeMissing
        usersWithAccess: JsonField<List<String>> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun allEmailCampaignIds(): Optional<List<String>> =
        allEmailCampaignIds.getOptional("allEmailCampaignIds")
     ...
     *   server responded with an unexpected value).
     */
    fun campaignName(): Optional<String> = campaignName.getOptional("campaignName")

    /**
     * @throws HubspotInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun campaignUtm(): Optional<String> = campaignUtm.getOptional("campaignUtm")
     ...
     *   server responded with an unexpected value).
     */
    fun emailCampaignGroupId(): Optional<String> =
        emailCampaignGroupId.getOptional("emailCampaignGroupId")

    /**
     * @throws HubspotInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun emailTemplateMode(): Optional<EmailTemplateMode> =
        emailTemplateMode.getOptional("emailTemplateMode")
     ...
     *   server responded with an unexpected value).
     */
    fun folderId(): Optional<Long> = folderId.getOptional("folderId")
     ...
     *   server responded with an unexpected value).
     */
    fun isTransactional(): Optional<Boolean> = isTransactional.getOptional("isTransactional")
     ...
     *   server responded with an unexpected value).
     */
    fun previewKey(): Optional<String> = previewKey.getOptional("previewKey")

    /**
     * @throws HubspotInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun primaryEmailCampaignId(): Optional<String> =
        primaryEmailCampaignId.getOptional("primaryEmailCampaignId")
     ...
     *   server responded with an unexpected value).
     */
    fun publishedByEmail(): Optional<String> = publishedByEmail.getOptional("publishedByEmail")
     ...
     *   server responded with an unexpected value).
     */
    fun publishedById(): Optional<String> = publishedById.getOptional("publishedById")
     ...
     *   server responded with an unexpected value).
     */
    fun publishedByName(): Optional<String> = publishedByName.getOptional("publishedByName")
     ...
     *   server responded with an unexpected value).
     */
    fun teamsWithAccess(): Optional<List<String>> = teamsWithAccess.getOptional("teamsWithAccess")
     ...
     *   server responded with an unexpected value).
     */
    fun unpublishedAt(): Optional<OffsetDateTime> = unpublishedAt.getOptional("unpublishedAt")
     ...
     *   server responded with an unexpected value).
     */
    fun usersWithAccess(): Optional<List<String>> = usersWithAccess.getOptional("usersWithAccess")
    ...
    /**
     * Returns the raw JSON value of [allEmailCampaignIds].
     *
     * Unlike [allEmailCampaignIds], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("allEmailCampaignIds")
    @ExcludeMissing
    fun _allEmailCampaignIds(): JsonField<List<String>> = allEmailCampaignIds
    ...
    /**
     * Returns the raw JSON value of [campaignUtm].
     *
     * Unlike [campaignUtm], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("campaignUtm") @ExcludeMissing fun _campaignUtm(): JsonField<String> = campaignUtm

    /**
     * Returns the raw JSON value of [clonedFrom].
     *
    ...
    /**
     * Returns the raw JSON value of [emailCampaignGroupId].
     *
     * Unlike [emailCampaignGroupId], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("emailCampaignGroupId")
    @ExcludeMissing
    fun _emailCampaignGroupId(): JsonField<String> = emailCampaignGroupId

    /**
     * Returns the raw JSON value of [emailTemplateMode].
     *
     * Unlike [emailTemplateMode], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("emailTemplateMode")
    @ExcludeMissing
    fun _emailTemplateMode(): JsonField<EmailTemplateMode> = emailTemplateMode

    /**
     * Returns the raw JSON value of [feedbackSurveyId].
     *
     * Unlike [feedbackSurveyId], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("feedbackSurveyId")
    @ExcludeMissing
    fun _feedbackSurveyId(): JsonField<String> = feedbackSurveyId
     ...
     */
    @JsonProperty("folderId") @ExcludeMissing fun _folderId(): JsonField<Long> = folderId
    ...
    /**
     * Returns the raw JSON value of [isTransactional].
     *
     * Unlike [isTransactional], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("isTransactional")
    @ExcludeMissing
    fun _isTransactional(): JsonField<Boolean> = isTransactional
     ...
     *
     * Unlike [previewKey], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("previewKey") @ExcludeMissing fun _previewKey(): JsonField<String> = previewKey

    /**
     * Returns the raw JSON value of [primaryEmailCampaignId].
     *
     * Unlike [primaryEmailCampaignId], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("primaryEmailCampaignId")
    @ExcludeMissing
    fun _primaryEmailCampaignId(): JsonField<String> = primaryEmailCampaignId
    ...
    /**
     * Returns the raw JSON value of [publishedByEmail].
     *
     * Unlike [publishedByEmail], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("publishedByEmail")
    @ExcludeMissing
    fun _publishedByEmail(): JsonField<String> = publishedByEmail

    /**
     * Returns the raw JSON value of [publishedById].
     *
     * Unlike [publishedById], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("publishedById")
    @ExcludeMissing
    fun _publishedById(): JsonField<String> = publishedById

    /**
     * Returns the raw JSON value of [publishedByName].
     *
     * Unlike [publishedByName], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("publishedByName")
    @ExcludeMissing
    fun _publishedByName(): JsonField<String> = publishedByName
    ...
    /**
     * Returns the raw JSON value of [teamsWithAccess].
     *
     * Unlike [teamsWithAccess], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("teamsWithAccess")
    @ExcludeMissing
    fun _teamsWithAccess(): JsonField<List<String>> = teamsWithAccess
    ...
    /**
     * Returns the raw JSON value of [unpublishedAt].
     *
     * Unlike [unpublishedAt], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("unpublishedAt")
    @ExcludeMissing
    fun _unpublishedAt(): JsonField<OffsetDateTime> = unpublishedAt
    ...
    /**
     * Returns the raw JSON value of [usersWithAccess].
     *
     * Unlike [usersWithAccess], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("usersWithAccess")
    @ExcludeMissing
    fun _usersWithAccess(): JsonField<List<String>> = usersWithAccess
    ...
    /**
     * Returns the raw JSON value of [workflowNames].
     *
     * Unlike [workflowNames], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("workflowNames")
    @ExcludeMissing
    fun _workflowNames(): JsonField<List<String>> = workflowNames
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicEmail].
         *
    ...
    class Builder internal constructor() {
        ...
        private var emailCampaignGroupId: JsonField<String> = JsonMissing.of()
        private var emailTemplateMode: JsonField<EmailTemplateMode> = JsonMissing.of()
        ...
        private var publishedByEmail: JsonField<String> = JsonMissing.of()
        ...
        private var usersWithAccess: JsonField<MutableList<String>>? = null
        private var webversion: JsonField<PublicWebversionDetails> = JsonMissing.of()
        private var workflowNames: JsonField<MutableList<String>>? = null
        ...
        internal fun from(publicEmail: PublicEmail) = apply {
            ...
            businessUnitId = publicEmail.businessUnitId
            campaign = publicEmail.campaign
            ...
            emailCampaignGroupId = publicEmail.emailCampaignGroupId
            emailTemplateMode = publicEmail.emailTemplateMode
            ...
            publishedAt = publicEmail.publishedAt
            publishedByEmail = publicEmail.publishedByEmail
            ...
            updatedById = publicEmail.updatedById
            usersWithAccess = publicEmail.usersWithAccess.map { it.toMutableList() }
            webversion = publicEmail.webversion
        ...
        /** List of emailCampaignIds. */
        fun allEmailCampaignIds(allEmailCampaignIds: List<String>) =
            allEmailCampaignIds(JsonField.of(allEmailCampaignIds))

        /**
         * Sets [Builder.allEmailCampaignIds] to an arbitrary JSON value.
         *
         * You should usually call [Builder.allEmailCampaignIds] with a well-typed `List<String>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun allEmailCampaignIds(allEmailCampaignIds: JsonField<List<String>>) = apply {
            this.allEmailCampaignIds = allEmailCampaignIds.map { it.toMutableList() }
        }

        /**
         * Adds a single [String] to [allEmailCampaignIds].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addAllEmailCampaignId(allEmailCampaignId: String) = apply {
            allEmailCampaignIds =
                (allEmailCampaignIds ?: JsonField.of(mutableListOf())).also {
                    checkKnown("allEmailCampaignIds", it).add(allEmailCampaignId)
                }
        }
        ...
        fun campaignUtm(campaignUtm: String) = campaignUtm(JsonField.of(campaignUtm))

        /**
         * Sets [Builder.campaignUtm] to an arbitrary JSON value.
         *
         * You should usually call [Builder.campaignUtm] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun campaignUtm(campaignUtm: JsonField<String>) = apply { this.campaignUtm = campaignUtm }

        /** The ID of the email this email was cloned from. */
        fun clonedFrom(clonedFrom: String) = clonedFrom(JsonField.of(clonedFrom))

        /**
         * Sets [Builder.clonedFrom] to an arbitrary JSON value.
         *
         * You should usually call [Builder.clonedFrom] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        ...
        fun emailCampaignGroupId(emailCampaignGroupId: String) =
            emailCampaignGroupId(JsonField.of(emailCampaignGroupId))

        /**
         * Sets [Builder.emailCampaignGroupId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.emailCampaignGroupId] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun emailCampaignGroupId(emailCampaignGroupId: JsonField<String>) = apply {
            this.emailCampaignGroupId = emailCampaignGroupId
        }

        fun emailTemplateMode(emailTemplateMode: EmailTemplateMode) =
            emailTemplateMode(JsonField.of(emailTemplateMode))

        /**
         * Sets [Builder.emailTemplateMode] to an arbitrary JSON value.
         *
         * You should usually call [Builder.emailTemplateMode] with a well-typed [EmailTemplateMode]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun emailTemplateMode(emailTemplateMode: JsonField<EmailTemplateMode>) = apply {
            this.emailTemplateMode = emailTemplateMode
        }

        /** The ID of the feedback survey linked to the email. */
        fun feedbackSurveyId(feedbackSurveyId: String) =
            feedbackSurveyId(JsonField.of(feedbackSurveyId))

        /**
         * Sets [Builder.feedbackSurveyId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.feedbackSurveyId] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun feedbackSurveyId(feedbackSurveyId: JsonField<String>) = apply {
            this.feedbackSurveyId = feedbackSurveyId
        }

        fun folderId(folderId: Long) = folderId(JsonField.of(folderId))

        /**
         * Sets [Builder.folderId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.folderId] with a well-typed [Long] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun folderId(folderId: JsonField<Long>) = apply { this.folderId = folderId }
        ...
        /** Returns whether the email is a transactional email or not. This is read only. */
        fun isTransactional(isTransactional: Boolean) =
            isTransactional(JsonField.of(isTransactional))

        /**
         * Sets [Builder.isTransactional] to an arbitrary JSON value.
         *
         * You should usually call [Builder.isTransactional] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun isTransactional(isTransactional: JsonField<Boolean>) = apply {
        ...
        /**
         * Sets [Builder.previewKey] to an arbitrary JSON value.
         *
         * You should usually call [Builder.previewKey] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun previewKey(previewKey: JsonField<String>) = apply { this.previewKey = previewKey }

        fun primaryEmailCampaignId(primaryEmailCampaignId: String) =
            primaryEmailCampaignId(JsonField.of(primaryEmailCampaignId))

        /**
         * Sets [Builder.primaryEmailCampaignId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.primaryEmailCampaignId] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun primaryEmailCampaignId(primaryEmailCampaignId: JsonField<String>) = apply {
            this.primaryEmailCampaignId = primaryEmailCampaignId
        }
        ...
        /** Email of the user who published/sent the email. */
        fun publishedByEmail(publishedByEmail: String) =
            publishedByEmail(JsonField.of(publishedByEmail))

        /**
         * Sets [Builder.publishedByEmail] to an arbitrary JSON value.
         *
         * You should usually call [Builder.publishedByEmail] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun publishedByEmail(publishedByEmail: JsonField<String>) = apply {
            this.publishedByEmail = publishedByEmail
        }

        /** The ID of the user who published the email. */
        fun publishedById(publishedById: String) = publishedById(JsonField.of(publishedById))

        /**
         * Sets [Builder.publishedById] to an arbitrary JSON value.
         *
         * You should usually call [Builder.publishedById] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun publishedById(publishedById: JsonField<String>) = apply {
            this.publishedById = publishedById
        }

        /** Name of the user who published the email. */
        fun publishedByName(publishedByName: String) =
            publishedByName(JsonField.of(publishedByName))

        /**
         * Sets [Builder.publishedByName] to an arbitrary JSON value.
         *
         * You should usually call [Builder.publishedByName] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun publishedByName(publishedByName: JsonField<String>) = apply {
         ...
         *
         * You should usually call [Builder.stats] with a well-typed [EmailStatisticsData] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        fun teamsWithAccess(teamsWithAccess: List<String>) =
            teamsWithAccess(JsonField.of(teamsWithAccess))

        /**
         * Sets [Builder.teamsWithAccess] to an arbitrary JSON value.
         *
         * You should usually call [Builder.teamsWithAccess] with a well-typed `List<String>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun teamsWithAccess(teamsWithAccess: JsonField<List<String>>) = apply {
            this.teamsWithAccess = teamsWithAccess.map { it.toMutableList() }
        }

        /**
         * Adds a single [String] to [Builder.teamsWithAccess].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addTeamsWithAccess(teamsWithAccess: String) = apply {
            this.teamsWithAccess =
                (this.teamsWithAccess ?: JsonField.of(mutableListOf())).also {
                    checkKnown("teamsWithAccess", it).add(teamsWithAccess)
                }
        }
        ...
        fun unpublishedAt(unpublishedAt: OffsetDateTime) =
            unpublishedAt(JsonField.of(unpublishedAt))

        /**
         * Sets [Builder.unpublishedAt] to an arbitrary JSON value.
         *
         * You should usually call [Builder.unpublishedAt] with a well-typed [OffsetDateTime] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun unpublishedAt(unpublishedAt: JsonField<OffsetDateTime>) = apply {
        ...
        fun usersWithAccess(usersWithAccess: List<String>) =
            usersWithAccess(JsonField.of(usersWithAccess))

        /**
         * Sets [Builder.usersWithAccess] to an arbitrary JSON value.
         *
         * You should usually call [Builder.usersWithAccess] with a well-typed `List<String>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun usersWithAccess(usersWithAccess: JsonField<List<String>>) = apply {
            this.usersWithAccess = usersWithAccess.map { it.toMutableList() }
        }

        /**
         * Adds a single [String] to [Builder.usersWithAccess].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addUsersWithAccess(usersWithAccess: String) = apply {
            this.usersWithAccess =
                (this.usersWithAccess ?: JsonField.of(mutableListOf())).also {
                    checkKnown("usersWithAccess", it).add(usersWithAccess)
                }
        }
        ...
        /** Names of workflows in which the email is used within a "send email" action. */
        fun workflowNames(workflowNames: List<String>) = workflowNames(JsonField.of(workflowNames))

        /**
         * Sets [Builder.workflowNames] to an arbitrary JSON value.
         *
         * You should usually call [Builder.workflowNames] with a well-typed `List<String>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun workflowNames(workflowNames: JsonField<List<String>>) = apply {
            this.workflowNames = workflowNames.map { it.toMutableList() }
        }

        /**
         * Adds a single [String] to [workflowNames].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addWorkflowName(workflowName: String) = apply {
            workflowNames =
                (workflowNames ?: JsonField.of(mutableListOf())).also {
                    checkKnown("workflowNames", it).add(workflowName)
                }
        }
        ...
        /**
         * Returns an immutable instance of [PublicEmail].
         *
        ...
        fun build(): PublicEmail =
            PublicEmail(
                ...
                updatedAt,
                updatedById,
                (usersWithAccess ?: JsonMissing.of()).map { it.toImmutable() },
                webversion,
                (workflowNames ?: JsonMissing.of()).map { it.toImmutable() },
    ...
    fun validate(): PublicEmail = apply {
        if (validated) {
            return@apply
        }
        ...
        deletedAt()
        emailCampaignGroupId()
        emailTemplateMode().ifPresent { it.validate() }
        feedbackSurveyId()
        folderId()
        folderIdV2()
    ...
    internal fun validity(): Int =
        (if (isAb.asKnown().isPresent) 1 else 0) +
            ...
            (if (emailCampaignGroupId.asKnown().isPresent) 1 else 0) +
            (emailTemplateMode.asKnown().getOrNull()?.validity() ?: 0) +
            ...
            (if (publishedByEmail.asKnown().isPresent) 1 else 0) +
    ...
    class EmailTemplateMode @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            @JvmField val DESIGN_MANAGER = of("DESIGN_MANAGER")

            @JvmField val DRAG_AND_DROP = of("DRAG_AND_DROP")

            @JvmStatic fun of(value: String) = EmailTemplateMode(JsonField.of(value))
        }

        /** An enum containing [EmailTemplateMode]'s known values. */
        enum class Known {
            DESIGN_MANAGER,
            DRAG_AND_DROP,
        }
        ...
        /**
         * An enum containing [EmailTemplateMode]'s known values, as well as an [_UNKNOWN] member.
         *
         * An instance of [EmailTemplateMode] can contain an unknown value in a couple of cases:
        ...
        enum class Value {
            ...
            DRAG_AND_DROP,
            /**
             * An enum member indicating that [EmailTemplateMode] was instantiated with an unknown
             * value.
             */
            _UNKNOWN,
        }
        ...
        fun value(): Value =
            when (this) {
                DESIGN_MANAGER -> Value.DESIGN_MANAGER
        ...
        fun known(): Known =
            when (this) {
                DESIGN_MANAGER -> Known.DESIGN_MANAGER
                DRAG_AND_DROP -> Known.DRAG_AND_DROP
                else -> throw HubspotInvalidDataException("Unknown EmailTemplateMode: $value")
            }
        ...
        fun validate(): EmailTemplateMode = apply {
            if (validated) {
                return@apply
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is EmailTemplateMode && value == other.value
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicEmail &&
            ...
            emailCampaignGroupId == other.emailCampaignGroupId &&
            emailTemplateMode == other.emailTemplateMode &&
            ...
            publishedByEmail == other.publishedByEmail &&
            ...
            usersWithAccess == other.usersWithAccess &&
