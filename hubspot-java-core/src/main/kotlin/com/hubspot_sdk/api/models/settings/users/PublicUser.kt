...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        private var superAdmin: JsonField<Boolean>? = null
        ...
        fun build(): PublicUser =
            PublicUser(
                ...
                checkRequired("superAdmin", superAdmin),
                firstName,
                lastName,
                primaryTeamId,
                roleId,
    ...
    override fun toString() =
        "PublicUser{id=$id, email=$email, roleIds=$roleIds, superAdmin=$superAdmin, firstName=$firstName, lastName=$lastName, primaryTeamId=$primaryTeamId, roleId=$roleId, secondaryTeamIds=$secondaryTeamIds, sendWelcomeEmail=$sendWelcomeEmail, additionalProperties=$additionalProperties}"
}
