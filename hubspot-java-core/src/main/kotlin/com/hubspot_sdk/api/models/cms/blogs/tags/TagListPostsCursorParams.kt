...
class TagListPostsCursorParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TagListPostsCursorParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TagListPostsCursorParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TagListPostsCursorParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tagListPostsCursorParams: TagListPostsCursorParams) = apply {
            after = tagListPostsCursorParams.after
            archived = tagListPostsCursorParams.archived
            createdAfter = tagListPostsCursorParams.createdAfter
            createdAt = tagListPostsCursorParams.createdAt
            createdBefore = tagListPostsCursorParams.createdBefore
            limit = tagListPostsCursorParams.limit
            property = tagListPostsCursorParams.property
            sort = tagListPostsCursorParams.sort?.toMutableList()
            updatedAfter = tagListPostsCursorParams.updatedAfter
            updatedAt = tagListPostsCursorParams.updatedAt
            updatedBefore = tagListPostsCursorParams.updatedBefore
            additionalHeaders = tagListPostsCursorParams.additionalHeaders.toBuilder()
            additionalQueryParams = tagListPostsCursorParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TagListPostsCursorParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TagListPostsCursorParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TagListPostsCursorParams &&
            after == other.after &&
    ...
    override fun toString() =
        "TagListPostsCursorParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
