...
/** @see ListServiceAsync.listMembershipsJoinOrder */
class ListListMembershipsJoinOrderPageAsync
private constructor(
    ...
    override fun nextPage(): CompletableFuture<ListListMembershipsJoinOrderPageAsync> =
    ...
    companion object {
         ...
         * [ListListMembershipsJoinOrderPageAsync].
         *
    ...
    /** A builder for [ListListMembershipsJoinOrderPageAsync]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            listListMembershipsJoinOrderPageAsync: ListListMembershipsJoinOrderPageAsync
        ) = apply {
            service = listListMembershipsJoinOrderPageAsync.service
            streamHandlerExecutor = listListMembershipsJoinOrderPageAsync.streamHandlerExecutor
            params = listListMembershipsJoinOrderPageAsync.params
            response = listListMembershipsJoinOrderPageAsync.response
        }
        ...
        /**
         * Returns an immutable instance of [ListListMembershipsJoinOrderPageAsync].
         *
         ...
         */
        fun build(): ListListMembershipsJoinOrderPageAsync =
            ListListMembershipsJoinOrderPageAsync(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ListListMembershipsJoinOrderPageAsync &&
    ...
    override fun toString() =
        "ListListMembershipsJoinOrderPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}
