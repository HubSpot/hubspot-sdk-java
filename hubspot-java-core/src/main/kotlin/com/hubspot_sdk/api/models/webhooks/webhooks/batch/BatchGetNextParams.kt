...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchGetNextParams].
         *
    ...
    /** A builder for [BatchGetNextParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchGetNextParams: BatchGetNextParams) = apply {
            offset = batchGetNextParams.offset
            count = batchGetNextParams.count
            installPortalId = batchGetNextParams.installPortalId
            additionalHeaders = batchGetNextParams.additionalHeaders.toBuilder()
            additionalQueryParams = batchGetNextParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BatchGetNextParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchGetNextParams &&
            offset == other.offset &&
            count == other.count &&
    ...
    override fun toString() =
        "BatchGetNextParams{offset=$offset, count=$count, installPortalId=$installPortalId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
