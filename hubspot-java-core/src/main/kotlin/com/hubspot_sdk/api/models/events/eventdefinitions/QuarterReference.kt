...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [QuarterReference].
         *
    ...
    /** A builder for [QuarterReference]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(quarterReference: QuarterReference) = apply {
            day = quarterReference.day
            month = quarterReference.month
            referenceType = quarterReference.referenceType
            hour = quarterReference.hour
            millisecond = quarterReference.millisecond
            minute = quarterReference.minute
            second = quarterReference.second
            additionalProperties = quarterReference.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [QuarterReference].
         *
    ...
    fun validate(): QuarterReference = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is QuarterReference &&
            day == other.day &&
            month == other.month &&
    ...
    override fun toString() =
        "QuarterReference{day=$day, month=$month, referenceType=$referenceType, hour=$hour, millisecond=$millisecond, minute=$minute, second=$second, additionalProperties=$additionalProperties}"
}
