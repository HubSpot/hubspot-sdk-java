...
class IntegratorSettingUpdateEventVisibilitySettingsResponse
...
private constructor(
    ...
    /** A builder for [IntegratorSettingUpdateEventVisibilitySettingsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            eventType = integratorSettingUpdateEventVisibilitySettingsResponse.eventType
            updatedAt = integratorSettingUpdateEventVisibilitySettingsResponse.updatedAt
            showInReporting = integratorSettingUpdateEventVisibilitySettingsResponse.showInReporting
            showInTimeline = integratorSettingUpdateEventVisibilitySettingsResponse.showInTimeline
            showInWorkflows = integratorSettingUpdateEventVisibilitySettingsResponse.showInWorkflows
            additionalProperties =
                integratorSettingUpdateEventVisibilitySettingsResponse.additionalProperties
                    .toMutableMap()
        }
         ...
         */
        fun build(): IntegratorSettingUpdateEventVisibilitySettingsResponse =
            IntegratorSettingUpdateEventVisibilitySettingsResponse(
    ...
    fun validate(): IntegratorSettingUpdateEventVisibilitySettingsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IntegratorSettingUpdateEventVisibilitySettingsResponse &&
    ...
    override fun toString() =
        "IntegratorSettingUpdateEventVisibilitySettingsResponse{eventType=$eventType, updatedAt=$updatedAt, showInReporting=$showInReporting, showInTimeline=$showInTimeline, showInWorkflows=$showInWorkflows, additionalProperties=$additionalProperties}"
}
