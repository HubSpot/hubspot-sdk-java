...
private constructor(
    ...
    private val timelineEventTemplateUpdateRequest: TimelineEventTemplateUpdateRequest,
    ...
    fun timelineEventTemplateUpdateRequest(): TimelineEventTemplateUpdateRequest =
        timelineEventTemplateUpdateRequest

    fun _additionalBodyProperties(): Map<String, JsonValue> =
        timelineEventTemplateUpdateRequest._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        private var timelineEventTemplateUpdateRequest: TimelineEventTemplateUpdateRequest? = null
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        @JvmSynthetic
        internal fun from(templateUpdateParams: TemplateUpdateParams) = apply {
            appId = templateUpdateParams.appId
            eventTemplateId = templateUpdateParams.eventTemplateId
            timelineEventTemplateUpdateRequest =
                templateUpdateParams.timelineEventTemplateUpdateRequest
        ...
        /** State of the template definition being updated. */
        fun timelineEventTemplateUpdateRequest(
            timelineEventTemplateUpdateRequest: TimelineEventTemplateUpdateRequest
        ) = apply { this.timelineEventTemplateUpdateRequest = timelineEventTemplateUpdateRequest }
    ...
    fun _body(): TimelineEventTemplateUpdateRequest = timelineEventTemplateUpdateRequest
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TemplateUpdateParams &&
            ...
            timelineEventTemplateUpdateRequest == other.timelineEventTemplateUpdateRequest &&
    ...
    override fun toString() =
        "TemplateUpdateParams{appId=$appId, eventTemplateId=$eventTemplateId, timelineEventTemplateUpdateRequest=$timelineEventTemplateUpdateRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
