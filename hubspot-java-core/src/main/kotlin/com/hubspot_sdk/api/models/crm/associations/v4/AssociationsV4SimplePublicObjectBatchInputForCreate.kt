...
class AssociationsV4SimplePublicObjectBatchInputForCreate
...
private constructor(
    ...
    /** A builder for [AssociationsV4SimplePublicObjectBatchInputForCreate]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            associations =
                associationsV4SimplePublicObjectBatchInputForCreate.associations.map {
                    it.toMutableList()
                }
            properties = associationsV4SimplePublicObjectBatchInputForCreate.properties
            objectWriteTraceId =
                associationsV4SimplePublicObjectBatchInputForCreate.objectWriteTraceId
            additionalProperties =
                associationsV4SimplePublicObjectBatchInputForCreate.additionalProperties
                    .toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AssociationsV4SimplePublicObjectBatchInputForCreate].
         *
         ...
         */
        fun build(): AssociationsV4SimplePublicObjectBatchInputForCreate =
            AssociationsV4SimplePublicObjectBatchInputForCreate(
    ...
    fun validate(): AssociationsV4SimplePublicObjectBatchInputForCreate = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AssociationsV4SimplePublicObjectBatchInputForCreate &&
    ...
    override fun toString() =
        "AssociationsV4SimplePublicObjectBatchInputForCreate{associations=$associations, properties=$properties, objectWriteTraceId=$objectWriteTraceId, additionalProperties=$additionalProperties}"
}
