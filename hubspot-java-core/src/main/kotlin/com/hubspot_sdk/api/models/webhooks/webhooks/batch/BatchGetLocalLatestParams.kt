...
class BatchGetLocalLatestParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): BatchGetLocalLatestParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [BatchGetLocalLatestParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BatchGetLocalLatestParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchGetLocalLatestParams: BatchGetLocalLatestParams) = apply {
            count = batchGetLocalLatestParams.count
            installPortalId = batchGetLocalLatestParams.installPortalId
            additionalHeaders = batchGetLocalLatestParams.additionalHeaders.toBuilder()
            additionalQueryParams = batchGetLocalLatestParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BatchGetLocalLatestParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BatchGetLocalLatestParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchGetLocalLatestParams &&
            count == other.count &&
    ...
    override fun toString() =
        "BatchGetLocalLatestParams{count=$count, installPortalId=$installPortalId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
