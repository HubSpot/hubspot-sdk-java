...
class PartnerServiceListParams
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of partner services
    ...
    companion object {
        ...
        @JvmStatic fun none(): PartnerServiceListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PartnerServiceListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PartnerServiceListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(partnerServiceListParams: PartnerServiceListParams) = apply {
            after = partnerServiceListParams.after
            archived = partnerServiceListParams.archived
            associations = partnerServiceListParams.associations?.toMutableList()
            limit = partnerServiceListParams.limit
            properties = partnerServiceListParams.properties?.toMutableList()
            propertiesWithHistory = partnerServiceListParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = partnerServiceListParams.additionalHeaders.toBuilder()
            additionalQueryParams = partnerServiceListParams.additionalQueryParams.toBuilder()
        }
         ...
         * of partner services that can be read by a single request.
         */
        ...
        /**
         * Returns an immutable instance of [PartnerServiceListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PartnerServiceListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PartnerServiceListParams &&
            after == other.after &&
    ...
    override fun toString() =
        "PartnerServiceListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
