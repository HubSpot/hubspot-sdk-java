...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(now: Now) = apply {
            ...
            inputs = now.inputs.map { it.toMutableList() }
    ...
    override fun toString() =
        "Now{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
