...
package com.hubspot_sdk.api.models.crm.objects.leads
...
private constructor(
    ...
    fun leadsId(): Optional<String> = Optional.ofNullable(leadsId)
    ...
    companion object {
        ...
        @JvmStatic fun none(): LeadGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [LeadGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LeadGetParams]. */
    class Builder internal constructor() {

        private var leadsId: String? = null
        ...
        @JvmSynthetic
        internal fun from(leadGetParams: LeadGetParams) = apply {
            leadsId = leadGetParams.leadsId
            archived = leadGetParams.archived
            associations = leadGetParams.associations?.toMutableList()
            idProperty = leadGetParams.idProperty
            properties = leadGetParams.properties?.toMutableList()
            propertiesWithHistory = leadGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = leadGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = leadGetParams.additionalQueryParams.toBuilder()
        }

        fun leadsId(leadsId: String?) = apply { this.leadsId = leadsId }

        /** Alias for calling [Builder.leadsId] with `leadsId.orElse(null)`. */
        fun leadsId(leadsId: Optional<String>) = leadsId(leadsId.getOrNull())
        ...
        /**
         * Returns an immutable instance of [LeadGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LeadGetParams =
            LeadGetParams(
                leadsId,
                archived,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LeadGetParams &&
            leadsId == other.leadsId &&
    ...
    override fun toString() =
        "LeadGetParams{leadsId=$leadsId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
