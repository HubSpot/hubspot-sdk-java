...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): CallGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [CallGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CallGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(callGetParams: CallGetParams) = apply {
            callId = callGetParams.callId
            archived = callGetParams.archived
            associations = callGetParams.associations?.toMutableList()
            idProperty = callGetParams.idProperty
            properties = callGetParams.properties?.toMutableList()
            propertiesWithHistory = callGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = callGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = callGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CallGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CallGetParams =
            CallGetParams(
                callId,
                archived,
    ...
    override fun toString() =
        "CallGetParams{callId=$callId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
