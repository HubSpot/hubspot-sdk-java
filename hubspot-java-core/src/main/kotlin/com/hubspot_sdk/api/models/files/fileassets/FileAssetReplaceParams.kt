...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): FileAssetReplaceParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [FileAssetReplaceParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FileAssetReplaceParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileAssetReplaceParams: FileAssetReplaceParams) = apply {
            fileId = fileAssetReplaceParams.fileId
            body = fileAssetReplaceParams.body.toBuilder()
            additionalHeaders = fileAssetReplaceParams.additionalHeaders.toBuilder()
            additionalQueryParams = fileAssetReplaceParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FileAssetReplaceParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FileAssetReplaceParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FileAssetReplaceParams &&
            fileId == other.fileId &&
            body == other.body &&
    ...
    override fun toString() =
        "FileAssetReplaceParams{fileId=$fileId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
