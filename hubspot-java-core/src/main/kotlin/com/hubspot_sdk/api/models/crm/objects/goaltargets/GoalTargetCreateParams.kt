...
/**
 * Create a goal target with the given properties and return a copy of the object, including the ID.
 * Documentation and examples for creating standard goal targets is provided.
 */
class GoalTargetCreateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [GoalTargetCreateParams].
         *
    ...
    /** A builder for [GoalTargetCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(goalTargetCreateParams: GoalTargetCreateParams) = apply {
            simplePublicObjectInputForCreate =
                goalTargetCreateParams.simplePublicObjectInputForCreate
            additionalHeaders = goalTargetCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = goalTargetCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [GoalTargetCreateParams].
         *
         ...
         */
        fun build(): GoalTargetCreateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GoalTargetCreateParams &&
    ...
    override fun toString() =
        "GoalTargetCreateParams{simplePublicObjectInputForCreate=$simplePublicObjectInputForCreate, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
