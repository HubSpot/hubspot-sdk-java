 ...
 */
class FileOperationReplaceParams
private constructor(
    ...
    /**
     * JSON string representing FileReplaceOptions. Includes options to set the access and expiresAt
     * properties, which will automatically update when the file is replaced.
     *
     * @throws HubspotInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    ...
    companion object {
        ...
        @JvmStatic fun none(): FileOperationReplaceParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [FileOperationReplaceParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FileOperationReplaceParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileOperationReplaceParams: FileOperationReplaceParams) = apply {
            fileId = fileOperationReplaceParams.fileId
            body = fileOperationReplaceParams.body.toBuilder()
            additionalHeaders = fileOperationReplaceParams.additionalHeaders.toBuilder()
            additionalQueryParams = fileOperationReplaceParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * JSON string representing FileReplaceOptions. Includes options to set the access and
         * expiresAt properties, which will automatically update when the file is replaced.
         */
        ...
        /**
         * Returns an immutable instance of [FileOperationReplaceParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FileOperationReplaceParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FileOperationReplaceParams &&
            fileId == other.fileId &&
            body == other.body &&
    ...
    override fun toString() =
        "FileOperationReplaceParams{fileId=$fileId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
