...
private constructor(
     ...
     */
    fun inputs(): List<JsonValue> = inputs.getRequired("inputs")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchInputJsonNode].
         *
    ...
    /** A builder for [BatchInputJsonNode]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchInputJsonNode: BatchInputJsonNode) = apply {
            inputs = batchInputJsonNode.inputs.map { it.toMutableList() }
            additionalProperties = batchInputJsonNode.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BatchInputJsonNode].
         *
    ...
    fun validate(): BatchInputJsonNode = apply {
        if (validated) {
            return@apply
        }
     ...
     */
    @JvmSynthetic internal fun validity(): Int = (inputs.asKnown().getOrNull()?.size ?: 0)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchInputJsonNode &&
            inputs == other.inputs &&
    ...
    override fun toString() =
        "BatchInputJsonNode{inputs=$inputs, additionalProperties=$additionalProperties}"
}
