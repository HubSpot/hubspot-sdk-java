...
class ActionResponseWithResultsPublicWideStatus
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val completedAt: JsonField<OffsetDateTime>,
    private val results: JsonField<List<PublicWideStatus>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<PublicWideStatus>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<PublicWideStatus> = results.getRequired("results")
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<PublicWideStatus>> = results
    ...
    /** A builder for [ActionResponseWithResultsPublicWideStatus]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<PublicWideStatus>>? = null
        ...
        @JvmSynthetic
        internal fun from(
            actionResponseWithResultsPublicWideStatus: ActionResponseWithResultsPublicWideStatus
        ) = apply {
            completedAt = actionResponseWithResultsPublicWideStatus.completedAt
            results = actionResponseWithResultsPublicWideStatus.results.map { it.toMutableList() }
            startedAt = actionResponseWithResultsPublicWideStatus.startedAt
            status = actionResponseWithResultsPublicWideStatus.status
            errors = actionResponseWithResultsPublicWideStatus.errors.map { it.toMutableList() }
            links = actionResponseWithResultsPublicWideStatus.links
            numErrors = actionResponseWithResultsPublicWideStatus.numErrors
            requestedAt = actionResponseWithResultsPublicWideStatus.requestedAt
            additionalProperties =
                actionResponseWithResultsPublicWideStatus.additionalProperties.toMutableMap()
        }
        ...
        /** An array containing the results of the operation. */
        fun results(results: List<PublicWideStatus>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed `List<PublicWideStatus>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun results(results: JsonField<List<PublicWideStatus>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [PublicWideStatus] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: PublicWideStatus) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [ActionResponseWithResultsPublicWideStatus].
         *
         ...
         */
        fun build(): ActionResponseWithResultsPublicWideStatus =
            ActionResponseWithResultsPublicWideStatus(
    ...
    fun validate(): ActionResponseWithResultsPublicWideStatus = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionResponseWithResultsPublicWideStatus &&
    ...
    override fun toString() =
        "ActionResponseWithResultsPublicWideStatus{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
