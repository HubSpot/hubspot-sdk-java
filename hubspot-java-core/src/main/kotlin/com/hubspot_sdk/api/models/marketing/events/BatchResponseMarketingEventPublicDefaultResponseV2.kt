...
private constructor(
    ...
    private val results: JsonField<List<MarketingEventPublicDefaultResponseV2>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<MarketingEventPublicDefaultResponseV2>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<MarketingEventPublicDefaultResponseV2> = results.getRequired("results")
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<MarketingEventPublicDefaultResponseV2>> = results
    ...
    /** A builder for [BatchResponseMarketingEventPublicDefaultResponseV2]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<MarketingEventPublicDefaultResponseV2>>? = null
        ...
        internal fun from(
            ...
            completedAt = batchResponseMarketingEventPublicDefaultResponseV2.completedAt
            results =
                batchResponseMarketingEventPublicDefaultResponseV2.results.map {
                    it.toMutableList()
                }
            startedAt = batchResponseMarketingEventPublicDefaultResponseV2.startedAt
            status = batchResponseMarketingEventPublicDefaultResponseV2.status
            errors =
                batchResponseMarketingEventPublicDefaultResponseV2.errors.map { it.toMutableList() }
            links = batchResponseMarketingEventPublicDefaultResponseV2.links
            numErrors = batchResponseMarketingEventPublicDefaultResponseV2.numErrors
            requestedAt = batchResponseMarketingEventPublicDefaultResponseV2.requestedAt
            additionalProperties =
                batchResponseMarketingEventPublicDefaultResponseV2.additionalProperties
                    .toMutableMap()
        }
        ...
        fun results(results: List<MarketingEventPublicDefaultResponseV2>) =
         ...
         * `List<MarketingEventPublicDefaultResponseV2>` value instead. This method is primarily for
         * setting the field to an undocumented or not yet supported value.
         */
        fun results(results: JsonField<List<MarketingEventPublicDefaultResponseV2>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [MarketingEventPublicDefaultResponseV2] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: MarketingEventPublicDefaultResponseV2) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [BatchResponseMarketingEventPublicDefaultResponseV2].
         *
         ...
         */
        fun build(): BatchResponseMarketingEventPublicDefaultResponseV2 =
            BatchResponseMarketingEventPublicDefaultResponseV2(
    ...
    fun validate(): BatchResponseMarketingEventPublicDefaultResponseV2 = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseMarketingEventPublicDefaultResponseV2 &&
    ...
    override fun toString() =
        "BatchResponseMarketingEventPublicDefaultResponseV2{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
