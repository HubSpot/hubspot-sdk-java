...
private constructor(
    ...
    private val crmObjectCreationStatus: JsonField<CrmObjectCreationStatus>,
    ...
    private val nextAvailableActionId: JsonField<String>,
    ...
    private constructor(
        ...
        @JsonProperty("crmObjectCreationStatus")
        @ExcludeMissing
        crmObjectCreationStatus: JsonField<CrmObjectCreationStatus> = JsonMissing.of(),
        ...
        @JsonProperty("nextAvailableActionId")
        @ExcludeMissing
        nextAvailableActionId: JsonField<String> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun crmObjectCreationStatus(): CrmObjectCreationStatus =
        crmObjectCreationStatus.getRequired("crmObjectCreationStatus")
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun nextAvailableActionId(): String = nextAvailableActionId.getRequired("nextAvailableActionId")
    ...
    /**
     * Returns the raw JSON value of [crmObjectCreationStatus].
     *
     * Unlike [crmObjectCreationStatus], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("crmObjectCreationStatus")
    @ExcludeMissing
    fun _crmObjectCreationStatus(): JsonField<CrmObjectCreationStatus> = crmObjectCreationStatus
    ...
    /**
     * Returns the raw JSON value of [nextAvailableActionId].
     *
     * Unlike [nextAvailableActionId], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("nextAvailableActionId")
    @ExcludeMissing
    fun _nextAvailableActionId(): JsonField<String> = nextAvailableActionId
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ApiContactFlow].
         *
    ...
    class Builder internal constructor() {
        ...
        private var crmObjectCreationStatus: JsonField<CrmObjectCreationStatus>? = null
        ...
        private var nextAvailableActionId: JsonField<String>? = null
        ...
        @JvmSynthetic
        internal fun from(apiContactFlow: ApiContactFlow) = apply {
            id = apiContactFlow.id
            actions = apiContactFlow.actions.map { it.toMutableList() }
            blockedDates = apiContactFlow.blockedDates.map { it.toMutableList() }
            canEnrollFromSalesforce = apiContactFlow.canEnrollFromSalesforce
            createdAt = apiContactFlow.createdAt
            crmObjectCreationStatus = apiContactFlow.crmObjectCreationStatus
            customProperties = apiContactFlow.customProperties
            dataSources = apiContactFlow.dataSources.map { it.toMutableList() }
            flowType = apiContactFlow.flowType
            isEnabled = apiContactFlow.isEnabled
            nextAvailableActionId = apiContactFlow.nextAvailableActionId
            objectTypeId = apiContactFlow.objectTypeId
            revisionId = apiContactFlow.revisionId
            suppressionListIds = apiContactFlow.suppressionListIds.map { it.toMutableList() }
            timeWindows = apiContactFlow.timeWindows.map { it.toMutableList() }
            type = apiContactFlow.type
            updatedAt = apiContactFlow.updatedAt
            description = apiContactFlow.description
            enrollmentCriteria = apiContactFlow.enrollmentCriteria
            enrollmentSchedule = apiContactFlow.enrollmentSchedule
            eventAnchor = apiContactFlow.eventAnchor
            goalFilterBranch = apiContactFlow.goalFilterBranch
            name = apiContactFlow.name
            startActionId = apiContactFlow.startActionId
            unEnrollmentSetting = apiContactFlow.unEnrollmentSetting
            uuid = apiContactFlow.uuid
            additionalProperties = apiContactFlow.additionalProperties.toMutableMap()
        }
        ...
        fun crmObjectCreationStatus(crmObjectCreationStatus: CrmObjectCreationStatus) =
            crmObjectCreationStatus(JsonField.of(crmObjectCreationStatus))

        /**
         * Sets [Builder.crmObjectCreationStatus] to an arbitrary JSON value.
         *
         * You should usually call [Builder.crmObjectCreationStatus] with a well-typed
         * [CrmObjectCreationStatus] value instead. This method is primarily for setting the field
         * to an undocumented or not yet supported value.
         */
        fun crmObjectCreationStatus(crmObjectCreationStatus: JsonField<CrmObjectCreationStatus>) =
            apply {
        ...
        fun nextAvailableActionId(nextAvailableActionId: String) =
            nextAvailableActionId(JsonField.of(nextAvailableActionId))

        /**
         * Sets [Builder.nextAvailableActionId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.nextAvailableActionId] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun nextAvailableActionId(nextAvailableActionId: JsonField<String>) = apply {
        ...
        /**
         * Returns an immutable instance of [ApiContactFlow].
         *
        ...
        fun build(): ApiContactFlow =
            ApiContactFlow(
                ...
                checkRequired("crmObjectCreationStatus", crmObjectCreationStatus),
                ...
                checkRequired("nextAvailableActionId", nextAvailableActionId),
    ...
    fun validate(): ApiContactFlow = apply {
        if (validated) {
            return@apply
        }
        ...
        canEnrollFromSalesforce()
        createdAt()
        crmObjectCreationStatus().validate()
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (crmObjectCreationStatus.asKnown().getOrNull()?.validity() ?: 0) +
            ...
            (if (nextAvailableActionId.asKnown().isPresent) 1 else 0) +
    ...
    private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmStatic fun of(value: String) = CrmObjectCreationStatus(JsonField.of(value))
        }

        /** An enum containing [CrmObjectCreationStatus]'s known values. */
        enum class Known {
            PENDING,
            COMPLETE,
        }
        ...
        /**
         * An enum containing [CrmObjectCreationStatus]'s known values, as well as an [_UNKNOWN]
         * member.
         *
         * An instance of [CrmObjectCreationStatus] can contain an unknown value in a couple of
         * cases:
        ...
        enum class Value {
            ...
            COMPLETE,
            /**
             * An enum member indicating that [CrmObjectCreationStatus] was instantiated with an
             * unknown value.
             */
            _UNKNOWN,
        }
        ...
        fun known(): Known =
            when (this) {
                ...
                else -> throw HubspotInvalidDataException("Unknown CrmObjectCreationStatus: $value")
            }
        ...
        fun validate(): CrmObjectCreationStatus = apply {
            if (validated) {
                return@apply
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is CrmObjectCreationStatus && value == other.value
        }
    ...
    override fun toString() =
        "ApiContactFlow{id=$id, actions=$actions, blockedDates=$blockedDates, canEnrollFromSalesforce=$canEnrollFromSalesforce, createdAt=$createdAt, crmObjectCreationStatus=$crmObjectCreationStatus, customProperties=$customProperties, dataSources=$dataSources, flowType=$flowType, isEnabled=$isEnabled, nextAvailableActionId=$nextAvailableActionId, objectTypeId=$objectTypeId, revisionId=$revisionId, suppressionListIds=$suppressionListIds, timeWindows=$timeWindows, type=$type, updatedAt=$updatedAt, description=$description, enrollmentCriteria=$enrollmentCriteria, enrollmentSchedule=$enrollmentSchedule, eventAnchor=$eventAnchor, goalFilterBranch=$goalFilterBranch, name=$name, startActionId=$startActionId, unEnrollmentSetting=$unEnrollmentSetting, uuid=$uuid, additionalProperties=$additionalProperties}"
}
