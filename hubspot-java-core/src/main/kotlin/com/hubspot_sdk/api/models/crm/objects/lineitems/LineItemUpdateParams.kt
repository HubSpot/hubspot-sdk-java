...
/**
 * Perform a partial update of an Object identified by `{lineItemId}`or optionally a unique property
 * value as specified by the `idProperty` query param. `{lineItemId}` refers to the internal object
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(lineItemUpdateParams: LineItemUpdateParams) = apply {
            lineItemId = lineItemUpdateParams.lineItemId
            idProperty = lineItemUpdateParams.idProperty
            simplePublicObjectInput = lineItemUpdateParams.simplePublicObjectInput
    ...
    override fun toString() =
        "LineItemUpdateParams{lineItemId=$lineItemId, idProperty=$idProperty, simplePublicObjectInput=$simplePublicObjectInput, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
