...
private constructor(
    ...
    private constructor(
        ...
        companion object {
            ...
            /** Returns a mutable builder for constructing an instance of [StringToCheck]. */
            @JvmStatic fun builder() = Builder()
        }

        /** A builder for [StringToCheck]. */
        class Builder internal constructor() {

            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

            @JvmSynthetic
            internal fun from(stringToCheck: StringToCheck) = apply {
                additionalProperties = stringToCheck.additionalProperties.toMutableMap()
            }
            ...
            /**
             * Returns an immutable instance of [StringToCheck].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): StringToCheck = StringToCheck(additionalProperties.toImmutable())
        }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is StringToCheck && additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "StringToCheck{additionalProperties=$additionalProperties}"
    }
