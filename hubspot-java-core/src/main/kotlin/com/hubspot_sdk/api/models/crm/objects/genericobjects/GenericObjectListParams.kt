...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): GenericObjectListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [GenericObjectListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [GenericObjectListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(genericObjectListParams: GenericObjectListParams) = apply {
            objectType = genericObjectListParams.objectType
            after = genericObjectListParams.after
            archived = genericObjectListParams.archived
            associations = genericObjectListParams.associations?.toMutableList()
            limit = genericObjectListParams.limit
            properties = genericObjectListParams.properties?.toMutableList()
            propertiesWithHistory = genericObjectListParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = genericObjectListParams.additionalHeaders.toBuilder()
            additionalQueryParams = genericObjectListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [GenericObjectListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): GenericObjectListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GenericObjectListParams &&
    ...
    override fun toString() =
        "GenericObjectListParams{objectType=$objectType, after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
