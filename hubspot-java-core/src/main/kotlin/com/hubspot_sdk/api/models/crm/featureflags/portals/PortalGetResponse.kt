...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PortalGetResponse].
         *
    ...
    /** A builder for [PortalGetResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(portalGetResponse: PortalGetResponse) = apply {
            appId = portalGetResponse.appId
            flagName = portalGetResponse.flagName
            flagState = portalGetResponse.flagState
            portalId = portalGetResponse.portalId
            additionalProperties = portalGetResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PortalGetResponse].
         *
    ...
    fun validate(): PortalGetResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PortalGetResponse &&
            appId == other.appId &&
    ...
    override fun toString() =
        "PortalGetResponse{appId=$appId, flagName=$flagName, flagState=$flagState, portalId=$portalId, additionalProperties=$additionalProperties}"
}
