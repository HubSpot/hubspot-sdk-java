...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ConstantBoolean].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(constantBoolean: ConstantBoolean) = apply {
            operator = constantBoolean.operator
            propertyName = constantBoolean.propertyName
            value = constantBoolean.value
            additionalProperties = constantBoolean.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConstantBoolean].
         *
    ...
    fun validate(): ConstantBoolean = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CONSTANT_BOOLEAN = of("CONSTANT_BOOLEAN")
        ...
        fun value(): Value =
            when (this) {
                CONSTANT_BOOLEAN -> Value.CONSTANT_BOOLEAN
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CONSTANT_BOOLEAN -> Known.CONSTANT_BOOLEAN
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConstantBoolean &&
    ...
    override fun toString() =
        "ConstantBoolean{operator=$operator, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
