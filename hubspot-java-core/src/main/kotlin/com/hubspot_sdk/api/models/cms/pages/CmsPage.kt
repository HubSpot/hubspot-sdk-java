...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CmsPage].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(cmsPage: CmsPage) = apply {
            id = cmsPage.id
            abStatus = cmsPage.abStatus
            abTestId = cmsPage.abTestId
            archivedAt = cmsPage.archivedAt
            archivedInDashboard = cmsPage.archivedInDashboard
            attachedStylesheets = cmsPage.attachedStylesheets.map { it.toMutableList() }
            authorName = cmsPage.authorName
            campaign = cmsPage.campaign
            categoryId = cmsPage.categoryId
            contentGroupId = cmsPage.contentGroupId
            contentTypeCategory = cmsPage.contentTypeCategory
            created = cmsPage.created
            createdById = cmsPage.createdById
            currentlyPublished = cmsPage.currentlyPublished
            currentState = cmsPage.currentState
            domain = cmsPage.domain
            dynamicPageDataSourceId = cmsPage.dynamicPageDataSourceId
            dynamicPageDataSourceType = cmsPage.dynamicPageDataSourceType
            dynamicPageHubDbTableId = cmsPage.dynamicPageHubDbTableId
            enableDomainStylesheets = cmsPage.enableDomainStylesheets
            enableLayoutStylesheets = cmsPage.enableLayoutStylesheets
            featuredImage = cmsPage.featuredImage
            featuredImageAltText = cmsPage.featuredImageAltText
            folderId = cmsPage.folderId
            footerHtml = cmsPage.footerHtml
            headHtml = cmsPage.headHtml
            htmlTitle = cmsPage.htmlTitle
            includeDefaultCustomCss = cmsPage.includeDefaultCustomCss
            language = cmsPage.language
            layoutSections = cmsPage.layoutSections
            linkRelCanonicalUrl = cmsPage.linkRelCanonicalUrl
            mabExperimentId = cmsPage.mabExperimentId
            metaDescription = cmsPage.metaDescription
            name = cmsPage.name
            pageExpiryDate = cmsPage.pageExpiryDate
            pageExpiryEnabled = cmsPage.pageExpiryEnabled
            pageExpiryRedirectId = cmsPage.pageExpiryRedirectId
            pageExpiryRedirectUrl = cmsPage.pageExpiryRedirectUrl
            pageRedirected = cmsPage.pageRedirected
            password = cmsPage.password
            publicAccessRules = cmsPage.publicAccessRules.map { it.toMutableList() }
            publicAccessRulesEnabled = cmsPage.publicAccessRulesEnabled
            publishDate = cmsPage.publishDate
            publishImmediately = cmsPage.publishImmediately
            slug = cmsPage.slug
            state = cmsPage.state
            subcategory = cmsPage.subcategory
            templatePath = cmsPage.templatePath
            themeSettingsValues = cmsPage.themeSettingsValues
            translatedFromId = cmsPage.translatedFromId
            translations = cmsPage.translations
            updated = cmsPage.updated
            updatedById = cmsPage.updatedById
            url = cmsPage.url
            useFeaturedImage = cmsPage.useFeaturedImage
            widgetContainers = cmsPage.widgetContainers
            widgets = cmsPage.widgets
            additionalProperties = cmsPage.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CmsPage].
         *
