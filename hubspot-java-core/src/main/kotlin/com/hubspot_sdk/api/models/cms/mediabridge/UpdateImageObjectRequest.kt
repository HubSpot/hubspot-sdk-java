...
class UpdateImageObjectRequest
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UpdateImageObjectRequest].
         *
    ...
    /** A builder for [UpdateImageObjectRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(updateImageObjectRequest: UpdateImageObjectRequest) = apply {
            mediaType = updateImageObjectRequest.mediaType
            detailsPageLink = updateImageObjectRequest.detailsPageLink
            duration = updateImageObjectRequest.duration
            externalId = updateImageObjectRequest.externalId
            fileUrl = updateImageObjectRequest.fileUrl
            oembedUrl = updateImageObjectRequest.oembedUrl
            posterUrl = updateImageObjectRequest.posterUrl
            thumbnailUrl = updateImageObjectRequest.thumbnailUrl
            title = updateImageObjectRequest.title
            additionalProperties = updateImageObjectRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UpdateImageObjectRequest].
         *
         ...
         */
        fun build(): UpdateImageObjectRequest =
    ...
    fun validate(): UpdateImageObjectRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UpdateImageObjectRequest &&
    ...
    override fun toString() =
        "UpdateImageObjectRequest{mediaType=$mediaType, detailsPageLink=$detailsPageLink, duration=$duration, externalId=$externalId, fileUrl=$fileUrl, oembedUrl=$oembedUrl, posterUrl=$posterUrl, thumbnailUrl=$thumbnailUrl, title=$title, additionalProperties=$additionalProperties}"
}
