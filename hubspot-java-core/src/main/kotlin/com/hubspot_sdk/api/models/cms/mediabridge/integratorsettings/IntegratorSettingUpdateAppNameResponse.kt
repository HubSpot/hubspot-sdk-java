...
class IntegratorSettingUpdateAppNameResponse
...
private constructor(
    ...
    /** A builder for [IntegratorSettingUpdateAppNameResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            integratorSettingUpdateAppNameResponse: IntegratorSettingUpdateAppNameResponse
        ) = apply {
            appId = integratorSettingUpdateAppNameResponse.appId
            name = integratorSettingUpdateAppNameResponse.name
            additionalProperties =
                integratorSettingUpdateAppNameResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IntegratorSettingUpdateAppNameResponse].
         *
         ...
         */
        fun build(): IntegratorSettingUpdateAppNameResponse =
            IntegratorSettingUpdateAppNameResponse(
    ...
    fun validate(): IntegratorSettingUpdateAppNameResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IntegratorSettingUpdateAppNameResponse &&
            appId == other.appId &&
            name == other.name &&
    ...
    override fun toString() =
        "IntegratorSettingUpdateAppNameResponse{appId=$appId, name=$name, additionalProperties=$additionalProperties}"
}
