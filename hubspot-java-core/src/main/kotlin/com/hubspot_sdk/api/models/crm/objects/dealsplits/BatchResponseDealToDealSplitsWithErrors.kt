...
private constructor(
    ...
    private val results: JsonField<List<DealToDealSplits>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<DealToDealSplits>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<DealToDealSplits> = results.getRequired("results")
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<DealToDealSplits>> = results
    ...
    /** A builder for [BatchResponseDealToDealSplitsWithErrors]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<DealToDealSplits>>? = null
        ...
        internal fun from(
            ...
            completedAt = batchResponseDealToDealSplitsWithErrors.completedAt
            results = batchResponseDealToDealSplitsWithErrors.results.map { it.toMutableList() }
            startedAt = batchResponseDealToDealSplitsWithErrors.startedAt
            status = batchResponseDealToDealSplitsWithErrors.status
            errors = batchResponseDealToDealSplitsWithErrors.errors.map { it.toMutableList() }
            links = batchResponseDealToDealSplitsWithErrors.links
            numErrors = batchResponseDealToDealSplitsWithErrors.numErrors
            requestedAt = batchResponseDealToDealSplitsWithErrors.requestedAt
            additionalProperties =
                batchResponseDealToDealSplitsWithErrors.additionalProperties.toMutableMap()
        }
        ...
        fun results(results: List<DealToDealSplits>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed `List<DealToDealSplits>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun results(results: JsonField<List<DealToDealSplits>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [DealToDealSplits] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: DealToDealSplits) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [BatchResponseDealToDealSplitsWithErrors].
         *
         ...
         */
        fun build(): BatchResponseDealToDealSplitsWithErrors =
            BatchResponseDealToDealSplitsWithErrors(
    ...
    fun validate(): BatchResponseDealToDealSplitsWithErrors = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseDealToDealSplitsWithErrors &&
    ...
    override fun toString() =
        "BatchResponseDealToDealSplitsWithErrors{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
