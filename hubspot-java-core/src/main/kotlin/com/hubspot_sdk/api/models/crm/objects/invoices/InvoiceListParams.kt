...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of invoices that can
    ...
    class Builder internal constructor() {
        ...
        internal fun from(invoiceListParams: InvoiceListParams) = apply {
            after = invoiceListParams.after
            archived = invoiceListParams.archived
            associations = invoiceListParams.associations?.toMutableList()
            limit = invoiceListParams.limit
            properties = invoiceListParams.properties?.toMutableList()
            propertiesWithHistory = invoiceListParams.propertiesWithHistory?.toMutableList()
         ...
         * of invoices that can be read by a single request.
         */
    ...
    override fun toString() =
        "InvoiceListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
