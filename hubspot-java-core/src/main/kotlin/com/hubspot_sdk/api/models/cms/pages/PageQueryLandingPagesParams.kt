...
class PageQueryLandingPagesParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PageQueryLandingPagesParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [PageQueryLandingPagesParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PageQueryLandingPagesParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pageQueryLandingPagesParams: PageQueryLandingPagesParams) = apply {
            after = pageQueryLandingPagesParams.after
            archived = pageQueryLandingPagesParams.archived
            createdAfter = pageQueryLandingPagesParams.createdAfter
            createdAt = pageQueryLandingPagesParams.createdAt
            createdBefore = pageQueryLandingPagesParams.createdBefore
            limit = pageQueryLandingPagesParams.limit
            property = pageQueryLandingPagesParams.property
            sort = pageQueryLandingPagesParams.sort?.toMutableList()
            updatedAfter = pageQueryLandingPagesParams.updatedAfter
            updatedAt = pageQueryLandingPagesParams.updatedAt
            updatedBefore = pageQueryLandingPagesParams.updatedBefore
            additionalHeaders = pageQueryLandingPagesParams.additionalHeaders.toBuilder()
            additionalQueryParams = pageQueryLandingPagesParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PageQueryLandingPagesParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PageQueryLandingPagesParams =
            PageQueryLandingPagesParams(
                after,
                archived,
                createdAfter,
                createdAt,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PageQueryLandingPagesParams &&
            after == other.after &&
    ...
    override fun toString() =
        "PageQueryLandingPagesParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
