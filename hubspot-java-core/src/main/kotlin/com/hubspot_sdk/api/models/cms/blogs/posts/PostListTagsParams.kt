...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PostListTagsParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PostListTagsParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PostListTagsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(postListTagsParams: PostListTagsParams) = apply {
            after = postListTagsParams.after
            archived = postListTagsParams.archived
            createdAfter = postListTagsParams.createdAfter
            createdAt = postListTagsParams.createdAt
            createdBefore = postListTagsParams.createdBefore
            limit = postListTagsParams.limit
            property = postListTagsParams.property
            sort = postListTagsParams.sort?.toMutableList()
            updatedAfter = postListTagsParams.updatedAfter
            updatedAt = postListTagsParams.updatedAt
            updatedBefore = postListTagsParams.updatedBefore
            additionalHeaders = postListTagsParams.additionalHeaders.toBuilder()
            additionalQueryParams = postListTagsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PostListTagsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PostListTagsParams =
            PostListTagsParams(
                after,
                archived,
                createdAfter,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PostListTagsParams &&
            after == other.after &&
    ...
    override fun toString() =
        "PostListTagsParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
