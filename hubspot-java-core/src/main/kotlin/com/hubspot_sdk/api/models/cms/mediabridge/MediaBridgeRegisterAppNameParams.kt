...
class MediaBridgeRegisterAppNameParams
private constructor(
    ...
    /** A builder for [MediaBridgeRegisterAppNameParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(mediaBridgeRegisterAppNameParams: MediaBridgeRegisterAppNameParams) =
            apply {
                appId = mediaBridgeRegisterAppNameParams.appId
                mediaBridgeProviderPartial =
                    mediaBridgeRegisterAppNameParams.mediaBridgeProviderPartial
                additionalHeaders = mediaBridgeRegisterAppNameParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    mediaBridgeRegisterAppNameParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [MediaBridgeRegisterAppNameParams].
         *
         ...
         */
        fun build(): MediaBridgeRegisterAppNameParams =
            MediaBridgeRegisterAppNameParams(
                appId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MediaBridgeRegisterAppNameParams &&
            appId == other.appId &&
    ...
    override fun toString() =
        "MediaBridgeRegisterAppNameParams{appId=$appId, mediaBridgeProviderPartial=$mediaBridgeProviderPartial, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
