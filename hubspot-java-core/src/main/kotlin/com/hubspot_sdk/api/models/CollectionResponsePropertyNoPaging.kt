...
import com.hubspot_sdk.api.models.cms.mediabridge.Property1
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(collectionResponsePropertyNoPaging: CollectionResponsePropertyNoPaging) =
            apply {
                results = collectionResponsePropertyNoPaging.results.map { it.toMutableList() }
        ...
        /**
         * Returns an immutable instance of [CollectionResponsePropertyNoPaging].
         *
         ...
         */
        fun build(): CollectionResponsePropertyNoPaging =
            CollectionResponsePropertyNoPaging(
    ...
    fun validate(): CollectionResponsePropertyNoPaging = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionResponsePropertyNoPaging &&
    ...
    override fun toString() =
        "CollectionResponsePropertyNoPaging{results=$results, additionalProperties=$additionalProperties}"
}
