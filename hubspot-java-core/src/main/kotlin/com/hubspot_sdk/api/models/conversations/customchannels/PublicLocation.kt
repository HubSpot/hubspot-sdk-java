...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicLocation].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicLocation: PublicLocation) = apply {
            latitude = publicLocation.latitude
            longitude = publicLocation.longitude
            type = publicLocation.type
            address = publicLocation.address
            name = publicLocation.name
            url = publicLocation.url
            additionalProperties = publicLocation.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicLocation].
         *
    ...
    fun validate(): PublicLocation = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicLocation &&
    ...
    override fun toString() =
        "PublicLocation{latitude=$latitude, longitude=$longitude, type=$type, address=$address, name=$name, url=$url, additionalProperties=$additionalProperties}"
}
