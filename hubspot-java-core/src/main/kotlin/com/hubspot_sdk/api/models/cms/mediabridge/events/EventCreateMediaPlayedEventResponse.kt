...
class EventCreateMediaPlayedEventResponse
...
private constructor(
    ...
    /** A builder for [EventCreateMediaPlayedEventResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            eventCreateMediaPlayedEventResponse: EventCreateMediaPlayedEventResponse
        ) = apply {
            contactId = eventCreateMediaPlayedEventResponse.contactId
            mediaBridgeId = eventCreateMediaPlayedEventResponse.mediaBridgeId
            mediaBridgeObjectCoordinates =
                eventCreateMediaPlayedEventResponse.mediaBridgeObjectCoordinates
            mediaBridgeObjectTypeId = eventCreateMediaPlayedEventResponse.mediaBridgeObjectTypeId
            mediaName = eventCreateMediaPlayedEventResponse.mediaName
            mediaType = eventCreateMediaPlayedEventResponse.mediaType
            occurredTimestamp = eventCreateMediaPlayedEventResponse.occurredTimestamp
            portalId = eventCreateMediaPlayedEventResponse.portalId
            providerId = eventCreateMediaPlayedEventResponse.providerId
            sessionId = eventCreateMediaPlayedEventResponse.sessionId
            state = eventCreateMediaPlayedEventResponse.state
            iframeUrl = eventCreateMediaPlayedEventResponse.iframeUrl
            mediaUrl = eventCreateMediaPlayedEventResponse.mediaUrl
            pageId = eventCreateMediaPlayedEventResponse.pageId
            pageName = eventCreateMediaPlayedEventResponse.pageName
            pageObjectCoordinates = eventCreateMediaPlayedEventResponse.pageObjectCoordinates
            pageUrl = eventCreateMediaPlayedEventResponse.pageUrl
            additionalProperties =
                eventCreateMediaPlayedEventResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EventCreateMediaPlayedEventResponse].
         *
         ...
         */
        fun build(): EventCreateMediaPlayedEventResponse =
            EventCreateMediaPlayedEventResponse(
    ...
    fun validate(): EventCreateMediaPlayedEventResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EventCreateMediaPlayedEventResponse &&
    ...
    override fun toString() =
        "EventCreateMediaPlayedEventResponse{contactId=$contactId, mediaBridgeId=$mediaBridgeId, mediaBridgeObjectCoordinates=$mediaBridgeObjectCoordinates, mediaBridgeObjectTypeId=$mediaBridgeObjectTypeId, mediaName=$mediaName, mediaType=$mediaType, occurredTimestamp=$occurredTimestamp, portalId=$portalId, providerId=$providerId, sessionId=$sessionId, state=$state, iframeUrl=$iframeUrl, mediaUrl=$mediaUrl, pageId=$pageId, pageName=$pageName, pageObjectCoordinates=$pageObjectCoordinates, pageUrl=$pageUrl, additionalProperties=$additionalProperties}"
}
