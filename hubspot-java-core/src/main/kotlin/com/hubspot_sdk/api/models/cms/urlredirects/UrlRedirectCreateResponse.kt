...
class UrlRedirectCreateResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UrlRedirectCreateResponse].
         *
    ...
    /** A builder for [UrlRedirectCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(urlRedirectCreateResponse: UrlRedirectCreateResponse) = apply {
            id = urlRedirectCreateResponse.id
            destination = urlRedirectCreateResponse.destination
            isMatchFullUrl = urlRedirectCreateResponse.isMatchFullUrl
            isMatchQueryString = urlRedirectCreateResponse.isMatchQueryString
            isOnlyAfterNotFound = urlRedirectCreateResponse.isOnlyAfterNotFound
            isPattern = urlRedirectCreateResponse.isPattern
            isProtocolAgnostic = urlRedirectCreateResponse.isProtocolAgnostic
            isTrailingSlashOptional = urlRedirectCreateResponse.isTrailingSlashOptional
            precedence = urlRedirectCreateResponse.precedence
            redirectStyle = urlRedirectCreateResponse.redirectStyle
            routePrefix = urlRedirectCreateResponse.routePrefix
            created = urlRedirectCreateResponse.created
            updated = urlRedirectCreateResponse.updated
            additionalProperties = urlRedirectCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UrlRedirectCreateResponse].
         *
         ...
         */
        fun build(): UrlRedirectCreateResponse =
    ...
    fun validate(): UrlRedirectCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UrlRedirectCreateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "UrlRedirectCreateResponse{id=$id, destination=$destination, isMatchFullUrl=$isMatchFullUrl, isMatchQueryString=$isMatchQueryString, isOnlyAfterNotFound=$isOnlyAfterNotFound, isPattern=$isPattern, isProtocolAgnostic=$isProtocolAgnostic, isTrailingSlashOptional=$isTrailingSlashOptional, precedence=$precedence, redirectStyle=$redirectStyle, routePrefix=$routePrefix, created=$created, updated=$updated, additionalProperties=$additionalProperties}"
}
