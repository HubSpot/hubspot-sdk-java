...
/**
 * Replaces the data in the draft version of the table with values from the published version. Any
 * unpublished changes in the draft will be lost after this call is made.
 */
class TableResetDraftParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TableResetDraftParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TableResetDraftParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TableResetDraftParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tableResetDraftParams: TableResetDraftParams) = apply {
            tableIdOrName = tableResetDraftParams.tableIdOrName
            includeForeignIds = tableResetDraftParams.includeForeignIds
            additionalHeaders = tableResetDraftParams.additionalHeaders.toBuilder()
            additionalQueryParams = tableResetDraftParams.additionalQueryParams.toBuilder()
            additionalBodyProperties = tableResetDraftParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TableResetDraftParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TableResetDraftParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TableResetDraftParams &&
    ...
    override fun toString() =
        "TableResetDraftParams{tableIdOrName=$tableIdOrName, includeForeignIds=$includeForeignIds, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
