...
private constructor(
    ...
    private val backgroundImageType: JsonField<BackgroundImageType>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        backgroundImageType: JsonField<BackgroundImageType> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun backgroundImageType(): Optional<BackgroundImageType> =
    ...
    @JsonProperty("backgroundImageType")
    @ExcludeMissing
    fun _backgroundImageType(): JsonField<BackgroundImageType> = backgroundImageType
    ...
    class Builder internal constructor() {
        ...
        private var backgroundImageType: JsonField<BackgroundImageType> = JsonMissing.of()
        ...
        fun backgroundImageType(backgroundImageType: BackgroundImageType) =
            backgroundImageType(JsonField.of(backgroundImageType))

        /**
         * Sets [Builder.backgroundImageType] to an arbitrary JSON value.
         *
         * You should usually call [Builder.backgroundImageType] with a well-typed
         * [BackgroundImageType] value instead. This method is primarily for setting the field to an
         * undocumented or not yet supported value.
         */
        fun backgroundImageType(backgroundImageType: JsonField<BackgroundImageType>) = apply {
    ...
    fun validate(): PublicEmailStyleSettings = apply {
        ...
        backgroundColor()
        backgroundImage()
        backgroundImageType().ifPresent { it.validate() }
        bodyBorderColor()
        bodyBorderColorChoice()
        bodyBorderWidth()
        bodyColor()
    ...
    internal fun validity(): Int =
        (if (backgroundColor.asKnown().isPresent) 1 else 0) +
            ...
            (backgroundImageType.asKnown().getOrNull()?.validity() ?: 0) +
    ...
    private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val REPEAT = of("REPEAT")

            @JvmField val SINGLE = of("SINGLE")

            @JvmField val STRETCH = of("STRETCH")

            @JvmStatic fun of(value: String) = BackgroundImageType(JsonField.of(value))
        }

        /** An enum containing [BackgroundImageType]'s known values. */
        enum class Known {
            REPEAT,
            SINGLE,
            STRETCH,
        ...
        /**
         * An enum containing [BackgroundImageType]'s known values, as well as an [_UNKNOWN] member.
         *
         * An instance of [BackgroundImageType] can contain an unknown value in a couple of cases:
        ...
        enum class Value {
            ...
            STRETCH,
            /**
             * An enum member indicating that [BackgroundImageType] was instantiated with an unknown
             * value.
             */
            _UNKNOWN,
        }
        ...
        fun known(): Known =
            when (this) {
                REPEAT -> Known.REPEAT
                SINGLE -> Known.SINGLE
                STRETCH -> Known.STRETCH
                else -> throw HubspotInvalidDataException("Unknown BackgroundImageType: $value")
            }
        ...
        fun validate(): BackgroundImageType = apply {
            if (validated) {
                return@apply
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is BackgroundImageType && value == other.value
        }
