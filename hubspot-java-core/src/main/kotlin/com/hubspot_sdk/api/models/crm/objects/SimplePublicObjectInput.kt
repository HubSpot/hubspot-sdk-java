...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SimplePublicObjectInput].
         *
    ...
    /** A builder for [SimplePublicObjectInput]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(simplePublicObjectInput: SimplePublicObjectInput) = apply {
            properties = simplePublicObjectInput.properties
            additionalProperties = simplePublicObjectInput.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SimplePublicObjectInput].
         *
         ...
         */
        fun build(): SimplePublicObjectInput =
    ...
    fun validate(): SimplePublicObjectInput = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SimplePublicObjectInput &&
    ...
    override fun toString() =
        "SimplePublicObjectInput{properties=$properties, additionalProperties=$additionalProperties}"
}
