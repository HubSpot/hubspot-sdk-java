...
private constructor(
    ...
    /** A builder for [ActionResponseWithSingleResultUri]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(actionResponseWithSingleResultUri: ActionResponseWithSingleResultUri) =
            apply {
                completedAt = actionResponseWithSingleResultUri.completedAt
                startedAt = actionResponseWithSingleResultUri.startedAt
                status = actionResponseWithSingleResultUri.status
                errors = actionResponseWithSingleResultUri.errors.map { it.toMutableList() }
                links = actionResponseWithSingleResultUri.links
                numErrors = actionResponseWithSingleResultUri.numErrors
                requestedAt = actionResponseWithSingleResultUri.requestedAt
                result = actionResponseWithSingleResultUri.result
        ...
        /**
         * Returns an immutable instance of [ActionResponseWithSingleResultUri].
         *
         ...
         */
        fun build(): ActionResponseWithSingleResultUri =
            ActionResponseWithSingleResultUri(
    ...
    fun validate(): ActionResponseWithSingleResultUri = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ActionResponseWithSingleResultUri &&
    ...
    override fun toString() =
        "ActionResponseWithSingleResultUri{completedAt=$completedAt, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, result=$result, additionalProperties=$additionalProperties}"
}
