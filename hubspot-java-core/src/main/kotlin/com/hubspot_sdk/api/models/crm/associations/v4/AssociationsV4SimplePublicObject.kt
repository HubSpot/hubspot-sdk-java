...
class AssociationsV4SimplePublicObject
...
private constructor(
    ...
    /** A builder for [AssociationsV4SimplePublicObject]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(associationsV4SimplePublicObject: AssociationsV4SimplePublicObject) =
            apply {
                id = associationsV4SimplePublicObject.id
                archived = associationsV4SimplePublicObject.archived
                createdAt = associationsV4SimplePublicObject.createdAt
                properties = associationsV4SimplePublicObject.properties
                updatedAt = associationsV4SimplePublicObject.updatedAt
                archivedAt = associationsV4SimplePublicObject.archivedAt
                objectWriteTraceId = associationsV4SimplePublicObject.objectWriteTraceId
                propertiesWithHistory = associationsV4SimplePublicObject.propertiesWithHistory
                additionalProperties =
                    associationsV4SimplePublicObject.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AssociationsV4SimplePublicObject].
         *
         ...
         */
        fun build(): AssociationsV4SimplePublicObject =
            AssociationsV4SimplePublicObject(
                checkRequired("id", id),
    ...
    fun validate(): AssociationsV4SimplePublicObject = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AssociationsV4SimplePublicObject &&
            id == other.id &&
    ...
    override fun toString() =
        "AssociationsV4SimplePublicObject{id=$id, archived=$archived, createdAt=$createdAt, properties=$properties, updatedAt=$updatedAt, archivedAt=$archivedAt, objectWriteTraceId=$objectWriteTraceId, propertiesWithHistory=$propertiesWithHistory, additionalProperties=$additionalProperties}"
}
