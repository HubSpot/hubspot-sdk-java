 ...
 */
class AssociationsV4SimplePublicObjectWithAssociations
...
private constructor(
    ...
    /** A builder for [AssociationsV4SimplePublicObjectWithAssociations]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = associationsV4SimplePublicObjectWithAssociations.id
            archived = associationsV4SimplePublicObjectWithAssociations.archived
            createdAt = associationsV4SimplePublicObjectWithAssociations.createdAt
            properties = associationsV4SimplePublicObjectWithAssociations.properties
            updatedAt = associationsV4SimplePublicObjectWithAssociations.updatedAt
            archivedAt = associationsV4SimplePublicObjectWithAssociations.archivedAt
            associations = associationsV4SimplePublicObjectWithAssociations.associations
            objectWriteTraceId = associationsV4SimplePublicObjectWithAssociations.objectWriteTraceId
            propertiesWithHistory =
                associationsV4SimplePublicObjectWithAssociations.propertiesWithHistory
            additionalProperties =
                associationsV4SimplePublicObjectWithAssociations.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AssociationsV4SimplePublicObjectWithAssociations].
         *
         ...
         */
        fun build(): AssociationsV4SimplePublicObjectWithAssociations =
            AssociationsV4SimplePublicObjectWithAssociations(
                checkRequired("id", id),
    ...
    fun validate(): AssociationsV4SimplePublicObjectWithAssociations = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AssociationsV4SimplePublicObjectWithAssociations &&
            id == other.id &&
    ...
    override fun toString() =
        "AssociationsV4SimplePublicObjectWithAssociations{id=$id, archived=$archived, createdAt=$createdAt, properties=$properties, updatedAt=$updatedAt, archivedAt=$archivedAt, associations=$associations, objectWriteTraceId=$objectWriteTraceId, propertiesWithHistory=$propertiesWithHistory, additionalProperties=$additionalProperties}"
}
