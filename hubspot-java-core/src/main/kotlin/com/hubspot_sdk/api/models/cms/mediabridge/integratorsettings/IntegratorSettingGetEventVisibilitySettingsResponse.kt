...
class IntegratorSettingGetEventVisibilitySettingsResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val createdAt: JsonField<OffsetDateTime>,
    private val visibilitySettings: JsonField<List<VisibilitySetting>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        visibilitySettings: JsonField<List<VisibilitySetting>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun visibilitySettings(): List<VisibilitySetting> =
    ...
    @JsonProperty("visibilitySettings")
    @ExcludeMissing
    fun _visibilitySettings(): JsonField<List<VisibilitySetting>> = visibilitySettings
    ...
    /** A builder for [IntegratorSettingGetEventVisibilitySettingsResponse]. */
    class Builder internal constructor() {

        private var createdAt: JsonField<OffsetDateTime>? = null
        private var visibilitySettings: JsonField<MutableList<VisibilitySetting>>? = null
        ...
        internal fun from(
            ...
            createdAt = integratorSettingGetEventVisibilitySettingsResponse.createdAt
            visibilitySettings =
                integratorSettingGetEventVisibilitySettingsResponse.visibilitySettings.map {
                    it.toMutableList()
                }
            additionalProperties =
                integratorSettingGetEventVisibilitySettingsResponse.additionalProperties
                    .toMutableMap()
        }
        ...
        fun visibilitySettings(visibilitySettings: List<VisibilitySetting>) =
         ...
         * `List<VisibilitySetting>` value instead. This method is primarily for setting the field
         * to an undocumented or not yet supported value.
         */
        fun visibilitySettings(visibilitySettings: JsonField<List<VisibilitySetting>>) = apply {
            this.visibilitySettings = visibilitySettings.map { it.toMutableList() }
        }

        /**
         * Adds a single [VisibilitySetting] to [visibilitySettings].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addVisibilitySetting(visibilitySetting: VisibilitySetting) = apply {
            visibilitySettings =
        ...
        /**
         * Returns an immutable instance of [IntegratorSettingGetEventVisibilitySettingsResponse].
         *
         ...
         */
        fun build(): IntegratorSettingGetEventVisibilitySettingsResponse =
            IntegratorSettingGetEventVisibilitySettingsResponse(
    ...
    fun validate(): IntegratorSettingGetEventVisibilitySettingsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [VisibilitySetting].
             *
             * The following fields are required:
             * ```java
             * .eventType()
        ...
        /** A builder for [VisibilitySetting]. */
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(visibilitySetting: VisibilitySetting) = apply {
                eventType = visibilitySetting.eventType
                updatedAt = visibilitySetting.updatedAt
                showInReporting = visibilitySetting.showInReporting
                showInTimeline = visibilitySetting.showInTimeline
                showInWorkflows = visibilitySetting.showInWorkflows
                additionalProperties = visibilitySetting.additionalProperties.toMutableMap()
            }
            ...
            /**
             * Returns an immutable instance of [VisibilitySetting].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
        ...
        fun validate(): VisibilitySetting = apply {
            if (validated) {
                return@apply
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is VisibilitySetting &&
        ...
        override fun toString() =
            "VisibilitySetting{eventType=$eventType, updatedAt=$updatedAt, showInReporting=$showInReporting, showInTimeline=$showInTimeline, showInWorkflows=$showInWorkflows, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IntegratorSettingGetEventVisibilitySettingsResponse &&
    ...
    override fun toString() =
        "IntegratorSettingGetEventVisibilitySettingsResponse{createdAt=$createdAt, visibilitySettings=$visibilitySettings, additionalProperties=$additionalProperties}"
}
