...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicNotAllFilterBranch].
         *
    ...
    /** A builder for [PublicNotAllFilterBranch]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicNotAllFilterBranch: PublicNotAllFilterBranch) = apply {
            filterBranches = publicNotAllFilterBranch.filterBranches.map { it.toMutableList() }
            filterBranchOperator = publicNotAllFilterBranch.filterBranchOperator
            filterBranchType = publicNotAllFilterBranch.filterBranchType
            filters = publicNotAllFilterBranch.filters.map { it.toMutableList() }
            additionalProperties = publicNotAllFilterBranch.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicNotAllFilterBranch].
         *
         ...
         */
        fun build(): PublicNotAllFilterBranch =
    ...
    fun validate(): PublicNotAllFilterBranch = apply {
        if (validated) {
            return@apply
        }
    ...
    class FilterBranchType @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        companion object {
            ...
            @JvmField val NOT_ALL = of("NOT_ALL")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicNotAllFilterBranch &&
    ...
    override fun toString() =
        "PublicNotAllFilterBranch{filterBranches=$filterBranches, filterBranchOperator=$filterBranchOperator, filterBranchType=$filterBranchType, filters=$filters, additionalProperties=$additionalProperties}"
}
