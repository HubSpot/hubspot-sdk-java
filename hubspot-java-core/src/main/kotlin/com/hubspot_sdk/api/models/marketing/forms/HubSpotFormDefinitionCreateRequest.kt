...
private constructor(
    ...
    /** A builder for [HubSpotFormDefinitionCreateRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(hubSpotFormDefinitionCreateRequest: HubSpotFormDefinitionCreateRequest) =
            apply {
                archived = hubSpotFormDefinitionCreateRequest.archived
                configuration = hubSpotFormDefinitionCreateRequest.configuration
                createdAt = hubSpotFormDefinitionCreateRequest.createdAt
                displayOptions = hubSpotFormDefinitionCreateRequest.displayOptions
                fieldGroups =
                    hubSpotFormDefinitionCreateRequest.fieldGroups.map { it.toMutableList() }
                formType = hubSpotFormDefinitionCreateRequest.formType
                legalConsentOptions = hubSpotFormDefinitionCreateRequest.legalConsentOptions
                name = hubSpotFormDefinitionCreateRequest.name
                updatedAt = hubSpotFormDefinitionCreateRequest.updatedAt
                archivedAt = hubSpotFormDefinitionCreateRequest.archivedAt
                additionalProperties =
                    hubSpotFormDefinitionCreateRequest.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [HubSpotFormDefinitionCreateRequest].
         *
         ...
         */
        fun build(): HubSpotFormDefinitionCreateRequest =
            HubSpotFormDefinitionCreateRequest(
    ...
    fun validate(): HubSpotFormDefinitionCreateRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is HubSpotFormDefinitionCreateRequest &&
    ...
    override fun toString() =
        "HubSpotFormDefinitionCreateRequest{archived=$archived, configuration=$configuration, createdAt=$createdAt, displayOptions=$displayOptions, fieldGroups=$fieldGroups, formType=$formType, legalConsentOptions=$legalConsentOptions, name=$name, updatedAt=$updatedAt, archivedAt=$archivedAt, additionalProperties=$additionalProperties}"
}
