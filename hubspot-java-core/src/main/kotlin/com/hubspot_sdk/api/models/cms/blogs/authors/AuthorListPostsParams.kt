...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AuthorListPostsParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AuthorListPostsParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AuthorListPostsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(authorListPostsParams: AuthorListPostsParams) = apply {
            after = authorListPostsParams.after
            archived = authorListPostsParams.archived
            createdAfter = authorListPostsParams.createdAfter
            createdAt = authorListPostsParams.createdAt
            createdBefore = authorListPostsParams.createdBefore
            limit = authorListPostsParams.limit
            property = authorListPostsParams.property
            sort = authorListPostsParams.sort?.toMutableList()
            updatedAfter = authorListPostsParams.updatedAfter
            updatedAt = authorListPostsParams.updatedAt
            updatedBefore = authorListPostsParams.updatedBefore
            additionalHeaders = authorListPostsParams.additionalHeaders.toBuilder()
            additionalQueryParams = authorListPostsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AuthorListPostsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AuthorListPostsParams =
            AuthorListPostsParams(
                after,
                archived,
                createdAfter,
                createdAt,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AuthorListPostsParams &&
            after == other.after &&
    ...
    override fun toString() =
        "AuthorListPostsParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
