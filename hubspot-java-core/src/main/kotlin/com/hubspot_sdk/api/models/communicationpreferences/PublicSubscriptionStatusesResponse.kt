...
private constructor(
    ...
    /**
     * The email address of the recipient for whom the subscription statuses are being retrieved. It
     * is a string.
     *
    ...
    /**
     * An array of PublicSubscriptionStatus objects, each detailing the subscription status of the
     * recipient for a particular subscription.
     *
     * @throws HubspotInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    ...
    class Builder internal constructor() {
        ...
        /**
         * An array of PublicSubscriptionStatus objects, each detailing the subscription status of
         * the recipient for a particular subscription.
         */
