...
private constructor(
    ...
    private val response: CollectionResponseWithTotalVersionBlog,
) : PageAsync<VersionBlog> {

    /**
     * Delegates to [CollectionResponseWithTotalVersionBlog], but gracefully handles missing data.
     *
     * @see CollectionResponseWithTotalVersionBlog.results
     */
     ...
     * Delegates to [CollectionResponseWithTotalVersionBlog], but gracefully handles missing data.
     *
     * @see CollectionResponseWithTotalVersionBlog.paging
     */
    ...
    fun response(): CollectionResponseWithTotalVersionBlog = response
    ...
    class Builder internal constructor() {
        ...
        private var response: CollectionResponseWithTotalVersionBlog? = null
        ...
        /** The response that this page was parsed from. */
        fun response(response: CollectionResponseWithTotalVersionBlog) = apply {
