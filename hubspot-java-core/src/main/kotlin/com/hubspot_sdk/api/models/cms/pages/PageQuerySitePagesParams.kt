...
class PageQuerySitePagesParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PageQuerySitePagesParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PageQuerySitePagesParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PageQuerySitePagesParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pageQuerySitePagesParams: PageQuerySitePagesParams) = apply {
            after = pageQuerySitePagesParams.after
            archived = pageQuerySitePagesParams.archived
            createdAfter = pageQuerySitePagesParams.createdAfter
            createdAt = pageQuerySitePagesParams.createdAt
            createdBefore = pageQuerySitePagesParams.createdBefore
            limit = pageQuerySitePagesParams.limit
            property = pageQuerySitePagesParams.property
            sort = pageQuerySitePagesParams.sort?.toMutableList()
            updatedAfter = pageQuerySitePagesParams.updatedAfter
            updatedAt = pageQuerySitePagesParams.updatedAt
            updatedBefore = pageQuerySitePagesParams.updatedBefore
            additionalHeaders = pageQuerySitePagesParams.additionalHeaders.toBuilder()
            additionalQueryParams = pageQuerySitePagesParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PageQuerySitePagesParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PageQuerySitePagesParams =
            PageQuerySitePagesParams(
                after,
                archived,
                createdAfter,
                createdAt,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PageQuerySitePagesParams &&
            after == other.after &&
    ...
    override fun toString() =
        "PageQuerySitePagesParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
