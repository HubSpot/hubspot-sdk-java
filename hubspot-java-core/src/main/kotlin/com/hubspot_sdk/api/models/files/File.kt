...
private constructor(
    ...
    private val sourceGroup: JsonField<String>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        sourceGroup: JsonField<String> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun sourceGroup(): Optional<String> = sourceGroup.getOptional("sourceGroup")
     ...
     */
    @JsonProperty("sourceGroup") @ExcludeMissing fun _sourceGroup(): JsonField<String> = sourceGroup
    ...
    class Builder internal constructor() {
        ...
        private var sourceGroup: JsonField<String> = JsonMissing.of()
        ...
        fun sourceGroup(sourceGroup: String) = sourceGroup(JsonField.of(sourceGroup))

        /**
         * Sets [Builder.sourceGroup] to an arbitrary JSON value.
         *
         * You should usually call [Builder.sourceGroup] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun sourceGroup(sourceGroup: JsonField<String>) = apply { this.sourceGroup = sourceGroup }
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (if (sourceGroup.asKnown().isPresent) 1 else 0) +
