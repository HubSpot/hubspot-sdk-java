...
class BatchResponsePublicStatusBulkResponseWithErrors
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val completedAt: JsonField<OffsetDateTime>,
    private val results: JsonField<List<PublicStatusBulkResponse>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<PublicStatusBulkResponse>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<PublicStatusBulkResponse> = results.getRequired("results")
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<PublicStatusBulkResponse>> = results
    ...
    /** A builder for [BatchResponsePublicStatusBulkResponseWithErrors]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<PublicStatusBulkResponse>>? = null
        ...
        internal fun from(
            ...
            completedAt = batchResponsePublicStatusBulkResponseWithErrors.completedAt
            results =
                batchResponsePublicStatusBulkResponseWithErrors.results.map { it.toMutableList() }
            startedAt = batchResponsePublicStatusBulkResponseWithErrors.startedAt
            status = batchResponsePublicStatusBulkResponseWithErrors.status
            errors =
                batchResponsePublicStatusBulkResponseWithErrors.errors.map { it.toMutableList() }
            links = batchResponsePublicStatusBulkResponseWithErrors.links
            numErrors = batchResponsePublicStatusBulkResponseWithErrors.numErrors
            requestedAt = batchResponsePublicStatusBulkResponseWithErrors.requestedAt
            additionalProperties =
                batchResponsePublicStatusBulkResponseWithErrors.additionalProperties.toMutableMap()
        }
        ...
        /** An array containing the results of the operation. */
        fun results(results: List<PublicStatusBulkResponse>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed
         * `List<PublicStatusBulkResponse>` value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun results(results: JsonField<List<PublicStatusBulkResponse>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [PublicStatusBulkResponse] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: PublicStatusBulkResponse) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [BatchResponsePublicStatusBulkResponseWithErrors].
         *
         ...
         */
        fun build(): BatchResponsePublicStatusBulkResponseWithErrors =
            BatchResponsePublicStatusBulkResponseWithErrors(
    ...
    fun validate(): BatchResponsePublicStatusBulkResponseWithErrors = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponsePublicStatusBulkResponseWithErrors &&
    ...
    override fun toString() =
        "BatchResponsePublicStatusBulkResponseWithErrors{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
