 ...
 * viewing.
 */
class EventCreateMediaPlayedPercentEventParams
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun playedPercent(): Int = body.playedPercent()
     ...
     */
    fun _playedPercent(): JsonField<Int> = body._playedPercent()
    ...
    /** A builder for [EventCreateMediaPlayedPercentEventParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            eventCreateMediaPlayedPercentEventParams: EventCreateMediaPlayedPercentEventParams
        ) = apply {
            body = eventCreateMediaPlayedPercentEventParams.body.toBuilder()
            additionalHeaders =
                eventCreateMediaPlayedPercentEventParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                eventCreateMediaPlayedPercentEventParams.additionalQueryParams.toBuilder()
        }
        ...
        fun playedPercent(playedPercent: Int) = apply { body.playedPercent(playedPercent) }
        ...
        fun playedPercent(playedPercent: JsonField<Int>) = apply {
            body.playedPercent(playedPercent)
        }
        ...
        /**
         * Returns an immutable instance of [EventCreateMediaPlayedPercentEventParams].
         *
         ...
         */
        fun build(): EventCreateMediaPlayedPercentEventParams =
            EventCreateMediaPlayedPercentEventParams(
                body.build(),
    ...
    private constructor(
         ...
         * Returns the raw JSON value of [playedPercent].
         *
         * Unlike [playedPercent], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("playedPercent")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) = apply {
                ...
                playedPercent = body.playedPercent
             ...
             * Sets [Builder.playedPercent] to an arbitrary JSON value.
             *
             * You should usually call [Builder.playedPercent] with a well-typed [Int] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun playedPercent(playedPercent: JsonField<Int>) = apply {
        ...
        override fun toString() =
            "Body{mediaType=$mediaType, occurredTimestamp=$occurredTimestamp, playedPercent=$playedPercent, sessionId=$sessionId, _hsenc=$_hsenc, contactId=$contactId, contactUtk=$contactUtk, externalId=$externalId, mediaBridgeId=$mediaBridgeId, mediaName=$mediaName, mediaUrl=$mediaUrl, pageId=$pageId, pageName=$pageName, pageUrl=$pageUrl, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EventCreateMediaPlayedPercentEventParams &&
            body == other.body &&
    ...
    override fun toString() =
        "EventCreateMediaPlayedPercentEventParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
