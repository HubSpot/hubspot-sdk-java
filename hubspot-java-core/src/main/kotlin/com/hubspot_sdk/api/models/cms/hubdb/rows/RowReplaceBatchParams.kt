...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RowReplaceBatchParams].
         *
    ...
    /** A builder for [RowReplaceBatchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rowReplaceBatchParams: RowReplaceBatchParams) = apply {
            tableIdOrName = rowReplaceBatchParams.tableIdOrName
            batchInputHubDbTableRowV3BatchUpdateRequest =
                rowReplaceBatchParams.batchInputHubDbTableRowV3BatchUpdateRequest
            additionalHeaders = rowReplaceBatchParams.additionalHeaders.toBuilder()
            additionalQueryParams = rowReplaceBatchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [RowReplaceBatchParams].
         *
         ...
         */
        fun build(): RowReplaceBatchParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RowReplaceBatchParams &&
    ...
    override fun toString() =
        "RowReplaceBatchParams{tableIdOrName=$tableIdOrName, batchInputHubDbTableRowV3BatchUpdateRequest=$batchInputHubDbTableRowV3BatchUpdateRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
