...
private constructor(
    ...
    /** A builder for [CollectionResponseWithTotalTagForwardPaging]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            results = collectionResponseWithTotalTagForwardPaging.results.map { it.toMutableList() }
            total = collectionResponseWithTotalTagForwardPaging.total
            paging = collectionResponseWithTotalTagForwardPaging.paging
            additionalProperties =
                collectionResponseWithTotalTagForwardPaging.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CollectionResponseWithTotalTagForwardPaging].
         *
         ...
         */
        fun build(): CollectionResponseWithTotalTagForwardPaging =
            CollectionResponseWithTotalTagForwardPaging(
    ...
    fun validate(): CollectionResponseWithTotalTagForwardPaging = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionResponseWithTotalTagForwardPaging &&
    ...
    override fun toString() =
        "CollectionResponseWithTotalTagForwardPaging{results=$results, total=$total, paging=$paging, additionalProperties=$additionalProperties}"
}
