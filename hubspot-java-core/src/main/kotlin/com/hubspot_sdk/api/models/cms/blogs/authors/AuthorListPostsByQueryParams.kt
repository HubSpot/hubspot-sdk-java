...
class AuthorListPostsByQueryParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AuthorListPostsByQueryParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [AuthorListPostsByQueryParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AuthorListPostsByQueryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(authorListPostsByQueryParams: AuthorListPostsByQueryParams) = apply {
            after = authorListPostsByQueryParams.after
            archived = authorListPostsByQueryParams.archived
            createdAfter = authorListPostsByQueryParams.createdAfter
            createdAt = authorListPostsByQueryParams.createdAt
            createdBefore = authorListPostsByQueryParams.createdBefore
            limit = authorListPostsByQueryParams.limit
            property = authorListPostsByQueryParams.property
            sort = authorListPostsByQueryParams.sort?.toMutableList()
            updatedAfter = authorListPostsByQueryParams.updatedAfter
            updatedAt = authorListPostsByQueryParams.updatedAt
            updatedBefore = authorListPostsByQueryParams.updatedBefore
            additionalHeaders = authorListPostsByQueryParams.additionalHeaders.toBuilder()
            additionalQueryParams = authorListPostsByQueryParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AuthorListPostsByQueryParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AuthorListPostsByQueryParams =
            AuthorListPostsByQueryParams(
                after,
                archived,
                createdAfter,
                createdAt,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AuthorListPostsByQueryParams &&
            after == other.after &&
    ...
    override fun toString() =
        "AuthorListPostsByQueryParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
