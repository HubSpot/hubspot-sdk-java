...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of deals that can be
    ...
    companion object {
        ...
        @JvmStatic fun none(): DealListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [DealListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DealListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dealListParams: DealListParams) = apply {
            after = dealListParams.after
            archived = dealListParams.archived
            associations = dealListParams.associations?.toMutableList()
            limit = dealListParams.limit
            properties = dealListParams.properties?.toMutableList()
            propertiesWithHistory = dealListParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = dealListParams.additionalHeaders.toBuilder()
            additionalQueryParams = dealListParams.additionalQueryParams.toBuilder()
        }
         ...
         * of deals that can be read by a single request.
         */
        ...
        /**
         * Returns an immutable instance of [DealListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DealListParams =
            DealListParams(
                after,
                archived,
    ...
    override fun toString() =
        "DealListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
