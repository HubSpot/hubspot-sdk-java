...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): MediaBridgeListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [MediaBridgeListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MediaBridgeListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(mediaBridgeListParams: MediaBridgeListParams) = apply {
            mediaType = mediaBridgeListParams.mediaType
            after = mediaBridgeListParams.after
            limit = mediaBridgeListParams.limit
            additionalHeaders = mediaBridgeListParams.additionalHeaders.toBuilder()
            additionalQueryParams = mediaBridgeListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [MediaBridgeListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MediaBridgeListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MediaBridgeListParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(mediaType, after, limit, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "MediaBridgeListParams{mediaType=$mediaType, after=$after, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
