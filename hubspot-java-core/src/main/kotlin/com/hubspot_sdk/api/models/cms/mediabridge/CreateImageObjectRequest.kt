...
class CreateImageObjectRequest
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CreateImageObjectRequest].
         *
    ...
    /** A builder for [CreateImageObjectRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(createImageObjectRequest: CreateImageObjectRequest) = apply {
            mediaType = createImageObjectRequest.mediaType
            title = createImageObjectRequest.title
            detailsPageLink = createImageObjectRequest.detailsPageLink
            duration = createImageObjectRequest.duration
            externalId = createImageObjectRequest.externalId
            fileUrl = createImageObjectRequest.fileUrl
            oembedUrl = createImageObjectRequest.oembedUrl
            posterUrl = createImageObjectRequest.posterUrl
            thumbnailUrl = createImageObjectRequest.thumbnailUrl
            additionalProperties = createImageObjectRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CreateImageObjectRequest].
         *
         ...
         */
        fun build(): CreateImageObjectRequest =
    ...
    fun validate(): CreateImageObjectRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CreateImageObjectRequest &&
    ...
    override fun toString() =
        "CreateImageObjectRequest{mediaType=$mediaType, title=$title, detailsPageLink=$detailsPageLink, duration=$duration, externalId=$externalId, fileUrl=$fileUrl, oembedUrl=$oembedUrl, posterUrl=$posterUrl, thumbnailUrl=$thumbnailUrl, additionalProperties=$additionalProperties}"
}
