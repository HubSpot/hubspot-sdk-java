...
package com.hubspot_sdk.api.models.webhooks.webhooks.batch
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchGetLocalNextParams].
         *
    ...
    /** A builder for [BatchGetLocalNextParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchGetLocalNextParams: BatchGetLocalNextParams) = apply {
            offset = batchGetLocalNextParams.offset
            count = batchGetLocalNextParams.count
            installPortalId = batchGetLocalNextParams.installPortalId
            additionalHeaders = batchGetLocalNextParams.additionalHeaders.toBuilder()
            additionalQueryParams = batchGetLocalNextParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BatchGetLocalNextParams].
         *
         ...
         */
        fun build(): BatchGetLocalNextParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchGetLocalNextParams &&
            offset == other.offset &&
            count == other.count &&
    ...
    override fun toString() =
        "BatchGetLocalNextParams{offset=$offset, count=$count, installPortalId=$installPortalId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
