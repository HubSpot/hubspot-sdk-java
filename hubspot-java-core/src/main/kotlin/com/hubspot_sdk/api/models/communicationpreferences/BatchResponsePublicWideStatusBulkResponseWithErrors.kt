...
class BatchResponsePublicWideStatusBulkResponseWithErrors
...
private constructor(
    ...
    /** A builder for [BatchResponsePublicWideStatusBulkResponseWithErrors]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            completedAt = batchResponsePublicWideStatusBulkResponseWithErrors.completedAt
            results =
                batchResponsePublicWideStatusBulkResponseWithErrors.results.map {
                    it.toMutableList()
                }
            startedAt = batchResponsePublicWideStatusBulkResponseWithErrors.startedAt
            status = batchResponsePublicWideStatusBulkResponseWithErrors.status
            errors =
                batchResponsePublicWideStatusBulkResponseWithErrors.errors.map {
                    it.toMutableList()
                }
            links = batchResponsePublicWideStatusBulkResponseWithErrors.links
            numErrors = batchResponsePublicWideStatusBulkResponseWithErrors.numErrors
            requestedAt = batchResponsePublicWideStatusBulkResponseWithErrors.requestedAt
            additionalProperties =
                batchResponsePublicWideStatusBulkResponseWithErrors.additionalProperties
                    .toMutableMap()
        }
        ...
        /**
         * The current status of the operation, which can be PENDING, PROCESSING, CANCELED, or
         * COMPLETE.
         */
        ...
        /**
         * An object containing related links, where each key is a link name and each value is a
         * URL.
         */
        ...
        /**
         * Returns an immutable instance of [BatchResponsePublicWideStatusBulkResponseWithErrors].
         *
         ...
         */
        fun build(): BatchResponsePublicWideStatusBulkResponseWithErrors =
            BatchResponsePublicWideStatusBulkResponseWithErrors(
    ...
    fun validate(): BatchResponsePublicWideStatusBulkResponseWithErrors = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponsePublicWideStatusBulkResponseWithErrors &&
    ...
    override fun toString() =
        "BatchResponsePublicWideStatusBulkResponseWithErrors{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
