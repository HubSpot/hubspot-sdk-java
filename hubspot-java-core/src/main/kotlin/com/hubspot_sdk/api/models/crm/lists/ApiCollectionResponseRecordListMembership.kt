...
class ApiCollectionResponseRecordListMembership
...
private constructor(
    ...
    /** A builder for [ApiCollectionResponseRecordListMembership]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            results = apiCollectionResponseRecordListMembership.results.map { it.toMutableList() }
            paging = apiCollectionResponseRecordListMembership.paging
            total = apiCollectionResponseRecordListMembership.total
            additionalProperties =
                apiCollectionResponseRecordListMembership.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ApiCollectionResponseRecordListMembership].
         *
         ...
         */
        fun build(): ApiCollectionResponseRecordListMembership =
            ApiCollectionResponseRecordListMembership(
    ...
    fun validate(): ApiCollectionResponseRecordListMembership = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ApiCollectionResponseRecordListMembership &&
    ...
    override fun toString() =
        "ApiCollectionResponseRecordListMembership{results=$results, paging=$paging, total=$total, additionalProperties=$additionalProperties}"
}
