...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(associationListParams: AssociationListParams) = apply {
            partnerServiceId = associationListParams.partnerServiceId
    ...
    override fun toString() =
        "AssociationListParams{partnerServiceId=$partnerServiceId, toObjectType=$toObjectType, after=$after, includeFa=$includeFa, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
