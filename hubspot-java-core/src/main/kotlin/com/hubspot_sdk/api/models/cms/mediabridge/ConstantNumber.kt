...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ConstantNumber].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(constantNumber: ConstantNumber) = apply {
            operator = constantNumber.operator
            propertyName = constantNumber.propertyName
            value = constantNumber.value
            additionalProperties = constantNumber.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ConstantNumber].
         *
    ...
    fun validate(): ConstantNumber = apply {
        if (validated) {
            return@apply
        }
    ...
    class Operator @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val CONSTANT_NUMBER = of("CONSTANT_NUMBER")
        ...
        fun value(): Value =
            when (this) {
                CONSTANT_NUMBER -> Value.CONSTANT_NUMBER
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CONSTANT_NUMBER -> Known.CONSTANT_NUMBER
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ConstantNumber &&
    ...
    override fun toString() =
        "ConstantNumber{operator=$operator, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
