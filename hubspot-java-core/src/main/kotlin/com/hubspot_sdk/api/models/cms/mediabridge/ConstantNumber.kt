...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(constantNumber: ConstantNumber) = apply {
            ...
            inputs = constantNumber.inputs.map { it.toMutableList() }
    ...
    override fun toString() =
        "ConstantNumber{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
