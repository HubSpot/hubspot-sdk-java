...
class PageListLandingPagesParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PageListLandingPagesParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [PageListLandingPagesParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PageListLandingPagesParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(pageListLandingPagesParams: PageListLandingPagesParams) = apply {
            after = pageListLandingPagesParams.after
            archived = pageListLandingPagesParams.archived
            createdAfter = pageListLandingPagesParams.createdAfter
            createdAt = pageListLandingPagesParams.createdAt
            createdBefore = pageListLandingPagesParams.createdBefore
            limit = pageListLandingPagesParams.limit
            property = pageListLandingPagesParams.property
            sort = pageListLandingPagesParams.sort?.toMutableList()
            updatedAfter = pageListLandingPagesParams.updatedAfter
            updatedAt = pageListLandingPagesParams.updatedAt
            updatedBefore = pageListLandingPagesParams.updatedBefore
            additionalHeaders = pageListLandingPagesParams.additionalHeaders.toBuilder()
            additionalQueryParams = pageListLandingPagesParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PageListLandingPagesParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PageListLandingPagesParams =
            PageListLandingPagesParams(
                after,
                archived,
                createdAfter,
                createdAt,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PageListLandingPagesParams &&
            after == other.after &&
    ...
    override fun toString() =
        "PageListLandingPagesParams{after=$after, archived=$archived, createdAfter=$createdAfter, createdAt=$createdAt, createdBefore=$createdBefore, limit=$limit, property=$property, sort=$sort, updatedAfter=$updatedAfter, updatedAt=$updatedAt, updatedBefore=$updatedBefore, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
