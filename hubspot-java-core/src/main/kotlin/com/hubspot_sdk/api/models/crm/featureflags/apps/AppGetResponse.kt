...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(appGetResponse: AppGetResponse) = apply {
            appId = appGetResponse.appId
            defaultState = appGetResponse.defaultState
            flagName = appGetResponse.flagName
            overrideState = appGetResponse.overrideState
    ...
    override fun toString() =
        "AppGetResponse{appId=$appId, defaultState=$defaultState, flagName=$flagName, overrideState=$overrideState, additionalProperties=$additionalProperties}"
}
