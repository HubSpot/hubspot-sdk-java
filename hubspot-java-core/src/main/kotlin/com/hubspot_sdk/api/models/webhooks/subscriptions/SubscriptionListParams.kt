...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionListParams: SubscriptionListParams) = apply {
            appId = subscriptionListParams.appId
        ...
        fun build(): SubscriptionListParams =
            SubscriptionListParams(appId, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "SubscriptionListParams{appId=$appId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
