...
class BatchResponsePublicStatusBulkResponse
...
private constructor(
    ...
    /** A builder for [BatchResponsePublicStatusBulkResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            batchResponsePublicStatusBulkResponse: BatchResponsePublicStatusBulkResponse
        ) = apply {
            completedAt = batchResponsePublicStatusBulkResponse.completedAt
            results = batchResponsePublicStatusBulkResponse.results.map { it.toMutableList() }
            startedAt = batchResponsePublicStatusBulkResponse.startedAt
            status = batchResponsePublicStatusBulkResponse.status
            errors = batchResponsePublicStatusBulkResponse.errors.map { it.toMutableList() }
            links = batchResponsePublicStatusBulkResponse.links
            numErrors = batchResponsePublicStatusBulkResponse.numErrors
            requestedAt = batchResponsePublicStatusBulkResponse.requestedAt
            additionalProperties =
                batchResponsePublicStatusBulkResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BatchResponsePublicStatusBulkResponse].
         *
         ...
         */
        fun build(): BatchResponsePublicStatusBulkResponse =
            BatchResponsePublicStatusBulkResponse(
    ...
    fun validate(): BatchResponsePublicStatusBulkResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponsePublicStatusBulkResponse &&
    ...
    override fun toString() =
        "BatchResponsePublicStatusBulkResponse{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
