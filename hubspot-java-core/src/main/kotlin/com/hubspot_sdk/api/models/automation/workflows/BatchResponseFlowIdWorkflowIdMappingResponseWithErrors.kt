...
class BatchResponseFlowIdWorkflowIdMappingResponseWithErrors
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val completedAt: JsonField<OffsetDateTime>,
    private val results: JsonField<List<FlowIdWorkflowIdMappingResponse>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<FlowIdWorkflowIdMappingResponse>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<FlowIdWorkflowIdMappingResponse> = results.getRequired("results")
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<FlowIdWorkflowIdMappingResponse>> = results
    ...
    /** A builder for [BatchResponseFlowIdWorkflowIdMappingResponseWithErrors]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<FlowIdWorkflowIdMappingResponse>>? = null
        ...
        internal fun from(
            ...
            completedAt = batchResponseFlowIdWorkflowIdMappingResponseWithErrors.completedAt
            results =
                batchResponseFlowIdWorkflowIdMappingResponseWithErrors.results.map {
                    it.toMutableList()
                }
            startedAt = batchResponseFlowIdWorkflowIdMappingResponseWithErrors.startedAt
            status = batchResponseFlowIdWorkflowIdMappingResponseWithErrors.status
            errors =
                batchResponseFlowIdWorkflowIdMappingResponseWithErrors.errors.map {
                    it.toMutableList()
                }
            links = batchResponseFlowIdWorkflowIdMappingResponseWithErrors.links
            numErrors = batchResponseFlowIdWorkflowIdMappingResponseWithErrors.numErrors
            requestedAt = batchResponseFlowIdWorkflowIdMappingResponseWithErrors.requestedAt
            additionalProperties =
                batchResponseFlowIdWorkflowIdMappingResponseWithErrors.additionalProperties
                    .toMutableMap()
        }
        ...
        fun results(results: List<FlowIdWorkflowIdMappingResponse>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed
         * `List<FlowIdWorkflowIdMappingResponse>` value instead. This method is primarily for
         * setting the field to an undocumented or not yet supported value.
         */
        fun results(results: JsonField<List<FlowIdWorkflowIdMappingResponse>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [FlowIdWorkflowIdMappingResponse] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: FlowIdWorkflowIdMappingResponse) = apply {
            results =
         ...
         */
        fun build(): BatchResponseFlowIdWorkflowIdMappingResponseWithErrors =
            BatchResponseFlowIdWorkflowIdMappingResponseWithErrors(
    ...
    fun validate(): BatchResponseFlowIdWorkflowIdMappingResponseWithErrors = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseFlowIdWorkflowIdMappingResponseWithErrors &&
    ...
    override fun toString() =
        "BatchResponseFlowIdWorkflowIdMappingResponseWithErrors{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
