...
class BatchResponseRecordIdWithMemberships
...
private constructor(
    ...
    /** A builder for [BatchResponseRecordIdWithMemberships]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            completedAt = batchResponseRecordIdWithMemberships.completedAt
            results = batchResponseRecordIdWithMemberships.results.map { it.toMutableList() }
            startedAt = batchResponseRecordIdWithMemberships.startedAt
            status = batchResponseRecordIdWithMemberships.status
            errors = batchResponseRecordIdWithMemberships.errors.map { it.toMutableList() }
            links = batchResponseRecordIdWithMemberships.links
            numErrors = batchResponseRecordIdWithMemberships.numErrors
            requestedAt = batchResponseRecordIdWithMemberships.requestedAt
            additionalProperties =
                batchResponseRecordIdWithMemberships.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BatchResponseRecordIdWithMemberships].
         *
         ...
         */
        fun build(): BatchResponseRecordIdWithMemberships =
            BatchResponseRecordIdWithMemberships(
    ...
    fun validate(): BatchResponseRecordIdWithMemberships = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseRecordIdWithMemberships &&
    ...
    override fun toString() =
        "BatchResponseRecordIdWithMemberships{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
