...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun isMatchFullUrl(): Boolean = body.isMatchFullUrl()
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun isMatchQueryString(): Boolean = body.isMatchQueryString()
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun isOnlyAfterNotFound(): Boolean = body.isOnlyAfterNotFound()
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun isPattern(): Boolean = body.isPattern()
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun isProtocolAgnostic(): Boolean = body.isProtocolAgnostic()
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun isTrailingSlashOptional(): Boolean = body.isTrailingSlashOptional()
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun precedence(): Int = body.precedence()
     ...
     */
    fun created(): Optional<OffsetDateTime> = body.created()

    /**
     * @throws HubspotInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun updated(): Optional<OffsetDateTime> = body.updated()
     ...
     */
    fun _created(): JsonField<OffsetDateTime> = body._created()
     ...
     */
    fun _updated(): JsonField<OffsetDateTime> = body._updated()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(urlRedirectUpdateParams: UrlRedirectUpdateParams) = apply {
            ...
            body = urlRedirectUpdateParams.body.toBuilder()
        ...
        fun created(created: OffsetDateTime) = apply { body.created(created) }
         ...
         * supported value.
         */
        fun created(created: JsonField<OffsetDateTime>) = apply { body.created(created) }

        fun updated(updated: OffsetDateTime) = apply { body.updated(updated) }
         ...
         * supported value.
         */
        fun updated(updated: JsonField<OffsetDateTime>) = apply { body.updated(updated) }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /**
             * Whether the URL redirect mapping should apply only if a live page on the URL isn't
             * found. If False, the URL redirect mapping will take precedence over any existing
             * page.
             */
            ...
            /**
             * Used to prioritize URL redirection. If a given URL matches more than one redirect,
             * the one with the **lower** precedence will be used.
             */
            ...
            /**
             * The type of redirect to create. Options include: 301 (permanent), 302 (temporary), or
             * 305 (proxy). Find more details
             * [here](https://knowledge.hubspot.com/cos-general/how-to-redirect-a-hubspot-page).
             */
        ...
        override fun toString() =
            "Body{id=$id, destination=$destination, isMatchFullUrl=$isMatchFullUrl, isMatchQueryString=$isMatchQueryString, isOnlyAfterNotFound=$isOnlyAfterNotFound, isPattern=$isPattern, isProtocolAgnostic=$isProtocolAgnostic, isTrailingSlashOptional=$isTrailingSlashOptional, precedence=$precedence, redirectStyle=$redirectStyle, routePrefix=$routePrefix, created=$created, updated=$updated, additionalProperties=$additionalProperties}"
    }
    ...
    override fun hashCode(): Int =
        Objects.hash(urlRedirectId, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "UrlRedirectUpdateParams{urlRedirectId=$urlRedirectId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
