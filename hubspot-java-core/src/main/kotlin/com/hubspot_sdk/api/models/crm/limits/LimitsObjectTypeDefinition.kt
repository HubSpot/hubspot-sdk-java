...
class LimitsObjectTypeDefinition
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LimitsObjectTypeDefinition].
         *
    ...
    /** A builder for [LimitsObjectTypeDefinition]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(limitsObjectTypeDefinition: LimitsObjectTypeDefinition) = apply {
            objectTypeId = limitsObjectTypeDefinition.objectTypeId
            pluralLabel = limitsObjectTypeDefinition.pluralLabel
            singularLabel = limitsObjectTypeDefinition.singularLabel
            additionalProperties = limitsObjectTypeDefinition.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LimitsObjectTypeDefinition].
         *
         ...
         */
        fun build(): LimitsObjectTypeDefinition =
    ...
    fun validate(): LimitsObjectTypeDefinition = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LimitsObjectTypeDefinition &&
    ...
    override fun toString() =
        "LimitsObjectTypeDefinition{objectTypeId=$objectTypeId, pluralLabel=$pluralLabel, singularLabel=$singularLabel, additionalProperties=$additionalProperties}"
}
