...
class BatchResponseExchangeRateWithErrors
...
private constructor(
    ...
    /** A builder for [BatchResponseExchangeRateWithErrors]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            batchResponseExchangeRateWithErrors: BatchResponseExchangeRateWithErrors
        ) = apply {
            completedAt = batchResponseExchangeRateWithErrors.completedAt
            results = batchResponseExchangeRateWithErrors.results.map { it.toMutableList() }
            startedAt = batchResponseExchangeRateWithErrors.startedAt
            status = batchResponseExchangeRateWithErrors.status
            errors = batchResponseExchangeRateWithErrors.errors.map { it.toMutableList() }
            links = batchResponseExchangeRateWithErrors.links
            numErrors = batchResponseExchangeRateWithErrors.numErrors
            requestedAt = batchResponseExchangeRateWithErrors.requestedAt
            additionalProperties =
                batchResponseExchangeRateWithErrors.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BatchResponseExchangeRateWithErrors].
         *
         ...
         */
        fun build(): BatchResponseExchangeRateWithErrors =
            BatchResponseExchangeRateWithErrors(
    ...
    fun validate(): BatchResponseExchangeRateWithErrors = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseExchangeRateWithErrors &&
    ...
    override fun toString() =
        "BatchResponseExchangeRateWithErrors{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
