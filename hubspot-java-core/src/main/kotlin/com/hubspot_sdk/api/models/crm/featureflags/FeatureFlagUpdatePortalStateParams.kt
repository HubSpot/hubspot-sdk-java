...
class FeatureFlagUpdatePortalStateParams
private constructor(
    ...
    /** A builder for [FeatureFlagUpdatePortalStateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(featureFlagUpdatePortalStateParams: FeatureFlagUpdatePortalStateParams) =
            apply {
                appId = featureFlagUpdatePortalStateParams.appId
                flagName = featureFlagUpdatePortalStateParams.flagName
                portalId = featureFlagUpdatePortalStateParams.portalId
                portalFlagStatePutRequest =
                    featureFlagUpdatePortalStateParams.portalFlagStatePutRequest
                additionalHeaders = featureFlagUpdatePortalStateParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    featureFlagUpdatePortalStateParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [FeatureFlagUpdatePortalStateParams].
         *
         ...
         */
        fun build(): FeatureFlagUpdatePortalStateParams =
            FeatureFlagUpdatePortalStateParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeatureFlagUpdatePortalStateParams &&
            appId == other.appId &&
    ...
    override fun toString() =
        "FeatureFlagUpdatePortalStateParams{appId=$appId, flagName=$flagName, portalId=$portalId, portalFlagStatePutRequest=$portalFlagStatePutRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
