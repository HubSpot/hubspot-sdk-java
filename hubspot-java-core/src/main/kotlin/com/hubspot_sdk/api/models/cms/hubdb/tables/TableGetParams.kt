...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TableGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TableGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TableGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tableGetParams: TableGetParams) = apply {
            tableIdOrName = tableGetParams.tableIdOrName
            archived = tableGetParams.archived
            includeForeignIds = tableGetParams.includeForeignIds
            isGetLocalizedSchema = tableGetParams.isGetLocalizedSchema
            additionalHeaders = tableGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = tableGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TableGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TableGetParams =
            TableGetParams(
                tableIdOrName,
                archived,
                includeForeignIds,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TableGetParams &&
    ...
    override fun toString() =
        "TableGetParams{tableIdOrName=$tableIdOrName, archived=$archived, includeForeignIds=$includeForeignIds, isGetLocalizedSchema=$isGetLocalizedSchema, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
