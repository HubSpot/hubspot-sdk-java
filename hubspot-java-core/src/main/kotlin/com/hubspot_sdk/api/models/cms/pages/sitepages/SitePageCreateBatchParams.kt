...
class SitePageCreateBatchParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SitePageCreateBatchParams].
         *
    ...
    /** A builder for [SitePageCreateBatchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sitePageCreateBatchParams: SitePageCreateBatchParams) = apply {
            batchInputPage = sitePageCreateBatchParams.batchInputPage
            additionalHeaders = sitePageCreateBatchParams.additionalHeaders.toBuilder()
            additionalQueryParams = sitePageCreateBatchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SitePageCreateBatchParams].
         *
         ...
         */
        fun build(): SitePageCreateBatchParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SitePageCreateBatchParams &&
    ...
    override fun toString() =
        "SitePageCreateBatchParams{batchInputPage=$batchInputPage, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
