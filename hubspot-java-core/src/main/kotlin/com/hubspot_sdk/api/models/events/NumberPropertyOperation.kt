...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NumberPropertyOperation].
         *
    ...
    /** A builder for [NumberPropertyOperation]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(numberPropertyOperation: NumberPropertyOperation) = apply {
            includeObjectsWithNoValueSet = numberPropertyOperation.includeObjectsWithNoValueSet
            operationType = numberPropertyOperation.operationType
            operator = numberPropertyOperation.operator
            operatorName = numberPropertyOperation.operatorName
            propertyType = numberPropertyOperation.propertyType
            value = numberPropertyOperation.value
            defaultValue = numberPropertyOperation.defaultValue
            renderSpec = numberPropertyOperation.renderSpec
            additionalProperties = numberPropertyOperation.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NumberPropertyOperation].
         *
         ...
         */
        fun build(): NumberPropertyOperation =
    ...
    fun validate(): NumberPropertyOperation = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NumberPropertyOperation &&
    ...
    override fun toString() =
        "NumberPropertyOperation{includeObjectsWithNoValueSet=$includeObjectsWithNoValueSet, operationType=$operationType, operator=$operator, operatorName=$operatorName, propertyType=$propertyType, value=$value, defaultValue=$defaultValue, renderSpec=$renderSpec, additionalProperties=$additionalProperties}"
}
