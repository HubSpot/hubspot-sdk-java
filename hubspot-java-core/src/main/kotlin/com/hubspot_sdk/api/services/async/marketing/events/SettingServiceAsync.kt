...
interface SettingServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /marketing/v3/marketing-events/{appId}/settings`,
         * but is otherwise the same as [SettingServiceAsync.createOrUpdate].
         */
        fun createOrUpdate(
            appId: Int,
            params: SettingCreateOrUpdateParams,
        ...
        /**
         * Returns a raw HTTP response for `get /marketing/v3/marketing-events/{appId}/settings`,
         * but is otherwise the same as [SettingServiceAsync.get].
         */
