...
import com.hubspot_sdk.api.services.async.crm.properties.BatchServiceAsyncImpl
import com.hubspot_sdk.api.services.async.crm.properties.GroupServiceAsync
import com.hubspot_sdk.api.services.async.crm.properties.GroupServiceAsyncImpl
...
class PropertyServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val createHandler: Handler<CreatedResponseProperty> =
            jsonHandler<CreatedResponseProperty>(clientOptions.jsonMapper)
        ...
        override fun create(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("crm", "v3", "properties", params._pathParam(0))
        ...
        private val listHandler: Handler<CollectionResponseProperty> =
            jsonHandler<CollectionResponseProperty>(clientOptions.jsonMapper)
