...
interface DiscountService {
     ...
     */
    fun create(params: DiscountCreateParams): CreatedResponseSimplePublicObject =
    ...
    interface WithRawResponse {
         ...
         * same as [DiscountService.create].
         */
        @MustBeClosed
        fun create(
            params: DiscountCreateParams
         ...
         * otherwise the same as [DiscountService.update].
         */
        @MustBeClosed
        fun update(
            discountId: String,
         ...
         * otherwise the same as [DiscountService.delete].
         */
        @MustBeClosed
         ...
         * the same as [DiscountService.search].
         */
        @MustBeClosed
        fun search(
            params: DiscountSearchParams
