...
class ActorServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ActorService {

    private val withRawResponse: ActorService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): ActorService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): ActorService =
        ActorServiceImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun get(params: ActorGetParams, requestOptions: RequestOptions): PublicActor =
        // get /conversations/v3/conversations/actors/{actorId}
        withRawResponse().get(params, requestOptions).parse()

    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ActorService.WithRawResponse {
        ...
        override fun withOptions(
            ...
            ActorServiceImpl.WithRawResponseImpl(
