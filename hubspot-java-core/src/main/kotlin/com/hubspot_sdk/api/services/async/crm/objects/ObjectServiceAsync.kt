...
interface ObjectServiceAsync {
    ...
    /** @see create */
    fun create(params: ObjectCreateParams): CompletableFuture<CreatedResponseSimplePublicObject> =
    ...
    interface WithRawResponse {
         ...
         * same as [ObjectServiceAsync.create].
         */
        fun create(
            objectType: String,
            params: ObjectCreateParams,
         ...
         * otherwise the same as [ObjectServiceAsync.update].
         */
        fun update(
            objectId: String,
            params: ObjectUpdateParams,
         ...
         * same as [ObjectServiceAsync.list].
         */
