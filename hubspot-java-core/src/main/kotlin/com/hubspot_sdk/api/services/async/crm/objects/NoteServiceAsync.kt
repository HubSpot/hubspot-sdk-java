...
interface NoteServiceAsync {
     ...
     */
    fun create(params: NoteCreateParams): CompletableFuture<CreatedResponseSimplePublicObject> =
    ...
    interface WithRawResponse {
         ...
         * the same as [NoteServiceAsync.update].
         */
        fun update(
            noteId: String,
            params: NoteUpdateParams,
         ...
         * the same as [NoteServiceAsync.delete].
         */
         ...
         * the same as [NoteServiceAsync.get].
         */
        fun get(
            noteId: String
         ...
         * same as [NoteServiceAsync.search].
         */
        fun search(
            params: NoteSearchParams
