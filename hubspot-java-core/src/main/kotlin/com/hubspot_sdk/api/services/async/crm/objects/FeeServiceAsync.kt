...
interface FeeServiceAsync {
     ...
     */
    fun create(params: FeeCreateParams): CompletableFuture<CreatedResponseSimplePublicObject> =
    ...
    interface WithRawResponse {
         ...
         * the same as [FeeServiceAsync.update].
         */
        fun update(
            feeId: String,
            params: FeeUpdateParams,
         ...
         * the same as [FeeServiceAsync.delete].
         */
         ...
         * same as [FeeServiceAsync.search].
         */
        fun search(
            params: FeeSearchParams
