...
interface FileService {
    ...
    interface WithRawResponse {
         ...
         * otherwise the same as [FileService.gdprDelete].
         */
        @MustBeClosed
         ...
         * as [FileService.getImportTaskStatus].
         */
        @MustBeClosed
