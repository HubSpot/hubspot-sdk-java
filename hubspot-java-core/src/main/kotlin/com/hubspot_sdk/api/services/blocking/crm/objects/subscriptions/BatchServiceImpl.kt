...
package com.hubspot_sdk.api.services.blocking.crm.objects.subscriptions
...
import com.hubspot_sdk.api.models.crm.objects.subscriptions.batch.BatchCreateParams
import com.hubspot_sdk.api.models.crm.objects.subscriptions.batch.BatchDeleteParams
import com.hubspot_sdk.api.models.crm.objects.subscriptions.batch.BatchGetParams
import com.hubspot_sdk.api.models.crm.objects.subscriptions.batch.BatchUpdateParams
import com.hubspot_sdk.api.models.crm.objects.subscriptions.batch.BatchUpsertParams
        ...
        override fun get(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.POST)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("crm", "objects", "2026-03", "subscriptions", "batch", "read")
                    .body(json(clientOptions.jsonMapper, params._body()))
                    .build()
                    .prepare(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
