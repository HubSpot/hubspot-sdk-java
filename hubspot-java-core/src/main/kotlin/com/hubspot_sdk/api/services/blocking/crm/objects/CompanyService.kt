...
interface CompanyService {
     ...
     */
    fun create(params: CompanyCreateParams): CreatedResponseSimplePublicObject =
    ...
    interface WithRawResponse {
         ...
         * otherwise the same as [CompanyService.delete].
         */
        @MustBeClosed
         ...
         * the same as [CompanyService.merge].
         */
        @MustBeClosed
         ...
         * the same as [CompanyService.search].
         */
        @MustBeClosed
        fun search(
            params: CompanySearchParams
