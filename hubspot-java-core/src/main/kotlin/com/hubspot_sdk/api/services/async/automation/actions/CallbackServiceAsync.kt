...
interface CallbackServiceAsync {
    ...
    interface WithRawResponse {
         ...
         * /automation/v4/actions/callbacks/{callbackId}/complete`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `post /automation/v4/actions/callbacks/complete`, but is
         * otherwise the same as [CallbackServiceAsync.completeBatch].
         */
