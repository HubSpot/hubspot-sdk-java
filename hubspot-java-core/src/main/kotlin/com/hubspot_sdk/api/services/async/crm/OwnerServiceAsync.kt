...
interface OwnerServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/owners/`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/owners/{ownerId}`, but is otherwise the same
         * as [OwnerServiceAsync.get].
         */
