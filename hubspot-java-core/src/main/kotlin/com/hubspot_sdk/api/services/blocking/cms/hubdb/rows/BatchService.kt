...
interface BatchService {
    ...
    /** @see cloneBatch */
    fun cloneBatch(params: BatchCloneBatchParams): BatchResponseHubDbTableRowV3 =
    ...
    /** @see createBatch */
    fun createBatch(params: BatchCreateBatchParams): BatchResponseHubDbTableRowV3 =
     ...
     */
    fun getBatch(tableIdOrName: String, params: BatchGetBatchParams): BatchResponseHubDbTableRowV3 =
    ...
    /** @see getBatch */
    fun getBatch(params: BatchGetBatchParams): BatchResponseHubDbTableRowV3 =
    ...
    /** @see getDraftBatch */
    fun getDraftBatch(params: BatchGetDraftBatchParams): BatchResponseHubDbTableRowV3 =
     ...
     */
    fun purgeBatch(tableIdOrName: String, params: BatchPurgeBatchParams) =
    ...
    /** @see purgeBatch */
    fun purgeBatch(params: BatchPurgeBatchParams) = purgeBatch(params, RequestOptions.none())
    ...
    /** @see replaceBatch */
    fun replaceBatch(params: BatchReplaceBatchParams): BatchResponseHubDbTableRowV3 =
    ...
    /** @see updateBatch */
    fun updateBatch(params: BatchUpdateBatchParams): BatchResponseHubDbTableRowV3 =
    ...
    interface WithRawResponse {
        ...
        fun cloneBatch(
            params: BatchCloneBatchParams
        ): HttpResponseFor<BatchResponseHubDbTableRowV3> = cloneBatch(params, RequestOptions.none())
        ...
        /** @see getBatch */
        @MustBeClosed
        fun getBatch(params: BatchGetBatchParams): HttpResponseFor<BatchResponseHubDbTableRowV3> =
            getBatch(params, RequestOptions.none())
         ...
         * as [BatchService.purgeBatch].
         */
        @MustBeClosed
        fun purgeBatch(tableIdOrName: String, params: BatchPurgeBatchParams): HttpResponse =
            purgeBatch(tableIdOrName, params, RequestOptions.none())
        ...
        /** @see purgeBatch */
        @MustBeClosed
        fun purgeBatch(params: BatchPurgeBatchParams): HttpResponse =
