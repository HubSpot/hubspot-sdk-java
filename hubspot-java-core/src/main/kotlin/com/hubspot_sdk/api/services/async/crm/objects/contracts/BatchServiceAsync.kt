...
package com.hubspot_sdk.api.services.async.crm.objects.contracts
...
import com.hubspot_sdk.api.models.crm.objects.contracts.batch.BatchCreateParams
import com.hubspot_sdk.api.models.crm.objects.contracts.batch.BatchDeleteParams
import com.hubspot_sdk.api.models.crm.objects.contracts.batch.BatchGetParams
import com.hubspot_sdk.api.models.crm.objects.contracts.batch.BatchUpdateParams
import com.hubspot_sdk.api.models.crm.objects.contracts.batch.BatchUpsertParams
...
interface BatchServiceAsync {
    ...
    /**
     * Create multiple contracts in a single request by providing the necessary properties and
     * associations for each contract. This endpoint returns a batch response containing the details
     * of each created contract.
     */
    ...
    /**
     * Update multiple contracts by their internal IDs or unique property values. This endpoint
     * allows you to modify the properties of several contracts in a single request, streamlining
     * the update process for batch operations.
     */
    ...
    /**
     * Archive a batch of contracts by their IDs. This operation moves the specified contracts to
     * the archive, making them inactive but still retrievable if needed.
     */
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /crm/objects/2026-03/contracts/batch/create`, but
        ...
        /**
         * Returns a raw HTTP response for `post /crm/objects/2026-03/contracts/batch/update`, but
         * is otherwise the same as [BatchServiceAsync.update].
         */
        fun update(
            params: BatchUpdateParams
        ): CompletableFuture<HttpResponseFor<BatchResponseSimplePublicObject>> =
        ...
        /**
         * Returns a raw HTTP response for `post /crm/objects/2026-03/contracts/batch/archive`, but
        ...
        /**
         * Returns a raw HTTP response for `post /crm/objects/2026-03/contracts/batch/read`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/objects/2026-03/contracts/batch/upsert`, but
         * is otherwise the same as [BatchServiceAsync.upsert].
         */
        fun upsert(
            params: BatchUpsertParams
