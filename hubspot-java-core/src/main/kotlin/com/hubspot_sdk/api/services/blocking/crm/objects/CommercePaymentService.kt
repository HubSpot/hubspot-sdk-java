...
interface CommercePaymentService {
     ...
     * provided.
     */
    fun create(params: CommercePaymentCreateParams): CreatedResponseSimplePublicObject =
    ...
    interface WithRawResponse {
         ...
         * the same as [CommercePaymentService.list].
         */
        @MustBeClosed
         ...
         * otherwise the same as [CommercePaymentService.search].
         */
        @MustBeClosed
        fun search(
            params: CommercePaymentSearchParams
