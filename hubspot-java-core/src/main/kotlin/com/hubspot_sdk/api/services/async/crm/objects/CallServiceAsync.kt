...
import com.hubspot_sdk.api.models.crm.objects.calls.CallListPageAsync
...
import com.hubspot_sdk.api.services.async.crm.objects.calls.BatchServiceAsync
...
interface CallServiceAsync {
     ...
     */
    fun create(params: CallCreateParams): CompletableFuture<CreatedResponseSimplePublicObject> =
    ...
    interface WithRawResponse {
         ...
         * the same as [CallServiceAsync.delete].
         */
         ...
         * the same as [CallServiceAsync.get].
         */
        fun get(
            callId: String
         ...
         * same as [CallServiceAsync.search].
         */
        fun search(
            params: CallSearchParams
