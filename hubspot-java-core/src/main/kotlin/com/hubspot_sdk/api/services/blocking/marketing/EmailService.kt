...
import com.hubspot_sdk.api.services.blocking.marketing.emails.StatisticService
...
interface EmailService {
    ...
    fun statistics(): StatisticService
    ...
    fun get(emailId: String): PublicEmail = get(emailId, EmailGetParams.none())
    ...
    fun get(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): PublicEmail = get(params.toBuilder().emailId(emailId).build(), requestOptions)

    /** @see get */
    fun get(emailId: String, params: EmailGetParams = EmailGetParams.none()): PublicEmail =
    ...
    /** @see get */
    fun get(params: EmailGetParams): PublicEmail = get(params, RequestOptions.none())

    /** @see get */
    fun get(emailId: String, requestOptions: RequestOptions): PublicEmail =
    ...
    fun getRevision(revisionId: String, params: EmailGetRevisionParams): VersionPublicEmail =
    ...
    /** @see getRevision */
    fun getRevision(params: EmailGetRevisionParams): VersionPublicEmail =
    ...
    interface WithRawResponse {
         ...
         * the same as [EmailService.update].
         */
        @MustBeClosed
         ...
         * the same as [EmailService.delete].
         */
        @MustBeClosed
         ...
         * is otherwise the same as [EmailService.createAbTestVariation].
         */
        @MustBeClosed
        fun createAbTestVariation(
            params: EmailCreateAbTestVariationParams
         ...
         */
        @MustBeClosed
        fun get(emailId: String): HttpResponseFor<PublicEmail> = get(emailId, EmailGetParams.none())
        ...
        fun get(
            emailId: String,
            params: EmailGetParams = EmailGetParams.none(),
        ): HttpResponseFor<PublicEmail> = get(emailId, params, RequestOptions.none())
        ...
        /** @see get */
        @MustBeClosed
        fun get(params: EmailGetParams): HttpResponseFor<PublicEmail> =
            get(params, RequestOptions.none())

        /** @see get */
        @MustBeClosed
        fun get(emailId: String, requestOptions: RequestOptions): HttpResponseFor<PublicEmail> =
            get(emailId, EmailGetParams.none(), requestOptions)
        ...
        fun getRevision(
            revisionId: String,
            params: EmailGetRevisionParams,
        ): HttpResponseFor<VersionPublicEmail> =
            getRevision(revisionId, params, RequestOptions.none())
        ...
        /** @see getRevision */
        @MustBeClosed
        fun getRevision(params: EmailGetRevisionParams): HttpResponseFor<VersionPublicEmail> =
            getRevision(params, RequestOptions.none())
         ...
         * otherwise the same as [EmailService.publish].
         */
        @MustBeClosed
         ...
         * otherwise the same as [EmailService.resetDraft].
         */
        @MustBeClosed
         ...
         * as [EmailService.restoreRevision].
         */
        @MustBeClosed
         ...
         * the same as [EmailService.restoreRevisionToDraft].
         */
        @MustBeClosed
        fun restoreRevisionToDraft(
            revisionId: Long,
         ...
         * otherwise the same as [EmailService.unpublish].
         */
        @MustBeClosed
