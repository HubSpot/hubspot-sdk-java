...
interface LimitService {
    ...
    interface WithRawResponse {
         ...
         * otherwise the same as [LimitService.getAssociationRecordsLimitsFromObjects].
         */
        @MustBeClosed
        fun getAssociationRecordsLimitsFromObjects():
         ...
         * [LimitService.getAssociationRecordsLimitsToObjects].
         */
        @MustBeClosed
        fun getAssociationRecordsLimitsToObjects(
            fromObjectTypeId: String
         ...
         * the same as [LimitService.getCustomPropertyLimits].
         */
        @MustBeClosed
         ...
         * as [LimitService.getPipelineLimits].
         */
        @MustBeClosed
         ...
         * as [LimitService.getRecordLimits].
         */
        @MustBeClosed
