...
import com.hubspot_sdk.api.services.blocking.marketing.emails.StatisticServiceImpl
...
class EmailServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val statistics: StatisticService by lazy { StatisticServiceImpl(clientOptions) }
    ...
    override fun statistics(): StatisticService = statistics
    ...
    override fun get(params: EmailGetParams, requestOptions: RequestOptions): PublicEmail =
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val statistics: StatisticService.WithRawResponse by lazy {
            StatisticServiceImpl.WithRawResponseImpl(clientOptions)
        }
        ...
        override fun statistics(): StatisticService.WithRawResponse = statistics
