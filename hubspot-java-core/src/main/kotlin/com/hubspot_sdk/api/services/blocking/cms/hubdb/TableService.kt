...
interface TableService {
    ...
    interface WithRawResponse {
         ...
         * otherwise the same as [TableService.delete].
         */
        @MustBeClosed
         ...
         * but is otherwise the same as [TableService.cloneDraft].
         */
        @MustBeClosed
        fun cloneDraft(
            tableIdOrName: String,
         ...
         * otherwise the same as [TableService.export].
         */
        @MustBeClosed
        fun export(tableIdOrName: String): HttpResponse =
            export(tableIdOrName, TableExportParams.none())
         ...
         * but is otherwise the same as [TableService.exportDraft].
         */
        @MustBeClosed
        fun exportDraft(tableIdOrName: String): HttpResponse =
            exportDraft(tableIdOrName, TableExportDraftParams.none())
         ...
         * otherwise the same as [TableService.getDraft].
         */
        @MustBeClosed
         ...
         * but is otherwise the same as [TableService.importDraft].
         */
        @MustBeClosed
         ...
         * but is otherwise the same as [TableService.resetDraft].
         */
        @MustBeClosed
         ...
         * but is otherwise the same as [TableService.unpublish].
         */
        @MustBeClosed
         ...
         * is otherwise the same as [TableService.updateDraft].
         */
        @MustBeClosed
        fun updateDraft(
            tableIdOrName: String,
