...
interface BatchService {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/calls/batch/create`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/calls/batch/update`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/calls/batch/archive`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/calls/batch/read`, but is otherwise
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/calls/batch/upsert`, but is
