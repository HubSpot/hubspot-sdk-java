...
interface BatchService {
    ...
    interface WithRawResponse {
         ...
         * /crm/objects/2026-03/commerce_payments/batch/create`, but is otherwise the same as
         * [BatchService.create].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `post
         * /crm/objects/2026-03/commerce_payments/batch/update`, but is otherwise the same as
         * [BatchService.update].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `post
         * /crm/objects/2026-03/commerce_payments/batch/archive`, but is otherwise the same as
         * [BatchService.delete].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `post /crm/objects/2026-03/commerce_payments/batch/read`,
        ...
        /**
         * Returns a raw HTTP response for `post
         * /crm/objects/2026-03/commerce_payments/batch/upsert`, but is otherwise the same as
         * [BatchService.upsert].
         */
        @MustBeClosed
        fun upsert(
