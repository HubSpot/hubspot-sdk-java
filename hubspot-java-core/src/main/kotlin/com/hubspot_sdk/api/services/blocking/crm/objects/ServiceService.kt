...
interface ServiceService {
     ...
     */
    fun create(params: ServiceCreateParams): CreatedResponseSimplePublicObject =
    ...
    interface WithRawResponse {
         ...
         * the same as [ServiceService.get].
         */
        @MustBeClosed
