...
interface ABTestServiceAsync {
    ...
    ): CompletableFuture<CmsPage> = createLandingPageVariation(params, RequestOptions.none())
    ...
    ): CompletableFuture<CmsPage> = createSitePageVariation(params, RequestOptions.none())
