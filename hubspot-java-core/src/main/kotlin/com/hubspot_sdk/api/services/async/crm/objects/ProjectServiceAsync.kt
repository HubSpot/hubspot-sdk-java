...
interface ProjectServiceAsync {
     ...
     */
    fun create(params: ProjectCreateParams): CompletableFuture<CreatedResponseSimplePublicObject> =
    ...
    interface WithRawResponse {
         ...
         * the same as [ProjectServiceAsync.merge].
         */
        fun merge(
            params: ProjectMergeParams
        ): CompletableFuture<HttpResponseFor<SimplePublicObject>> =
         ...
         * the same as [ProjectServiceAsync.search].
         */
        fun search(
            params: ProjectSearchParams
