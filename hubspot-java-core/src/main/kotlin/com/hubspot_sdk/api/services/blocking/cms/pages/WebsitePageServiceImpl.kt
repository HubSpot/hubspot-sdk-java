...
class WebsitePageServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun create(params: WebsitePageCreateParams, requestOptions: RequestOptions): Page =
        // post /cms/pages/2026-03/site-pages
        withRawResponse().create(params, requestOptions).parse()

    override fun update(params: WebsitePageUpdateParams, requestOptions: RequestOptions): Page =
    ...
    override fun clone(params: WebsitePageCloneParams, requestOptions: RequestOptions): Page =
        // post /cms/pages/2026-03/site-pages/clone
        withRawResponse().clone(params, requestOptions).parse()

    override fun get(params: WebsitePageGetParams, requestOptions: RequestOptions): Page =
        // get /cms/pages/2026-03/site-pages/{objectId}
        withRawResponse().get(params, requestOptions).parse()

    override fun getDraft(params: WebsitePageGetDraftParams, requestOptions: RequestOptions): Page =
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val createHandler: Handler<Page> = jsonHandler<Page>(clientOptions.jsonMapper)
