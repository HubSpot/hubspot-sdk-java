...
interface EmailService {
     ...
     */
    fun create(params: EmailCreateParams): CreatedResponseSimplePublicObject =
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun create(params: EmailCreateParams): HttpResponseFor<CreatedResponseSimplePublicObject> =
            create(params, RequestOptions.none())
         ...
         * the same as [EmailService.search].
         */
        @MustBeClosed
        fun search(
            params: EmailSearchParams
