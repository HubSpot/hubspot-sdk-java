...
interface FileServiceAsync {
    ...
    interface WithRawResponse {
         ...
         * otherwise the same as [FileServiceAsync.gdprDelete].
         */
         ...
         * same as [FileServiceAsync.getByPath].
         */
         ...
         * as [FileServiceAsync.getImportTaskStatus].
         */
        fun getImportTaskStatus(
            taskId: String
