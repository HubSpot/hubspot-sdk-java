...
class MappingServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    MappingServiceAsync {

    private val withRawResponse: MappingServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): MappingServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): MappingServiceAsync =
        MappingServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    override fun batchCreateIdMapping(
        ...
        withRawResponse().batchCreateIdMapping(params, requestOptions).thenApply { it.parse() }
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            MappingServiceAsyncImpl.WithRawResponseImpl(
