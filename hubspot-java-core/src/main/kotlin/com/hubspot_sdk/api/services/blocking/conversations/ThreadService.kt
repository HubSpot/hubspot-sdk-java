...
interface ThreadService {
     ...
     * restored.
     */
    fun update(threadId: Long, params: ThreadUpdateParams): PublicThread =
     ...
     * archived state.
     */
    fun delete(threadId: Long) = delete(threadId, ThreadDeleteParams.none())
    ...
    /** @see delete */
    fun delete(threadId: Long, params: ThreadDeleteParams = ThreadDeleteParams.none()) =
    ...
    /** @see delete */
    fun delete(threadId: Long, requestOptions: RequestOptions) =
        delete(threadId, ThreadDeleteParams.none(), requestOptions)

    /** Retrieve a single thread by its ID */
    fun get(threadId: Long): PublicThread = get(threadId, ThreadGetParams.none())
    ...
    /** @see get */
    fun get(threadId: Long, params: ThreadGetParams = ThreadGetParams.none()): PublicThread =
    ...
    /** @see get */
    fun get(threadId: Long, requestOptions: RequestOptions): PublicThread =
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun update(threadId: Long, params: ThreadUpdateParams): HttpResponseFor<PublicThread> =
            update(threadId, params, RequestOptions.none())
         ...
         */
        @MustBeClosed
        fun delete(threadId: Long): HttpResponse = delete(threadId, ThreadDeleteParams.none())
        ...
        /** @see delete */
        @MustBeClosed
        fun delete(threadId: Long, requestOptions: RequestOptions): HttpResponse =
            delete(threadId, ThreadDeleteParams.none(), requestOptions)
         ...
         */
        @MustBeClosed
        fun get(threadId: Long): HttpResponseFor<PublicThread> =
        ...
        /** @see get */
        @MustBeClosed
        fun get(threadId: Long, requestOptions: RequestOptions): HttpResponseFor<PublicThread> =
            get(threadId, ThreadGetParams.none(), requestOptions)
    }
}
