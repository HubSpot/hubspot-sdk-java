...
interface BatchService {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/contracts/batch/create`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/contracts/batch/update`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/contracts/batch/archive`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/contracts/batch/read`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/contracts/batch/upsert`, but is
