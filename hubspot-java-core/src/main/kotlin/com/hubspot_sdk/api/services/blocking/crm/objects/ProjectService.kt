...
import com.hubspot_sdk.api.services.blocking.crm.objects.projects.AssociationService
...
interface ProjectService {
     ...
     */
    fun create(params: ProjectCreateParams): CreatedResponseSimplePublicObject =
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /crm/objects/v3/projects`, but is otherwise the
        ...
        /**
         * Returns a raw HTTP response for `patch /crm/objects/v3/projects/{projectId}`, but is
        ...
        /**
         * Returns a raw HTTP response for `get /crm/objects/v3/projects`, but is otherwise the same
        ...
        /**
         * Returns a raw HTTP response for `delete /crm/objects/v3/projects/{projectId}`, but is
        ...
        /**
         * Returns a raw HTTP response for `get /crm/objects/v3/projects/{projectId}`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/objects/v3/projects/merge`, but is otherwise
         * the same as [ProjectService.merge].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `post /crm/objects/v3/projects/search`, but is otherwise
         * the same as [ProjectService.search].
         */
        @MustBeClosed
        fun search(
            params: ProjectSearchParams
