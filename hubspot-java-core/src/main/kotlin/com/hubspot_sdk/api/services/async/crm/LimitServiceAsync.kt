...
interface LimitServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/limits/associations/labels`, but is
         ...
         * /crm/v3/limits/associations/records/{fromObjectTypeId}/{toObjectTypeId}`, but is
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/limits/associations/records/from`, but is
         * otherwise the same as [LimitServiceAsync.getAssociationRecordsLimitsFromObjects].
         */
        fun getAssociationRecordsLimitsFromObjects():
            CompletableFuture<
        ...
        /**
         * Returns a raw HTTP response for `get
         * /crm/v3/limits/associations/records/{fromObjectTypeId}/to`, but is otherwise the same as
         * [LimitServiceAsync.getAssociationRecordsLimitsToObjects].
         */
        fun getAssociationRecordsLimitsToObjects(
            fromObjectTypeId: String
        ): CompletableFuture<
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/limits/calculated-properties`, but is
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/limits/custom-object-types`, but is
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/limits/custom-properties`, but is otherwise
         * the same as [LimitServiceAsync.getCustomPropertyLimits].
         */
        fun getCustomPropertyLimits():
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/limits/pipelines`, but is otherwise the same
         * as [LimitServiceAsync.getPipelineLimits].
         */
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/limits/records`, but is otherwise the same
         * as [LimitServiceAsync.getRecordLimits].
         */
