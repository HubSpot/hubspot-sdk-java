...
package com.hubspot_sdk.api.services.blocking.crm.objects.fees
...
import com.hubspot_sdk.api.models.crm.objects.fees.batch.BatchCreateParams
import com.hubspot_sdk.api.models.crm.objects.fees.batch.BatchDeleteParams
import com.hubspot_sdk.api.models.crm.objects.fees.batch.BatchGetParams
import com.hubspot_sdk.api.models.crm.objects.fees.batch.BatchUpdateParams
import com.hubspot_sdk.api.models.crm.objects.fees.batch.BatchUpsertParams
...
interface BatchService {
    ...
    /**
     * Create multiple fees in a single request by providing a batch of fee objects with their
     * properties and associations. This operation returns a list of the created fee objects,
    ...
    /**
     * Update multiple fee records in a single request using their internal IDs or unique property
     * values. This operation allows you to modify the properties of several fees simultaneously,
     * streamlining the process of managing fee data in bulk.
     */
    ...
    /**
     * Create and update a batch of fees by a unique property. Fees that don't exist will be
     * created, while existing fees will be updated.
     */
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /crm/objects/2026-03/fees/batch/create`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/objects/2026-03/fees/batch/update`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/objects/2026-03/fees/batch/archive`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/objects/2026-03/fees/batch/read`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/objects/2026-03/fees/batch/upsert`, but is
