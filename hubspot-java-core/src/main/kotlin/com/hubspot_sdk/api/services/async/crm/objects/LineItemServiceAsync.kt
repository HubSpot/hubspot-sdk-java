...
interface LineItemServiceAsync {
     ...
     */
    fun create(params: LineItemCreateParams): CompletableFuture<CreatedResponseSimplePublicObject> =
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/line_items`, but is otherwise the
        ...
        /**
         * Returns a raw HTTP response for `patch /crm/v3/objects/line_items/{lineItemId}`, but is
         * otherwise the same as [LineItemServiceAsync.update].
         */
        fun update(
            lineItemId: String,
            params: LineItemUpdateParams,
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/objects/line_items`, but is otherwise the
        ...
        /**
         * Returns a raw HTTP response for `delete /crm/v3/objects/line_items/{lineItemId}`, but is
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/objects/line_items/{lineItemId}`, but is
         * otherwise the same as [LineItemServiceAsync.get].
         */
        fun get(
            lineItemId: String
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/line_items/search`, but is
