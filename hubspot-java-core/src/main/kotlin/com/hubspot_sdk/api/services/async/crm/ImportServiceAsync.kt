...
interface ImportServiceAsync {
    ...
    /**
     * Begins importing data from the specified file resources. This uploads the corresponding file
     * and uses the import request object to convert rows in the files to objects.
     */
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/imports/`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/imports/`, but is otherwise the same as
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/imports/{importId}/cancel`, but is
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/imports/{importId}`, but is otherwise the
         * same as [ImportServiceAsync.get].
         */
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/imports/{importId}/errors`, but is otherwise
         * the same as [ImportServiceAsync.listErrors].
         */
        fun listErrors(
            importId: Long
