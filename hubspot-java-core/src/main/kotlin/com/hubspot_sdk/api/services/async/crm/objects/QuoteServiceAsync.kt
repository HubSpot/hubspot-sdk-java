...
interface QuoteServiceAsync {
     ...
     */
    fun create(params: QuoteCreateParams): CompletableFuture<CreatedResponseSimplePublicObject> =
    ...
    interface WithRawResponse {
         ...
         * the same as [QuoteServiceAsync.get].
         */
        fun get(
            quoteId: String
         ...
         * the same as [QuoteServiceAsync.search].
         */
        fun search(
            params: QuoteSearchParams
