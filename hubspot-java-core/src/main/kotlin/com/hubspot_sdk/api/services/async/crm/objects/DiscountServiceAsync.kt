...
interface DiscountServiceAsync {
     ...
     */
    fun create(params: DiscountCreateParams): CompletableFuture<CreatedResponseSimplePublicObject> =
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/discounts`, but is otherwise the
         * same as [DiscountServiceAsync.create].
         */
        fun create(
            params: DiscountCreateParams
        ...
        /**
         * Returns a raw HTTP response for `patch /crm/v3/objects/discounts/{discountId}`, but is
         * otherwise the same as [DiscountServiceAsync.update].
         */
        fun update(
            discountId: String,
            params: DiscountUpdateParams,
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/objects/discounts`, but is otherwise the
         * same as [DiscountServiceAsync.list].
         */
        ...
        /**
         * Returns a raw HTTP response for `delete /crm/v3/objects/discounts/{discountId}`, but is
         * otherwise the same as [DiscountServiceAsync.delete].
         */
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/objects/discounts/{discountId}`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/discounts/search`, but is otherwise
         * the same as [DiscountServiceAsync.search].
         */
        fun search(
            params: DiscountSearchParams
