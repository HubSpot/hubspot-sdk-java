...
interface BatchService {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/0-410/batch/create`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/0-410/batch/update`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/0-410/batch/archive`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/0-410/batch/read`, but is otherwise
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/0-410/batch/upsert`, but is
