...
interface FolderService {
    ...
    /** Creates a folder. */
    fun create(params: FolderCreateParams): Folder = create(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun create(params: FolderCreateParams): HttpResponseFor<Folder> =
         ...
         * the same as [FolderService.deleteById].
         */
        @MustBeClosed
         ...
         * the same as [FolderService.deleteByPath].
         */
        @MustBeClosed
         ...
         * the same as [FolderService.getByPath].
         */
        @MustBeClosed
         ...
         * the same as [FolderService.updateAsyncById].
         */
        @MustBeClosed
        fun updateAsyncById(
            params: FolderUpdateAsyncByIdParams
         ...
         * the same as [FolderService.updateById].
         */
        @MustBeClosed
