...
interface OrderService {
     ...
     */
    fun create(params: OrderCreateParams): CreatedResponseSimplePublicObject =
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun create(params: OrderCreateParams): HttpResponseFor<CreatedResponseSimplePublicObject> =
            create(params, RequestOptions.none())
         ...
         * the same as [OrderService.search].
         */
        @MustBeClosed
        fun search(
            params: OrderSearchParams
