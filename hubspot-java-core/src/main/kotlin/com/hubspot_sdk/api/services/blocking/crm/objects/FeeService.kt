...
interface FeeService {
     ...
     */
    fun create(params: FeeCreateParams): CreatedResponseSimplePublicObject =
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/fees`, but is otherwise the same as
         * [FeeService.create].
         */
        @MustBeClosed
        fun create(params: FeeCreateParams): HttpResponseFor<CreatedResponseSimplePublicObject> =
            create(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `patch /crm/v3/objects/fees/{feeId}`, but is otherwise
         * the same as [FeeService.update].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/objects/fees`, but is otherwise the same as
         * [FeeService.list].
         */
        ...
        /**
         * Returns a raw HTTP response for `delete /crm/v3/objects/fees/{feeId}`, but is otherwise
         * the same as [FeeService.delete].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/objects/fees/{feeId}`, but is otherwise the
         * same as [FeeService.get].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/fees/search`, but is otherwise the
         * same as [FeeService.search].
         */
        @MustBeClosed
        fun search(
            params: FeeSearchParams
