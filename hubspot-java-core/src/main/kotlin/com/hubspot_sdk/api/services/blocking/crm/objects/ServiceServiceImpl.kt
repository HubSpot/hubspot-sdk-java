...
import com.hubspot_sdk.api.services.blocking.crm.objects.services.BatchServiceImpl
...
class ServiceServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun list(params: ServiceListParams, requestOptions: RequestOptions): ServiceListPage =
        // get /crm/v3/objects/0-162
        withRawResponse().list(params, requestOptions).parse()

    override fun delete(params: ServiceDeleteParams, requestOptions: RequestOptions) {
        ...
        override fun create(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("crm", "v3", "objects", "0-162")
        ...
        override fun update(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("crm", "v3", "objects", "0-162", params._pathParam(0))
                    .body(json(clientOptions.jsonMapper, params._body()))
                    .build()
                    .prepare(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
        ...
        override fun list(
            ...
            return errorHandler.handle(response).parseable {
                response
                    ...
                    .let {
                        ServiceListPage.builder()
                            .service(ServiceServiceImpl(clientOptions))
                            .params(params)
                            .response(it)
                            .build()
                    }
        ...
        override fun search(
            ...
            val request =
                HttpRequest.builder()
                    .method(HttpMethod.POST)
                    .baseUrl(clientOptions.baseUrl())
                    .addPathSegments("crm", "v3", "objects", "0-162", "search")
                    .body(json(clientOptions.jsonMapper, params._body()))
                    .build()
                    .prepare(clientOptions, params)
            val requestOptions = requestOptions.applyDefaults(RequestOptions.from(clientOptions))
