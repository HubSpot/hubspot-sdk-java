...
import com.hubspot_sdk.api.models.files.fileassets.FileAssetCreateParams
import com.hubspot_sdk.api.models.files.fileassets.FileAssetDeleteParams
import com.hubspot_sdk.api.models.files.fileassets.FileAssetGdprDeleteParams
import com.hubspot_sdk.api.models.files.fileassets.FileAssetGetByPathParams
import com.hubspot_sdk.api.models.files.fileassets.FileAssetGetImportTaskStatusParams
...
import com.hubspot_sdk.api.models.files.fileassets.FileAssetImportFromUrlAsyncParams
import com.hubspot_sdk.api.models.files.fileassets.FileAssetReplaceParams
import com.hubspot_sdk.api.models.files.fileassets.FileAssetSearchPageAsync
import com.hubspot_sdk.api.models.files.fileassets.FileAssetSearchParams
...
class FileAssetServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    FileAssetServiceAsync {

    private val withRawResponse: FileAssetServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): FileAssetServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): FileAssetServiceAsync =
        FileAssetServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            FileAssetServiceAsyncImpl.WithRawResponseImpl(
                ...
                .thenApply { response ->
                    errorHandler.handle(response).parseable {
                        response
                            ...
                            .let {
                                FileAssetSearchPageAsync.builder()
                                    .service(FileAssetServiceAsyncImpl(clientOptions))
