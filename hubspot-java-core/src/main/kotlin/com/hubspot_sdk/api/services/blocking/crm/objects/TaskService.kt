...
import com.hubspot_sdk.api.models.crm.objects.tasks.TaskListPage
...
interface TaskService {
     ...
     */
    fun create(params: TaskCreateParams): CreatedResponseSimplePublicObject =
    ...
    interface WithRawResponse {
         ...
         * as [TaskService.create].
         */
        @MustBeClosed
        fun create(params: TaskCreateParams): HttpResponseFor<CreatedResponseSimplePublicObject> =
            create(params, RequestOptions.none())
         ...
         * the same as [TaskService.update].
         */
        @MustBeClosed
         ...
         * the same as [TaskService.delete].
         */
        @MustBeClosed
