...
interface ProductServiceAsync {
     ...
     */
    fun create(params: ProductCreateParams): CompletableFuture<CreatedResponseSimplePublicObject> =
    ...
    interface WithRawResponse {
         ...
         * same as [ProductServiceAsync.create].
         */
        fun create(
            params: ProductCreateParams
         ...
         * the same as [ProductServiceAsync.search].
         */
        fun search(
            params: ProductSearchParams
