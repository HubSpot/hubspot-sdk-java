...
class FileOperationServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    FileOperationServiceAsync {

    private val withRawResponse: FileOperationServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): FileOperationServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): FileOperationServiceAsync =
        FileOperationServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            FileOperationServiceAsyncImpl.WithRawResponseImpl(
                ...
                .thenApply { response ->
                    errorHandler.handle(response).parseable {
                        response
                            ...
                            .let {
                                FileOperationSearchPageAsync.builder()
                                    .service(FileOperationServiceAsyncImpl(clientOptions))
