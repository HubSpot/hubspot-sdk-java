...
interface BatchService {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/emails/batch/create`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/emails/batch/update`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/emails/batch/archive`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/emails/batch/read`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/emails/batch/upsert`, but is
