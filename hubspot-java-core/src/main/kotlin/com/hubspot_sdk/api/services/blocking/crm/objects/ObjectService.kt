...
interface ObjectService {
     ...
     */
    fun create(objectType: String, params: ObjectCreateParams): SimplePublicObject =
    ...
    /** @see create */
    fun create(params: ObjectCreateParams): SimplePublicObject =
    ...
    interface WithRawResponse {
         ...
         * otherwise the same as [ObjectService.create].
         */
        @MustBeClosed
        fun create(
            objectType: String,
        ...
        /** @see create */
        @MustBeClosed
        fun create(params: ObjectCreateParams): HttpResponseFor<SimplePublicObject> =
            create(params, RequestOptions.none())
         ...
         * is otherwise the same as [ObjectService.update].
         */
        @MustBeClosed
        fun update(
            objectId: String,
