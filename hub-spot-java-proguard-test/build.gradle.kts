...
dependencies {
    testImplementation(project(":hub-spot-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../hub-spot-java-core/src/main/resources/META-INF/proguard/hub-spot-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.hubspot_sdk.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../hub-spot-java-core/src/main/resources/META-INF/proguard/hub-spot-java-core.pro",
