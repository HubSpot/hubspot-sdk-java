...
dependencies {
    testImplementation(project(":hubspot-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../hubspot-java-core/src/main/resources/META-INF/proguard/hubspot-java-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../hubspot-java-core/src/main/resources/META-INF/proguard/hubspot-java-core.pro",
