...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(stringTargetPropertyVariable: StringTargetPropertyVariable) = apply {
            ...
            inputs = stringTargetPropertyVariable.inputs.map { it.toMutableList() }
    ...
    override fun toString() =
        "StringTargetPropertyVariable{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
