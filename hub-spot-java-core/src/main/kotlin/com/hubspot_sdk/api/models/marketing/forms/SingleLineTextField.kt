...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SingleLineTextField].
         *
    ...
    /** A builder for [SingleLineTextField]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(singleLineTextField: SingleLineTextField) = apply {
            dependentFields = singleLineTextField.dependentFields.map { it.toMutableList() }
            fieldType = singleLineTextField.fieldType
            hidden = singleLineTextField.hidden
            label = singleLineTextField.label
            name = singleLineTextField.name
            objectTypeId = singleLineTextField.objectTypeId
            required = singleLineTextField.required
            defaultValue = singleLineTextField.defaultValue
            description = singleLineTextField.description
            placeholder = singleLineTextField.placeholder
            additionalProperties = singleLineTextField.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SingleLineTextField].
         *
    ...
    fun validate(): SingleLineTextField = apply {
        if (validated) {
            return@apply
        }
    ...
    class FieldType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val SINGLE_LINE_TEXT = of("single_line_text")
        ...
        fun known(): Known =
            when (this) {
                SINGLE_LINE_TEXT -> Known.SINGLE_LINE_TEXT
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SingleLineTextField &&
    ...
    override fun toString() =
        "SingleLineTextField{dependentFields=$dependentFields, fieldType=$fieldType, hidden=$hidden, label=$label, name=$name, objectTypeId=$objectTypeId, required=$required, defaultValue=$defaultValue, description=$description, placeholder=$placeholder, additionalProperties=$additionalProperties}"
}
