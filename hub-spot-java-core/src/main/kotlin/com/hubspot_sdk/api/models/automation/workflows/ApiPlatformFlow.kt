...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ApiPlatformFlow].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(apiPlatformFlow: ApiPlatformFlow) = apply {
            id = apiPlatformFlow.id
            actions = apiPlatformFlow.actions.map { it.toMutableList() }
            blockedDates = apiPlatformFlow.blockedDates.map { it.toMutableList() }
            createdAt = apiPlatformFlow.createdAt
            crmObjectCreationStatus = apiPlatformFlow.crmObjectCreationStatus
            customProperties = apiPlatformFlow.customProperties
            dataSources = apiPlatformFlow.dataSources.map { it.toMutableList() }
            flowType = apiPlatformFlow.flowType
            isEnabled = apiPlatformFlow.isEnabled
            nextAvailableActionId = apiPlatformFlow.nextAvailableActionId
            objectTypeId = apiPlatformFlow.objectTypeId
            revisionId = apiPlatformFlow.revisionId
            timeWindows = apiPlatformFlow.timeWindows.map { it.toMutableList() }
            type = apiPlatformFlow.type
            updatedAt = apiPlatformFlow.updatedAt
            description = apiPlatformFlow.description
            enrollmentCriteria = apiPlatformFlow.enrollmentCriteria
            enrollmentSchedule = apiPlatformFlow.enrollmentSchedule
            name = apiPlatformFlow.name
            startActionId = apiPlatformFlow.startActionId
            suppressionFilterBranch = apiPlatformFlow.suppressionFilterBranch
            uuid = apiPlatformFlow.uuid
            additionalProperties = apiPlatformFlow.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ApiPlatformFlow].
         *
    ...
    fun validate(): ApiPlatformFlow = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ApiPlatformFlow &&
            id == other.id &&
    ...
    override fun toString() =
        "ApiPlatformFlow{id=$id, actions=$actions, blockedDates=$blockedDates, createdAt=$createdAt, crmObjectCreationStatus=$crmObjectCreationStatus, customProperties=$customProperties, dataSources=$dataSources, flowType=$flowType, isEnabled=$isEnabled, nextAvailableActionId=$nextAvailableActionId, objectTypeId=$objectTypeId, revisionId=$revisionId, timeWindows=$timeWindows, type=$type, updatedAt=$updatedAt, description=$description, enrollmentCriteria=$enrollmentCriteria, enrollmentSchedule=$enrollmentSchedule, name=$name, startActionId=$startActionId, suppressionFilterBranch=$suppressionFilterBranch, uuid=$uuid, additionalProperties=$additionalProperties}"
}
