...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of appointments that
    ...
    companion object {
        ...
        @JvmStatic fun none(): AppointmentListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AppointmentListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AppointmentListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(appointmentListParams: AppointmentListParams) = apply {
            after = appointmentListParams.after
            archived = appointmentListParams.archived
            associations = appointmentListParams.associations?.toMutableList()
            limit = appointmentListParams.limit
            properties = appointmentListParams.properties?.toMutableList()
            propertiesWithHistory = appointmentListParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = appointmentListParams.additionalHeaders.toBuilder()
            additionalQueryParams = appointmentListParams.additionalQueryParams.toBuilder()
        }
         ...
         * of appointments that can be read by a single request.
         */
        ...
        /**
         * Returns an immutable instance of [AppointmentListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AppointmentListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AppointmentListParams &&
            after == other.after &&
    ...
    override fun toString() =
        "AppointmentListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
