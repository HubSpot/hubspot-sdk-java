...
private constructor(
    private val allowMultipleFiles: JsonField<Boolean>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        allowMultipleFiles: JsonField<Boolean> = JsonMissing.of(),
     ...
     */
    fun allowMultipleFiles(): Boolean = allowMultipleFiles.getRequired("allowMultipleFiles")
    ...
    /**
     * Returns the raw JSON value of [allowMultipleFiles].
     *
     * Unlike [allowMultipleFiles], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("allowMultipleFiles")
    @ExcludeMissing
    fun _allowMultipleFiles(): JsonField<Boolean> = allowMultipleFiles
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FileField].
         *
    ...
    /** A builder for [FileField]. */
    class Builder internal constructor() {

        private var allowMultipleFiles: JsonField<Boolean>? = null
        ...
        @JvmSynthetic
        internal fun from(fileField: FileField) = apply {
            allowMultipleFiles = fileField.allowMultipleFiles
            dependentFields = fileField.dependentFields.map { it.toMutableList() }
            fieldType = fileField.fieldType
            hidden = fileField.hidden
            label = fileField.label
            name = fileField.name
            objectTypeId = fileField.objectTypeId
            required = fileField.required
            defaultValue = fileField.defaultValue
            description = fileField.description
            placeholder = fileField.placeholder
            additionalProperties = fileField.additionalProperties.toMutableMap()
        }

        /** Whether to allow the upload of multiple files. */
        fun allowMultipleFiles(allowMultipleFiles: Boolean) =
            allowMultipleFiles(JsonField.of(allowMultipleFiles))

        /**
         * Sets [Builder.allowMultipleFiles] to an arbitrary JSON value.
         *
         * You should usually call [Builder.allowMultipleFiles] with a well-typed [Boolean] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun allowMultipleFiles(allowMultipleFiles: JsonField<Boolean>) = apply {
        ...
        /**
         * Returns an immutable instance of [FileField].
         *
        ...
        fun build(): FileField =
            FileField(
                checkRequired("allowMultipleFiles", allowMultipleFiles),
    ...
    internal fun validity(): Int =
        (if (allowMultipleFiles.asKnown().isPresent) 1 else 0) +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FileField &&
            allowMultipleFiles == other.allowMultipleFiles &&
    ...
    override fun toString() =
        "FileField{allowMultipleFiles=$allowMultipleFiles, dependentFields=$dependentFields, fieldType=$fieldType, hidden=$hidden, label=$label, name=$name, objectTypeId=$objectTypeId, required=$required, defaultValue=$defaultValue, description=$description, placeholder=$placeholder, additionalProperties=$additionalProperties}"
}
