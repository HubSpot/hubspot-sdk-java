...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): LandingPageGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [LandingPageGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LandingPageGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(landingPageGetParams: LandingPageGetParams) = apply {
            objectId = landingPageGetParams.objectId
            archived = landingPageGetParams.archived
            property = landingPageGetParams.property
            additionalHeaders = landingPageGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = landingPageGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LandingPageGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LandingPageGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LandingPageGetParams &&
    ...
    override fun toString() =
        "LandingPageGetParams{objectId=$objectId, archived=$archived, property=$property, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
