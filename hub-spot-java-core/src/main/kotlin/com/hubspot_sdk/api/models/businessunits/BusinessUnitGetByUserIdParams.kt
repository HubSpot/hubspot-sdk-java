...
private constructor(
    ...
    /**
     * The names of Business Units to retrieve. If empty or not provided, then all associated
     * Business Units will be returned.
     */
    fun name(): Optional<List<String>> = Optional.ofNullable(name)

    /**
     * The names of properties to optionally include in the response body. The only valid value is
     * `logoMetadata`.
     */
    ...
    class Builder internal constructor() {
        ...
        /**
         * The names of properties to optionally include in the response body. The only valid value
         * is `logoMetadata`.
         */
