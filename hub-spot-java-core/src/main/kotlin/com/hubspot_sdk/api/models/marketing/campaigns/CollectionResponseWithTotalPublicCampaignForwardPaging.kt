...
class CollectionResponseWithTotalPublicCampaignForwardPaging
...
private constructor(
    ...
    /** A builder for [CollectionResponseWithTotalPublicCampaignForwardPaging]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            results =
                collectionResponseWithTotalPublicCampaignForwardPaging.results.map {
                    it.toMutableList()
                }
            total = collectionResponseWithTotalPublicCampaignForwardPaging.total
            paging = collectionResponseWithTotalPublicCampaignForwardPaging.paging
            additionalProperties =
                collectionResponseWithTotalPublicCampaignForwardPaging.additionalProperties
                    .toMutableMap()
        }
         ...
         */
        fun build(): CollectionResponseWithTotalPublicCampaignForwardPaging =
            CollectionResponseWithTotalPublicCampaignForwardPaging(
    ...
    fun validate(): CollectionResponseWithTotalPublicCampaignForwardPaging = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionResponseWithTotalPublicCampaignForwardPaging &&
    ...
    override fun toString() =
        "CollectionResponseWithTotalPublicCampaignForwardPaging{results=$results, total=$total, paging=$paging, additionalProperties=$additionalProperties}"
}
