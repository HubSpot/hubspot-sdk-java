...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MultiLineTextField].
         *
    ...
    /** A builder for [MultiLineTextField]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(multiLineTextField: MultiLineTextField) = apply {
            dependentFields = multiLineTextField.dependentFields.map { it.toMutableList() }
            fieldType = multiLineTextField.fieldType
            hidden = multiLineTextField.hidden
            label = multiLineTextField.label
            name = multiLineTextField.name
            objectTypeId = multiLineTextField.objectTypeId
            required = multiLineTextField.required
            defaultValue = multiLineTextField.defaultValue
            description = multiLineTextField.description
            placeholder = multiLineTextField.placeholder
            additionalProperties = multiLineTextField.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MultiLineTextField].
         *
    ...
    fun validate(): MultiLineTextField = apply {
        if (validated) {
            return@apply
        }
    ...
    class FieldType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val MULTI_LINE_TEXT = of("multi_line_text")
        ...
        fun known(): Known =
            when (this) {
                MULTI_LINE_TEXT -> Known.MULTI_LINE_TEXT
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MultiLineTextField &&
    ...
    override fun toString() =
        "MultiLineTextField{dependentFields=$dependentFields, fieldType=$fieldType, hidden=$hidden, label=$label, name=$name, objectTypeId=$objectTypeId, required=$required, defaultValue=$defaultValue, description=$description, placeholder=$placeholder, additionalProperties=$additionalProperties}"
}
