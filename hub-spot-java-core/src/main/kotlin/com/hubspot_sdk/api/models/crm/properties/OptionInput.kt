...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OptionInput].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(optionInput: OptionInput) = apply {
            hidden = optionInput.hidden
            label = optionInput.label
            value = optionInput.value
            description = optionInput.description
            displayOrder = optionInput.displayOrder
            additionalProperties = optionInput.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OptionInput].
         *
    ...
    fun validate(): OptionInput = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "OptionInput{hidden=$hidden, label=$label, value=$value, description=$description, displayOrder=$displayOrder, additionalProperties=$additionalProperties}"
}
