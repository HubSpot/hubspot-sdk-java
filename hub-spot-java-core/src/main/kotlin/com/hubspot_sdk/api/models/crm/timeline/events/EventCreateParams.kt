...
private constructor(
    ...
    fun timelineEvent(): TimelineEvent = timelineEvent

    fun _additionalBodyProperties(): Map<String, JsonValue> = timelineEvent._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        private var timelineEvent: TimelineEvent? = null
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        @JvmSynthetic
        internal fun from(eventCreateParams: EventCreateParams) = apply {
            timelineEvent = eventCreateParams.timelineEvent
        ...
        /** The state of the timeline event. */
        fun timelineEvent(timelineEvent: TimelineEvent) = apply {
        ...
        fun build(): EventCreateParams =
            EventCreateParams(
                checkRequired("timelineEvent", timelineEvent),
                additionalHeaders.build(),
                additionalQueryParams.build(),
            )
    }

    fun _body(): TimelineEvent = timelineEvent
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EventCreateParams &&
            timelineEvent == other.timelineEvent &&
            additionalHeaders == other.additionalHeaders &&
            additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int =
        Objects.hash(timelineEvent, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "EventCreateParams{timelineEvent=$timelineEvent, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
