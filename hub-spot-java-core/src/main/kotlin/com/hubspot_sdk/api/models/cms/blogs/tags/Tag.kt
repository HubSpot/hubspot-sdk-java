...
private constructor(
    ...
    ) : this(id, created, deletedAt, language, name, translatedFromId, updated, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(tag: Tag) = apply {
            ...
            name = tag.name
            translatedFromId = tag.translatedFromId
            updated = tag.updated
    ...
    override fun toString() =
        "Tag{id=$id, created=$created, deletedAt=$deletedAt, language=$language, name=$name, translatedFromId=$translatedFromId, updated=$updated, additionalProperties=$additionalProperties}"
}
