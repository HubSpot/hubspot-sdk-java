...
/**
 * Update the filter branch definition of a `DYNAMIC` list. Once updated, the list memberships will
 * be re-evaluated and updated to match the new definition.
 */
class ListUpdateFiltersParams
private constructor(
    ...
    /**
     * A flag indicating whether or not the memberships added to the list as a result of the filter
     * change should be enrolled in workflows that are relevant to this list.
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ListUpdateFiltersParams].
         *
    ...
    /** A builder for [ListUpdateFiltersParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(listUpdateFiltersParams: ListUpdateFiltersParams) = apply {
            listId = listUpdateFiltersParams.listId
            enrollObjectsInWorkflows = listUpdateFiltersParams.enrollObjectsInWorkflows
            listFilterUpdateRequest = listUpdateFiltersParams.listFilterUpdateRequest
            additionalHeaders = listUpdateFiltersParams.additionalHeaders.toBuilder()
            additionalQueryParams = listUpdateFiltersParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * A flag indicating whether or not the memberships added to the list as a result of the
         * filter change should be enrolled in workflows that are relevant to this list.
         */
        ...
        /**
         * Returns an immutable instance of [ListUpdateFiltersParams].
         *
         ...
         */
        fun build(): ListUpdateFiltersParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ListUpdateFiltersParams &&
            listId == other.listId &&
    ...
    override fun toString() =
        "ListUpdateFiltersParams{listId=$listId, enrollObjectsInWorkflows=$enrollObjectsInWorkflows, listFilterUpdateRequest=$listFilterUpdateRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
