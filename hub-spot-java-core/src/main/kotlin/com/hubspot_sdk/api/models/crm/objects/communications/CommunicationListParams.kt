...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of communications
    ...
    companion object {
        ...
        @JvmStatic fun none(): CommunicationListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [CommunicationListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CommunicationListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(communicationListParams: CommunicationListParams) = apply {
            after = communicationListParams.after
            archived = communicationListParams.archived
            associations = communicationListParams.associations?.toMutableList()
            limit = communicationListParams.limit
            properties = communicationListParams.properties?.toMutableList()
            propertiesWithHistory = communicationListParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = communicationListParams.additionalHeaders.toBuilder()
            additionalQueryParams = communicationListParams.additionalQueryParams.toBuilder()
        }
         ...
         * of communications that can be read by a single request.
         */
        ...
        /**
         * Returns an immutable instance of [CommunicationListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CommunicationListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CommunicationListParams &&
            after == other.after &&
    ...
    override fun toString() =
        "CommunicationListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
