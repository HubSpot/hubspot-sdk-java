...
/**
 * Returns all Marketing Events available on the portal, along with their properties, regardless of
 * whether they were created manually or through the application.
 *
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): EventListParams =
            EventListParams(after, limit, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "EventListParams{after=$after, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
