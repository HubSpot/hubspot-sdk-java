...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PhoneFieldValidation].
         *
    ...
    /** A builder for [PhoneFieldValidation]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(phoneFieldValidation: PhoneFieldValidation) = apply {
            maxAllowedDigits = phoneFieldValidation.maxAllowedDigits
            minAllowedDigits = phoneFieldValidation.minAllowedDigits
            additionalProperties = phoneFieldValidation.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PhoneFieldValidation].
         *
         ...
         */
        fun build(): PhoneFieldValidation =
    ...
    fun validate(): PhoneFieldValidation = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PhoneFieldValidation &&
    ...
    override fun toString() =
        "PhoneFieldValidation{maxAllowedDigits=$maxAllowedDigits, minAllowedDigits=$minAllowedDigits, additionalProperties=$additionalProperties}"
}
