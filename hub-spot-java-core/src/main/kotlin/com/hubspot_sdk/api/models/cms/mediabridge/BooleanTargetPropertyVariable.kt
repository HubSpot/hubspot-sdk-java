...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(booleanTargetPropertyVariable: BooleanTargetPropertyVariable) = apply {
            ...
            inputs = booleanTargetPropertyVariable.inputs.map { it.toMutableList() }
    ...
    override fun toString() =
        "BooleanTargetPropertyVariable{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
