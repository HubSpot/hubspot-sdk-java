...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RadioField].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(radioField: RadioField) = apply {
            defaultValues = radioField.defaultValues.map { it.toMutableList() }
            dependentFields = radioField.dependentFields.map { it.toMutableList() }
            fieldType = radioField.fieldType
            hidden = radioField.hidden
            label = radioField.label
            name = radioField.name
            objectTypeId = radioField.objectTypeId
            options = radioField.options.map { it.toMutableList() }
            required = radioField.required
            description = radioField.description
            placeholder = radioField.placeholder
            additionalProperties = radioField.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RadioField].
         *
    ...
    override fun toString() =
        "RadioField{defaultValues=$defaultValues, dependentFields=$dependentFields, fieldType=$fieldType, hidden=$hidden, label=$label, name=$name, objectTypeId=$objectTypeId, options=$options, required=$required, description=$description, placeholder=$placeholder, additionalProperties=$additionalProperties}"
}
