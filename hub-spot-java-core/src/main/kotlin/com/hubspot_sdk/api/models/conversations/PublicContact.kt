...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicContact].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicContact: PublicContact) = apply {
            contactProfile = publicContact.contactProfile
            type = publicContact.type
            additionalProperties = publicContact.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicContact].
         *
    ...
    fun validate(): PublicContact = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "PublicContact{contactProfile=$contactProfile, type=$type, additionalProperties=$additionalProperties}"
}
