...
private constructor(
    ...
    private val validation: JsonField<NumberFieldValidation>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        validation: JsonField<NumberFieldValidation> = JsonMissing.of(),
    ) : this(
        dependentFields,
        fieldType,
        hidden,
     ...
     *   server responded with an unexpected value).
     */
    fun validation(): Optional<NumberFieldValidation> = validation.getOptional("validation")
    ...
    @JsonProperty("validation")
    @ExcludeMissing
    fun _validation(): JsonField<NumberFieldValidation> = validation
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NumberField].
         *
    ...
    class Builder internal constructor() {
        ...
        private var validation: JsonField<NumberFieldValidation> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(numberField: NumberField) = apply {
            dependentFields = numberField.dependentFields.map { it.toMutableList() }
            fieldType = numberField.fieldType
            hidden = numberField.hidden
            label = numberField.label
            name = numberField.name
            objectTypeId = numberField.objectTypeId
            ...
            additionalProperties = numberField.additionalProperties.toMutableMap()
        }
        ...
        /** Describes how a numeric value should be validated. */
        fun validation(validation: NumberFieldValidation) = validation(JsonField.of(validation))

        /**
         * Sets [Builder.validation] to an arbitrary JSON value.
         *
         * You should usually call [Builder.validation] with a well-typed [NumberFieldValidation]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun validation(validation: JsonField<NumberFieldValidation>) = apply {
        ...
        /**
         * Returns an immutable instance of [NumberField].
         *
    ...
    fun validate(): NumberField = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "NumberField{dependentFields=$dependentFields, fieldType=$fieldType, hidden=$hidden, label=$label, name=$name, objectTypeId=$objectTypeId, required=$required, defaultValue=$defaultValue, description=$description, placeholder=$placeholder, validation=$validation, additionalProperties=$additionalProperties}"
}
