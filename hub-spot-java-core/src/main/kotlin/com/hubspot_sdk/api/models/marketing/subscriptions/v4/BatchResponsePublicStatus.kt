...
class BatchResponsePublicStatus
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchResponsePublicStatus].
         *
    ...
    /** A builder for [BatchResponsePublicStatus]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchResponsePublicStatus: BatchResponsePublicStatus) = apply {
            completedAt = batchResponsePublicStatus.completedAt
            results = batchResponsePublicStatus.results.map { it.toMutableList() }
            startedAt = batchResponsePublicStatus.startedAt
            status = batchResponsePublicStatus.status
            errors = batchResponsePublicStatus.errors.map { it.toMutableList() }
            links = batchResponsePublicStatus.links
            numErrors = batchResponsePublicStatus.numErrors
            requestedAt = batchResponsePublicStatus.requestedAt
            additionalProperties = batchResponsePublicStatus.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BatchResponsePublicStatus].
         *
         ...
         */
        fun build(): BatchResponsePublicStatus =
    ...
    fun validate(): BatchResponsePublicStatus = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponsePublicStatus &&
    ...
    override fun toString() =
        "BatchResponsePublicStatus{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
