...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SitePageGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SitePageGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sitePageGetParams: SitePageGetParams) = apply {
            objectId = sitePageGetParams.objectId
            archived = sitePageGetParams.archived
            property = sitePageGetParams.property
            additionalHeaders = sitePageGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = sitePageGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SitePageGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SitePageGetParams =
            SitePageGetParams(
                objectId,
                archived,
                property,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SitePageGetParams &&
    ...
    override fun toString() =
        "SitePageGetParams{objectId=$objectId, archived=$archived, property=$property, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
