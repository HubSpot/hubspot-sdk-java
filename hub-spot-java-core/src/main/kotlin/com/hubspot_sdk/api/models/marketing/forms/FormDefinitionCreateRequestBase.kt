...
private constructor(
    ...
    /** A builder for [FormDefinitionCreateRequestBase]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(formDefinitionCreateRequestBase: FormDefinitionCreateRequestBase) =
            apply {
                archived = formDefinitionCreateRequestBase.archived
                configuration = formDefinitionCreateRequestBase.configuration
                createdAt = formDefinitionCreateRequestBase.createdAt
                displayOptions = formDefinitionCreateRequestBase.displayOptions
                fieldGroups = formDefinitionCreateRequestBase.fieldGroups.map { it.toMutableList() }
                formType = formDefinitionCreateRequestBase.formType
                legalConsentOptions = formDefinitionCreateRequestBase.legalConsentOptions
                name = formDefinitionCreateRequestBase.name
                updatedAt = formDefinitionCreateRequestBase.updatedAt
                archivedAt = formDefinitionCreateRequestBase.archivedAt
                additionalProperties =
                    formDefinitionCreateRequestBase.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [FormDefinitionCreateRequestBase].
         *
         ...
         */
        fun build(): FormDefinitionCreateRequestBase =
            FormDefinitionCreateRequestBase(
    ...
    fun validate(): FormDefinitionCreateRequestBase = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FormDefinitionCreateRequestBase &&
    ...
    override fun toString() =
        "FormDefinitionCreateRequestBase{archived=$archived, configuration=$configuration, createdAt=$createdAt, displayOptions=$displayOptions, fieldGroups=$fieldGroups, formType=$formType, legalConsentOptions=$legalConsentOptions, name=$name, updatedAt=$updatedAt, archivedAt=$archivedAt, additionalProperties=$additionalProperties}"
}
