...
class StatusBatchUnsubscribeAllParams
private constructor(
    ...
    companion object {
         ...
         * [StatusBatchUnsubscribeAllParams].
         *
    ...
    /** A builder for [StatusBatchUnsubscribeAllParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(statusBatchUnsubscribeAllParams: StatusBatchUnsubscribeAllParams) =
            apply {
                channel = statusBatchUnsubscribeAllParams.channel
                businessUnitId = statusBatchUnsubscribeAllParams.businessUnitId
                verbose = statusBatchUnsubscribeAllParams.verbose
                batchInputString = statusBatchUnsubscribeAllParams.batchInputString
                additionalHeaders = statusBatchUnsubscribeAllParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    statusBatchUnsubscribeAllParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [StatusBatchUnsubscribeAllParams].
         *
         ...
         */
        fun build(): StatusBatchUnsubscribeAllParams =
            StatusBatchUnsubscribeAllParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StatusBatchUnsubscribeAllParams &&
    ...
    override fun toString() =
        "StatusBatchUnsubscribeAllParams{channel=$channel, businessUnitId=$businessUnitId, verbose=$verbose, batchInputString=$batchInputString, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
