...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(booleanPropertyVariable: BooleanPropertyVariable) = apply {
            ...
            inputs = booleanPropertyVariable.inputs.map { it.toMutableList() }
    ...
    override fun toString() =
        "BooleanPropertyVariable{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
