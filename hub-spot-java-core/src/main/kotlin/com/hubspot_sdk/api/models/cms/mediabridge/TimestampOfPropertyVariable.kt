...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(timestampOfPropertyVariable: TimestampOfPropertyVariable) = apply {
            ...
            inputs = timestampOfPropertyVariable.inputs.map { it.toMutableList() }
    ...
    override fun toString() =
        "TimestampOfPropertyVariable{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
