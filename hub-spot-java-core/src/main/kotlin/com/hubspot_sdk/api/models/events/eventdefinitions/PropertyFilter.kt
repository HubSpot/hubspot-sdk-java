...
private constructor(
    ...
    ) : this(filterType, operation, property, frameworkFilterId, mutableMapOf())
    ...
    private val hashCode: Int by lazy {
        Objects.hash(filterType, operation, property, frameworkFilterId, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "PropertyFilter{filterType=$filterType, operation=$operation, property=$property, frameworkFilterId=$frameworkFilterId, additionalProperties=$additionalProperties}"
}
