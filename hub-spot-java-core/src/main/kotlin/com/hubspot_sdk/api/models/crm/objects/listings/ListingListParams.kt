...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of listings that can
    ...
    companion object {
        ...
        @JvmStatic fun none(): ListingListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ListingListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ListingListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(listingListParams: ListingListParams) = apply {
            after = listingListParams.after
            archived = listingListParams.archived
            associations = listingListParams.associations?.toMutableList()
            limit = listingListParams.limit
            properties = listingListParams.properties?.toMutableList()
            propertiesWithHistory = listingListParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = listingListParams.additionalHeaders.toBuilder()
            additionalQueryParams = listingListParams.additionalQueryParams.toBuilder()
        }
         ...
         * of listings that can be read by a single request.
         */
        ...
        /**
         * Returns an immutable instance of [ListingListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ListingListParams =
            ListingListParams(
                after,
                archived,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ListingListParams &&
            after == other.after &&
    ...
    override fun toString() =
        "ListingListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
