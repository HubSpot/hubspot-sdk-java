...
/** @see CustomServiceAsync.list */
class CustomListPageAsync
private constructor(
    private val service: CustomServiceAsync,
    ...
    fun nextPageParams(): CustomListParams {
        val nextCursor =
            paging()
                .flatMap { it._next().getOptional("next") }
                ._after()
    ...
    override fun nextPage(): CompletableFuture<CustomListPageAsync> = service.list(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CustomListPageAsync].
         *
    ...
    /** A builder for [CustomListPageAsync]. */
    class Builder internal constructor() {

        private var service: CustomServiceAsync? = null
        ...
        @JvmSynthetic
        internal fun from(customListPageAsync: CustomListPageAsync) = apply {
            service = customListPageAsync.service
            streamHandlerExecutor = customListPageAsync.streamHandlerExecutor
            params = customListPageAsync.params
            response = customListPageAsync.response
        }

        fun service(service: CustomServiceAsync) = apply { this.service = service }
        ...
        /**
         * Returns an immutable instance of [CustomListPageAsync].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomListPageAsync &&
    ...
    override fun toString() =
        "CustomListPageAsync{service=$service, streamHandlerExecutor=$streamHandlerExecutor, params=$params, response=$response}"
}
