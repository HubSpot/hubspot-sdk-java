...
/**
 * Replaces multiple rows as a batch in the draft version of the table, with a maximum of 100 rows
 * per call. See the endpoint `PUT /tables/{tableIdOrName}/rows/{rowId}/draft` for details on
 * updating a single row.
 */
class BatchReplaceBatchParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchReplaceBatchParams].
         *
    ...
    /** A builder for [BatchReplaceBatchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchReplaceBatchParams: BatchReplaceBatchParams) = apply {
            tableIdOrName = batchReplaceBatchParams.tableIdOrName
            batchInputHubDbTableRowV3BatchUpdateRequest =
                batchReplaceBatchParams.batchInputHubDbTableRowV3BatchUpdateRequest
            additionalHeaders = batchReplaceBatchParams.additionalHeaders.toBuilder()
            additionalQueryParams = batchReplaceBatchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BatchReplaceBatchParams].
         *
         ...
         */
        fun build(): BatchReplaceBatchParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchReplaceBatchParams &&
    ...
    override fun toString() =
        "BatchReplaceBatchParams{tableIdOrName=$tableIdOrName, batchInputHubDbTableRowV3BatchUpdateRequest=$batchInputHubDbTableRowV3BatchUpdateRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
