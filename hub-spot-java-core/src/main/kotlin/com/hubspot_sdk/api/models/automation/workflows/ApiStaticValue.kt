...
private constructor(
    ...
    ) : this(staticValue, type, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ApiStaticValue].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(apiStaticValue: ApiStaticValue) = apply {
            staticValue = apiStaticValue.staticValue
            type = apiStaticValue.type
            additionalProperties = apiStaticValue.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ApiStaticValue].
         *
    ...
    fun validate(): ApiStaticValue = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ApiStaticValue &&
            staticValue == other.staticValue &&
            type == other.type &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(staticValue, type, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ApiStaticValue{staticValue=$staticValue, type=$type, additionalProperties=$additionalProperties}"
}
