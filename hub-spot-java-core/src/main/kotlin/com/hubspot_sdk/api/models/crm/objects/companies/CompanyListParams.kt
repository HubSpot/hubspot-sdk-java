...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of companies that can
    ...
    class Builder internal constructor() {
        ...
        internal fun from(companyListParams: CompanyListParams) = apply {
            after = companyListParams.after
            archived = companyListParams.archived
            associations = companyListParams.associations?.toMutableList()
            limit = companyListParams.limit
            properties = companyListParams.properties?.toMutableList()
            propertiesWithHistory = companyListParams.propertiesWithHistory?.toMutableList()
         ...
         * of companies that can be read by a single request.
         */
    ...
    override fun toString() =
        "CompanyListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
