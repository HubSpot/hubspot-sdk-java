...
private constructor(
    ...
    /**
     * A builder for [BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors].
     */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            completedAt =
                batchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors
                    .completedAt
            results =
                batchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors.results
            ...
            errors =
                batchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors.errors
                    .map { it.toMutableList() }
            links =
         ...
         */
        fun build(): BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors =
            BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors(
    ...
    fun validate(): BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors =
        apply {
            if (validated) {
                return@apply
            }
    ...
    override fun toString() =
        "BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
