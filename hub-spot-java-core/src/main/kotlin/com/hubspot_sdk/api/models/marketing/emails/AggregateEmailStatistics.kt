...
/**
 * Aggregated statistics for the given interval, plus the IDs of emails that were sent during that
 * interval.
 */
...
private constructor(
     ...
     */
    fun aggregate(): Optional<EmailStatisticsData> = aggregate.getOptional("aggregate")
     ...
     *   server responded with an unexpected value).
     */
    fun campaignAggregations(): Optional<CampaignAggregations> =
        campaignAggregations.getOptional("campaignAggregations")
     ...
     *   server responded with an unexpected value).
     */
    fun emails(): Optional<List<Long>> = emails.getOptional("emails")
    ...
    class Builder internal constructor() {
        ...
        private var aggregate: JsonField<EmailStatisticsData> = JsonMissing.of()
        private var campaignAggregations: JsonField<CampaignAggregations> = JsonMissing.of()
    ...
    fun validate(): AggregateEmailStatistics = apply {
        ...
        aggregate().ifPresent { it.validate() }
        campaignAggregations().ifPresent { it.validate() }
        emails()
        validated = true
    }
