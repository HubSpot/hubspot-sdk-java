...
/**
 * Perform a partial update of an Object identified by `{orderId}`or optionally a unique property
 * value as specified by the `idProperty` query param. `{orderId}` refers to the internal object ID
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrderUpdateParams].
         *
    ...
    /** A builder for [OrderUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orderUpdateParams: OrderUpdateParams) = apply {
            orderId = orderUpdateParams.orderId
            idProperty = orderUpdateParams.idProperty
            simplePublicObjectInput = orderUpdateParams.simplePublicObjectInput
            additionalHeaders = orderUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = orderUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [OrderUpdateParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrderUpdateParams &&
    ...
    override fun toString() =
        "OrderUpdateParams{orderId=$orderId, idProperty=$idProperty, simplePublicObjectInput=$simplePublicObjectInput, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
