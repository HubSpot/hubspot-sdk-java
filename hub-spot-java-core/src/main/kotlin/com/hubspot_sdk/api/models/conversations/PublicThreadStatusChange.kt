...
class PublicThreadStatusChange
...
private constructor(
    ...
    private val newStatus: JsonField<NewStatus>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        newStatus: JsonField<NewStatus> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun newStatus(): NewStatus = newStatus.getRequired("newStatus")
     ...
     */
    @JsonProperty("newStatus") @ExcludeMissing fun _newStatus(): JsonField<NewStatus> = newStatus
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicThreadStatusChange].
         *
    ...
    /** A builder for [PublicThreadStatusChange]. */
    class Builder internal constructor() {
        ...
        private var newStatus: JsonField<NewStatus>? = null
        ...
        @JvmSynthetic
        internal fun from(publicThreadStatusChange: PublicThreadStatusChange) = apply {
            id = publicThreadStatusChange.id
            archived = publicThreadStatusChange.archived
            client = publicThreadStatusChange.client
            conversationsThreadId = publicThreadStatusChange.conversationsThreadId
            createdAt = publicThreadStatusChange.createdAt
            createdBy = publicThreadStatusChange.createdBy
            newStatus = publicThreadStatusChange.newStatus
            recipients = publicThreadStatusChange.recipients.map { it.toMutableList() }
            senders = publicThreadStatusChange.senders.map { it.toMutableList() }
            type = publicThreadStatusChange.type
            updatedAt = publicThreadStatusChange.updatedAt
            additionalProperties = publicThreadStatusChange.additionalProperties.toMutableMap()
        }
        ...
        fun newStatus(newStatus: NewStatus) = newStatus(JsonField.of(newStatus))

        /**
         * Sets [Builder.newStatus] to an arbitrary JSON value.
         *
         * You should usually call [Builder.newStatus] with a well-typed [NewStatus] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun newStatus(newStatus: JsonField<NewStatus>) = apply { this.newStatus = newStatus }
        ...
        /**
         * Returns an immutable instance of [PublicThreadStatusChange].
         *
         ...
         */
        fun build(): PublicThreadStatusChange =
    ...
    fun validate(): PublicThreadStatusChange = apply {
        if (validated) {
            return@apply
        }
    ...
    class NewStatus @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmStatic fun of(value: String) = NewStatus(JsonField.of(value))
        }

        /** An enum containing [NewStatus]'s known values. */
        enum class Known {
            OPEN,
            CLOSED,
        }
        ...
        /**
         * An enum containing [NewStatus]'s known values, as well as an [_UNKNOWN] member.
         *
         * An instance of [NewStatus] can contain an unknown value in a couple of cases:
        ...
        enum class Value {
            ...
            CLOSED,
            /**
             * An enum member indicating that [NewStatus] was instantiated with an unknown value.
             */
            _UNKNOWN,
        }
        ...
        fun known(): Known =
            when (this) {
                OPEN -> Known.OPEN
                CLOSED -> Known.CLOSED
                else -> throw HubSpotInvalidDataException("Unknown NewStatus: $value")
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is NewStatus && value == other.value
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val THREAD_STATUS_CHANGE = of("THREAD_STATUS_CHANGE")
        ...
        fun value(): Value =
            when (this) {
                THREAD_STATUS_CHANGE -> Value.THREAD_STATUS_CHANGE
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                THREAD_STATUS_CHANGE -> Known.THREAD_STATUS_CHANGE
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicThreadStatusChange &&
            id == other.id &&
    ...
    override fun toString() =
        "PublicThreadStatusChange{id=$id, archived=$archived, client=$client, conversationsThreadId=$conversationsThreadId, createdAt=$createdAt, createdBy=$createdBy, newStatus=$newStatus, recipients=$recipients, senders=$senders, type=$type, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
