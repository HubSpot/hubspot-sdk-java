...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fileGetParams: FileGetParams) = apply {
            ...
            properties = fileGetParams.properties?.toMutableList()
    ...
    override fun toString() =
        "FileGetParams{fileId=$fileId, properties=$properties, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
