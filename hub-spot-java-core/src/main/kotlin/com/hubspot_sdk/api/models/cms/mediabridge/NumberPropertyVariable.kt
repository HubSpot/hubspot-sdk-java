...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(numberPropertyVariable: NumberPropertyVariable) = apply {
            ...
            inputs = numberPropertyVariable.inputs.map { it.toMutableList() }
    ...
    override fun toString() =
        "NumberPropertyVariable{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
