...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(numberTargetPropertyVariable: NumberTargetPropertyVariable) = apply {
            ...
            inputs = numberTargetPropertyVariable.inputs.map { it.toMutableList() }
    ...
    override fun toString() =
        "NumberTargetPropertyVariable{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
