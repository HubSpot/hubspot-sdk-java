...
private constructor(
    ...
    /** A builder for [PublicDateTimePropertyOperation]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicDateTimePropertyOperation: PublicDateTimePropertyOperation) =
            apply {
                includeObjectsWithNoValueSet =
                    publicDateTimePropertyOperation.includeObjectsWithNoValueSet
                operationType = publicDateTimePropertyOperation.operationType
                operator = publicDateTimePropertyOperation.operator
                requiresTimeZoneConversion =
                    publicDateTimePropertyOperation.requiresTimeZoneConversion
                timestamp = publicDateTimePropertyOperation.timestamp
                additionalProperties =
                    publicDateTimePropertyOperation.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [PublicDateTimePropertyOperation].
         *
         ...
         */
        fun build(): PublicDateTimePropertyOperation =
            PublicDateTimePropertyOperation(
    ...
    fun validate(): PublicDateTimePropertyOperation = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicDateTimePropertyOperation &&
    ...
    override fun toString() =
        "PublicDateTimePropertyOperation{includeObjectsWithNoValueSet=$includeObjectsWithNoValueSet, operationType=$operationType, operator=$operator, requiresTimeZoneConversion=$requiresTimeZoneConversion, timestamp=$timestamp, additionalProperties=$additionalProperties}"
}
