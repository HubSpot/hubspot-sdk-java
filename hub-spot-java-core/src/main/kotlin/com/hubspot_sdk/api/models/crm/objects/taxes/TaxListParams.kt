...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of taxes that can be
    ...
    companion object {
        ...
        @JvmStatic fun none(): TaxListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TaxListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TaxListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(taxListParams: TaxListParams) = apply {
            after = taxListParams.after
            archived = taxListParams.archived
            associations = taxListParams.associations?.toMutableList()
            limit = taxListParams.limit
            properties = taxListParams.properties?.toMutableList()
            propertiesWithHistory = taxListParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = taxListParams.additionalHeaders.toBuilder()
            additionalQueryParams = taxListParams.additionalQueryParams.toBuilder()
        }
         ...
         * of taxes that can be read by a single request.
         */
        ...
        /**
         * Returns an immutable instance of [TaxListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TaxListParams =
            TaxListParams(
                after,
                archived,
    ...
    override fun toString() =
        "TaxListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
