...
private constructor(
    ...
    ) : this(archived, inputs, dataSensitivity, mutableMapOf())
    ...
    private val hashCode: Int by lazy {
        Objects.hash(archived, inputs, dataSensitivity, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BatchReadInputPropertyName{archived=$archived, inputs=$inputs, dataSensitivity=$dataSensitivity, additionalProperties=$additionalProperties}"
}
