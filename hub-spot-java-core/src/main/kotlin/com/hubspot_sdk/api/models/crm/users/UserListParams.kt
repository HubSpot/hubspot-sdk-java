...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of users that can be
    ...
    class Builder internal constructor() {
        ...
        internal fun from(userListParams: UserListParams) = apply {
            ...
            archived = userListParams.archived
            associations = userListParams.associations?.toMutableList()
            limit = userListParams.limit
            properties = userListParams.properties?.toMutableList()
            propertiesWithHistory = userListParams.propertiesWithHistory?.toMutableList()
         ...
         * of users that can be read by a single request.
         */
    ...
    override fun toString() =
        "UserListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
