...
private constructor(
    ...
    /** A builder for [CollectionResponseWithTotalBlogPostForwardPaging]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            results =
                collectionResponseWithTotalBlogPostForwardPaging.results.map { it.toMutableList() }
            total = collectionResponseWithTotalBlogPostForwardPaging.total
            paging = collectionResponseWithTotalBlogPostForwardPaging.paging
            additionalProperties =
                collectionResponseWithTotalBlogPostForwardPaging.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CollectionResponseWithTotalBlogPostForwardPaging].
         *
         ...
         */
        fun build(): CollectionResponseWithTotalBlogPostForwardPaging =
            CollectionResponseWithTotalBlogPostForwardPaging(
    ...
    fun validate(): CollectionResponseWithTotalBlogPostForwardPaging = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionResponseWithTotalBlogPostForwardPaging &&
    ...
    override fun toString() =
        "CollectionResponseWithTotalBlogPostForwardPaging{results=$results, total=$total, paging=$paging, additionalProperties=$additionalProperties}"
}
