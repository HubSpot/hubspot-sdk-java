...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicClient: PublicClient) = apply {
            clientType = publicClient.clientType
            integrationAppId = publicClient.integrationAppId
    ...
    fun validate(): PublicClient = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "PublicClient{clientType=$clientType, integrationAppId=$integrationAppId, additionalProperties=$additionalProperties}"
}
