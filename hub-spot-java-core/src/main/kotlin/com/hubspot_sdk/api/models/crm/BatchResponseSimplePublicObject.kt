...
private constructor(
    ...
    /** A builder for [BatchResponseSimplePublicObject]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchResponseSimplePublicObject: BatchResponseSimplePublicObject) =
            apply {
                completedAt = batchResponseSimplePublicObject.completedAt
                results = batchResponseSimplePublicObject.results.map { it.toMutableList() }
                startedAt = batchResponseSimplePublicObject.startedAt
                status = batchResponseSimplePublicObject.status
                errors = batchResponseSimplePublicObject.errors.map { it.toMutableList() }
                links = batchResponseSimplePublicObject.links
                numErrors = batchResponseSimplePublicObject.numErrors
                requestedAt = batchResponseSimplePublicObject.requestedAt
                additionalProperties =
                    batchResponseSimplePublicObject.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BatchResponseSimplePublicObject].
         *
         ...
         */
        fun build(): BatchResponseSimplePublicObject =
            BatchResponseSimplePublicObject(
    ...
    fun validate(): BatchResponseSimplePublicObject = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseSimplePublicObject &&
    ...
    override fun toString() =
        "BatchResponseSimplePublicObject{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
