...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of services that can
    ...
    class Builder internal constructor() {
        ...
        internal fun from(serviceListParams: ServiceListParams) = apply {
            after = serviceListParams.after
            archived = serviceListParams.archived
            associations = serviceListParams.associations?.toMutableList()
            limit = serviceListParams.limit
            properties = serviceListParams.properties?.toMutableList()
            propertiesWithHistory = serviceListParams.propertiesWithHistory?.toMutableList()
         ...
         * of services that can be read by a single request.
         */
    ...
    override fun toString() =
        "ServiceListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
