...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LlmActor].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(llmActor: LlmActor) = apply {
            id = llmActor.id
            type = llmActor.type
            avatar = llmActor.avatar
            name = llmActor.name
            additionalProperties = llmActor.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LlmActor].
         *
    ...
    override fun toString() =
        "LlmActor{id=$id, type=$type, avatar=$avatar, name=$name, additionalProperties=$additionalProperties}"
}
