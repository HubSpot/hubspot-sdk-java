...
class CreatedResponsePropertyGroup
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val createdResourceId: JsonField<String>,
    private val entity: JsonField<PropertyGroup>,
    ...
    private constructor(
        ...
        @JsonProperty("entity") @ExcludeMissing entity: JsonField<PropertyGroup> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun entity(): PropertyGroup = entity.getRequired("entity")
     ...
     */
    @JsonProperty("entity") @ExcludeMissing fun _entity(): JsonField<PropertyGroup> = entity
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CreatedResponsePropertyGroup].
         *
    ...
    /** A builder for [CreatedResponsePropertyGroup]. */
    class Builder internal constructor() {

        private var createdResourceId: JsonField<String>? = null
        private var entity: JsonField<PropertyGroup>? = null
        private var location: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(createdResponsePropertyGroup: CreatedResponsePropertyGroup) = apply {
            createdResourceId = createdResponsePropertyGroup.createdResourceId
            entity = createdResponsePropertyGroup.entity
            location = createdResponsePropertyGroup.location
            additionalProperties = createdResponsePropertyGroup.additionalProperties.toMutableMap()
        }
        ...
        /** An ID for a group of properties */
        fun entity(entity: PropertyGroup) = entity(JsonField.of(entity))

        /**
         * Sets [Builder.entity] to an arbitrary JSON value.
         *
         * You should usually call [Builder.entity] with a well-typed [PropertyGroup] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun entity(entity: JsonField<PropertyGroup>) = apply { this.entity = entity }
        ...
        /**
         * Returns an immutable instance of [CreatedResponsePropertyGroup].
         *
         ...
         */
        fun build(): CreatedResponsePropertyGroup =
    ...
    fun validate(): CreatedResponsePropertyGroup = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CreatedResponsePropertyGroup &&
    ...
    override fun toString() =
        "CreatedResponsePropertyGroup{createdResourceId=$createdResourceId, entity=$entity, location=$location, additionalProperties=$additionalProperties}"
}
