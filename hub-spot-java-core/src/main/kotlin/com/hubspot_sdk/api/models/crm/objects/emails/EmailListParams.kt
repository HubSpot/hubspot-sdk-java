...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of emails that can be
    ...
    class Builder internal constructor() {
        ...
        internal fun from(emailListParams: EmailListParams) = apply {
            ...
            associations = emailListParams.associations?.toMutableList()
            limit = emailListParams.limit
            properties = emailListParams.properties?.toMutableList()
            propertiesWithHistory = emailListParams.propertiesWithHistory?.toMutableList()
         ...
         * of emails that can be read by a single request.
         */
    ...
    override fun toString() =
        "EmailListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
