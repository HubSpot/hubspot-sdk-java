...
private constructor(
    ...
    private val paging: JsonField<BoundedPaging>,
    ...
    private constructor(
        ...
        @JsonProperty("paging") @ExcludeMissing paging: JsonField<BoundedPaging> = JsonMissing.of(),
     ...
     */
    fun paging(): Optional<BoundedPaging> = paging.getOptional("paging")
     ...
     */
    @JsonProperty("paging") @ExcludeMissing fun _paging(): JsonField<BoundedPaging> = paging
    ...
    /** A builder for [RandomAccessCollectionResponseWithTotalHubDbTableRowV3]. */
    class Builder internal constructor() {

        private var results: JsonField<MutableList<HubDbTableRowV3Wrapper>>? = null
        private var total: JsonField<Int>? = null
        private var type: JsonField<Type>? = null
        private var paging: JsonField<BoundedPaging> = JsonMissing.of()
        ...
        internal fun from(
            ...
            results =
                randomAccessCollectionResponseWithTotalHubDbTableRowV3.results.map {
                    it.toMutableList()
                }
            total = randomAccessCollectionResponseWithTotalHubDbTableRowV3.total
            type = randomAccessCollectionResponseWithTotalHubDbTableRowV3.type
            paging = randomAccessCollectionResponseWithTotalHubDbTableRowV3.paging
            additionalProperties =
                randomAccessCollectionResponseWithTotalHubDbTableRowV3.additionalProperties
                    .toMutableMap()
        }
        ...
        fun paging(paging: BoundedPaging) = paging(JsonField.of(paging))

        /**
         * Sets [Builder.paging] to an arbitrary JSON value.
         *
         * You should usually call [Builder.paging] with a well-typed [BoundedPaging] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun paging(paging: JsonField<BoundedPaging>) = apply { this.paging = paging }
         ...
         */
        fun build(): RandomAccessCollectionResponseWithTotalHubDbTableRowV3 =
            RandomAccessCollectionResponseWithTotalHubDbTableRowV3(
    ...
    fun validate(): RandomAccessCollectionResponseWithTotalHubDbTableRowV3 = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val RANDOM_ACCESS = of("RANDOM_ACCESS")
        ...
        fun value(): Value =
            when (this) {
                RANDOM_ACCESS -> Value.RANDOM_ACCESS
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                RANDOM_ACCESS -> Known.RANDOM_ACCESS
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RandomAccessCollectionResponseWithTotalHubDbTableRowV3 &&
    ...
    override fun toString() =
        "RandomAccessCollectionResponseWithTotalHubDbTableRowV3{results=$results, total=$total, type=$type, paging=$paging, additionalProperties=$additionalProperties}"
}
