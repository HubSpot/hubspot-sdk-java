...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): FileGetSignedUrlParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [FileGetSignedUrlParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FileGetSignedUrlParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileGetSignedUrlParams: FileGetSignedUrlParams) = apply {
            fileId = fileGetSignedUrlParams.fileId
            expirationSeconds = fileGetSignedUrlParams.expirationSeconds
            size = fileGetSignedUrlParams.size
            upscale = fileGetSignedUrlParams.upscale
            additionalHeaders = fileGetSignedUrlParams.additionalHeaders.toBuilder()
            additionalQueryParams = fileGetSignedUrlParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FileGetSignedUrlParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FileGetSignedUrlParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FileGetSignedUrlParams &&
            fileId == other.fileId &&
    ...
    override fun toString() =
        "FileGetSignedUrlParams{fileId=$fileId, expirationSeconds=$expirationSeconds, size=$size, upscale=$upscale, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
