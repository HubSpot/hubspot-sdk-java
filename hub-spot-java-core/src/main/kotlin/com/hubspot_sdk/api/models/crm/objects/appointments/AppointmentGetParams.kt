...
/**
 * Read an Object identified by `{appointmentId}`. `{appointmentId}` refers to the internal object
 * ID by default, or optionally any unique property value as specified by the `idProperty` query
 * param. Control what is returned via the `properties` query param.
 */
class AppointmentGetParams
private constructor(
    ...
    fun appointmentId(): Optional<String> = Optional.ofNullable(appointmentId)
    ...
    companion object {
        ...
        @JvmStatic fun none(): AppointmentGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AppointmentGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AppointmentGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(appointmentGetParams: AppointmentGetParams) = apply {
            appointmentId = appointmentGetParams.appointmentId
            archived = appointmentGetParams.archived
            associations = appointmentGetParams.associations?.toMutableList()
            idProperty = appointmentGetParams.idProperty
            properties = appointmentGetParams.properties?.toMutableList()
            propertiesWithHistory = appointmentGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = appointmentGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = appointmentGetParams.additionalQueryParams.toBuilder()
        }

        fun appointmentId(appointmentId: String?) = apply { this.appointmentId = appointmentId }

        /** Alias for calling [Builder.appointmentId] with `appointmentId.orElse(null)`. */
        fun appointmentId(appointmentId: Optional<String>) =
            appointmentId(appointmentId.getOrNull())
        ...
        /**
         * Returns an immutable instance of [AppointmentGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AppointmentGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AppointmentGetParams &&
    ...
    override fun toString() =
        "AppointmentGetParams{appointmentId=$appointmentId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
