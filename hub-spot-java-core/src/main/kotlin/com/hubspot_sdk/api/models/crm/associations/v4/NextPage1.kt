...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NextPage1].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(nextPage1: NextPage1) = apply {
            after = nextPage1.after
            link = nextPage1.link
            additionalProperties = nextPage1.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NextPage1].
         *
         ...
         */
        fun build(): NextPage1 =
            NextPage1(checkRequired("after", after), link, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): NextPage1 = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "NextPage1{after=$after, link=$link, additionalProperties=$additionalProperties}"
}
