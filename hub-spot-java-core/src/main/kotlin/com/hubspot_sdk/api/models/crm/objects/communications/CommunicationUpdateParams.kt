 ...
 * property value as specified by the `idProperty` query param. `{communicationId}` refers to the
 ...
 * empty string.
 */
class CommunicationUpdateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CommunicationUpdateParams].
         *
    ...
    /** A builder for [CommunicationUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(communicationUpdateParams: CommunicationUpdateParams) = apply {
            communicationId = communicationUpdateParams.communicationId
            idProperty = communicationUpdateParams.idProperty
            simplePublicObjectInput = communicationUpdateParams.simplePublicObjectInput
            additionalHeaders = communicationUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = communicationUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CommunicationUpdateParams].
         *
         ...
         */
        fun build(): CommunicationUpdateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CommunicationUpdateParams &&
    ...
    override fun toString() =
        "CommunicationUpdateParams{communicationId=$communicationId, idProperty=$idProperty, simplePublicObjectInput=$simplePublicObjectInput, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
