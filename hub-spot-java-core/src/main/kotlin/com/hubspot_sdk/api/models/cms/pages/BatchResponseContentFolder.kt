...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchResponseContentFolder].
         *
    ...
    /** A builder for [BatchResponseContentFolder]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchResponseContentFolder: BatchResponseContentFolder) = apply {
            completedAt = batchResponseContentFolder.completedAt
            results = batchResponseContentFolder.results.map { it.toMutableList() }
            startedAt = batchResponseContentFolder.startedAt
            status = batchResponseContentFolder.status
            links = batchResponseContentFolder.links
            requestedAt = batchResponseContentFolder.requestedAt
            additionalProperties = batchResponseContentFolder.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BatchResponseContentFolder].
         *
         ...
         */
        fun build(): BatchResponseContentFolder =
    ...
    fun validate(): BatchResponseContentFolder = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseContentFolder &&
    ...
    override fun toString() =
        "BatchResponseContentFolder{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, links=$links, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
