...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): ThreadListParams =
            ThreadListParams(additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "ThreadListParams{additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
