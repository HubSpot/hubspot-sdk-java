...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(eventGetParams: EventGetParams) = apply {
            objectId = eventGetParams.objectId
        ...
        fun build(): EventGetParams =
            EventGetParams(objectId, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "EventGetParams{objectId=$objectId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
