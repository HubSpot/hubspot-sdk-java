...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [StandardError1].
         *
    ...
    class Builder internal constructor() {
        ...
        private var subCategory: JsonValue = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(standardError1: StandardError1) = apply {
            category = standardError1.category
            context = standardError1.context
            errors = standardError1.errors.map { it.toMutableList() }
            links = standardError1.links
            message = standardError1.message
            status = standardError1.status
            id = standardError1.id
            subCategory = standardError1.subCategory
            additionalProperties = standardError1.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [StandardError1].
         *
    ...
    fun validate(): StandardError1 = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StandardError1 &&
    ...
    override fun toString() =
        "StandardError1{category=$category, context=$context, errors=$errors, links=$links, message=$message, status=$status, id=$id, subCategory=$subCategory, additionalProperties=$additionalProperties}"
}
