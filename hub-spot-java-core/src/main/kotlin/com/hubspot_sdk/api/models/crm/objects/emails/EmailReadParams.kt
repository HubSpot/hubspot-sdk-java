...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EmailReadParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [EmailReadParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [EmailReadParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emailReadParams: EmailReadParams) = apply {
            emailId = emailReadParams.emailId
            archived = emailReadParams.archived
            associations = emailReadParams.associations?.toMutableList()
            idProperty = emailReadParams.idProperty
            properties = emailReadParams.properties?.toMutableList()
            propertiesWithHistory = emailReadParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = emailReadParams.additionalHeaders.toBuilder()
            additionalQueryParams = emailReadParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EmailReadParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EmailReadParams =
            EmailReadParams(
                emailId,
                archived,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmailReadParams &&
    ...
    override fun toString() =
        "EmailReadParams{emailId=$emailId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
