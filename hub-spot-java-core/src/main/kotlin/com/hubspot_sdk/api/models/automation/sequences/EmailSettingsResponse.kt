...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmailSettingsResponse].
         *
    ...
    /** A builder for [EmailSettingsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emailSettingsResponse: EmailSettingsResponse) = apply {
            criteria = emailSettingsResponse.criteria
            sellingStrategy = emailSettingsResponse.sellingStrategy
            additionalProperties = emailSettingsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EmailSettingsResponse].
         *
         ...
         */
        fun build(): EmailSettingsResponse =
    ...
    fun validate(): EmailSettingsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmailSettingsResponse &&
    ...
    override fun toString() =
        "EmailSettingsResponse{criteria=$criteria, sellingStrategy=$sellingStrategy, additionalProperties=$additionalProperties}"
}
