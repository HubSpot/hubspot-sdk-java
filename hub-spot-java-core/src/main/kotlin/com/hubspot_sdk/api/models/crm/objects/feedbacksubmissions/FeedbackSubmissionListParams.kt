 ...
 */
class FeedbackSubmissionListParams
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of feedback
     * submissions that can be read by a single request.
     */
    ...
    companion object {
        ...
        @JvmStatic fun none(): FeedbackSubmissionListParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [FeedbackSubmissionListParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FeedbackSubmissionListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(feedbackSubmissionListParams: FeedbackSubmissionListParams) = apply {
            after = feedbackSubmissionListParams.after
            archived = feedbackSubmissionListParams.archived
            associations = feedbackSubmissionListParams.associations?.toMutableList()
            limit = feedbackSubmissionListParams.limit
            properties = feedbackSubmissionListParams.properties?.toMutableList()
            propertiesWithHistory =
                feedbackSubmissionListParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = feedbackSubmissionListParams.additionalHeaders.toBuilder()
            additionalQueryParams = feedbackSubmissionListParams.additionalQueryParams.toBuilder()
        }
         ...
         * of feedback submissions that can be read by a single request.
         */
        ...
        /**
         * Returns an immutable instance of [FeedbackSubmissionListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FeedbackSubmissionListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeedbackSubmissionListParams &&
            after == other.after &&
    ...
    override fun toString() =
        "FeedbackSubmissionListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
