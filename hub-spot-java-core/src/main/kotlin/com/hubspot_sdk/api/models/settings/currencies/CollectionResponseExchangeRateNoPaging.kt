...
class CollectionResponseExchangeRateNoPaging
...
private constructor(
    ...
    /** A builder for [CollectionResponseExchangeRateNoPaging]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            collectionResponseExchangeRateNoPaging: CollectionResponseExchangeRateNoPaging
        ) = apply {
            results = collectionResponseExchangeRateNoPaging.results.map { it.toMutableList() }
            additionalProperties =
                collectionResponseExchangeRateNoPaging.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CollectionResponseExchangeRateNoPaging].
         *
         ...
         */
        fun build(): CollectionResponseExchangeRateNoPaging =
            CollectionResponseExchangeRateNoPaging(
    ...
    fun validate(): CollectionResponseExchangeRateNoPaging = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionResponseExchangeRateNoPaging &&
    ...
    override fun toString() =
        "CollectionResponseExchangeRateNoPaging{results=$results, additionalProperties=$additionalProperties}"
}
