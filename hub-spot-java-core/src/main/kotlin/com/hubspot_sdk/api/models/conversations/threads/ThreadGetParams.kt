...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): ThreadGetParams =
            ThreadGetParams(threadId, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "ThreadGetParams{threadId=$threadId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
