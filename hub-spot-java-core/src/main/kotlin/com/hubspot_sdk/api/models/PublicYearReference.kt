...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicYearReference].
         *
    ...
    /** A builder for [PublicYearReference]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicYearReference: PublicYearReference) = apply {
            day = publicYearReference.day
            month = publicYearReference.month
            referenceType = publicYearReference.referenceType
            hour = publicYearReference.hour
            millisecond = publicYearReference.millisecond
            minute = publicYearReference.minute
            second = publicYearReference.second
            additionalProperties = publicYearReference.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicYearReference].
         *
    ...
    fun validate(): PublicYearReference = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicYearReference &&
            day == other.day &&
            month == other.month &&
    ...
    override fun toString() =
        "PublicYearReference{day=$day, month=$month, referenceType=$referenceType, hour=$hour, millisecond=$millisecond, minute=$minute, second=$second, additionalProperties=$additionalProperties}"
}
