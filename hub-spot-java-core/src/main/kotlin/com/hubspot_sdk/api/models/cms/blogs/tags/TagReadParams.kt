...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TagReadParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TagReadParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TagReadParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tagReadParams: TagReadParams) = apply {
            objectId = tagReadParams.objectId
            archived = tagReadParams.archived
            property = tagReadParams.property
            additionalHeaders = tagReadParams.additionalHeaders.toBuilder()
            additionalQueryParams = tagReadParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TagReadParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TagReadParams =
            TagReadParams(
                objectId,
                archived,
                property,
    ...
    override fun toString() =
        "TagReadParams{objectId=$objectId, archived=$archived, property=$property, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
