...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of discounts that can
    ...
    class Builder internal constructor() {
        ...
        internal fun from(discountListParams: DiscountListParams) = apply {
            after = discountListParams.after
            archived = discountListParams.archived
            associations = discountListParams.associations?.toMutableList()
            limit = discountListParams.limit
            properties = discountListParams.properties?.toMutableList()
            propertiesWithHistory = discountListParams.propertiesWithHistory?.toMutableList()
         ...
         * of discounts that can be read by a single request.
         */
    ...
    override fun toString() =
        "DiscountListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
