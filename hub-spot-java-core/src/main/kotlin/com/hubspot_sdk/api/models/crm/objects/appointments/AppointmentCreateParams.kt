...
/**
 * Create a appointment with the given properties and return a copy of the object, including the ID.
 * Documentation and examples for creating standard appointments is provided.
 */
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AppointmentCreateParams].
         *
    ...
    /** A builder for [AppointmentCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(appointmentCreateParams: AppointmentCreateParams) = apply {
            simplePublicObjectInputForCreate =
                appointmentCreateParams.simplePublicObjectInputForCreate
            additionalHeaders = appointmentCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = appointmentCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AppointmentCreateParams].
         *
         ...
         */
        fun build(): AppointmentCreateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AppointmentCreateParams &&
    ...
    override fun toString() =
        "AppointmentCreateParams{simplePublicObjectInputForCreate=$simplePublicObjectInputForCreate, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
