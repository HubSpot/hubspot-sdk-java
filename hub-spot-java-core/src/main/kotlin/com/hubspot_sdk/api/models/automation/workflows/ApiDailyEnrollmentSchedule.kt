...
class ApiDailyEnrollmentSchedule
...
private constructor(
    ...
    ) : this(timeOfDay, type, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ApiDailyEnrollmentSchedule].
         *
    ...
    /** A builder for [ApiDailyEnrollmentSchedule]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(apiDailyEnrollmentSchedule: ApiDailyEnrollmentSchedule) = apply {
            timeOfDay = apiDailyEnrollmentSchedule.timeOfDay
            type = apiDailyEnrollmentSchedule.type
            additionalProperties = apiDailyEnrollmentSchedule.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ApiDailyEnrollmentSchedule].
         *
         ...
         */
        fun build(): ApiDailyEnrollmentSchedule =
    ...
    fun validate(): ApiDailyEnrollmentSchedule = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ApiDailyEnrollmentSchedule &&
            timeOfDay == other.timeOfDay &&
            type == other.type &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { Objects.hash(timeOfDay, type, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ApiDailyEnrollmentSchedule{timeOfDay=$timeOfDay, type=$type, additionalProperties=$additionalProperties}"
}
