...
private constructor(
    ...
    /** A builder for [BatchResponseLabelsBetweenObjectPair]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            completedAt = batchResponseLabelsBetweenObjectPair.completedAt
            results = batchResponseLabelsBetweenObjectPair.results.map { it.toMutableList() }
            startedAt = batchResponseLabelsBetweenObjectPair.startedAt
            status = batchResponseLabelsBetweenObjectPair.status
            errors = batchResponseLabelsBetweenObjectPair.errors.map { it.toMutableList() }
            links = batchResponseLabelsBetweenObjectPair.links
            numErrors = batchResponseLabelsBetweenObjectPair.numErrors
            requestedAt = batchResponseLabelsBetweenObjectPair.requestedAt
            additionalProperties =
                batchResponseLabelsBetweenObjectPair.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BatchResponseLabelsBetweenObjectPair].
         *
         ...
         */
        fun build(): BatchResponseLabelsBetweenObjectPair =
            BatchResponseLabelsBetweenObjectPair(
    ...
    fun validate(): BatchResponseLabelsBetweenObjectPair = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseLabelsBetweenObjectPair &&
    ...
    override fun toString() =
        "BatchResponseLabelsBetweenObjectPair{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
