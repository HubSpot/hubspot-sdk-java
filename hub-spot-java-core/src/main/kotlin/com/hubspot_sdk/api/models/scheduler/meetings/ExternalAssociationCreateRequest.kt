...
class ExternalAssociationCreateRequest
...
private constructor(
    ...
    /** A builder for [ExternalAssociationCreateRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(externalAssociationCreateRequest: ExternalAssociationCreateRequest) =
            apply {
                to = externalAssociationCreateRequest.to
                types = externalAssociationCreateRequest.types.map { it.toMutableList() }
                additionalProperties =
                    externalAssociationCreateRequest.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ExternalAssociationCreateRequest].
         *
         ...
         */
        fun build(): ExternalAssociationCreateRequest =
            ExternalAssociationCreateRequest(
                checkRequired("to", to),
    ...
    fun validate(): ExternalAssociationCreateRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExternalAssociationCreateRequest &&
            to == other.to &&
            types == other.types &&
    ...
    override fun toString() =
        "ExternalAssociationCreateRequest{to=$to, types=$types, additionalProperties=$additionalProperties}"
}
