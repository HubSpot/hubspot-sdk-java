...
class V4CreateDefaultAssociationParams
private constructor(
    ...
    /** A builder for [V4CreateDefaultAssociationParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v4CreateDefaultAssociationParams: V4CreateDefaultAssociationParams) =
            apply {
                fromObjectType = v4CreateDefaultAssociationParams.fromObjectType
                fromObjectId = v4CreateDefaultAssociationParams.fromObjectId
                toObjectType = v4CreateDefaultAssociationParams.toObjectType
                toObjectId = v4CreateDefaultAssociationParams.toObjectId
                additionalHeaders = v4CreateDefaultAssociationParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    v4CreateDefaultAssociationParams.additionalQueryParams.toBuilder()
                additionalBodyProperties =
                    v4CreateDefaultAssociationParams.additionalBodyProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [V4CreateDefaultAssociationParams].
         *
         ...
         */
        fun build(): V4CreateDefaultAssociationParams =
            V4CreateDefaultAssociationParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is V4CreateDefaultAssociationParams &&
    ...
    override fun toString() =
        "V4CreateDefaultAssociationParams{fromObjectType=$fromObjectType, fromObjectId=$fromObjectId, toObjectType=$toObjectType, toObjectId=$toObjectId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
