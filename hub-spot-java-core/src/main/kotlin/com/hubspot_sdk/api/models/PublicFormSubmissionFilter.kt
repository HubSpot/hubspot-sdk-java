...
private constructor(
    ...
    ) : this(filterType, operator, coalescingRefineBy, formId, pruningRefineBy, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicFormSubmissionFilter].
         *
    ...
    /** A builder for [PublicFormSubmissionFilter]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicFormSubmissionFilter: PublicFormSubmissionFilter) = apply {
            filterType = publicFormSubmissionFilter.filterType
            operator = publicFormSubmissionFilter.operator
            coalescingRefineBy = publicFormSubmissionFilter.coalescingRefineBy
            formId = publicFormSubmissionFilter.formId
            pruningRefineBy = publicFormSubmissionFilter.pruningRefineBy
            additionalProperties = publicFormSubmissionFilter.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicFormSubmissionFilter].
         *
         ...
         */
        fun build(): PublicFormSubmissionFilter =
    ...
    fun validate(): PublicFormSubmissionFilter = apply {
        if (validated) {
            return@apply
        }
    ...
    class FilterType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val FORM_SUBMISSION = of("FORM_SUBMISSION")
        ...
        fun value(): Value =
            when (this) {
                FORM_SUBMISSION -> Value.FORM_SUBMISSION
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                FORM_SUBMISSION -> Known.FORM_SUBMISSION
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicFormSubmissionFilter &&
    ...
    override fun toString() =
        "PublicFormSubmissionFilter{filterType=$filterType, operator=$operator, coalescingRefineBy=$coalescingRefineBy, formId=$formId, pruningRefineBy=$pruningRefineBy, additionalProperties=$additionalProperties}"
}
