...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /**
         * Results will display maximum 100 users per page. Additional results will be on the next
         * page.
         */
        ...
        fun build(): UserListParams =
            UserListParams(after, limit, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "UserListParams{after=$after, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
