...
private constructor(
    private val results: JsonField<List<PublicEmail>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<PublicEmail>> = JsonMissing.of(),
     ...
     */
    fun results(): List<PublicEmail> = results.getRequired("results")
     ...
     */
    @JsonProperty("results") @ExcludeMissing fun _results(): JsonField<List<PublicEmail>> = results
    ...
    /** A builder for [CollectionResponseWithTotalPublicEmailForwardPaging]. */
    class Builder internal constructor() {

        private var results: JsonField<MutableList<PublicEmail>>? = null
        ...
        internal fun from(
            ...
            results =
                collectionResponseWithTotalPublicEmailForwardPaging.results.map {
                    it.toMutableList()
                }
            total = collectionResponseWithTotalPublicEmailForwardPaging.total
            paging = collectionResponseWithTotalPublicEmailForwardPaging.paging
            additionalProperties =
                collectionResponseWithTotalPublicEmailForwardPaging.additionalProperties
                    .toMutableMap()
        }

        /** Collection of emails. */
        fun results(results: List<PublicEmail>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed `List<PublicEmail>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun results(results: JsonField<List<PublicEmail>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [PublicEmail] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: PublicEmail) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [CollectionResponseWithTotalPublicEmailForwardPaging].
         *
         ...
         */
        fun build(): CollectionResponseWithTotalPublicEmailForwardPaging =
            CollectionResponseWithTotalPublicEmailForwardPaging(
    ...
    fun validate(): CollectionResponseWithTotalPublicEmailForwardPaging = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionResponseWithTotalPublicEmailForwardPaging &&
    ...
    override fun toString() =
        "CollectionResponseWithTotalPublicEmailForwardPaging{results=$results, total=$total, paging=$paging, additionalProperties=$additionalProperties}"
}
