...
private constructor(
    ...
    ) : this(containsEncryptedProperties, fileId, lineNumber, rowData, pageName, mutableMapOf())
    ...
    override fun toString() =
        "ImportRowCore{containsEncryptedProperties=$containsEncryptedProperties, fileId=$fileId, lineNumber=$lineNumber, rowData=$rowData, pageName=$pageName, additionalProperties=$additionalProperties}"
}
