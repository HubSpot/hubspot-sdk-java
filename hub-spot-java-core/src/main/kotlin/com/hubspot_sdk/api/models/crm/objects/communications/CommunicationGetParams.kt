...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): CommunicationGetParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [CommunicationGetParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CommunicationGetParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(communicationGetParams: CommunicationGetParams) = apply {
            communicationId = communicationGetParams.communicationId
            archived = communicationGetParams.archived
            associations = communicationGetParams.associations?.toMutableList()
            idProperty = communicationGetParams.idProperty
            properties = communicationGetParams.properties?.toMutableList()
            propertiesWithHistory = communicationGetParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = communicationGetParams.additionalHeaders.toBuilder()
            additionalQueryParams = communicationGetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CommunicationGetParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CommunicationGetParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CommunicationGetParams &&
    ...
    override fun toString() =
        "CommunicationGetParams{communicationId=$communicationId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
