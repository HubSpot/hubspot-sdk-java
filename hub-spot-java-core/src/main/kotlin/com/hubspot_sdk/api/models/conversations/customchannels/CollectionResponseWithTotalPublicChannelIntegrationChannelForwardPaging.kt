...
class CollectionResponseWithTotalPublicChannelIntegrationChannelForwardPaging
...
private constructor(
    ...
    /** A builder for [CollectionResponseWithTotalPublicChannelIntegrationChannelForwardPaging]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            total = collectionResponseWithTotalPublicChannelIntegrationChannelForwardPaging.total
            paging = collectionResponseWithTotalPublicChannelIntegrationChannelForwardPaging.paging
         ...
         */
        fun build(): CollectionResponseWithTotalPublicChannelIntegrationChannelForwardPaging =
            CollectionResponseWithTotalPublicChannelIntegrationChannelForwardPaging(
    ...
    fun validate(): CollectionResponseWithTotalPublicChannelIntegrationChannelForwardPaging =
        apply {
            if (validated) {
                return@apply
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionResponseWithTotalPublicChannelIntegrationChannelForwardPaging &&
    ...
    override fun toString() =
        "CollectionResponseWithTotalPublicChannelIntegrationChannelForwardPaging{results=$results, total=$total, paging=$paging, additionalProperties=$additionalProperties}"
}
