...
private constructor(
    ...
    override fun nextPage(): AppointmentListPage = service.list(nextPageParams())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AppointmentListPage].
         *
    ...
    /** A builder for [AppointmentListPage]. */
    class Builder internal constructor() {

        private var service: AppointmentService? = null
        ...
        @JvmSynthetic
        internal fun from(appointmentListPage: AppointmentListPage) = apply {
            service = appointmentListPage.service
            params = appointmentListPage.params
            response = appointmentListPage.response
        }

        fun service(service: AppointmentService) = apply { this.service = service }
        ...
        /**
         * Returns an immutable instance of [AppointmentListPage].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AppointmentListPage &&
    ...
    override fun toString() =
        "AppointmentListPage{service=$service, params=$params, response=$response}"
}
