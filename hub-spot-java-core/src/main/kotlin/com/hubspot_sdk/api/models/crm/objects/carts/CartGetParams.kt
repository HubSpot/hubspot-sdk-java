...
/**
 * Read an Object identified by `{cartId}`. `{cartId}` refers to the internal object ID by default,
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(cartGetParams: CartGetParams) = apply {
            cartId = cartGetParams.cartId
            archived = cartGetParams.archived
            associations = cartGetParams.associations?.toMutableList()
            idProperty = cartGetParams.idProperty
            properties = cartGetParams.properties?.toMutableList()
            propertiesWithHistory = cartGetParams.propertiesWithHistory?.toMutableList()
    ...
    override fun toString() =
        "CartGetParams{cartId=$cartId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
