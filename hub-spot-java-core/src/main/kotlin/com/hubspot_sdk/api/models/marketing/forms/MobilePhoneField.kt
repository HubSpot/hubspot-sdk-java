...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MobilePhoneField].
         *
    ...
    /** A builder for [MobilePhoneField]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(mobilePhoneField: MobilePhoneField) = apply {
            dependentFields = mobilePhoneField.dependentFields.map { it.toMutableList() }
            fieldType = mobilePhoneField.fieldType
            hidden = mobilePhoneField.hidden
            label = mobilePhoneField.label
            name = mobilePhoneField.name
            objectTypeId = mobilePhoneField.objectTypeId
            required = mobilePhoneField.required
            validation = mobilePhoneField.validation
            defaultValue = mobilePhoneField.defaultValue
            description = mobilePhoneField.description
            placeholder = mobilePhoneField.placeholder
            additionalProperties = mobilePhoneField.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MobilePhoneField].
         *
    ...
    fun validate(): MobilePhoneField = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MobilePhoneField &&
    ...
    override fun toString() =
        "MobilePhoneField{dependentFields=$dependentFields, fieldType=$fieldType, hidden=$hidden, label=$label, name=$name, objectTypeId=$objectTypeId, required=$required, validation=$validation, defaultValue=$defaultValue, description=$description, placeholder=$placeholder, additionalProperties=$additionalProperties}"
}
