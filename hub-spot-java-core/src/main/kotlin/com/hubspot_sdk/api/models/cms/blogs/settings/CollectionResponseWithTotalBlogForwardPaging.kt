...
class CollectionResponseWithTotalBlogForwardPaging
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val results: JsonField<List<Blog>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("results") @ExcludeMissing results: JsonField<List<Blog>> = JsonMissing.of(),
     ...
     */
    fun results(): List<Blog> = results.getRequired("results")
     ...
     */
    @JsonProperty("results") @ExcludeMissing fun _results(): JsonField<List<Blog>> = results
    ...
    /** A builder for [CollectionResponseWithTotalBlogForwardPaging]. */
    class Builder internal constructor() {

        private var results: JsonField<MutableList<Blog>>? = null
        ...
        internal fun from(
            ...
            results =
                collectionResponseWithTotalBlogForwardPaging.results.map { it.toMutableList() }
            total = collectionResponseWithTotalBlogForwardPaging.total
            paging = collectionResponseWithTotalBlogForwardPaging.paging
            additionalProperties =
                collectionResponseWithTotalBlogForwardPaging.additionalProperties.toMutableMap()
        }

        /** Collection of blogs. */
        fun results(results: List<Blog>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed `List<Blog>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun results(results: JsonField<List<Blog>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [Blog] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: Blog) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [CollectionResponseWithTotalBlogForwardPaging].
         *
         ...
         */
        fun build(): CollectionResponseWithTotalBlogForwardPaging =
            CollectionResponseWithTotalBlogForwardPaging(
    ...
    fun validate(): CollectionResponseWithTotalBlogForwardPaging = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionResponseWithTotalBlogForwardPaging &&
    ...
    override fun toString() =
        "CollectionResponseWithTotalBlogForwardPaging{results=$results, total=$total, paging=$paging, additionalProperties=$additionalProperties}"
}
