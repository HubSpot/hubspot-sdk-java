...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(stringPropertyVariable: StringPropertyVariable) = apply {
            ...
            inputs = stringPropertyVariable.inputs.map { it.toMutableList() }
    ...
    override fun toString() =
        "StringPropertyVariable{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
