...
private constructor(
    ...
    private val results: JsonField<List<TimelineEventResponse>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        results: JsonField<List<TimelineEventResponse>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun results(): List<TimelineEventResponse> = results.getRequired("results")
    ...
    @JsonProperty("results")
    @ExcludeMissing
    fun _results(): JsonField<List<TimelineEventResponse>> = results
    ...
    /** A builder for [BatchResponseTimelineEventResponseWithErrors]. */
    class Builder internal constructor() {

        private var completedAt: JsonField<OffsetDateTime>? = null
        private var results: JsonField<MutableList<TimelineEventResponse>>? = null
        ...
        internal fun from(
            ...
            completedAt = batchResponseTimelineEventResponseWithErrors.completedAt
            results =
                batchResponseTimelineEventResponseWithErrors.results.map { it.toMutableList() }
            startedAt = batchResponseTimelineEventResponseWithErrors.startedAt
            status = batchResponseTimelineEventResponseWithErrors.status
            errors = batchResponseTimelineEventResponseWithErrors.errors.map { it.toMutableList() }
            links = batchResponseTimelineEventResponseWithErrors.links
            numErrors = batchResponseTimelineEventResponseWithErrors.numErrors
            requestedAt = batchResponseTimelineEventResponseWithErrors.requestedAt
            additionalProperties =
                batchResponseTimelineEventResponseWithErrors.additionalProperties.toMutableMap()
        }
        ...
        fun results(results: List<TimelineEventResponse>) = results(JsonField.of(results))

        /**
         * Sets [Builder.results] to an arbitrary JSON value.
         *
         * You should usually call [Builder.results] with a well-typed `List<TimelineEventResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun results(results: JsonField<List<TimelineEventResponse>>) = apply {
            this.results = results.map { it.toMutableList() }
        }

        /**
         * Adds a single [TimelineEventResponse] to [results].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addResult(result: TimelineEventResponse) = apply {
            results =
        ...
        /**
         * Returns an immutable instance of [BatchResponseTimelineEventResponseWithErrors].
         *
         ...
         */
        fun build(): BatchResponseTimelineEventResponseWithErrors =
            BatchResponseTimelineEventResponseWithErrors(
    ...
    fun validate(): BatchResponseTimelineEventResponseWithErrors = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseTimelineEventResponseWithErrors &&
    ...
    override fun toString() =
        "BatchResponseTimelineEventResponseWithErrors{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, errors=$errors, links=$links, numErrors=$numErrors, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
