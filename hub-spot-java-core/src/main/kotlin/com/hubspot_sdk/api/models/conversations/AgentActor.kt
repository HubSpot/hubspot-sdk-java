...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AgentActor].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(agentActor: AgentActor) = apply {
            id = agentActor.id
            type = agentActor.type
            avatar = agentActor.avatar
            email = agentActor.email
            name = agentActor.name
            additionalProperties = agentActor.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AgentActor].
         *
    ...
    override fun toString() =
        "AgentActor{id=$id, type=$type, avatar=$avatar, email=$email, name=$name, additionalProperties=$additionalProperties}"
}
