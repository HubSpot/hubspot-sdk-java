...
package com.hubspot_sdk.api.models.crm.objects.communications
...
private constructor(
    ...
    fun communicationId(): Optional<String> = Optional.ofNullable(communicationId)
    ...
    companion object {
        ...
        @JvmStatic fun none(): CommunicationReadParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [CommunicationReadParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CommunicationReadParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(communicationReadParams: CommunicationReadParams) = apply {
            communicationId = communicationReadParams.communicationId
            archived = communicationReadParams.archived
            associations = communicationReadParams.associations?.toMutableList()
            idProperty = communicationReadParams.idProperty
            properties = communicationReadParams.properties?.toMutableList()
            propertiesWithHistory = communicationReadParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = communicationReadParams.additionalHeaders.toBuilder()
            additionalQueryParams = communicationReadParams.additionalQueryParams.toBuilder()
        }

        fun communicationId(communicationId: String?) = apply {
            this.communicationId = communicationId
        }

        /** Alias for calling [Builder.communicationId] with `communicationId.orElse(null)`. */
        fun communicationId(communicationId: Optional<String>) =
            communicationId(communicationId.getOrNull())
        ...
        /**
         * Returns an immutable instance of [CommunicationReadParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CommunicationReadParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CommunicationReadParams &&
    ...
    override fun toString() =
        "CommunicationReadParams{communicationId=$communicationId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
