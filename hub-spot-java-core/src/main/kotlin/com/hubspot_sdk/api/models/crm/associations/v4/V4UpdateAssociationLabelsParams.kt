...
class V4UpdateAssociationLabelsParams
private constructor(
    ...
    /** A builder for [V4UpdateAssociationLabelsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(v4UpdateAssociationLabelsParams: V4UpdateAssociationLabelsParams) =
            apply {
                objectType = v4UpdateAssociationLabelsParams.objectType
                objectId = v4UpdateAssociationLabelsParams.objectId
                toObjectType = v4UpdateAssociationLabelsParams.toObjectType
                toObjectId = v4UpdateAssociationLabelsParams.toObjectId
                body = v4UpdateAssociationLabelsParams.body.toMutableList()
                additionalHeaders = v4UpdateAssociationLabelsParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    v4UpdateAssociationLabelsParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [V4UpdateAssociationLabelsParams].
         *
         ...
         */
        fun build(): V4UpdateAssociationLabelsParams =
            V4UpdateAssociationLabelsParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is V4UpdateAssociationLabelsParams &&
    ...
    override fun toString() =
        "V4UpdateAssociationLabelsParams{objectType=$objectType, objectId=$objectId, toObjectType=$toObjectType, toObjectId=$toObjectId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
