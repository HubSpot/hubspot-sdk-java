...
private constructor(
    ...
    /** A builder for [BatchResponseTimelineEventResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchResponseTimelineEventResponse: BatchResponseTimelineEventResponse) =
            apply {
                completedAt = batchResponseTimelineEventResponse.completedAt
                results = batchResponseTimelineEventResponse.results.map { it.toMutableList() }
                startedAt = batchResponseTimelineEventResponse.startedAt
                status = batchResponseTimelineEventResponse.status
                links = batchResponseTimelineEventResponse.links
                requestedAt = batchResponseTimelineEventResponse.requestedAt
                additionalProperties =
                    batchResponseTimelineEventResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BatchResponseTimelineEventResponse].
         *
         ...
         */
        fun build(): BatchResponseTimelineEventResponse =
            BatchResponseTimelineEventResponse(
    ...
    fun validate(): BatchResponseTimelineEventResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseTimelineEventResponse &&
    ...
    override fun toString() =
        "BatchResponseTimelineEventResponse{completedAt=$completedAt, results=$results, startedAt=$startedAt, status=$status, links=$links, requestedAt=$requestedAt, additionalProperties=$additionalProperties}"
}
