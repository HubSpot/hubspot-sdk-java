...
class CreatedResponseProperty
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val createdResourceId: JsonField<String>,
    private val entity: JsonField<Property>,
    ...
    private constructor(
        ...
        @JsonProperty("entity") @ExcludeMissing entity: JsonField<Property> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun entity(): Property = entity.getRequired("entity")
     ...
     */
    @JsonProperty("entity") @ExcludeMissing fun _entity(): JsonField<Property> = entity
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CreatedResponseProperty].
         *
    ...
    /** A builder for [CreatedResponseProperty]. */
    class Builder internal constructor() {

        private var createdResourceId: JsonField<String>? = null
        private var entity: JsonField<Property>? = null
        private var location: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(createdResponseProperty: CreatedResponseProperty) = apply {
            createdResourceId = createdResponseProperty.createdResourceId
            entity = createdResponseProperty.entity
            location = createdResponseProperty.location
            additionalProperties = createdResponseProperty.additionalProperties.toMutableMap()
        }
        ...
        /** Defines a property */
        fun entity(entity: Property) = entity(JsonField.of(entity))

        /**
         * Sets [Builder.entity] to an arbitrary JSON value.
         *
         * You should usually call [Builder.entity] with a well-typed [Property] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun entity(entity: JsonField<Property>) = apply { this.entity = entity }
        ...
        /**
         * Returns an immutable instance of [CreatedResponseProperty].
         *
         ...
         */
        fun build(): CreatedResponseProperty =
    ...
    fun validate(): CreatedResponseProperty = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CreatedResponseProperty &&
    ...
    override fun toString() =
        "CreatedResponseProperty{createdResourceId=$createdResourceId, entity=$entity, location=$location, additionalProperties=$additionalProperties}"
}
