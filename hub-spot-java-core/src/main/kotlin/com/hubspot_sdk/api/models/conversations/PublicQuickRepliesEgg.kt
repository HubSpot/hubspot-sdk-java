...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicQuickRepliesEgg].
         *
    ...
    /** A builder for [PublicQuickRepliesEgg]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicQuickRepliesEgg: PublicQuickRepliesEgg) = apply {
            quickReplies = publicQuickRepliesEgg.quickReplies.map { it.toMutableList() }
            type = publicQuickRepliesEgg.type
            additionalProperties = publicQuickRepliesEgg.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicQuickRepliesEgg].
         *
         ...
         */
        fun build(): PublicQuickRepliesEgg =
    ...
    fun validate(): PublicQuickRepliesEgg = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicQuickRepliesEgg &&
    ...
    override fun toString() =
        "PublicQuickRepliesEgg{quickReplies=$quickReplies, type=$type, additionalProperties=$additionalProperties}"
}
