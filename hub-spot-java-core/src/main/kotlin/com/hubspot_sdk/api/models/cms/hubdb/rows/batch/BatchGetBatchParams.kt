...
/**
 * Returns rows in the published version of the specified table, given a set of row IDs. **Note:**
 * This endpoint can be accessed without any authentication if the table is set to be allowed for
 * public access.
 */
class BatchGetBatchParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchGetBatchParams].
         *
    ...
    /** A builder for [BatchGetBatchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchGetBatchParams: BatchGetBatchParams) = apply {
            tableIdOrName = batchGetBatchParams.tableIdOrName
            batchInputString = batchGetBatchParams.batchInputString
            additionalHeaders = batchGetBatchParams.additionalHeaders.toBuilder()
            additionalQueryParams = batchGetBatchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BatchGetBatchParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchGetBatchParams &&
    ...
    override fun toString() =
        "BatchGetBatchParams{tableIdOrName=$tableIdOrName, batchInputString=$batchInputString, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
