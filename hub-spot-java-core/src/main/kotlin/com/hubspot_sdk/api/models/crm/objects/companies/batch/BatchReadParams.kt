...
package com.hubspot_sdk.api.models.crm.objects.companies.batch
...
/**
 * Retrieve a batch of companies by ID (`companyId`) or by a unique property (`idProperty`). You can
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(batchReadParams: BatchReadParams) = apply {
            archived = batchReadParams.archived
            batchReadInputSimplePublicObjectId = batchReadParams.batchReadInputSimplePublicObjectId
    ...
    override fun toString() =
        "BatchReadParams{archived=$archived, batchReadInputSimplePublicObjectId=$batchReadInputSimplePublicObjectId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
