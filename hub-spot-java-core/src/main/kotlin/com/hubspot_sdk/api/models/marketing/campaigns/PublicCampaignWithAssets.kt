...
class PublicCampaignWithAssets
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val id: JsonField<String>,
    private val assets: JsonField<Assets>,
    ...
    private constructor(
        ...
        @JsonProperty("assets") @ExcludeMissing assets: JsonField<Assets> = JsonMissing.of(),
    ...
    ) : this(id, assets, businessUnits, createdAt, properties, updatedAt, mutableMapOf())
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun assets(): Assets = assets.getRequired("assets")
     ...
     */
    @JsonProperty("assets") @ExcludeMissing fun _assets(): JsonField<Assets> = assets
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicCampaignWithAssets].
         *
    ...
    /** A builder for [PublicCampaignWithAssets]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var assets: JsonField<Assets>? = null
        ...
        @JvmSynthetic
        internal fun from(publicCampaignWithAssets: PublicCampaignWithAssets) = apply {
            id = publicCampaignWithAssets.id
            assets = publicCampaignWithAssets.assets
            businessUnits = publicCampaignWithAssets.businessUnits.map { it.toMutableList() }
            createdAt = publicCampaignWithAssets.createdAt
            properties = publicCampaignWithAssets.properties
            updatedAt = publicCampaignWithAssets.updatedAt
            additionalProperties = publicCampaignWithAssets.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.assets] with a well-typed [Assets] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun assets(assets: JsonField<Assets>) = apply { this.assets = assets }
        ...
        /**
         * Returns an immutable instance of [PublicCampaignWithAssets].
         *
         ...
         */
        fun build(): PublicCampaignWithAssets =
    ...
    fun validate(): PublicCampaignWithAssets = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            (assets.asKnown().getOrNull()?.validity() ?: 0) +
    ...
    private constructor(
        ...
        companion object {
            ...
            /** Returns a mutable builder for constructing an instance of [Assets]. */
            @JvmStatic fun builder() = Builder()
        }
        ...
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(assets: Assets) = apply {
                additionalProperties = assets.additionalProperties.toMutableMap()
            }
            ...
            /**
             * Returns an immutable instance of [Assets].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Assets = Assets(additionalProperties.toImmutable())
        }

        private var validated: Boolean = false

        fun validate(): Assets = apply {
            if (validated) {
                return@apply
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Assets && additionalProperties == other.additionalProperties
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicCampaignWithAssets &&
            id == other.id &&
            assets == other.assets &&
    ...
    override fun toString() =
        "PublicCampaignWithAssets{id=$id, assets=$assets, businessUnits=$businessUnits, createdAt=$createdAt, properties=$properties, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
