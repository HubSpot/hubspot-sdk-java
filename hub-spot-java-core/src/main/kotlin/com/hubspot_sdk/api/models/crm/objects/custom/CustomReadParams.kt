...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CustomReadParams].
         *
    ...
    /** A builder for [CustomReadParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customReadParams: CustomReadParams) = apply {
            objectType = customReadParams.objectType
            objectId = customReadParams.objectId
            archived = customReadParams.archived
            associations = customReadParams.associations?.toMutableList()
            idProperty = customReadParams.idProperty
            properties = customReadParams.properties?.toMutableList()
            propertiesWithHistory = customReadParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = customReadParams.additionalHeaders.toBuilder()
            additionalQueryParams = customReadParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CustomReadParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomReadParams &&
    ...
    override fun toString() =
        "CustomReadParams{objectType=$objectType, objectId=$objectId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
