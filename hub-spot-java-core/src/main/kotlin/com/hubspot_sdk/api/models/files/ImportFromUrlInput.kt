...
private constructor(
     ...
     */
    fun duplicateValidationScope(): Optional<DuplicateValidationScope> =
        duplicateValidationScope.getOptional("duplicateValidationScope")
     ...
     *   server responded with an unexpected value).
     */
    fun duplicateValidationStrategy(): Optional<DuplicateValidationStrategy> =
        duplicateValidationStrategy.getOptional("duplicateValidationStrategy")
    ...
    class Builder internal constructor() {
        ...
        private var duplicateValidationScope: JsonField<DuplicateValidationScope> = JsonMissing.of()
        private var duplicateValidationStrategy: JsonField<DuplicateValidationStrategy> =
            JsonMissing.of()
    ...
    fun validate(): ImportFromUrlInput = apply {
        ...
        access().validate()
        url()
        duplicateValidationScope().ifPresent { it.validate() }
        duplicateValidationStrategy().ifPresent { it.validate() }
        expiresAt()
        folderId()
        folderPath()
        name()
    ...
    override fun toString() =
        "ImportFromUrlInput{access=$access, url=$url, duplicateValidationScope=$duplicateValidationScope, duplicateValidationStrategy=$duplicateValidationStrategy, expiresAt=$expiresAt, folderId=$folderId, folderPath=$folderPath, name=$name, overwrite=$overwrite, ttl=$ttl, additionalProperties=$additionalProperties}"
}
