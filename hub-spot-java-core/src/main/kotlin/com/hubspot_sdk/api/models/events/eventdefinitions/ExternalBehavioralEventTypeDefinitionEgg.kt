...
private constructor(
    ...
    override fun toString() =
        "ExternalBehavioralEventTypeDefinitionEgg{label=$label, propertyDefinitions=$propertyDefinitions, description=$description, name=$name, primaryObject=$primaryObject, additionalProperties=$additionalProperties}"
}
