...
private constructor(
     ...
     * will be ignored. Usage of this parameter will reduce the maximum number of tickets that can
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ticketListParams: TicketListParams) = apply {
            after = ticketListParams.after
            archived = ticketListParams.archived
            associations = ticketListParams.associations?.toMutableList()
            limit = ticketListParams.limit
            properties = ticketListParams.properties?.toMutableList()
            propertiesWithHistory = ticketListParams.propertiesWithHistory?.toMutableList()
         ...
         * of tickets that can be read by a single request.
         */
    ...
    override fun toString() =
        "TicketListParams{after=$after, archived=$archived, associations=$associations, limit=$limit, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
