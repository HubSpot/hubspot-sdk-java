...
class CollectionResponseWithTotalVersionBlog
...
private constructor(
    ...
    /** A builder for [CollectionResponseWithTotalVersionBlog]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            collectionResponseWithTotalVersionBlog: CollectionResponseWithTotalVersionBlog
        ) = apply {
            results = collectionResponseWithTotalVersionBlog.results.map { it.toMutableList() }
            total = collectionResponseWithTotalVersionBlog.total
            paging = collectionResponseWithTotalVersionBlog.paging
            additionalProperties =
                collectionResponseWithTotalVersionBlog.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CollectionResponseWithTotalVersionBlog].
         *
         ...
         */
        fun build(): CollectionResponseWithTotalVersionBlog =
            CollectionResponseWithTotalVersionBlog(
    ...
    fun validate(): CollectionResponseWithTotalVersionBlog = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CollectionResponseWithTotalVersionBlog &&
    ...
    override fun toString() =
        "CollectionResponseWithTotalVersionBlog{results=$results, total=$total, paging=$paging, additionalProperties=$additionalProperties}"
}
