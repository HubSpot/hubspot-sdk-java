...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AssociationSpec1].
         *
    ...
    /** A builder for [AssociationSpec1]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(associationSpec1: AssociationSpec1) = apply {
            associationCategory = associationSpec1.associationCategory
            associationTypeId = associationSpec1.associationTypeId
            additionalProperties = associationSpec1.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AssociationSpec1].
         *
    ...
    fun validate(): AssociationSpec1 = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AssociationSpec1 &&
    ...
    override fun toString() =
        "AssociationSpec1{associationCategory=$associationCategory, associationTypeId=$associationTypeId, additionalProperties=$additionalProperties}"
}
