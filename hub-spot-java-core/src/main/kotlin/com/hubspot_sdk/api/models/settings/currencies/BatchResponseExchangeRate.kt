...
class BatchResponseExchangeRate
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchResponseExchangeRate].
         *
    ...
    /** A builder for [BatchResponseExchangeRate]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchResponseExchangeRate: BatchResponseExchangeRate) = apply {
            completedAt = batchResponseExchangeRate.completedAt
        ...
        /**
         * Returns an immutable instance of [BatchResponseExchangeRate].
         *
         ...
         */
        fun build(): BatchResponseExchangeRate =
    ...
    fun validate(): BatchResponseExchangeRate = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchResponseExchangeRate &&
