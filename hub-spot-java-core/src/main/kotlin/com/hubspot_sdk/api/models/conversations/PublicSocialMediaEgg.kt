...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PublicSocialMediaEgg].
         *
    ...
    /** A builder for [PublicSocialMediaEgg]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(publicSocialMediaEgg: PublicSocialMediaEgg) = apply {
            socialMetadata = publicSocialMediaEgg.socialMetadata
            type = publicSocialMediaEgg.type
            additionalProperties = publicSocialMediaEgg.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PublicSocialMediaEgg].
         *
         ...
         */
        fun build(): PublicSocialMediaEgg =
    ...
    fun validate(): PublicSocialMediaEgg = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PublicSocialMediaEgg &&
    ...
    override fun toString() =
        "PublicSocialMediaEgg{socialMetadata=$socialMetadata, type=$type, additionalProperties=$additionalProperties}"
}
