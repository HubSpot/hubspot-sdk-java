...
private constructor(
    ...
    ) : this(id, type, avatar, email, name, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VisitorActor].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(visitorActor: VisitorActor) = apply {
            id = visitorActor.id
            type = visitorActor.type
            avatar = visitorActor.avatar
            email = visitorActor.email
            name = visitorActor.name
            additionalProperties = visitorActor.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [VisitorActor].
         *
    ...
    fun validate(): VisitorActor = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val VISITOR = of("VISITOR")
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, type, avatar, email, name, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "VisitorActor{id=$id, type=$type, avatar=$avatar, email=$email, name=$name, additionalProperties=$additionalProperties}"
}
