...
private constructor(
    ...
    override fun toString() =
        "SimplePublicUpsertObject{id=$id, createdAt=$createdAt, new_=$new_, properties=$properties, updatedAt=$updatedAt, archived=$archived, archivedAt=$archivedAt, objectWriteTraceId=$objectWriteTraceId, propertiesWithHistory=$propertiesWithHistory, additionalProperties=$additionalProperties}"
}
