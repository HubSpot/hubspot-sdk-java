...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(constantBoolean: ConstantBoolean) = apply {
            ...
            inputs = constantBoolean.inputs.map { it.toMutableList() }
    ...
    override fun toString() =
        "ConstantBoolean{operator=$operator, inputs=$inputs, propertyName=$propertyName, value=$value, additionalProperties=$additionalProperties}"
}
