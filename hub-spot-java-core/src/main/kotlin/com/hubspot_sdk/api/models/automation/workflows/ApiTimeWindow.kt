...
private constructor(
    ...
    private val endTime: JsonField<ApiTimeOfDay>,
    private val startTime: JsonField<ApiTimeOfDay>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        endTime: JsonField<ApiTimeOfDay> = JsonMissing.of(),
        @JsonProperty("startTime")
        @ExcludeMissing
        startTime: JsonField<ApiTimeOfDay> = JsonMissing.of(),
    ) : this(day, endTime, startTime, mutableMapOf())
     ...
     */
    @JsonProperty("endTime") @ExcludeMissing fun _endTime(): JsonField<ApiTimeOfDay> = endTime
     ...
     */
    @JsonProperty("startTime") @ExcludeMissing fun _startTime(): JsonField<ApiTimeOfDay> = startTime
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ApiTimeWindow].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(apiTimeWindow: ApiTimeWindow) = apply {
            day = apiTimeWindow.day
            endTime = apiTimeWindow.endTime
            startTime = apiTimeWindow.startTime
            additionalProperties = apiTimeWindow.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.day] with a well-typed [Day] value instead. This method
         * is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun day(day: JsonField<Day>) = apply { this.day = day }

        fun endTime(endTime: ApiTimeOfDay) = endTime(JsonField.of(endTime))

        /**
         * Sets [Builder.endTime] to an arbitrary JSON value.
         *
         * You should usually call [Builder.endTime] with a well-typed [ApiTimeOfDay] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun endTime(endTime: JsonField<ApiTimeOfDay>) = apply { this.endTime = endTime }

        fun startTime(startTime: ApiTimeOfDay) = startTime(JsonField.of(startTime))

        /**
         * Sets [Builder.startTime] to an arbitrary JSON value.
         *
         * You should usually call [Builder.startTime] with a well-typed [ApiTimeOfDay] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun startTime(startTime: JsonField<ApiTimeOfDay>) = apply { this.startTime = startTime }
        ...
        /**
         * Returns an immutable instance of [ApiTimeWindow].
         *
    ...
    fun validate(): ApiTimeWindow = apply {
        if (validated) {
            return@apply
        }
    ...
    private val hashCode: Int by lazy {
        Objects.hash(day, endTime, startTime, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ApiTimeWindow{day=$day, endTime=$endTime, startTime=$startTime, additionalProperties=$additionalProperties}"
}
