...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BatchUpdateBatchParams].
         *
    ...
    /** A builder for [BatchUpdateBatchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(batchUpdateBatchParams: BatchUpdateBatchParams) = apply {
            tableIdOrName = batchUpdateBatchParams.tableIdOrName
            batchInputHubDbTableRowV3BatchUpdateRequest =
                batchUpdateBatchParams.batchInputHubDbTableRowV3BatchUpdateRequest
            additionalHeaders = batchUpdateBatchParams.additionalHeaders.toBuilder()
            additionalQueryParams = batchUpdateBatchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BatchUpdateBatchParams].
         *
         ...
         */
        fun build(): BatchUpdateBatchParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BatchUpdateBatchParams &&
    ...
    override fun toString() =
        "BatchUpdateBatchParams{tableIdOrName=$tableIdOrName, batchInputHubDbTableRowV3BatchUpdateRequest=$batchInputHubDbTableRowV3BatchUpdateRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
