...
class ApiAuthKeyWebhookAuthSettings
...
private constructor(
     ...
     */
    @JsonProperty("secretName") @ExcludeMissing fun _secretName(): JsonField<String> = secretName
    ...
    /** A builder for [ApiAuthKeyWebhookAuthSettings]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(apiAuthKeyWebhookAuthSettings: ApiAuthKeyWebhookAuthSettings) = apply {
            location = apiAuthKeyWebhookAuthSettings.location
            name = apiAuthKeyWebhookAuthSettings.name
            secretName = apiAuthKeyWebhookAuthSettings.secretName
            type = apiAuthKeyWebhookAuthSettings.type
        ...
        /**
         * Returns an immutable instance of [ApiAuthKeyWebhookAuthSettings].
         *
         ...
         */
        fun build(): ApiAuthKeyWebhookAuthSettings =
            ApiAuthKeyWebhookAuthSettings(
    ...
    fun validate(): ApiAuthKeyWebhookAuthSettings = apply {
        if (validated) {
            return@apply
        }
    ...
    class Location @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val QUERY_PARAM = of("QUERY_PARAM")

            @JvmStatic fun of(value: String) = Location(JsonField.of(value))
        }
        ...
        enum class Value {
            HEADER,
            QUERY_PARAM,
            /** An enum member indicating that [Location] was instantiated with an unknown value. */
            _UNKNOWN,
        }
        ...
        fun known(): Known =
            when (this) {
                HEADER -> Known.HEADER
                QUERY_PARAM -> Known.QUERY_PARAM
                else -> throw HubSpotInvalidDataException("Unknown Location: $value")
            }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val AUTH_KEY = of("AUTH_KEY")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ApiAuthKeyWebhookAuthSettings &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(location, name, secretName, type, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ApiAuthKeyWebhookAuthSettings{location=$location, name=$name, secretName=$secretName, type=$type, additionalProperties=$additionalProperties}"
}
