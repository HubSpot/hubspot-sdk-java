 ...
 * value as specified by the `idProperty` query param. `{feeId}` refers to the internal object ID by
 * default, and the `idProperty` query param refers to a property whose values are unique for the
 * object. Provided property values will be overwritten. Read-only and non-existent properties will
 * result in an error. Properties values can be cleared by passing an empty string.
 */
class FeeUpdateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FeeUpdateParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(feeUpdateParams: FeeUpdateParams) = apply {
            feeId = feeUpdateParams.feeId
            idProperty = feeUpdateParams.idProperty
            simplePublicObjectInput = feeUpdateParams.simplePublicObjectInput
            additionalHeaders = feeUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = feeUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FeeUpdateParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeeUpdateParams &&
            feeId == other.feeId &&
    ...
    override fun toString() =
        "FeeUpdateParams{feeId=$feeId, idProperty=$idProperty, simplePublicObjectInput=$simplePublicObjectInput, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
