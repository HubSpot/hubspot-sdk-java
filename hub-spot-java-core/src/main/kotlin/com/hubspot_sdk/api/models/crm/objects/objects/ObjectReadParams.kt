...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ObjectReadParams].
         *
    ...
    /** A builder for [ObjectReadParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(objectReadParams: ObjectReadParams) = apply {
            objectType = objectReadParams.objectType
            objectId = objectReadParams.objectId
            archived = objectReadParams.archived
            associations = objectReadParams.associations?.toMutableList()
            idProperty = objectReadParams.idProperty
            properties = objectReadParams.properties?.toMutableList()
            propertiesWithHistory = objectReadParams.propertiesWithHistory?.toMutableList()
            additionalHeaders = objectReadParams.additionalHeaders.toBuilder()
            additionalQueryParams = objectReadParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ObjectReadParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ObjectReadParams &&
    ...
    override fun toString() =
        "ObjectReadParams{objectType=$objectType, objectId=$objectId, archived=$archived, associations=$associations, idProperty=$idProperty, properties=$properties, propertiesWithHistory=$propertiesWithHistory, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
