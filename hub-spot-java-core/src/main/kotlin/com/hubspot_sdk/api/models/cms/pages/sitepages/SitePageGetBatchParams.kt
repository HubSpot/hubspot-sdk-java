...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SitePageGetBatchParams].
         *
    ...
    /** A builder for [SitePageGetBatchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sitePageGetBatchParams: SitePageGetBatchParams) = apply {
            archived = sitePageGetBatchParams.archived
            batchInputString = sitePageGetBatchParams.batchInputString
            additionalHeaders = sitePageGetBatchParams.additionalHeaders.toBuilder()
            additionalQueryParams = sitePageGetBatchParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SitePageGetBatchParams].
         *
         ...
         */
        fun build(): SitePageGetBatchParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SitePageGetBatchParams &&
    ...
    override fun toString() =
        "SitePageGetBatchParams{archived=$archived, batchInputString=$batchInputString, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
