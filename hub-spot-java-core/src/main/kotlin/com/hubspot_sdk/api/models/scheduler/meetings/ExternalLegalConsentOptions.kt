...
private constructor(
    ...
    private val processingConsentType: JsonField<String>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        processingConsentType: JsonField<String> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun processingConsentType(): String = processingConsentType.getRequired("processingConsentType")
    ...
    @JsonProperty("processingConsentType")
    @ExcludeMissing
    fun _processingConsentType(): JsonField<String> = processingConsentType
    ...
    class Builder internal constructor() {
        ...
        private var processingConsentType: JsonField<String>? = null
        ...
        fun processingConsentType(processingConsentType: String) =
            processingConsentType(JsonField.of(processingConsentType))

        /**
         * Sets [Builder.processingConsentType] to an arbitrary JSON value.
         *
         * You should usually call [Builder.processingConsentType] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun processingConsentType(processingConsentType: JsonField<String>) = apply {
    ...
    internal fun validity(): Int =
        (communicationConsentCheckboxes.asKnown().getOrNull()?.sumOf { it.validity().toInt() }
            ...
            (if (processingConsentType.asKnown().isPresent) 1 else 0) +
