...
import com.hubspot_sdk.api.models.marketing.transactional.CollectionResponseSmtpApiTokenViewForwardPaging
        ...
        override fun create(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("marketing", "v3", "transactional", "smtp-tokens")
