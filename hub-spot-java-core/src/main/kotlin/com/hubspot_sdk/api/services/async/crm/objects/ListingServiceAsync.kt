...
interface ListingServiceAsync {
     ...
     */
    fun create(params: ListingCreateParams): CompletableFuture<CreatedResponseSimplePublicObject> =
    ...
    interface WithRawResponse {
         ...
         * the same as [ListingServiceAsync.get].
         */
        fun get(
            listingId: String
         ...
         * same as [ListingServiceAsync.search].
         */
        fun search(
            params: ListingSearchParams
