...
interface CourseServiceAsync {
     ...
     */
    fun create(params: CourseCreateParams): CompletableFuture<CreatedResponseSimplePublicObject> =
    ...
    interface WithRawResponse {
         ...
         * the same as [CourseServiceAsync.get].
         */
        fun get(
            courseId: String
         ...
         * same as [CourseServiceAsync.search].
         */
        fun search(
            params: CourseSearchParams
