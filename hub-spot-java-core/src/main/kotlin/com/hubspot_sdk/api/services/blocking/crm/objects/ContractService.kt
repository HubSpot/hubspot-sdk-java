...
interface ContractService {
     ...
     */
    fun create(params: ContractCreateParams): CreatedResponseSimplePublicObject =
    ...
    interface WithRawResponse {
         ...
         * same as [ContractService.create].
         */
        @MustBeClosed
        fun create(
            params: ContractCreateParams
         ...
         * the same as [ContractService.search].
         */
        @MustBeClosed
        fun search(
            params: ContractSearchParams
