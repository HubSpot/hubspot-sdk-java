...
interface MeetingService {
     ...
     */
    fun create(params: MeetingCreateParams): CreatedResponseSimplePublicObject =
    ...
    interface WithRawResponse {
         ...
         * otherwise the same as [MeetingService.delete].
         */
        @MustBeClosed
         ...
         * the same as [MeetingService.search].
         */
        @MustBeClosed
        fun search(
            params: MeetingSearchParams
