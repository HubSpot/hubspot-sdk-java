...
interface ContractServiceAsync {
     ...
     */
    fun create(params: ContractCreateParams): CompletableFuture<CreatedResponseSimplePublicObject> =
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/contracts`, but is otherwise the
         * same as [ContractServiceAsync.create].
         */
        fun create(
            params: ContractCreateParams
        ...
        /**
         * Returns a raw HTTP response for `patch /crm/v3/objects/contracts/{contractId}`, but is
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/objects/contracts`, but is otherwise the
         * same as [ContractServiceAsync.list].
         */
        ...
        /**
         * Returns a raw HTTP response for `delete /crm/v3/objects/contracts/{contractId}`, but is
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/objects/contracts/{contractId}`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/contracts/search`, but is otherwise
         * the same as [ContractServiceAsync.search].
         */
        fun search(
            params: ContractSearchParams
