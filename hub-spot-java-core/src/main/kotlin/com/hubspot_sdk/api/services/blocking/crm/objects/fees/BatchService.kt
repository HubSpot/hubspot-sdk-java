...
interface BatchService {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/fees/batch/create`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/fees/batch/update`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/fees/batch/archive`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/fees/batch/read`, but is otherwise
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/fees/batch/upsert`, but is
