...
interface SmtpTokenService {
    ...
    interface WithRawResponse {
         ...
         * otherwise the same as [SmtpTokenService.create].
         */
        @MustBeClosed
         ...
         * otherwise the same as [SmtpTokenService.list].
         */
        @MustBeClosed
         ...
         * but is otherwise the same as [SmtpTokenService.get].
         */
        @MustBeClosed
         ...
         * same as [SmtpTokenService.resetPassword].
         */
        @MustBeClosed
