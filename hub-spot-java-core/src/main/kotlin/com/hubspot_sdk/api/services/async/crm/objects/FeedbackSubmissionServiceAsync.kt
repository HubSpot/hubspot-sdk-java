...
interface FeedbackSubmissionServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/objects/feedback_submissions`, but is
         ...
         * /crm/v3/objects/feedback_submissions/{feedbackSubmissionId}`, but is otherwise the same
         * as [FeedbackSubmissionServiceAsync.get].
         */
        fun get(
            feedbackSubmissionId: String
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/feedback_submissions/search`, but
         * is otherwise the same as [FeedbackSubmissionServiceAsync.search].
         */
        fun search(
            params: FeedbackSubmissionSearchParams
