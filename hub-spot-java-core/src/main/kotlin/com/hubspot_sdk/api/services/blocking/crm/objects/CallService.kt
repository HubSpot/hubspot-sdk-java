...
import com.hubspot_sdk.api.models.crm.objects.calls.CallDeleteParams
import com.hubspot_sdk.api.models.crm.objects.calls.CallGetParams
import com.hubspot_sdk.api.models.crm.objects.calls.CallListPage
import com.hubspot_sdk.api.models.crm.objects.calls.CallListParams
import com.hubspot_sdk.api.models.crm.objects.calls.CallSearchParams
import com.hubspot_sdk.api.models.crm.objects.calls.CallUpdateParams
import com.hubspot_sdk.api.services.blocking.crm.objects.calls.BatchService
...
interface CallService {
     ...
     */
    fun create(params: CallCreateParams): CreatedResponseSimplePublicObject =
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/calls`, but is otherwise the same
         * as [CallService.create].
         */
        @MustBeClosed
        fun create(params: CallCreateParams): HttpResponseFor<CreatedResponseSimplePublicObject> =
            create(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `patch /crm/v3/objects/calls/{callId}`, but is otherwise
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/objects/calls`, but is otherwise the same as
         * [CallService.list].
         */
        ...
        /**
         * Returns a raw HTTP response for `delete /crm/v3/objects/calls/{callId}`, but is otherwise
         * the same as [CallService.delete].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/objects/calls/{callId}`, but is otherwise
         * the same as [CallService.get].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/calls/search`, but is otherwise the
         * same as [CallService.search].
         */
        @MustBeClosed
        fun search(
            params: CallSearchParams
