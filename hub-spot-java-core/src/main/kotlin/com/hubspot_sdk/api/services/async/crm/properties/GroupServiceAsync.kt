...
interface GroupServiceAsync {
    ...
    /** @see create */
    fun create(params: GroupCreateParams): CompletableFuture<CreatedResponsePropertyGroup> =
    ...
    fun list(objectType: String): CompletableFuture<CollectionResponsePropertyGroup> =
    ...
    /** @see list */
    fun list(params: GroupListParams): CompletableFuture<CollectionResponsePropertyGroup> =
    ...
    interface WithRawResponse {
         ...
         * but is otherwise the same as [GroupServiceAsync.get].
         */
        fun get(
            groupName: String,
            params: GroupGetParams,
