...
class SettingServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun list(params: SettingListParams, requestOptions: RequestOptions): SettingsResponse =
        // get /webhooks/v3/{appId}/settings
        withRawResponse().list(params, requestOptions).parse()

    override fun delete(params: SettingDeleteParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val updateHandler: Handler<SettingsResponse> =
        ...
        override fun update(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("webhooks", "v3", params._pathParam(0), "settings")
        ...
        private val listHandler: Handler<SettingsResponse> =
            jsonHandler<SettingsResponse>(clientOptions.jsonMapper)
