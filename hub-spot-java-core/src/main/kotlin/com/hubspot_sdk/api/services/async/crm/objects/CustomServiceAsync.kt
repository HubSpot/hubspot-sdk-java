...
interface CustomServiceAsync {
    ...
    /** @see create */
    fun create(params: CustomCreateParams): CompletableFuture<CreatedResponseSimplePublicObject> =
    ...
    interface WithRawResponse {
         ...
         * same as [CustomServiceAsync.create].
         */
        fun create(
            objectType: String,
            params: CustomCreateParams,
         ...
         * otherwise the same as [CustomServiceAsync.update].
         */
        fun update(
            objectId: String,
            params: CustomUpdateParams,
         ...
         * same as [CustomServiceAsync.list].
         */
         ...
         * otherwise the same as [CustomServiceAsync.delete].
         */
