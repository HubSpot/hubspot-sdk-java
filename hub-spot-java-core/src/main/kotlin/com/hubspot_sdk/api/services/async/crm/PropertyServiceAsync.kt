...
import com.hubspot_sdk.api.services.async.crm.properties.BatchServiceAsync
import com.hubspot_sdk.api.services.async.crm.properties.GroupServiceAsync
...
interface PropertyServiceAsync {
    ...
    ): CompletableFuture<CreatedResponseProperty> =
    ...
    /** @see create */
    fun create(params: PropertyCreateParams): CompletableFuture<CreatedResponseProperty> =
    ...
    fun list(objectType: String): CompletableFuture<CollectionResponseProperty> =
    ...
    fun list(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CompletableFuture<CollectionResponseProperty> =
    ...
    /** @see list */
    fun list(params: PropertyListParams): CompletableFuture<CollectionResponseProperty> =
    ...
    interface WithRawResponse {
         ...
         * the same as [PropertyServiceAsync.create].
         */
        fun create(
            objectType: String,
            params: PropertyCreateParams,
        ): CompletableFuture<HttpResponseFor<CreatedResponseProperty>> =
            create(objectType, params, RequestOptions.none())
         ...
         * but is otherwise the same as [PropertyServiceAsync.update].
         */
        fun update(
            propertyName: String,
            params: PropertyUpdateParams,
         ...
         * the same as [PropertyServiceAsync.list].
         */
        fun list(
            objectType: String
        ): CompletableFuture<HttpResponseFor<CollectionResponseProperty>> =
            list(objectType, PropertyListParams.none())
         ...
         * but is otherwise the same as [PropertyServiceAsync.delete].
         */
        fun delete(
            propertyName: String,
            params: PropertyDeleteParams,
         ...
         * is otherwise the same as [PropertyServiceAsync.get].
         */
        fun get(
            propertyName: String,
            params: PropertyGetParams,
