...
interface DealService {
     ...
     */
    fun create(params: DealCreateParams): CreatedResponseSimplePublicObject =
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/0-3`, but is otherwise the same as
         * [DealService.create].
         */
        @MustBeClosed
        fun create(params: DealCreateParams): HttpResponseFor<CreatedResponseSimplePublicObject> =
            create(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `patch /crm/v3/objects/0-3/{dealId}`, but is otherwise
         * the same as [DealService.update].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/objects/0-3`, but is otherwise the same as
         * [DealService.list].
         */
        ...
        /**
         * Returns a raw HTTP response for `delete /crm/v3/objects/0-3/{dealId}`, but is otherwise
         * the same as [DealService.delete].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/objects/0-3/{dealId}`, but is otherwise the
         * same as [DealService.get].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/0-3/merge`, but is otherwise the
         * same as [DealService.merge].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/0-3/search`, but is otherwise the
         * same as [DealService.search].
         */
        @MustBeClosed
        fun search(
            params: DealSearchParams
