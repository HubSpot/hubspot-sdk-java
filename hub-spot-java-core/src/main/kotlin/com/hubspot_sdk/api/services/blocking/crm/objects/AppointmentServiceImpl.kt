...
import com.hubspot_sdk.api.services.blocking.crm.objects.appointments.BatchServiceImpl
...
class AppointmentServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun delete(params: AppointmentDeleteParams, requestOptions: RequestOptions) {
        ...
        override fun list(
            ...
            return errorHandler.handle(response).parseable {
                response
                    ...
                    .let {
                        AppointmentListPage.builder()
                            .service(AppointmentServiceImpl(clientOptions))
                            .params(params)
                            .response(it)
                            .build()
                    }
