...
interface DealServiceAsync {
     ...
     */
    fun create(params: DealCreateParams): CompletableFuture<CreatedResponseSimplePublicObject> =
    ...
    interface WithRawResponse {
         ...
         * the same as [DealServiceAsync.update].
         */
        fun update(
            dealId: String,
            params: DealUpdateParams,
         ...
         * the same as [DealServiceAsync.delete].
         */
         ...
         * same as [DealServiceAsync.merge].
         */
         ...
         * same as [DealServiceAsync.search].
         */
        fun search(
            params: DealSearchParams
