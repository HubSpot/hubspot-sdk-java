...
interface TicketService {
     ...
     */
    fun create(params: TicketCreateParams): CreatedResponseSimplePublicObject =
    ...
    interface WithRawResponse {
         ...
         * as [TicketService.create].
         */
        @MustBeClosed
        fun create(params: TicketCreateParams): HttpResponseFor<CreatedResponseSimplePublicObject> =
            create(params, RequestOptions.none())
         ...
         * the same as [TicketService.merge].
         */
        @MustBeClosed
         ...
         * the same as [TicketService.search].
         */
        @MustBeClosed
        fun search(
            params: TicketSearchParams
