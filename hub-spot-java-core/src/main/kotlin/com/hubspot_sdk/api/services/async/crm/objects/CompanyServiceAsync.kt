...
interface CompanyServiceAsync {
     ...
     */
    fun create(params: CompanyCreateParams): CompletableFuture<CreatedResponseSimplePublicObject> =
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/companies`, but is otherwise the
         * same as [CompanyServiceAsync.create].
         */
        fun create(
            params: CompanyCreateParams
        ...
        /**
         * Returns a raw HTTP response for `patch /crm/v3/objects/companies/{companyId}`, but is
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/objects/companies`, but is otherwise the
         * same as [CompanyServiceAsync.list].
         */
        ...
        /**
         * Returns a raw HTTP response for `delete /crm/v3/objects/companies/{companyId}`, but is
         * otherwise the same as [CompanyServiceAsync.delete].
         */
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/objects/companies/{companyId}`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/companies/merge`, but is otherwise
         * the same as [CompanyServiceAsync.merge].
         */
        fun merge(
            params: CompanyMergeParams
        ): CompletableFuture<HttpResponseFor<SimplePublicObject>> =
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/companies/search`, but is otherwise
         * the same as [CompanyServiceAsync.search].
         */
        fun search(
            params: CompanySearchParams
