...
interface BatchService {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/line_items/batch/create`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/line_items/batch/update`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/line_items/batch/archive`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/line_items/batch/read`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/line_items/batch/upsert`, but is
