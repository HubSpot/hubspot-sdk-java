...
interface GoalTargetService {
     ...
     */
    fun create(params: GoalTargetCreateParams): CreatedResponseSimplePublicObject =
    ...
    interface WithRawResponse {
         ...
         * same as [GoalTargetService.create].
         */
        @MustBeClosed
        fun create(
            params: GoalTargetCreateParams
         ...
         * is otherwise the same as [GoalTargetService.update].
         */
        @MustBeClosed
        fun update(
            goalTargetId: String,
         ...
         * same as [GoalTargetService.list].
         */
        @MustBeClosed
         ...
         * is otherwise the same as [GoalTargetService.delete].
         */
        @MustBeClosed
         ...
         * otherwise the same as [GoalTargetService.get].
         */
        @MustBeClosed
