...
import com.hubspot_sdk.api.models.crm.users.UserListPageAsync
...
import com.hubspot_sdk.api.services.async.crm.users.BatchServiceAsync
...
interface UserServiceAsync {
     ...
     */
    fun create(params: UserCreateParams): CompletableFuture<CreatedResponseSimplePublicObject> =
    ...
    interface WithRawResponse {
         ...
         * same as [UserServiceAsync.search].
         */
        fun search(
            params: UserSearchParams
