...
interface LeadServiceAsync {
     ...
     */
    fun create(params: LeadCreateParams): CompletableFuture<CreatedResponseSimplePublicObject> =
    ...
    interface WithRawResponse {
         ...
         * the same as [LeadServiceAsync.update].
         */
        fun update(
            leadsId: String,
            params: LeadUpdateParams,
         ...
         * the same as [LeadServiceAsync.get].
         */
        fun get(
            leadsId: String
         ...
         * same as [LeadServiceAsync.search].
         */
        fun search(
            params: LeadSearchParams
