...
interface ContactServiceAsync {
     ...
     */
    fun create(params: ContactCreateParams): CompletableFuture<CreatedResponseSimplePublicObject> =
    ...
    interface WithRawResponse {
         ...
         * same as [ContactServiceAsync.create].
         */
        fun create(
            params: ContactCreateParams
         ...
         * the same as [ContactServiceAsync.search].
         */
        fun search(
            params: ContactSearchParams
