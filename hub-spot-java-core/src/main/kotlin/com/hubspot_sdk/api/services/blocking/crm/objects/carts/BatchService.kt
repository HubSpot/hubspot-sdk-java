...
interface BatchService {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/carts/batch/create`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/carts/batch/update`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/carts/batch/archive`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/carts/batch/read`, but is otherwise
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/carts/batch/upsert`, but is
