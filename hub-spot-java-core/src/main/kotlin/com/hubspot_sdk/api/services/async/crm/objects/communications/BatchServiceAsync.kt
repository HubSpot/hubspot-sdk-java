...
package com.hubspot_sdk.api.services.async.crm.objects.communications
...
import com.hubspot_sdk.api.models.crm.objects.communications.batch.BatchCreateParams
import com.hubspot_sdk.api.models.crm.objects.communications.batch.BatchDeleteParams
import com.hubspot_sdk.api.models.crm.objects.communications.batch.BatchGetParams
import com.hubspot_sdk.api.models.crm.objects.communications.batch.BatchUpdateParams
import com.hubspot_sdk.api.models.crm.objects.communications.batch.BatchUpsertParams
...
interface BatchServiceAsync {
    ...
    /**
     * Create a batch of messages. The `inputs` array can contain a `properties` object to define
     * property values for each message, along with an `associations` array to define
    ...
    /**
     * Delete a batch of messages by ID. A deleted message can be restored within 90 days of being
     * deleted. Learn more about
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/communications/batch/create`, but
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/communications/batch/update`, but
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/communications/batch/archive`, but
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/communications/batch/read`, but is
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/communications/batch/upsert`, but
