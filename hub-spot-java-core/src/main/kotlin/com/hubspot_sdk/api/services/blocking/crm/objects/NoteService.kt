...
interface NoteService {
     ...
     */
    fun create(params: NoteCreateParams): CreatedResponseSimplePublicObject =
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/notes`, but is otherwise the same
         * as [NoteService.create].
         */
        @MustBeClosed
        fun create(params: NoteCreateParams): HttpResponseFor<CreatedResponseSimplePublicObject> =
            create(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `patch /crm/v3/objects/notes/{noteId}`, but is otherwise
         * the same as [NoteService.update].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/objects/notes`, but is otherwise the same as
         * [NoteService.list].
         */
        ...
        /**
         * Returns a raw HTTP response for `delete /crm/v3/objects/notes/{noteId}`, but is otherwise
         * the same as [NoteService.delete].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/objects/notes/{noteId}`, but is otherwise
         * the same as [NoteService.get].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/notes/search`, but is otherwise the
         * same as [NoteService.search].
         */
        @MustBeClosed
        fun search(
            params: NoteSearchParams
