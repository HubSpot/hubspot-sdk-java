...
import com.hubspot_sdk.api.models.crm.objects.leads.LeadListPage
...
import com.hubspot_sdk.api.services.blocking.crm.objects.leads.BatchService
...
interface LeadService {
     ...
     */
    fun create(params: LeadCreateParams): CreatedResponseSimplePublicObject =
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/leads`, but is otherwise the same
         * as [LeadService.create].
         */
        @MustBeClosed
        fun create(params: LeadCreateParams): HttpResponseFor<CreatedResponseSimplePublicObject> =
            create(params, RequestOptions.none())
        ...
        /**
         * Returns a raw HTTP response for `patch /crm/v3/objects/leads/{leadsId}`, but is otherwise
         * the same as [LeadService.update].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/objects/leads`, but is otherwise the same as
         * [LeadService.list].
         */
        ...
        /**
         * Returns a raw HTTP response for `delete /crm/v3/objects/leads/{leadsId}`, but is
        ...
        /**
         * Returns a raw HTTP response for `get /crm/v3/objects/leads/{leadsId}`, but is otherwise
         * the same as [LeadService.get].
         */
        @MustBeClosed
        ...
        /**
         * Returns a raw HTTP response for `post /crm/v3/objects/leads/search`, but is otherwise the
         * same as [LeadService.search].
         */
        @MustBeClosed
        fun search(
            params: LeadSearchParams
