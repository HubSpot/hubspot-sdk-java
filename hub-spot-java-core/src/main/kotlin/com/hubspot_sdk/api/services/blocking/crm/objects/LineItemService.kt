...
interface LineItemService {
     ...
     */
    fun create(params: LineItemCreateParams): CreatedResponseSimplePublicObject =
    ...
    interface WithRawResponse {
         ...
         * otherwise the same as [LineItemService.update].
         */
        @MustBeClosed
        fun update(
            lineItemId: String,
         ...
         * otherwise the same as [LineItemService.get].
         */
        @MustBeClosed
