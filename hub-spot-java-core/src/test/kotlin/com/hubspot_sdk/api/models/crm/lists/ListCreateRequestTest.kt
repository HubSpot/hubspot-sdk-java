...
internal class ListCreateRequestTest {
    ...
    fun create() {
        ...
        assertThat(listCreateRequest.name()).isEqualTo("Dynamic Association List Example")
        assertThat(listCreateRequest.objectTypeId()).isEqualTo("0-1")
        assertThat(listCreateRequest.processingType()).isEqualTo("DYNAMIC")
