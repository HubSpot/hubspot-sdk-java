...
internal class PostReadParamsTest {

    @Test
    fun create() {
        PostReadParams.builder().objectId("objectId").archived(true).property("property").build()
    }

    @Test
    fun pathParams() {
        val params = PostReadParams.builder().objectId("objectId").build()
