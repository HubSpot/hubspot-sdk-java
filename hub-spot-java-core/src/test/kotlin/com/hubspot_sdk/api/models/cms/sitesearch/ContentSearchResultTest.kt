...
internal class ContentSearchResultTest {
    ...
    fun create() {
        ...
        assertThat(contentSearchResult.type()).isEqualTo(ContentSearchResult.Type.LANDING_PAGE)
        ...
        assertThat(contentSearchResult.language()).contains(ContentSearchResult.Language.AF)
