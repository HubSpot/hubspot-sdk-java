    ...
    fun create() {
        val attentionSpanEvent =
            AttentionSpanEvent.builder()
                ...
                .mediaName("mediaName")
                .mediaType(AttentionSpanEvent.MediaType.VIDEO)
        ...
        assertThat(attentionSpanEvent.mediaType()).isEqualTo(AttentionSpanEvent.MediaType.VIDEO)
        ...
        assertThat(attentionSpanEvent.portalId()).isEqualTo(1234567)
