...
internal class ApiFlowCreateRequestTest {
    ...
    fun ofContact() {
        ...
        val apiFlowCreateRequest = ApiFlowCreateRequest.ofContact(contact)

        assertThat(apiFlowCreateRequest.contact()).contains(contact)
        assertThat(apiFlowCreateRequest.platform()).isEmpty
    }

    @Test
    fun ofContactRoundtrip() {
        val jsonMapper = jsonMapper()
        val apiFlowCreateRequest =
        ...
        val roundtrippedApiFlowCreateRequest =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(apiFlowCreateRequest),
                jacksonTypeRef<ApiFlowCreateRequest>(),
            )

        assertThat(roundtrippedApiFlowCreateRequest).isEqualTo(apiFlowCreateRequest)
    }
    ...
    fun ofPlatform() {
        ...
        val apiFlowCreateRequest = ApiFlowCreateRequest.ofPlatform(platform)

        assertThat(apiFlowCreateRequest.contact()).isEmpty
        assertThat(apiFlowCreateRequest.platform()).contains(platform)
    }
    ...
    fun ofPlatformRoundtrip() {
        val jsonMapper = jsonMapper()
        val apiFlowCreateRequest =
            ApiFlowCreateRequest.ofPlatform(
                ApiPlatformFlowCreateRequest.builder()
                    .addAction(
                        ApiStaticBranchAction.builder()
                            .actionId("1")
    ...
    fun incompatibleJsonShapeDeserializesToUnknown(testCase: IncompatibleJsonShapeTestCase) {
        val apiFlowCreateRequest =
            jsonMapper().convertValue(testCase.value, jacksonTypeRef<ApiFlowCreateRequest>())

        val e = assertThrows<HubSpotInvalidDataException> { apiFlowCreateRequest.validate() }
