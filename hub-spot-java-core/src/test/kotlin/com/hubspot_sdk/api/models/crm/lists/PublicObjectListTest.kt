...
internal class PublicObjectListTest {

    @Test
    fun create() {
        val publicObjectList =
        ...
        assertThat(publicObjectList.listId()).isEqualTo("listId")
        assertThat(publicObjectList.listVersion()).isEqualTo(0)
        assertThat(publicObjectList.name()).isEqualTo("name")
        assertThat(publicObjectList.objectTypeId()).isEqualTo("objectTypeId")
        assertThat(publicObjectList.processingStatus()).isEqualTo("processingStatus")
        assertThat(publicObjectList.processingType()).isEqualTo("processingType")
        assertThat(publicObjectList.createdAt())
            .contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(publicObjectList.createdById()).contains("createdById")
        assertThat(publicObjectList.deletedAt())
            .contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        ...
        assertThat(publicObjectList.filtersUpdatedAt())
            .contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(publicObjectList.listPermissions())
            .contains(
                PublicListPermissions.builder()
                    .addTeamsWithEditAccess(0)
                    .addUsersWithEditAccess(0)
        ...
        assertThat(publicObjectList.membershipSettings())
            .contains(
                PublicMembershipSettings.builder()
                    .includeUnassigned(true)
                    .membershipTeamId(0)
        ...
        assertThat(publicObjectList.size()).contains(0L)
        assertThat(publicObjectList.updatedAt())
            .contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(publicObjectList.updatedById()).contains("updatedById")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedPublicObjectList =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(publicObjectList),
                jacksonTypeRef<PublicObjectList>(),
            )

        assertThat(roundtrippedPublicObjectList).isEqualTo(publicObjectList)
    }
}
