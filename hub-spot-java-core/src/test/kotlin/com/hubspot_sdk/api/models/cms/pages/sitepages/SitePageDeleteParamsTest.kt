...
internal class SitePageDeleteParamsTest {
    ...
    @Test
    fun pathParams() {
        val params = SitePageDeleteParams.builder().objectId("objectId").build()
    ...
    @Test
    fun queryParams() {
        val params = SitePageDeleteParams.builder().objectId("objectId").archived(true).build()
