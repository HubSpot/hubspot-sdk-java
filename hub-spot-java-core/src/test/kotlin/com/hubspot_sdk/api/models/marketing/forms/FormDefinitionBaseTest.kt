...
internal class FormDefinitionBaseTest {

    @Test
    fun create() {
        val formDefinitionBase =
            FormDefinitionBase.builder()
                .id("id")
                .archived(true)
                .configuration(
                ...
                .formType(FormDefinitionBase.FormType.HUBSPOT)
                .legalConsentOptions(
        ...
        assertThat(formDefinitionBase.id()).isEqualTo("id")
        assertThat(formDefinitionBase.archived()).isEqualTo(true)
        assertThat(formDefinitionBase.configuration())
            .isEqualTo(
                HubSpotFormConfiguration.builder()
                    .allowLinkToResetKnownValues(true)
                    .archivable(true)
        ...
        assertThat(formDefinitionBase.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(formDefinitionBase.displayOptions())
            .isEqualTo(
                FormDisplayOptions.builder()
                    .renderRawHtml(true)
                    .style(
        ...
        assertThat(formDefinitionBase.fieldGroups())
            .containsExactly(
                FieldGroup.builder()
                    .addField(
                        EmailField.builder()
        ...
        assertThat(formDefinitionBase.formType()).isEqualTo(FormDefinitionBase.FormType.HUBSPOT)
        assertThat(formDefinitionBase.legalConsentOptions())
            .isEqualTo(
                FormDefinitionBase.LegalConsentOptions.ofNone(
                    LegalConsentOptionsNone.builder()
                        .type(LegalConsentOptionsNone.Type.NONE)
                        .build()
                )
            )
        assertThat(formDefinitionBase.name()).isEqualTo("name")
        assertThat(formDefinitionBase.updatedAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(formDefinitionBase.archivedAt())
    ...
    fun roundtrip() {
        ...
        val roundtrippedFormDefinitionBase =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(formDefinitionBase),
                jacksonTypeRef<FormDefinitionBase>(),
            )

        assertThat(roundtrippedFormDefinitionBase).isEqualTo(formDefinitionBase)
    }
}
