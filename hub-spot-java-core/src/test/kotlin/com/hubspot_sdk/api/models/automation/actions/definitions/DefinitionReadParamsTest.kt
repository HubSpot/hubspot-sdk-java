...
internal class DefinitionReadParamsTest {

    @Test
    fun create() {
        DefinitionReadParams.builder().appId(0).definitionId("definitionId").archived(true).build()
    }

    @Test
    fun pathParams() {
        val params = DefinitionReadParams.builder().appId(0).definitionId("definitionId").build()
