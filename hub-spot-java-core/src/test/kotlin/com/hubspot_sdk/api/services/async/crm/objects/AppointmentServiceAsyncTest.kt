...
internal class AppointmentServiceAsyncTest {
    ...
    fun create() {
        val client =
            HubSpotOkHttpClientAsync.builder()
                ...
                .build()
        val appointmentServiceAsync = client.crm().objects().appointments()

        val createdResponseSimplePublicObjectFuture =
            appointmentServiceAsync.create(
    ...
    fun update() {
        ...
        val simplePublicObjectFuture =
            appointmentServiceAsync.update(
                AppointmentUpdateParams.builder()
    ...
    fun list() {
        ...
        val pageFuture = appointmentServiceAsync.list()
    ...
    fun delete() {
        ...
        val future = appointmentServiceAsync.delete("appointmentId")
    ...
    fun search() {
        ...
        val collectionResponseWithTotalSimplePublicObjectFuture =
            appointmentServiceAsync.search(
